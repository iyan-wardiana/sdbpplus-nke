...
/* 
	...
	* Create Date	= 19 Januari 2022
	* File Name		= mstr_item_list.php
	* Location		= -
*/
					...
					<div class="box box-primary">
						...
						<div class="box-body">
	                        <div class="form-group">
	                          	...
	                          	<div class="col-sm-2">
	                            	<select name="ITM_GROUP" id="ITM_GROUP" class="form-control select2" onchange="grpItem()">
	                            		<option value=""> --- </option>
										<?php
	                          	...
	                          	<div class="col-sm-3">
	                            	<select name="ITM_CATEG" id="ITM_CATEG" class="form-control select2" onchange="grpItem()">
	                            		<option value=""> --- </option>
										<?php
	                          	...
	                          	<button class="btn btn-primary" type="button" id="btnGrp" name="btnGrp" onClick="grpItem()" style="display: none;">
		    ...
		    <script type="text/javascript">
		    	function grpItem()
		    	{
		    		...
		    		$('#example').DataTable( {
						...
						"autoWidth": true,
						"filter": true,
				        "ajax": "<?php echo site_url('c_inventory/c_it180e2elst/get_AllDataGRP_MSTR/?id='.$PRJCODE)?>"+'&ITMGRP='+ITM_GROUP+'&ITMCAT='+ITM_CATEG,
				        "type": "POST",
		    	...
		    	<div class="box-body">
		    		<div class="search-table-outter">
		                ...
		                <table id="example" class="table table-bordered table-striped table-responsive search-table inner" width="100%">
		                    <thead>
			                    <tr>
			                        <th width="10%" style="vertical-align:middle; text-align:center" nowrap><?php echo $ItemCode ?> </th>
			                        <th width="60%" style="vertical-align:middle; text-align:center"><?php echo $ItemName ?> </th>
			                        <th width="10%" style="vertical-align:middle; text-align:center"><?php echo $OnHand; ?></th>
			                        <th width="5%" style="vertical-align:middle; text-align:center" nowrap>Unit</th>
			                        <th width="5%" style="vertical-align:middle; text-align:center"><?php echo $Status ?> </th>
			                        <th width="10%" style="vertical-align:middle; text-align:center">&nbsp;</th>
			                    </tr>
		                    </thead>
		                    <tbody>
		                    </tbody>
	                                        	...
	                                        	<div class="row">
							                        <div class="box box-success">
							                            <div class="box-body">
															...
															<?php
									                            $s_ac	= "tbl_chartaccount WHERE Account_Category = '1' AND PRJCODE = '$PRJCODE'";
									                            $r_ac 	= $this->db->count_all($s_ac);
									                            
									                            $s_av	= "SELECT DISTINCT Acc_ID, Account_Number, Account_Level,
								                            					Account_NameEn, Account_NameId, Acc_ParentList,
																				Acc_DirParent, isLast
								                                            FROM tbl_chartaccount WHERE Account_Category = 1 AND PRJCODE = '$PRJCODE'
								                                            	ORDER BY Account_Number";
									                            $r_av 	= $this->db->query($s_av)->result();
									                            
									                            $s_bc	= "tbl_chartaccount WHERE Account_Category = '5' AND PRJCODE = '$PRJCODE'";
									                            $r_bc 	= $this->db->count_all($s_bc);
									                            
									                            $s_bv	= "SELECT DISTINCT Acc_ID, Account_Number, Account_Level,
								                            					Account_NameEn, Account_NameId, Acc_ParentList,
																				Acc_DirParent, isLast
								                                            FROM tbl_chartaccount WHERE Account_Category = 5 AND PRJCODE = '$PRJCODE'
								                                            	ORDER BY Account_Number";
...
<script>
	...
	$(document).ready(function() {
	    $('#example').DataTable( {
			...
			"autoWidth": true,
			"filter": true,
	        "ajax": "<?php echo site_url('c_inventory/c_it180e2elst/get_AllData_MSTR/?id='.$PRJCODE)?>",
	        "type": "POST",
			//"lengthMenu": [[10, 25, 50, 100, 200], [10, 25, 50, 100, 200]],
			"lengthMenu": [[25, 50, 100, 200, -1], [25, 50, 100, 200, "All"]],
			"columnDefs": [	{ targets: [2], className: 'dt-body-right' },
