          ...
          <form name="frmsync" id="frmsync" action="" method=POST>
            ...
            <table id="example" class="table table-bordered table-striped" width="100%">
                ...
                <tr>
                    ...
                    <th width="31%" rowspan="2" style="vertical-align:middle; text-align:center"><?php echo $ItemName ?> </th>
                    <th colspan="5" style="vertical-align:middle; text-align:center"><?php echo $StockQuantity ?> </th>
                    <th width="9%" rowspan="2" style="vertical-align:middle; text-align:center"><?php echo $Price ?> </th>
                    <th width="5%" rowspan="2" style="vertical-align:middle; text-align:center" nowrap><?php echo $UnitName ?> </th>
                    <th width="4%" rowspan="2" style="vertical-align:middle; text-align:center"><?php echo $Status ?> </th>
                    <th width="5%" rowspan="2" style="vertical-align:middle; text-align:center">&nbsp;</th>
                </tr>
                <tr>
                    <th width="6%" style="vertical-align:middle; text-align:center" nowrap><?php echo $BudgetQty; ?> </th>
                    <th width="5%" style="vertical-align:middle; text-align:center" nowrap><?php echo $ReceiptQty; ?></th>
                    <th width="6%" style="vertical-align:middle; text-align:center" nowrap><?php echo $RemBudget; ?> </th>
                    <th width="8%" style="vertical-align:middle; text-align:center" nowrap><?php echo $Used; ?></th>
                    <th width="7%" style="vertical-align:middle; text-align:center" nowrap><?php echo $OnHand; ?> </th>
                  </tr>
                </thead>
                <tbody>
                </tbody>
...
<script>
    ...
    $('#example').DataTable( {
        "processing": true,
        "serverSide": true,
        "ajax": "<?php echo site_url('c_inventory/c_it180e2elst/get_data_item/?id='.$PRJCODE)?>",
        "type": "POST"
    } );
} );
</script>
