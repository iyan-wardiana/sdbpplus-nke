    ...
    <div class="box box-primary">
        ...
        <form method="post" name="sendDate" id="sendDate" class="form-user" action="<?php echo $secGenCode; ?>" style="display:none">		
            <table>
                <tr>
                    <td>
                        <input type="hidden" name="ITMTSFJCODEX" id="ITMTSFJCODEX" value="<?php echo $PRJCODE; ?>">
                        ...
                        <input type="hidden" name="ITMTSFDate" id="ITMTSFDate" value="">
                    </td>
        ...
        <form name="frmsrch1" id="frmsrch1" action="" method=POST style="display:none">
            ...
            <input type="text" name="JOBCODE1" id="JOBCODE1" value="<?php echo $ITMTSF_REFNO; ?>" />
        ...
        <form class="form-horizontal" name="frm" method="post" action="<?php echo $form_action; ?>" enctype="multipart/form-data" onSubmit="return checkInData()">
            ...
            <input type="Hidden" name="rowCount" id="rowCount" value="0">
            	...
            	<div class="form-group" style="display:none">
                    ...
                    <div class="col-sm-10">
                    	<input type="text" class="form-control" style="max-width:180px;text-align:left" name="ITMTSF_NUM1" id="ITMTSF_NUM1" size="30" value="<?php echo $DocNumber; ?>" disabled />
                    	<input type="hidden" class="form-control" style="max-width:350px;text-align:right" name="ITMTSF_NUM" id="ITMTSF_NUM" size="30" value="<?php echo $DocNumber; ?>" />
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <label>
                            <input type="text" class="form-control" style="min-width:width:150px; max-width:150px" name="ITMTSF_CODE" id="ITMTSF_CODE" value="<?php echo $ITMTSF_CODE; ?>" >
                        </label>
                        <label>
            	...
            	<div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        <i class="fa fa-calendar"></i>&nbsp;</div><input type="text" name="ITMTSF_DATE1" class="form-control pull-left" id="datepicker" value="<?php echo $ITMTSF_DATE; ?>" style="width:106px" disabled><input type="hidden" name="ITMTSF_DATE" class="form-control pull-left" id="datepicker" value="<?php echo $ITMTSF_DATE; ?>" style="width:106px" onChange="getITMTSF_NUM(this.value)"></div>
                    </div>
                </div>
            	<div class="form-group">
                    ...
                    <div class="col-sm-10">
                    	<div class="input-group date">
                        <div class="input-group-addon">
                        <i class="fa fa-calendar"></i>&nbsp;</div><input type="text" name="ITMTSF_SENDD1" class="form-control pull-left" id="datepicker1" value="<?php echo $ITMTSF_SENDD; ?>" style="width:106px" disabled><input type="hidden" name="ITMTSF_SENDD" class="form-control pull-left" id="datepicker1" value="<?php echo $ITMTSF_SENDD; ?>" style="width:106px" onChange="getITMTSF_NUM(this.value)"></div>
                    </div>
                </div>
            	<div class="form-group">
				...
				if($isHidden == 0)
				{
					...
					<div class="form-group" style="display:none">
						...
						<div class="col-sm-10">
							<select name="ITMTSF_REFNO" id="ITMTSF_REFNO" class="form-control select2" data-placeholder="&nbsp;&nbsp;&nbsp;<?php echo $JobName; ?>" style="max-width:400px;" onChange="selJOB(this.value)">
					...
					<script>
						function selJOB(ITMTSF_REFNO) 
						{
							document.getElementById("JOBCODE1").value = ITMTSF_REFNO;
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                    	<input type="text" class="form-control" style="max-width:400px" name="ITMTSF_SENDER" id="ITMTSF_SENDER" value="<?php echo $ITMTSF_SENDER; ?>" placeholder="<?php echo $Sender; ?>" disabled >
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputName" class="col-sm-2 control-label"><?php echo $Notes; ?></label>
                    <div class="col-sm-10">
                        <textarea name="ITMTSF_NOTE" class="form-control" style="max-width:400px;" id="ITMTSF_NOTE" cols="30" disabled><?php echo $ITMTSF_NOTE; ?></textarea>                        
                    </div>
                </div>
                <?php
					if($ISAPPROVE == 1)
					{
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" style="min-width:width:150px; max-width:400px" name="ITMTSF_RECEIVER" id="ITMTSF_RECEIVER" value="<?php echo $ITMTSF_RECEIVER; ?>" placeholder="<?php echo $Receiver; ?>" >
                            </div>
                        </div>
                        <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea name="ITMTSF_NOTE2" class="form-control" style="max-width:400px;" id="ITMTSF_NOTE2" cols="30"><?php echo $ITMTSF_NOTE2; ?></textarea>                        
                    </div>
                </div>
            	<div class="form-group">
										...
										if($disableAll == 0)
										{
											if($canApprove == 1)
											{
												...
												if($resCAPPHE > 0)
													$disButton	= 1;
												?>
													<select name="ITMTSF_STAT" id="ITMTSF_STAT" class="form-control" style="max-width:100px" onChange="selStat(this.value)" <?php if($disButton == 1) { ?> disabled <?php } ?> >
														...
														<option value="7"<?php if($ITMTSF_STAT == 7) { ?> selected <?php } ?> style="display:none">Awaiting</option>
													</select>
												<?php
											}
											else
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <script>
                                    ...
                                    {
										/*alert('a')
                                        ITMTSF_REFNO	= document.getElementById('ITMTSF_REFNO').value;
										alert('b')
                                        if(ITMTSF_REFNO == '')
                                        {
                                            alert('Silahkan pilih nama pekerjaan');
                                            document.getElementById('ITMTSF_REFNO').focus();
                                            return false;
                                        }
										alert('c')*/
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <table width="100%" border="1" id="tbl">
                            ...
                            if($task == 'edit')
                            {
                                $sqlDET	= "SELECT A.ITMTSF_NUM, A.ITMTSF_CODE, A.ITMTSF_DATE, A.PRJCODE, A.PRJCODE_DEST, A.JOBCODEID, 
												A.ITM_CODE, A.ITM_GROUP, A.ITM_NAME, A.ITM_UNIT, A.ITM_VOLM, A.ITMTSF_VOLM, 
								...
								/*	if ($j==1) {
									...
									<td width="3%" height="25" style="text-align:left">
								 	...
								 	<td width="10%" style="text-align:left" nowrap>
                                      	...
                                      	<input type="hidden" id="data<?php echo $currentRow; ?>ITMTSF_NUM" name="data[<?php echo $currentRow; ?>][ITMTSF_NUM]" value="<?php echo $ITMTSF_NUM; ?>" class="form-control" style="max-width:300px;">
                                      	<input type="hidden" id="data<?php echo $currentRow; ?>ITMTSF_CODE" name="data[<?php echo $currentRow; ?>][ITMTSF_CODE]" value="<?php echo $ITMTSF_CODE; ?>" class="form-control" style="max-width:300px;">
...
<script>
	...
	function add_item(strItem) 
	{
		...
		var ITMTSF_NUMx = "<?php echo $DocNumber; ?>";		
		var ITMTSF_CODE = "<?php echo $ITMTSF_CODE; ?>";
		var JOBCODEID 	= "<?php echo $ITMTSF_REFNO; ?>";
	...
	function getConvertion(thisVal1, row)
	{
		...
		if(ITMTSF_VOLM > ITM_VOLM)
		{
			alert('<?php echo $alert4; ?>');
			var ITMTSF_VOLM	= parseFloat(ITM_VOLM);
		}
	...
	function checkInData(value)
	{
		...
		if(ITMTSF_STAT == 0)
		{
			...
			document.getElementById('ITMTSF_STAT').focus();
			return false;
		}
