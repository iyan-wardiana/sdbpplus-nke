...
<div class="box">
    <div class="box-body">
        <div class="search-table-outter">
                ...
                <?php
                    ...
                    if($cData >0)
                    {
                        foreach($vData as $row) :													
                            ...
                            $ADJ_STAT		= $row->ADJ_STAT;
                            $ADJ_CREATER	= $row->ADJ_CREATER;
                            ...
                            if ($j==1) {
                                ...
                                ?>
                                        <td style="text-align:center">
                                        	<?php echo $myNewNo1; ?>.
                                            <input type="radio" name="chkDetail" id="chkDetail" value="<?php echo $ADJ_NUM;?>" onClick="getValueNo(this);" style="display:none" />
                                        </td>
                                        <td nowrap>
                                            <?php echo $ADJ_NUM;?>
                                        </td>
                                        <td> <?php print $ADJ_CODE; ?></td>
                                        <td style="text-align:center"><?php
                                                $date = new DateTime($ADJ_DATE);
                                                echo $ADJ_DATE;
                                            ?>                            </td>
                                        <td><?php print "$JOBDESC - $ADJ_NOTE"; ?> </td>
                                        <td style="text-align:center"><?php echo $ADJ_CREATER; ?></td>
                                        <td style="text-align:center">
                                        ...
                                        <?php
                                            $secUpd		= site_url('c_inventory/c_tr4n5p3r/update/?id='.$this->url_encryption_helper->encode_url($ADJ_NUM));
                                            $secPrint	= site_url('c_inventory/c_tr4n5p3r/printdocument/?id='.$this->url_encryption_helper->encode_url($ADJ_NUM));
                                            $CollID		= "$ADJ_NUM~$PRJCODE";
                                            $secDel_PO 	= base_url().'index.php/c_inventory/c_tr4n5p3r/trash_PO/?id='.$ADJ_NUM;
                                        ?>
                                        ...
                                        <td style="text-align:center" nowrap>
                                            ...
                                            <a href="#" onClick="deleteMail('<?php echo $secDel_PO; ?>')" title="Delete file" class="btn btn-danger btn-xs" <?php if($ADJ_STAT > 1) { ?>disabled="disabled" <?php } ?>>
            ...
            <?php
                $secIndex_PR	= site_url('c_inventory/c_tr4n5p3r/index/?id='.$this->url_encryption_helper->encode_url($PRJCODE));
            ?>
        </div>
        <!-- /.box-body -->
    </div>
