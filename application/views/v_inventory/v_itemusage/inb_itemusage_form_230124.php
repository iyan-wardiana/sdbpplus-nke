						...
						<div class="box box-primary">
							...
							<div class="box-body">
				            	...
				            	<div class="form-group">
				                    ...
				                    <div class="col-sm-9">
										<select name="UM_TYPEX" id="UM_TYPEX" class="form-control select2" onChange="selType(this.value)">
											<option value="0"> --- </option>
											<option value="1"<?php if($UM_TYPE == 1) { ?> selected <?php } ?>><?=$selfUsed?></option>
											<option value="2"<?php if($UM_TYPE == 2) { ?> selected <?php } ?>><?=$usedTP?></option>
										</select>
	                    ...
	                    <div class="box box-primary">
	                        <div class="search-table-outter">
	                            <table id="tbl" class="table table-bordered table-striped" width="100%">
		                            ...
		                            <?php
		                                $sqlDET	= "SELECT A.UM_NUM, A.UM_CODE, B.ACC_ID, B.ACC_ID_UM, A.PRJCODE, A.JOBCODEDET, A.JOBCODEID, 
