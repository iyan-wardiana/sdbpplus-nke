...
<html>
    ...
    <body class="<?php echo $appBody; ?>" style="background-color: <?=$comp_color?>">
        <section class="content-header">
        	<h1>
        	<img src="<?php echo base_url() . 'assets/AdminLTE-2.0.5/dist/img/icon/barcode.png'; ?>" style="max-width:40px; max-height:40px" >&nbsp;&nbsp;<?php echo $mnName; ?>
						...
						<div class="box box-primary">
							...
							<div class="box-body">
		                        ...
		                        <div class="form-group">
		                          	...
		                          	<div class="col-sm-9">
		                                <input type="text" name="IR_NUM1" id="IR_NUM1" value="<?php echo $IR_NUM; ?>" class="form-control">
		                        ...
		                        <div class="form-group">
		                          	...
		                          	<div class="col-sm-9">
		                                <div class="input-group">
		                                    ...
		                                    <input type="text" class="form-control" name="PO_NUM1" id="PO_NUM1" value="<?php echo "$PO_CODE"; ?>" onClick="pleaseCheck();" readonly>
		                                    <div class="input-group-btn" title="Tampilkan semua item">
												<button type="button" class="btn btn-warning" id="shwDet" onClick="refrDetil()"><i class="glyphicon glyphicon-refresh"></i></button>
		                                    </div>
		                        ...
		                        <?php
		                        	...
		                        	$getTRW 	= base_url().'index.php/c_inventory/c_ir180c15/getTRow/?id=';
		                        ?>
		                        <script type="text/javascript">
		                        	function refrDetil()
		                        	{
		                        		...
		                        		console.log('PO_NUM = '+PO_NUM+' = '+collDt)
								    	$('#tbl').DataTable(
								    	{
								    		"bDestroy": true,
									        "processing": true,
											...
											"autoWidth": true,
											"filter": true,
									        "ajax": "<?php echo site_url('c_inventory/c_ir180c15/get_AllDataIRDet/?id='.$PRJCODE.'&collDt='.$collDt.'&task='.$task.'&PO_NUM=')?>"+PO_NUM,
									        "type": "POST",
                                ...
                                <thead>
                                    <tr>
                                        <th width="2%" height="25" style="text-align:left">&nbsp;</th>
                                      	...
                                      	<th width="15%" style="text-align:center; vertical-align: middle">No. SJ</th>
                                ...
                                <?php
	                                ...
	                                if($task == 'edit' && isset($_POST['PO_NUMX']))
	                                {
										$sqlDETPO	= "SELECT A.PO_NUM, A.PO_CODE, A.PR_NUM, A.JOBCODEDET, A.JOBCODEID, A.ITM_CODE, 
															...
															B.ISFASTM, B.ISWAGE, 0 AS ISPRCREATE, 0 AS ADD_PRVOLM, 0 AS SJ_NUM
														FROM tbl_po_detail A
															INNER JOIN tbl_item B ON A.ITM_CODE = B.ITM_CODE
																AND B.PRJCODE = '$PRJCODE' -- AND B.ITM_CATEG NOT IN ('UA')
														WHERE PO_NUM = '$PO_NUMX' 
															AND B.PRJCODE = '$PRJCODE' ORDER BY B.ITM_NAME";
									...
									if($resultC > 0)
									{
										...
										foreach($result as $row) :
											...
											$chkCopy 		= "$currRow|$IR_NUM|$IR_CODE|$PO_NUM|$PRJCODE|$POD_ID|$ITM_CODE|$ACC_ID|$JOBCODEDET|$JOBCODEID|$JOBPARENT|$JOBPARDESC|$ITM_NAME|$ITM_CATEG|$ITM_QTY|$ITM_UNIT|$ITM_GROUP|$ITM_CATEG|$ITM_TYPE|$ITM_PRICE|$ITM_TOTAL|$ITM_DISP|$ITM_DISC|$TAXCODE1|$TAXPRICE1|$IR_AMOUNTNET|$ITM_QTY_BONUS|$ITM_DESC|$ISPRCREATE|$ADD_PRVOLM";
											...
											{
												?>
												<tr id="tr_<?php echo $currRow; ?>" style="background-color: #red">
														...
														<?php
				                                            if($IR_STAT == 1)
				                                            {
				                                                ...
				                                                <label style="white-space:nowrap">
						                                            <input type="hidden" name="urlDel<?php echo $currRow; ?>" id="urlDel<?php echo $currRow; ?>" value="<?=$delROW?>">
																	<input type="hidden" name="urlCopy<?php echo $currRow; ?>" id="urlCopy<?php echo $currRow; ?>" value="<?=$copyROW?>">
																	<input type="hidden" name="chkCopy<?php echo $currRow; ?>" id="chkCopy<?php echo $currRow; ?>" value="<?=$chkCopy?>">
						                                            <a onClick="deleteRow(<?php echo $currRow; ?>)" title="Delete" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i></a>
						                                            <a onClick="copyRow(<?php echo $currRow; ?>)" title="Copy" class="btn btn-warning btn-xs"><i class="glyphicon glyphicon-copy"></i></a>
						                                        </label>
				                                                <?php
				                                            }
				                                            else
			                                          	...
			                                          	?>
														<input type="Checkbox" id="data[<?php echo $currRow; ?>][chk]" name="data[<?php echo $currRow; ?>][chk]" value="<?php echo $currRow; ?>" onClick="pickThis(this,<?php echo $currRow; ?>)" style="display:none">
														<input type="Checkbox" style="display:none" id="chk<?php echo $currRow; ?>" name="chk<?php echo $currRow; ?>" value="">
														<input type="hidden" id="chk" name="chk" value="<?php echo $currRow; ?>" width="10" size="15" readonly class="form-control" style="max-width:350px;text-align:right">
														<input type="hidden" id="data<?php echo $currRow; ?>IR_ID" name="data[<?php echo $currRow; ?>][IR_ID]" value="<?php echo $IR_ID; ?>" width="10" size="15" readonly class="form-control" style="max-width:350px;text-align:right">
														<input type="hidden" id="data<?php echo $currRow; ?>IR_NUM" name="data[<?php echo $currRow; ?>][IR_NUM]" value="<?php echo $IR_NUM; ?>" width="10" size="15" readonly class="form-control" style="max-width:350px;text-align:right">
														<input type="hidden" id="data<?php echo $currRow; ?>IR_CODE" name="data[<?php echo $currRow; ?>][IR_CODE]" value="<?php echo $IR_CODE; ?>" width="10" size="15" readonly class="form-control" style="max-width:350px;text-align:right">
														<input type="hidden" id="data<?php echo $currRow; ?>PO_NUM" name="data[<?php echo $currRow; ?>][PO_NUM]" value="<?php echo $PO_NUM; ?>" width="10" size="15" readonly class="form-control" style="max-width:350px;text-align:right">
														<input type="hidden" id="data<?php echo $currRow; ?>PRJCODE" name="data[<?php echo $currRow; ?>][PRJCODE]" value="<?php echo $PRJCODE; ?>" width="10" size="15" readonly class="form-control" style="max-width:350px;text-align:right">
														<!-- Checkbox -->
													</td>
													<td style="text-align:left; display: none;" nowrap>
														<?php echo "$ItmCol1$ITM_CODE$ItmCol2"; ?>
														<input type="hidden" id="data<?php echo $currRow; ?>POD_ID" name="data[<?php echo $currRow; ?>][POD_ID]" value="<?php echo $POD_ID; ?>" width="10" size="15" readonly class="form-control" style="max-width:350px;text-align:right">
														<input type="hidden" id="data<?php echo $currRow; ?>ITM_CODE" name="data[<?php echo $currRow; ?>][ITM_CODE]" value="<?php echo $ITM_CODE; ?>" width="10" size="15" readonly class="form-control" style="max-width:350px;text-align:right">
														<input type="hidden" id="data<?php echo $currRow; ?>ACC_ID" name="data[<?php echo $currRow; ?>][ACC_ID]" value="<?php echo $ACC_ID; ?>" width="10" size="15" readonly class="form-control">
														<input type="hidden" id="data<?php echo $currRow; ?>JOBCODEDET" name="data[<?php echo $currRow; ?>][JOBCODEDET]" value="<?php echo $JOBCODEDET; ?>" width="10" size="15" readonly class="form-control">
														<input type="hidden" id="data<?php echo $currRow; ?>JOBCODEID" name="data[<?php echo $currRow; ?>][JOBCODEID]" value="<?php echo $JOBCODEID; ?>" width="10" size="15" readonly class="form-control">
	                                                    <input type="text" id="data<?php echo $currRow; ?>JOBPARENT" name="data[<?php echo $currRow; ?>][JOBPARENT]" value="<?php print $JOBPARENT; ?>" width="10" size="15">
	                                                    <input type="text" id="data<?php echo $currRow; ?>JOBPARDESC" name="data[<?php echo $currRow; ?>][JOBPARDESC]" value="<?php print $JOBPARDESC; ?>" width="10" size="15">
														<!-- Item Code --></td>
													...
													<td style="text-align:left; vertical-align: middle;">
														...
														<input type="hidden" class="form-control" name="itemname<?php echo $currRow; ?>" id="itemname<?php echo $currRow; ?>" value="<?php echo $ITM_NAME; ?>" >
														<!-- Item Name --></td>

													<!-- SJ_NUM -->
													<td style="text-align:center; vertical-align: middle; font-style:italic">
														<input type="text" id="data<?php echo $currRow; ?>SJ_NUM" name="data[<?php echo $currRow; ?>][SJ_NUM]" value="<?php echo $SJ_NUM; ?>" class="form-control" style="max-width:350px;">
													</td>
													...
													<td style="text-align:center; vertical-align: middle; font-style:italic">
														<?php
															if($IR_STAT == 1 || $IR_STAT == 4) 
															{
																if($ITM_CATEG == 'UA')
																{
																	?>
																		hidden
																		<input type="hidden" class="form-control" style="text-align:right" name="ITM_QTYX<?php echo $currRow; ?>" id="ITM_QTYX<?php echo $currRow; ?>" value="<?php print number_format($ITM_QTY, $decFormat); ?>" onBlur="changeValue(this, <?php echo $currRow; ?>)" onKeyPress="return isIntOnlyNew(event);" <?php if($isDisabled == 1) { ?> disabled <?php } ?> size="20" >
																	<?php
																}
																else
																{
																	?>
																		<input type="text" class="form-control" style="text-align:right" name="ITM_QTYX<?php echo $currRow; ?>" id="ITM_QTYX<?php echo $currRow; ?>" value="<?php print number_format($ITM_QTY, $decFormat); ?>" onBlur="changeValue(this, <?php echo $currRow; ?>)" onKeyPress="return isIntOnlyNew(event);" <?php if($isDisabled == 1) { ?> disabled <?php } ?> size="20" >
																	<?php
																}
															}
															else
														...
														?>
														<input type="hidden" style="text-align:right" name="data[<?php echo $currRow; ?>][ITM_QTY]" id="ITM_QTY<?php echo $currRow; ?>" size="10" value="<?php echo $ITM_QTY; ?>" >
														<input type="hidden" style="text-align:right" id="REMAINQTY<?php echo $currRow; ?>" size="10" value="<?php echo $REMAINQTY; ?>" >
														<input type="hidden" style="text-align:right" name="data[<?php echo $currRow; ?>][ITM_QTY_REM]" id="ITM_QTY_REM<?php echo $currRow; ?>" size="10" value="<?php echo $ITM_QTY_REM; ?>" >
														<!-- Item Qty -->
													</td>
													...
													<td style="text-align:center; vertical-align: middle; font-style:italic">
														<?php
															if($ITM_CATEG == 'UA')
																...
																echo $ITM_UNIT;
														?>
														<input type="hidden" class="form-control" style="max-width:350px; text-align:right" name="data[<?php echo $currRow; ?>][ITM_UNIT]" id="ITM_UNIT<?php echo $currRow; ?>" size="10" value="<?php echo $ITM_UNIT; ?>" >
	                                                    <input type="hidden" class="form-control" style="max-width:350px; text-align:right" name="data[<?php echo $currRow; ?>][ITM_GROUP]" id="ITM_GROUP<?php echo $currRow; ?>" size="10" value="<?php echo $ITM_GROUP; ?>" >
	                                                    <input type="hidden" class="form-control" style="max-width:350px; text-align:right" id="ITM_CATEG<?php echo $currRow; ?>" size="10" value="<?php echo $ITM_CATEG; ?>" >
	                                                    <input type="hidden" class="form-control" style="max-width:350px; text-align:right" name="data[<?php echo $currRow; ?>][ITM_TYPE]" id="ITM_TYPE<?php echo $currRow; ?>" size="10" value="<?php echo $ITM_TYPE; ?>" >
														<!-- Item Unit --></td>

													<!-- ITM_PRICE, ITM_TOTAL -->
													<td style="text-align:center; vertical-align: middle; font-style:italic">
	                                                	hidden
														<input type="hidden" class="form-control" style="min-width:100px; max-width:350px; text-align:right;" name="ITM_PRICEX<?php echo $currRow; ?>" id="ITM_PRICEX<?php echo $currRow; ?>" value="<?php print number_format($ITM_PRICE, $decFormat); ?>" onBlur="changeValuePrc(this, <?php echo $currRow; ?>)" disabled >
														<input type="hidden" style="text-align:right" name="data[<?php echo $currRow; ?>][ITM_PRICE]" id="ITM_PRICE<?php echo $currRow; ?>" size="10" value="<?php echo $ITM_PRICE; ?>" >
														<!-- Item Price -->
														<input type="hidden" style="text-align:right" name="data[<?php echo $currRow; ?>][ITM_TOTAL]" id="ITM_TOTAL<?php echo $currRow; ?>" size="10" value="<?php echo $ITM_TOTAL; ?>" >
													</td>

													<!-- ITM_DISP -->
													<td style="text-align:center; vertical-align: middle; font-style:italic">
	                                                	hidden
														<input type="hidden" class="form-control" size="10"  style=" min-width:65px; max-width:150px; text-align:right;" name="ITM_DISPx<?php echo $currRow; ?>" id="ITM_DISPx<?php echo $currRow; ?>" value="<?php print number_format($ITM_DISP, $decFormat); ?>" onBlur="countDisp(this, <?php echo $currRow; ?>);" disabled >
														<input style="text-align:right" type="hidden" name="data[<?php echo $currRow; ?>][ITM_DISP]" id="ITM_DISP<?php echo $currRow; ?>" value="<?php echo $ITM_DISP; ?>"></td>

													<!-- ITM_DISC -->
													<td style="text-align:center; vertical-align: middle; font-style:italic">
	                                                	hidden
														<input type="text" class="form-control" style="min-width:100px; max-width:350px; text-align:right; display:none" name="ITM_DISCX<?php echo $currRow; ?>" id="ITM_DISCX<?php echo $currRow; ?>" value="<?php print number_format($ITM_DISC, $decFormat); ?>" onBlur="countDisc(this, <?php echo $currRow; ?>);" disabled >
														<input style="text-align:right" type="hidden" name="data[<?php echo $currRow; ?>][ITM_DISC]" id="ITM_DISC<?php echo $currRow; ?>" value="<?php echo $ITM_DISC; ?>"></td>

													<!-- TAXPRICE1 -->
													<td style="text-align:center; vertical-align: middle; font-style:italic">
	                                                	hidden
	                                                	<input type="hidden" name="data[<?php echo $currRow; ?>][TAXCODE1]" id="TAXCODE1<?php echo $currRow; ?>" value="<?php echo $TAXCODE1; ?>">
														<input type="hidden" style="text-align:right" name="data[<?php echo $currRow; ?>][TAXPRICE1]" id="TAXPRICE1<?php echo $currRow; ?>" size="10" value="<?php echo $TAXPRICE1; ?>" >
														<!-- Item Price Total PPn --></td>

													<!-- ITM_TOTAL_NETT -->
													<td style="text-align:center; vertical-align: middle; font-style:italic">
	                                                	hidden
	                                                    <input type="hidden" class="form-control" style="min-width:100px; max-width:350px; text-align:right;" name="ITM_TOTAL_NETT<?php echo $currRow; ?>" id="ITM_TOTAL_NETT<?php echo $currRow; ?>" value="<?php print number_format($IR_AMOUNTNET, $decFormat); ?>" disabled >
													</td>

													<!-- ITM_QTY_BONUS -->
													<td style="text-align:center; vertical-align: middle; font-style:italic; display: none;">
	                                                	<input type="text" class="form-control" style="min-width:100px; max-width:350px; text-align:right" name="ITM_QTY_BONUSX<?php echo $currRow; ?>" id="ITM_QTY_BONUSX<?php echo $currRow; ?>" value="<?php print number_format($ITM_QTY_BONUS, $decFormat); ?>" onBlur="changeValueQtyBonus(this, <?php echo $currRow; ?>)" onKeyPress="return isIntOnlyNew(event);" <?php if($isDisabled == 1) { ?> disabled <?php } ?> size="20" >
														<input type="hidden" style="text-align:right" name="data[<?php echo $currRow; ?>][ITM_QTY_BONUS]" id="ITM_QTY_BONUS<?php echo $currRow; ?>" size="10" value="<?php echo $ITM_QTY_BONUS; ?>" >
													</td>
													...
													<td style="text-align:left; vertical-align: middle; font-style:italic">
														<?php
															if($IR_STAT == 1 || $IR_STAT == 4) 
															{
																if($ITM_CATEG == 'UA')
																{
																	echo $ITM_DESC;
																	?>
																	<input type="hidden" name="data[<?php echo $currRow; ?>][NOTES]" id="data<?php echo $currRow; ?>NOTES" value="<?php echo $ITM_DESC; ?>" class="form-control" style="text-align:left" size="10">
																	<?php
																}
																else
																{
														...
														?>
														<input type="hidden" name="data[<?php echo $currRow; ?>][ISPRCREATE]" id="ISPRCREATE<?php echo $currRow; ?>" value="<?php echo $ISPRCREATE; ?>" class="form-control">
														<input type="hidden" name="data[<?php echo $currRow; ?>][ADD_PRVOLM]" id="ADD_PRVOLM<?php echo $currRow; ?>" value="<?php echo $ADD_PRVOLM; ?>" class="form-control">
													</td>
										  		</tr>
												<?php
											}
										endforeach;
										?>
										<input type="text" name="totalrow" id="totalrow" value="<?php echo $currRow; ?>">
										<?php
									}
									if($task == 'add')
									{
...
<script>
	...
	function changeValue(thisVal, theRow)
	{
		...
		//document.getElementById('IR_AMOUNTNETX'+theRow).value 		= doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(G_itmTot)),decFormat));
            ...
            success: function(response)
            {
                ...
                {*/
			    	...
			    	/*$('#tbl').DataTable(
			    	{
						...
						"autoWidth": true,
						"filter": true,
				        "ajax": "<?php echo site_url('c_inventory/c_ir180c15/get_AllDataIRDetIR/?id='.$PRJCODE.'&collDt='.$collDt.'&PO_NUM=')?>"+PO_NUM,
				        "type": "POST",
						//"lengthMenu": [[10, 25, 50, 100, 200, -1], [10, 25, 50, 100, 200, "All"]],
						"lengthMenu": [[10, 25, 50, 100, 200], [10, 25, 50, 100, 200]],
						"columnDefs": [	{ targets: [0], className: 'dt-body-center' },
