...
/* 
	...
	* Create Date	= 24 April 2019
	* File Name	= inb_itemreceipt_form_so.php
	* Location		= -
*/
...
{	
	...
	$IR_DUEDATE		= date('m/d/Y', strtotime($IR_DUEDATE));
		            ...
		            <div class="box box-primary">
		                ...
		                <div class="box-body chart-responsive">
		                    ...
		                    <form class="form-horizontal" name="frm" id="frm" method="post" action="<?php echo $form_action; ?>" onSubmit="return checkInp()">
		                        ...
		                        <div class="form-group">
		                          	<label for="inputName" class="col-sm-2 control-label"><?php echo $ReceiptFrom; ?> </label>
		                          	<div class="col-sm-10">
		                          		<input type="hidden" name="SPLCODE" id="SPLCODE" value="<?php echo $SPLCODE; ?>">
		                        		<select name="SPLCODE1" id="SPLCODE1" class="form-control select2" data-placeholder="&nbsp;&nbsp;&nbsp;<?php echo $ReceiptFrom; ?>" disabled >
		                        ...
		                        <div class="form-group">
		                          	...
		                          	<div class="col-sm-10">
		                                ...
		                                <select name="TERM_PAY1" id="TERM_PAY1" class="form-control" style="max-width:100px" disabled>
		                        ...
		                        <div class="form-group">
		                          	...
		                          	<div class="col-sm-10">
		                                <textarea class="form-control" name="IR_NOTE"  id="IR_NOTE" style="max-width:350px;height:70px; display:none"><?php echo $IR_NOTE; ?></textarea>
		                                <textarea class="form-control" name="IR_NOTE1"  id="IR_NOTE1" style="height:70px" disabled><?php echo $IR_NOTE; ?></textarea>
		                            </div>
		                        </div>
		                        <div class="form-group">
		                          	<label for="inputName" class="col-sm-2 control-label"><?php echo $ApproverNotes ?> </label>
		                          	<div class="col-sm-10">
		                                <textarea class="form-control" name="IR_NOTE2"  id="IR_NOTE2" style="height:70px"><?php echo $IR_NOTE2; ?></textarea>
		                            </div>
		                        </div>
		                        <!--
		                        	APPROVE STATUS
		                                    ...
		                                    <table id="tbl" class="table table-bordered table-striped" width="100%">
		                                        <tr style="background:#CCCCCC">
		                                            <th width="2%" height="25" rowspan="2" style="text-align:left">&nbsp;</th>
		                                          	<th width="9%" rowspan="2" style="text-align:center; vertical-align: middle;"><?php echo $ItemCode; ?> </th>
		                                          	<th width="27%" rowspan="2" style="text-align:center; vertical-align: middle;"><?php echo $ItemName; ?> </th>
		                                          	<th colspan="4" style="text-align:center"><?php echo $Receipt; ?> </th>
		                                            <th rowspan="2" style="text-align:center; vertical-align: middle;"><?php echo $Discount; ?><br>(%)</th>
		                                            <th rowspan="2" style="text-align:center; vertical-align: middle;"><?php echo $Discount; ?></th>
		                                            <th rowspan="2" style="text-align:center; vertical-align: middle;"><?php echo $PPn; ?></th>
		                                            <th rowspan="2" style="text-align:center; vertical-align: middle;"><?php echo $Total; ?></th>
		                                            <th width="4%" rowspan="2" style="text-align:center; display:none">Bonus<br>(Qty)</th>
		                                            <th width="3%" rowspan="2" style="text-align:cente; vertical-align: middle;r"><?php echo $Remarks ?></th>
		                                            <th width="3%" rowspan="2" style="text-align:center; vertical-align: middle;">QRC</th>
		                                      	</tr>
		                                        <tr style="background:#CCCCCC">
												...
												$sqlDET		= "SELECT A.IR_ID, A.PRJCODE, A.IR_NUM, A.IR_CODE, A.JOBCODEDET, A.JOBCODEID,
																	A.ACC_ID, A.PO_NUM, A.ITM_CODE, A.ITM_UNIT, A.ITM_QTY, A.ITM_QTY2, A.POD_ID,
																	A.ITM_QTY_BONUS, A.ITM_PRICE, A.ITM_TOTAL, A.ITM_DISP, 
																	A.ITM_DISC, A.NOTES, A.TAXCODE1, A.TAXCODE2, A.TAXPRICE1, 
																	A.TAXPRICE2, B.ITM_NAME, B.ACC_ID, B.ITM_GROUP,  A.CREATEQRC,
												...
												if($resultC > 0)
												{
													...
													foreach($result as $row) :
														...
														<td width="5%" nowrap style="text-align:right;">
		                                                	<?php print number_format($ITM_QTY2, $decFormat); ?>
		                                                    <input type="hidden" class="form-control" style="max-width:100px; text-align:right" name="ITM_QTY2<?php echo $currentRow; ?>" id="ITM_QTY2<?php echo $currentRow; ?>" value="<?php print number_format($ITM_QTY2, $decFormat); ?>" onBlur="changeValue(this, <?php echo $currentRow; ?>)" onKeyPress="return isIntOnlyNew(event);" size="4" >
														...
														<td width="7%" nowrap style="text-align:right; font-style:italic"> hidden                                                    <?php //print number_format($ITM_PRICE, $decFormat); ?>
															...
															<!-- Item Price -->												</td>
														<td width="7%" nowrap style="text-align:right; font-style:italic"> hidden
														...
														<td width="9%" nowrap style="text-align:right; font-style:italic"> hidden
															...
															<!-- Item Price Total --></td>
														<td width="4%" style="text-align:center; display:none">
		                                                	<?php
																if($ITM_QTY_BONUS == '')
																	$ITM_QTY_BONUS = 0;
														...
														<td width="3%" style="text-align:left">
															<?php echo $ITM_DESC; ?>
															<input type="hidden" name="data[<?php echo $currentRow; ?>][NOTES]" id="NOTES<?php echo $currentRow; ?>" value="<?php echo $ITM_DESC; ?>" ></td>
														</td>
														<td width="3%" style="text-align:center">
		                                                	<input type="checkbox" id="data<?php echo $currentRow; ?>crtQRC" onclick="crtQRC(<?php echo $currentRow; ?>)" <?php if($CREATEQRC == 1) { ?> checked <?php } ?> disabled >
...
<script>
  $(function () {
	...
	/*$('#crtQRC').on('ifChecked', function(event){
	  swal(event.type + ' callback');
	});*/
