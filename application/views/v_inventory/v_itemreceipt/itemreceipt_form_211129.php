		                        ...
		                        <div class="form-group">
		                          	...
		                          	<div class="col-sm-9">
		                                <div class="input-group">
		                                    ...
		                                    <input type="text" class="form-control" name="PO_NUM1" id="PO_NUM1" value="<?php echo $PO_CODE; ?>" onClick="pleaseCheck();" <?php if($editable == 0) { ?> disabled <?php } ?> style="display: none;">
	                            ...
	                            <table id="tbl" class="table table-bordered table-striped" width="100%">
									...
									if($task == 'add' && $PO_NUMX != '')
									{
										$sqlDETPO	= "SELECT A.PO_NUM, A.PO_CODE, A.PR_NUM, A.JOBCODEDET, A.JOBCODEID, A.ITM_CODE, 
															...
															B.ITM_NAME, B.ACC_ID, B.ITM_GROUP, B.ITM_CATEG,
											...
											<tr id="tr_<?php echo $currentRow; ?>" style="background-color: #red">
												...
												<td style="text-align:right; vertical-align: middle;">
													<?php if($IR_STAT == 1 || $IR_STAT == 4) { ?>
														<input type="text" class="form-control" style="text-align:right" name="ITM_QTYx<?php echo $currentRow; ?>" id="ITM_QTYx<?php echo $currentRow; ?>" value="<?php print number_format($ITM_QTY, $decFormat); ?>" onBlur="changeValue(this, <?php echo $currentRow; ?>)" onKeyPress="return isIntOnlyNew(event);" <?php if($isDisabled == 1) { ?> disabled <?php } ?> size="20" >
												...
												<td style="text-align:left; vertical-align: middle; font-style:italic">
													<?php if($IR_STAT == 1 || $IR_STAT == 4) { ?>
														<input type="text" name="data[<?php echo $currentRow; ?>][NOTES]" id="data<?php echo $currentRow; ?>NOTES" value="<?php echo $ITM_DESC; ?>" class="form-control" style="text-align:left" size="10">
													<?php } else { echo $ITM_DESC; } ?>
			                                            ...
			                                            <table id="examplex" class="table table-bordered table-striped table-responsive search-table inner" width="100%">
			                                                <thead>
			                                                    <tr>
							                                        ...
							                                        <th width="30%" nowrap style="text-align:center"><?php echo $SupplierName; ?></th>
							                                        <th width="48%" nowrap style="text-align:center"><span style="text-align:center;"><?php echo $Description; ?></span></th>
                                        							<th width="5%" nowrap style="text-align:center;"><span style="text-align:center"><?php echo $ReceivePlan; ?></span></th>
											                  	</tr>
			                                                </thead>
			                                                <tbody>
								                            <?php
							                                    ...
							                                    if($resPOC > 0)
							                                    {
							                                        ...
							                                        foreach($viewAllPOV as $row) :
								                                        ...
								                                        ?>
									                                        <td style="text-align:center"><input type="radio" name="chk0" value="<?php echo $PO_NUM;?>|<?php echo $PO_CODE;?>" onClick="pickThis0(this);" /></td>
								                                            <td nowrap>
	...
	function changeValue(thisVal, theRow)
	{
		...
		if(ITM_QTYx > REMAINQTY)
		{
			...
			else
			{
				...
				if(ITM_CATEG == 'MA')
				{
					MAXTOLERANCE 	= parseFloat(REMAINQTY) + parseFloat(REMAINQTY * 0.05);
		...
		if(TAXCODE1 == 0 || TAXCODE1 == '')
		{
        	...
        	itmTax		= parseFloat(TOT_ITMTEMP) * taxPerc;
