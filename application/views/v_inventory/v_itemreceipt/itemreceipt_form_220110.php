						...
						<div class="box box-primary">
							...
							<div class="box-body">
		                        ...
		                        <div class="form-group" style="display: none;">
		                          	...
		                          	<div class="col-sm-9">
		                                <input type="hidden" name="IR_NUM1" id="IR_NUM1" value="<?php echo $IR_NUM; ?>" class="form-control">
		                        ...
		                        <script type="text/javascript">
		                        	function refrDetil()
		                        	{
								    	...
								    	$('#tbl').DataTable(
								    	{
											...
											"filter": true,
									        "ajax": {
										        "url": "<?php echo site_url('c_inventory/c_ir180c15/get_AllDataIRDetAftCpy/?id='.$PRJCODE.'&collDt='.$collDt.'&task='.$task.'&PO_NUM=')?>"+PO_NUM,
										        "type": "POST",
										        "complete": function()
										        {
...
<script>
	...
	function changeValue(thisVal, theRow)
	{
		...
		console.log('ITM_QTYX = '+ITM_QTYX+' & ITM_QTYX = '+ITM_QTYX)
		...
		var collREM = IR_ID+'~'+IR_NUM+'~'+ITMVOL+'~'+ITMCOD+'~'+ITMREM+'~'+POVOLM;
		$.ajax({
            type: 'POST',
            url: "<?=$secUpVOL?>",
