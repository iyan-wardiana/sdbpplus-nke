    ...
    <section class="page sheet custom">
        ...
        <div class="cont">
            ...
            <div class="box-header-content">
                ...
                <span>TGL. : &nbsp;<?php echo date('d M Y', strtotime($IR_DATE)); ?></span>
            </div>
            <div class="box-notes">
                ...
                <div class="notes">
                    <ul class="dashed">
                        ...
                        <li>Pengadaan oleh Pusat, LPB sudah diserahkan/disampaikan (terlampir : surat jalan & dok. pendukungnya) ke Pusat/Cabang paling lambat (<b style="color: red;">4</b> hari : proyek dalam kota, <b style="color: red;">7</b> hari : proyek luar kota) terhitung sejak barang diterima</li>
                    </ul>
                </div>
                <div class="notes-nb">
                    <dd>
            ...
            <div class="box-detail-header">
                ...
                <div class="box-column-2">
                    ...
                    <span>Pilih dengan memberikan tanda <i class="fa fa-check"></i></span>
                    <span>
                        <label><input type="checkbox" name="SUPPLIER" id="SUPPLIER" checked /> SUPPLIER: &nbsp;</label>
                        <?php echo "$SPLDESC ($SPLCODE)"; ?>
                        <label style="display: none;"><input type="checkbox" name="GUDANG" id="GUDANG" /> GUDANG:</label>
                        <label style="display: none;"><input type="checkbox" name="PERALATAN" id="PERALATAN" /> PERALATAN:</label>
                    </span>
                </div>
            </div>
            <div class="box-detail-no">
                <div class="box-column-1">
                    ...
                    <span>(PENGADAAN: Proyek/Pusat<span style="color: red;">*</span>):</span>
                </div>
                <div class="box-column-2">
                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                        <tr>
