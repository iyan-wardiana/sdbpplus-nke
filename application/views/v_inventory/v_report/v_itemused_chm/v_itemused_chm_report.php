 ...
 * File Name	= v_itemused_chm_report.php
 * Location		= -
 */
...
<body class="hold-transition skin-blue sidebar-mini">
	<?php
		...
		if($PRJCODE != "'All'")
		{
			...
			endforeach;
			$ADDQRY1	= "A.proj_Code IN ('$PRJCODE') AND";
		}
		/*if($COLREFCUST != "'All'")
		...
		$GTOTPPH	= 0;
		$GTOTREM	= 0;
		$sqlTRX		= "tbl_itemhistory A
						WHERE $ADDQRY1
							A.Transaction_Date >= '$Start_Date' AND A.Transaction_Date <= '$End_Date'";
				...
				<div class="page">
					<table border="0" width="100%">
					    ...
					    <tr>
					        ...
					        <td nowrap width="15%">Hal : <?=$pageNo?></td>
					    </tr>
					...
					<table border="1" width="100%">
			        	<tr class="hcol1" style="border-top: double; border-bottom: double; line-height: 20px">
							...
							<td width="40%" nowrap style="text-align:center; font-weight:bold; border-left: hidden;">Jenis Obat</td>
							<td width="20%" nowrap style="text-align:center; font-weight:bold; border-left: hidden;">Quantity</td>
							<td width="20%" nowrap style="text-align:center; font-weight:bold; border-left: hidden; border-right: hidden;">Nominal</td>
				      	</tr>
				      	<?php
					      	for($i=0;$i<45;$i++)
				            {
										...
										<?php
											...
											$sqlTRX 		= "SELECT A.Item_Code, B.ITM_NAME, SUM(A.Qty_Min) AS TOT_OUT,
																...
																FROM tbl_itemhistory A
																	INNER JOIN tbl_item B ON B.ITM_CODE = A.Item_Code
																		AND B.PRJCODE = A.proj_Code
																WHERE $ADDQRY1
																	A.Transaction_Date >= '$Start_Date' AND A.Transaction_Date <= '$End_Date'
																	AND A.Transaction_Type IN ('STF','UM')
																 GROUP BY A.Item_Code ORDER BY B.ITM_NAME LIMIT $strQry, $maxRow";
