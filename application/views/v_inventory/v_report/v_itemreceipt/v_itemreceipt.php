...
<?php
	...
	if($LangID == 'IND')
	{
		...
		$alert2	= "Silahkan pilih salah satu materil.";
	}
	else
	{
		$alert1	= "Please select a project.";
		$alert2	= "Please select a material.";
	}
?>
    ...
    <div class="box box-primary"><br>
   	  <form method="post" name="frm" id="frm" action="<?php echo $form_action; ?>" onSubmit="return target_popup(this);" >
          <table width="100%">
            ...
            <tr id="projAll01">
                <td nowrap valign="top"><?php echo $ItemName ?></td>
                <td nowrap valign="top">:</td>
                <td width="14%" id="projAll02" nowrap>
                    <select multiple="multiple" class="options" size="10" name="pavailableCB" onclick="MoveOption(this.form.pavailableCB, this.form.packageelementsCB)" style="width:300px; max-width:350px; max-height:200px">
						<?php
                            $sqlITM	= "SELECT DISTINCT
											A.ITM_CODE, 
											A.ITM_NAME
										FROM tbl_item A
                ...
                <td width="72%" id="projAll03" nowrap>
                    <select multiple="multiple" name="packageelementsCB[]" id="packageelementsCB" size="10" ondblclick="MoveOption(this.form.packageelementsCB, this.form.pavailableCB)" style="width:300px; max-height:200px">
                    </select>               </td>
            </tr>
            <tr id="TransDate">
...
<script>
	...
	function target_popup(form)
	{
		...
		packageelementsCB	= document.getElementById('packageelementsCB').value;
		if(packageelementsCB == '')
		{
