					                ...
					                <?php
										if(isset($_POST['kata_kunci']))
										{
											...
											else
											{
												...
												/*$sqlSE	= "tbl_company WHERE
															COMP_CODE LIKE '%$search%' ESCAPE '!' OR COMP_NAME LIKE '%$search%' ESCAPE '!' 
															OR COMP_ADD LIKE '%$search%' ESCAPE '!' OR COMP_STATE LIKE '%$search%' ESCAPE '!'
															OR COMP_PROV LIKE '%$search%' ESCAPE '!' OR COMP_CITY LIKE '%$search%' ESCAPE '!'
															OR COMP_MAIL LIKE '%$search%' ESCAPE '!' OR COMP_CP LIKE '%$search%' ESCAPE '!'
															OR COMP_PHONE LIKE '%$search%' ESCAPE '!' OR COMP_NEWS1 LIKE '%$search%' ESCAPE '!'
															OR COMP_NEWS2 LIKE '%$search%' ESCAPE '!' OR COMP_NEWS3 LIKE '%$search%' ESCAPE '!'";*/
												//$resSE	= $this->db->count_all($sqlSE);
												//echo "resSE = $resSE";
