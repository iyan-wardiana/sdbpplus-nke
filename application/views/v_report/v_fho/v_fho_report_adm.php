...
<section class="content">
    ...
    <tr>
        ...
        <td colspan="2" class="style2" style="text-align:center; font-weight:bold; text-transform:uppercase; font-size:12px">Print Out FHO <span class="style2" style="text-align:center; font-weight:bold; text-transform:uppercase; font-size:12px">(ADMIN)</span></td>
  </tr>
    <tr>
        ...
        <td colspan="3" class="style2">
            <table width="100%" border="1" rules="all">
                <tr style="background:#CCCCCC">
                  ...
                  <td rowspan="2" width="12%" nowrap style="text-align:center; font-weight:bold">Nomor FHO</td>
                  <td rowspan="2" width="12%" nowrap style="text-align:center; font-weight:bold">Tanggal FHO</td>
                  <td rowspan="2" width="18%" nowrap style="text-align:center; font-weight:bold">Nilai FHO</td>
                ...
                <?php					
                    ...
                    if($viewProj == 0)	// PER PROJECT
                    {
						$sqlq1 			= "SELECT * FROM tbl_hrdoc_header
											WHERE PRJCODE IN ($PRJCODECOL) AND DOCCODE='D02415' AND $TYPE1 ORDER BY HRDOCNO";
													
                        $resq1 			= $this->db->query($sqlq1)->result();
                    }
                    else
                    {
						$sqlq1 			= "SELECT * FROM tbl_hrdoc_header WHERE DOCCODE='D02415' AND  $TYPE1 ORDER BY HRDOCNO";
