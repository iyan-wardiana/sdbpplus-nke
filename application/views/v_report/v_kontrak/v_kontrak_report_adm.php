 ...
 * File Name	= v_kontrak_report.php
 * Location		= -
*/
if($viewType == 1)
{
...
<section class="content">
    ...
    <tr>
        ...
        <td colspan="2" class="style2" style="text-align:center; font-weight:bold; text-transform:uppercase; font-size:12px">Print Out Kontrak <span class="style2" style="text-align:center; font-weight:bold; text-transform:uppercase; font-size:12px">(ADMIN)</span></td>
  </tr>
    <tr>
        ...
        <td colspan="3" class="style2">
            <table width="100%" border="1" rules="all">
                <tr style="background:#CCCCCC">
                  ...
                  <td rowspan="2" width="12%" nowrap style="text-align:center; font-weight:bold">Nomor Kontrak</td>
                  <td rowspan="2" width="12%" nowrap style="text-align:center; font-weight:bold">Tanggal Kontrak</td>
                  <td rowspan="2" width="18%" nowrap style="text-align:center; font-weight:bold">Nilai Kontrak</td>
                ...
                <?php					
                    ...
                    if($viewProj == 0)	// PER PROJECT
                    {
						$sqlq1 			= "SELECT * FROM tbl_hrdoc_header
											WHERE PRJCODE IN ($PRJCODECOL) AND DOCCODE='D02411' AND $TYPE1 ORDER BY HRDOCNO";
													
                        $resq1 			= $this->db->query($sqlq1)->result();
                    }
                    else
                    {
						$sqlq1 			= "SELECT * FROM tbl_hrdoc_header WHERE DOCCODE='D02411' AND  $TYPE1 ORDER BY HRDOCNO";
