...
<section class="content">
    ...
    <tr>
        ...
        <td colspan="2" class="style2" style="text-align:center; font-weight:bold; text-transform:uppercase; font-size:12px">Print Out SPK (ADMIN)</td>
  </tr>
    <tr>
        ...
        <td colspan="3" class="style2">
            <table width="100%" border="1" rules="all">
                <tr style="background:#CCCCCC">
                  ...
                  <td rowspan="2" width="12%" nowrap style="text-align:center; font-weight:bold">Nomor SPK</td>
                  <td rowspan="2" width="12%" nowrap style="text-align:center; font-weight:bold">Tanggal SPK</td>
                  <td rowspan="2" width="18%" nowrap style="text-align:center; font-weight:bold">Nilai SPK</td>
