...
/* 
 	...
 	* Create Date	= 04 Desember 2021
 	* File Name		= project_list_set_ho.php
 	* Location		= -
*/
...
$sqlPL 		= "SELECT proj_Number, PRJCODE, PRJNAME
				FROM tbl_project WHERE PRJLEV = 0 ORDER BY PRJNAME";
            ...
            <div class="box">
                <div class="box-body">
                        ...
                        <table id="example" class="table table-bordered table-striped table-responsive search-table inner" width="100%">
                            <thead>
                                <tr>
									...
									<th width="35%" style="text-align:center; vertical-align:middle"><?php echo $BudName ?> </th>
									<th width="50%" style="text-align:center; vertical-align:middle"><?php echo $Remarks ?> </th>
					...
					<?php
						if($ISCREATE == 1)
						{
                        	$url_add 	= site_url('c_comprof/c_bUd93tL15t/addHO/?id='.$this->url_encryption_helper->encode_url($PRJCODE));
...
<script>
	$(document).ready(function()
	{
		...
		"autoWidth": true,
		"filter": true,
        "ajax": "<?php echo site_url('c_project/lst180c2hprj/get_AllDataHOFFICE/?id='.$secURL)?>",
        "type": "POST",
