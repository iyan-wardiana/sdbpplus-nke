...
/* 
 	...
 	* File Name		= project_list_news.php
 	* Location		= -
*/
...
<html>
    ...
    <body class="<?php echo $appBody; ?>" style="background-color: <?=$comp_color?>">
      	<section class="content-header">
        	<h1>
            <img src="<?php echo base_url() . 'assets/AdminLTE-2.0.5/dist/img/icon/project.png'; ?>" style="max-width:40px; max-height:40px" >&nbsp;&nbsp;<?php echo $CompList; ?>
                        ...
                        <table id="example" class="table table-bordered table-striped table-hover table-responsive search-table inner" width="100%">
                            <thead>
                                <tr>
									...
									<th width="15%" style="text-align:center; vertical-align:middle" nowrap>Status</th>
									<th width="25%" style="text-align:center; vertical-align:middle">Progress</th>
                                </tr>
                            </thead>
                            <tbody>
                            </tbody>
...
<script>
    ...
    $('#example').DataTable( {
		...
		"autoWidth": true,
		"filter": true,
        "ajax": "<?php echo site_url('c_project/lst180c2hprj/get_AllDataPRJ_news/?id='.$secURL.'&mnCode='.$mn_Code.'&MenuApp='.$mn_App.'&jrnCat='.$jrn_Cat)?>",
        "type": "POST",
