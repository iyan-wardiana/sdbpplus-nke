...
<html>
    ...
    <body class="<?php echo $appBody; ?>" style="background-color: <?=$comp_color?>">
      	<section class="content-header">
			<h1>
				<img src="<?php echo base_url() . 'assets/AdminLTE-2.0.5/dist/img/icon/wbs.png'; ?>" style="max-width:40px; max-height:40px" >&nbsp;&nbsp;<?php echo $BudList; ?>
...
<script>
    ...
    $('#example').DataTable( {
		...
		"autoWidth": true,
		"filter": true,
        "ajax": "<?php echo site_url('c_project/lst180c2hprj/get_AllDataPRJ/?id='.$secURL.'&mnCode='.$mn_Code.'&MenuApp='.$mn_App.'&jrnCat='.$jrn_Cat.'&jrnType='.$jrnType.'&SPPCAT='.$SPPCAT)?>",
        "type": "POST",
