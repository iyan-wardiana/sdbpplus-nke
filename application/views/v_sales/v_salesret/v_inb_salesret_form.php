...
<html>
	...
	<?php
		...
		if($LangID == 'IND')
		{
			$alert1		= 'Item yang dikembalikan tidak boleh kosong.';
			$alert2		= 'Silahkan pilih nama pelanggan.';
			$alert3		= 'Silahkan pilih kode pengiriman.';
			$alert4		= 'Jumlah pengembalian lebih besar dari jumlah yang dikirim.';
			$alert5		= 'Silahkan pilih status pengembalian.';
			$alert6		= "Silahkan tulis alasan revisi dokumen.";
			$alert7		= "Catatan persetujuan tidak boleh kosong.";
			$isManual	= "Centang untuk kode manual.";
		}
		else
		{
			$alert1		= 'Returned items cannot be empty.';
			$alert2		= 'Please select a customer name.';
			$alert3		= 'Please select a shipment code.';
			$alert4		= 'Return qty is greater than shipment qty.';
			$alert5		= 'Please select return status.';
			$alert6		= "lease write the document note.";
    ...
    <body class="<?php echo $appBody; ?>" style="background-color: <?=$comp_color?>">
		<section class="content-header">
			<h1>
			    <img src="<?php echo base_url() . 'assets/AdminLTE-2.0.5/dist/img/icon/salesreturn.png'; ?>" style="max-width:40px; max-height:40px" >&nbsp;&nbsp;<?php echo $mnName; ?>
							...
							<div class="box-body">
				                ...
				                <!-- SR_NUM, SR_CODE -->
					            	<div class="form-group">
					                    ...
					                    <div class="col-sm-9">
				                            ...
				                            <input type="text" class="form-control" style="min-width:width:150px;" name="SR_CODE" id="SR_CODE" value="<?php echo $SR_CODE; ?>" readonly >
					                    </div>
					                </div>
					                ...
					                <div class="form-group">
					                    ...
					                    <div class="col-sm-9">
					                        <div class="input-group date">
					                            ...
					                            <input type="text" name="SR_DATE1" class="form-control pull-left" id="datepicker1" value="<?php echo $SR_DATE; ?>" style="width:105px" disabled>
					                            <input type="hidden" class="form-control" name="SR_DATE" id="SR_DATE" value="<?php echo $SR_DATE; ?>" >
					                        </div>
					                    </div>
					                </div>
				                ...
				                <!-- CUST_CODE -->
					                <div class="form-group">
					                    ...
					                    <div class="col-sm-9">
					                        <select name="CUST_CODE1" id="CUST_CODE1" class="form-control select2" disabled>
				                ...
				                <!-- SR_TYPE -->
					                <div class="form-group">
					                  <label for="inputName" class="col-sm-3 control-label"><?php echo $Reason ?> </label>
					                    <div class="col-sm-9">
					                        <select name="SR_TYPE1" id="SR_TYPE1" class="form-control select2" disabled>
					                        ...
					                        <input type="hidden" class="form-control" name="SR_TYPE" id="SR_TYPE" value="<?php echo $SR_TYPE; ?>" >
					                    </div>
					                </div>
					        </div>
					    </div>
					...
					<div class="col-md-6">
						<div class="box box-warning">
							...
							<div class="box-body">
				                <!-- SR_NOTES -->
					                <div class="form-group">
					                    <label for="inputName" class="col-sm-3 control-label"><?php echo $Notes ?> / <?php echo $ApproverNotes ?> </label>
					                    <div class="col-sm-5">
					                        <textarea class="form-control" name="SR_NOTES"  id="SR_NOTES" style="height:85px" disabled><?php echo $SR_NOTES; ?></textarea>
					                        <input type="hidden" name="SR_TOTCOST" id="SR_TOTCOST" value="<?php echo $SR_TOTCOST; ?>">
					                    </div>
					                    <div class="col-sm-4">
					                        <textarea class="form-control" name="SR_NOTES1"  id="SR_NOTES1" style="height:85px"><?php echo $SR_NOTES1; ?></textarea>
					                    </div>
					                </div>
					                ...
					                <div class="form-group" >
					                    ...
					                    <div class="col-sm-9">
					                        <input type="hidden" name="STAT_BEFORE" id="STAT_BEFORE" value="<?php echo $SR_STAT; ?>">
					                            <input type="hidden" name="SR_STATx" id="SR_STATx" value="<?php echo $SR_STAT; ?>">
					                            <?php
					                                // START : FOR ALL APPROVAL FUNCTION
					                                    if($disableAll == 0)
					                                    {
					                                        ...
					                                        {
					                                            $disButton	= 0;
					                                            $sqlCAPPHE	= "tbl_approve_hist WHERE AH_CODE = '$SR_NUM' AND AH_APPROVER = '$DefEmp_ID'";
					                                            $resCAPPHE	= $this->db->count_all($sqlCAPPHE);
					                                            if($resCAPPHE > 0)
					                                                $disButton	= 1;
					                                            ?>
					                                                <select name="SR_STAT" id="SR_STAT" class="form-control select2" <?php if($disButton == 1) { ?> disabled <?php } ?> >
					                                                    <option value="0"> --- </option>
					                                                    <option value="3"<?php if($SR_STAT == 3) { ?> selected <?php } ?>>Approved</option>
					                                                    <option value="4"<?php if($SR_STAT == 4) { ?> selected <?php } ?>>Revised</option>
					                                                    <option value="5"<?php if($SR_STAT == 5) { ?> selected <?php } ?>>Rejected</option>
					                                                    <!-- <option value="6"<?php if($SR_STAT == 6) { ?> selected <?php } ?>>Closed</option> -->
					                                                    <option value="7"<?php if($SR_STAT == 7) { ?> selected <?php } ?> disabled>Awaiting</option>
					                                                </select>
					                                            <?php
					                                        }
					                                        else
                    ...
                    <div class="col-md-12">
			                                    	...
			                                    	?>
				                                        <tr id="trQRC_<?php echo $currRow; ?>">
				                                            ...
				                                            <td width="8%" style="text-align:right">
				                                                <?php echo number_format($QRC_VOLM_RET, 2); ?>
		                ...
		                <div class="form-group">
		                    <div class="col-sm-offset-2 col-sm-10">
		                        <?php
		                        	if(($SR_STAT == 2 || $SR_STAT == 7) && $ISAPPROVE == 1)
									{
										?>
...
<script>
	...
	function checkInp()
	{
		var SR_NOTES1 = document.getElementById('SR_NOTES1').value;
		if(SR_NOTES1 == '')
		{
			...
			.then(function()
			{
				document.getElementById('SR_NOTES1').focus();
			});
			return false;	
		}

		SR_STAT		= document.getElementById('SR_STAT').value;
		if(SR_STAT == 0)
		{
			...
			document.getElementById('SR_STAT').focus();
			return false;	
		}
	}
</script>
