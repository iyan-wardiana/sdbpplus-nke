                ...
                <div class="box-body">
                    <div class="search-table-outter">
                          <table id="example" class="table table-bordered table-striped" width="100%">
                            <thead>
                                <tr>
                                    <th width="1%" style="vertical-align:middle; text-align:center">&nbsp;</th>
                                    ...
                                    <th width="25%" style="vertical-align:middle; text-align:center"><?php echo $CustName  ?> </th>
                                    <th width="30%" style="vertical-align:middle; text-align:center"><?php echo $Notes ?> </th> 
                                    <th width="8%" style="vertical-align:middle; text-align:center"><?php echo $SOCode ?> </th>
                                    <th width="8%" style="vertical-align:middle; text-align:center"><?php echo $ShipmentNo ?> </th>                  
                            ...
                            <tr>
                              	<td colspan="9">
                                    <?php
            							$url_add 	= site_url('c_sales/c_r3tu7N/a44_sr3tu7N/?id='.$this->url_encryption_helper->encode_url($PRJCODE));
...
<script>
    ...
    $('#example').DataTable( {
		...
		"autoWidth": true,
		"filter": true,
        "ajax": "<?php echo site_url('c_sales/c_r3tu7N/get_AllData/?id='.$PRJCODE)?>",
        "type": "POST",
		//"lengthMenu": [[10, 25, 50, 100, 200, -1], [10, 25, 50, 100, 200, "All"]],
		"lengthMenu": [[10, 25, 50, 100, 200], [10, 25, 50, 100, 200]],
		"columnDefs": [	{ targets: [1,5,7], className: 'dt-body-center' },
