			                ...
			                <div class="box-body chart-responsive">   
			                    ...
			                    <form class="form-horizontal" name="frm" id="frm" method="post" action="<?php echo $form_action; ?>" onSubmit="return checkInp()">
			                        ...
			                        <div class="form-group"> <!-- CUST_ADDRESS -->
			                          	<label for="inputName" class="col-sm-2 control-label"><?php echo $AdditAddress ?> </label>
			                          	<div class="col-sm-10">
			                        ...
			                        <div class="form-group"> <!-- CCAL_NUM, CCAL_CODE, BOM_CODE -->
			                          	<label for="inputName" class="col-sm-2 control-label"><?php echo $MatchCode ?> </label>
			                          	<div class="col-sm-10">
			                        ...
			                        <div class="form-group">
			                          	...
			                          	<div class="col-sm-10">
			                                <textarea class="form-control" name="OFF_NOTES1"  id="OFF_NOTES1" style="height:70px" placeholder="<?php echo $ApproverNotes; ?>"><?php echo $OFF_NOTES1; ?></textarea>
			                          	</div>
			                        </div>
			                        <!--
			                        	APPROVE STATUS
													...
													if($disableAll == 0)
													{
														if($canApprove == 1)
														{
															...
															if($resCAPPHE > 0)
																$disButton	= 1;
															?>
																<select name="OFF_STAT" id="OFF_STAT" class="form-control select2" style="max-width:120px" <?php if($disButton == 1) { ?> disabled <?php } ?> >
																	...
																	<option value="7"<?php if($OFF_STAT == 7) { ?> selected <?php } ?> style="display:none">Awaiting</option>
																</select>
															<?php
														}
														else
			                            ...
			                            <div class="col-md-12">
			                                ...
			                                <table width="100%" border="1" id="tbl">
			                                    <tr style="background:#CCCCCC">
			                                      ...
			                                      <th width="8%" style="text-align:center" nowrap><?php echo $ItemCode; ?> </th>
			                                      <th width="38%" style="text-align:center" nowrap><?php echo $ItemName; ?> </th>
			                                      <th width="7%" style="text-align:center" nowrap><?php echo $Quantity; ?> </th> 
			                              			<!-- Input Manual -->
			                                        <th width="4%" style="text-align:center" nowrap><?php echo $Unit; ?> </th>
			                                      <th width="9%" style="text-align:center" nowrap><?php echo $UnitPrice; ?> </th>
			                                      <th width="7%" style="text-align:center" nowrap><?php echo $Discount; ?><br>
			                                      (%)</th>
			                                      <th width="8%" style="text-align:center" nowrap><?php echo $Discount; ?> </th>
			                                      <th width="2%" style="text-align:center; display:none" nowrap><?php echo $Tax; ?></th>
			                                      <th width="13%" style="text-align:center" nowrap><?php echo $Price; ?></th>
			                                  </tr>
			                                    <?php
													$resultC	= 0;
													if($task == 'edit')
													...
													if($resultC > 0)
													{
			                                            ...
			                                            <tr id="tr_<?php echo $currentRow; ?>">
			                                                ...
			                                                <!-- ITEM NAME -->
															<td width="38%" style="text-align:left"><?php echo $ITM_NAME; ?></td>
															...
															<!-- ITEM TAX -->
															<td width="2%" style="text-align:left; display:none">
			                                                	&nbsp;
