...
<html>
	...
	<?php
		...
		if($LangID == 'IND')
		{
			...
			$alert4		= "Catatan persetujuan tidak boleh kosong.";
		...
		else
		{
			...
			$alert4		= "Approval note can not be empty.";
						...
						<div class="box box-primary">
							...
							<div class="box-body">
		                        ...
		                        <div class="form-group">
		                          	...
		                          	<div class="col-sm-9">
		                                    <input type="text" class="form-control" name="SO_CODE1" id="SO_CODE1" value="<?php echo $SO_CODE; ?>" disabled >
		                        ...
		                        <div class="form-group">
		                          	...
		                          	<div class="col-sm-4">
		                                <div class="input-group date">
		                                    ...
		                                    <input type="text" name="SO_DATE1" class="form-control pull-left" id="datepicker1" value="<?php echo $SO_DATE; ?>" style="width:107px" disabled>
		                                	<input type="hidden" name="SO_DATE" class="form-control pull-left" id="SO_DATE" value="<?php echo $SO_DATE; ?>" style="width:150px">
		                                </div>
		                          	</div>
		                          	<div class="col-sm-5">
		                                <select name="SO_CATX" id="SO_CATX" class="form-control select2" disabled>
		                                ...
		                                <input type="hidden" name="SO_CAT" class="form-control pull-left" id="SO_CAT" value="<?php echo $SO_CAT; ?>">
		                          	</div>
		                        </div>
		                        <script>
										...
										$(".tombol-date").click(function()
										{
											...
											$.ajax({
												...
												success: function(response)
												{
													...
													document.getElementById('SO_NUM1').value 	= myarr[0];
													document.getElementById('SO_NUM').value 	= myarr[0];
													document.getElementById('SO_CODE').value 	= myarr[1];
												}
											});
										});
									});
								...
								<?php
									...
									$url_selPR_CODE		= site_url('c_sales/c_s4l350r4/popupallPR/?id='.$this->url_encryption_helper->encode_url($PRJCODE));
		                        ?>
		                        <script>
		                        ...
		                        <div class="form-group">
		                          	...
		                          	<div class="col-sm-9">
		                            	<select name="CUST_CODE1" id="CUST_CODE1" class="form-control" onChange="getVendName(this.value)" disabled>
		                                ...
		                                <input type="hidden" name="CUST_CODE" class="form-control pull-left" id="CUST_CODE" value="<?php echo $CUST_CODE; ?>" style="width:150px">
		                          	</div>
		                        </div>
		                        <div class="form-group">
		                          	<label for="inputName" class="col-sm-3 control-label"><?php echo $AdditAddress ?> </label>
		                          	<div class="col-sm-9">
		                                <textarea class="form-control" name="CUST_ADDRESS1"  id="CUST_ADDRESS1" style="height:100px" placeholder="<?php echo $AdditAddress; ?>" disabled><?php echo $CUST_ADDRESS; ?></textarea>
		                        ...
		                        <div class="form-group" style="display:none">
		                          	...
		                          	<div class="col-sm-9">
		                            	<select name="SO_CURR" id="SO_CURR" class="form-control" style="max-width:75px" disabled>
		                        ...
		                        <div class="form-group">
		                       	  <label for="inputName" class="col-sm-3 control-label"><?php echo $PaymentType ?> </label>
		                          	<div class="col-sm-4">
	                                    <select name="SO_PAYTYPE1" id="SO_PAYTYPE1" class="form-control" onChange="selSO_PAYTYPE(this.value)" disabled>
	                                        <option value="1" <?php if($SO_PAYTYPE == 1) { ?> selected="selected" <?php } ?>>Cash</option>
	                                        <option value="2" <?php if($SO_PAYTYPE == 2) { ?> selected="selected" <?php } ?>>Credit</option>
	                                    </select>
	                                </div>
		                          	<div class="col-sm-5">
	                                    <select name="SO_TENOR1" id="SO_TENOR1" class="form-control" onChange="selSO_TENOR(this.value)" disabled>
	                                        <option value="0" <?php if($SO_TENOR == 0) { ?> selected <?php } ?>>Cash</option>
		                                ...
		                                <input type="hidden" name="SO_PAYTYPE" class="form-control pull-left" id="SO_PAYTYPE" value="<?php echo $SO_PAYTYPE; ?>" style="width:150px">
		                                <input type="hidden" name="SO_TENOR" class="form-control pull-left" id="SO_TENOR" value="<?php echo $SO_TENOR; ?>" style="width:150px">
		                        	</div>
		                        </div>
		                        <script>
							...
							<div class="box-body">
		                        <div class="form-group">
		                          	...
		                          	<div class="col-sm-9">
		                                <div class="input-group date">
		                                    <div class="input-group-addon"><i class="fa fa-calendar"></i>&nbsp;</div>
		                                    <input type="text" name="SO_PRODD1" class="form-control pull-left" id="datepicker2" value="<?php echo $SO_PRODD; ?>" style="width:107px" disabled>
		                                	<input type="hidden" name="SO_PRODD" class="form-control pull-left" id="SO_PRODD" value="<?php echo $SO_PRODD; ?>" style="width:107px">
		                                </div>
		                          	</div>
		                        </div>
		                        <div class="form-group">
		                            ...
		                            <div class="col-sm-9">
		                                <input type="text" class="form-control" name="SO_REFRENS1" id="SO_REFRENS1" size="30" value="<?php echo $SO_REFRENS; ?>" placeholder="<?php echo $RefNumber; ?>" disabled />
		                                <input type="hidden" name="SO_REFRENS" class="form-control pull-left" id="SO_REFRENS" value="<?php echo $SO_REFRENS; ?>" style="width:150px">
		                            </div>
		                        </div>
		                        <div class="form-group">
		                          	<label for="inputName" class="col-sm-3 control-label"><?php echo $Notes ?> </label>
		                          	<div class="col-sm-9">
		                                <textarea class="form-control" name="SO_NOTESX"  id="SO_NOTESX" style="height:70px" placeholder="<?php echo $Notes; ?>" disabled><?php echo $SO_NOTES; ?></textarea>
		                                <textarea class="form-control" name="SO_NOTES"  id="SO_NOTES" style="height:70px;display:none" placeholder="<?php echo $Notes; ?>"><?php echo $SO_NOTES; ?></textarea>
		                        ...
		                        <div class="form-group">
		                          	...
		                          	<div class="col-sm-9">
		                                <textarea class="form-control" name="SO_NOTES1"  id="SO_NOTES1" style="height:70px" placeholder="<?php echo $ApproverNotes; ?>"><?php echo $SO_NOTES1; ?></textarea>
		                          	</div>
		                        </div>
		                        <!--
		                        	APPROVE STATUS
		                                ...
		                                <?php
		                                    // START : FOR ALL APPROVAL FUNCTION
		                                        if($disableAll == 0)
		                                        {
		                                            ...
		                                            {
		                                                $disButton	= 0;
		                                                $sqlCAPPHE	= "tbl_approve_hist WHERE AH_CODE = '$SO_NUM' AND AH_APPROVER = '$DefEmp_ID'";
		                                                $resCAPPHE	= $this->db->count_all($sqlCAPPHE);
		                                                if($resCAPPHE > 0)
		                                                    $disButton	= 1;
		                                                ?>
		                                                    <select name="SO_STAT" id="SO_STAT" class="form-control select2" <?php if($disButton == 1) { ?> disabled <?php } ?> >
		                                                        <option value="0"> --- </option>
		                                                        <option value="3"<?php if($SO_STAT == 3) { ?> selected <?php } ?>>Approved</option>
		                                                        <option value="4"<?php if($SO_STAT == 4) { ?> selected <?php } ?>>Revised</option>
		                                                        <option value="5"<?php if($SO_STAT == 5) { ?> selected <?php } ?>>Rejected</option>
		                                                        <!-- <option value="6"<?php if($SO_STAT == 6) { ?> selected <?php } ?> style="display:none">Closed</option> -->
		                                                        <option value="7"<?php if($SO_STAT == 7) { ?> selected <?php } ?> disabled>Awaiting</option>
		                                                    </select>
		                                                <?php
		                                            }
		                                            else
                                    ...
                                    <?php
										...
										if($resultC > 0)
										{
											...
											foreach($result as $row) :
												...
												$JOBDESCH		= "";
												$sqlJOBDESC		= "SELECT JOBDESC, JOBDESC FROM tbl_joblist
																	WHERE JOBCODEID = (SELECT JOBPARENT FROM tbl_joblist
                                            ...
                                            <tr>
												...
												<td style="text-align:left; vertical-align: middle;">
													<?php echo $ITM_NAME; ?>
												  	...
												  	<div style="font-style: italic;">
												  		<i class='text-muted fa fa-rss'></i>&nbsp;&nbsp;<?php echo $JobView; ?>
												</td>
                                                
											  	<!-- ITEM ORDER NOW -->  
											  	<td style="text-align:right; vertical-align: middle;">
											  		<?php echo number_format($SO_VOLM, $decFormat); ?>
                                                	<input type="hidden" class="form-control" style="max-width:200px; text-align:right" name="SO_VOLM<?php echo $currentRow; ?>" id="SO_VOLM<?php echo $currentRow; ?>" value="<?php echo number_format($SO_VOLM, 2); ?>" onKeyPress="return isIntOnlyNew(event);" onBlur="getValueSO(this, <?php echo $currentRow; ?>);" disabled >
                                                ...
                                                <!-- ITEM PRICE -->
											  	<td style="text-align:right; vertical-align: middle;">
											  		<?php echo number_format($SO_PRICE, $decFormat); ?>
                                                	<input type="hidden" class="form-control" style="text-align:right; min-width:100px" name="SO_PRICE<?php echo $currentRow; ?>" id="SO_PRICE<?php echo $currentRow; ?>" size="10" value="<?php echo number_format($SO_PRICE, 2); ?>" onKeyPress="return isIntOnlyNew(event);" onBlur="getValueSO(this, <?php echo $currentRow; ?>);" disabled>
                                                ...
                                                <!-- ITEM DISCOUNT PERCENTATION -->
											  	<td style="text-align:right; vertical-align: middle;">
											  		<?php echo number_format($SO_DISP, $decFormat); ?>
													<input type="hidden" class="form-control" size="10"  style=" min-width:65px; max-width:150px; text-align:right" name="SO_DISP<?php echo $currentRow; ?>" id="SO_DISP<?php echo $currentRow; ?>" value="<?php print number_format($SO_DISP, $decFormat); ?>" onBlur="countDisp(this, <?php echo $currentRow; ?>);" disabled >
												...
												<!-- ITEM DISCOUNT -->
											  	<td style="text-align:right; vertical-align: middle;">
											  		<?php echo number_format($SO_DISC, $decFormat); ?>
													<input type="hidden" class="form-control" style="min-width:100px; max-width:350px; text-align:right" name="SO_DISC<?php echo $currentRow; ?>" id="SO_DISC<?php echo $currentRow; ?>" value="<?php print number_format($SO_DISC, $decFormat); ?>" onBlur="countDisc(this, <?php echo $currentRow; ?>);" disabled >
												...
												<!-- ITEM TAX -->
											  	<td style="text-align:center; vertical-align: middle;">
	                                                	...
	                                                	else
	                                                	{
                                               	  	...
                                               	  	?>
													<input type="hidden" name="data[<?php echo $currentRow; ?>][TAXCODE1]" id="data<?php echo $currentRow; ?>TAXCODE1" value="<?php echo $TAXCODE1; ?>">
                                               	</td>
                                                
											  	<!-- ITEM TOTAL COST -->
											  	<td style="text-align:right; vertical-align: middle;">
											  		<?php echo number_format($SO_COST, $decFormat); ?>
                                           	    	<input type="hidden" class="form-control" style="min-width:130px; max-width:350px; text-align:right" name="SO_COST<?php echo $currentRow; ?>" id="SO_COST<?php echo $currentRow; ?>" value="<?php print number_format($SO_COST, $decFormat); ?>" disabled>
								...
								<label for="inputName" class="col-sm-3 control-label">&nbsp;</label>
	                          	<div class="col-sm-9">
	                            	<?php
	                                    if($disableAll == 0)
	                                    {
	                                        if(($SO_STAT == 2 || $SO_STAT == 7) && $canApprove == 1)
	                                        {
	                                            ?>
	                                    ...
	                                    $backURL	= site_url('c_sales/c_s4l350r4/gls0iN2_0x/?id='.$this->url_encryption_helper->encode_url($PRJCODE));
...
<script>
  $(function () {
	...
	function checkInp()
	{
		...
		SO_NOTES1	= document.getElementById('SO_NOTES1').value;
		SO_STAT		= document.getElementById('SO_STAT').value;
		...
		if(SO_NOTES1 == '')
		{
			...
			.then(function()
			{
				document.getElementById('SO_NOTES1').focus();
			});
			return false;	
		}
		...
		if(SO_STAT == 0)
		{
			...
			document.getElementById('SO_STAT').focus();
			return false;	
		}
	}
	...
	function add_item(strItem) 
	{
		...
		ITM_CODE 		= arrItem[1];
		ITM_NAME 		= arrItem[2];
		serialNumber	= arrItem[3];
		ITM_UNIT 		= arrItem[4];
		ITM_PRICE 		= arrItem[5];
		ITM_VOLM		= arrItem[6];
		ITM_USED 		= arrItem[7];
		itemConvertion	= arrItem[8];
		ITM_AMOUNT 		= arrItem[9];
		ITM_BUDG 		= arrItem[10];
		SO_COST			= 0;
		...
		objTD = objTR.insertCell(objTR.cells.length);
		objTD.style.textAlign = 'right';
		objTD.innerHTML = '<input type="text" class="form-control" style="min-width:130px; max-width:350px; text-align:right" name="SO_COST'+intIndex+'" id="SO_COST'+intIndex+'" value="0.00" ><input style="text-align:right" type="hidden" name="data['+intIndex+'][SO_COST]" id="data'+intIndex+'SO_COST" value="0"><input style="text-align:right" type="hidden" name="data['+intIndex+'][TAXPRICE1]" id="data'+intIndex+'TAXPRICE1" value="0"><input type="hidden" name="totalrow" id="totalrow" value="'+intIndex+'">';
