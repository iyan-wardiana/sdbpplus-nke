						...
						<div class="box box-primary">
							...
							<div class="box-body">
		                        ...
		                        <?php } ?>
			                        ...
			                        <div class="form-group">
			                          	<label for="inputName" class="col-sm-3 control-label"><?php echo $Customer ?> </label>
			                          	<div class="col-sm-9">
	                            ...
	                            <table id="tbl" class="table table-bordered table-striped" width="100%">
                                    <tr style="background:#CCCCCC">
                                        ...
                                        <th width="5%" style="text-align:center; vertical-align: middle;" nowrap><?php echo $Unit; ?> </th>
                                      	...
                                      	<th width="5%" style="text-align:center; vertical-align: middle;" nowrap> Disc. (%)</th>
                                    ...
                                    <?php
										...
										if($task == 'add' && $OFF_NUMX != '')
										{
											$sqlDETPO	= "SELECT A.OFF_NUM, A.OFF_CODE, A.BOM_CODE, A.ITM_CODE, A.CCAL_NUM,
																A.ITM_UNIT, A.OFF_VOLM AS SO_VOLM, A.OFF_PRICE AS SO_PRICE,  A.OFF_PRICE AS ITM_PRICE, 
																...
																B.ITM_NAME, B.ITM_GROUP, '' AS JOBCODEID
										...
										if($resultC > 0)
										{
											...
											foreach($result as $row) :
												...
												$CCAL_NAME 		= '';
												$sqlCOLNM 		= "SELECT CCAL_NAME FROM tbl_ccal_header
																	WHERE CCAL_NUM = '$CCAL_NUM' LIMIT 1";
                                            ...
                                            <tr id="tr_<?php echo $currentRow; ?>">
                                                ...
                                                <!-- ITEM PRICE -->
											  	<td style="text-align:right; vertical-align: middle;">
                                                    ...
                                                    <input type="hidden" style="text-align:right" name="data[<?php echo $currentRow; ?>][ITM_PRICE]" id="data<?php echo $currentRow; ?>ITM_PRICE" size="6" value="<?php echo $ITM_PRICE; ?>">
...
<script>
	...
	function add_item(strItem) 
	{
		...
		objTD = objTR.insertCell(objTR.cells.length);
		objTD.style.textAlign = 'right';
		objTD.innerHTML = '<select name="data['+intIndex+'][TAXCODE1]" id="data'+intIndex+'TAXCODE1" class="form-control" style="max-width:150px" onChange="getTax(this, '+intIndex+');"><option value=""> --- </option><option value="TAX01">PPn 10%</option><option value="TAX02">PPh 3%</option></select><input style="text-align:right" type="hidden" name="data['+intIndex+'][TAXPRICE1]" id="data'+intIndex+'TAXPRICE1" value="0"><input style="text-align:right" type="text" name="data'+intIndex+'TAXPERC" id="data'+intIndex+'TAXPERC" value="0">';
	...
	function add_itemDir(strItem) 
	{
		...
		// ITM_CODE, SO_NUM, SO_CODE, PRJCODE, OFF_NUM, OFF_CODE
			objTD = objTR.insertCell(objTR.cells.length);
			objTD.align = 'right';
			objTD.innerHTML = ''+ITM_CODE+'<input type="hidden" id="data'+intIndex+'ITM_CODE" name="data['+intIndex+'][ITM_CODE]" value="'+ITM_CODE+'" width="10" size="15"><input type="hidden" id="data'+intIndex+'SO_NUM" name="data['+intIndex+'][SO_NUM]" value="'+SO_NUM+'" width="10" size="15"><input type="hidden" id="data'+intIndex+'SO_CODE" name="data['+intIndex+'][SO_CODE]" value="'+SO_CODE+'" width="10" size="15"><input type="hidden" id="data'+intIndex+'PRJCODE" name="data['+intIndex+'][PRJCODE]" value="'+PRJCODE+'" width="10" size="15"><input type="hidden" id="data'+intIndex+'OFF_NUM" name="data['+intIndex+'][OFF_NUM]" value="'+OFF_NUM+'" width="10" size="15"><input type="hidden" id="data'+intIndex+'OFF_CODE" name="data['+intIndex+'][OFF_CODE]" value="'+OFF_CODE+'" width="10" size="15"><input type="hidden" id="data'+intIndex+'JOBCODEID" name="data['+intIndex+'][JOBCODEID]" value="'+JOBCODEID+'" width="10" size="15">';
		...
		// ITEM TAX : TAXCODE1, TAXPRICE1
			objTD = objTR.insertCell(objTR.cells.length);
			objTD.style.textAlign = 'right';
			objTD.innerHTML = '<select name="data['+intIndex+'][TAXCODE1]" id="data'+intIndex+'TAXCODE1" class="form-control" style="max-width:150px" onChange="getTax(this.value, '+intIndex+');"><option value=""> --- </option><?php foreach($rPPN as $rwPPN) : $TAXLA_NUM= $rwPPN->TAXLA_NUM; $TAXLA_DESC	= $rwPPN->TAXLA_DESC; ?> endforeach; ?> <option value="<?php echo $TAXLA_NUM; ?>"><?php echo $TAXLA_DESC; ?></option> <?php endforeach; ?></select><input style="text-align:right" type="hidden" name="data['+intIndex+'][TAXPRICE1]" id="data'+intIndex+'TAXPRICE1" value="0"><input style="text-align:right" type="hidden" name="data'+intIndex+'TAXPERC" id="data'+intIndex+'TAXPERC" value="0">';
