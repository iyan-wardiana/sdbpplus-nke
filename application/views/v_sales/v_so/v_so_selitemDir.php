                    ...
                    <div class="nav-tabs-custom">
                        ...
                        <div class="tab-content">
                            <?php
                                                        ...
                                                        <table id="example1" class="table table-bordered table-striped table-responsive search-table inner" width="100%">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th width="10%" nowrap><?php echo $RemBudget; ?>  </th>
                                                                    <th width="8%" nowrap><?php echo $StockQuantity; ?>  </th>
                                                              </tr>
                                                            </thead>
                                                            <tbody>
                                                            </tbody>
                                ...
                                elseif($List_Type == 1) // Item Penganti
                                {
                                    ?>
...
<script>
    $(document).ready(function()
    {
        $('#example1').DataTable(
        {
            ...
            "autoWidth": true,
            "filter": true,
            "ajax": "<?php echo site_url('c_sales/c_s4l350r4/get_AllDataITM/?id='.$PRJCODE)?>",
            "type": "POST",
        ...
        $('#example2').DataTable(
        {
            ...
            "autoWidth": true,
            "filter": true,
            "ajax": "<?php echo site_url('c_sales/c_s4l350r4/get_AllDataITMS/?id='.$PRJCODE)?>",
            "type": "POST",
            //"lengthMenu": [[10, 25, 50, 100, 200, -1], [10, 25, 50, 100, 200, "All"]],
            "lengthMenu": [[10, 25, 50, 100, 200], [10, 25, 50, 100, 200]],
            "columnDefs": [ { targets: [2,4,5], className: 'dt-body-center' },
...
function get_item() 
    {
        ...
        if(typeof(document.frmSearch.chk[0]) == 'object') 
        {
            for(i=0;i<document.frmSearch.chk.length;i++) 
            {
                if(document.frmSearch.chk[i].checked) 
                {
                    ...
                    window.opener.add_itemDir(document.frmSearch.chk[i].value);                
                }
            }
        } 
        else 
        {
            ...
            {
                window.opener.add_itemDir(document.frmSearch.chk.value);
