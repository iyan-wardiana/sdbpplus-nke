...
/*  
     ...
     * Create Date	= 25 Oktober 2018
     * File Name	= v_inb_so.php
     * Location		= -
*/
                    ...
                    <div class="search-table-outter">
                        <table id="example" class="table table-bordered table-striped table-responsive search-table inner" width="100%">
                            ...
                            <tr>
                                ...
                                <th width="7%" style="vertical-align:middle; text-align:center" nowrap><?php echo $RefNumber ?> </td>
...
<script>
  $(document).ready(function() {
    $('#example').DataTable( {
        ...
        "autoWidth": true,
        "filter": true,
        "ajax": "<?php echo site_url('c_sales/c_s4l350r4/get_AllData_1n2/?id='.$PRJCODE)?>",
        "type": "POST",
