        ...
        <section class="content">
            <div class="box">
        		...
        		<div class="box-body">
                    <div class="search-table-outter">
                        <table id="example" class="table table-bordered table-striped table-responsive search-table inner" width="100%">
                            ...
                            <tr>
                                ...
                                <th width="7%" style="vertical-align:middle; text-align:center" nowrap><?php echo $ManualCode ?> </th>
                                ...
                                <th width="8%" style="vertical-align:middle; text-align:center"><?php echo $SOValue ?> </th>
                                <th width="8%" style="vertical-align:middle; text-align:center"><?php echo $ProdPlan ?> </th>
                    ...
                    <br>
                    <?php
                        $urladd = site_url('c_sales/c_s4l350r4/a44_s0/?id='.$this->url_encryption_helper->encode_url($PRJCODE));
                        if($ISCREATE == 1 && $DEPCODE != '') {
                        echo anchor("$urladd",'<button class="btn btn-primary">&nbsp;<i class="glyphicon glyphicon-plus"></i></button>&nbsp;&nbsp;');}
...
<script>
    ...
    $('#example').DataTable( {
        ...
        "autoWidth": true,
        "filter": true,
        "ajax": "<?php echo site_url('c_sales/c_s4l350r4/get_AllData/?id='.$PRJCODE)?>",
        "type": "POST",
