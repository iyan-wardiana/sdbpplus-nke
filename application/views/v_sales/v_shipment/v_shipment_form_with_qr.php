                    ...
                    <div class="col-md-12" <?php if($SN_TYPE == 4) { ?> style="display: none;" <?php } ?>>
                        <div class="box box-success">
							<div class="box-body">
					            ...
					            ?>
                    			<div style="text-align: center; font-weight: bold;"><?php echo $shiplist; if($SN_STAT == 1 || $SN_STAT == 4) { ?> [ <a href="javascript:void();" data-toggle="modal" data-target="#modal_add_new"><i class='glyphicon glyphicon-qrcode'></i></a> ] <?php } ?></div>
                    			<br>
