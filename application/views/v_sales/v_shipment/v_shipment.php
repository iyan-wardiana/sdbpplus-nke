        ...
        <section class="content">
			<div class="box">
			    <div class="box-body">
			        <div class="search-table-outter">
			            <table id="example" class="table table-bordered table-striped" width="100%">
		                    ...
		                    <tr>
		                        ...
		                        <th width="6%" style="vertical-align:middle; text-align:center" nowrap><?php echo $ShipmentNo ?> </th>
		                        <th width="6%" style="vertical-align:middle; text-align:center"><?php echo $Date ?> </th>
		                        <th width="7%" style="vertical-align:middle; text-align:center" nowrap><?php echo $OrderNum ?></th>
		                        <th width="20%" style="vertical-align:middle; text-align:center"><?php echo $Receiver  ?></th>
		                        <th width="40%" style="vertical-align:middle; text-align:center"><?php echo $DestAdd ?> </th>
		                        <th width="4%" style="vertical-align:middle; text-align:center">ID </th>                   
		            ...
		            <br>
                	<?php
						$secAddURL = site_url('c_sales/c_sh1pn0t35/a44_sN0t35/?id='.$this->url_encryption_helper->encode_url($PRJCODE));
...
<script>
    ...
    $('#example').DataTable( {
		...
		"autoWidth": true,
		"filter": true,
        "ajax": "<?php echo site_url('c_sales/c_sh1pn0t35/get_AllData/?id='.$PRJCODE)?>",
        "type": "POST",
		//"lengthMenu": [[10, 25, 50, 100, 200, -1], [10, 25, 50, 100, 200, "All"]],
		"lengthMenu": [[10, 25, 50, 100, 200], [10, 25, 50, 100, 200]],
		"columnDefs": [	{ targets: [0,1,3,6,7], className: 'dt-body-center' },
	...
	function printDINV(row)
	{
		var url	= document.getElementById('urlPrintINV'+row).value;
		w = 900;
		h = 550;
	...
	function createINV(row)
	{
		var urlSec	= document.getElementById('urlSINV'+row).value;
		$.ajax({
		    url: urlSec,
		    type: 'POST',
		    data: {option : row},
