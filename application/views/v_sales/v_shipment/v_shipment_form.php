		...
		<section class="content">	
		    <div class="row">
                    ...
                    <div class="col-md-12" <?php if($SN_TYPE == 4) { ?> style="display: none;" <?php } ?>>
                        <div class="box box-success">
							<div class="box-body">
                    			...
                    			<div style="text-align: center; font-weight: bold;"><?php echo $shiplist; if($SN_STAT == 1 || $SN_STAT == 4) { ?> [ <a href="javascript:void();" data-toggle="modal" data-target="#mdl_sQRC"><i class='glyphicon glyphicon-qrcode'></i></a> ] <?php } ?></div>
                    			<br>
			    ...
			    <!-- ============ START MODAL SCAN QRCODE =============== -->
			    	...
			    	?>
			        <div class="modal fade" id="mdl_sQRC" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
					                ...
					                <div class="modal-body">
	                                    ...
	                                    <div class="form-group">
	                                            ...
	                                            <form method="post" name="sendData" id="sendData" class="form-user" action="">
	                                                <div class="form-group" style="text-align:center">
	                                                    <div class="thumbnail" id="result">
	                                                        ...
	                                                        <div class="caption">
	                                                            <p id="scanned-QR"></p>
	                                                            <input type="text" name="scanned-QRText" id="scanned-QRText" value="STW21101009303501001" width="250px" class="inplabel" style="display:none" >
	                                                            ...
	                                                            <button class="btn btn-danger" type="button" onClick="window.close()" style="display: none;">
	                                        ...
	                                        <script>
	                                                        ...
	                                                        success: function(response)
	                                                        {
	                                                            ...
	                                                            else
	                                                            {
	                                                                ...
	                                                                else if(isExist == 2)
	                                                                {
	                                                                    ...
	                                                                    document.getElementById('SN_CODE1').innerHTML       = SN_CODE+ ' / '+SN_DATEV;
	                                                                    document.getElementById('noQRC').style.display      = 'none';
	                                                                    document.getElementById('detInf').style.display     = 'none';
	                                                                    //document.getElementById('btnShD').style.display   = 'none';
	                                                                    document.getElementById('btnSel').style.display     = 'none';
	                                            ...
	                                            function get_item() 
	                                            {
	                                            	var colD 	= document.getElementById('collDATA').value;
	                                            	add_item(colD);
	                                            	document.getElementById("collDATA").value 			= '';
	                                            	document.getElementById('btnSel').style.display     = 'none';
