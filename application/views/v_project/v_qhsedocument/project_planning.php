	...
	<table id="example1" class="table table-bordered table-striped table-responsive search-table inner">
		<thead>
            <tr>
              ...
              <th style="text-align:center; vertical-align:middle" width="71%" nowrap><?php echo $Project ?> </th>
		...
		<?php 
			...
			foreach($viewproject as $row) : 
				...
				$secUpd		= site_url('c_project/qhsedocument/get_last_ten_GroupType/?id='.$this->url_encryption_helper->encode_url($PRJCODE));
				...
				if ($j==1) {
					...
					?>
						<td style="text-align:center; vertical-align:middle" nowrap><?php echo anchor($secUpd,$PRJCODE);?></td>
