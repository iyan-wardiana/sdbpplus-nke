            ...
            <div class="search-table-outter">
                <table id="example1" class="table table-bordered table-striped table-responsive search-table inner" width="100%">
                    ...
                    <tr>
                        ...
                        <th width="38%"><?php echo $JobDescription; ?> </th>
                    ...
                    <tbody> 
                        ...
                        if($cData > 0)
                        {
                            foreach($vData as $row) :
                                ...
                                $secUpd	= site_url('c_project/c_am1h0db2/updateAMD/?id='.$this->url_encryption_helper->encode_url($AMD_NUM));
								if($AMD_STAT == 1)
								{
									$AMD_STATD 		= 'New';
									$STATCOL		= 'warning';
                        		...
                        		?>
                                    ...
                                    <td style="display:none" nowrap> <?php print $AMD_NUM; ?> </td>
