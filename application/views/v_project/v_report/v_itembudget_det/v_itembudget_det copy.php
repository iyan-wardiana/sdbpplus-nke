                ...
                <div class="box-body chart-responsive">
                  	<form class="form-horizontal" method="post" name="frm" id="frm" action="<?php echo $form_action; ?>" onSubmit="return target_popup(this);">
                        ...
                        ?>
                      	...
                      	<div class="form-group">
                        	<label for="inputName" class="col-sm-2 control-label"><?php echo $Item ?> </label>
                        	<div class="col-sm-10">
                              	<select name="ITM_CODE[]" id="ITM_CODE" multiple class="form-control select2">
                                </select>
                        	</div>
                      	</div>
						<div class="form-group">
...
<script>
  	$(function () {
		...
		$('#PRJCODE').on('change', function(){
			$.ajax({
                type: "POST",
                url: "<?php echo base_url("c_project/c_r3p/getITEMSG") ?>",
                dataType: "JSON",
                data: {PRJCODE:$(this).val()},
