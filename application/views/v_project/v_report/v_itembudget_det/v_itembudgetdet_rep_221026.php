            ...
            <table width="100%" border="0" style="size:auto">
                <tr>
                    ...
                    <td colspan="2" class="style2" style="text-align:center; font-weight:bold; text-transform:uppercase; font-size:20px">
                        LAPORAN BUDGET ITEM DETIL <span style="font-size: 10pt; display:block; padding-top:5px;">PERIODE: <?php echo date('d-m-Y', strtotime($Start_Date));?>  S/D <?php echo date('d-m-Y', strtotime($End_Date));?></span>
                    </td>
            </tr>
                <tr>
                ...
                if($resBUD_ITM->num_rows() > 0)
                {
                            ...
                            <table width="100%" border="0" style="size:auto">
                                ...
                                <tr style="vertical-align: top;">
                                    <td class="style2" style="text-align:left; font-style:italic">
                                        ...
                                        <tr style="text-align:left; font-style:italic">
                                                <td width="8%" nowrap valign="top">Kode Induk Pekerjaan</td>
                                                <td width="0%">:</td>
                                                <td width="92%"><?php echo "$JOBCODEID_H"; ?></span></td>
                                            </tr>
                                            <tr style="text-align:left; font-style:italic">
                                            <td nowrap valign="top">Nama Induk Pekerjaan</td>
                                            <td>:</td>
                                                    ...
                                                    <?php
                                                        ...
                                                        foreach($resDataVC->result() as $rVC):
                                                            ...
                                                            // Get SPLDESC
                                                                if($SPLDESC == '')
                                                                {
                                                                    $SPLDESC = $this->db->get_where("tbl_supplier", ["SPLCODE" => $SPLCODE, "SPLSTAT" => 1])->row("SPLDESC");
                                                                }
                    ...
                    // get Data PD
                        $getDataPD     = "SELECT A.JournalH_Code, A.JournalH_Date, A.JournalType, A.Acc_Id, A.JournalD_Debet, 
                                            ...
                                            A.PPN_Code, A.PPN_Perc, A.PPN_Amount, A.PPH_Code, A.PPH_Perc, A.PPH_Amount, A.JOBCODEID, A.ITM_CODE, 
                                            A.ITM_GROUP, A.ITM_CATEG, A.ITM_VOLM, A.ITM_PRICE, A.ITM_UNIT, A.Other_Desc, 
                                            B.GEJ_STAT, B.STATDESC, B.Manual_No, B.JournalH_Desc, B.SPLCODE, B.SPLDESC, CONCAT(C.First_Name) AS SPLDESC2
                    ...
                    // get Data OPN
                        $getDataOPN     = "SELECT A.*, 
                                            B.OPNH_STAT, B.STATDESC, B.OPNH_CODE, B.OPNH_NOTE, B.SPLCODE, B.SPLDESC
