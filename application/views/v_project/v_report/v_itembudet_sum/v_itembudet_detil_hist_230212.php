		                    ...
		                    <?php
								...
								foreach($resJD as $rowJD) :
									...
									if($DOC_CATEG == 'PR')
									{
										...
										$REMB_VOL 		= $RAP_VOL - $RAPUT_VOL;
										$REMB_VAL 		= $RAP_VAL - $RAPUT_VAL;
									}
									elseif($DOC_CATEG == 'PO')
									{
										...
										$REMB_VOL 		= $RAP_VOL - $POT_VOL;
										$REMB_VAL 		= $RAP_VAL - $POT_VAL;
									}
									elseif($DOC_CATEG == 'IR')
									{
									...
									elseif($DOC_CATEG == 'WO')
									{
										...
										$REMA_VOL 		= $RAP_VOL - $POT_VOL;
										$REMA_VAL 		= $RAP_VAL - $POT_VAL;
									...
									?>
		                                <tr>
		                                    ...
		                                    <td style="text-align:right; background-color: rgb(233, 233, 233);"><?php echo number_format($REMB_VOL,2); ?></td>
		                                    <td style="text-align:right; background-color: rgb(233, 233, 233);"><?php echo number_format($REMB_VAL,2); ?></td>
		                                    <td style="text-align:right; <?=$alrtStyl3?>"><?php echo number_format($RAPR_VOL,2); ?> <?php //echo $REMA_VOLV;?></td>
		                                    <td style="text-align:right; <?=$alrtStyl4?>"><?php echo number_format($RAPR_VAL,2); ?> <?php //echo $REMA_VALV;?></td>
		                                </tr>
		                    		<?php
