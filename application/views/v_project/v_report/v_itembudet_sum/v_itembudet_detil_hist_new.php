						...
						<td class="style2" style="text-align:left; font-size:10px">
		              	<table width="100%" border="1" style="size:auto; font-size:10px;" rules="all">
		                    ...
		                    <?php
								...
								$AMD_VOL 	= 0;
								$AMD_VAL 	= 0;
								$RAPIT_VOL 	= $RAPT_VOL;		// TOTOL VOL RAP ITEM
								$RAPIT_VAL 	= $RAPT_VAL;		// TOTAL VAL RAP ITEM
								$RAPUT_VOL 	= 0;
								$RAPUT_VAL 	= 0;
								...
								foreach($resJD as $rowJD) :
									...
									$RAP_VOLA 		= $rowJD->RAP_VOL;
									$RAP_VALA 		= $rowJD->RAP_VAL;
									...
									if($DOC_CATEG == 'AMD')
									{
										...
										$RAP_VOL 	= $RAP_VOL+$AMD_VOL;
										$RAP_VAL 	= $RAP_VAL+$AMD_VAL;
										...
										$REMB_VOL 	= round($RAP_VOL,2);
										$REMB_VAL 	= round($RAP_VAL,2);

										$REMC_VOL 	= round($RAPIT_VOL,2);
										$REMC_VAL 	= round($RAPIT_VAL,2);
									}
									else if($DOC_CATEG == 'PR')
									{
										...
										$RAP_VOL 	= $RAP_VOL-$PR_VOL;
										$RAP_VAL 	= $RAP_VAL-0;
										$RAPIT_VOL 	= $RAPIT_VOL-$PR_VOL;
										$RAPIT_VAL 	= $RAPIT_VAL-0;

										$REMA_VOL 	= round($PRT_VOL,2);
										$REMA_VAL 	= round($PRT_VAL,2);
									...
									elseif($DOC_CATEG == 'PO')
									{
										...
										$PRT_VOL 	= $PRT_VOL - $PO_VOL;
										$PRT_VAL 	= $RAP_VAL - $PO_VAL;

										$RAP_VAL 	= $RAP_VAL - $PO_VAL;

										$RAPIT_VAL 	= $RAPIT_VAL - $PO_VAL;
									...
									elseif($DOC_CATEG == 'WO')
									{
										...
										$RAP_VOL 	= $RAP_VOL-$PO_VOL;
										$RAP_VAL 	= $RAP_VAL-$PO_VAL;
										$RAPIT_VOL 	= $RAPIT_VOL-$POT_VOL;
										$RAPIT_VAL 	= $RAPIT_VAL-$POT_VAL;
									...
									elseif($DOC_CATEG == 'VCASH' || $DOC_CATEG == 'VLK' || $DOC_CATEG == 'PPD')
									{
										...
										$RAP_VOL 	= $RAP_VOL-$UM_VOL;
										$RAP_VAL 	= $RAP_VAL-$UM_VAL;
										$RAPIT_VOL 	= $RAPIT_VOL-$UM_VOL;
										$RAPIT_VAL 	= $RAPIT_VAL-$UM_VAL;
									...
									?>
		                                <tr>
		                                    ...
		                                    <td style="text-align:right; <?=$alrtStyl5?>"><?php echo number_format($REMC_VOL,2); ?> <?php //echo $REMA_VOLV;?></td>
		                                    <td style="text-align:right; <?=$alrtStyl6?>"><?php echo number_format($REMC_VAL,2); ?> <?php //echo $REMA_VALV;?></td>
		                                </tr>
		                    		<?php
