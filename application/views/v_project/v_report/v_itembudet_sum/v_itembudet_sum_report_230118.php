        	...
        	<table width="100%" border="1" rules="all" style="border-color: black;">
        		<thead>
	                <tr style="background:#CCCCCC">
						...
						<th colspan="4" nowrap style="text-align:center; font-weight:bold; border-top-width:2px; border-top-color:#000; border-right-width:2px; border-right-color:#000; border-left-width:2px; border-left-color:#000;">PERUBAHAN</th>
               	...
               	<?php
					...
					// get Group Item
						...
						if($resGItem->num_rows() > 0)
						{
							...
							foreach($resGItem->result() as $rGItem):
								...
								// get Joblist_detail
									...
									$getJobD 	= "SELECT A.PRJCODE, A.ITM_GROUP, A.ITM_CODE, A.ITM_UNIT, A.JOBDESC,
													...
													A.IS_LEVEL, A.ISLASTH, A.ISLAST, B.ITM_NAME
										...
										foreach($resJobD->result() as $rJobD):
											...
											// Get ADD, REQ, REALIZ PERIODE INI
												$getBUDGItem = "SELECT SUM(AMD_VOL+AMDM_VOL) AS ADDVOLM, SUM(AMD_VAL+AMDM_VAL) AS ADD_TOTAL,
																SUM(AMDM_VOL) AS ADDMVOLM, SUM(AMDM_VAL) AS ADDM_TOTAL,
												...
												if($resBUDGItem->num_rows() > 0)
												{
													foreach($resBUDGItem->result() as $rBUDGItem):
														// Addendum => SAAT INI
															...
															$ADDMVOLM 		= $rBUDGItem->ADDMVOLM;
															$ADDM_TOTAL 	= $rBUDGItem->ADDM_TOTAL;
											...
											// Get ADD, REQ, REALIZ KOMULATIF
												...
												if($resBUDGLItem->num_rows() > 0)
												{
													foreach($resBUDGLItem->result() as $rBUDGLItem):
														// Addendum => KOMULATIF
															...
															$ADDMVOLM_KOM 		= $rBUDGLItem->ADDMVOLM;
															$ADDM_TOTAL_KOM 	= $rBUDGLItem->ADDM_TOTAL;
												...
												?>
													<tr>
														...
														<!-- PERUBAHAN KOMULATIF --->
														<td nowrap style="text-align:right;"><?php echo number_format($ADDVOLM_KOM, 2); ?></td>
															<td nowrap style="text-align:right; border-right-color:#000; border-right-width:2px;"><?php echo number_format($ADD_TOTAL_KOM, 2); ?></td>
											...
											?>
												...
												<tr style="background:#CCCCCC; font-weight: bold;">
													...
													<!-- PERUBAHAN BULAN LALU--->
														<td nowrap style="text-align:right;border-bottom-width:2px; border-bottom-color:#000; border-left-width:2px; border-left-color:#000; border-top-width:2px; border-top-color:#000;"><?php echo number_format(0, 2); ?></td>
														<td nowrap style="text-align:right;border-bottom-width:2px; border-bottom-color:#000; border-right-width:2px; border-right-color:#000; border-top-width:2px; border-top-color:#000;"><?php echo number_format($TOT_ADDM_KOM, 2); ?></td>
							...
							$ITM_BUDG_UNCOL 	= 0;
							$getJobD 			= "SELECT SUM(A.ITM_BUDG) AS ITM_BUDG FROM tbl_joblist_detail_$PRJCODEVW A
														LEFT JOIN tbl_item_$PRJCODEVW B ON B.ITM_CODE = A.ITM_CODE AND B.ITM_GROUP = A.ITM_GROUP
														AND B.PRJCODE = A.PRJCODE WHERE A.ITM_CODE != '' AND A.PRJCODE = '$PRJCODE' AND A.ISLAST = 1
														AND A.ITM_GROUP NOT IN ('M','U','S','T','I','R','O')";
							$resJobD 			= $this->db->query($getJobD);
							if($resJobD->num_rows() > 0)
							{
								$newNo = $newNo;
								foreach($resJobD->result() as $rJobD):
									$ITM_BUDG_UNCOL 	= $rJobD->ITM_BUDG;
									if($DefEmp_ID == 'D15040004221') {	
										?>
											<tr style="background:#CCCCCC; font-weight: bold;">
												<td nowrap colspan="5" style="text-align:center;border-bottom-width:2px; border-bottom-color:#000; border-left-width:2px; border-left-color:#000; border-right-width:2px; border-right-color:#000; border-top-width:2px; border-top-color:#000;">TOTAL UNCOLLECTED</td>
												<!-- BUDGET AWAL --->
													<td nowrap style="text-align:right;border-bottom-width:2px; border-bottom-color:#000; border-left-width:2px; border-left-color:#000; border-top-width:2px; border-top-color:#000;"><?php echo number_format(0, 2); ?></td>
													<!-- <td nowrap style="text-align:right;"><?php echo number_format($ITM_LASTP, 2); ?></td> -->
													<td nowrap style="text-align:right;border-bottom-width:2px; border-bottom-color:#000; border-right-width:2px; border-right-color:#000; border-top-width:2px; border-top-color:#000;"><?php echo number_format($ITM_BUDG_UNCOL, 2); ?></td>
							...
							?>
								...
								<tr style="background:#CCCCCC; font-weight: bold;">
									...
									<!-- BUDGET AWAL --->
										<td nowrap style="text-align:right;border-bottom-width:2px; border-bottom-color:#000; border-left-width:2px; border-left-color:#000; border-top-width:2px; border-top-color:#000;"><?php echo number_format(0, 2); ?></td>
										<!-- <td nowrap style="text-align:right;"><?php echo number_format($ITM_LASTP, 2); ?></td> -->
										<td nowrap style="text-align:right;border-bottom-width:2px; border-bottom-color:#000; border-right-width:2px; border-right-color:#000; border-top-width:2px; border-top-color:#000;"><?php echo number_format($GTOT_BUDGM+$ITM_BUDG_UNCOL, 2); ?></td>
									...
									<!-- PERUBAHAN BULAN LALU--->
									<td nowrap style="text-align:right;border-bottom-width:2px; border-bottom-color:#000; border-left-width:2px; border-left-color:#000; border-top-width:2px; border-top-color:#000;"><?php echo number_format(0, 2); ?></td>
										<td nowrap style="text-align:right;border-bottom-width:2px; border-bottom-color:#000; border-right-width:2px; border-right-color:#000; border-top-width:2px; border-top-color:#000;"><?php echo number_format($GTOT_ADDM_KOM, 2); ?></td>
