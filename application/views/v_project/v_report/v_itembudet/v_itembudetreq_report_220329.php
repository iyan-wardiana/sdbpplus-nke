        ...
        <td class="style2" style="text-align:left; font-style:italic">
            <table width="100%">
              ...
              <tr style="text-align:left; font-style:italic">
                  ...
                  <td>:</td>
                  <td><?php echo "$SelJOBCODEID_H - $SelJOBDESC_H"; ?></td>
                </tr>
                <tr style="text-align:left; font-style:italic">
                    ...
                    // SISA BUDGET THD REQUEST
                        ...
                        ?>
                            <table width="100%" border="0" rules="all" style="border-bottom: 1px solid;">
                              ...
                              <tr style="text-align:left; font-style:italic">
                                  <td nowrap valign="top">REQUEST</td>
                              ...
                              <tr style="text-align:left; font-style:italic">
                                  <td nowrap valign="top" style="font-weight: bold;">SISA BUDGET THD REQUEST</td>
        ...
        <td colspan="3">
            <div class="jobH">
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <?php
                            $getJOB_H       = "SELECT * FROM tbl_joblist
                                                WHERE PRJCODE = '$PRJCODE' AND JOBPARENT LIKE '$JOBPARENT%'
                                                ORDER BY ORD_ID ASC";
                            ...
                            if($resJOB_H->num_rows() > 0)
                            {
                                foreach($resJOB_H->result() as $rJOB_H):
                                    ...
                                    $JOBLEV_H       = $rJOB_H->JOBLEV;
                                    $ISLASTH_H      = $rJOB_H->ISLASTH;

                                    $JOBLEV_HP     = "";
                                    if($JOBLEV_H == 2) $JOBLEV_HP      = "&nbsp;&nbsp;";
                                    if($JOBLEV_H == 3) $JOBLEV_HP      = "&nbsp;&nbsp;&nbsp;&nbsp;";
                                    if($JOBLEV_H == 4) $JOBLEV_HP      = "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
                                    if($JOBLEV_H == 5) $JOBLEV_HP      = "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
                                    if($JOBLEV_H == 6) $JOBLEV_HP      = "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
                                    if($JOBLEV_H == 7) $JOBLEV_HP      = "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
                                    if($JOBLEV_H == 8) $JOBLEV_HP      = "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
                                    if($JOBLEV_H == 9) $JOBLEV_HP      = "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";

                                    $JOBDESC_H1     = cut_text($JOBDESC_H, 50, "&nbsp;...");

                                    ?>
                                        <tr>
                                            <td colspan="4"><?php echo "$JOBLEV_HP$JOBCODEID_H - $JOBDESC_H"; ?></td>
                                            <td>&nbsp;</td>
                                            <td>&nbsp;</td>
                                            <td>&nbsp;</td>
                                            <td>&nbsp;</td>
                                    ...
                                    if($ISLASTH_H == 1)
                                    {
                                        // Get JOBCODEID Detail
                                        $this->db->select("JOBCODEID, ITM_CODE")->from("tbl_joblist_detail");
                                        $this->db->where(["PRJCODE" => $PRJCODE, "JOBPARENT" => $JOBCODEID_H]);
                                        $getJOB_D        = $this->db->get();
                                        $JOBCODEID_D     = [];
                                        $ITM_CODE_D      = [];
                                        foreach($getJOB_D->result() as $rJOB_D):
                                            $JOBCODEID_D[]  = $rJOB_D->JOBCODEID;
                                            $ITM_CODE_D[]   = $rJOB_D->ITM_CODE;
                                        endforeach;

                                        $ArrJOBCODEID_D = implode("','", $JOBCODEID_D);
                                        $ArrITM_CODE_D  = implode("','", $ITM_CODE_D);
                                        ...
                                        $sqlREQ     = "SELECT A.PO_NUM AS REQ_NUM, A.PO_CODE AS REQ_CODE, 
                                                        ...
                                                        WHERE A.PRJCODE = '$PRJCODE' AND A.JOBCODEID IN ('$ArrJOBCODEID_D') AND A.PO_DATE BETWEEN '$Start_Date' AND '$End_Date' AND B.PO_STAT IN (1,2,3,4,7)
                                                        UNION
                                                        ...
                                                        INNER JOIN tbl_joblist_detail C ON C.JOBCODEID = A.JOBCODEID AND 
                                                        C.ITM_CODE = A.ITM_CODE AND C.PRJCODE = A.PRJCODE
                                                        WHERE A.PRJCODE = '$PRJCODE' AND A.JOBCODEID IN ('$ArrJOBCODEID_D') AND A.WO_DATE BETWEEN '$Start_Date' AND '$End_Date' AND B.WO_STAT IN (1,2,3,4,7)
                                                        UNION
                                                        ...
                                                        WHERE B.proj_Code = '$PRJCODE' AND A.JOBCODEID IN ('$ArrJOBCODEID_D') AND B.JournalH_Date BETWEEN '$Start_Date' AND '$End_Date' AND B.GEJ_STAT IN (1,2,3,4,7)
                                                        UNION
                                                        SELECT B.JournalH_Code AS REQ_NUM, B.Manual_No AS REQ_CODE, B.JournalH_Date AS REQ_DATE, A.Other_Desc AS REQ_DESC, A.ITM_VOLM AS REQ_VOLM, A.JournalD_Debet AS REQ_AMOUNT, A.JOBCODEID, A.ITM_CODE, A.ITM_UNIT, C.ITM_VOLM AS ITM_VOLMBG, C.ITM_BUDG,
                                                        C.ADD_VOLM, C.ADD_JOBCOST AS ADD_TOTAL, C.ADDM_VOLM AS ADDM_VOLM, C.ADDM_JOBCOST AS ADDM_TOTAL
                                                        FROM tbl_journaldetail_cprj A 
                                            ...
                                            ?>
                                                ...
                                                <?php
                                                    ...
                                                    // AFTER ADDENDUM
                                                        ...
                                                        $ADD_PRICE      = 0;
                                                        $ADD_TOTAL      = 0;
                                                        $getBUDG_ADD    = "SELECT ADD_VOLM, ADD_PRICE, ADD_JOBCOST, ADDM_VOLM, ADDM_JOBCOST FROM tbl_joblist_detail WHERE PRJCODE = '$PRJCODE' AND JOBCODEID = '$JOBCODEID' AND ITM_CODE = '$ITM_CODE'";
                                                        $resBUDG_ADD    = $this->db->query($getBUDG_ADD);
                                                        if($resBUDG_ADD->num_rows() > 0)
                                                        {
                                                            foreach($resBUDG_ADD->result() as $rB_ADD):
                                                                $ADD_VOLM       = $rB_ADD->ADD_VOLM;
                                                                $ADD_PRICE      = $rB_ADD->ADD_PRICE;
                                                                $ADD_TOTAL      = $rB_ADD->ADD_JOBCOST;

                                                                $ADDM_VOLM      = $rB_ADD->ADDM_VOLM;
                                                                $ADDM_TOTAL     = $rB_ADD->ADDM_JOBCOST;
                                                            endforeach;
                                                        }
                                                        ...
                                                        // AFTER ADDENDUM
                                                            $ITM_VOLM2  = $ITM_VOLMBG + $ADD_VOLM - $ADDM_VOLM;
                                                            $ITM_BUDG2  = $ITM_BUDG + $ADD_TOTAL - $ADDM_TOTAL;
                                                            $ITM_PRICE2 = $ITM_BUDG2 / $ITM_VOLM2;

                                                            $REMREQ_VOLMBG    = $ITM_VOLMBG - $REQ_VOLM;
                                                            $REMREQ_BUDG      = $ITM_BUDG - $REQ_AMOUNT;
                                                            $REMREQ_PRICE     = $REMREQ_BUDG / $REMREQ_VOLMBG;
                                                        ...
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <td style="text-align: left; font-weight: normal;"><?php echo "$JobView"; ?></td>
