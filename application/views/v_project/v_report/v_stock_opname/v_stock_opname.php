...
<html>
    ...
    <?php
    	...
    	foreach($resTransl as $rowTransl) :
    		...
    		if($TranslCode == 'viewPrice')$viewPrice = $LangTransl;
                ...
                <div class="box-body chart-responsive">
                    <form class="form-horizontal" method="post" name="frm" id="frm" action="<?php echo $form_action; ?>" onSubmit="return target_popup(this);">
                        ...
                        <div class="form-group" style="display: none;">
                            ...
                            <div class="col-sm-10">
                                <select name="ITM_GROUP" id="ITM_GROUP" class="form-control select2" data-placeholder="&nbsp;<?php echo $ItemGroup; ?>">
                                	<option value="">--- None ---</option>
                                    <?php
        								$sqlITMG	= "SELECT IG_Num, IG_Code, IG_Name FROM tbl_itemgroup ORDER BY IG_Name ASC";
        								$resITMG 	= $this->db->query($sqlITMG)->result();
        								foreach($resITMG as $rowITMG) :
        									$IG_Num 	= $rowITMG->IG_Num;
        									$IG_Code 	= $rowITMG->IG_Code;
        									$IG_Name 	= $rowITMG->IG_Name;
        									?>
        										<option value="<?php echo $IG_Num; ?>"><?php echo "$IG_Code - $IG_Name";?></option>
        									<?php
        								endforeach;
                                    ?>
                                </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select name="ITM_CODE" id="ITM_CODE" class="form-control select2" data-placeholder="&nbsp;&nbsp;&nbsp;<?php echo $ItemName; ?>">
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <?php if($ISDELETE == 1): ?>
                        <div class="form-group">
                            <label for="inputName" class="col-sm-2 control-label"><?php echo $viewPrice; ?></label>
                            <div class="col-sm-10">
                                <label>
                                    <input type="radio" name="viewPrice" id="viewPrice" class="minimal" value="0" checked /> 
                                    <?php echo $Inactive; ?> &nbsp;
                                    <input type="radio" name="viewPrice" id="viewPrice" class="minimal" value="1" /> 
                                    <?php echo $Active; ?>
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <label>
                                    <input type="radio" name="viewType" id="viewType" class="minimal" value="0" checked /> 
                                    <?php echo $WebViewer ?> &nbsp;
                                    <input type="radio" name="viewType" id="viewType" class="minimal" value="1" /> 
                                    <?php echo $Excel ?>
                                </label>
                            </div>
                        </div>
        ...
        getAllITM_CODE = function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if(lnData != 0) dataOpt = '<option value="1">Semua Item</option>';
