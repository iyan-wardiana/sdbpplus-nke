	...
	<div class="print_content" style="padding-top: 5px; font-size: 12px;">
		<table width="100%" border="1" rules="all" style="border-color: black;">
			<tr style="background:#CCCCCC">
				<td rowspan="2" width="5%" nowrap style="text-align:center; font-weight:bold">NO</td>
				<td rowspan="2" width="10%" nowrap style="text-align:center; font-weight:bold"><?php echo $ItemCode; ?></td>
				<td rowspan="2" width="20%" nowrap style="text-align:center; font-weight:bold"><?php echo $Description; ?></td>
				<td rowspan="2" width="5%" nowrap style="text-align:center; font-weight:bold"><?php echo $Unit; ?></td>
				<td rowspan="2" width="10%" nowrap style="text-align:center; font-weight:bold"><?php echo $Budget; ?><br>(A)</td>
				<td rowspan="2" width="8%" nowrap style="text-align:center; font-weight:bold"><?php echo $Requested; ?><br>(B)</td>
				<td rowspan="2" width="8%" nowrap style="text-align:center; font-weight:bold"><?php echo $Ordered; ?><br>(C)</td>
				<td rowspan="2" width="8%" nowrap style="text-align:center; font-weight:bold"><?php echo $Received; ?><br>(D)</td>
				<td rowspan="2" width="8%" nowrap style="text-align:center; font-weight:bold"><?php echo $Used; ?><br>(E)</td>
				<td rowspan="2" width="8%" nowrap style="text-align:center; font-weight:bold"><?php echo "$Remain $Budget"; ?><br>(A-C)</td>
				<td colspan="2" width="10%" nowrap style="text-align:center; font-weight:bold"><?php echo "$Remain $Stock"; ?><br>(D-E)</td>
			</tr>
			<tr style="background:#CCCCCC">
				<td nowrap width="20" style="text-align:center; font-weight:bold">Vol.</td>
				<td nowrap width="80" style="text-align:center; font-weight:bold">Jumlah</td>
			</tr>
			<?php
			...
			if ($resStock->num_rows() > 0) {
				...
				foreach ($resStock->result() as $rowsqlq1) :
					...
					foreach ($rNOW->result() as $rwNOW) :
						...
						$PRT_VOL 	= $PR_VOL + $PR_VOL_R + $VCASH_VOL + $VCASH_VOL_R + $VLK_VOL + $VLK_VOL_R + $PPD_VOL + $PPD_VOL_R - $PR_CVOL;
						$PRT_VAL 	= $PO_VAL + $PO_VAL_R + $VCASH_VAL + $VCASH_VAL_R + $VLK_VAL + $VLK_VAL_R + $PPD_VAL + $PPD_VAL_R - $PO_CVAL;
						...
						$POT_VOL 	= $PO_VOL + $PO_VOL_R + $VCASH_VOL + $VCASH_VOL_R + $VLK_VOL + $VLK_VOL_R + $PPD_VOL + $PPD_VOL_R - $PO_CVOL;
						$POT_VAL 	= $PO_VAL + $PO_VAL_R + $VCASH_VAL + $VCASH_VAL_R + $VLK_VAL + $VLK_VAL_R + $PPD_VAL + $PPD_VAL_R - $PO_CVAL;
						...
						// $IRT_VOL = $IR_VOL + $IR_VOL_R + $VCASH_VOL + $VCASH_VOL_R + $VLK_VOL + $VLK_VOL_R + $PPD_VOL + $PPD_VOL_R;
						// $IRT_VAL = $IR_VAL + $IR_VAL_R + $VCASH_VAL + $VCASH_VAL_R + $VLK_VAL + $VLK_VAL_R + $PPD_VAL + $PPD_VAL_R;
						$IRT_VOL 	= $IR_VOL + $VCASH_VOL + $VCASH_VOL_R + $VLK_VOL + $VLK_VOL_R + $PPD_VOL + $PPD_VOL_R;
						$IRT_VAL 	= $IR_VAL + $VCASH_VAL + $VCASH_VAL_R + $VLK_VAL + $VLK_VAL_R + $PPD_VAL + $PPD_VAL_R;

						// TOTAL DIGUNAKAN
						// $UMT_VOL 	= $UM_VOL + $UM_VOL_R + $VCASH_VOL + $VCASH_VOL_R + $VLK_VOL + $VLK_VOL_R + $PPD_VOL + $PPD_VOL_R;
						// $UMT_VAL 	= $UM_VAL + $UM_VAL_R + $VCASH_VAL + $VCASH_VAL_R + $VLK_VAL + $VLK_VAL_R + $PPD_VAL + $PPD_VAL_R;
						...
						$UMT_VOL 	= $UM_VOL + $VCASH_VOL + $VCASH_VOL_R + $VLK_VOL + $VLK_VOL_R + $PPD_VOL + $PPD_VOL_R;
						$UMT_VAL 	= $UM_VAL + $VCASH_VAL + $VCASH_VAL_R + $VLK_VAL + $VLK_VAL_R + $PPD_VAL + $PPD_VAL_R;

						// TOTAL SISA
						$REMB_VOL	= $ITM_VOL2 - $PRT_VOL;
			...
			?>
					<tr>
						...
						<td nowrap style="text-align:left;"><?php echo $ITM_DESC; ?></td>
						...
						<td nowrap style="text-align:right; border-right-color:#000; border-right-width:2px; <?= $alrtStyl1 ?>">
							<a onclick="showITMDET('<?php echo $secvwPRD; ?>')" style="cursor: pointer; text-decoration:none;">
								<?php echo number_format($PRT_VOLV, 2); ?>
							</a>
						</td>
						<td nowrap style="text-align:right; border-right-color:#000; border-right-width:2px; <?= $alrtStyl2 ?>">
							<a onclick="showITMDET('<?php echo $secvwPOD; ?>')" style="cursor: pointer; text-decoration:none;">
								<?php echo number_format($POT_VOLV, 2); ?>
							</a>
						</td>
						<td nowrap style="text-align:right; border-right-color:#000; border-right-width:2px; <?= $alrtStyl3 ?>">
							<a onclick="showITMDET('<?php echo $secvwIRD; ?>')" style="cursor: pointer; text-decoration:none;">
								<?php echo number_format($IRT_VOLV, 2); ?>
							</a>
						</td>
						<td nowrap style="text-align:right; border-right-color:#000; border-right-width:2px; <?= $alrtStyl4 ?>">
							<a onclick="showITMDET('<?php echo $secvwUMD; ?>')" style="cursor: pointer; text-decoration:none;">
								<?php echo number_format($UMT_VOLV, 2); ?>
							</a>
						</td>
						<td nowrap style="text-align:right; <?= $alrtStyl5 ?>">
							<?php echo number_format($REMB_VOLV, $decFormat); ?>
						</td>
						<td nowrap style="text-align:right; <?= $alrtStyl6 ?>">
							<?php echo number_format($REMR_VOLV, $decFormat); ?>
						</td>
						<td nowrap style="text-align:right; <?= $alrtStyl6 ?>">
							<?php
							echo number_format($REMR_VALV, $decFormat);
							?>
						</td>
					</tr>
				<?php
				...
				?>
				<tr>
					<td colspan="10" style="text-align:right; font-weight: bold;">TOTAL SISA STOCK</td>
					<td style="text-align:right; font-weight: bold;"><?php echo number_format($GTREMR_VOLV, $decFormat); ?></td>
					<td style="text-align:right; font-weight: bold;">
						<?php
						echo number_format($GTREMR_VALV, $decFormat);
						?>
					</td>
				</tr>
			<?php
			...
			?>
				<tr>
					<td colspan="14" nowrap style="text-align:center;">--- none ---</td>
				</tr>
			<?php
			}
			?>
