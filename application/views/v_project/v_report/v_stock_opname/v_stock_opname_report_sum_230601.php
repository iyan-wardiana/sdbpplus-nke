        ...
        <div class="print_content" style="padding-top: 5px; font-size: 12px;">
        	<table width="100%" border="1" rules="all" style="border-color: black;">
                <tr style="background:#CCCCCC">
                  	...
                  	<td rowspan="2" width="8%" nowrap style="text-align:center; font-weight:bold"><?php echo $Budget; ?><br>(A)</td>
                  	...
                  	<td rowspan="2" width="7%" nowrap style="text-align:center; font-weight:bold"><?php echo $Received; ?><br>(D)</td>
                  	<td rowspan="2" width="7%" nowrap style="text-align:center; font-weight:bold"><?php echo $Used; ?><br>(E)</td>
                	<td rowspan="2" width="8%" nowrap style="text-align:center; font-weight:bold"><?php echo "$Remain $Budget"; ?><br>(A-C)</td>
                  	<td colspan="2" width="8%" nowrap style="text-align:center; font-weight:bold"><?php echo "$Remain $Stock"; ?><br>(D-E)</td>
              	</tr>
				<tr style="background:#CCCCCC">
						...
						foreach($resStock->result() as $rowsqlq1):
							...
							?>
								<tr>
									...
									<td width="8%" nowrap style="text-align:right; border-right-color:#000; border-right-width:2px; <?=$alrtStyl1?>">
										<a onclick="showITMDET('<?php echo $secvwPRD; ?>')" style="cursor: pointer; text-decoration:none;">
											<?php echo number_format($PRT_VOLV, 2); ?>
										</a>
									</td>
									<td width="8%" nowrap style="text-align:right; border-right-color:#000; border-right-width:2px; <?=$alrtStyl2?>">
										<a onclick="showITMDET('<?php echo $secvwPOD; ?>')" style="cursor: pointer; text-decoration:none;">
											<?php echo number_format($POT_VOLV, 2); ?>
										</a>
									</td>
									<td width="7%" nowrap style="text-align:right; border-right-color:#000; border-right-width:2px; <?=$alrtStyl3?>">										
										<a onclick="showITMDET('<?php echo $secvwIRD; ?>')" style="cursor: pointer; text-decoration:none;">
											<?php echo number_format($IRT_VOLV, 2); ?>
										</a>
									</td>
									<td width="7%" nowrap style="text-align:right; border-right-color:#000; border-right-width:2px; <?=$alrtStyl4?>">										
									...
									<td width="8%" nowrap style="text-align:right; <?=$alrtStyl6?>"><?php echo number_format($REMR_VALV,$decFormat); ?></td>
								</tr>
							<?php
						endforeach;
						?>
							<tr>
								...
								<td style="text-align:right; font-weight: bold;"><?php echo number_format($GTREMR_VALV,$decFormat); ?></td>
							</tr>
						<?php
					}
					else
