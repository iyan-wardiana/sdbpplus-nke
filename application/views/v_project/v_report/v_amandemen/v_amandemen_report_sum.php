                        ...
                        <table width="100%" border="1">
                            <thead>
                                <tr class="header">
                                    ...
                                    <th colspan = "3">Nilai Amandemen</th>
                                    <th colspan = "3">Budget Awal</th>
                                    <th colspan = "3">Budget Setelah Amandemen</th>
                                </tr>
                                <tr class="header">
                                    <th>Volume</th>
                                    <th>Harga Satuan</th>
                    ...
                    <table width="100%" border="1">
                        ...
                        <?php
                            ...
                            <tr style="text-align: right; font-weight: bold;">
                                ...
                                <td style="background-color: gray;"><?=number_format($TADDPRICE, 2)?></td>
                                <td style="background-color: gray;"><?=number_format($TADDCOST, 2)?></td>
                                <td style="background-color: gray;"><?=number_format($TITM_VOLMBG, 2)?></td>
                                <td style="background-color: gray;"><?=number_format($TITM_PRICE, 2)?></td>
                                <td style="background-color: gray;"><?=number_format($TITM_TOTALP, 2)?></td>
                                <td style="background-color: gray;"><?=number_format($GTADD_VOLM, 2)?></td>
                                <td style="background-color: gray;"><?=number_format($GTADD_PRICE, 2)?></td>
                                <td style="background-color: gray;"><?=number_format($GTADD_COST, 2)?></td>
                            </tr>
