 ...
 * Create Date	= 23 Maret 2019
 * File Name	= v_amandemen_report_det.php
 * Location		= -
*/
        ...
        <td colspan="3" class="style2">
            <table width="100%" border="1" rules="all">
                <tr style="background:#CCCCCC">
                  ...
                  <th width="8%" rowspan="2" nowrap style="text-align:center; border-bottom-width:2px; border-bottom-color:#000; font-weight:bold; border-top-width:2px; border-top-color:#000;">NOMOR</th>
                  <th width="8%" rowspan="2" nowrap style="text-align:center; border-bottom-width:2px; border-bottom-color:#000; font-weight:bold; border-top-width:2px; border-top-color:#000;">TANGGAL</th>
               ...
               <?php
					...
					$TAMD_AMOUNT	= 0;
				   	$sqlAMC			= "tbl_amd_detail A
											INNER JOIN tbl_amd_header B ON B.AMD_NUM = A.AMD_NUM
												AND B.PRJCODE = '$PRJCODE'
											LEFT JOIN tbl_item C ON C.ITM_CODE = A.ITM_CODE
												AND C.PRJCODE = '$PRJCODE'
										WHERE A.PRJCODE = '$PRJCODE' AND A.ITM_CODE = '$ITM_CODE'
											AND B.AMD_STAT = 3 AND (B.AMD_DATE BETWEEN '$Start_Date' AND '$End_Date')";
					$resAMC			= $this->db->count_all($sqlAMC);
					if($resAMC > 0)
					{
						$sqlAM		= "SELECT B.AMD_CODE, B.AMD_DATE, B.AMD_CATEG, A.JOBDESC, A.AMD_DESC, A.ITM_CODE, A.ITM_UNIT,
											A.AMD_VOLM, A.AMD_PRICE, A.AMD_TOTAL,
											C.ITM_NAME, C.ITM_VOLMBG, C.ITM_PRICE, C.ITM_LASTP, C.ITM_TOTALP
						...
						foreach($resAM as $rowAM):
							...
							$ADDVOLM	= $rowAM->AMD_VOLM;
							$ADDPRICE	= $rowAM->AMD_PRICE;
							$ADDCOST	= $rowAM->AMD_TOTAL;
							$ITM_VOLMBG	= $rowAM->ITM_VOLMBG;
							$ITM_PRICE	= $rowAM->ITM_PRICE;
							$ITM_LASTP	= $rowAM->ITM_LASTP;
							$ITM_TOTALP	= $ITM_VOLMBG * $ITM_PRICE;
							$TADD_VOL	= $ITM_VOLMBG + $ADDVOLM;
							$TADD_AMN	= $ITM_TOTALP + $ADDCOST;
							$TADD_VOLA	= $TADD_VOL;
						...
						?>
							<tr>
                                ...
                                <td nowrap style="text-align:left;"><?php echo $ITM_NAME; ?></td>
                              	...
                              	<td nowrap style="text-align:left;"><?php echo "$AMD_CATEGD : $AMD_DESC"; ?></td>
