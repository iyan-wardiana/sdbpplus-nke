                  	...
                  	<form class="form-horizontal" method="post" name="frm" id="frm" action="<?php echo $form_action; ?>" onSubmit="return target_popup(this);">
                        ...
                        <div class="col-md-12">
	                   	...
	                   	<div class="col-md-12">
							<div class="form-group">
	                        	...
	                        	<div class="col-sm-10">
	                              	<select class="form-control pull-left select2" id="CFType" name="CFType" style="max-width:150px" onchange="showDesc(this.value)">
	                                  	...
	                                  	<option value="2">Detil Pekerjaan</option>
	                                  	<option value="3">Detil Pekerjaan Only</option>
	                      	...
	                      	<script type="text/javascript">
	                      		function showDesc(theVal)
	                      		{
	                      			if(theVal == 1)
	                      			{
	                      				...
	                      				document.getElementById('lap_03').style.display 	= "none";
	                      				document.getElementById('lap_dt').style.display 	= "";
	                      			}
	                      			else if(theVal == 2)
	                      			{
	                      			...
	                      			else if(theVal == 3)
	                      			{
	                      				document.getElementById('lap_01').style.display 	= "none";
	                      				document.getElementById('lap_02').style.display 	= "none";
	                      				document.getElementById('lap_03').style.display 	= "";
	                      				document.getElementById('lap_dt').style.display 	= "none";
	                      				var JOBPARENT = document.getElementById('JOBPARENT').value;
	                      				if(JOBPARENT == '')
	                      				{
	                      					swal('Silahkan pilih induk pekerjaan',
	                      					{
	                      						icon:"warning"
	                      					});
	                      					return false;
							...
							<div class="form-group" id="lap_dt">
	                   		...
	                   		<div class="form-group" id="lap_01" style="display: none;">
	                            ...
	                            <div class="col-sm-10">
	                                <div class="alert alert-warning alert-dismissible">
	                                    ...
	                                    Laporan ini akan menampilkan laporan daftar ringkasan penggunaan (realisasi) anggaran di setiap induk pekerjaan yang dipilih.
	                                </div>
	                            </div>
	                        </div>
	                   		<div class="form-group" id="lap_02" style="display: none;">
	                            ...
	                            <div class="col-sm-10">
	                                <div class="alert alert-warning alert-dismissible">
	                                    ...
	                                    Laporan ini akan menampilkan laporan daftar ringkasan permintaan (request) dan penggunaan (realisasi) anggaran di setiap komponen (detil) dari induk pekerjaan yang dipilih.
	                                </div>
	                            </div>
	                        </div>
	                   		<div class="form-group" id="lap_03" style="display: none;">
	                            <label for="inputName" class="col-sm-2 control-label">&nbsp;</label>
	                            <div class="col-sm-10">
	                                <div class="alert alert-warning alert-dismissible">
	                                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
	                                    <h4><i class="icon fa fa-ban"></i> Perhatian!</h4>
	                                    Laporan ini akan menampilkan laporan daftar ringkasan budget tanpa terikat oleh periode tertentu.
	                                </div>
	                            </div>
	                        </div>
	                      	<div class="form-group">
