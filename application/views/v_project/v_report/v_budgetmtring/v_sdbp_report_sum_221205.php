            ...
            <table width="100%" border="0" style="size:auto">
                <tr>
                    ...
                    <td colspan="2" class="style2" style="text-align:center; font-size:20px">
                        <span style="font-weight:bold; text-transform:uppercase; "><?=$h1_title?></span> <span style="font-style: italic;">(Summary)</span> <span style="font-size: 10pt; display:block; padding-top:5px;">PERIODE: <?php echo date('d-m-Y', strtotime($Start_Date));?>  S/D <?php echo date('d-m-Y', strtotime($End_Date));?></span>
                    </td>
                </tr>
            </table>
        </div>
