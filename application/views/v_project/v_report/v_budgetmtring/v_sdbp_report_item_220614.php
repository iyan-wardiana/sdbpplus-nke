        	...
        	<table width="100%" border="1" rules="all" style="border-color: black;">
	            ...
	            <tbody>
               	<?php
					...
					{
						$ITMGROUP 	= "";
						$sqlAM		= "SELECT A.PRJCODE, A.ITM_GROUP, A.ITM_CODE, A.ITM_UNIT, 
										...
										INNER JOIN tbl_item B ON B.ITM_CODE = A.ITM_CODE AND B.ITM_GROUP = A.ITM_GROUP AND B.PRJCODE = A.PRJCODE
										WHERE A.PRJCODE = '$PRJCODE' AND A.ITM_CODE != '' $ADDQUERY
										GROUP BY A.ITM_CODE ORDER BY A.ITM_GROUP ASC";
						...
						foreach($resAM as $rowAM):
							...
							$ITM_VOLM	= $rowAM->ITM_VOLMBG;				// STOCK
							...
							$ITM_BUDG	= $rowAM->ITM_BUDG;		// BUDGET AMOUNTs
							...
							?>
	                            <tr style="background:#CCCCCC; font-weight: bold;">
	                            	...
	                            	<?php
										...
										if($ITMGROUP == 'M') echo "TOTAL MATERIAL";
										if($ITMGROUP == 'U') echo "TOTAL UPAH";
										if($ITMGROUP == 'S') echo "TOTAL SUB-KONT";
										if($ITMGROUP == 'T') echo "TOTAL ALAT";
										if($ITMGROUP == 'I') echo "TOTAL LAIN-LAIN";
										if($ITMGROUP == 'R') echo "TOTAL OVERHEAD LAPANGAN";
										if($ITMGROUP == 'O') echo "TOTAL OVERHEAD";
									?>
									</td>
	                                <!-- BUDGET AWAL --->
