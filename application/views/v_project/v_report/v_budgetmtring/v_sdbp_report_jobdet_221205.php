        ...
        <div class="print_title">
            <table width="100%" border="0" style="size:auto">
                <tr>
                    ...
                    <td colspan="2" class="style2" style="text-align:center; font-size:20px">
                        <span style="font-weight:bold; text-transform:uppercase; ">LAPORAN RINGKASAN BUDGET</span><br><span style="font-style: italic;">Detil Pekerjaan</span> <span style="font-size: 10pt; display:block; padding-top:5px;">PERIODE: <?php echo date('d-m-Y', strtotime($Start_Date));?>  S/D <?php echo date('d-m-Y', strtotime($End_Date));?></span>
                    </td>
                </tr>
            </table>
        </div>
        	...
        	<table width="100%" border="1" rules="all" style="border-color: black;">
        		<thead>
        			<tr style="background:#CCCCCC">
						...
						<th colspan="6"  style="text-align:center; font-weight:bold; border-top-color:#000; border-right-color:#000;">REQUEST</th>
        		...
        		<tbody>
        			<?php
						...
						{
							$addQJOB_ID = "JOBCODEID = '$JOBPARENT'";
							$addQJOB_P 	= "JOBCODEID LIKE '$JOBPARENT%'";
						}
						...
						$getJOBD 		= "SELECT ORD_ID, JOBCODEID, JOBPARENT, PRJCODE, JOBDESC, ITM_GROUP, ITM_CODE, 
											...
											WHERE $addQJOB_P ORDER BY JOBCODEID, ORD_ID ASC";
						...
						if($resJOBD->num_rows() > 0)
						{
							...
							foreach($resJOBD->result() as $rJOBD):
								...
								// Get BUDGET => PERIODE INI
									$get_RQRLZ 	= "SELECT SUM(AMD_VOL+AMD_VOL_R) AS ADDVOLM, 
													...
													WHERE $ADDQRY_01 AND PERIODE BETWEEN '$Start_Date' AND '$End_Date'";
								...
								$get_LRQRLZ 	= "SELECT SUM(AMD_VOL+AMD_VOL_R) AS ADDVOLM, 
													...
													SUM(OPN_VAL+OPN_VAL_R+VCASH_VAL+VCASH_VAL_R+VLK_VAL+VLK_VAL_R+PPD_VAL+PPD_VAL_R) AS REALZ_AMOUNT
													FROM tbl_joblist_report_$PRJCODEVW
													WHERE $ADDQRY_01 AND PERIODE <= '$End_Date'";
							...
							?>
								<tr style="border: 2px solid;">
									...
									<td style="text-align: right; font-weight:bold;"><?php echo number_format($GTITM_BUDG2, 2); ?></td>
									<td>&nbsp;</td>
									<td style="text-align: right; font-weight:bold;"><?php echo number_format($GTREQ_AMOUNT, 2); ?></td>
									<td>&nbsp;</td>
									<td style="text-align: right; font-weight:bold;"><?php echo number_format($GTREQ_AMOUNT_KOM, 2); ?></td>
									<td>&nbsp;</td>
									<td style="text-align: right; font-weight:bold;"><?php echo number_format($GTREMREQ_AMOUNT, 2); ?></td>
									<td>&nbsp;</td>
									<td style="text-align: right; font-weight:bold;"><?php echo number_format($GTITM_USED_AM, 2); ?></td>
									<td>&nbsp;</td>
									<td style="text-align: right; font-weight:bold;"><?php echo number_format($GTITM_USED_AM_KOM, 2); ?></td>
									<td>&nbsp;</td>
