        ...
        <section class="content">
            ...
            // cek LS & friends
                ...
                $getBUD_ITM     = "SELECT JOBCODEID, JOBPARENT, JOBDESC, ITM_CODE, ITM_UNIT, ITM_VOLM, ITM_BUDG, ADD_VOLM, ADD_JOBCOST, ADDM_VOLM, ADDM_JOBCOST, ITM_USED, ITM_USED_AM FROM tbl_joblist_detail_$PRJCODEVW
                                    WHERE ITM_CODE = '$ITM_CODE' AND JOBPARENT IN ('$JoinJOBPAR') AND ISLAST = 1";
                ...
                if($resBUD_ITM->num_rows() > 0)
                {
                                                    ...
                                                    <?php
                                                        ...
                                                        foreach($resDataSPP->result() as $rSPP):
                                                            ...
                                                            // SPP belum menentukan harga
                                                                ...
                                                                if(array_search(strtoupper($ITM_UNIT), $UNIT_CHK) != '')
                                                                {
                                                            ...
                                                            $TOT_ITMUSEDAM      = $TOT_ITMUSEDAM + $PR_TOTAL;
                                                            ...
                                                            // GET PO BY PR_NUM
                                                                $getPO  = "SELECT A.*, B.PR_CODE AS REF_CODE, B.SPLCODE FROM tbl_po_detail A 
                                                                ...
                                                                if($resPO->num_rows() > 0)
                                                                {
                                                                    ...
                                                                    foreach($resPO->result() as $rPO):
                                                                        ...
                                                                        $TOT_ITMUSEDAM      = $TOT_ITMUSEDAM + $PO_TOTAL;
                    ...
                    // get Data SPK => REQUEST
                        $getDataSPK     = "SELECT A.*, 
                                            B.WO_CODE, B.WO_STAT, B.STATDESC
                                                ...
                                                <tbody>
                                                    <?php
                                                        ...
                                                        foreach($resDataSPK->result() as $rSPK):
                                                            ...
                                                            $TOT_ITMUSEDAM      = $TOT_ITMUSEDAM + $WO_TOTAL;
                                                        ...
                                                        endforeach;
                                                            ?>
                                                                <tr>
                                                                    ...
                                                                    <td style="text-align: right;"><?php echo number_format($TOT_ITMUSEDAM, $decFormat); ?></td>
                                                                    <td>&nbsp;</td>
                                                                    <td>&nbsp;</td>
                                                                    <td>&nbsp;</td>
                                                                </tr>
