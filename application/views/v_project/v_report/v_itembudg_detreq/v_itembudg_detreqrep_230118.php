                ...
                if($resBUD_ITM->num_rows() > 0)
                {
                    ...
                    ?>
                        <div id="grand_total">
                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td width="1065" style="text-align: right; font-weight: bold;">GRAND TOTAL</td>
                                    <td style="text-align: right; font-weight: bold;"><?php echo number_format($GTOT_ITMUSEDAM, 2); ?></td>
                                    <td width="270">&nbsp;</td>
                                </tr>
                            </table>
                        </div>
