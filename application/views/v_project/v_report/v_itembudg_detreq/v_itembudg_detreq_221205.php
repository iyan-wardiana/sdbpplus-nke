        ...
        <div class="col-md-12">
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    <li class="active"><a href="#JobDetail" data-toggle="tab">Detail Pekerjaan</a></li>
                    <li><a href="#ItemDetail" data-toggle="tab">Detail Item</a></li>
                </ul>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group date">
                                        ...
                                        <input type="text" name="datePeriod" class="form-control pull-left" id="frm1daterange-btn" style="width:200px">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <label>
                                        <input type="radio" name="viewType" id="frm1viewType" value="0" checked /> 
                                        <?php echo $WebViewer ?> &nbsp;&nbsp;
                                        <input type="radio" name="viewType" id="frm1viewType" value="1" /> 
                                        <?php echo $Excel ?>
                                    </label>
                                </div>
                            </div>
                    ...
                    <div class="tab-pane" id="ItemDetail">
                        <form class="form-horizontal" method="post" name="frm2" id="frm2" action="<?php echo $form_action; ?>" onSubmit="return targetITM_popup(this);">
                            ...
                            <div class="form-group">
                                <label for="inputName" class="col-sm-2 control-label"><?php echo $ItemName; ?></label>
                                <div class="col-sm-10">
                                    <select name="ITM_CODE[]" id="frm2ITM_CODE" multiple class="form-control select2" data-placeholder="&nbsp;&nbsp;&nbsp;<?php echo $ItemName; ?>">
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group date">
                                        <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                        <input type="text" name="datePeriod" class="form-control pull-left" id="frm2daterange-btn" style="width:200px">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <label>
                                        <input type="radio" name="viewType" id="frm2viewType" value="0" checked /> 
                                        <?php echo $WebViewer ?> &nbsp;&nbsp;
                                        <input type="radio" name="viewType" id="frm2viewType" value="1" /> 
                                        <?php echo $Excel ?>
                                    </label>
                                </div>
                            </div>
