    ...
    <div class="page">
        ...
        <section class="content">
            ...
            // cek LS & friends
                ...
                $getBUD_ITM     = "SELECT JOBCODEID, JOBPARENT, JOBDESC, ITM_CODE, ITM_UNIT, ITM_VOLM, ITM_BUDG, AMD_VOL, AMD_VAL, AMDM_VOL, AMDM_VAL
                ...
                if($resBUD_ITM->num_rows() > 0)
                {
                    ...
                    foreach($resBUD_ITM->result() as $rB):
                                ...
                                ?>
                                    <table width="100%" border="0" cellpadding="0" cellspacing="0"> 
                                        <thead style="background-color: lightgray;">
                                            <tr>
                                                <th colspan="12" style="height: 30px; vertical-align: middle; text-align: center;">DETIL TRANSAKSI SPP</th>
                        ...
                        // END DETIL SPP    => REQUEST

                        // START DETIL OP   => REQUEST
                            ?>
                                <table width="100%" border="0" cellpadding="0" cellspacing="0"> 
                                    <thead style="background-color: lightgray;">
                                        <tr>
                                            <th colspan="12" style="height: 30px; vertical-align: middle; text-align: center;">DETIL TRANSAKSI OP</th>
                                            <th colspan="2" style="height: 30px; vertical-align: middle; text-align: center; border-right: hidden;">SISA BUDGET</th>
                                        </tr>
                                        <tr>
                                            <th width="20" style="font-style: italic; text-align: center;">NO.</th>
                                    ...
                                    <tbody>
                                        <?php
                                            $getPO  = "SELECT A.*, B.PR_CODE AS REF_CODE, B.SPLCODE, B.STATDESC FROM tbl_po_detail A 
                                                        ...
                                                        WHERE A.PRJCODE = '$PRJCODE' AND A.JOBCODEID = '$JOBCODEID'
                                                        AND A.PR_NUM IN (SELECT A.PR_NUM FROM tbl_pr_detail A 
                                                            INNER JOIN tbl_pr_header B ON B.PR_NUM = A.PR_NUM AND B.PRJCODE = A.PRJCODE
                                                            WHERE B.PRJCODE = '$PRJCODE' AND A.JOBCODEID = '$JOBCODEID' AND A.ITM_CODE = '$ITM_CODE' AND B.PR_STAT NOT IN (5,9)
                                                            AND (A.PR_DATE BETWEEN '$Start_Date' AND '$End_Date'))
                                                        AND B.PO_STAT NOT IN (5,9) AND A.ITM_CODE = '$ITM_CODE'
                                                        ORDER BY B.PO_CODE, B.PO_DATE ASC";
                                            ...
                                            foreach($resPO->result() as $rPO):
                                                ...
                                                //$PO_TOTAL   = ($PO_VOLM - $PO_CVOL) * $PO_PRICE; // BELUM TERDAPAT DISKON
                                                $PO_TPOT    = $PO_DISC + $PO_CTOTAL;
                                                $PO_TOTAL   = $PO_COST - $PO_DISC - $PO_CTOTAL;

                                                $PO_TPOTV   = "";
                                                if($PO_TPOT > 0)
                                                {
                                                    $PO_TPOTV = "(".number_format($PO_TPOT, 2).")";
                                                }
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td style="text-align: right;"><?php echo number_format($PO_TOTAL, $decFormat); ?></td>
                                                        <td style="text-align: center;"><?php echo $STATDESC; ?></td>
                                                        <td style="text-align: center;"><?php echo number_format($REM_VOLMBG, $decFormat); ?></td>
                                                        <td style="text-align: right;"><?php echo number_format($REM_BUDG, $decFormat); ?></td>
                                                    </tr>
                        ...
                        // get Data SPK => REQUEST
                            ...
                            $getDataSPK     = "SELECT A.*, 
                                                ...
                                                WHERE B.PRJCODE = '$PRJCODE' AND A.JOBCODEID = '$JOBCODEID' AND A.ITM_CODE = '$ITM_CODE' AND B.WO_STAT NOT IN (5,9)
                            ...
                            if($resDataVLK->num_rows() > 0)
                            {
                                ?>
                                    <table width="100%" border="0" cellpadding="0" cellspacing="0"> 
                                        <thead style="background-color: lightgray;">
                                            <tr>
                                                <th colspan="12" style="height: 30px; vertical-align: middle; text-align: center;">DETIL TRANSAKSI VOUCHER LK</th>
                                                <th colspan="2" style="height: 30px; vertical-align: middle; text-align: center; border-right: hidden;">SISA BUDGET</th>
                                            </tr>
                                            <tr>
                                                <th width="20" style="font-style: italic; text-align: center;">NO.</th>
                            ...
                            <div id="sub_total">
                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td width="108" style="font-weight: bold; border-right: hidden; text-align: right;"><?php echo number_format($SUBTOT_ITMUSEDAM, 2); ?></td>
                                        <td width="109" style="font-style: italic; text-align: center;">&nbsp;</td>
                                        <td width="55" style="font-style: italic; text-align: center;">&nbsp;</td>
                                        <td width="108" style="font-style: italic; text-align: center;">&nbsp;</td>
                                    </tr>
                                </table>
                            </div>
                            <?php
                        ...
                        <div id="grand_total">
                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td width="108" style="text-align: right; font-weight: bold;"><?php echo number_format($GTOT_ITMUSEDAM, 2); ?></td>
                                    <td width="109" style="font-style: italic; text-align: center;">&nbsp;</td>
                                    <td width="55" style="font-style: italic; text-align: center;">&nbsp;</td>
                                    <td width="108" style="font-style: italic; text-align: center;">&nbsp;</td>
                                </tr>
