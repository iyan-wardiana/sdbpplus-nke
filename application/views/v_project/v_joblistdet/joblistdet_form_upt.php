	            ...
	            <div class="box-body chart-responsive">
	            	<form class="form-horizontal" name="frm" method="post" action="" enctype="multipart/form-data" onSubmit="return submitForm()">
	                    ...
	                    <div class="form-group">
	                        ...
	                        <div class="col-sm-10">
	                        	<select name="ISHEADER1" id="ISHEADER1" class="form-control select2" style="max-width:100px" onChange="chgType(this.value);" <?php if($countTRX > 0) { ?> disabled <?php } ?>>
	                                <option value="0" <?php if($ISHEADER == 0) { ?> selected <?php } ?>>Detail</option>
	                                <option value="1" <?php if($ISHEADER == 1) { ?> selected <?php } ?>>Header</option>
	                            </select>
	                            <input type="hidden" name="ISHEADER" id="ISHEADER" value="<?php echo $ISHEADER;?>">
	                        </div>
	                    </div>
	                    <script>
