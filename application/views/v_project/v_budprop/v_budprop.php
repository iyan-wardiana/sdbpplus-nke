                ...
                <div class="box-body">
                    <div class="search-table-outter">
                        <table id="example" class="table table-bordered table-striped" width="100%">
                            <thead>
                                <tr>
                                    <th style="vertical-align:middle; text-align:center" width="15%" nowrap>No. Pengajuan</th>
                                    <th style="vertical-align:middle; text-align:center" width="45%"><?php echo $Description; ?> </th>
                                    <th style="vertical-align:middle; text-align:center" width="15%" nowrap>Nilai Pengajuan</th>
                                    <th style="vertical-align:middle; text-align:center" width="15%" nowrap>Pengaju</th>
...
<script>
    $(document).ready(function() {
        $('#example').DataTable( {
            ...
            "autoWidth": true,
            "filter": true,
            "ajax": "<?php echo site_url('c_project/c_budprop/get_AllData/?id='.$PRJCODE)?>",
            "type": "POST",
    ...
    function hideDocCls()
    {
        ...
        $('#example').DataTable( {
            ...
            "autoWidth": true,
            "filter": true,
            "ajax": "<?php echo site_url('c_project/c_pR0p/get_AllDataSH/?id='.$PRJCODE.'&ISCLS=')?>"+1,
            "type": "POST",
            //"lengthMenu": [[10, 25, 50, 100, 200, -1], [10, 25, 50, 100, 200, "All"]],
            "lengthMenu": [[10, 25, 50, 100, 200], [10, 25, 50, 100, 200]],
    ...
    function showDocShw()
    {
        ...
        $('#example').DataTable( {
            ...
            "autoWidth": true,
            "filter": true,
            "ajax": "<?php echo site_url('c_project/c_pR0p/get_AllDataSH/?id='.$PRJCODE.'&ISCLS=')?>"+0,
            "type": "POST",
            //"lengthMenu": [[10, 25, 50, 100, 200, -1], [10, 25, 50, 100, 200, "All"]],
            "lengthMenu": [[10, 25, 50, 100, 200], [10, 25, 50, 100, 200]],
            "columnDefs": [ { targets: [4,5,6], className: 'dt-body-center' },
