                ...
                <div class="box-body chart-responsive">
                	<form class="form-horizontal" name="frm" method="post" action="<?php echo $form_action; ?>" onSubmit="return saveCategory()">
                        <div class="form-group">
                          	<label for="inputName" class="col-sm-2 control-label">Category Code</label>
                          	<div class="col-sm-10">
                                <label>
                                <input type="text" name="VendCat_Code1" id="VendCat_Code1" class="form-control" style="max-width:150px" value="<?php echo $VendCat_Code; ?>" onChange="functioncheck(this.value)" <?php if($task == 'edit') { ?> disabled <?php } ?>/>
                        ...
                        <div class="form-group">
                          	...
                          	<div class="col-sm-10">
                            	<input type="text" class="form-control" style="max-width:150px" name="VendCat_Name" id="VendCat_Name" value="<?php echo $VendCat_Name; ?>" />
                          	</div>
                        </div>
                        <div class="form-group">
                          	<label for="inputName" class="col-sm-2 control-label">Description</label>
                          	<div class="col-sm-10">
                                <textarea class="form-control" name="VendCat_Desc"  id="VendCat_Desc" style="max-width:500px;height:70px"><?php echo $VendCat_Desc; ?></textarea>
                          	</div>
                        </div>
                        <div class="form-group">
