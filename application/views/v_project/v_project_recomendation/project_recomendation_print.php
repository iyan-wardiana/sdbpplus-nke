		...
		<td colspan="3" valign="top" class="style2">
            <table class="table" border="1" width="100%" style="font-size:12px; font-family:Arial, Helvetica, sans-serif" rules="all">
                        <tr style="font-weight:bold; height:22px">
                            ...
                            <td colspan="2" align="right" nowrap>&nbsp;Nilai = + / -&nbsp;&nbsp;&nbsp;<?php echo $REC_CURRENCY; ?>&nbsp;<?php print number_format($REC_VALUE, $decFormat); ?>&nbsp;</td>
                        </tr>
                        <tr style="font-weight:bold; height:22px">
                        ...
                        <tr style=" height:22px">
                            ...
                            <td colspan="2">
                                <?php /*?><input type="checkbox" name="REC_FUNDSRC" id="REC_FUNDSRC1" value="1" class="minimal" <?php if($REC_FUNDSRC == 1) { ?> checked <?php } ?> disabled>
                                &nbsp;&nbsp;Tersedia (aman)&nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                <input type="checkbox" name="REC_FUNDSRC_APBN" id="REC_FUNDSRC_APBN" value="1" class="minimal" <?php if($REC_FUNDSRC_APBN==1) { ?> checked <?php } ?> disabled>
                                &nbsp;&nbsp;APBN&nbsp;&nbsp;&nbsp;&nbsp;
                                <input type="checkbox" name="REC_FUNDSRC_APBD" id="REC_FUNDSRC_APBD" value="1" class="minimal" <?php if($REC_FUNDSRC_APBD==1) { ?> checked <?php } ?> disabled>
                                &nbsp;&nbsp;APBD&nbsp;&nbsp;&nbsp;&nbsp;
                                <input type="checkbox" name="REC_FUNDSRC_PRIV" id="REC_FUNDSRC_PRIV" value="1" class="minimal" <?php if($REC_FUNDSRC_PRIV==1) { ?> checked <?php } ?> disabled>
                                &nbsp;&nbsp;Private&nbsp;&nbsp;&nbsp;&nbsp;
                                <input type="checkbox" name="REC_FUNDSRC_LOAN" id="REC_FUNDSRC_LOAN" value="1" class="minimal" <?php if($REC_FUNDSRC_LOAN==1) { ?> checked <?php } ?> disabled>
                                &nbsp;&nbsp;LOAN&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <tr style=" height:22px">
                            <td colspan="3" style="border-right-color:#FFFFFF;">&nbsp;2. &nbsp;&nbsp;Sistem Pembayaran</td>
                            <td colspan="2">
