...
// CEK APAKAH PERNAH ADA PERUBAHAN NILAI KONTRAK
	...
	foreach($resultPRJ  as $rowPRJ) :
		...
		$PRJCOST_IDR1= $rowPRJ->PRJCOST;
		$PRJCOST2		= $rowPRJ->PRJCOST2;
		if($ISCHANGE == 1)
		{
			$PRJCOST_IDR1= $PRJCOST2;
		}
...
// CEK APAKAH PERNAH ADA SI INCLUDE TO KONTRAK
	...
	foreach($resultPRJ2  as $rowPRJ2) :
		$PRJCOST_IDR2	= $rowPRJ2->SI_APPVAL;
	endforeach;
	$PRJCOST_IDR		= $PRJCOST_IDR1 + $PRJCOST_IDR2;
	...
	if($task == 'add')
	{
		...
		// START : DEFAULT VALUE
			...
			foreach($resDP as $rowDP) :
				...
				$PINV_DPVALnPPn	= $PINV_DPVALnPPn + $PINV_DPVALA + $DPPPNVALA;
			endforeach;
				
			$PINV_DPPER			= $PINV_DPPER1;				// Persentase DP
			$PINV_DPVAL			= $PINV_DPVAL1;				// Nilai DP tanpa PPN
			$PINV_DPVALnPPn		= $PINV_DPVALnPPn;			// Nilai DP dengan PPN
			$PINV_DPVALPPn		= round(0.1 * $PINV_DPVAL);	// PPN
...
else
{
	...
	$PINV_TOTPROGRESSPPn	= 0.1 * $PINV_TOTPROGRESS;
	...
	$PINV_PAYAKUMPPn		= round(0.1 * $PINV_PAYAKUM);
							...
							<div class="box-body">
	                        	...
	                        	<div class="col-sm-12">
	                                <div class="form-group">
	                                    <label for="inputName"><?php echo $InvoiceNumber; ?></label>
	                        	...
	                        	<div class="col-sm-12">
	                                <div class="form-group">
	                                	<label for="inputName"><?php echo $INVCode; ?></label>
	                        	...
	                        	<?php if($PINV_CAT == 2) { ?>
	                          		<div class="col-sm-8">
		                                <div class="form-group">
					                        ...
					                        <input type="hidden" class="textbox" name="MC_REF" id="MC_REF" size="20" value="<?php echo $MC_REF; ?>" />
					                        <?php
							...
							<div class="box-body">
	                        	...
	                        	<div class="col-sm-4">
	                                <div class="form-group">
		                        		...
		                        		<input type="text" class="form-control" style="text-align:right;" name="PRJCOST_IDR1" id="PRJCOST_IDR1" value="<?php print number_format($PRJCOST_IDR, 0); ?>" disabled>
		                        		<input type="hidden" size="15" class="textbox" style="text-align:right;" name="PRJCOST_IDR" id="PRJCOST_IDR" value="<?php echo $PRJCOST_IDR; ?>">
	                                </div>
	                            </div>
	                        	...
	                        	<div class="col-sm-4">
	                                <div class="form-group">
	                                	<label for="inputName"><!-- PPn -->&nbsp;</label>
		                          		<?php
					                        $proj_amountPPnIDR 	= round($PRJCOST_IDR * 0.1);
					                        $proj_amountnPPnIDR = round($PRJCOST_IDR + $proj_amountPPnIDR);
					                    ?>
					                      <input type="text" class="form-control" style="text-align:right;" name="proj_amountPPnIDR1" id="proj_amountPPnIDR1" value="<?php print number_format($proj_amountPPnIDR, 0); ?>" disabled>
	                        	...
	                        	<div class="col-sm-4">
	                                <div class="form-group">
	                                	<label for="inputName"><!-- Total -->&nbsp;</label>
		                          		<input type="text" class="form-control" style="text-align:right;" name="proj_amountTotIDR1" id="proj_amountTotIDR1" value="<?php print number_format($proj_amountnPPnIDR, 0); ?>" disabled>
		                   				<input type="hidden" size="15" class="textbox" style="text-align:right;" name="proj_amountTotIDR" id="proj_amountTotIDR" value="<?php echo $proj_amountnPPnIDR; ?>">
	                                </div>
	                            </div>
	                        	...
	                        	<div class="col-sm-3">
	                                <div class="form-group">
				                        ...
				                        <input type="text" class="form-control" style="text-align:right;" name="PINV_TOTVALPPH1" id="PINV_TOTVALPPH1" value="<?php echo number_format($PINV_TOTVALPPhP, 4); ?>" onBlur="countPPHPer(this.value)" onKeyPress="return isIntOnlyNew(event);" >
	                        	...
	                        	<div class="col-sm-4">
	                                <div class="form-group">
				                        ...
				                        <input type="text" class="form-control" style="text-align:right;" name="PINV_TOTVALPPH2" id="PINV_TOTVALPPH2" value="<?php echo number_format($PINV_TOTVALPPh, $decFormat); ?>" onBlur="countPPHVal(this.value)" onKeyPress="return isIntOnlyNew(event);">
...
<script>
    ...
    function getDPValue(thisVal)
    {
        ...
        var PRJCOST_IDR		= document.getElementById('proj_amountTotIDR').value;
        ...
        PINV_DPVALx			= Math.round(DPPer * PRJCOST_IDR / 100);				//	Nilai DP sebelum dipotong PPn
        PINV_DPPPnVALx		= Math.round(((PINV_DPVALx * 100) / 110) * 0.1);		//	Nilai PPn dari DP
		...
		// TOTAL AKUM PPN
			PINV_PAYAKUMPPn = parseFloat(PINV_PAYAKUM * 0.1);
        ...
        document.getElementById('PINV_TOTVALPPH2').value 	= doDecimalFormatxx(RoundNDecimal(parseFloat(Math.abs(PINV_PPHVAL)),decFormat));
	...
	function chgRetPer(thisVal)
	{
		...
		if(PINV_CAT == 1)
		{
			...
			var PPH_PERC	= eval(document.getElementById('PINV_TOTVALPPH1')).value.split(",").join("");
	...
	function countPPHPer(thisVal)
	{
		...
		document.getElementById('PINV_TOTVALPPH1').value 	= doDecimalFormatxx(RoundNDecimal(parseFloat(Math.abs(valPPh)),4));
		...
		if(PINV_CAT == 1)
		{
			...
			document.getElementById('PINV_TOTVALPPH2').value 	= doDecimalFormatxx(RoundNDecimal(parseFloat(Math.abs(PINV_PPHVAL)),2));
	...
	{
		var valPPh	= thisVal.split(",").join("");
		document.getElementById('PINV_TOTVALPPH2').value 	= doDecimalFormatxx(RoundNDecimal(parseFloat(Math.abs(valPPh)),2));
	...
	function chgGTOTAL(thisVal)
	{
		...
		document.getElementById('PINV_RECEIVETOT1').value 	= doDecimalFormatxx(RoundNDecimal(parseFloat(Math.abs(PINV_RECEIVETOT1)), 4));
	}
	...
	function getDetail(strItem, PINV_MMC, MC_TOTVAL1, MC_REF, PINV_PAYBEF) 
	{
		...
		if(pageFrom == 'MC')
		{
			...
			MC_PROGB 		= arrItem[5];		// 5
			MC_PROG 		= arrItem[6];		// 6
			MC_PROGVAL		= arrItem[7];		// 7
			MC_PROGCUR 		= arrItem[8];		// 9
			MC_PROGCURVAL 	= arrItem[9];		// 10
			MC_PROGAPP		= arrItem[10];		// 11
			MC_PROGAPPVAL 	= arrItem[11];		// 12
			MC_VALADD 		= arrItem[12];		// 13
			MC_MATVAL		= arrItem[13];		// 14
			MC_DPPER		= arrItem[14];		// 15
			MC_DPVAL 		= arrItem[15];		// 16
			MC_DPBACK 		= arrItem[16];		// 17
			MC_DPBACKCUR 	= arrItem[17];		// 18
			MC_RETCUTP 		= arrItem[18];		// 19
			MC_RETCUT 		= arrItem[19];		// 20
			MC_RETCUTCUR 	= arrItem[20];		// 21
			MC_VALBEF 		= arrItem[21];		// 22
			MC_TOTVAL 		= arrItem[22];		// 23
			MC_TOTVAL_PPn 	= arrItem[23];		// 24
			MC_TOTVAL_PPh 	= arrItem[24];		// 24
			MC_NOTES 		= arrItem[25];		// 25
			MC_OWNER 		= arrItem[26];		// 26
			OWN_INST 		= arrItem[27];		// 27
			MC_AKUMNEXT		= arrItem[28];		// 28

			document.getElementById('PINV_SOURCE1').value 			= MC_CODE;
			document.getElementById('MC_REF').value 				= MC_REF;	
			PRJCOST_IDR	= document.getElementById('proj_amountTotIDR').value;
			...
			// OK - Nilai Uang Muka
				...
				MC_DPVALPPn				= parseFloat(Math.round(0.1 * MC_DPVAL));
			...
			// Nilai PPn Prestasi Saat ini - not use
				PINV_PAYAKUMPPn			= Math.round(parseFloat(0.1 * PINV_PAYAKUM));
			...
			// PPh
				...
				document.getElementById('PINV_TOTVALPPH1').value 	= doDecimalFormatxx(RoundNDecimal(parseFloat(Math.abs(PPHPerc)),4));
				document.getElementById('PINV_TOTVALPPH2').value 	= doDecimalFormatxx(RoundNDecimal(parseFloat(Math.abs(MC_TOTVAL_PPh)),2));
		...
		else if(pageFrom == 'MCG')
		{
			...
			{
				MC_PROGVAL	= parseFloat(MC_PROGVAL);
				MC_PROG		= MC_PROGVAL / PRJCOST_IDR * 100;
			}*/
			...
			if(MC_PPHVAL > 0)
			{
				...
				document.getElementById('PINV_TOTVALPPH1').value 	= doDecimalFormatxx(RoundNDecimal(parseFloat(Math.abs(PPH_PERC)),4));
				document.getElementById('PINV_TOTVALPPH2').value 	= doDecimalFormatxx(RoundNDecimal(parseFloat(Math.abs(MC_PPHVAL)),4));
			}
			else
			{
				PPH_PERC	= 0;
				document.getElementById('PINV_TOTVALPPH').value 	= MC_PPHVAL;
				document.getElementById('PINV_TOTVALPPHP').value 	= PPH_PERC;
				document.getElementById('PINV_TOTVALPPH1').value 	= doDecimalFormatxx(RoundNDecimal(parseFloat(Math.abs(MC_PPHP)),4));
				document.getElementById('PINV_TOTVALPPH2').value 	= doDecimalFormatxx(RoundNDecimal(parseFloat(Math.abs(MC_PPHVAL)),4));
			}
			// OK - Nilai Prestasi
				document.getElementById('PINV_PROG1').value 		= doDecimalFormatxx(RoundNDecimal(parseFloat(Math.abs(MC_PROG)),4));
				...
				MC_PROGVAL			= parseFloat(MC_PROGVAL);
				MC_PROGVALPPn		= parseFloat(Math.round(0.1 * MC_PROGVAL));			// PPn Nilai Prestasi
				document.getElementById('PINV_PROGVAL1').value 		= doDecimalFormatxx(RoundNDecimal(parseFloat(Math.abs(MC_PROGVAL)),2));
			...
			// OK - Pekerjaan Tambahan
				MC_VALADD			= parseFloat(MC_VALADD);
				MC_VALADDPPn		= parseFloat(Math.round(0.1 * MC_VALADD));			// PPn Nilai Pekerjaan Tambah
				document.getElementById('PINV_VALADD').value 		= MC_VALADD;
			...
			// OK - Nilai Termasuk Pekerjaan Tambah
				...
				PINV_TOTPROGRESSPPn		= parseFloat(Math.round(0.1 * PINV_TOTPROGRESS));	// PPn Nilai Termasuk Pekerjaan Tambah
			...
			// Nilai PPn Prestasi Saat ini - not use
				PINV_PAYAKUMPPn			= Math.round(parseFloat(0.1 * MC_TOTVAL));
				document.getElementById('PINV_PAYAKUMPPn').value 	= PINV_PAYAKUMPPn;
				//swal(PINV_PAYAKUMPPn)
				
			// Nilai PPh				
				PPhPercent			= eval(document.getElementById('PINV_TOTVALPPH1')).value.split(",").join("");
				...
				document.getElementById('PINV_TOTVALPPH2').value 	= doDecimalFormatxx(RoundNDecimal(parseFloat(Math.abs(PINV_TOTVALPPH)),2));
		...
		if(pageFrom == 'SIC')
		{
			...
			// OK - Nilai Prestasi
				...
				SIC_PROGVALPPn		= parseFloat(Math.round(0.1 * SIC_PROGVAL));			// PPn Nilai Prestasi
