...
if($task == 'add')
{
	...
	$MCH_PAYMENT		= $MCH_PAYAKUM - $MCH_VALBEF;
	$MCH_PAYDUE		= 0;
	$MCH_PAYDUEPPh	= 0;	
	$MCH_TOTVAL_PPn	= 0;
	$MCH_TOTVAL_PPh	= 0;
...
else
{
	...
	$MCH_DATE1 		= $default['MCH_DATE'];
	$MCH_DATE		= date('m/d/Y',strtotime($MCH_DATE1));
	$MCH_ENDDATE1 	= $default['MCH_ENDDATE']; 
	$MCH_ENDDATE	= date('m/d/Y',strtotime($MCH_ENDDATE1));
	$MCH_CREATED1 	= $default['MCH_CREATED'];
	$MCH_CREATED	= date('m/d/Y',strtotime($MCH_CREATED1));
	$MCH_RETVAL 	= $default['MCH_RETVAL'];
	$MCH_RETCUT 	= $default['MCH_RETCUT'];
	$MCH_DPPER 		= $default['MCH_DPPER'];
	$MCH_DPVAL 		= $default['MCH_DPVAL'];
	$MCH_DPVALnPPn	= $MCH_DPVAL + round(0.1 * $MCH_DPVAL);
	$MCH_DPBACK 	= $default['MCH_DPBACK'];
	$MCH_PROG 		= $default['MCH_PROG'];
	$MCH_PROGVAL 	= $default['MCH_PROGVAL'];
	$MCH_PROGVALXY	= $MCH_PROGVAL + round(0.1 * $MCH_PROGVAL);;
	...
	$MCH_TOTPROGRESS= $MCH_PROGVAL + $MCH_VALADD + $MCH_MATVAL;
	$MCH_PAYBEFRET	= $MCH_AKUMNEXT;
	$MCH_PAYAKUM	= $MCH_PAYBEFRET;
	$MCH_PAYMENT	= $MCH_PAYAKUM - $MCH_VALBEF;
	$MCH_TOTVAL_PPn	= $default['MCH_TOTVAL_PPn'];
	$MCH_TOTVAL_PPh	= $default['MCH_TOTVAL_PPh'];
	$MCH_PAYDUE		= $MCH_PAYMENT + $MCH_TOTVAL_PPn;
	//$MCH_PAYDUEPPh	= round(0.03 * $MCH_PAYMENT);
	$TOTPAYMENT		= $MCH_PAYDUE - $MCH_TOTVAL_PPh;
}
                ...
                <form name="frm" id="frm" method="post" action="<?php echo $form_action; ?>">
                    ...
                    <?php } ?>
                      ...
                      <tr>
                          ...
                          <input type="text" name="MCH_MANNO" id="MCH_MANNO" value="<?php echo $MCH_CODE; ?>" class="form-control" style="max-width:200px">
                          </td>
                      ...
                      <tr>
                          ...
                          <td align="left" class="style1" >
                              <input type="text" class="form-control" style="max-width:200px; text-align:right;" name="MCH_DPVAL1" id="MCH_DPVAL1" value="<?php print number_format($MCH_DPVALnPPn, $decFormat); ?>" disabled></td>
                      </tr>
                      <tr>
                          <td align="left" class="style1">&nbsp;&nbsp;<?php echo $Progress ?>  (%)</td>
                          <td align="left" class="style1">:</td>
                          <td align="left" class="style1">
                              <input type="text" class="form-control" style="max-width:90px; text-align:right;" name="MCH_PROG1" id="MCH_PROG1" value="<?php print number_format($MCH_PROG, 4); ?>" onBlur="getPROGValueX(); getPROGValue1(1)" onKeyPress="return isIntOnlyNew(event);" <?php if($ISCREATE == 0) { ?> disabled <?php } ?>>
                              ...
                              <input type="hidden" class="form-control" style="max-width:90px; text-align:right;" name="MCH_PROGX" id="MCH_PROGX" value="<?php print $MCH_PROG; ?>" >                </td>
                          <td align="left" class="style1" ><?php echo $AdvPaymentInstallment ?></td>
                          <td align="left" class="style1" ><input type="text" class="form-control" style="max-width:200px; text-align:right;" name="MCH_DPBACK1" id="MCH_DPBACK1" value="<?php print number_format($MCH_DPBACK, $decFormat); ?>" onBlur="getTOTDUE(this)" title="Progress Approved * 0.01">
                          <input type="hidden" class="form-control" style="max-width:200px; text-align:right;" name="MCH_DPBACK" id="MCH_DPBACK" value="<?php echo $MCH_DPBACK; ?>"></td>
                          <!-- MCH_PROG, MCH_PROG1 -->
                      </tr>
                        <script>			
                      ...
                      <tr>
                          ...
                          <td align="left" class="style1">:</td>
                          <td align="left" class="style1">
                              <input type="text" class="form-control" style="max-width:200px; text-align:right;" name="MCH_PROGVAL1" id="MCH_PROGVAL1" value="<?php print number_format($MCH_PROGVAL, $decFormat); ?>" onBlur="getPROGPER(this)" >
                    ...
                    <tr>
                        ...
                        <td align="left" class="style1">:</td>
                        <td align="left" class="style1">
                            <label><input type="text" class="form-control" style="max-width:100px; text-align:right;" name="MCH_PROGAPPx" id="MCH_PROGAPPx" value="<?php print number_format($MCH_PROGAPP, 4); ?>" onBlur="getPROGAPPValue(this.value)" onKeyPress="return isIntOnlyNew(event);" >
                            ...
                            <label>
                            <input type="text" class="form-control" style="max-width:185px; text-align:right;" name="MCH_PROGAPPVALx" id="MCH_PROGAPPVALx" value="<?php print number_format($MCH_PROGAPPVAL, $decFormat); ?>" onBlur="getPROGPERAPP(this.value)" title="Progress Approved Amount">
                        ...
                        <td align="left" class="style1">
                        	<input type="text" class="form-control" style="max-width:200px; text-align:right;" name="MCH_VALBEFx" id="MCH_VALBEFx" value="<?php echo number_format($MCH_VALBEF, $decFormat); ?>" title="Amount Before" disabled>
                    ...
                    <tr>
                        ...
                        <td align="left" class="style1">
                            ...
                            <input type="hidden" class="form-control" style="max-width:200px; text-align:right;" name="MCH_TOTPROGRESS" id="MCH_TOTPROGRESS" value="<?php echo $MCH_TOTPROGRESS; ?>" title="Total Progress">
                            <label>
                            <input type="text" class="form-control" style="max-width:150px; text-align:right;" name="MCH_RETCUTx" id="MCH_RETCUTx" value="<?php echo number_format($MCH_RETCUT, $decFormat); ?>" onBlur="getTOTAL(this)" title="RetCut = 0.05*Progress Approved">
                            <input type="hidden" class="form-control" style="max-width:130px; text-align:right;" name="MCH_RETCUT" id="MCH_RETCUT" value="<?php echo $MCH_RETCUT; ?>" title="RetCut = 0.05*Progress Approved"></label>
                           ...
                           <label>
                            <input type="text" class="form-control" style="max-width:140px; text-align:right;" name="MCH_PAYBEFRETx" id="MCH_PAYBEFRETx" value="<?php echo number_format($MCH_PAYBEFRET, $decFormat); ?>" title="Pay.bef.Ret = Tot.Progres + DP - DP.Back - Ret.Cut" disabled>
                            <input type="hidden" class="form-control" style="max-width:155px; text-align:right;" name="MCH_PAYBEFRET" id="MCH_PAYBEFRET" value="<?php echo $MCH_PAYBEFRET; ?>" title="Payment Before Retention">
                          </label>
                        </td> 
                        <td align="left" class="style1"><?php echo $PaymentNext ?></td>
                        <td align="left" class="style1">
                        	<input type="text" class="form-control" style="max-width:200px; text-align:right;" name="MCH_AKUMNEXTx" id="MCH_AKUMNEXTx" value="<?php echo number_format($MCH_AKUMNEXT, $decFormat); ?>" title="Next Amount" disabled>
                      ...
                      <tr>
                          ...
                          <td align="left" class="style1">
                          	<label>
                            <input type="hidden" class="form-control" style="max-width:200px; text-align:right;" name="MCH_PAYAKUM" id="MCH_PAYAKUM" value="<?php echo $MCH_PAYAKUM; ?>" title="Pay Acummulation">
                            <input type="text" class="form-control" style="max-width:150px; text-align:right;" name="MCH_PAYMENTx" id="MCH_PAYMENTx" value="<?php echo number_format($MCH_PAYMENT, $decFormat); ?>" title="MCPay. = Next Amount - Amount Before">
                            <input type="hidden" class="form-control" style="max-width:200px; text-align:right;" name="MCH_PAYMENT" id="MCH_PAYMENT" value="<?php echo $MCH_PAYMENT; ?>" title="MCPay. = Next Amount - Amount Before">
                            </label>
                            <label>
                            <input type="text" class="form-control" style="max-width:140px; text-align:right;" name="MCH_TOTVAL_PPnx" id="MCH_TOTVAL_PPnx" value="<?php echo number_format($MCH_TOTVAL_PPn, $decFormat); ?>" onBlur="getTOTPlusPPN(this.value)" onKeyPress="return isIntOnlyNew(event);">
                    ...
                    <script>
						...
						{
                            var decFormat		= document.getElementById('decFormat').value;
							var MCH_PAYMENT		= document.getElementById('MCH_PAYMENT').value;
                            var MCH_TOTVAL_PPn	= PPNValue.split(",").join("");
                        ...
                        function getPROGPERAPP(MCH_PROGAPPVALx)
                        {
                            var ISAPPROVE		= document.getElementById('ISAPPROVE').value;
                            var decFormat		= document.getElementById('decFormat').value;
                            var proj_amountIDR	= document.getElementById('proj_amountTotIDRNon').value;
                            var MCH_PROGAPPVAL	= MCH_PROGAPPVALx.split(",").join("");
                            MCH_PROGAPP			= parseFloat(MCH_PROGAPPVAL) / parseFloat(proj_amountIDR) * 100;
                        ...
                        function getTOTAL(thisVal)
                        {
							...
							// Approved Percentation
                            var MCH_PROGAPP		= document.getElementById('MCH_PROGAPP').value;
                            document.getElementById('MCH_PROGAPPx').value = doDecimalFormatxx(RoundNDecimal(parseFloat(Math.abs(MCH_PROGAPP)), 4));
                            document.getElementById('MCH_PROGAPP').value = MCH_PROGAPP;
							
							// Approved Amount
                            var MCH_PROGAPPVAL	= document.getElementById('MCH_PROGAPPVAL').value;
                            document.getElementById('MCH_PROGAPPVALx').value = doDecimalFormatxx(RoundNDecimal(parseFloat(Math.abs(MCH_PROGAPPVAL)), 4));
                            document.getElementById('MCH_PROGAPPVAL').value = MCH_PROGAPPVAL;
							
                            MCH_VALADD			= document.getElementById('MCH_VALADD').value;
                            MCH_MATVAL			= document.getElementById('MCH_MATVAL').value;
                            
                            //MCH_PROGVALAPPx	= Math.round(thisVal * proj_amountIDR / 100);
                            MCH_PROGVALXY		= Math.round(MCH_PROGAPPVAL + (0.1 * MCH_PROGAPPVAL));
							
                            document.getElementById('MCH_PROGVALXY').value 	= doDecimalFormatxx(RoundNDecimal(parseFloat(Math.abs(MCH_PROGVALXY)),decFormat));
                            MCH_DPVAL			= document.getElementById('MCH_DPVAL').value;
                            MCH_TOTPROGRESS		= Math.round(parseFloat(MCH_PROGAPPVAL) +  parseFloat(MCH_VALADD) +  parseFloat(MCH_MATVAL));
                            document.getElementById('MCH_TOTPROGRESS').value = MCH_TOTPROGRESS;	// KEMAJUAN PEKERJAAN
                            
                            MCH_TOTPROGRESS		= document.getElementById('MCH_TOTPROGRESS').value;
							var MCH_RETCUT		= eval(thisVal).value.split(",").join("");
							
                            document.getElementById('MCH_RETCUT').value 		= MCH_RETCUT;	// PEMOTONGAN (RETENSI)
                            document.getElementById('MCH_RETCUTx').value 	= doDecimalFormatxx(RoundNDecimal(parseFloat(Math.abs(MCH_RETCUT)),decFormat));
                            
                            MCH_DPBACK			= document.getElementById('MCH_DPBACK').value;
                            //if(MCH_DPBACK == 0)
                            //{
                                //MCH_DPBACK 		= Math.round(thisVal / 100 * MCH_DPVAL);
                                //MCH_DPBACK 			= Math.round(MCH_PROGAPPx / 100 * MCH_DPVAL);
                                MCH_DPBACK 			= Math.round(MCH_PROGAPPVAL * 0.1);
                            //}
                            document.getElementById('MCH_DPBACK').value 		= MCH_DPBACK;	// ANG. PENGEMBALIAN UANG MUKA (PROPORSIONAL)
                        ...
                        function getPROGValue(MCH_PROGAPPVAL)
                        {
                            var MCH_PROGAPPx		= document.getElementById('MCH_PROGAPPx').value; // GET NILAI ASLI SAAT PROGRESS APP DI ISI
                            document.getElementById('MCH_PROGAPPx').value = doDecimalFormatxx(RoundNDecimal(parseFloat(Math.abs(MCH_PROGAPPx)), 4));
                            document.getElementById('MCH_PROGAPP').value = MCH_PROGAPPx;
                            ...
                            //MCH_PROGVALAPPx	= Math.round(thisVal * proj_amountIDR / 100);
                            MCH_PROGVALAPPx		= Math.round(MCH_PROGAPPVAL);
                            MCH_PROGVALXY		= Math.round(MCH_PROGVALAPPx + (0.1 * MCH_PROGVALAPPx));
                            
                            document.getElementById('MCH_PROGAPPVAL').value 	= MCH_PROGVALAPPx;
                            document.getElementById('MCH_PROGAPPVALx').value = doDecimalFormatxx(RoundNDecimal(parseFloat(Math.abs(MCH_PROGVALAPPx)),decFormat));					
                            document.getElementById('MCH_PROGVALXY').value 	= doDecimalFormatxx(RoundNDecimal(parseFloat(Math.abs(MCH_PROGVALXY)),decFormat));
                            MCH_DPVAL			= document.getElementById('MCH_DPVAL').value;
                            MCH_TOTPROGRESS		= Math.round(parseFloat(MCH_PROGVALAPPx) +  parseFloat(MCH_VALADD) +  parseFloat(MCH_MATVAL));
                            document.getElementById('MCH_TOTPROGRESS').value = MCH_TOTPROGRESS;	// KEMAJUAN PEKERJAAN
                            
                            //MCH_RETCUT			= Math.round((5 / 100 * MCH_PROGVALx));
                            MCH_RETCUT			= Math.round((5 / 100 * MCH_TOTPROGRESS));
                            document.getElementById('MCH_RETCUT').value 		= MCH_RETCUT;	// PEMOTONGAN (RETENSI)
                            document.getElementById('MCH_RETCUTx').value 	= doDecimalFormatxx(RoundNDecimal(parseFloat(Math.abs(MCH_RETCUT)),decFormat));
                      ...
                      <tr>
                          ...
                          <td align="left" class="style1">:</td>
                          <td align="left" class="style1" style="font-weight:bold; color:#FFF"><input type="hidden" class="form-control" style="max-width:200px; text-align:right;" name="MCH_PROGVALXY" id="MCH_PROGVALXY" value="<?php print number_format($MCH_PROGVALXY, $decFormat); ?>" disabled>
                                  ...
                                  <div class="box box-primary">
                                    ...
                                    <table width="100%" border="1" id="tbl" >
                                    	<tr style="background:#CCCCCC">
                                            ...
                                            <th width="12%" nowrap style="text-align:center">Total</th>
                                        </tr>
										<?php					
                                            if($task == 'edit')
                                            {
												...
												foreach($result as $row) :
													...
													<tr>
														...
														<td style="text-align:center" nowrap>
															<?php echo $MC_DATE; ?>
                                                            <input type="hidden" id="data<?php echo $currentRow; ?>MC_DATE" name="data[<?php echo $currentRow; ?>][MC_DATE]" value="<?php echo $MC_MANNO; ?>" width="10" size="15" readonly class="textbox">
                                                        </td>
														<td nowrap style="text-align:center">
                                                        	<?php echo $MC_STEP; ?>
                                                        	<input type="hidden" id="data<?php echo $currentRow; ?>MC_STEP" name="data[<?php echo $currentRow; ?>][MC_STEP]" value="<?php echo $MC_MANNO; ?>" width="10" size="15" readonly class="textbox">
                                                        </td>
														<td nowrap>
															<?php echo $MC_NOTES; ?>
...
<script>
  $(function () {
	...
	function add_item(strItem) 
	{
		...
		MC_STEP			= arrItem[3];
		MC_PROG 		= arrItem[4];		
		MC_PROGAPPVAL 	= arrItem[5];
		MC_NOTES 		= arrItem[6];
		MC_TOTVAL 		= arrItem[7];
		MC_TOTVAL_PPn 	= arrItem[8];
		MC_TOTVAL_PPh 	= arrItem[9];
		MC_GTOTVAL 		= arrItem[10];
		
		/*validateDouble(SI_CODE)
		if(validateDouble(SI_CODE))
		{
			alert("Double Item for " + SI_CODE);
			return;
		}*/
		...
		objTD.noWrap = true;
		objTD.innerHTML = ''+MC_CODE+'<input type="text" id="data'+intIndex+'MC_CODE" name="data['+intIndex+'][MC_CODE]" value="'+MC_CODE+'" width="10" size="15" readonly class="textbox"><input type="text" id="data'+intIndex+'MC_MANNO" name="data['+intIndex+'][MC_MANNO]" value="'+MC_MANNO+'" width="10" size="15" readonly class="textbox">';
		...
		objTD = objTR.insertCell(objTR.cells.length);
		objTD.style.textAlign = 'right';
		objTD.innerHTML = ''+MC_PROGAPPVAL1+'<input type="hidden" style="text-align:right" name="data['+intIndex+'][MC_PROGAPPVAL]" id="data'+intIndex+'MC_PROGAPPVAL" size="10" value="'+MC_PROGAPPVAL+'" class="textbox" onKeyPress="return isIntOnlyNew(event);" onBlur="getConvertion(this,'+intIndex+');" >';
		...
		objTD = objTR.insertCell(objTR.cells.length);
		objTD.style.textAlign = 'right';
		objTD.innerHTML = ''+MC_GTOTVAL1+'<input type="hidden" style="text-align:right" name="data['+intIndex+'][MC_GTOTVAL]" id="data'+intIndex+'MC_GTOTVAL" size="10" value="'+MC_GTOTVAL+'" class="textbox" onKeyPress="return isIntOnlyNew(event);" >';
	...
	function submitForm(value)
	{
		...
		if(ISAPPROVE == 1)
		{
			...
			if(MCH_PROGAPP == 0)
			{
				alert('Please input Progress Approve Presentation');
		...
		if(MCH_STATX == 3)
		{
			alert('The Document has been Approved/Closed. You can not update.')
			return false;
		}
		else
		{
