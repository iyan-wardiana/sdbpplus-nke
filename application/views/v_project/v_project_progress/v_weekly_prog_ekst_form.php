		                      	...
		                      	<div class="form-group">
									...
									<div class="col-sm-3">
										<div class="input-group date">
											...
											<input type="hidden" name="PRJP_DATE_S" class="form-control pull-left" id="datepicker2" value="<?php echo $Prg_Date1; ?>" style="width:100px" <?php if($PRJP_STAT_EKS != 1 && $PRJP_STAT_EKS != 4) { ?> readonly <?php } ?> >
											<input type="text" name="PRJP_DATE1_S" class="form-control pull-left" id="datepicker2" value="<?php echo $Prg_Date1; ?>" style="width:100px" <?php if($PRJP_STAT_EKS != 1 && $PRJP_STAT_EKS != 4) { ?> readonly <?php } ?> disabled>
										</div>
									</div>
		                            <div class="col-sm-2">
		                            ...
		                            <div class="col-sm-3">
		                              	<div class="input-group date">
		                                  	<div class="input-group-addon"><i class="fa fa-calendar"></i></div>
		                                  	<input type="hidden" name="PRJP_DATE_E" class="form-control pull-left" id="datepicker3" value="<?php echo $Prg_Date2; ?>" style="width:100px" <?php if($PRJP_STAT_EKS != 1 && $PRJP_STAT_EKS != 4) { ?> readonly <?php } ?> >
		                                  	<input type="text" name="PRJP_DATE1_E" class="form-control pull-left" id="datepicker3" value="<?php echo $Prg_Date2; ?>" style="width:100px" <?php if($PRJP_STAT_EKS != 1 && $PRJP_STAT_EKS != 4) { ?> readonly <?php } ?> disabled>
		                                </div>
		                            </div>
		                        </div>
				            	<div class="form-group" style="display: none;">
												...
												if($ISAPPROVE == 1)
												{
													...
													else
													{
														...
														if($canApprove == 0)
															$disButton	= 1;													
														?>
															<select name="PRJP_STAT_EKS" id="PRJP_STAT_EKS" class="form-control select2" disabled>
																<option value="1"<?php if($PRJP_STAT_EKS == 1) { ?> selected <?php } ?> >New</option>
																<option value="2"<?php if($PRJP_STAT_EKS == 2) { ?> selected <?php } ?> >Confirm</option>
																<option value="3"<?php if($PRJP_STAT_EKS == 3) { ?> selected <?php } ?> >Approved</option>
															</select>
