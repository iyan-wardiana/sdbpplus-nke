...
$PRJP_PERC_PI	= $default['PRJP_PERC_PI'];
$PRJP_PERC_PEKS	= $default['PRJP_PERC_PEKS'];
$Patt_Number	= $default['Patt_Number'];

if($PRJP_PERC_PEKS == 0)
$PRJP_PERC_PEKS	= $PRJP_PERC_PI;
						...
						<div class="box box-primary">
							...
							<div class="box-body">
				            	...
				            	<div class="form-group">
				                    ...
				                    <div class="col-sm-9">
				                        <select name="PRJP_STEP" id="PRJP_STEP" class="form-control select2" style="max-width:70px" onChange="selProgStep(this.value)" <?php if($PRJP_STAT_EKS != 1 && $PRJP_STAT_EKS != 4) { ?> disabled <?php } ?> >
				                            <?php
				                                if($resCountAll > 0)
				                                {
				                                    ...
				                                    {
				                                    ?>
				                                        <option value="<?php echo $i; ?>" <?php if(($i < $PRJP_STEP_APP) AND $i != $PRJP_STEPC) { ?> disabled <?php } if($i == $PRJP_STEPC) { ?> selected <?php } ?>><?php echo $i; ?></option>
				                                    <?php
				                                    }
				                                }
												else
		                      	...
		                      	<div class="form-group">
									...
									<div class="col-sm-3">
										<div class="input-group date">
											...
											<input type="text" name="PRJP_DATE_S" class="form-control pull-left" id="datepicker2" value="<?php echo $Prg_Date1; ?>" style="width:100px" <?php if($PRJP_STAT_EKS != 1 && $PRJP_STAT_EKS != 4) { ?> readonly <?php } ?> >
										</div>
									</div>
		                            <div class="col-sm-2">
		                            ...
		                            <div class="col-sm-3">
		                              	<div class="input-group date">
		                                  	<div class="input-group-addon"><i class="fa fa-calendar"></i></div>
		                                  	<input type="text" name="PRJP_DATE_E" class="form-control pull-left" id="datepicker3" value="<?php echo $Prg_Date2; ?>" style="width:100px" <?php if($PRJP_STAT_EKS != 1 && $PRJP_STAT_EKS != 4) { ?> readonly <?php } ?> >
		                                </div>
		                            </div>
		                        </div>
				            	<div class="form-group" style="display: none;">
				            	...
				            	<div class="form-group">
				                    ...
				                    <div class="col-sm-9">
				                    	<textarea name="PRJP_DESC" class="form-control" id="PRJP_DESC" cols="30" placeholder="<?php echo $Description; ?>" style="height: 75px" <?php if($PRJP_STAT_EKS != 1 && $PRJP_STAT_EKS != 4) { ?> readonly <?php } ?>><?php echo $PRJP_DESC; ?></textarea>
				                    </div>
				                </div>
					        </div>
					    </div>
					...
					<div class="col-md-6">
						<div class="box box-warning">
							<div class="box-header with-border">
								...
								<h3 class="box-title"><?php echo "$mnName ($PRJCODE)"; ?></h3>
							</div>
							<div class="box-body">
				                <?php
									$PRJP_TOTBEF	= 0;
								...
								?>
				            	<div class="form-group">
				                    <label for="inputName" class="col-sm-3 control-label">Prog. Sebelumnya</label>
				                    <div class="col-sm-3">
				                    	<input type="hidden" class="form-control" style="text-align:right" name="PRJP_TOTBEF" id="PRJP_TOTBEF" value="<?php echo $PRJP_TOTBEF; ?>" />
				                    	<input type="text" class="form-control" style="text-align:right" name="PRJP_TOTBEFX" id="PRJP_TOTBEFX" value="<?php echo number_format($PRJP_TOTBEF, 4); ?>" readonly />
				                    </div>
				                    <label for="inputName" class="col-sm-3 control-label">Prog. Akumulasi</label>
				                    <div class="col-sm-3">
				                    	<input type="text" class="form-control" style="text-align:right" name="PRJP_GTOTX" id="PRJP_GTOTX" value="<?php echo number_format($PRJP_GTOT, 4); ?>" readonly />
				            	...
				            	<div class="form-group">
				                    <div class="col-sm-3">
				                    	<label for="inputName" class="control-label pull-right">Prog. Saat Ini</label>
				                    </div>
				                    <div class="col-sm-3">
				                    	<input type="text" class="form-control" style="text-align:right" name="PRJP_TOTX" id="PRJP_TOTX" value="<?php echo number_format($PRJP_TOT, 4); ?>" readonly />
				                    ...
				                    <div class="col-sm-3">
				                    	<label for="inputName" class="control-label pull-right">Prog. Akumulasi (%)</label>
				                    </div>
				                    <div class="col-sm-3">
				                    	<input type="text" class="form-control" style="text-align:right" name="PRJPRGSX" id="PRJPRGSX" value="<?php echo number_format($PRJP_PERC_PEKS, 2); ?>" readonly />
				                    	<input type="hidden" class="form-control" style="text-align:right" name="PRJPRGS" id="PRJPRGS" value="<?php echo $PRJP_PERC_PEKS; ?>" />
				                    </div>
				                </div>
				            	<div class="form-group">
										...
										<?php
											// START : FOR ALL APPROVAL FUNCTION
												...
												if($task == 'add')
												{
													...
													{
														?>
															<select name="PRJP_STAT_EKS" id="PRJP_STAT_EKS" class="form-control select2" <?php if($disButton == 1){ ?> disabled <?php } ?>>
												...
												else
												{
													...
													if($ISCREATE == 1)
													{
														if($PRJP_STAT_EKS == 1 || $PRJP_STAT_EKS == 4)
														{
															//$disButton	= 0;
															?>
																<select name="PRJP_STAT_EKS" id="PRJP_STAT_EKS" class="form-control select2" <?php if($disButton == 1){ ?> disabled <?php } ?>>
														...
														elseif($PRJP_STAT_EKS == 2 || $PRJP_STAT_EKS == 7)
														{
															//$disButton	= 0;
															if($canApprove == 0)
																$disButton	= 1;
															...
															if($resCAPPHE > 0)
																$disButton	= 1;										
															?>
																<select name="PRJP_STAT_EKS" id="PRJP_STAT_EKS" class="form-control select2" onChange="selStat(this.value)" >
																	<option value="1"<?php if($PRJP_STAT_EKS == 1) { ?> selected <?php } ?> disabled>New</option>
																	...
																	<option value="4"<?php if($PRJP_STAT_EKS == 4) { ?> selected <?php } ?> >Revising</option>
																	<option value="5"<?php if($PRJP_STAT_EKS == 5) { ?> selected <?php } ?> >Rejected</option>
																	<option value="6"<?php if($PRJP_STAT_EKS == 6) { ?> selected <?php } ?> disabled>Closed</option>
																	<option value="7"<?php if($PRJP_STAT_EKS == 7) { ?> selected <?php } ?> >Waiting</option>
																	<option value="9"<?php if($PRJP_STAT_EKS == 9) { ?> selected <?php } ?> disabled>Void</option>
																</select>
															<?php
														}
														elseif($PRJP_STAT_EKS == 3)
														{
															...
															?>
																<select name="PRJP_STAT_EKS" id="PRJP_STAT_EKS" class="form-control select2" >
																	<option value="1"<?php if($PRJP_STAT_EKS == 1) { ?> selected <?php } ?> disabled>New</option>
																	<option value="2"<?php if($PRJP_STAT_EKS == 2) { ?> selected <?php } ?> disabled>Confirm</option>
																	<option value="3"<?php if($PRJP_STAT_EKS == 3) { ?> selected <?php } ?> >Approved</option>
																	<option value="4"<?php if($PRJP_STAT_EKS == 4) { ?> selected <?php } ?> disabled>Revising</option>
																	<option value="5"<?php if($PRJP_STAT_EKS == 5) { ?> selected <?php } ?> disabled>Rejected</option>
																	<option value="6"<?php if($PRJP_STAT_EKS == 6) { ?> selected <?php } ?> disabled>Closed</option>
																	<option value="7"<?php if($PRJP_STAT_EKS == 7) { ?> selected <?php } ?> disabled >Waiting</option>
																	<option value="9"<?php if($PRJP_STAT_EKS == 9) { ?> selected <?php } ?> disabled>Void</option>
																</select>
															<?php
														}
				                ...
				                <div class="form-group">
				                    ...
				                    <div class="col-sm-9">
				                        <?php
											...
											if($disableAll == 0)
											{
												if(($PRJP_STAT_EKS == 2 || $PRJP_STAT_EKS == 7) && $canApprove == 1)
												{
													?>
												...
												elseif($PRJP_STAT_EKS == 1 || $PRJP_STAT_EKS == 4)
												{
														?>
											...
											$backURL	= site_url('c_project/c_uPpR09r355/pR09r355Lst_ekst/?id='.$this->url_encryption_helper->encode_url($PRJCODE));
	                        ...
	                        <div class="search-table-outter">
	                            <table id="tbl" class="table table-bordered table-striped" width="100%">
		                        	<tr style="background:#CCCCCC">
		                              	...
		                              	<th width="8%" style="text-align:center; vertical-align: middle;">Bobot (%) </th>
		                              	...
		                              	<th width="8%" style="text-align:center; vertical-align: middle;">Progres Ekst.</th>
		                              	<th width="5%" style="text-align:center; vertical-align: middle;">%</th>
		                              	<th width="12%" style="text-align:center; vertical-align: middle;"><?php echo $Remarks; ?></th>
		                          	</tr>
		                            <?php					
										if($task == 'edit')
										{
											...
											/*$sqlDET		= "SELECT A.JOBCODEID, B.JOBDESC, B.ITM_VOLM AS PROG_BUDG, B.ITM_BUDG AS BOQ_JOBCOST,
																A.PROG_VAL, A.PROG_PERC, A.BOQ_BOBOT, A.PROG_VAL_EKS, A.PROG_PERC_EKS, B.ITM_UNIT, A.PROG_DESC
															...
															WHERE A.PRJP_NUM = '$PRJP_NUM'
																AND A.PRJCODE = '$PRJCODE' AND A.BOQ_BOBOT > 0 AND ISLASTH = 1
															ORDER BY A.JOBCODEID ASC";*/
											/*$sqlDET		= "SELECT A.JOBCODEID, B.JOBDESC, B.BOQ_VOLM AS PROG_BUDG, B.BOQ_JOBCOST,
																A.PROG_VAL, A.PROG_PERC, A.BOQ_BOBOT, A.PROG_VAL_EKS, A.PROG_PERC_EKS, B.ITM_UNIT, A.PROG_DESC
															FROM tbl_project_progress_det A
																INNER JOIN tbl_joblist_detail_$PRJCODEVW B ON A.JOBCODEID = B.JOBCODEID AND A.PRJCODE = B.PRJCODE
															WHERE A.PRJP_NUM = '$PRJP_NUM'
											...
											$sqlDET		= "SELECT A.JOBCODEID, B.JOBDESC, B.BOQ_VOLM AS PROG_BUDG, B.BOQ_JOBCOST,
															...
															FROM tbl_project_progress_det A
																INNER JOIN tbl_joblist_detail_$PRJCODEVW B ON A.JOBCODEID = B.JOBCODEID AND A.PRJCODE = B.PRJCODE
															WHERE A.PRJP_NUM = '$PRJP_NUM'
																AND A.PRJCODE = '$PRJCODE' AND A.BOQ_BOBOT > 0
															ORDER BY A.JOBCODEID ASC";
											...
											foreach($result as $row) :
												...
												$sqlTOTBEF		= "SELECT SUM(PROG_VAL) AS TOTBEF_VAL FROM tbl_project_progress_det A 
																	INNER JOIN tbl_project_progress B ON A.PRJP_NUM = B.PRJP_NUM
																	WHERE JOBCODEID = '$JOBCODEID' AND A.PRJCODE = '$PRJCODE' AND B.PRJP_STAT = 3
																	AND B.PRJP_ID < (SELECT A.PRJP_ID FROM tbl_project_progress A WHERE A.PRJCODE  = '$PRJCODE' AND PRJP_NUM = '$PRJP_NUM')";
												$resTOTBEF 		= $this->db->query($sqlTOTBEF)->result();
												foreach($resTOTBEF as $rowTOTBEF) :
			                                    ...
			                                    <tr id="tr_<?php echo $currentRow; ?>">
													...
													<td nowrap style="text-align:right">
				                                    	<input type="hidden" name="data<?php echo $currentRow; ?>BOQ_BOBOTX" id="data<?php echo $currentRow; ?>BOQ_BOBOTX" value="<?php echo $BOQ_BOBOT; ?>" class="form-control" style="min-width:100px; max-width:150px; text-align:right" readonly >
				                                    	...
				                                    	<?php echo number_format($BOQ_BOBOT, 6); ?>
				                                    </td>
													<td nowrap style="text-align:right">
				                                    	<input type="hidden" name="data<?php echo $currentRow; ?>PROG_BUDGX" id="data<?php echo $currentRow; ?>PROG_BUDGX" value="<?php echo $PROG_BUDG; ?>" class="form-control" style="min-width:100px; max-width:150px; text-align:right" readonly >
													...
													<td nowrap style="text-align:center">
				                                    	<input type="hidden" name="JOBUNIT<?php echo $currentRow; ?>" id="JOBUNIT<?php echo $currentRow; ?>" value="<?php echo $JOBUNIT; ?>" class="form-control" style="min-width:50px; max-width:100px; text-align:center" readonly >
				                                    	<?php echo $JOBUNIT; ?>
				                                    </td>
													<td nowrap style="text-align:right">
														<?php
															if($BOQ_JOBCOST == 0 && $BOQ_BOBOT > 0)
															{ ?>
						                                    	<input type="hidden" name="<?php echo $currentRow; ?>PROG_BEF" id="PROG_BEF<?php echo $currentRow; ?>" value="<?php echo $TOTBEF_VAL; ?>" class="form-control" style="max-width:150px; text-align:right" readonly >
						                                    	...
						                                    	<?php echo number_format($TOTBEF_VAL, 6); ?>
				                                    			<?php
															}
															else
															{ ?>
													...
													<td nowrap style="text-align:right;">
														<?php
															if($BOQ_JOBCOST == 0 && $BOQ_BOBOT > 0)
															{ ?>
				                                    			<input type="hidden" name="PROG_VAL<?php echo $currentRow; ?>" id="PROG_VAL<?php echo $currentRow; ?>" value="<?php echo number_format($PROG_VAL, 2); ?>" class="form-control" style="min-width:110px; max-width:300px; text-align:right" onKeyPress="return isIntOnlyNew(event);" onBlur="getConvertion(this,<?php echo $currentRow; ?>);" readonly >
						                                    	...
						                                    	<?php echo number_format($PROG_VAL, 6); ?>
				                                    			<?php
															}
															else
															{ ?>
				                                    			<input type="hidden" name="PROG_VAL<?php echo $currentRow; ?>" id="PROG_VAL<?php echo $currentRow; ?>" value="<?php echo number_format($PROG_VAL, 2); ?>" class="form-control" style="min-width:110px; max-width:300px; text-align:right" onKeyPress="return isIntOnlyNew(event);" onBlur="getConvertion(this,<?php echo $currentRow; ?>);" readonly >
						                                        <input type="hidden" name="data[<?php echo $currentRow; ?>][PROG_VAL]" id="data<?php echo $currentRow; ?>PROG_VAL" value="<?php echo $PROG_VAL; ?>" class="form-control" style="max-width:300px;" >
						                                    	<?php echo number_format($PROG_VAL, 2); ?>
				                                    			<?php
															}
														?>
				                                    </td>
													<td nowrap style="text-align:center">
				                                    	<input type="hidden" name="PROG_PERC<?php echo $currentRow; ?>" id="PROG_PERC<?php echo $currentRow; ?>" value="<?php echo number_format($PROG_PERC, 16); ?>" class="form-control" style="min-width:80px; max-width:80px; text-align:right" onKeyPress="return isIntOnlyNew(event);" onBlur="getConvertion(this,<?php echo $currentRow; ?>);" size="10" readonly >
				                                    	...
				                                    	<?php echo number_format($PROG_PERC, 16); ?>
				                                    </td>
													<td nowrap style="text-align:center">
														<?php
															if($BOQ_JOBCOST == 0 && $BOQ_BOBOT > 0)
															{ ?>
						                                    	<input type="text" name="PROG_VAL_EKS<?php echo $currentRow; ?>" id="PROG_VAL_EKS<?php echo $currentRow; ?>" value="<?php echo number_format($PROG_VAL_EKS, 6); ?>" class="form-control" style="min-width:110px; max-width:300px; text-align:right" onKeyPress="return isIntOnlyNew(event);" onBlur="getConvertion_ekst(this,<?php echo $currentRow; ?>);">
													...
													<td nowrap style="text-align:center">
				                                        ...
				                                        <?php echo number_format($PROG_PERC_EKS, 16); ?>
				                                    </td>
												  	<td style="text-align:left">
...
<script>
	...
	function selStat(PRJP_STAT_EKS)
	{
		if(PRJP_STAT_EKS == 3 || PRJP_STAT_EKS == 4 || PRJP_STAT_EKS == 5)
		{
	...
	function getConvertion(thisVal1, row)
	{
		...
		document.getElementById('PROG_VAL'+row).value		= doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(PROG_VAL)), 16));
		...
		document.getElementById('PROG_PERC'+row).value		= doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(PROG_PERC)), 16));
		...
		document.getElementById('PRJPRGSX').value		= doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(PRJP_TOT * 100)), 2));
		document.getElementById('PRJPRGS').value		= Math.abs(PRJP_TOT * 100);
		/*document.getElementById('PRJPRGSX').value		= doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(PRJP_TOT)), 2));
		document.getElementById('PRJPRGS').value		= Math.abs(PRJP_TOT);*/
		//document.getElementById('PRJPRGS').value		= doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(PRJP_TOT)), 3));
	...
	function getConvertion_ekst(thisVal1, row)
	{
		...
		// CHECK PROGRESS BEFORE
		BOQ_BOBOT		= parseFloat(document.getElementById('data'+row+'BOQ_BOBOT').value);
		PROG_BUDG		= parseFloat(document.getElementById('data'+row+'PROG_BUDG').value);
		PROG_BEF		= parseFloat(document.getElementById('data'+row+'PROG_BEF').value);
		PROG_VAL		= parseFloat(eval(thisVal1).value.split(",").join(""));

		if(PROG_BUDG == 0 && BOQ_BOBOT > 0)
		{
			TOLERANCE		= 0.1 * parseFloat(BOQ_BOBOT);
			PROG_REM		= parseFloat(BOQ_BOBOT) - parseFloat(PROG_BEF);
			//PROG_REM		= parseFloat(PROG_BUDG) - parseFloat(PROG_BEF) + parseFloat(TOLERANCE);
			...
			document.getElementById('data'+row+'PROG_VAL_EKS').value= PROG_VAL;
			document.getElementById('PROG_VAL_EKS'+row).value		= doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(PROG_VAL)), 6));
			
			PROG_TOT		= parseFloat(PROG_BEF) + parseFloat(PROG_VAL);
			
			// CURRENT PROGRESS
				PROG_PERC	= parseFloat(PROG_VAL);
			
			// AKUM. PROGRESS
				PROG_PERCT	= parseFloat(PROG_TOT);
			
			document.getElementById('data'+row+'PROG_PERC_EKS').value = PROG_PERC;
			document.getElementById('PROG_PERC_EKS'+row).value		= doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(PROG_PERC)), 16));
			
			PRJP_TOT	= 0;
			PRJP_GTOT	= 0;
			for(i=1;i<=totrow;i++)
			{
				var PROG_PERC	= document.getElementById('data'+i+'PROG_PERC_EKS').value;
				var PROG_VAL	= document.getElementById('data'+i+'PROG_VAL_EKS').value;				
				PRJP_TOT		= parseFloat(PRJP_TOT) + parseFloat(PROG_PERC);
			}
			...
			document.getElementById('PRJP_TOT').value		= PRJP_TOT;
			document.getElementById('PRJP_TOTX').value		= doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(PRJP_TOT)), 4));
			document.getElementById('PRJPRGSX').value		= doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(PRJP_GTOT * 100)), 2));
			document.getElementById('PRJPRGS').value		= Math.abs(PRJP_GTOT * 100);
			/*document.getElementById('PRJPRGSX').value		= doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(PRJP_GTOT)), 2));
			document.getElementById('PRJPRGS').value		= Math.abs(PRJP_GTOT);*/
			document.getElementById('PRJP_GTOT').value		= PRJP_GTOT;
			document.getElementById('PRJP_GTOTX').value		= doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(PRJP_GTOT)), 4));
		}
		else
		{
			...
			document.getElementById('data'+row+'PROG_VAL_EKS').value= PROG_VAL;
			document.getElementById('PROG_VAL_EKS'+row).value		= doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(PROG_VAL)), 2));
			
			PROG_TOT		= parseFloat(PROG_BEF) + parseFloat(PROG_VAL);
			console.log('PROG_TOT = '+PROG_TOT)
			
			// CURRENT PROGRESS
				PROG_PERC	= parseFloat(PROG_VAL) / parseFloat(PROG_BUDG) * parseFloat(BOQ_BOBOT);
			console.log('PROG_PERC = '+PROG_VAL+' / '+PROG_BUDG+' * '+BOQ_BOBOT)
			
			// AKUM. PROGRESS
				PROG_PERCT	= parseFloat(PROG_TOT) / parseFloat(PROG_BUDG) * parseFloat(BOQ_BOBOT);
			console.log('PROG_PERCT = '+PROG_TOT+' / '+PROG_BUDG+' * '+BOQ_BOBOT)
			...
			document.getElementById('PRJPRGSX').value		= doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(PRJP_GTOT * 100)), 2));
			document.getElementById('PRJPRGS').value		= Math.abs(PRJP_GTOT * 100);
			//document.getElementById('PRJPRGS').value		= doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(PRJP_GTOT)), 3));
			document.getElementById('PRJP_GTOT').value		= PRJP_GTOT;
			document.getElementById('PRJP_GTOTX').value		= doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(PRJP_GTOT)), 4));
		}
	}
	
	function getConvertion_ekst_aaa(thisVal1, row)
	{
		var decFormat	= document.getElementById('decFormat').value;
		totrow			= document.getElementById('totalrow').value;
	...
	function getConvertion_ekst_xx(thisVal1, row)
	{
		var decFormat	= document.getElementById('decFormat').value;
		totrow			= document.getElementById('totalrow').value;
		...
		document.getElementById('PROG_VAL_EKS'+row).value			= doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(PROG_VAL_EKS)), 16));
		...
		document.getElementById('PROG_PERC_EKS'+row).value			= doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(PROG_PERC_EKS)), 16));
