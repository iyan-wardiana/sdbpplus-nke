...
{	
	...
	$Prg_Date1 		= date('Y-m-d');
	$Prg_Date2 		= date('Y-m-d');
	$PRJP_DESC		= '';
	$PRJP_STAT		= 1;
	$PRJP_TOT		= 0;
	$PRJP_GTOT		= 0;
...
<html>
    ...
    <body class="<?php echo $appBody; ?>" style="background-color: <?=$comp_color?>">
		<section class="content-header">
			<h1>
		    <img src="<?php echo base_url() . 'assets/AdminLTE-2.0.5/dist/img/icon/progress.png'; ?>" style="max-width:40px; max-height:40px" >&nbsp;&nbsp;<?php echo "$subTitleH ($PRJCODE)"; ?>
		                      	...
		                      	<div class="form-group">
									...
									<div class="col-sm-3">
										<div class="input-group date">
											...
											<input type="hidden" name="PRJP_DATE_S" class="form-control pull-left" id="PRJP_DATE_S" value="<?php echo $Prg_Date1; ?>" style="width:100px" >
											<input type="text" name="PRJP_DATE1_S" class="form-control pull-left" id="datepicker2" value="<?php echo $Prg_Date1; ?>" style="width:100px" disabled>
										</div>
									</div>
		                            <div class="col-sm-2">
		                            ...
		                            <div class="col-sm-3">
		                              	<div class="input-group date">
		                                  	<div class="input-group-addon"><i class="fa fa-calendar"></i></div>
		                                  	<input type="hidden" name="PRJP_DATE_E" class="form-control pull-left" id="datepicker3" value="<?php echo $Prg_Date2; ?>" style="width:100px" >
		                                  	<input type="text" name="PRJP_DATE1_E" class="form-control pull-left" id="datepicker3" value="<?php echo $Prg_Date2; ?>" style="width:100px" disabled>
		                                </div>
		                            </div>
		                        </div>
				            	<div class="form-group" style="display: none;">
						...
						<div class="box box-warning">
							...
							<div class="box-body">
				            	...
				            	<div class="form-group">
				                    ...
				                    <div class="col-sm-3">
				                    	<input type="text" class="form-control" style="text-align:right" name="PRJPRGSX" id="PRJPRGSX" value="<?php echo number_format($PRJP_PERC_PI, 2); ?>" readonly />
				                    	<input type="hidden" class="form-control" style="text-align:right" name="PRJPRGS" id="PRJPRGS" value="<?php echo $PRJP_PERC_PI; ?>" />
				                    </div>
				                </div>
				            	<div class="form-group">
											...
											// START : FOR ALL APPROVAL FUNCTION
												...
												else
												{
													...
													if(($ISCREATE == 1 && $ISAPPROVE == 1))
													{
														...
														elseif($PRJP_STAT == 2 || $PRJP_STAT == 7)
														{
															$disButton	= 0;
															if($canApprove == 0)
																$disButton	= 1;
														...
														elseif($PRJP_STAT == 3)
														{
															...
															?>
																<select name="PRJP_STAT" id="PRJP_STAT" class="form-control select2" <?php if($disButton == 1){ ?> disabled <?php } ?>>
																	...
																	<option value="6"<?php if($PRJP_STAT == 6) { ?> selected <?php } ?> disabled>Closed</option>
																	<option value="7"<?php if($PRJP_STAT == 7) { ?> selected <?php } ?> disabled>Waiting</option>
																	<option value="9"<?php if($PRJP_STAT == 9) { ?> selected <?php } ?>>Void</option>
																</select>
															<?php
				                    ...
				                    <div class="col-sm-3">
				                        ...
				                        <?php if($PRJP_STAT == 1 || $PRJP_STAT == 4) { ?>
	                        ...
	                        <div class="search-table-outter">
	                            <table id="tbl" class="table table-bordered table-striped" width="100%">
		                        	<tr style="background:#CCCCCC">
		                              	...
		                              	<th width="10%" style="text-align:center; vertical-align: middle;">Bobot (%) </th>
		                            ...
		                            <?php					
										if($task == 'edit')
										{
											...
											/*$sqlDET		= "SELECT A.JOBCODEID, B.JOBDESC, B.ITM_VOLM AS PROG_BUDG, B.ITM_BUDG AS BOQ_JOBCOST,
																A.PROG_VAL, A.PROG_PERC, A.BOQ_BOBOT, B.ITM_UNIT, A.PROG_DESC
															...
															ORDER BY A.JOBCODEID ASC";*/
											/*$sqlDET		= "SELECT A.PRJPD_ID, A.JOBCODEID, B.JOBDESC, B.BOQ_VOLM AS PROG_BUDG, B.BOQ_JOBCOST,
																A.PROG_VAL, A.PROG_PERC, A.BOQ_BOBOT, B.ITM_UNIT, A.PROG_DESC
															FROM tbl_project_progress_det A
																INNER JOIN tbl_joblist_detail_$PRJCODEVW B ON A.JOBCODEID = B.JOBCODEID AND A.PRJCODE = B.PRJCODE
															WHERE A.PRJP_NUM = '$PRJP_NUM'
											...
											foreach($result as $row) :
			                                    ...
			                                    <tr id="tr_<?php echo $currentRow; ?>">
													...
													<td nowrap style="text-align:center">
				                                    	<input type="hidden" name="JOBUNIT<?php echo $currentRow; ?>" id="JOBUNIT<?php echo $currentRow; ?>" value="<?php echo $JOBUNIT; ?>" class="form-control" style="min-width:50px; max-width:100px; text-align:center" >
				                                    	<?php echo $JOBUNIT; ?>
				                                    </td>
													<td nowrap style="text-align:right">
														<?php
															...
															{ ?>
						                                    	<input type="hidden" name="<?php echo $currentRow; ?>PROG_BEF" id="PROG_BEF<?php echo $currentRow; ?>" value="<?php echo $TOTBEF_VAL; ?>" class="form-control" style="max-width:150px; text-align:right" >
													...
													<td nowrap style="text-align:center">
														<?php
															if($BOQ_JOBCOST == 0 && $BOQ_BOBOT > 0)
															{ ?>
				                                    			<input type="text" name="PROG_VAL<?php echo $currentRow; ?>" id="PROG_VAL<?php echo $currentRow; ?>" value="<?php echo number_format($PROG_VAL, 6); ?>" class="form-control" style="min-width:110px; max-width:300px; text-align:right" onKeyPress="return isIntOnlyNew(event);" onBlur="getVAL(this,<?php echo $currentRow; ?>);" >
				                                    			<?php
															}
															else
															{ ?>
				                                    			<input type="text" name="PROG_VAL<?php echo $currentRow; ?>" id="PROG_VAL<?php echo $currentRow; ?>" value="<?php echo number_format($PROG_VAL, 2); ?>" class="form-control" style="min-width:110px; max-width:300px; text-align:right" onKeyPress="return isIntOnlyNew(event);" onBlur="getVAL(this,<?php echo $currentRow; ?>);" >
				                                    			<?php
															}
														?>
													...
													<td nowrap style="text-align:center">
				                                    	<input type="text" name="PROG_PERC<?php echo $currentRow; ?>" id="PROG_PERC<?php echo $currentRow; ?>" value="<?php echo number_format($PROG_PERC, 16); ?>" class="form-control" style="min-width:80px;text-align:right" onKeyPress="return isIntOnlyNew(event);" size="10" readonly >
							            	...
							            	<div class="<?php echo $Active1; ?> tab-pane" id="itm1">
		                                        <div class="form-group">
		                                        	<form method="post" name="frmSearch1" id="frmSearch1" action="">
			                                            <table id="listjob" class="table table-bordered table-striped table-responsive search-table inner" width="100%">
			                                                <thead>
			                                                    <tr>
			                                                        <th width="2%" style="text-align: center; vertical-align: middle;">&nbsp;</th>
			                                                        <th width="55%" style="text-align: center; vertical-align: middle;" nowrap><?php echo $JobCode; ?></th>
			                                                        <th width="3%" style="text-align: center; vertical-align: middle;" nowrap><?php echo $Unit; ?></th>
			                                                        <th width="10%" style="text-align: center; vertical-align: middle;" nowrap>Bobot (%)</th>
			                                                        <th width="10%" style="text-align: center; vertical-align: middle;" nowrap>Volume</th>
			                                                        <th width="10%" style="text-align: center; vertical-align: middle;" nowrap>Progress Int.</th>
			                                                        <th width="10%" style="text-align: center; vertical-align: middle;" nowrap>Progress Ekst.</th>
			                                                  	</tr>
			                                                </thead>
			                                                <tbody>
			                                                </tbody>
				...
				<script type="text/javascript">
					$(document).ready(function()
					{
				    	$('#listjob').DataTable(
				    	{
							...
							"autoWidth": true,
							"filter": true,
					        "ajax": "<?php echo site_url('c_project/c_uPpR09r355/get_AllDataJL/?id='.$PRJCODE.'&PRNUM='.$PRJP_NUM)?>",
					        "type": "POST",
...
<script>
	...
	function add_item(strItem) 
	{
		...
		PROG_VAL 		= arrItem[8];
		PROG_PERC		= arrItem[9];
		BOQ_BOBOT		= arrItem[10];
		// AMD_VOL			= arrItem[11];
		// AMD_VAL			= arrItem[12];
		AMD_VOL			= arrItem[14];
		AMD_VAL			= arrItem[15];

		console.log("JOBVOLM = "+JOBVOLM+" AMD_VOL = "+AMD_VOL);
		
		PROG_BUDG		= parseFloat(JOBVOLM) + parseFloat(AMD_VOL);
		PROG_BEF		= parseFloat(PROG_VAL);
		...
		objTD = objTR.insertCell(objTR.cells.length);
		objTD.align = 'right';
		objTD.innerHTML = JOBCODEID+'<input type="hidden" name="data['+intIndex+'][PRJP_NUM]" id="data'+intIndex+'PRJP_NUM" value="<?php echo $PRJP_NUM; ?>" class="form-control" style="max-width:150px;" ><input type="hidden" name="data['+intIndex+'][PRJCODE]" id="data'+intIndex+'PRJCODE" value="<?php echo $PRJCODE; ?>" class="form-control" style="max-width:150px;" ><input type="hidden" name="data['+intIndex+'][JOBCODEID]" id="data'+intIndex+'JOBCODEID" value="'+JOBCODEID+'" class="form-control" style="max-width:150px;" onClick="selectAccount('+intIndex+');">';
		
		// Job Description
		objTD = objTR.insertCell(objTR.cells.length);
		objTD.align = 'left';
		objTD.noWrap = true;
		objTD.innerHTML = JOBDESC+'<input type="hidden" name="data'+intIndex+'JOBDESC" id="data'+intIndex+'JOBDESC" value="'+JOBDESC+'" class="form-control" style="max-width:500px;" placeholder="<?php echo $Description; ?>">';
		
		// Budget
		BOQ_BOBOTV = doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(BOQ_BOBOT)), 6));
		objTD = objTR.insertCell(objTR.cells.length);
		objTD.style.textAlign = 'right';
		objTD.innerHTML = BOQ_BOBOTV+'<input type="hidden" name="data'+intIndex+'BOQ_BOBOTX" id="data'+intIndex+'BOQ_BOBOTX" value="'+BOQ_BOBOT+'" class="form-control" style="min-width:110px; max-width:150px; text-align:right" readonly ><input type="hidden" name="data['+intIndex+'][BOQ_BOBOT]" id="data'+intIndex+'BOQ_BOBOT" value="'+BOQ_BOBOT+'" class="form-control" style="max-width:300px;" >';
		
		// Budget
		PROG_BUDGV = doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(PROG_BUDG)),decFormat));
		objTD = objTR.insertCell(objTR.cells.length);
		objTD.style.textAlign = 'right';
		objTD.innerHTML = PROG_BUDGV+'<input type="hidden" name="data'+intIndex+'PROG_BUDGX" id="data'+intIndex+'PROG_BUDGX" value="'+PROG_BUDG+'" class="form-control" style="min-width:110px; max-width:150px; text-align:right" disabled ><input type="hidden" name="data['+intIndex+'][PROG_BUDG]" id="data'+intIndex+'PROG_BUDG" value="'+PROG_BUDG+'" class="form-control" style="max-width:300px;" ><input type="hidden" name="data['+intIndex+'][BOQ_BOBOT]" id="data'+intIndex+'BOQ_BOBOT" value="'+BOQ_BOBOT+'" class="form-control" style="max-width:300px;" >';
		
		// Satuan
		objTD = objTR.insertCell(objTR.cells.length);
		objTD.style.textAlign = 'center';
		objTD.innerHTML = JOBUNIT+'<input type="hidden" name="JOBUNIT'+intIndex+'" id="JOBUNIT'+intIndex+'" value="'+JOBUNIT+'" class="form-control" style="min-width:50px; max-width:100px; text-align:center" disabled >';
		
		// Progress Before
		PROG_BEFV = doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(PROG_BEF)),decFormat));
		objTD = objTR.insertCell(objTR.cells.length);
		objTD.style.textAlign = 'right';
		objTD.innerHTML = PROG_BEFV+'<input type="hidden" name="data'+intIndex+'PROG_BEF" id="PROG_BEF'+intIndex+'" value="'+PROG_BEF+'" class="form-control" style="max-width:150px; text-align:right" disabled ><input type="hidden" name="data['+intIndex+'][PROG_BEF]" id="data'+intIndex+'PROG_BEF" value="'+PROG_BEF+'" class="form-control" style="max-width:300px;" >';
		...
		if(JOBVOLM == 0 && BOQ_BOBOT > 0)
			document.getElementById('PROG_PERC'+intIndex).readOnly 	= true;
		
		document.getElementById('totalrow').value = intIndex;
	}
	
	function getVAL(thisVal1, row)
	{
		decFormat		= document.getElementById('decFormat').value;
		...
		if(PROG_BUDG == 0 && BOQ_BOBOT > 0)
		{
			...
			document.getElementById('PROG_VAL'+row).value		= doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(PROG_VAL)), 6));
			...
			/*document.getElementById('PRJPRGSX').value		= doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(PRJP_GTOT)), 4));
		...
		else
		{
			...
			document.getElementById('data'+row+'PROG_VAL').value= PROG_VAL;
			document.getElementById('PROG_VAL'+row).value		= doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(PROG_VAL)), 2));
