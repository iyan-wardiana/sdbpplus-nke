 ...
 * Create Date	= 13 Januari 2016
 * File Name	= galeri_detil.php
 * Location		= -
*/
?>
<?php
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" id="detailPR">
        ...
        <tr>
            <td>                
                <ul id='produk'>
                    <?php						
						$QGaleri0	= "SELECT * FROM galeri_detail WHERE galeri_Kode = '$galeri_Kode'";
						...
						foreach($QGaleri as $AGaleri) :
							...
							<li class="lis-produk">
								...
								<a class="fancybox" href="<?php echo base_url() . 'images/foto/'.$file_Name.''; ?>" data-fancybox-group="gallery" title="<?php echo $file_Name;?>">
