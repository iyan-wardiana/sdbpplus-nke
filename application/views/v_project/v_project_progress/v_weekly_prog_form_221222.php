										...
										if($task == 'edit')
										{
											...
											foreach($result as $row) :
			                                    ...
			                                    <tr id="tr_<?php echo $currentRow; ?>">
													...
													<td nowrap style="text-align:center">
				                                    	<input type="text" name="PROG_PERC<?php echo $currentRow; ?>" id="PROG_PERC<?php echo $currentRow; ?>" value="<?php echo number_format($PROG_PERC, 4); ?>" class="form-control" style="min-width:80px; max-width:80px; text-align:right" onKeyPress="return isIntOnlyNew(event);" size="10" readonly >
		                                        	...
		                                        	<form method="post" name="frmSearch1" id="frmSearch1" action="">
			                                            <table id="listjob" class="table table-bordered table-striped table-responsive search-table inner" width="100%">
			                                                <thead>
			                                                    <tr>
			                                                        <th width="2%" style="text-align: center; vertical-align: middle;">&nbsp;</th>
			                                                        <th width="65%" style="text-align: center; vertical-align: middle;" nowrap><?php echo $JobCode; ?></th>
