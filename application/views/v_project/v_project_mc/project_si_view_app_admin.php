...
<table width="100%" border="0" style="size:auto">
    ...
    <tr>
    	<td rowspan="4" class="style2" style="text-align:left; font-weight:bold;" valign="top"><span class="style2" style="text-align:left; font-weight:bold;"><img src="<?php echo base_url().'images/Logo2.jpg'; ?>" width="300" height="70" /></span></td>
      <td colspan="2" nowrap class="style2" style="text-align:left; font-weight:bold; text-transform:uppercase; font-size:24px"> REKAPITULASI PERSETUJUAN SI - ADMIN</td>
    </tr>
    <tr>
