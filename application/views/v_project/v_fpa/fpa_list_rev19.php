      ...
      <table id="example1" class="table table-bordered table-striped" width="100%">
		<thead>
            <tr>
                ...
                <th style="vertical-align:middle; text-align:center" width="14%" nowrap><?php echo $NoFPA; ?> </th>
                <th width="10%" nowrap="nowrap" style="vertical-align:middle; text-align:center; display:none"><?php echo $Date; ?>  </th>
				...
				foreach($vwprojmatreq as $row) :				
					...
					if ($j==1) {
						...
						?>
								...
								<td style="display:none"> <?php print $FPA_CODE; ?></td>
                                ...
                                <?php
									$secUpd		= site_url('c_project/c_f180p0/up180d0bdt/?id='.$this->url_encryption_helper->encode_url($FPA_NUM));
								...
								<td style="text-align:center" nowrap>
                                    ...
                                    <a href="javascript:void(null);" class="btn btn-warning btn-xs" title="Opname" onClick="printDocument('<?php echo $myNewNo1; ?>')">
                                    ...
                                    <a href="#" onClick="deleteMail('<?php echo $secDel_WO; ?>')" title="Delete file" class="btn btn-danger btn-xs" <?php if($FPA_STAT > 1) { ?>disabled="disabled" <?php } ?>>
