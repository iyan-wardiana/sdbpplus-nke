      ...
      <table id="example1" class="table table-bordered table-striped" width="100%">
		<thead>
            <tr>
                ...
                <th style="vertical-align:middle; text-align:center; display:none" width="9%" nowrap><?php echo $Code; ?>  </th>
				...
				foreach($vData as $row) :				
					...
					if ($j==1) {
						...
						?>
								...
								<td style="display:none"> <?php print $WO_CODE; ?></td>
                                ...
                                <?php
									$secUpd		= site_url('c_project/c_s180d0bpk/r3q_70ls_up1a/?id='.$this->url_encryption_helper->encode_url($WO_NUM));
