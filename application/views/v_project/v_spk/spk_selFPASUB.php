                ...
                <?php
                    ...
                    if($countFPA>0)
                    {
                        ...
                        foreach($vwFPA as $row) :
                            ...
                            <td style="text-align:center" nowrap><?php echo $Date; ?></td>
                            <td nowrap><?php echo cut_text($JOBDESC, 30); ?></td>
                            <td style="text-align:left"><?php echo $FPA_NOTE; ?></td>
                            <td nowrap style="text-align:center"><?php echo $FPA_DATE; ?></td>
                            <td nowrap style="text-align:center"><?php echo $FPA_TSFD; ?></td>
                        </tr>
                        <?php
                        endforeach;
                    }
