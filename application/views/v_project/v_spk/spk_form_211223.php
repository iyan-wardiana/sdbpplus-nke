						...
						<div class="box box-primary">
							...
							<div class="box-body">
				            	...
				            	<div class="form-group">
				                    ...
				                    <div class="col-sm-3">
				                    	<select name="WO_CATEG" id="WO_CATEG" class="form-control select2" onChange="changeCODE(this.value)" >
				                          	...
				                          	<option value="SUB" <?php if($WO_CATEG == 'SUB') { ?> selected <?php } ?>> Subkon</option>
				                        </select>
				                    </div>
				                    <div class="col-sm-6">
				            	...
				            	<div class="form-group">
				                    ...
				                    <div class="col-sm-9">
				                    	<textarea name="WO_NOTE" class="form-control" id="WO_NOTE" cols="30" style="height: 60px" placeholder="Catatan SPK"><?php echo $WO_NOTE; ?></textarea>
				                    </div>
				                </div>
				            	<div class="form-group">
				                    <label for="inputName" class="col-sm-3 control-label"><?php echo $ApproverNotes; ?></label>
				                    <div class="col-sm-9">
				                    	<textarea name="WO_NOTE2" class="form-control" style="height: 60px" id="WO_NOTE2" cols="30" placeholder="<?php echo $ApproverNotes; ?>" readonly><?php echo $WO_NOTE2; ?></textarea>                        
				                    </div>
				                </div>
				            </div>
				        </div>
							...
							<div class="box-body">
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
			                            ...
			                            <input type="text" class="form-control" style="max-width:200px; text-align:right;" name="WO_DPVALX" id="WO_DPVALX" value="<?php echo number_format($WO_DPVAL, 2); ?>">
									</div>
								</div>
				                <script>
									function getDPer(thisVal1)
									{
										...
										WO_DPVAL		= parseFloat(thisVal * WO_GTOTAL);
		                                    ...
		                                    <tr id="tr_<?php echo $currentRow; ?>" style="vertical-align: middle;">
												...
												<td style="text-align:center;display: none;">
											  	...
											  	<td nowrap style="text-align:right; vertical-align: middle;">
				                                    ...
				                                    <?php } ?>
			                                        <input type="hidden" name="data[<?php echo $currentRow; ?>][TAXPERC1]" id="data<?php echo $currentRow; ?>TAXPERC1" size="20" value="<?php echo $TAXPERC1; ?>" class="form-control" style="min-width:110px; max-width:300px; text-align:left">
			                                    ...
			                                    <td nowrap style="text-align:right; vertical-align: middle;">
				                                    ...
				                                    <?php } ?>
			                                        <input type="hidden" name="data[<?php echo $currentRow; ?>][TAXPERC2]" id="data<?php echo $currentRow; ?>TAXPERC2" size="20" value="<?php echo $TAXPERC2; ?>" class="form-control" style="min-width:110px; max-width:300px; text-align:left">
	...
	function getWOVol(thisVal1, row)
	{
		...
		if(ITM_UNIT == 'LS')
		{
			...
			else
			{
				...
				WO_TOTAL2 	= parseFloat(WO_VOLM + PPN_VAL - PPH_VAL);
