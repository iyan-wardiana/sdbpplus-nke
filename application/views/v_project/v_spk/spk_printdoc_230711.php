                ...
                <table width="100%" border="1" cellpadding="0" cellspacing="0">
                    <thead>
                        ...
                        <!-- <tr style="height: 100px;">
                            <td width="<?=$COLW?>" style="vertical-align: top; <?php if($WO_CATEG == 'S') { ?> display: none; <?php } ?>">
                            ...
                            <td width="<?=$COLW?>" style="vertical-align: top; <?php if($WO_CATEG != 'S' && $PRJHO == 'NKE' && $TOT_SIGN != 2) { ?> display: none; <?php } ?>">
                            ...
                            <td width="<?=$COLW?>" style="vertical-align: top; <?php if($TOT_SIGN == 2 || $WO_CATEG == 'S' && $PRJHO != 'KTR') { ?> display: none; <?php } ?>" >
                            ...
                            <td width="<?=$COLW?>" style="vertical-align: top; <?php if($TOT_SIGN == 2) { ?> display: none; <?php } ?>" >
                            ...
                            <td colspan="<?=$COLSP?>" style="vertical-align: top;">
                        ...
                        <tr style="height: 100px;">
                            ...
                            <td width="<?=$COLW?>" style="vertical-align: top; <?php if($PRJHO == 'NKE') { ?> display: none; <?php } ?>">
                                <div style="text-align: center; font-weight: bold;"><?=strtoupper($POSIT_02)?><br><br>
                                    <input id="app_02" type="app_02" value="<?php echo $COMPIL_02; ?>" style="width:80%; display:none" />
                                    <div id="qrc_02"></div>
                                </div><br>
