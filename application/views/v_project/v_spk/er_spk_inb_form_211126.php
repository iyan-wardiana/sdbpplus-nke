							...
							<div class="box-body">
				                ...
				                <div class="form-group">
				                    ...
				                    <div class="col-sm-3">
				                        ...
				                        <i class="fa fa-calendar"></i>&nbsp;</div><input type="text" name="WO_DATE" class="form-control pull-left" id="datepicker" value="<?php echo $WO_DATE; ?>" style="width:106px" disabled></div>
				                    </div>
				                    <div class="col-sm-2">
				                    ...
				                    <div class="col-sm-4">
				                        ...
				                        <div class="input-group-addon">
					                        ...
					                        <input type="text" name="WO_ENDD" class="form-control pull-left" id="datepicker1" value="<?php echo $WO_ENDD; ?>" onChange="getWO_NUM(this.value)" disabled>
				                        	<input type="hidden" class="form-control" style="min-width:110px; max-width:150px; text-align:left" id="WO_ENDD" name="WO_ENDD" size="5" value="<?php echo $WO_ENDD; ?>" />
					                    </div>
				                    </div>
				                </div>
				            	<div class="form-group">
				                    ...
				                    <div class="col-sm-9">
				                        ...
				                        <input type="hidden" class="form-control" style="min-width:110px; max-width:150px; text-align:left" id="WO_CATEG" name="WO_CATEG" size="5" value="<?php echo $WO_CATEG; ?>" />
				                    </div>
				                </div>
				                <?php
									$WO_CODE	= '';
				            	...
				            	<div class="form-group">
				                    ...
				                    <div class="col-sm-9">
				                        ...
				                        <input type="hidden" class="form-control" style="min-width:110px; max-width:150px; text-align:left" id="SPLCODE" name="SPLCODE" size="5" value="<?php echo $SPLCODE; ?>" />
				                    </div>
				                </div>
				            	<div class="form-group">
				                    ...
				                    <div class="col-sm-9">
				                    	...
				                    	<textarea name="WO_NOTE" class="form-control" id="WO_NOTE" cols="30" style="height: 87px" placeholder="Catatan SPK" disabled><?php echo $WO_NOTE; ?></textarea>
				                    </div>
				                </div>
				                <script>
						...
						<div class="box box-warning">
							...
							<div class="box-body">
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" class="form-control" name="WO_REFNO" id="WO_REFNO" value="<?php echo $WO_REFNO; ?>" placeholder="Nomor Surat Keputusan" disabled>
									</div>
								</div>
								<div class="form-group">
									<label for="inputName" class="col-sm-3 control-label"><?php echo $QuotNo; ?></label>
									<div class="col-sm-9">
										<input type="text" class="form-control" name="WO_QUOT" id="WO_QUOT" value="<?php echo $WO_QUOT; ?>" placeholder="<?php echo $QuotNo; ?>" disabled>
									</div>
								</div>
								<div class="form-group">
									<label for="inputName" class="col-sm-3 control-label"><?php echo $NegotNo; ?></label>
									<div class="col-sm-9">
										<input type="text" class="form-control" name="WO_NEGO" id="WO_NEGO" value="<?php echo $WO_NEGO; ?>" placeholder="<?php echo $NegotNo; ?>" disabled>
									</div>
								</div>
								<div class="form-group">
				                    ...
				                    <div class="col-sm-2">
			                            ...
			                            <input type="text" class="form-control" style="max-width:80px; text-align:right;" name="WO_DPPERX" id="WO_DPPERX" value="<?php echo number_format($WO_DPPER, $decFormat); ?>" onBlur="getDPVal(this)" readonly>
				                    ...
				                    <div class="col-sm-3">
				                    	<label for="inputName" class="col-sm-12 control-label">Total - SPK</label>
				                    </div>
				                    <div class="col-sm-4">
				            	...
				            	<div class="form-group">
				                    ...
				                    <div class="col-sm-9">
				                    	<textarea name="WO_NOTE2" class="form-control" style="height: 87px" id="WO_NOTE2" cols="30"><?php echo $WO_NOTE2; ?></textarea>                        
				                    </div>
				                </div>
				            	<div class="form-group">
		                            ...
		                            if($task == 'edit')
		                            {
		                                $sqlDET	= "SELECT A.*,
													...
													FROM tbl_wo_detail A
														...
														INNER JOIN tbl_wo_header D ON D.WO_NUM = A.WO_NUM
										...
										/*	if ($j==1) {
										    ...
										    <input type="hidden" id="chk" name="chk" value="<?php echo $currentRow; ?>" width="10" size="15" readonly class="form-control" style="max-width:350px;text-align:right">
										  	...
										  	<td style="text-align:left; min-width:100px; max-width:100px;">
												<?php echo $ITM_NAME; ?>
											...
											<?php
												...
												$sqlTOTBUDG		= "SELECT SUM(A.WO_VOLM * A.ITM_PRICE) AS TOTWOAMOUNT,
																	...
																	WHERE A.ITM_CODE = '$ITM_CODE' AND A.PRJCODE = '$PRJCODE'
																		AND A.JOBCODEDET = '$JOBCODEDET' AND B.WO_STAT IN (3,6)";
											...
											<td style="text-align:right"> <!-- Item Bdget -->
										  	...
										  	<td style="text-align:right">  <!-- Item Requested FOR INFORMATION ONLY -->
		                                    ...
		                                    <td style="text-align:right" nowrap> <!-- Item Request Now -- PR_VOLM -->
		                                     	<?php if($disRow == 1) { ?>
		                                     		<?php echo number_format($WO_VOLM, $decFormat); ?>
		                                        	<input type="hidden" name="WO_VOLM<?php echo $currentRow; ?>" id="WO_VOLM<?php echo $currentRow; ?>" value="<?php echo number_format($WO_VOLM, $decFormat); ?>" class="form-control" style="min-width:100px; max-width:100px; text-align:right" onKeyPress="return isIntOnlyNew(event);" onBlur="getConvertion(this,<?php echo $currentRow; ?>);" >
			                                    <?php } else { ?>
		                                    ...
		                                    <td style="text-align:right">
			                                    ...
			                                    <?php } else { ?>
		                                        	<?php if($disPrice == 1) { ?>
		                                        		...
		                                        		<input type="hidden" name="ITM_PRICE<?php echo $currentRow; ?>" id="ITM_PRICE<?php echo $currentRow; ?>" value="<?php echo number_format($ITM_PRICE, $decFormat); ?>" class="form-control" style="min-width:100px; max-width:100px; text-align:right" onKeyPress="return isIntOnlyNew(event);" onBlur="getConvertion_1(this,<?php echo $currentRow; ?>);" >
				                                    <?php } else { ?>
			                                        	<input type="text" name="ITM_PRICE<?php echo $currentRow; ?>" id="ITM_PRICE<?php echo $currentRow; ?>" value="<?php echo number_format($ITM_PRICE, $decFormat); ?>" class="form-control" style="text-align:right" onKeyPress="return isIntOnlyNew(event);" onBlur="getConvertion_1(this,<?php echo $currentRow; ?>);" >
				                                    <?php } ?>
			                                    <?php } ?>
