				...
				foreach($vData as $row) :				
					...
					if ($j==1) {
						...
						?>
                                ...
                                <?php
									$secUpd		= site_url('c_project/c_s180d0bpk/update_inb/?id='.$this->url_encryption_helper->encode_url($WO_NUM));
								...
								<td style="text-align:center" nowrap>
                                    ...
                                    <a href="#" onClick="deleteMail('<?php echo $secDel_PO; ?>')" title="Delete file" class="btn btn-danger btn-xs" <?php if($WO_STAT > 1) { ?>disabled="disabled" <?php } ?> style="display:none">
