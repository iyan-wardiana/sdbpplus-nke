							...
							<div class="box-body">
				            	...
				            	<div class="form-group">
				                    ...
				                    <div class="col-sm-9">
				                    	...
				                    	<textarea name="WO_NOTE" class="form-control" id="WO_NOTE" cols="30" style="height: 70px" placeholder="Catatan SPK" disabled><?php echo $WO_NOTE; ?></textarea>
				                    </div>
				                </div>
				                <script>
				            	...
				            	<div class="form-group">
				                    ...
				                    <div class="col-sm-9">
				                    	<textarea name="WO_NOTE2" class="form-control" style="height: 70px" id="WO_NOTE2" cols="30"><?php echo $WO_NOTE2; ?></textarea>                        
				                    </div>
				                </div>
				            </div>
				        </div>
