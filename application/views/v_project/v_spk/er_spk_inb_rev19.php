...
<h1>
    ...
    <small><?php echo "$Approval - Sewa Alat"; ?></small>
  </h1><br>
						...
						?>
								...
								<td style="text-align:center"><?php
										$date = new DateTime($WO_DATE);
									   	echo $WO_DATE;
									?>                            </td>
								<td><?php print $WO_NOTE; ?> </td>
								<td style="text-align:center"><?php echo $CREATER_NAME; ?></td>
                                ...
                                <?php
									$secUpd		= site_url('c_project/c_s180d0bpk/up4t_ibx1_er/?id='.$this->url_encryption_helper->encode_url($WO_NUM));
