...
<body class="page A4">
    <section class="page sheet custom">
        <?php
            $block_print    = 'block';
            if($WO_STAT == 1 || $WO_STAT == 2 || $WO_STAT == 4)
            {
                $block_print    = 'none';
            }
            ...
            <div class="box-header-detail-col-6">
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td width="10">:</td>
                        <td><?php echo "$WO_STARTDv s/d $WO_ENDDv"; ?></td>
                    </tr>
                    <tr>
                ...
                <table width="100%" border="1" cellpadding="0" cellspacing="0">
                    <thead>
                        ...
                        <tr style="height: 100px;">
                            ...
                            <td width="<?=$COLW?>" style="vertical-align: top; <?php if($TOT_SIGN == 2 || $TOT_SIGN == 3) { ?> display: none; <?php } ?>" >
