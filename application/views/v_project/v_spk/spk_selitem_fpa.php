                ...
                <?php
                    ...
                    if($countAllItem>0)
                    {
                        ...
                        foreach($vwAllItem as $row) :
							...
							?>
                            <td style="text-align:center"><input type="checkbox" name="chk" value="<?php echo $JOBCODEDET;?>|<?php echo $JOBCODEID;?>|<?php echo $JOBCODE;?>|<?php echo $PRJCODE;?>|<?php echo $ITM_CODE;?>|<?php echo $JOBDESC;?>|<?php echo $serialNumber;?>|<?php echo $ITM_UNIT;?>|<?php echo $ITM_PRICE;?>|<?php echo $ITM_BUDG;?>|<?php echo $ITM_STOCK;?>|<?php echo $ITM_USED;?>|<?php echo $itemConvertion;?>|<?php echo $ITM_AMOUNT;?>|<?php echo $tempTotMax;?>|<?php echo $PO_AMOUNT;?>|<?php echo $ITM_VOLM_AMN;?>|<?php echo $TOT_USEDQTY;?>|<?php echo $WO_QTY;?>|<?php echo $WO_AMOUNT;?>|<?php echo $OPN_QTY;?>|<?php echo $OPN_AMOUNT;?>" onClick="pickThis(this);"/>
                            </td>
                            <td><?php echo $ITM_CODE; ?></td>
                            <td nowrap><?php echo cut_text($JOBDESC, 50); ?></td>
                            <td nowrap><?php echo cut_text($JOBDESCP, 50); ?></td>
