                        ...
                        <div class="box-body">
                            <div class="col-sm-2" style="display: none;">
                                ...
                                <select name="WO_CATEG" id="WO_CATEG" class="form-control select2" style="width: 100%" onChange="grpBP(this.value)">
                                    <option value=""> --- </option>
                                    <?php
                                        $s_WOC  = "SELECT VendCat_Code, VendCat_Name FROM tbl_vendcat WHERE VendCat_Code IN ('B')";
                                ...
                                <select name="SPLCODE" id="SPLCODE" class="form-control select2" style="width: 100%" onChange="grpBP(this.value)">
                                    ...
                                    <?php
                                        $s_SPL  = "SELECT DISTINCT B.SPLCODE, B.SPLDESC FROM tbl_wo_header A
                                                    LEFT JOIN tbl_supplier B ON A.SPLCODE = B.SPLCODE WHERE A.WO_CATEG = 'T' ORDER BY B.SPLDESC ASC";
            ...
            <script type="text/javascript">
                function grpBP()
                {
                    ...
                    $('#example').DataTable( {
                        ...
                        "autoWidth": true,
                        "filter": true,
                        "ajax": "<?php echo site_url('c_project/c_s180d0bpk/get_AllDataWOGRP_int/?id='.$PRJCODE)?>"+'&SPLC='+SPLC+'&GSTAT='+GSTAT+'&SRC='+SRC,
                        "type": "POST",
...
<script>
    ...
    $(document).ready(function() {
        $('#example').DataTable( {
            ...
            "autoWidth": true,
            "filter": true,
            "ajax": "<?php echo site_url('c_project/c_s180d0bpk/get_AllData_int/?id='.$PRJCODE)?>",
            "type": "POST",
            "lengthMenu": [[5, 10, 25, 50, 100, 200, -1], [5, 10, 25, 50, 100, 200, "All"]],
            // "lengthMenu": [[10, 25, 50, 100, 200], [10, 25, 50, 100, 200]],
            "columnDefs": [ { targets: [5,7], className: 'dt-body-center' },
