 ...
 * File Name	= spk_req_inb_form.php
 * Location		= -
*/
			    ...
			    <div class="box box-primary">
			        ...
			        <form class="form-horizontal" name="frm" method="post" action="<?php echo $form_action; ?>" enctype="multipart/form-data" onSubmit="return checkInp()">
			            	...
			            	<div class="form-group">
			                    ...
			                    <div class="col-sm-10">
			                    	<input type="hidden" class="form-control" style="min-width:110px; max-width:150px; text-align:left" id="WO_CODE" name="WO_CODE" size="5" value="<?php echo $WO_CODE; ?>" />
			                    	<input type="text" class="form-control" style="text-align:left" id="WO_CODE1" name="WO_CODE1" size="5" value="<?php echo $WO_CODE; ?>" disabled />
			                    </div>
			                </div>
			            	<div class="form-group">
			                    ...
			                    <div class="col-sm-10">
			                        ...
			                        <i class="fa fa-calendar"></i>&nbsp;</div><input type="text" name="WO_DATE" class="form-control pull-left" id="datepicker" value="<?php echo $WO_DATE; ?>" style="width:106px" onChange="getWO_NUM(this.value)" disabled></div>
			                    </div>
			                </div>
			            	<div class="form-group">
			                    ...
			                    <div class="col-sm-10">
			                    	<div class="input-group date">
			                        <div class="input-group-addon">
			                        <i class="fa fa-calendar"></i>&nbsp;</div><input type="text" name="WO_ENDD" class="form-control pull-left" id="datepicker1" value="<?php echo $WO_ENDD; ?>" style="width:106px" onChange="getWO_NUM(this.value)" disabled></div>
			                    </div>
			                </div>
			            	<div class="form-group" style="display:none">
			                    <label for="inputName" class="col-sm-2 control-label"><?php echo $Category; ?></label>
			                    <div class="col-sm-10">
			                    	<input type="hidden" name="WO_CATEG" id="WO_CATEG" value="<?php echo $WO_CATEG; ?>">
			                    	<select name="WO_CATEG1" id="WO_CATEG1" class="form-control" disabled >
			            	...
			            	<div class="form-group">
			                    ...
			                    <div class="col-sm-10">
			                    	<textarea name="WO_NOTE" class="form-control" style="max-width:350px; display:none" id="WO_NOTE" cols="30"><?php echo $WO_NOTE; ?></textarea>
			                    	<textarea name="WO_NOTE1" class="form-control" id="WO_NOTE1" cols="30" disabled><?php echo $WO_NOTE; ?></textarea>
			                    </div>
			                </div>
			            	<div class="form-group">
			                    <label for="inputName" class="col-sm-2 control-label"><?php echo $ApproverNotes; ?></label>
			                    <div class="col-sm-10">
			                    	<textarea name="WO_NOTE2" class="form-control" id="WO_NOTE2" cols="30"><?php echo $WO_NOTE2; ?></textarea>                        
			                    </div>
			                </div>
			            	<div class="form-group">
										...
										if($disableAll == 0)
										{
											if($canApprove == 1)
											{
												...
												if($resCAPPHE > 0)
													$disButton	= 1;
												?>
													<select name="WO_STAT" id="WO_STAT" class="form-control" onChange="selStat(this.value)" <?php if($disButton == 1) { ?> disabled <?php } ?> >
			                    ...
			                    <div class="col-md-12">
			                        ...
			                        <table width="100%" border="1" id="tbl">
			                        	<tr style="background:#CCCCCC">
			                              ...
			                              <th width="13%" rowspan="2" style="text-align:center;"><?php echo $Amount ?> </th>
			                          	</tr>
			                            <tr style="background:#CCCCCC">
											...
											/*	if ($j==1) {
												...
												<td width="8%" style="text-align:right"> <!-- Item Bdget -->
			                                     ...
			                                     <td width="8%" style="text-align:right"> <!-- Item Request Now -- PR_VOLM -->
			                                        <input type="text" name="WO_VOLM<?php echo $currentRow; ?>" id="WO_VOLM<?php echo $currentRow; ?>" value="<?php echo number_format($WO_VOLM, $decFormat); ?>" class="form-control" style="min-width:100px; max-width:100px; text-align:right" onKeyPress="return isIntOnlyNew(event);" onBlur="getConvertion(this,<?php echo $currentRow; ?>);" disabled >
			                                        <input type="hidden" name="data[<?php echo $currentRow; ?>][WO_VOLM]" id="data<?php echo $currentRow; ?>WO_VOLM" value="0.00" class="form-control" style="max-width:300px;" >                                    
			                                        </td>
			                                     <td width="7%" style="text-align:center; font-style:italic">
			                                     	none
			                                        <input type="hidden" name="ITM_PRICE<?php echo $currentRow; ?>" id="ITM_PRICE<?php echo $currentRow; ?>" value="<?php echo number_format($ITM_PRICE, $decFormat); ?>" class="form-control" style="min-width:100px; max-width:100px; text-align:right" onKeyPress="return isIntOnlyNew(event);" onBlur="getConvertion_1(this,<?php echo $currentRow; ?>);" disabled >
			                                    ...
			                                    <!-- Item Unit Type -- ITM_UNIT --></td>
											  	<td width="15%" nowrap style="text-align:center; font-style:italic">
			                                    	none
			                                        <select name="data[<?php echo $currentRow; ?>][TAXCODE1]" id="TAXCODE1<?php echo $currentRow; ?>" class="form-control" style="max-width:150px; display:none" onChange="getConvertion(this,<?php echo $currentRow; ?>);" disabled>
			                                        	<option value=""> no tax </option>
			                                        	<option value="TAX01" <?php if($TAXCODE1 == 'TAX01') { ?> selected <?php } ?>>PPn 10%</option>
			                                        	<option value="TAX02" <?php if($TAXCODE1 == 'TAX02') { ?> selected <?php } ?>>PPh 2%</option>
			                                        	<option value="TAX03" <?php if($TAXCODE1 == 'TAX03') { ?> selected <?php } ?>>PPh 3%</option>
			                                        	<option value="TAX04" <?php if($TAXCODE1 == 'TAX04') { ?> selected <?php } ?>>PPh 4%</option>
			                                        </select>
											  	...
											  	<td width="13%" style="text-align:center; font-style:italic">
			                                    	none
			                                        ...
			                                        <input type="hidden" name="data[<?php echo $currentRow; ?>][WO_DESC]" id="data<?php echo $currentRow; ?>WO_DESC" size="20" value="" class="form-control" style="min-width:110px; max-width:100px; text-align:left">
			                              		</td>
										  </tr>
			                              	<?php
			                             	endforeach;
			                ...
			                <div class="form-group">
			                    <div class="col-sm-offset-2 col-sm-10">
			                        <?php
										...
										$backURL	= site_url('c_project/c_s180d0bpk/r3q_70ls_1nb_a/?id='.$this->url_encryption_helper->encode_url($PRJCODE));
...
<script>
	...
	function checkInp()
	{
		...
		if(WO_NOTE2 == '')
		{
			...
			document.getElementById('WO_NOTE2').focus();
			return false;
		}
