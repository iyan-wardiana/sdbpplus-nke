	                        ...
	                        <div class="search-table-outter">
	                            <table id="tbl" class="table table-bordered table-striped" width="100%">
		                        	<tr style="background:#CCCCCC"><tr style="background:#CCCCCC">
										...
										<th width="5%" style="text-align:center; vertical-align: middle;"><?php echo "% PPh"; ?></th>
										...
										foreach($result as $row) :
		                                    ...
		                                    <tr id="tr_<?php echo $currentRow; ?>" style="vertical-align: middle;">
			                                    ...
			                                    <td nowrap style="text-align:right; vertical-align: middle;">
			                                     	<?php if($disRow == 1) { ?>
			                                     		<?php
			                                     			echo number_format($TAXPRICE2, 2);
			                                     		?>
...
<script>
	...
	function add_item(strItem) 
	{
		...
		objTD.innerHTML = ''+ITM_UNIT2+'<input type="hidden" name="data['+intIndex+'][ITM_UNIT]" id="data'+intIndex+'ITM_UNIT" value="'+ITM_UNIT+'" class="form-control" style="max-width:300px;" >';
