...
{
	$isSetDocNo = 1;
	$s_Patt		= "SELECT Pattern_Code, Pattern_Length FROM tbl_docpattern WHERE menu_code = '$MenuCode' LIMIT 1";
...
else
{
	...
	if($WO_VALUE > 100000000 && trim($WO_REFNO) == '' && $WO_CATEG != 'U')
		$disBtn 	= 1;
}
...
<html>
	...
	<?php
		...
		if($LangID == 'IND')
		{
			...
			$alert10	= "Cara Bayar SPK tidak boleh kosong";
		...
		else
		{
			...
			$alert10	= "how to pay WO can not be empty";
			...
			if($PRJHO == 'KTR')
			{
				...
				foreach($r_DIV as $rw_DIV):
					...
					if($MenuAppA == 'MN437')				// Sekret
						// $MenuApp 	= "MN458";
					{
						if($WO_CATEG == 'U') $MenuApp 	= "MN473";
						elseif($WO_CATEG == 'S') $MenuApp 	= "MN474";
						elseif($WO_CATEG == 'O') $MenuApp 	= "MN475";
						elseif($WO_CATEG == 'A') $MenuApp 	= "MN517";
						elseif($WO_CATEG == 'T') $MenuApp 	= "MN470";
						// else $MenuApp 	= "MN354";
					}
					elseif($MenuAppA == 'MN438')			// Audit
						// $MenuApp 	= "MN459";
					{
						if($WO_CATEG == 'U') $MenuApp 	= "MN476";
						elseif($WO_CATEG == 'S') $MenuApp 	= "MN477";
						elseif($WO_CATEG == 'O') $MenuApp 	= "MN478";
						elseif($WO_CATEG == 'A') $MenuApp 	= "MN518";
						elseif($WO_CATEG == 'T') $MenuApp 	= "MN470";
						// else $MenuApp 	= "MN354";
					}
					elseif($MenuAppA == 'MN439')			// Corp. L1
						// $MenuApp 	= "MN460";
					{
						if($WO_CATEG == 'U') $MenuApp 	= "MN479";
						elseif($WO_CATEG == 'S') $MenuApp 	= "MN480";
						elseif($WO_CATEG == 'O') $MenuApp 	= "MN481";
						elseif($WO_CATEG == 'A') $MenuApp 	= "MN519";
						elseif($WO_CATEG == 'T') $MenuApp 	= "MN470";
						// else $MenuApp 	= "MN354";
					}
					elseif($MenuAppA == 'MN440')			// Corp. L2
						// $MenuApp 	= "MN461";
					{
						if($WO_CATEG == 'U') $MenuApp 	= "MN482";
						elseif($WO_CATEG == 'S') $MenuApp 	= "MN483";
						elseif($WO_CATEG == 'O') $MenuApp 	= "MN484";
						elseif($WO_CATEG == 'A') $MenuApp 	= "MN520";
						elseif($WO_CATEG == 'T') $MenuApp 	= "MN470";
						// else $MenuApp 	= "MN354";
					}
					elseif($MenuAppA == 'MN441')			// QHSSE-SI
						// $MenuApp 	= "MN462";
					{
						if($WO_CATEG == 'U') $MenuApp 	= "MN485";
						elseif($WO_CATEG == 'S') $MenuApp 	= "MN486";
						elseif($WO_CATEG == 'O') $MenuApp 	= "MN487";
						elseif($WO_CATEG == 'A') $MenuApp 	= "MN521";
						elseif($WO_CATEG == 'T') $MenuApp 	= "MN470";
						// else $MenuApp 	= "MN354";
					}
					elseif($MenuAppA == 'MN442')			// Marketing
						// $MenuApp 	= "MN463";
					{
						if($WO_CATEG == 'U') $MenuApp 	= "MN488";
						elseif($WO_CATEG == 'S') $MenuApp 	= "MN489";
						elseif($WO_CATEG == 'O') $MenuApp 	= "MN490";
						elseif($WO_CATEG == 'A') $MenuApp 	= "MN522";
						elseif($WO_CATEG == 'T') $MenuApp 	= "MN470";
						// else $MenuApp 	= "MN354";
					}
					elseif($MenuAppA == 'MN443')			// Operasi
						// $MenuApp 	= "MN464";
					{
						if($WO_CATEG == 'U') $MenuApp 	= "MN491";
						elseif($WO_CATEG == 'S') $MenuApp 	= "MN492";
						elseif($WO_CATEG == 'O') $MenuApp 	= "MN493";
						elseif($WO_CATEG == 'A') $MenuApp 	= "MN523";
						elseif($WO_CATEG == 'T') $MenuApp 	= "MN470";
						// else $MenuApp 	= "MN354";
					}
					elseif($MenuAppA == 'MN444')			// Keuangan
						// $MenuApp 	= "MN465";
					{
						if($WO_CATEG == 'U') $MenuApp 	= "MN494";
						elseif($WO_CATEG == 'S') $MenuApp 	= "MN495";
						elseif($WO_CATEG == 'O') $MenuApp 	= "MN496";
						elseif($WO_CATEG == 'A') $MenuApp 	= "MN524";
						elseif($WO_CATEG == 'T') $MenuApp 	= "MN470";
						// else $MenuApp 	= "MN354";
					}
					elseif($MenuAppA == 'MN445')			// HRD
						// $MenuApp 	= "MN466";
					{
						if($WO_CATEG == 'U') $MenuApp 	= "MN497";
						elseif($WO_CATEG == 'S') $MenuApp 	= "MN498";
						elseif($WO_CATEG == 'O') $MenuApp 	= "MN499";
						elseif($WO_CATEG == 'A') $MenuApp 	= "MN525";
						elseif($WO_CATEG == 'T') $MenuApp 	= "MN470";
						// else $MenuApp 	= "MN354";
					}
					elseif($MenuAppA == 'MN446')			// SPK Anak Usaha
						// $MenuApp 	= "MN467";
					{
						if($WO_CATEG == 'U') $MenuApp 	= "MN500";
						elseif($WO_CATEG == 'S') $MenuApp 	= "MN501";
						elseif($WO_CATEG == 'O') $MenuApp 	= "MN502";
						elseif($WO_CATEG == 'A') $MenuApp 	= "MN526";
						elseif($WO_CATEG == 'T') $MenuApp 	= "MN470";
						// else $MenuApp 	= "MN354";
					}
		...
		<section class="content">
						...
						<div class="box box-primary">
							...
							<div class="box-body">
				                ...
				                <div class="form-group">
				                    ...
				                    <div class="col-sm-2">
				                        <label for="inputName" class="control-label pull-right"><?php echo $SPKDate; ?></label>
				                    </div>
			                        <div class="col-sm-4">
				                    	<div class="input-group date">
				                        <div class="input-group-addon">
				                        <i class="fa fa-calendar"></i>&nbsp;</div><input type="text" name="WO_DATE" class="form-control pull-left" id="WO_DATE" value="<?php echo $WO_DATE; ?>" readonly></div>
				                    </div>
				                </div>
				            	<div class="form-group">
				                    ...
				                    <div class="col-sm-4">
				                    	<div class="input-group date">
				                        <div class="input-group-addon">
				                        <i class="fa fa-calendar"></i>&nbsp;</div><input type="text" name="WO_STARTD" class="form-control pull-left" id="datepicker1" value="<?php echo $WO_STARTD; ?>"></div>
				                    </div>
				                    <div class="col-sm-2">
				                    	<label for="inputName" class="control-label pull-right">s.d.</label>
				                    </div>
				                    <div class="col-sm-4">
				                    	<div class="input-group date">
				                        <div class="input-group-addon">
				                        <i class="fa fa-calendar"></i>&nbsp;</div><input type="text" name="WO_ENDD" class="form-control pull-left" id="datepicker2" value="<?php echo $WO_ENDD; ?>"></div>
				                    </div>
				                </div>
				                <?php
									$WO_CODE	= '';
				                ...
				                <script>
									function changeCODE(thisVal)
									{
										...
										if(thisVal == 'U')
										{
											...
											var ITM_CATEG	= "U";
											$.ajax({
												url: "<?php echo site_url('c_project/c_s180d0bpk/get_ITMSRC'); ?>",
												type: "POST",
												dataType: "JSON",
												data: {PRJCODE:PRJCODE, WO_CATEG:ITM_CATEG},
												beforeSend: function() {
													$('#ITMU_SRC').select2({
										...
										else
										{
											...
											$.ajax({
												...
												success: function(result) {
													...
													$('#ITMM_SRC').html(SRC_ITM);
												}
											});
										}

										document.getElementById('WO_CODE').value = WO_CODEN;
										document.getElementById('ITM_CATEG').value = thisVal;
									}
								</script>
						...
						<div class="box box-warning">
							...
							<div class="box-body">
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" class="form-control" name="WO_REFNO" id="WO_REFNO" value="<?php echo $WO_REFNO; ?>" placeholder="Nomor Kontrak" onChange="shwBtn()" >
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-4">
			                            ...
			                            <input type="text" class="form-control" style="text-align:right;" name="WO_DPPERX" id="WO_DPPERX" value="<?php echo number_format($WO_DPPER, $decFormat); ?>" onBlur="getDPer(this)" onKeyPress="return isIntOnlyNew(event);">
				                    </div>
				                    <div class="col-sm-5">
			                            ...
			                            <input type="text" class="form-control" style="text-align:right;" name="WO_DPVALX" id="WO_DPVALX" value="<?php echo number_format($WO_DPVAL, 2); ?>" onBlur="getDPVAL(this)" onKeyPress="return isIntOnlyNew(event);">
									</div>
								</div>
				                <script>
									function getDPer(thisVal1)
									{
										...
										WO_VALUE 		= parseFloat(document.getElementById('WO_VALUE').value);
										WO_DPVAL		= parseFloat(thisVal * WO_VALUE) / 100;
									...
									function getDPVAL(thisVal1)
									{
										var decFormat	= document.getElementById('decFormat').value;

										thisVal 		= parseFloat(Math.abs(eval(thisVal1).value.split(",").join("")));
										let WO_VAL 		= document.getElementById('WO_VALUE').value;
										let DPPer 		= parseFloat(thisVal/WO_VAL) * 100;

										document.getElementById('WO_DPVAL').value	= RoundNDecimal(parseFloat(Math.abs(thisVal)),2);
										document.getElementById('WO_DPVALX').value	= doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(thisVal)),2));

										document.getElementById('WO_DPPER').value	= RoundNDecimal(parseFloat(Math.abs(DPPer)),2);
										document.getElementById('WO_DPPERX').value	= doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(DPPer)),2));
										getTotalWO();
									}

									function shwBtn()
									{
										var WO_REFNO 	= document.getElementById('WO_REFNO').value;
										if(WO_REFNO.trim() == '')
										{
											swal('Total SPK ini lebih dari 500.000.000! Anda DIHARUSKAN mengisi no kontrak',
											{
												icon: "warning",
											})
											.then(function()
								            {
								                ...
								                document.getElementById('WO_REFNO').focus();
								            });
										}
										else
										{
				                ...
				                <div class="form-group">
				                    ...
				                    <div class="col-sm-5">
			                            ...
			                            <input type="text" class="form-control" style="text-align:right;" name="WO_RETVALX" id="WO_RETVALX" value="<?php echo number_format($WO_RETVAL, 2); ?>" onBlur="getRETVAL(this)" onKeyPress="return isIntOnlyNew(event);">
									</div>
								</div>
								<script>
									function getRETP(thisValR)
									{
										...
										//WO_GTOTAL 		= parseFloat(document.getElementById('WO_GTOTAL').value);
										WO_VALUE 		= parseFloat(document.getElementById('WO_VALUE').value);
										WO_RETVAL		= parseFloat(thisVal * WO_VALUE) / 100;
									...
									function getRETVAL(thisValR)
									{
										var decFormat	= document.getElementById('decFormat').value;

										thisVal 		= parseFloat(Math.abs(eval(thisValR).value.split(",").join("")));

										document.getElementById('WO_RETVAL').value	= RoundNDecimal(parseFloat(Math.abs(thisVal)),2);
										document.getElementById('WO_RETVALX').value	= doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(thisVal)),2));
										getTotalWO();
									}
								</script>
		                        	...
		                        	<tr style="background:#CCCCCC">
			                            ...
			                            <th width="5%" style="text-align:center; vertical-align: middle;">
			                            	...
			                            	<select name="TAXCODE1H" id="TAXCODE1H" class="form-control" onChange="setAllPPN(this.value);">
	                                        	<option value=""> --- </option>
	                                        	<?php
	                                        		$s_01 	= "SELECT TAXLA_NUM, TAXLA_DESC FROM tbl_tax_ppn LIMIT 1";
										...
										<th style="text-align:center; vertical-align: middle;" nowrap><?php echo $Tax ?> PPN</th>
			                            <th width="5%" style="text-align:center; vertical-align: middle;">
			                            	<?php //echo "$Tax PPh<br>"; ?>
										...
										<th style="text-align:center; vertical-align: middle;" nowrap><?php echo $Tax ?> PPH</th>
		                            ...
		                            if($task == 'edit')
		                            {
										...
										foreach($result as $row) :
											...
											$s_OPN			= "SELECT SUM(OPND_VOLM) AS OPN_VOLM FROM tbl_opn_detail WHERE WO_ID = $WO_ID AND WO_NUM = '$WO_NUM'
																AND PRJCODE = '$PRJCODE' AND OPNH_STAT NOT IN (5,9)";
											...
											foreach($resJOBDESC as $rowJOBDESC) :
												$JOBDESCH	= htmlspecialchars(html_entity_decode($rowJOBDESC->JOBDESC, ENT_QUOTES | ENT_SUBSTITUTE | ENT_HTML401 | ENT_HTML5,'UTF-8'));
											endforeach;
		                                    ...
		                                    <tr id="tr_<?php echo $currentRow; ?>" style="vertical-align: middle;">
			                                    ...
			                                    <td style="text-align:right; vertical-align: middle;" nowrap>
											  	...
											  	<td nowrap style="text-align:center; vertical-align: middle;">
			                                        <?php
					                                    ...
					                                    <?php } else { ?>
														  	<input type="text" name="data[<?php echo $currentRow; ?>][ITM_UNIT2]" id="data<?php echo $currentRow; ?>ITM_UNIT2" value="<?php echo $ITM_UNIT2; ?>" class="form-control" style="text-align:center; width:90px;" >
														  	<input type="hidden" name="data[<?php echo $currentRow; ?>][ITM_UNIT]" id="data<?php echo $currentRow; ?>ITM_UNIT" value="<?php echo $ITM_UNIT; ?>" class="form-control" style="text-align:center; width:90px;" >
						                                    <?php
						                                }
			                                        ?>
												...
												<td style="text-align:center; vertical-align: middle;" nowrap>
				                                    ...
				                                    <?php } else { ?>
														<input type="text" name="TAXPRICE1<?php echo $currentRow; ?>" id="TAXPRICE1<?php echo $currentRow; ?>" size="20" value="<?php echo number_format($TAXPRICE1, 2); ?>" class="form-control" style="min-width:110px; max-width:300px; text-align:left">
														<input type="hidden" name="data[<?php echo $currentRow; ?>][TAXPRICE1]" id="data<?php echo $currentRow; ?>TAXPRICE1" size="20" value="<?php echo $TAXPRICE1; ?>" class="form-control" style="min-width:110px; max-width:300px; text-align:left">
														<input type="hidden" name="data[<?php echo $currentRow; ?>][TAXPERC1]" id="data<?php echo $currentRow; ?>TAXPERC1" size="20" value="<?php echo $TAXPERC1; ?>" class="form-control" style="min-width:110px; max-width:300px; text-align:right">
				                                    <?php } ?>    
			                                    </td>
												...
												<td style="text-align:center; vertical-align: middle;" nowrap>
				                                    ...
				                                    <?php } else { ?>
														<input type="text" name="TAXPRICE2<?php echo $currentRow; ?>" id="TAXPRICE2<?php echo $currentRow; ?>" size="20" value="<?php echo number_format($TAXPRICE2, 2); ?>" class="form-control" style="min-width:110px; max-width:300px; text-align:right" onchange="getWOPPHVAL(<?php echo $currentRow; ?>)">
														<input type="hidden" name="data[<?php echo $currentRow; ?>][TAXPRICE2]" id="data<?php echo $currentRow; ?>TAXPRICE2" size="20" value="<?php echo $TAXPRICE2; ?>" class="form-control" style="min-width:110px; max-width:300px; text-align:left">
														<input type="hidden" name="data[<?php echo $currentRow; ?>][TAXPERC2]" id="data<?php echo $currentRow; ?>TAXPERC2" size="20" value="<?php echo $TAXPERC2; ?>" class="form-control" style="min-width:110px; max-width:300px; text-align:right">
				                                    <?php } ?>    
			                                    </td>
		                    ...
		                    <div class="col-sm-9">
		                    	<?php
									...
									elseif($task=='edit')
									{
										...
										elseif($disBtn == 0 && ($ISCREATE == 1 && $ISAPPROVE == 1) && ($WO_STAT == 1))
										{
											?>
		                                        <button class="btn btn-primary" id="btnSave">
		                                        <i class="fa fa-save"></i></button>&nbsp;
	    	...
	    	<!-- ============ START MODAL ITEM =============== -->
		        ...
		        <div class="modal fade" id="mdl_addItm" name='mdl_addItm' role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		            <div class="modal-dialog">
			            <div class="modal-content">
							<input type="hidden" id="ITM_CATEG" class="form-control" name="ITM_CATEG" value="<?=$WO_CATEG?>">
			                <div class="modal-body">
								<div class="row">
							    	<div class="col-md-12">
						              	<ul class="nav nav-tabs">
							            	...
							            	<div class="<?php echo $Active1; ?> tab-pane" id="itm1" style="display: none;">
		                                        <div class="form-group">
		                                        	<form method="post" name="frmSearch1" id="frmSearch1" action="">
			                                            <table id="example1" class="table table-bordered table-striped table-responsive search-table inner" width="100%">
			                                                <thead>
			                                                    <tr>
											                        ...
											                        <th width="5%" style="text-align: center;" nowrap><?php echo $Account; ?></th>
											                        ...
											                        <th width="10%" style="text-align: center;" nowrap><?php echo $Used; ?></th>
				                                        ...
				                                        <br>
												        <div class="row">
															<div class="col-md-12" id="idprogbar1" style="display: none;">
																<div class="cssProgress">
															      	<div class="cssProgress">
																	    <div class="progress3">
																			<div id="progressbarXX1" style="text-align: center;">0%</div>
																		</div>
		                                        	...
		                                        	<form method="post" name="frmSearch2" id="frmSearch2" action="">
		                                        		<div class="search-table-outter">
				                                            <table id="example2" class="table table-bordered table-striped table-responsive search-table inner" width="100%">
				                                                <thead>
			                                                        <tr>
												                        <th width="3%" style="text-align: center;">U</th>
											                       	 	<th width="5%" style="text-align: center;" nowrap><?php echo $Account; ?></th>
												                        <th width="32%" style="text-align: center;" nowrap><?php echo $Description; ?></th>
												                        <th width="5%" style="text-align: center;" nowrap><?php echo $Unit; ?></th>
												                        <th width="10%" style="text-align: center;" nowrap><?php echo $BudgetQty; ?>  </th>
		                                        	...
		                                        	<form method="post" name="frmSearch3" id="frmSearch3" action="">
		                                        		<div class="search-table-outter">
				                                            <table id="example3" class="table table-bordered table-striped table-responsive search-table inner" width="100%">
				                                                <thead>
			                                                        <tr>
												                        <th width="3%" style="text-align: center;">A</th>
											                        	<th width="5%" style="text-align: center;" nowrap><?php echo $Account; ?></th>
												                        <th width="32%" style="text-align: center;" nowrap><?php echo $Description; ?></th>
												                        <th width="5%" style="text-align: center;" nowrap><?php echo $Unit; ?></th>
												                        <th width="10%" style="text-align: center;" nowrap><?php echo $BudgetQty; ?>  </th>
												        ...
												        <div class="row">
															<div class="col-md-12" id="idprogbar3" style="display: none;">
																<div class="cssProgress">
															      	<div class="cssProgress">
																	    <div class="progress3">
																			<div id="progressbarXX3" style="text-align: center;">0%</div>
																		</div>
																		<span class="cssProgress-label" id="information" ></span>
																	</div>
															    </div>
							            	...
							            	<div class="<?php echo $Active4; ?> tab-pane" id="itm4" style="display: none;">
		                                        <div class="form-group">
		                                        	<form method="post" name="frmSearch4" id="frmSearch4" action="">
				                                        ...
				                                        <br>
												        <div class="row">
															<div class="col-md-12" id="idprogbar4" style="display: none;">
																<div class="cssProgress">
															      	<div class="cssProgress">
																	    <div class="progress3">
																			<div id="progressbarXX4" style="text-align: center;">0%</div>
																		</div>
																		<span class="cssProgress-label" id="information" ></span>
																	</div>
															    </div>
		                                        ...
		                                        <div class="form-group">
		                                        	<form method="post" name="frmSearch5" id="frmSearch5" action="">
			                                            <table id="example5" class="table table-bordered table-striped table-responsive search-table inner" width="100%">
			                                                <thead>
		                                                        <tr>
											                        <th width="3%" style="text-align: center;">O</th>
											                        <th width="5%" style="text-align: center;" nowrap><?php echo $Account; ?></th>
											                        <th width="32%" style="text-align: center;" nowrap><?php echo $Description; ?></th>
											                        <th width="5%" style="text-align: center;" nowrap><?php echo $Unit; ?></th>
											                        <th width="10%" style="text-align: center;" nowrap><?php echo $BudgetQty; ?>  </th>
				                                        ...
				                                        <br>
												        <div class="row">
															<div class="col-md-12" id="idprogbar5" style="display: none;">
																<div class="cssProgress">
															      	<div class="cssProgress">
																	    <div class="progress3">
																			<div id="progressbarXX5" style="text-align: center;">0%</div>
																		</div>
																		<span class="cssProgress-label" id="information" ></span>
																	</div>
															    </div>
		                                    ...
		                                    <div class="<?php echo $Active8; ?> tab-pane" id="itm8" style="display: none;">
		                                        <div class="form-group">
		                                        	<form method="post" name="frmSearch8" id="frmSearch8" action="">
														...
														<br>
												        <div class="row">
															<div class="col-md-12" id="idprogbar8" style="display: none;">
																<div class="cssProgress">
															      	<div class="cssProgress">
																	    <div class="progress3">
																			<div id="progressbarXX8" style="text-align: center;">0%</div>
																		</div>
																		<span class="cssProgress-label" id="information" ></span>
																	</div>
															    </div>
				...
				<script type="text/javascript">
					$(document).ready(function()
					{
				    	...
				    	$('#example1').DataTable(
				    	{
							"dom": "<'row'<'col-sm-2'l><'col-sm-7'<'toolbar_01'>><'col-sm-3'f>>"+
							"<'row'<'col-sm-12'tr>>",
					        "processing": true, 
					        "serverSide": true,
							//"scrollX": false,
					        ...
					        // "type": "POST",
							"ajax": {
								"url": "<?php echo site_url('c_project/c_s180d0bpk/get_AllDataM/?id='.$PRJCODE)?>",
								"type": "POST",
								"data": function(data) {
									data.ITM_SRC 	= $('#ITMM_SRC').val();
									// data.ITMCAT_SRC = $('#WO_CATEG').val();
								}
							},
							"lengthMenu": [[10, 25, 50, 100, 200, -1], [10, 25, 50, 100, 200, "All"]],
							...
							"columnDefs": [	{ targets: [0,1,3], className: 'dt-body-center' },
											...
											{ sortable: false, targets: [4,5,6,7] }
										  ],
							"language": {
					            "infoFiltered":"",
					            "processing": "<img src='<?php echo base_url() . 'assets/AdminLTE-2.0.5/dist/img/loading/loading1.gif'; ?>' width='150' />"
						...
						$('div.toolbar_01').html('<form id="form-filter_01" class="form-horizontal">'+
						'<select class="form-control select2" name="ITMM_SRC" id="ITMM_SRC" style="width: 250px;">'+
						'<option value=""></option></select>&nbsp;'+
						'<button type="button" class="btn btn-warning" id="btn-reset_01" name="btn-reset_01"><i class="fa fa-eraser"></i>&nbsp;Clear</button>'+
						'</form>');

						$("#ITMM_SRC").change(function()
						{
							$('#example1').DataTable().ajax.reload();
						});

						$('#btn-reset_01').click(function(){
							$('#ITMM_SRC').val('').trigger('change');
							$('#example1').DataTable().ajax.reload();
						});

						$('#example2').DataTable(
				    	{
							"dom": "<'row'<'col-sm-2'l><'col-sm-7'<'toolbar_02'>><'col-sm-3'f>>"+
							"<'row'<'col-sm-12'tr>>",
					        "processing": true, 
					        "serverSide": true,
							//"scrollX": false,
					        ...
					        // "type": "POST",
							"ajax": {
								"url": "<?php echo site_url('c_project/c_s180d0bpk/get_AllDataU/?id='.$PRJCODE)?>",
								"type": "POST",
								"data": function(data) {
									data.ITM_SRC 	= $('#ITMU_SRC').val();
									// data.ITMCAT_SRC = $('#WO_CATEG').val();
								}
							},
							"lengthMenu": [[10, 25, 50, 100, 200, -1], [10, 25, 50, 100, 200, "All"]],
						...
						$('div.toolbar_02').html('<form id="form-filter_02" class="form-horizontal">'+
						'<select class="form-control select2" name="ITMU_SRC" id="ITMU_SRC" style="width: 250px;">'+
						'<option value=""></option></select>&nbsp;'+
						'<button type="button" class="btn btn-warning" id="btn-reset_02" name="btn-reset_02"><i class="fa fa-eraser"></i>&nbsp;Clear</button>'+
						'</form>');

						$("#ITMU_SRC").change(function()
						{
							$('#example2').DataTable().ajax.reload();
						});

						$('#btn-reset_02').click(function(){
							$('#ITMU_SRC').val('').trigger('change');
							$('#example2').DataTable().ajax.reload();
						});

						$('#example3').DataTable(
				    	{
							"dom": "<'row'<'col-sm-2'l><'col-sm-7'<'toolbar_03'>><'col-sm-3'f>>"+
							"<'row'<'col-sm-12'tr>>",
					        "processing": true, 
					        "serverSide": true,
							//"scrollX": false,
					        ...
					        // "type": "POST",
							"ajax": {
								"url": "<?php echo site_url('c_project/c_s180d0bpk/get_AllDataA/?id='.$PRJCODE)?>",
								"type": "POST",
								"data": function(data) {
									data.ITM_SRC 	= $('#ITMA_SRC').val();
									// data.ITMCAT_SRC = $('#WO_CATEG').val();
								}
							},
							"lengthMenu": [[10, 25, 50, 100, 200, -1], [10, 25, 50, 100, 200, "All"]],
						...
						$('div.toolbar_03').html('<form id="form-filter_03" class="form-horizontal">'+
						'<select class="form-control select2" name="ITMA_SRC" id="ITMA_SRC" style="width: 250px;">'+
						'<option value=""></option></select>&nbsp;'+
						'<button type="button" class="btn btn-warning" id="btn-reset_03" name="btn-reset_03"><i class="fa fa-eraser"></i>&nbsp;Clear</button>'+
						'</form>');

						$("#ITMA_SRC").change(function()
						{
							$('#example3').DataTable().ajax.reload();
						});

						$('#btn-reset_03').click(function(){
							$('#ITMA_SRC').val('').trigger('change');
							$('#example3').DataTable().ajax.reload();
						});

				    	$('#example4').DataTable(
				    	{
							"dom": "<'row'<'col-sm-2'l><'col-sm-7'<'toolbar_04'>><'col-sm-3'f>>"+
							"<'row'<'col-sm-12'tr>>",
					        "processing": true, 
					        "serverSide": true,
							//"scrollX": false,
					        ...
					        // "type": "POST",
							"ajax": {
								"url": "<?php echo site_url('c_project/c_s180d0bpk/get_AllDataS/?id='.$PRJCODE)?>",
								"type": "POST",
								"data": function(data) {
									data.ITM_SRC 	= $('#ITMS_SRC').val();
									// data.ITMCAT_SRC = $('#WO_CATEG').val();
								}
							},
							"lengthMenu": [[10, 25, 50, 100, 200, -1], [10, 25, 50, 100, 200, "All"]],
						...
						$('div.toolbar_04').html('<form id="form-filter_04" class="form-horizontal">'+
						'<select class="form-control select2" name="ITMS_SRC" id="ITMS_SRC" style="width: 250px;">'+
						'<option value=""></option></select>&nbsp;'+
						'<button type="button" class="btn btn-warning" id="btn-reset_04" name="btn-reset_04"><i class="fa fa-eraser"></i>&nbsp;Clear</button>'+
						'</form>');

						$("#ITMS_SRC").change(function()
						{
							$('#example4').DataTable().ajax.reload();
						});

						$('#btn-reset_04').click(function(){
							$('#ITMS_SRC').val('').trigger('change');
							$('#example4').DataTable().ajax.reload();
						});

						$('#example5').DataTable(
				    	{
							"dom": "<'row'<'col-sm-2'l><'col-sm-7'<'toolbar_05'>><'col-sm-3'f>>"+
							"<'row'<'col-sm-12'tr>>",
					        "processing": true, 
					        "serverSide": true,
							//"scrollX": false,
					        ...
					        // "type": "POST",
							"ajax": {
								"url": "<?php echo site_url('c_project/c_s180d0bpk/get_AllDataO/?id='.$PRJCODE)?>",
								"type": "POST",
								"data": function(data) {
									data.ITM_SRC 	= $('#ITMO_SRC').val();
									// data.ITMCAT_SRC = $('#WO_CATEG').val();
								}
							},
							"lengthMenu": [[10, 25, 50, 100, 200, -1], [10, 25, 50, 100, 200, "All"]],
						...
						$('div.toolbar_05').html('<form id="form-filter_05" class="form-horizontal">'+
						'<select class="form-control select2" name="ITMO_SRC" id="ITMO_SRC" style="width: 250px;">'+
						'<option value=""></option></select>&nbsp;'+
						'<button type="button" class="btn btn-warning" id="btn-reset_05" name="btn-reset_05"><i class="fa fa-eraser"></i>&nbsp;Clear</button>'+
						'</form>');

						$("#ITMO_SRC").change(function()
						{
							$('#example5').DataTable().ajax.reload();
						});

						$('#btn-reset_05').click(function(){
							$('#ITMO_SRC').val('').trigger('change');
							$('#example5').DataTable().ajax.reload();
						});
					...
					function setType(tabType)
					{
						if(tabType == 1)
						{
							...
							document.getElementById('ITM_CATEG').value = ITM_CATEG;
						}
						else if(tabType == 2)
						{
						...
						else if(tabType == 8)
						{
							...
							document.getElementById('ITM_CATEG').value = "";
						}
					}
				</script>
	    	<!-- ============ END MODAL ITEM =============== -->
										                    	...
										                    	<div class="col-md-9">
										                    		<div class="row">
												                    	<div class="col-md-4" style="text-align: right; white-space: nowrap;">
												                    		<?php echo "<i><strong>SPK:</strong></i><br><i class='text-primary' style='font-size: 16px;' id='itmPRVol'><strong></strong></i>"; ?>
												                    	</div>
												                    	<div class="col-md-4" style="text-align: right; white-space: nowrap;">
												                    		<?php echo "<i><strong>Opname:</strong></i><br><i class='text-yellow' style='font-size: 16px;' id='itmPOVol'><strong></strong></i>"; ?>
												                    	</div>
												                    	<div class="col-md-4" style="text-align: right; white-space: nowrap;">
...
<script>
	...
	function recountItmM(row)
	{
		var collID  = document.getElementById('urlRecM'+row).value;
		myarr 		= collID.split('~');
    	url			= myarr[0];
	...
	function recountItmU(row)
	{
		var collID  = document.getElementById('urlRecU'+row).value;
		myarr 		= collID.split('~');
    	url			= myarr[0];

		document.getElementById('btnDetail2').style.display 		= 'none';
		document.getElementById('idClose2').style.display 			= 'none';
		document.getElementById('idRefresh2').style.display 		= 'none';

		document.getElementById('idprogbar2').style.display 		= '';
	    document.getElementById("progressbarXX2").innerHTML			="<div class='cssProgress-bar cssProgress-primary cssProgress-active' style='width: 100%; text-align:center; font-weight:bold;'><span style='text-align:center; font-weight:bold'>Please wait, we are processing synchronization ...</span></div>";
        ...
        $.ajax({
            ...
            success: function(response)
            {
                ...
                .then(function()
                {
					...
					document.getElementById('btnDetail2').style.display 		= '';
					document.getElementById('idClose2').style.display 			= '';
					document.getElementById('idRefresh2').style.display 		= '';
	...
	function recountItmA(row)
	{
		var collID  = document.getElementById('urlRecA'+row).value;
		myarr 		= collID.split('~');
    	url			= myarr[0];

		document.getElementById('btnDetail3').style.display 		= 'none';
		document.getElementById('idClose3').style.display 			= 'none';
		document.getElementById('idRefresh3').style.display 		= 'none';

		document.getElementById('idprogbar3').style.display 		= '';
	    document.getElementById("progressbarXX3").innerHTML			="<div class='cssProgress-bar cssProgress-primary cssProgress-active' style='width: 100%; text-align:center; font-weight:bold;'><span style='text-align:center; font-weight:bold'>Please wait, we are processing synchronization ...</span></div>";
        ...
        $.ajax({
            ...
            success: function(response)
            {
                ...
                .then(function()
                {
					...
					document.getElementById('btnDetail3').style.display 		= '';
					document.getElementById('idClose3').style.display 			= '';
					document.getElementById('idRefresh3').style.display 		= '';

					document.getElementById('idprogbar3').style.display 		= 'none';
				    document.getElementById("progressbarXX3").innerHTML			="<div class='cssProgress-bar cssProgress-primary cssProgress-active' style='width: 100%; text-align:center; font-weight:bold;'><span style='text-align:center; font-weight:bold'>Please wait, we are processing synchronization ...</span></div>";
                })
            }
        });
	...
	function recountItmS(row)
	{
		var collID  = document.getElementById('urlRecS'+row).value;
		myarr 		= collID.split('~');
    	url			= myarr[0];

		document.getElementById('btnDetail4').style.display 		= 'none';
		document.getElementById('idClose4').style.display 			= 'none';
		document.getElementById('idRefresh4').style.display 		= 'none';

		document.getElementById('idprogbar4').style.display 		= '';
	    document.getElementById("progressbarXX4").innerHTML			="<div class='cssProgress-bar cssProgress-primary cssProgress-active' style='width: 100%; text-align:center; font-weight:bold;'><span style='text-align:center; font-weight:bold'>Please wait, we are processing synchronization ...</span></div>";
        ...
        $.ajax({
            ...
            success: function(response)
            {
                ...
                .then(function()
                {
					...
					document.getElementById('btnDetail4').style.display 		= '';
					document.getElementById('idClose4').style.display 			= '';
					document.getElementById('idRefresh4').style.display 		= '';

					document.getElementById('idprogbar4').style.display 		= 'none';
				    document.getElementById("progressbarXX4").innerHTML			="<div class='cssProgress-bar cssProgress-primary cssProgress-active' style='width: 100%; text-align:center; font-weight:bold;'><span style='text-align:center; font-weight:bold'>Please wait, we are processing synchronization ...</span></div>";
                })
            }
        });
	...
	function recountItmO(row)
	{
		var collID  = document.getElementById('urlRecO'+row).value;
		myarr 		= collID.split('~');
    	url			= myarr[0];

		document.getElementById('btnDetail5').style.display 		= 'none';
		document.getElementById('idClose5').style.display 			= 'none';
		document.getElementById('idRefresh5').style.display 		= 'none';

		document.getElementById('idprogbar5').style.display 		= '';
	    document.getElementById("progressbarXX5").innerHTML			="<div class='cssProgress-bar cssProgress-primary cssProgress-active' style='width: 100%; text-align:center; font-weight:bold;'><span style='text-align:center; font-weight:bold'>Please wait, we are processing synchronization ...</span></div>";
        ...
        $.ajax({
            ...
            success: function(response)
            {
                ...
                .then(function()
                {
					...
					document.getElementById('btnDetail5').style.display 		= '';
					document.getElementById('idClose5').style.display 			= '';
					document.getElementById('idRefresh5').style.display 		= '';

					document.getElementById('idprogbar5').style.display 		= 'none';
				    document.getElementById("progressbarXX5").innerHTML			="<div class='cssProgress-bar cssProgress-primary cssProgress-active' style='width: 100%; text-align:center; font-weight:bold;'><span style='text-align:center; font-weight:bold'>Please wait, we are processing synchronization ...</span></div>";
                })
            }
        });
	...
	{
		let ITM_CATEG	= document.getElementById('ITM_CATEG').value;
		...
		else if(ITM_CATEG == 'A' || ITM_CATEG == 'T')
		{
			document.getElementById('btnDetail3').style.display 		= 'none';
			document.getElementById('idClose3').style.display 			= 'none';
			document.getElementById('idRefresh3').style.display 		= 'none';
		...
		{
			document.getElementById('btnDetail8').style.display 		= 'none';
			document.getElementById('idClose8').style.display 			= 'none';
			document.getElementById('idRefresh8').style.display 		= 'none';

			document.getElementById('idprogbar8').style.display 		= '';
			document.getElementById("progressbarXX8").innerHTML			="<div class='cssProgress-bar cssProgress-primary cssProgress-active' style='width: 100%; text-align:center; font-weight:bold;'><span style='text-align:center; font-weight:bold'>Please wait, we are processing synchronization ...</span></div>";
		}
            ...
            success: function(response)
            {
                ...
                .then(function()
                {
					...
					else
					{
						...
						document.getElementById('btnDetail8').style.display 		= '';
						document.getElementById('idClose8').style.display 			= '';
						document.getElementById('idRefresh8').style.display 		= '';

						document.getElementById('idprogbar8').style.display 		= 'none';
						document.getElementById("progressbarXX8").innerHTML			="<div class='cssProgress-bar cssProgress-primary cssProgress-active' style='width: 100%; text-align:center; font-weight:bold;'><span style='text-align:center; font-weight:bold'>Please wait, we are processing synchronization ...</span></div>";
					}
                })
            }
	...
	function addUCODE()
	{
		...
		var DOCDATE		= document.getElementById('WO_DATE').value;
		var ACC_ID		= "";
		var PDManNo 	= "";
		var DOCTYPE 	= "WO";
		...
		$('#frm').validate({
	    	submitHandler: function(form)
	    	{
				...
				if(WO_CATEG == 'SALT' && FPA_CODE == '')
				{
			  	...
			  	let tglB 		= $('#datepicker1').val().split('/');
			  	var tglB_dy 	= tglB[0];
			  	var tglB_mn 	= tglB[1];
			  	var tglB_yr 	= tglB[2];
			  	var tglB_dt 	= new Date(tglB_yr, tglB_mn, tglB_dy);

			  	let tglC 		= $('#datepicker2').val().split('/');
			  	var tglC_dy 	= tglC[0];
			  	var tglC_mn 	= tglC[1];
			  	var tglC_yr 	= tglC[2];
			  	var tglC_dt 	= new Date(tglC_yr, tglC_mn, tglC_dy);
				
				if(tglB_dt > tglC_dt)
				{
					swal('Tanggal Mulai SPK tidak boleh lebih besar dari tanggl selesai SPK',
					{
						icon:"warning",
					})
					.then(function()
	...
	function add_fpa(strItem)
	{
    	...
    	$('#example8').DataTable(
    	{
			"dom": "<'row'<'col-sm-2'l><'col-sm-7'<'toolbar_08'>><'col-sm-3'f>>"+
			"<'row'<'col-sm-12'tr>>",
			"destroy":true,
	        "processing": true, 
	        "serverSide": true,
	        ...
	        // "type": "POST",
			"ajax": {
				"url": "<?php echo site_url('c_project/c_s180d0bpk/get_AllDataFPAITM/?id='.$PRJCODE.'&FPA_NUM=')?>"+FPA_NUM,
				"type": "POST",
				"data": function(data) {
					data.ITM_SRC = $('#ITMFPA_SRC').val();
					// data.ITMCAT_SRC = $('#WO_CATEG').val();
				}
			},
			"lengthMenu": [[10, 25, 50, 100, 200, -1], [10, 25, 50, 100, 200, "All"]],
		...
		$('div.toolbar_08').html('<form id="form-filter_08" class="form-horizontal">'+
		'<select class="form-control select2" name="ITMFPA_SRC" id="ITMFPA_SRC" style="width: 250px;">'+
		'<option value=""></option></select>&nbsp;'+
		'<button type="button" class="btn btn-warning" id="btn-reset_08" name="btn-reset_08"><i class="fa fa-eraser"></i>&nbsp;Clear</button>'+
		'</form>');

		$("#ITMFPA_SRC").change(function()
		{
			$('#example8').DataTable().ajax.reload();
		});

		$('#btn-reset_08').click(function(){
			$('#ITMFPA_SRC').val('').trigger('change');
			$('#example8').DataTable().ajax.reload();
		});
		...
		var ITM_CATEG	= "T";
		$.ajax({
			url: "<?php echo site_url('c_project/c_s180d0bpk/get_ITMFPASRC/?id='.$PRJCODE.'&WO_CATEG=T&FPA_NUM=')?>"+FPA_NUM,
			dataType: "JSON",
			beforeSend: function() {
				$('#ITMFPA_SRC').select2({
					placeholder: "Please waitting..."
	...
	function add_item(strItem)
	{
		...
		// FIELD LIST
			...
			JOB_ACC_UMV 	= JOB_ACC_UM;
			if ( isNaN(JOB_ACC_UM))
				JOB_ACC_UMV = "No Account";

			let DescAcc 	= '<div style="font-style: italic;"><i class="text-muted fa fa-chevron-circle-right"></i>&nbsp;&nbsp;'+JOB_ACC_UMV+'</div>';
		...
		// VIEW ONLY
			if(ITM_UNIT == 'LS' || ITM_UNIT == 'LOT' || ITM_UNIT == 'BLN' || ITM_UNIT == 'TH' || ITM_UNIT == 'THN' || ITM_UNIT == 'Org' || ITM_UNIT == 'BULAN')
			{
				var isLS 	= 1;
		...
		// console.log('WO_TOTAL ==== '+WO_TOTAL);

		// console.log('i')
		// Item Unit Type -- ITM_UNIT
			objTD = objTR.insertCell(objTR.cells.length);
			objTD.style.textAlign = 'center';
			objTD.innerHTML = '<input type="text" name="data['+intIndex+'][ITM_UNIT2]" id="data'+intIndex+'ITM_UNIT2" value="'+ITM_UNIT+'" class="form-control" style="text-align:center; width:90px;"><input type="hidden" name="data['+intIndex+'][ITM_UNIT]" id="data'+intIndex+'ITM_UNIT" value="'+ITM_UNIT+'" class="form-control" style="text-align:center; width:90px;">';
		...
		// PPn Amount
			var TAXPRICE1vW 	= doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(0)), 2))
			objTD = objTR.insertCell(objTR.cells.length);
			objTD.style.textAlign = 'right';
			objTD.innerHTML = '<input type="text" name="TAXPRICE1'+intIndex+'" id="TAXPRICE1'+intIndex+'" size="20" value="'+TAXPRICE1vW+'" class="form-control" style="min-width:110px; max-width:300px; text-align:right" disabled>'+
							  '<input type="hidden" name="data['+intIndex+'][TAXPERC1]" id="data'+intIndex+'TAXPERC1"  value="0" class="form-control" style="min-width:70px; max-width:70px;">'+
							  '<input type="hidden" name="data['+intIndex+'][TAXPRICE1]" id="data'+intIndex+'TAXPRICE1" size="20" value="0" class="form-control" style="min-width:110px; max-width:300px; text-align:left">';

		// console.log('m')
		// Tax PPH -- TAXCODE2, TAXPRICE2
			objTD = objTR.insertCell(objTR.cells.length);
			objTD.style.textAlign = 'right';
			objTD.innerHTML = '<select name="data['+intIndex+'][TAXCODE2]" id="TAXCODE2'+intIndex+'" class="form-control" style="min-width: 80px; max-width:150px" onChange="getWOPPH(this.value,'+intIndex+');"><option value=""> --- </option><?php $s_02 	= "SELECT A.TAXLA_NUM, A.TAXLA_DESC FROM tbl_tax_la A INNER JOIN tbl_chartaccount_$PRJHOVW B ON A.TAXLA_LINKIN = B.Account_Number"; $r_02 	= $this->db->query($s_02)->result(); foreach($r_02 as $rw_02): $PPH_NUM 	= $rw_02->TAXLA_NUM; $PPH_DESC = $rw_02->TAXLA_DESC; ?> <option value="<?php echo $PPH_NUM?>"><?php echo $PPH_DESC?></option> <?php endforeach; ?></select>';
		...
		// PPh Ammount
			var TAXPRICE2vW 	= doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(0)), 2));
			objTD = objTR.insertCell(objTR.cells.length);
			objTD.style.textAlign = 'right';
			objTD.innerHTML = '<input type="text" name="TAXPRICE2'+intIndex+'" id="TAXPRICE2'+intIndex+'" size="20" value="'+TAXPRICE2vW+'" class="form-control" style="min-width:110px; max-width:300px; text-align:right" onChange="getWOPPHVAL('+intIndex+');">'+
							  '<input type="hidden" name="data['+intIndex+'][TAXPERC2]" id="data'+intIndex+'TAXPERC2"  value="0" class="form-control" style="min-width:70px; max-width:70px;">'+
							  '<input type="hidden" name="data['+intIndex+'][TAXPRICE2]" id="data'+intIndex+'TAXPRICE2" size="20" value="0" class="form-control" style="min-width:110px; max-width:300px; text-align:left">';
	...
	function getWOVol(thisVal1, row)
	{
		...
		WO_TOTAL 		= RoundNDecimal(parseFloat(WO_VOLM) * parseFloat(WO_PRICE), 2);
		...
		{
			// console.log('WO_PRICE = '+WO_PRICE+' - WO_TOTAL = '+WO_TOTAL+' > ITM_REM_AMN = '+ITM_REM_AMN)
			if(WO_TOTAL > ITM_REM_AMN)
			{
				swal('<?php echo $alertGreat; ?>',
				{
	...
	function getWOPrice(thisVal1, row)
	{
		...
		if(WO_TOTAL > ITM_REM_AMN)
		{
			ITM_REM_VOLP 	= ITM_REM_VOL;
			if(ITM_REM_VOL == 0)
				ITM_REM_VOLP = 1;

			var WO_PRICE 	= parseFloat(ITM_REM_AMN) / parseFloat(ITM_REM_VOLP);

			// console.log('WO_TOTAL = '+WO_TOTAL+' > ITM_REM_AMN = '+ITM_REM_AMN+ 'ITM_REM_VOLP = '+ITM_REM_VOLP)
		...
		else
		{
			...
			$.ajax({
				...
				success: function(response)
				{
					...
					document.getElementById('data'+row+'TAXPRICE1').value	= PPN_VAL;
					document.getElementById('TAXPRICE1'+row).value			= doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(PPN_VAL)), 2));
		...
		else
		{
			...
			$.ajax({
				...
				success: function(response)
				{
					...
					document.getElementById('data'+row+'TAXPRICE2').value	= PPH_VAL;
					document.getElementById('TAXPRICE2'+row).value			= doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(PPH_VAL)), 2));
	...
	function getWOPPHVAL(row)
	{
		PPH_VAL1 	= document.getElementById('TAXPRICE2'+row);
		PPH_VAL 	= parseFloat(eval(PPH_VAL1).value.split(",").join(""));
		WO_VOLM1 	= document.getElementById('WO_VOLM'+row);
		WO_VOLM 	= parseFloat(eval(WO_VOLM1).value.split(",").join(""));
		ITM_PRICE1 	= document.getElementById('ITM_PRICE'+row);
		ITM_PRICE 	= parseFloat(eval(ITM_PRICE1).value.split(",").join(""));
		PPN_VAL1 	= document.getElementById('TAXPRICE1'+row);
		PPN_VAL 	= parseFloat(eval(PPN_VAL1).value.split(",").join(""));
		
		document.getElementById('data'+row+'TAXPRICE2').value 	= PPH_VAL;
		document.getElementById('TAXPRICE2'+row).value 			= doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(PPH_VAL)), 2));
		

		WO_TOTAL 	= parseFloat(WO_VOLM) * parseFloat(ITM_PRICE);
	...
	function cancelRow(row) 
	{
        ...
        var WO_VOLM     = myarr[5];
		var WO_CVOL 	= myarr[6];
        var OPN_VOLM    = myarr[7];
        var REM_VOLWO   = myarr[8];
        var ITM_UNIT   	= myarr[9];
        var WO_ID   	= myarr[10];
        // console.log('WO_VOLM = '+WO_VOLM)
        // console.log('WO_CVOL = '+WO_CVOL)
        // console.log('OPN_VOLM = '+OPN_VOLM)
        // console.log('REM_VOLWO = '+REM_VOLWO)
		...
		document.getElementById('itmPRVol').innerHTML 	= doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(WO_VOLM-WO_CVOL)), 2))+' '+ITM_UNIT;
	...
	function checkInp()
	{
	  	/*let tglA 		= $('#datepicker').val().split('/');
	  	var tglA_dy 	= tglA[0];
	  	var tglA_mn 	= tglA[1];
	  	var tglA_yr 	= tglA[2];
	  	var tglA_dt 	= new Date(tglA_yr, tglA_mn, tglA_dy);
	  	var tglA_dt1	= new Date(tglA_mn+"/"+tglA_dy+"/"+tglA_yr);*/
	  	...
	  	var tglB_yr 	= tglB[2];
	  	var tglB_dt 	= new Date(tglB_yr, tglB_mn, tglB_dy);
	  	var tglB_dt2	= new Date(tglB_mn+"/"+tglB_dy+"/"+tglB_yr);
	  	...
	  	/*var tglB_Dev 	= tglB_dt2.getTime() - tglA_dt1.getTime();
	  	var tglB_DevDy 	= tglB_Dev / (1000 * 3600 * 24);*/
		...
		if(WO_PAYNOTE == '')
		{
			...
			.then(function()
			{
				document.getElementById('WO_PAYNOTE').focus();
			});
			return false;
		}
	...
	function getConvertion(thisVal1, row)
	{
		...
		// CHECK DOKUMEN KONTRAK, JIKA TOTAL OP/SPK > 100 JT WAJIB ISI DOK. KONTRAK
			var WO_REFNO 	= document.getElementById('WO_REFNO').value;
			var WO_CATEG		= document.getElementById("WO_CATEG").value;
			if(parseFloat(GTOTAL_WO) > 100000000 && WO_REFNO.trim() == '' && WO_CATEG != 'U')
			{
				swal('Total SPK ini lebih dari 100.000.000! Anda DIHARUSKAN mengisi no kontrak',
				{
					icon: "warning",
				})
				.then(function()
	...
	function getTotalWO()
	{
		...
		let WO_DPVAL 		= parseFloat(document.getElementById('WO_DPVAL').value);
		let WO_RETVAL 		= parseFloat(document.getElementById('WO_RETVAL').value);
		...
		GtotPPN 			= parseFloat(totPPN); 									// Total PPn dari nilai asli setelah konfirmasi ke Pak Edi Wong tgl 28 des 2022
		totPPHP 			= parseFloat(totPPH / totWO);
		//GtotPPH 			= parseFloat(totWO - WO_DPVAL - WO_RETVAL) * totPPHP; 	// Total PPn setelah dipotong DP & Retensi
		GtotPPH 			= parseFloat(totPPH); 									// Total PPh dari nilai asli setelah konfirmasi ke Pak Edi Wong tgl 28 des 2022

		console.log ('GtotPPH === '+GtotPPH);
		...
		// CHECK DOKUMEN KONTRAK, JIKA TOTAL OP/SPK > 500 JT WAJIB ISI DOK. KONTRAK
			var WO_REFNO 	= document.getElementById('WO_REFNO').value;
			if(parseFloat(totWO) > 500000000 && WO_REFNO.trim() == '')
			{
				swal('Total SPK ini lebih dari 500.000.000! Anda DIHARUSKAN mengisi no kontrak',
				{
					icon: "warning",
