 ...
 * File Name	= ovh_spk_inb_form.php
 * Location		= -
*/
				            	...
				            	<div class="form-group">
				                    ...
				                    <div class="col-sm-4">
				                    	<select name="WO_CATEG1" id="WO_CATEG1" class="form-control select2" disabled>
				                          	...
				                          	<option value="O" <?php if($WO_CATEG == 'O') { ?> selected <?php } ?>> Overhead</option>
				                        </select>
		                ...
		                <div class="form-group">
		                    ...
		                    <div class="col-sm-9">
		                    	<?php
									...
									$backURL	= site_url('c_project/c_s180d0bpk/ibx1_ovh/?id='.$this->url_encryption_helper->encode_url($PRJCODE));
