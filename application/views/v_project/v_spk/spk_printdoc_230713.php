                ...
                <table width="100%" border="1" cellpadding="0" cellspacing="0">
                    <thead>
                        ...
                        <tr style="height: 100px;">
                            <td width="<?=$COLW?>" style="vertical-align: top; <?php if($PRJHO != 'KTR') { ?> display: none;" <?php } ?>>
                            ...
                            <td width="<?=$COLW?>" style="vertical-align: top; <?php if(($WO_CATEG != 'A' && $PRJHO != 'KTR') || $PRJHO != 'NKE') { ?> display: none; <?php } ?>" >
                            ...
                            <td width="<?=$COLW?>" style="vertical-align: top; <?php if($WO_CATEG == 'A' || $PRJHO == 'KTR') { ?> display: none; <?php } ?>" >
