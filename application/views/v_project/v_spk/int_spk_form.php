...
/*
	...
	* Create Date	= 25 Oktober 2022
	* File Name		= int_spk_form.php
	* Location		= -
*/
...
if($task == 'add')
{
	...
	$SPLCODE		= '';
	$WO_DEPT		= '';
	$WO_CATEG		= 'T'; // SPK Sewa Alat Internal
	$WO_TYPE		= 'PO';
	$JOBCODEID		= '';
	$PR_REFNO		= '';
	$JOBCODE1		= $PR_REFNO;
				            	...
				            	<div class="form-group">
				                    ...
				                    <div class="col-sm-4">
				                    	<select name="WO_CATEG" id="WO_CATEG" class="form-control select2" onChange="changeCODE(this.value)" >
				                          	...
				                          	?>
				                          	<option value="T" <?php echo $WO_CATEG == 'T' ? 'selected':'' ?>> Alat Internal </option>
				                        </select>
				                    </div>
				                </div>
				                <script>
		                            ...
		                            if($task == 'edit')
		                            {
		                                /*$sqlDET	= "SELECT A.*,
													...
													WHERE A.WO_NUM = '$WO_NUM'
														AND B.PRJCODE = '$PRJCODE'";*/
		                                $sqlDET	= "SELECT A.*,
														C.JOBDESC, C.JOBPARENT, C.ITM_PRICE AS ITM_LASTP, C.ITM_BUDG
													FROM tbl_wo_detail A
														INNER JOIN tbl_joblist_detail C ON A.JOBCODEID = C.JOBCODEID
															AND C.PRJCODE = '$PRJCODE'
															AND A.ITM_CODE = C.ITM_CODE
		                                    ...
		                                    <tr id="tr_<?php echo $currentRow; ?>" style="vertical-align: middle;">
			                                    ...
			                                    <td style="text-align:right; vertical-align: middle;" nowrap>
											  	...
											  	<td nowrap style="text-align:center; vertical-align: middle;">
												  	<input type="text" name="data[<?php echo $currentRow; ?>][ITM_UNIT2]" id="data<?php echo $currentRow; ?>ITM_UNIT2" value="<?php echo $ITM_UNIT2; ?>" class="form-control" style="text-align:center; width:90px; text-transform:uppercase;" >
												...
												<td style="text-align:center; vertical-align: middle;" nowrap>
				                                    ...
				                                    <?php } else { ?>
														<input type="text" name="TAXPRICE1<?php echo $currentRow; ?>" id="TAXPRICE1<?php echo $currentRow; ?>" size="20" value="<?php echo number_format($TAXPRICE1, 2); ?>" class="form-control" style="min-width:110px; max-width:300px; text-align:right" disabled>
														<input type="hidden" name="data[<?php echo $currentRow; ?>][TAXPRICE1]" id="data<?php echo $currentRow; ?>TAXPRICE1" size="20" value="<?php echo $TAXPRICE1; ?>" class="form-control" style="min-width:110px; max-width:300px; text-align:left">
														<input type="hidden" name="data[<?php echo $currentRow; ?>][TAXPERC1]" id="data<?php echo $currentRow; ?>TAXPERC1" size="20" value="<?php echo $TAXPERC1; ?>" class="form-control" style="min-width:110px; max-width:300px; text-align:right">
				                                    <?php } ?>    
			                                    </td>
		                ...
		                <div class="form-group">
		                    ...
		                    <div class="col-sm-9">
		                    	<?php
									...
									$backURL	= site_url('c_project/c_s180d0bpk/gallS180d0bpk_int/?id='.$this->url_encryption_helper->encode_url($PRJCODE));
...
<script>
	...
	function add_item(strItem)
	{
		...
		// Item Unit Type -- ITM_UNIT
			...
			objTD.innerHTML = '<input type="text" name="data['+intIndex+'][ITM_UNIT2]" id="data'+intIndex+'ITM_UNIT2" value="'+ITM_UNIT+'" class="form-control" style="text-align:center; width:90px; text-transform:uppercase;" >'+
								'<input type="hidden" name="data['+intIndex+'][ITM_UNIT]" id="data'+intIndex+'ITM_UNIT" value="'+ITM_UNIT+'" class="form-control" style="max-width:300px;" >';
