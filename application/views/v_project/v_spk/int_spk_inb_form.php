 ...
 * File Name	= int_spk_inb_form.php
 * Location		= -
*/
	                            ...
	                            <table id="tbl" class="table table-bordered table-striped" width="100%">
		                            ...
		                            if($task == 'edit')
		                            {
										...
										$sqlDET	= "SELECT A.*,
													...
													FROM tbl_wo_detail A
														INNER JOIN tbl_joblist_detail_$PRJCODEVW C ON A.JOBCODEID = C.JOBCODEID
															AND C.PRJCODE = '$PRJCODE'
															AND A.ITM_CODE = C.ITM_CODE
														LEFT JOIN tbl_wo_header D ON D.WO_NUM = A.WO_NUM
														    AND D.JOBCODEID = C.JOBPARENT
										...
										foreach($result as $row) :
											...
											$JOBDESCH		= "";
											$sqlJOBDESC		= "SELECT JOBDESC FROM tbl_joblist_$PRJCODEVW WHERE JOBCODEID = '$JOBPARENT' LIMIT 1";
