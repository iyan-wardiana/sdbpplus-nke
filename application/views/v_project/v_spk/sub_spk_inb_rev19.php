...
<h1>
    ...
    <small><?php echo "$Approval - Subcont"; ?></small>
  </h1><br>
				...
				foreach($vData as $row) :				
					...
					if ($j==1) {
						...
						?>
								...
								<td style="text-align:center"><?php echo $WO_CREATER; ?></td>
                                ...
                                <?php
									$secUpd		= site_url('c_project/c_s180d0bpk/update_inb_sub/?id='.$this->url_encryption_helper->encode_url($WO_NUM));
