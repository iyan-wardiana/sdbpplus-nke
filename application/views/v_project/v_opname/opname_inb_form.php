...
<html>
    ...
    <body class="<?php echo $appBody; ?>" style="background-color: <?=$comp_color?>">
        <section class="content-header">
            <h1>
                <img src="<?php echo base_url() . 'assets/AdminLTE-2.0.5/dist/img/icon/opname.png'; ?>" style="max-width:40px; max-height:40px" >&nbsp;&nbsp;<?php echo "$mnName ($PRJCODE)"; ?>
                                    ...
                                    <?php
                                        ...
                                        if($resultC > 0)
                                        {
                                            ...
                                            foreach($resDETWO as $row) :
                                                ...
                                                //$OPND_ITMTOTAL2 = $OPND_ITMTOTAL - $OPND_POTDP;
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                <button class="btn btn-primary" id="btnSave" onClick="hideBtn()" <?php if($btnShow == 0) { ?> style="display: none;" <?php } ?> >
