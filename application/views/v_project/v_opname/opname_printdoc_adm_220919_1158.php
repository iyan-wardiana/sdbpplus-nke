<?php
    ...
    // get PRJNAME
        $PRJNAME = "";
        $PRJLOCT = "";
        $get_PRJ = "SELECT PRJNAME, PRJLOCT FROM tbl_project WHERE PRJCODE = '$PRJCODE'";
            ...
            <div class="content-item">
                <div class="content-header">
                    <table width="100%" cellpadding="0" cellspacing="0" border="0">
                        <tr>
                            <td width="100">Kode Opname</td>
                            <td width="10">:</td>
                            <td style="font-weight: 800;"><?php echo "$OPNH_CODE"; ?></td>
                            <td width="130">Kode SPK</td>
                            <td width="10">:</td>
                            <td><?php echo $WO_CODE; ?></td>
                            <td width="130">Tgl. Opname</td>
                            <td width="10">:</td>
                            <td><?php echo "$OPNH_DATEV"; ?></td>
                        </tr>
                        <tr>
                            <td width="100">Kode Proyek</td>
                            <td width="10">:</td>
                            <td style="font-weight: 800;"><?php echo "$PRJCODE"; ?></td>
                            <td width="130">Tgl. SPK</td>
                            <td width="10">:</td>
                            <td><?php echo $WO_DATEV; ?></td>
                            <td width="130">Opname Ke</td>
                            <td width="10">:</td>
                            <td><?php echo $OPNH_TO; ?></td>
                        </tr>
                        <tr>
                            ...
                            <td width="130">Pgrs sd Opname Ini</td>
                            <td width="10">:</td>
                            ...
                            <?php
                                ...
                                if($res_OPND->num_rows() > 0)
                                {
                                    ...
                                    foreach($res_OPND->result() as $rOPND):
                                        ...
                                        // Get JOBDESC
                                            $getJOBP = "SELECT JOBDESC FROM tbl_joblist WHERE JOBCODEID = '$JOBPARENT' AND PRJCODE = '$PRJCODE'";
                ...
                <div class="footer-detail">
                    <table width="100%" cellpadding="0" cellspacing="0" border="0">
                        ...
                        <tr>
                            ...
                            <td width="10">:</td>
                            <td style="text-align: right;"><?php echo number_format($OPNH_RETAMN, 2); ?></td>
                        </tr>
                        <tr>
                            <td width="100" style="font-weight: bold;">Invoice</td>
                            <td width="10">:</td>
                ...
                <div class="asign-detail">
                    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-right: hidden;">
                        <tr>
                            ...
                            <td>Pernyataan Setuju</td>
                        </tr>
                        <tr height="70">
                            <td style="vertical-align: bottom;">Pelaksana</td>
                            <td style="vertical-align: bottom;">ENG. / QS</td>
                            <td style="vertical-align: bottom;"> QC / QHSE</td>
                            <td style="vertical-align: bottom;">Cost Controll</td>
                            <td style="vertical-align: bottom;">PM / SM</td>
                            <td style="vertical-align: bottom;">Pemasok</td>
                        </tr>
                    </table>
                </div>
            </div>
