...
$OPNH_TOTAMOUNT		= $OPNH_AMOUNT + $OPNH_AMOUNTPPN - $OPNH_RETAMN - $OPNH_POT;
$OPNH_TOTAMOUNTX	= $OPNH_AMOUNT + $OPNH_AMOUNTPPN - $OPNH_AMOUNTPPH - $OPNH_RETAMN - $OPNH_POT;
						...
						<div class="box box-primary">
							...
							<div class="box-body">
				            	...
				            	<div class="form-group">
				                    ...
				                    <div class="col-sm-9">
				                    	<textarea name="OPNH_NOTE" id="OPNH_NOTE" class="form-control" style="height: 75px" cols="30"><?php echo $OPNH_NOTE; ?></textarea>
				                    </div>
				                </div>
...
<script>
	...
	function countGTotalOPN()
	{
		...
		OPNH_RETAMN 			= parseFloat(document.getElementById('OPNH_RETAMN').value);
		GTOTTOTAL 				= parseFloat(GTOT_TOTAL - OPNH_RETAMN);
