							...
							<div class="box-body">
				            	...
				            	<div class="form-group">
				                    ...
				                    <div class="col-sm-5">
				                        ...
				                        <i class="fa fa-calendar"></i>&nbsp;</div><input type="text" name="OPNH_DATE" class="form-control pull-left" id="datepicker" value="<?php echo $OPNH_DATE; ?>" style="width:106px"></div>
				                    </div>
				                    <div class="col-sm-4">
				                    	<div class="input-group date">
				                        <div class="input-group-addon">
				            	...
				            	<div class="form-group">
				                    ...
				                    <div class="col-sm-9">
				                    	<textarea name="OPNH_NOTE" id="OPNH_NOTE" class="form-control" style="height: 65px" cols="30"><?php echo $OPNH_NOTE; ?></textarea>
				                    </div>
				                </div>
					...
					<div class="col-md-6">
						<div class="box box-warning">
							...
							<div class="box-body">
				                ...
				                <!-- OPNH_AMOUNTPPNP, OPNH_AMOUNTPPN -->
				                <div class="form-group">
				                    ...
				                    <div class="col-sm-6">
				                    	<label>
				                            ...
				                            <input type="text" class="form-control" style="max-width:70px; text-align:right;" name="OPNH_AMOUNTPPNPX" id="OPNH_AMOUNTPPNPX" value="<?php echo number_format($OPNH_AMOUNTPPNP, $decFormat); ?>" onBlur="getPPnPer()" readonly>
				                        </label>
				                        <label>
				                        	...
				                        	<input type="text" class="form-control" style="max-width:160px; text-align:right" name="OPNH_AMOUNTPPNX" id="OPNH_AMOUNTPPNX" value="<?php echo number_format($OPNH_AMOUNTPPN, 2); ?>" onBlur="getPPnVal(this)" onKeyPress="return isIntOnlyNew(event);" readonly >
				                        </label>
				                    </div>
				                    <div class="col-sm-3">
								...
								<div class="form-group">
									...
									<div class="col-sm-4">
				                        <label>
				                            ...
				                            <input type="text" class="form-control" style="max-width:160px; text-align:right;" name="DPVAL_WOX" id="DPVAL_WOX" value="<?php echo number_format($DPVAL_WO, $decFormat); ?>" readonly>
				                        </label>
									</div>
									...
									<div class="col-sm-4">
				                        <label>
				                            ...
				                            <input type="text" class="form-control" style="max-width:160px; text-align:right;" name="DPVAL_REMX" id="DPVAL_REMX" value="<?php echo number_format($DPVAL_REM, $decFormat); ?>" readonly>
				                        </label>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
				                        ...
				                        <label>
				                            ...
				                            <input type="text" class="form-control" style="max-width:160px; text-align:right;" name="OPNH_DPVALX" id="OPNH_DPVALX" value="<?php echo number_format($OPNH_DPVAL, $decFormat); ?>" onBlur="getDPVal(this)" >
				                        </label>
									</div>
								</div>
	                            ...
	                            <table id="tbl" class="table table-bordered table-striped" width="100%">
		                            ...
		                            <?php
										...
										else
										{
											...
											{
												//*from data
												$sqlDET		= "SELECT DISTINCT A.JOBCODEDET, A.JOBCODEID, A.WO_ID, A.ITM_CODE, A.ITM_UNIT, A.OPND_VOLM,
																	A.OPND_ITMPRICE, A.OPND_ITMTOTAL, A.OPND_DESC,
										...
										if($resultC > 0)
										{
											...
											foreach($resDETWO as $row) :
													...
													if($ITM_UNIT == 'LS')
													{
														if($task == 'add')
														{
															...
															if($task == 'add')
																...
																$REMOPN_AMN = $OPND_ITMTOTAL;
														}
														else
														{
															$REMOPN_VOL = $OPND_VOLM;
															$REMOPN_AMN = $OPND_ITMTOTAL;
														}
													}
													else
												...
												$TAXPRICE1 		= $TAXPERC1 * $OPND_ITMTOTAL / 100;
												$TAXPRICE2 		= $TAXPERC2 * $OPND_ITMTOTAL / 100;
												$OPND_TOTAL 	= $OPND_ITMTOTAL + $TAXPRICE1 - $TAXPRICE2;;
												...
												<tr id="tr_<?php echo $currentRow; ?>">
													...
													<td width="11%" style="text-align:right" nowrap> <!-- SPK Qty -->
												 	...
												 	<td width="11%" style="text-align:right"> <!-- Opname Now -->
														<?php if($disRow == 0) { ?>
														  	<input type="text" name="OPND_VOLM<?php echo $currentRow; ?>" id="OPND_VOLM<?php echo $currentRow; ?>" value="<?php echo number_format($REMOPN_VOL, 2); ?>" class="form-control" style="min-width:70px; text-align:right" onKeyPress="return isIntOnlyNew(event);" onBlur="chgOPNVol(this,<?php echo $currentRow; ?>);">
														<?php } else { ?>
															<!-- <span class='label label-success' style='font-size:12px'>
																<?php echo number_format($REMOPN_VOL, $decFormat); ?>
															</span> -->
															<?php echo number_format($REMOPN_VOL, $decFormat); ?>
														  	
														  	<input type="hidden" name="OPND_VOLM<?php echo $currentRow; ?>" id="OPND_VOLM<?php echo $currentRow; ?>" value="<?php echo number_format($REMOPN_VOL, 2); ?>" class="form-control" style="min-width:110px; max-width:300px; text-align:right" onKeyPress="return isIntOnlyNew(event);" onBlur="chgOPNVol(this,<?php echo $currentRow; ?>);">
														<?php } ?>

														<input type="hidden" name="data[<?php echo $currentRow; ?>][OPND_VOLM]" id="data<?php echo $currentRow; ?>OPND_VOLM" value="<?php echo $REMOPN_VOL; ?>" class="form-control" style="max-width:300px;" >
													</td>
													...
													<td width="4%" style="text-align:center" nowrap>
														<?php if($disRow == 0) { ?>
															<input type="text" name="OPND_ITMTOTAL<?php echo $currentRow; ?>" id="OPND_ITMTOTAL<?php echo $currentRow; ?>" value="<?php echo number_format($OPND_ITMTOTAL, $decFormat); ?>" class="form-control" style="min-width:110px; max-width:300px; text-align:right" onKeyPress="return isIntOnlyNew(event);" readonly>
														<?php } else { ?>
				                                        	...
				                                        	<form method="post" name="frmSearch1" id="frmSearch1" action="">
					                                            <table id="example0" class="table table-bordered table-striped table-responsive search-table inner" width="100%">
					                                                <thead>
					                                                    <tr>
													                        <th width="2%">&nbsp;</th>
										                                    <th width="10%" style="vertical-align:middle; text-align:center" nowrap><?php echo $NoSPK; ?></th>
										                                    <th width="15%" style="vertical-align:middle; text-align:center"><?php echo $Date; ?></th>
										                                    <th width="43%" nowrap style="text-align:center"><?php echo $Description; ?></th>
										                                    <th width="10%" nowrap style="text-align:center"><?php echo "SPK"; ?></th>
										                                    <th width="10%" nowrap style="text-align:center"><?php echo $QtyOpnamed; ?></th>
...
<script>
	...
	function chgOPNVol(thisVal1, row)
	{
		...
		// SETTING TAX HERE
			...
			{
	        	taxPerc1 	= parseFloat(0 / 100);

	        	itmTax		= parseFloat(OPND_ITMTOTAL) * taxPerc1;
				document.getElementById('data'+row+'TAXPRICE1').value 	= parseFloat(Math.abs(itmTax));
				OPND_TOTAL 	= parseFloat(OPND_ITMTOTAL) + parseFloat(itmTax);
				document.getElementById('data'+row+'OPND_TOTAL').value 	= parseFloat(Math.abs(OPND_TOTAL));
				countTaxPPH(OPND_TOTAL, TAXCODE2, row);
			}
			else
			{
				...
				$.ajax({
		            ...
		            url: url,
		            data: {collID: collID},
		            success: function(taxPercDt)
		            {
		            	var myarr 		= taxPercDt.split("~");
		            	var taxType 	= myarr[0];
		            	var taxPerc1 	= myarr[1];

		            	taxPerc1 	= parseFloat(taxPerc1 / 100);
			        	itmTax		= parseFloat(OPND_ITMTOTAL) * taxPerc1;
						document.getElementById('data'+row+'TAXPRICE1').value 	= parseFloat(Math.abs(itmTax));
						OPND_TOTAL 	= parseFloat(OPND_ITMTOTAL) + parseFloat(itmTax);
						document.getElementById('data'+row+'OPND_TOTAL').value 	= parseFloat(Math.abs(OPND_TOTAL));
						//****console.log('OPND_TOTALx = '+OPND_TOTAL)
						countTaxPPH(OPND_TOTAL, TAXCODE2, row);
		            }
		        });
			}
	...
	function chgOPNPrc(thisVal1, row)
	{
		var decFormat	= document.getElementById('decFormat').value;

		ITM_PRICE		= parseFloat(eval(thisVal1).value.split(",").join(""));
		OPND_VOLM		= parseFloat(document.getElementById('data'+row+'OPND_VOLM').value);
		TOTWO_VOL		= parseFloat(document.getElementById('TOTWO_VOL'+row).value);
		TOTWO_AMN		= parseFloat(document.getElementById('TOTWO_AMN'+row).value);
		TOTOPN_VOL		= parseFloat(document.getElementById('TOTOPN_VOL'+row).value);
		TOTOPN_AMN		= parseFloat(document.getElementById('TOTOPN_AMN'+row).value);
	...
	function countTaxPPH(OPND_TOTAL, TAXCODE2, row)
	{
		OPNDTOTAL 		= parseFloat(OPND_TOTAL);
		OPND_ITMTOTAL 	= parseFloat(document.getElementById('data'+row+'OPND_ITMTOTAL').value);

		var taxPerc2	= 0;
		if(TAXCODE2 == 0 || TAXCODE2 == '')
		{
        	taxPerc2 	= parseFloat(0 / 100);

        	itmTax		= parseFloat(OPND_ITMTOTAL) * taxPerc2;
			document.getElementById('data'+row+'TAXPRICE2').value 	= parseFloat(Math.abs(itmTax));
			countGTotalOPN();
		}
		else
		{
			var url 		= "<?php echo $secGTax; ?>";
			var collID		= "<?php echo $tblTax; ?>~"+TAXCODE2;
			$.ajax({
	            type: 'POST',
	            url: url,
	            data: {collID: collID},
	            success: function(taxPercDt)
	            {
		        	...
		        	itmTax		= parseFloat(OPND_ITMTOTAL) * taxPerc1;
					document.getElementById('data'+row+'TAXPRICE2').value 	= parseFloat(Math.abs(itmTax));
					OPND_TOTAL 	= parseFloat(OPNDTOTAL) - parseFloat(itmTax);
					document.getElementById('data'+row+'OPND_TOTAL').value 	= parseFloat(Math.abs(OPND_TOTAL));
					countGTotalOPN();
	            }
	        });
	...
	function getOPN_VOLM(thisVal1, row)
	{
		...
		TOTWO_VOL			= document.getElementById('TOTWO_VOL'+row).value;
		TOTWO_AMN			= document.getElementById('TOTWO_AMN'+row).value;						// Total SPK Amount
		TOTOPN_VOL			= parseFloat(document.getElementById('TOTOPN_VOL'+row).value);			// Total Opname Approved Qty
		TOTOPN_AMN		= parseFloat(document.getElementById('TOTOPN_AMN'+row).value);		// Total Opname Approved Amount
		...
		REM_OPN_QTY			= parseFloat(TOTWO_VOL) - parseFloat(TOTOPN_VOL);
		//swal(REM_OPN_QTY);
		REM_OPN_AMOUNT		= parseFloat(TOTWO_AMN) - parseFloat(TOTOPN_AMN);
		//swal(REM_OPN_AMOUNT);
	...
	function getDPVal(thisVal)
	{
		...
		if(OPNH_DPVAL > DPVAL_REM)
		{
			...
			.then(function()
            {
				OPNH_DPPER		= parseFloat(DPVAL_REM / totOPN1 * 100);
	...
	function countGTotalOPN()
	{
		...
		for(i=1;i<=totRow;i++)
		{
			...
			{
				// TOTAL BRUTO
				OPND_ITMTOTAL 	= parseFloat(document.getElementById('data'+i+'OPND_ITMTOTAL').value);
				OPND_TOTTAXPPN 	= parseFloat(document.getElementById('data'+i+'TAXPRICE1').value);
				OPND_TOTTAXPPH 	= parseFloat(document.getElementById('data'+i+'TAXPRICE2').value);
				OPND_TOTAL 		= parseFloat(document.getElementById('data'+i+'OPND_TOTAL').value);
				GTOT_ITEM		= parseFloat(GTOT_ITEM + OPND_ITMTOTAL);
				GTOT_PPN		= parseFloat(GTOT_PPN + OPND_TOTTAXPPN);
				GTOT_PPH		= parseFloat(GTOT_PPH + OPND_TOTTAXPPH);
				GTOT_TOTAL		= parseFloat(GTOT_TOTAL + OPND_TOTAL);
			}
		}
		OPNH_DPPER 				= parseFloat(document.getElementById('OPNH_DPPER').value);
		OPNH_DPVAL 				= parseFloat(OPNH_DPPER * GTOT_ITEM / 100);

		document.getElementById('OPNH_DPVAL').value		= OPNH_DPVAL;
		document.getElementById('OPNH_DPVALX').value	= doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(OPNH_DPVAL)), 2));

		console.log('OPNH_DPVAL 	= '+OPNH_DPVAL)
		//****console.log('GTOT_ITEM 	= '+GTOT_ITEM)
		//****console.log('GTOT_PPN 	= '+GTOT_PPN)
		//****console.log('GTOT_PPH 	= '+GTOT_PPH)
		//****console.log('GTOT_TOTAL = '+GTOT_TOTAL)
		OPNH_RETAMN 			= parseFloat(document.getElementById('OPNH_RETAMN').value);
		console.log('GTOT_TOTAL 	= '+GTOT_TOTAL+'-'+OPNH_RETAMN+'-'+OPNH_DPVAL)
		GTOTTOTAL 				= parseFloat(GTOT_TOTAL - OPNH_RETAMN - OPNH_DPVAL);
		console.log('GTOTTOTAL 	= '+GTOTTOTAL)
		//****console.log('a')
		document.getElementById('OPNH_AMOUNT').value		= GTOT_ITEM;
		//****console.log('b')
		document.getElementById('OPNH_AMOUNTX').value		= doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(GTOT_ITEM)), 2));
		//****console.log('b')
		document.getElementById('OPNH_AMOUNTPPN').value		= GTOT_PPN;
		document.getElementById('OPNH_AMOUNTPPNX').value	= doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(GTOT_PPN)), 2));
		//****console.log('d')
		document.getElementById('OPNH_AMOUNTPPH').value		= GTOT_PPH;
		document.getElementById('OPNH_AMOUNTPPHX').value	= doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(GTOT_PPH)), 2));
		//****console.log('e')
		document.getElementById('OPNH_TOTAMOUNT').value 	= GTOTTOTAL;
		document.getElementById('OPNH_TOTAMOUNTX').value 	= doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(GTOTTOTAL)), 2));
		//****console.log('f')
