							...
							<div class="box-body">
				            	...
				            	<div class="form-group">
				                    ...
				                    <div class="col-sm-5">
				                        ...
				                        <i class="fa fa-calendar"></i>&nbsp;</div><input type="text" name="OPNH_DATE" class="form-control pull-left" id="datepicker" value="<?php echo $OPNH_DATE; ?>"></div>
				                    </div>
				                    <div class="col-sm-4">
				                    	<div class="input-group date">
				                        <div class="input-group-addon">
				                        <i class="fa fa-calendar" style="display: none;"></i>&nbsp;</div><input type="text" name="OPNH_DATESP" class="form-control pull-left" id="datepicker1" value="<?php echo $OPNH_DATESP; ?>"></div>
				                    </div>
				                </div>
				            	...
				            	<div class="form-group">
				                    ...
				                    <div class="col-sm-9">
				                    	<textarea name="OPNH_NOTE" id="OPNH_NOTE" class="form-control" style="height: 40px"><?php echo $OPNH_NOTE; ?></textarea>
				                    </div>
				                </div>

				                <!-- OPNH_NOTE2 -->
				            	<div class="form-group">
				                    <label for="inputName" class="col-sm-3 control-label">Cat. Penyetuju</label>
				                    <div class="col-sm-9">
				                    	<textarea name="OPNH_NOTE2" class="form-control" id="OPNH_NOTE2" style="height: 40px" readonly><?php echo $OPNH_NOTE2; ?></textarea>
				                    </div>
				                </div>
				            </div>
				        </div>
					                                            ...
					                                            <table id="example0" class="table table-bordered table-striped table-responsive search-table inner" width="100%">
					                                                <thead>
					                                                    <tr>
										                                    ...
										                                    <th width="58%" nowrap style="text-align:center"><?php echo $Description; ?></th>
...
<script>
	...
	function getAmountRet1()
	{
		...
		// NILAI PPN DAN PPH ADALAH SETELAH DIKURANGI RETENSI DAN PENGEMBALIAN DP
			OPNH_AMOUNT2 	= parseFloat(OPNH_AMOUNT1 - OPNH_RETAMN - OPNH_DPVAL);
			PPN_PERC 		= parseFloat(document.getElementById('OPNH_AMOUNTPPNP').value);
			PPN_AMN 		= parseFloat(PPN_PERC * OPNH_AMOUNT2) / 100;

			document.getElementById('OPNH_AMOUNTPPN').value		= PPN_AMN;
			document.getElementById('OPNH_AMOUNTPPNX').value	= doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(PPN_AMN)), 2));
	...
	function countGTotalOPN()
	{
		...
		// PENGHITUNGAN RETENSI
			...
			OPNH_RETAMN 		= parseFloat(OPNH_RETPERC * GTOT_ITEM / 100);

			document.getElementById('OPNH_RETAMN').value 	= OPNH_RETAMN;
			document.getElementById('OPNH_RETAMNX').value 	= doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(OPNH_RETAMN)), 2));

		// PENGHITUNGAN PENGEMBALIAN DP		
		...
		// PENGHITUNGAN NILAI PPN SETELAH DIKURANGI RETENSI DAN PENGEMBALIAN DP
			OPNH_AMOUNT1 	= parseFloat(GTOT_ITEM - OPNH_RETAMN - OPNH_DPVAL);
			PPN_PERC 		= parseFloat(document.getElementById('OPNH_AMOUNTPPNP').value);
			PPN_AMN 		= parseFloat(PPN_PERC * OPNH_AMOUNT1) / 100;

			document.getElementById('OPNH_AMOUNTPPN').value		= PPN_AMN;
			document.getElementById('OPNH_AMOUNTPPNX').value	= doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(PPN_AMN)), 2));

		// PENGHITUNGAN NILAI PPH ADALAH SETELAH DIKURANGI RETENSI DAN PENGEMBALIAN DP
			OPNH_AMOUNT2 	= parseFloat(GTOT_ITEM - OPNH_RETAMN - OPNH_DPVAL);
			PPH_PERC 		= parseFloat(document.getElementById('OPNH_AMOUNTPPHP').value);
			PPH_AMN 		= parseFloat(PPH_PERC * OPNH_AMOUNT2) / 100;

			document.getElementById('OPNH_AMOUNTPPH').value		= PPH_AMN;
			document.getElementById('OPNH_AMOUNTPPHX').value	= doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(PPH_AMN)), 2));

		GTOTTOTAL 			= parseFloat(GTOT_ITEM - OPNH_RETAMN - OPNH_DPVAL + PPN_AMN - PPH_AMN);
