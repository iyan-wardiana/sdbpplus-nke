            ...
            <div class="content-item">
                <div class="content-header">
                    <table width="100%" cellpadding="0" cellspacing="0" border="0">
                        <tr>
                            <td width="120">Kode/Tgl. Opname</td>
                            <td width="10">:</td>
                            <td style="font-weight: 800;"><?php echo "$OPNH_CODE / $OPNH_DATEV"; ?></td>
                            <td width="70">Kode SPK</td>
                            <td width="10">:</td>
                        ...
                        <tr>
                            ...
                            <td width="130">Akum. Prog. sd Saat Ini</td>
                            <td width="10">:</td>
