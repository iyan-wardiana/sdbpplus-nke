	...
	function countTotalOpn()
	{
		...
		for(i=1;i<=totRow;i++)
		{
			...
			if(theObj != null)
			{
				...
				var OPND_POTRET		= parseFloat(OPNH_RETPERC * OPND_ITMTOTAL / 100);
				...
				var OPND_ITMTOTAL2 	= parseFloat(OPND_ITMTOTAL - OPND_POTRET - OPND_POTDP);
				...
				var TAXPRICE1		= parseFloat(TAXPERC1 * OPND_ITMTOTAL2 / 100);
				var TAXPRICE2 		= parseFloat(TAXPERC2 * OPND_ITMTOTAL2 / 100);
		...
		// HITUNG RETENSI
			OPNH_RETAMN 	= parseFloat(OPNH_RETPERC * TOT_OPNVAL / 100);
		...
		var OPND_ITMTOTAL3 	= parseFloat(TOT_OPNVAL - OPNH_RETAMN - OPNH_DPVAL);
		...
		var GTOT_OPNVAL 	= parseFloat(TOT_OPNVAL - OPNH_RETAMN - OPNH_DPVAL + PPN_VAL - PPH_VAL);
