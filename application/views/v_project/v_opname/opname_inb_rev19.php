				...
				foreach($vData as $row) :				
					...
					if ($j==1) {
						...
						?>
								...
								<td nowrap> <?php print $OPNH_CODE; ?></td>
                                ...
                                <?php
									...
									$secPrint	= site_url('c_project/c_o180d0bpnm/printdocument/?id='.$this->url_encryption_helper->encode_url($OPNH_NUM));
								...
								<td style="text-align:center" nowrap>
                                    ...
                                    <a href="javascript:void(null);" class="btn btn-warning btn-xs" title="Opname" onClick="printDocument('<?php echo $myNewNo1; ?>')" disabled="disabled" style="display:none">
