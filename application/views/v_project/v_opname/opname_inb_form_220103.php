							...
							<div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        ...
                                        <i class="fa fa-calendar"></i>&nbsp;</div><input type="text" name="OPNH_DATE" class="form-control pull-left" id="datepicker" value="<?php echo $OPNH_DATE; ?>" style="width:106px" readonly></div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="input-group date">
                                        <div class="input-group-addon">
                                        <i class="fa fa-calendar"></i>&nbsp;</div><input type="text" name="OPNH_DATESP" class="form-control pull-left" id="datepicker1" value="<?php echo $OPNH_DATESP; ?>" style="width:106px" readonly></div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea name="OPNH_NOTE" id="OPNH_NOTE" class="form-control" style="height: 65px" readonly><?php echo $OPNH_NOTE; ?></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <label>
                                            ...
                                            <input type="text" class="form-control" style="max-width:70px; text-align:right;" name="OPNH_DPPERX" id="OPNH_DPPERX" value="<?php echo number_format($OPNH_DPPER, $decFormat); ?>" onBlur="getDPer()" readonly >
                                        </label>
                                        <label>
                                            ...
                                            <input type="text" class="form-control" style="max-width:160px; text-align:right;" name="OPNH_DPVALX" id="OPNH_DPVALX" value="<?php echo number_format($OPNH_DPVAL, $decFormat); ?>" onBlur="getDPVal(this)" readonly>
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <label>
                                            ...
                                            <input type="text" class="form-control" style="max-width:70px; text-align:right" name="OPNH_RETPERCX" id="OPNH_RETPERCX" value="<?php echo number_format($OPNH_RETPERC, 2); ?>" onBlur="getAmountRet1()" onKeyPress="return isIntOnlyNew(event);" readonly>
                                        </label>
                                        <label>
