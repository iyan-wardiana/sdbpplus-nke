				      	...
				      	<table id="" class="table table-bordered table-striped table-responsive search-table inner" width="100%">
					        <thead>
					            <tr>
					                ...
					                <th width="2%" style="text-align:center; vertical-align:middle" nowrap><?php echo "$Amount<br>(BOQ)"; ?></th>
					                <th width="1%" style="text-align:center; vertical-align:middle" nowrap><?php echo "$Amount<br>(RAB)"; ?></th>
							...
							<?php
								...
								if($countjobl > 0)
								{
									foreach($vwjoblist as $row) :
										...
										$TotBOQ		= $TotBOQ + $JOBCOST;
										$BOQ_TotBOQ	= $BOQ_TotBOQ + $BOQ_JOBCOST;
										...
										?>
											...
											<td nowrap><?php print $JOBGRPD; ?> </td>
											...
											<td nowrap style="text-align:right">
					                            <a href="<?php echo $secUpd; ?>" class="btn btn-info btn-xs" title="Update" disabled="disabled">
										...
										if($ressqlC2 > 0)
										{
											...
											foreach($resJOB2 as $rowJOB2) :
												...
												//$ISHEADER2		= 0;
												$sqlC3			= "tbl_boqlist WHERE JOBPARENT = '$JOBCODEID2' AND PRJCODE = '$PRJCODE' AND ISHEADER = '1'";
												...
												?>
					                                    ...
					                                    <td nowrap style="text-align:right">
					                                    <a href="<?php echo $secUpd2; ?>" class="btn btn-info btn-xs" title="Update" disabled="disabled">
					                                        <i class="glyphicon glyphicon-pencil"></i>
					                                    </a>
					                                    <a href="" class="btn btn-danger btn-xs" title="In Active Project" onclick="return confirm('<?php echo $sureDelete; ?>')" disabled="disabled">
					                                        <i class="glyphicon glyphicon-trash"></i>
												...
												if($ressqlC3 > 0)
												{
													...
													foreach($resJOB3 as $rowJOB3) :
														...
														//$ISHEADER3		= 0;
														$sqlC4			= "tbl_boqlist WHERE JOBPARENT = '$JOBCODEID3' AND PRJCODE = '$PRJCODE' AND ISHEADER = '1'";
														...
														else
														{
															...
															?>
					                                            ...
					                                            <td nowrap style="text-align:right">
					                                            <a href="<?php echo $secUpd3; ?>" class="btn btn-info btn-xs" title="Update" disabled="disabled">
					                                                <i class="glyphicon glyphicon-pencil"></i>
					                                            </a>
					                                            <a href="" class="btn btn-danger btn-xs" title="In Active Project" onclick="return confirm('<?php echo $sureDelete; ?>')" disabled="disabled">
					                                                <i class="glyphicon glyphicon-trash"></i>
														...
														if($ressqlC4 > 0)
														{
															...
															foreach($resJOB4 as $rowJOB4) :
																...
																$ISHEADER4		= 0;
																$sqlC5			= "tbl_boqlist WHERE JOBPARENT = '$JOBCODEID4' AND PRJCODE = '$PRJCODE' AND ISHEADER = '1'";
																...
																?>
					                                                    ...
					                                                    <td nowrap style="text-align:right">
					                                                    <a href="<?php echo $secUpd4; ?>" class="btn btn-info btn-xs" title="Update" disabled="disabled">
					                                                        <i class="glyphicon glyphicon-pencil"></i>
					                                                    </a>
					                                                    <a href="" class="btn btn-danger btn-xs" title="In Active Project" onclick="return confirm('<?php echo $sureDelete; ?>')" disabled="disabled">
					                                                        <i class="glyphicon glyphicon-trash"></i>
																...
																if($ressqlC5 > 0)
																{
																	...
																	foreach($resJOB5 as $rowJOB5) :
																		...
																		$ISHEADER5		= 0;
																		$sqlC6			= "tbl_boqlist WHERE JOBPARENT = '$JOBCODEID5' AND PRJCODE = '$PRJCODE' AND ISHEADER = '1'";
																		...
																		?>
					                                                            ...
					                                                            <td nowrap style="text-align:right">
					                                                            <a href="<?php echo $secUpd5; ?>" class="btn btn-info btn-xs" title="Update" disabled="disabled">
					                                                                <i class="glyphicon glyphicon-pencil"></i>
					                                                            </a>
					                                                            <a href="" class="btn btn-danger btn-xs" title="In Active Project" onclick="return confirm('<?php echo $sureDelete; ?>')" disabled="disabled">
					                                                                <i class="glyphicon glyphicon-trash"></i>
							...
							?>
					            <tr>
					                ...
					                <th width="2%" style="text-align:right; vertical-align:middle" nowrap><?php echo number_format($BOQ_TotBOQ, $decFormat); ?></th>
					                <th width="1%" nowrap style="text-align:right; vertical-align:middle"><?php echo number_format($TotBOQ, $decFormat); ?></th>
					                <th width="1%" nowrap style="text-align:right; vertical-align:middle"><?php echo number_format($DEV_TotBOQ, $decFormat); ?></th>
