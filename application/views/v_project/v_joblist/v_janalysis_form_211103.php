						...
						<div class="box box-primary">
							...
							<div class="box-body">
				                ...
				                <div class="form-group">
				                    ...
				                    <div class="col-sm-3">
				                    	<a class="btn btn-app" data-toggle="modal" data-target="#mdl_addJList">
	                                        ...
	                                        <tr id="tr_<?php echo $currentRow; ?>" style="vertical-align: middle;">
		                                        ...
		                                        <td style="text-align:left; vertical-align: middle;" nowrap> <!-- IITM_CODE -->
		                                     	...
		                                     	<td style="text-align:right; vertical-align: middle;"> <!-- ITM_QTY -->
		                                          	<input type="text" name="ITM_QTY<?php echo $currentRow; ?>" id="ITM_QTY<?php echo $currentRow; ?>" value="<?php print number_format($ITM_QTY, $decFormat); ?>" class="form-control" style="min-width:110px; max-width:300px; text-align:right" onKeyPress="return isIntOnlyNew(event);" onBlur="chgQty(this,<?php echo $currentRow; ?>);" >
...
<script>
	...
	function chgQty(thisVal1, row)
	{
		...
		document.getElementById('ITM_TOTAL'+row).value			= doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(ITM_TOTAL)), 4));
	}
