...
{
	$JOB_NUM		= $default['JOB_NUM'];
	$JOB_MCODE		= $default['JOB_MCODE'];
	$JOB_DATE		= date('d/m/Y',strtotime($PR_DATED));
	$JOB_PARCODE	= $default['JOB_PARCODE'];
	$JOB_NOTE		= $default['JOB_NOTE'];
	$JOB_MEMO		= $default['JOB_MEMO'];
	$JOB_NOREF		= $default['JOB_NOREF'];
	$JOB_STAT		= $default['JOB_STAT'];
}
			                  	...
			                  	<div class="row">
			                    	...
			                    	<div class="col-md-8">
			                    		<div class="row">
					                    	<div class="col-md-3">
					                    		<?php
					                    			echo 	"<i class='text-primary' style='font-size: 16px;'><strong>".number_format($BOQ_VOLM, 2)."</strong></i>";
					                    		?>
					                    	...
					                    	<div class="col-md-4">
					                    		<?php
					                    			echo 	"<i class='text-primary' style='font-size: 16px;'><strong>".number_format($BOQ_PRICE, 2)."</strong></i>";
					                    		?>
					                    		<input type="hidden" name="JOB_BOQP" id="JOB_BOQP" value="<?php echo $BOQ_PRICE; ?>" />
					                    	</div>
					                    	<div class="col-md-5">
					                    		<?php
					                    			echo 	"<i class='text-primary' style='font-size: 16px;'><strong>".number_format($BOQ_JOBCOST, 2)."</strong></i>";
					                    		?>
					                    		<input type="hidden" name="JOB_BOQT" id="JOB_BOQT" value="<?php echo $BOQ_JOBCOST; ?>" />
					                    	</div>
					                    </div>
			                    	</div>
		                    	</div>
			                  	<div class="row">
			                    	...
			                    	<div class="col-md-8">
			                    		<div class="row">
					                    	<div class="col-md-3">
					                    		<?php
					                    			echo 	"<i class='text-yellow' style='font-size: 16px;'><strong>".number_format($JOBVOLM, 2)."</strong></i>";
					                    		?>
					                    		<input type="hidden" name="JOB_RAPV" id="JOB_RAPV" value="<?php echo $JOBVOLM; ?>" />
					                    	</div>
					                    	<div class="col-md-4">
					                    		<?php
					                    			echo 	"<i class='text-yellow' style='font-size: 16px;'><strong>".number_format($JOBPRICE, 2)."</strong></i>";
					                    		?>
					                    		<input type="hidden" name="JOB_RAPP" id="JOB_RAPP" value="<?php echo $JOBPRICE; ?>" />
					                    	</div>
					                    	<div class="col-md-5">
					                    		<?php
					                    			echo 	"<i class='text-yellow' style='font-size: 16px;'><strong>".number_format($JOBCOST, 2)."</strong></i>";
					                    		?>
					                    		<input type="hidden" name="JOB_RAPT" id="JOB_RAPT" value="<?php echo $JOBCOST; ?>" />
					                    	</div>
					                    </div>
			                    	</div>
		                    	</div>
			                  	<div class="row">
			                    	...
			                    	<div class="col-md-8">
			                    		<div class="row">
					                    	...
					                    	<div class="col-md-5">
					                    		<?php
					                    			echo 	"<i class='text-success' style='font-size: 16px;'><strong>".number_format($JOBCOST, 2)."</strong></i>";
					                    		?>
					                    	</div>
					                    </div>
			                    	</div>
							...
							<div class="box-body">
				                ...
				                <div class="form-group">
				                    ...
				                    <div class="col-sm-6">
				                        ...
				                        ?>
		                                <select name="JOB_STAT" id="JOB_STAT" class="form-control select2" onChange="chkSTAT(this.value)">
		                                    <?php
			                                    $disableBtn	= 0;
	                        ...
	                        <div class="search-table-outter">
	                            <table id="tbl" class="table table-bordered table-striped" width="100%">
	                                <tr style="background:#CCCCCC">
	                                  	...
	                                  	<th width="10%" rowspan="2" style="text-align:center; vertical-align: middle;"><?php echo $JobCode ?> </th>
	                                  	<th width="20%" rowspan="2" style="text-align:center; vertical-align: middle;"><?php echo $ItemName ?> </th>
	                                  	<th colspan="2" style="text-align:center">BoQ</th>
	                                  	<th colspan="2" style="text-align:center">RAP</th>
	                                  	<th width="2%" rowspan="2" style="text-align:center; vertical-align: middle;"><?php echo $Unit ?> </th>
	                                  	<th width="12%" rowspan="2" style="text-align:center; vertical-align: middle;"><?php echo $Remarks ?> </th>
	                                </tr>
	                                <tr style="background:#CCCCCC">
	                                ...
	                                if($task == 'edit')
	                                {
	                                    $sqlDET	= "SELECT A.PRJCODE, A.JOB_NUM, A.JOBD_CHILD, A.ITM_CODE, A.ITM_NAME, A.ITM_UNIT, A.ITM_GROUP,
	                                    				A.ITM_BOQV, A.ITM_BOQP, A.ITM_RAPV, A.ITM_RAPP, A.ITM_TOTAL, A.ITM_NOTES
	                                                FROM tbl_jobcreate_detail A
	                                    ...
	                                    foreach($result as $row) :
	                                        ...
	                                        $PRJCODE 		= $row->PRJCODE;
	                                        $JOB_NUM 		= $row->JOB_NUM;
	                                        $JOBD_CHILD 	= $row->JOBD_CHILD;
	                                        $ITM_CODE 		= $row->ITM_CODE;
	                                        $ITM_NAME 		= $row->ITM_NAME;
	                                        $ITM_UNIT 		= $row->ITM_UNIT;
	                                        $ITM_GROUP 		= $row->ITM_GROUP;
	                                        $ITM_BOQV 		= $row->ITM_BOQV;
	                                        $ITM_BOQP 		= $row->ITM_BOQP;
	                                        ...
	                                        <tr id="tr_<?php echo $currentRow; ?>" style="vertical-align: middle;">
		                                        ...
		                                        <td style="text-align:left; vertical-align: middle;" nowrap>
		                                          	<?php
			                                            ...
			                                            {
			                                                ?>
			                                                <input type="text" id="data<?php echo $currentRow; ?>JOBD_CHILD" name="data[<?php echo $currentRow; ?>][JOBD_CHILD]" value="<?php echo $JOBD_CHILD; ?>" class="form-control" style="max-width:300px;">
			                                                <?php
			                                            }
			                                            else
			                                            {
			                                            	echo "$JOBD_CHILD";
			                                            	?>
			                                                	<input type="hidden" id="data<?php echo $currentRow; ?>JOBD_CHILD" name="data[<?php echo $currentRow; ?>][JOBD_CHILD]" value="<?php echo $JOBD_CHILD; ?>" class="form-control" style="max-width:300px;">
			                                                <?php
			                                            }
		                                          	?>
		                                        ...
		                                        <td style="text-align:left; vertical-align: middle;" nowrap>
		                                          	<?php
			                                            ...
			                                            {
			                                                ?>
			                                                <input type="text" id="data<?php echo $currentRow; ?>ITM_CODE" name="data[<?php echo $currentRow; ?>][ITM_CODE]" value="<?php echo $ITM_CODE; ?>" class="form-control" style="max-width:300px;">
			                                                <?php
			                                            }
			                                            else
			                                            {
		                                        ...
		                                        <td style="text-align:left; vertical-align: middle;" nowrap>
		                                          	<?php
			                                            ...
			                                            {
			                                                ?>
			                                                <input type="text" id="data<?php echo $currentRow; ?>ITM_NAME" name="data[<?php echo $currentRow; ?>][ITM_NAME]" value="<?php echo $ITM_NAME; ?>" class="form-control" style="max-width:300px;">
			                                                <?php
			                                            }
			                                            else
			                                            {
		                                        ...
		                                        <td style="text-align:left; vertical-align: middle;" nowrap>
	                                                ...
	                                                <input type="hidden" id="data<?php echo $currentRow; ?>ITM_GROUP" name="data[<?php echo $currentRow; ?>][ITM_GROUP]" value="<?php echo $ITM_GROUP; ?>" class="form-control">
		                                      	</td>
		                                        ...
		                                        <td style="text-align:right; vertical-align: middle;">
		                                        	<?php
			                                        	...
			                                        	{
			                                        		?>
			                                          			<input type="text" class="form-control" style="min-width:110px; max-width:300px; text-align:right" name="ITM_BOQVX<?php echo $currentRow; ?>" id="ITM_BOQVX<?php echo $currentRow; ?>" value="<?php print number_format($ITM_BOQV, $decFormat); ?>" disabled >
		                                      				<?php
		                                      			}
		                                      			else
		                                      			{
		                                      				print number_format($ITM_BOQV, $decFormat);
		                                      				?> 
		                                      					<input type="hidden" class="form-control" style="min-width:110px; max-width:300px; text-align:right" name="ITM_BOQVX<?php echo $currentRow; ?>" id="ITM_BOQVX<?php echo $currentRow; ?>" value="<?php print number_format($ITM_BOQV, $decFormat); ?>" disabled >
		                                      				<?php
		                                      			}
		                                      		?>
		                                          	<input type="hidden" style="text-align:right" name="data[<?php echo $currentRow; ?>][ITM_BOQV]" id="ITM_BOQV<?php echo $currentRow; ?>" value="<?php echo $ITM_BOQV; ?>" >
		                                      	</td>
		                                        ...
		                                        <td style="text-align:right; vertical-align: middle;">
		                                        	<?php
			                                        	...
			                                        	{
			                                        		?>
			                                          			<input type="text" class="form-control" style="min-width:110px; max-width:300px; text-align:right" name="ITM_BOQPX<?php echo $currentRow; ?>" id="ITM_BOQPX<?php echo $currentRow; ?>" value="<?php print number_format($ITM_BOQP, $decFormat); ?>" disabled >
		                                      				<?php
		                                      			}
		                                      			else
		                                      			{
		                                      				print number_format($ITM_BOQP, $decFormat);
		                                      				?> 
		                                      					<input type="hidden" class="form-control" style="min-width:110px; max-width:300px; text-align:right" name="ITM_BOQPX<?php echo $currentRow; ?>" id="ITM_BOQPX<?php echo $currentRow; ?>" value="<?php print number_format($ITM_BOQP, $decFormat); ?>" disabled >
		                                      				<?php
		                                      			}
		                                      		?>
		                                          	<input type="hidden" style="text-align:right" name="data[<?php echo $currentRow; ?>][ITM_BOQP]" id="ITM_BOQP<?php echo $currentRow; ?>" value="<?php echo $ITM_BOQP; ?>" >
		                                      	</td>
		                                        ...
		                                        <td style="text-align:right; vertical-align: middle;">
		                                        	<?php
			                                        	...
			                                        	{
			                                        		?>
			                                          			<input type="text" class="form-control" style="min-width:110px; max-width:300px; text-align:right" name="ITM_RAPVX<?php echo $currentRow; ?>" id="ITM_RAPVX<?php echo $currentRow; ?>" value="<?php print number_format($ITM_RAPV, $decFormat); ?>" disabled >
		                                      				<?php
		                                      			}
		                                      			else
		                                      			{
		                                      				print number_format($ITM_RAPV, $decFormat);
		                                      				?> 
		                                      					<input type="hidden" class="form-control" style="min-width:110px; max-width:300px; text-align:right" name="ITM_RAPVX<?php echo $currentRow; ?>" id="ITM_RAPVX<?php echo $currentRow; ?>" value="<?php print number_format($ITM_RAPV, $decFormat); ?>" disabled >
		                                      				<?php
		                                      			}
		                                      		?>
		                                          	<input type="hidden" style="text-align:right" name="data[<?php echo $currentRow; ?>][ITM_RAPV]" id="ITM_RAPV<?php echo $currentRow; ?>" value="<?php echo $ITM_RAPV; ?>" >
		                                      	</td>
		                                        ...
		                                        <td style="text-align:right; vertical-align: middle;"> <!-- Item Bdget -->
		                                        	<?php
			                                        	...
			                                        	{
			                                        		?>
			                                          			<input type="text" class="form-control" style="min-width:110px; max-width:300px; text-align:right" name="ITM_RAPPX<?php echo $currentRow; ?>" id="ITM_RAPPX<?php echo $currentRow; ?>" value="<?php print number_format($ITM_RAPP, $decFormat); ?>" disabled >
		                                      				<?php
		                                      			}
		                                      			else
		                                      			{
		                                      				print number_format($ITM_RAPP, $decFormat);
		                                      				?> 
		                                      					<input type="hidden" class="form-control" style="min-width:110px; max-width:300px; text-align:right" name="ITM_RAPPX<?php echo $currentRow; ?>" id="ITM_RAPPX<?php echo $currentRow; ?>" value="<?php print number_format($ITM_RAPP, $decFormat); ?>" disabled >
		                                      				<?php
		                                      			}
		                                      		?>
		                                          	<input type="hidden" style="text-align:right" name="data[<?php echo $currentRow; ?>][ITM_RAPP]" id="ITM_RAPP<?php echo $currentRow; ?>" value="<?php echo $ITM_RAPP; ?>" >
		                                      	</td>
		                                        ...
		                                        <td style="text-align:right; vertical-align: middle;"> <!-- Item Bdget -->
		                                        	<?php
			                                        	...
			                                        	{
			                                        		?>
			                                          			<input type="text" class="form-control" style="min-width:110px; max-width:300px; text-align:right" name="ITM_TOTALX<?php echo $currentRow; ?>" id="ITM_TOTALX<?php echo $currentRow; ?>" value="<?php print number_format($ITM_TOTAL, $decFormat); ?>" disabled >
		                                      				<?php
		                                      			}
		                                      			else
		                                      			{
		                                      				print number_format($ITM_TOTAL, $decFormat);
		                                      				?> 
		                                      					<input type="hidden" class="form-control" style="min-width:110px; max-width:300px; text-align:right" name="ITM_TOTALX<?php echo $currentRow; ?>" id="ITM_TOTALX<?php echo $currentRow; ?>" value="<?php print number_format($ITM_TOTAL, $decFormat); ?>" disabled >
		                                      				<?php
		                                      			}
		                                      		?>
		                                          	<input type="hidden" style="text-align:right" name="data[<?php echo $currentRow; ?>][ITM_TOTAL]" id="ITM_TOTAL<?php echo $currentRow; ?>" value="<?php echo $ITM_TOTAL; ?>" >
		                                      	</td>
		                ...
		                <div class="form-group">
		                    ...
		                    <div class="col-sm-9">
		                        <?php
		                            if($task=='add')
		                            {
		                                if($resCAPP > 0 && (($JOB_STAT == 1 || $JOB_STAT == 4) && $ISCREATE == 1))
		                                {
		                                    ?>
		                            ...
		                            {
		                                if(($JOB_STAT == 1 || $JOB_STAT == 4) && $ISCREATE == 1)
		                                {
		                                    ?>
		                                        <button class="btn btn-primary" id="btnSave">
		                                        <i class="fa fa-save"></i></button>&nbsp;
			                                            ...
			                                            <table id="example1" class="table table-bordered table-striped table-responsive search-table inner" width="100%">
			                                                <thead>
			                                                    <tr>
			                                                        ...
			                                                        <th width="40%" rowspan="2" style="text-align: center; vertical-align: middle;"  nowrap><?php echo $ItemName; ?></th>
			                                                        <th width="10%" rowspan="2" style="text-align: center; vertical-align: middle;" nowrap><?php echo $Unit; ?></th>
			                                                        <th width="10%" rowspan="2" style="text-align: center; vertical-align: middle;" nowrap>Group</th>
			                                                        <th colspan="3" width="30%" style="text-align: center; vertical-align: middle;" nowrap>Total</th>
			                                                  	</tr>
			                                                    <tr>
				...
				<script type="text/javascript">
					...
					$(document).ready(function()
					{
				    	$('#example1').DataTable(
				    	{
							...
							"autoWidth": true,
							"filter": true,
					        "ajax": "<?php echo site_url('c_project/c_joblist/get_AllDataITM2/?id='.$PRJCODE.'JID='.$JOBCODEID)?>",
					        "type": "POST",
...
<script>
	...
	function add_item(strItem) 
	{
		...
		var PR_CODEx 	= "<?php echo $JOB_MCODE; ?>";
		ilvl = arrItem[1];
		...
		// ITM_CODE, PRJCODE, ITM_GROUP
			objTD = objTR.insertCell(objTR.cells.length);
			objTD.align = 'right';
			objTD.innerHTML = ''+ITM_CODE+'<input type="text" id="data'+intIndex+'ITM_CODE" name="data['+intIndex+'][ITM_CODE]" value="'+ITM_CODE+'" class="form-control" style="max-width:300px;"><input type="text" id="data'+intIndex+'PRJCODE" name="data['+intIndex+'][PRJCODE]" value="'+PRJCODE+'" class="form-control" style="max-width:300px;"><input type="text" id="data'+intIndex+'ITM_GROUP" name="data['+intIndex+'][ITM_GROUP]" value="'+ITM_GROUP+'" class="form-control" style="max-width:300px;">';
		
		// ITM_NAME
			objTD = objTR.insertCell(objTR.cells.length);
			objTD.align = 'left';
			objTD.noWrap = true;
			objTD.innerHTML = '<input type="text" id="data'+intIndex+'ITM_NAME" name="data['+intIndex+'][ITM_NAME]" value="'+ITM_NAME+'" class="form-control" style="max-width:300px;">';
		
		// ITM_BOQV, ITM_BOQP
			objTD = objTR.insertCell(objTR.cells.length);
			objTD.style.textAlign = 'right';
			objTD.innerHTML = '<input type="text" name="ITM_BOQV'+intIndex+'" id="ITM_BOQV'+intIndex+'" value="'+ITM_BOQV+'" class="form-control" style="min-width:110px; max-width:300px; text-align:right" onKeyPress="return isIntOnlyNew(event);" onBlur="getConvertion(this,'+intIndex+');" ><input type="text" name="data['+intIndex+'][ITM_BOQP]" id="data'+intIndex+'ITM_BOQP" value="'+ITM_BOQP+'" class="form-control" style="max-width:300px;" >';
		
		// ITM_RAPV, ITM_RAPP
			objTD = objTR.insertCell(objTR.cells.length);
			objTD.style.textAlign = 'right';
			objTD.innerHTML = '<input type="text" name="ITM_RAPV'+intIndex+'" id="ITM_RAPV'+intIndex+'" value="'+ITM_RAPV+'" class="form-control" style="min-width:110px; max-width:300px; text-align:right" onKeyPress="return isIntOnlyNew(event);" onBlur="getConvertion(this,'+intIndex+');" ><input type="text" name="data['+intIndex+'][ITM_RAPP]" id="data'+intIndex+'ITM_RAPP" value="'+ITM_RAPP+'" class="form-control" style="max-width:300px;" >';
