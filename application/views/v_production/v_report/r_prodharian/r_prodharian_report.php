...
/*
	...
	* File Name		= r_prodharian_report.php
	* Location		= -
 */
...
if($viewType == 1)
{
	...
	header("Content-Disposition: attachment; filename=LapProdHarian_$dateRep.xls");
	...
	<div class="page">
		...
		<table border="1" width="100%">
				...
				for($i=1;$i<=$maxRow;$i++)
				{
					if($i<=$totRow)
					{
						if($i==$totRow)							// Baris terakhir
						{
							...
							// MUTASI PENERIMAAN DIDAPATKAN DARI HASIL PRODUKSI COMPAKTOR, YAITU MESIN TERAKHIR SEBELUM PACKING
								$TOTFG_A1 	= 0;
								$sqlFG_A1 	= "SELECT SUM(STF_VOLM) AS TOTFG_A1
												FROM tbl_stf_detail A
												WHERE $ADDQRY1 ITM_CATEG = 'FG' AND JO_CATEG = '1' AND STF_STAT IN (3,6) AND STF_DATE = '$fDtWL'";
						...
						elseif($i==1)
						{
							...
							// MUTASI PENERIMAAN DIDAPATKAN DARI HASIL PRODUKSI COMPAKTOR, YAITU MESIN TERAKHIR SEBELUM PACKING
								...
								$sqlFG_A1 	= "SELECT SUM(STF_VOLM) AS TOTFG_A1
												FROM tbl_stf_detail A
												WHERE $ADDQRY1 ITM_CATEG = 'FG' AND JO_CATEG = '1' AND STF_STAT IN (3,6)
		            	...
		            	?>
							<tr style="line-height: 25px;">
			                    ...
			                    <td style="text-align:left; vertical-align: middle;" nowrap>Hasil Produksi</td>
			...
			<tr style="font-weight: bold;">
                <td style="text-align:center; vertical-align: middle;" colspan="4" rowspan="2" nowrap>Rata2 Produksi <?php echo "$dt $MONTHD $YEAR"; ?></td>
                <td style="text-align:center; vertical-align: middle;" nowrap>Total Produksi</td>
