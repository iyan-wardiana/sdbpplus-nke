		    ...
		    <div class="box">
				...
				<div class="box-body">
                    ...
                    <?php
	                    if($ISCREATE == 1)
	                    {
	                        $url_add 	= site_url('c_production/c_b0fm47/a44_i4xIcut/?id='.$this->url_encryption_helper->encode_url($PRJCODE));   
...
<script>
    ...
    $('#example').DataTable( {
		...
		"autoWidth": true,
		"filter": true,
        "ajax": "<?php echo site_url('c_production/c_b0fm47/get_AllDataIcu7/?id='.$PRJCODE)?>",
        "type": "POST",
