...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="ko" lang="ko">
	...
	<?php
		...
		if($CUST_DESC == '')
		{
			$sqlCUST 		= "SELECT REC_DESC FROM tbl_qrc_detail WHERE QRC_NUM = '$ICUT_QRCN'";
			$resCUST 		= $this->db->query($sqlCUST)->result();
			foreach($resCUST as $rowCUST) :
				$CUST_DESC = $rowCUST->REC_DESC;		
			endforeach;
		}
	?>
	<input id="text" type="hidden" value="<?php echo $COMPIL; ?>" style="width:80%;" /><br />
	<table width="200" border="1" align="center" style="font-family:'Courier New', Courier, monospace" rules="all">
		...
		<tr>
			<td>Kode</td>
			<td>:</td>
			<td nowrap><?php echo $ICUT_CODE; ?> </td>
		</tr>
		<tr>
		...
		<tr>
			<td>Dibuat</td>
			<td>:</td>
			<td nowrap><?php echo date('d/m/y H:i:s', strtotime($ICUT_CREATED)); ?> </td>
		</tr>
