...
<?php
	...
	foreach($resTransl as $rowTransl) :
		...
		if($TranslCode == 'chemical')$chemical = $LangTransl;
	...
	if(isset($_POST['submit1']))
	{
		...
		if($List_Type == 1)
		{
			...
			$sqlDataItm		= "SELECT PRJCODE, ITM_CODE, ITM_GROUP, ITM_CATEG, ITM_NAME, ITM_UNIT, ITM_VOLM, ITM_PRICE,
								...
								FROM tbl_item WHERE PRJCODE = '$PRJCODE' AND ISRM = 1 AND STATUS = 1
									AND ITM_CATEG NOT IN ('CM', 'DY', 'WIP', 'FG')";
    	 ...
    	 <div class="col-md-12">
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    <li <?php echo $Active1Cls; ?>><a href="#rmlist" data-toggle="tab" onClick="setType(1)"><?php echo $ItemList; ?></a></li>
                    <li <?php echo $Active2Cls; ?>><a href="#wiplist" data-toggle="tab" onClick="setType(2)"><?php echo $WIPList; ?></a></li>
                    <li <?php echo $Active3Cls; ?>><a href="#dyelist" data-toggle="tab" onClick="setType(3)">Dyestuff</a></li>
                    <li <?php echo $Active4Cls; ?>><a href="#chmlist" data-toggle="tab" onClick="setType(4)"><?php echo $chemical; ?></a></li>
                    <li <?php echo $Active5Cls; ?>><a href="#fglist" data-toggle="tab" onClick="setType(5)"><?php echo $FinGoods; ?></a></li>
                    <li <?php echo $Active9Cls; ?>><a href="#others" data-toggle="tab" onClick="setType(9)">Kelompok Kain</a></li>
                </ul>
                ...
                <div class="tab-content">
                	<?php
						...
						{
							?>
                                <div class="<?php echo $Active1; ?> tab-pane" id="rmlist">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <table id="tree-table" class="table table-bordered table-striped table-responsive search-table inner" width="100%">
                                                ...
                                                <?php
                                                    ...
                                                    if($cDataItm>0)
													{
														$sqlItm	= "SELECT PRJCODE, ITM_CODE, ITM_GROUP, ITM_CATEG, ITM_NAME, ITM_UNIT,
																	ITM_VOLM, ITM_PRICE, ITM_IN, ITM_OUT, ACC_ID, ACC_ID_UM, NEEDQRC
																	FROM tbl_item WHERE PRJCODE = '$PRJCODE'
																	AND ISRM = 1 AND STATUS = 1 AND ITM_CATEG NOT IN ('CM', 'DY', 'WIP', 'FG')";
														...
														foreach($resItm as $row) :								
															...
															$ITMCATD		= "-";
															$sqlITMCAT		= "SELECT IC_Name FROM tbl_itemcategory WHERE IC_Num = '$ITM_CATEG'";
															$resITMCAT		= $this->db->query($sqlITMCAT)->result();
															foreach($resITMCAT as $rowITMC) :
																$ITMCATD	= $rowITMC->IC_Name;
															endforeach;
						...
						{
							?>
                                <div class="<?php echo $Active2; ?> tab-pane" id="wiplist">
                                  <div class="box box-success">
                                        <div>
                                            &nbsp;
                                        </div>
                                                ...
                                                <?php
                                                    ...
                                                    if($cDataItm>0)
													{
														$sqlItm	= "SELECT PRJCODE, ITM_CODE, ITM_GROUP, ITM_CATEG, ITM_NAME, ITM_UNIT, ITM_VOLM, ITM_PRICE,
																	...
																	FROM tbl_item WHERE PRJCODE = '$PRJCODE'
																	AND ISWIP = 1 AND STATUS = 1 AND ITM_CATEG IN ('WIP')";
														$resItm	= $this->db->query($sqlItm)->result();
														$totRow	= 0;
														foreach($resItm as $row) :								
															$PRJCODE 		= $row->PRJCODE;			// 0
															...
															?>
															<td style="text-align:center"><input type="checkbox" name="chk" value="<?php echo $PRJCODE;?>|<?php echo $ITM_CODE;?>|<?php echo $ITM_CATEG;?>|<?php echo $ITM_NAME;?>|<?php echo $ITM_UNIT;?>|<?php echo $ITM_VOLM;?>|<?php echo $REM_QTY;?>|<?php echo $ITM_PRICE;?>|<?php echo $ACC_ID;?>|<?php echo $ACC_ID_UM;?>|<?php echo $ITM_STOCK;?>|<?php echo $PRODS_STEP;?>|<?php echo $NEEDQRC;?>|<?php echo $JO_QTY;?>|<?php echo $SOURCE;?>|<?php echo $ITM_CODE1;?>|<?php echo $ITM_CATEG;?>" onClick="pickThis(this);" /></td>
															<td nowrap><?php echo $ITM_CODE; ?></td>
															<td nowrap><?php echo cut_text($ITM_NAME, 50); ?></td>
															<td style="text-align:center"><?php echo $ITM_UNIT; ?></td>
															<td nowrap style="text-align:right">
						...
						{
							?>
                                <div class="<?php echo $Active3; ?> tab-pane" id="dyelist">
                                  <div class="box box-success">
                                        <div>
                                            &nbsp;
                                        </div>
                                                ...
                                                <?php
                                                    ...
                                                    if($cDataItm>0)
													{
														$sqlItm	= "SELECT PRJCODE, ITM_CODE, ITM_GROUP, ITM_CATEG, ITM_NAME, ITM_UNIT, ITM_VOLM, ITM_PRICE,
																		ITM_IN, ITM_OUT, ACC_ID, ACC_ID_UM, NEEDQRC
																	FROM tbl_item WHERE PRJCODE = '$PRJCODE'
																	AND ISRM = 1 AND STATUS = 1 AND ITM_CATEG IN ('DY')";
														$resItm	= $this->db->query($sqlItm)->result();
														$totRow	= 0;
														foreach($resItm as $row) :								
															$PRJCODE 		= $row->PRJCODE;			// 0
						...
						{
							?>
                                <div class="<?php echo $Active4; ?> tab-pane" id="chmlist">
                                  <div class="box box-success">
                                        <div>
                                            &nbsp;
                                        </div>
                                                ...
                                                <?php
                                                    ...
                                                    if($cDataItm>0)
													{
														$sqlItm	= "SELECT PRJCODE, ITM_CODE, ITM_GROUP, ITM_CATEG, ITM_NAME, ITM_UNIT, ITM_VOLM, ITM_PRICE,
																		ITM_IN, ITM_OUT, ACC_ID, ACC_ID_UM, NEEDQRC
																	FROM tbl_item WHERE PRJCODE = '$PRJCODE'
																	AND ISRM = 1 AND STATUS = 1 AND ITM_CATEG IN ('CM')";
														$resItm	= $this->db->query($sqlItm)->result();
														$totRow	= 0;
														foreach($resItm as $row) :								
															$PRJCODE 		= $row->PRJCODE;			// 0
						...
						{
							?>
                                <div class="<?php echo $Active5; ?> tab-pane" id="fglist">
                                  <div class="box box-success">
                                        <div>
                                            &nbsp;
                                        </div>
                                                ...
                                                <?php
                                                    ...
                                                    if($cDataItm>0)
													{
														$sqlItm	= "SELECT PRJCODE, ITM_CODE, ITM_GROUP, ITM_CATEG, ITM_NAME, ITM_UNIT, ITM_VOLM, ITM_PRICE,
																		ITM_IN, ITM_OUT, ACC_ID, ACC_ID_UM, NEEDQRC
																	FROM tbl_item WHERE PRJCODE = '$PRJCODE'
																	AND ISFG = 1 AND STATUS = 1 AND ITM_CATEG IN ('FG')";
														$resItm	= $this->db->query($sqlItm)->result();
														$totRow	= 0;
														foreach($resItm as $row) :								
															$PRJCODE 		= $row->PRJCODE;			// 0
						...
						{
							?>
                                <div class="<?php echo $Active9; ?> tab-pane" id="others">
                                  <div class="box box-success">
                                        <div>
                                            &nbsp;
                                        </div>
                                                ...
                                                <?php
                                                    ...
                                                    if($cDataItm>0)
													{
														$sqlItm	= "SELECT A.ICOLL_NUM, A.ICOLL_CODE, A.CUST_CODE, A.CUST_DESC, A.ICOLL_NOTES,
																		A.ICOLL_FG, B.ITM_NAME, B.ITM_UNIT, A.ICOLL_REFNUM, B.ITM_CATEG
														...
														foreach($resItm as $row) :								
															...
															?>
                                                                ...
                                                                <td nowrap><?php echo "$ITM_NAME - $ITM_NAME1<br>$CUST_DESC"; ?> </td>
