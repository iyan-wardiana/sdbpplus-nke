        ...
        <section class="content">
		    <div class="box">
				...
				<div class="box-body">
		            <div class="search-table-outter">
		                <table id="example" class="table table-bordered table-striped table-responsive search-table inner" width="100%">
		                    ...
		                    <tr>
		                        ...
		                        <th width="19%" style="vertical-align:middle; text-align:center"><?php echo $ColorName  ?> </th>
		                        <th width="20%" style="vertical-align:middle; text-align:center" nowrap><?php echo $Description ?> </th>
		                        <th width="27%" style="vertical-align:middle; text-align:center"><?php echo $CustName ?> </th>
		                        <th width="8%" style="vertical-align:middle; text-align:center"><?php echo $Created ?> </th>
		            ...
		            <br>
                    <?php
						$url_add 	= site_url('c_production/c_b0fm47/a44_b0m/?id='.$this->url_encryption_helper->encode_url($PRJCODE));
...
<script>
    ...
    $('#example').DataTable( {
		...
		"autoWidth": true,
		"filter": true,
        "ajax": "<?php echo site_url('c_production/c_b0fm47/get_AllData/?id='.$PRJCODE)?>",
        "type": "POST",
		//"lengthMenu": [[10, 25, 50, 100, 200, -1], [10, 25, 50, 100, 200, "All"]],
		"lengthMenu": [[10, 25, 50, 100, 200], [10, 25, 50, 100, 200]],
		"columnDefs": [	{ targets: [0,1,5,6,7], className: 'dt-body-center' },
