...
/* 
 	...
 	* File Name  	= v_material_print.php
 	* Location  	= -
*/
...
$MR_DATEV	= strftime('%d %B %Y', strtotime($MR_DATE));
            	...
            	<td>
            		<table border="1" width="100%">
	            		...
	            		<tr style="border-top: hidden;">
	           				<td width="15%" style="border-right: hidden;">NO. PO</td>
	           				<td width="30%" style="border-right: hidden;">:</td>
	           				<td width="15%" style="border-right: hidden;">TANGGAL</td>
	           				<td width="25%" style="border-right: hidden;">:</td>
	           				<td width="15%">NO.:</td>
				        </tr>
	            		<tr style="border-top: hidden;">
	           				<td width="15%" style="border-right: hidden;">PEMESANAN</td>
	           				<td width="30%" style="border-right: hidden;">:</td>
	           				<td width="15%" style="border-right: hidden;">NO. MT</td>
	           				<td width="25%" style="border-right: hidden;">:</td>
	           				<td width="15%">&nbsp;</td>
				        </tr>
	            		<tr style="border-top: hidden;">
	           				<td width="15%" nowrap style="border-right: hidden;">NO. OP. PROD</td>
	           				<td width="30%" style="border-right: hidden;">:</td>
	           				<td width="15%" style="border-right: hidden;">LOT</td>
	           				<td width="25%" style="border-right: hidden;">:</td>
	           				<td width="15%">&nbsp;</td>
				        </tr>
	            		<tr style="border-top: hidden;">
	           				<td width="15%" style="border-right: hidden;">JENIS KAIN</td>
	           				<td width="30%" style="border-right: hidden;">:</td>
	           				<td width="15%" style="border-right: hidden;">JUMLAH</td>
	           				<td width="25%" style="border-right: hidden;">:</td>
	           				<td width="15%">&nbsp;</td>
				        </tr>
	            		<tr style="border-top: hidden;">
	           				<td width="15%" style="border-right: hidden;">KODE WARNA</td>
	           				<td colspan="4">:</td>
				        </tr>
				    </table>
            	</td>
            	...
            	<td>
            		<table border="1" width="100%">
            			...
            			<tr>
			                ...
			                <td style="vertical-align: middle; border-bottom-style: hidden; text-align: right; font-weight: bold;"><?=number_format(0,2)?>&nbsp;&nbsp;</td>
			            </tr>
            			<tr>
			                <td style="height: 10px; vertical-align: middle; border-right-style: hidden; font-weight: bold;">DISC %</td>
			                <td style="vertical-align: middle; text-align: right; font-weight: bold;"><?=number_format(0,2)?>&nbsp;&nbsp;</td>
			            </tr>
            			<tr>
			                <td style="height: 30px; vertical-align: middle; border-right-style: hidden; font-weight: bold;">TOTAL </td>
			                <td style="height: 30px; vertical-align: middle; text-align: right; font-weight: bold;"><?=number_format(0,2)?>&nbsp;&nbsp;</td>
			            </tr>
			        	<tr>
