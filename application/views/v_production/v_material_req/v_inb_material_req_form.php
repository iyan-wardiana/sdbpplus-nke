...
/* 
	...
	* File Name	= v_inb_material_req_form.php
	* Location		= -
*/
...
<html>
	...
	<?php
		...
		else
		{
			...
			$alert2		= "Plese input approval notes of this document.";
		        ...
		        <form class="form-horizontal" name="frm" method="post" action="<?php echo $form_action; ?>" enctype="multipart/form-data" onSubmit="return validateInData()">
		            ...
		            <input type="hidden" name="rowCount" id="rowCount" value="0">
		            	...
		            	<div class="form-group">
		                    ...
		                    <div class="col-sm-10">
		                    		<input type="hidden" class="form-control" style="min-width:150px; max-width:150px; text-align:left" id="MR_CODE" name="MR_CODE" size="5" value="<?php echo $MR_CODE; ?>" />
		                    		<input type="text" class="form-control" style="text-align:left" id="MR_CODE1" name="MR_CODE1" value="<?php echo $MR_CODE; ?>" disabled />
		                    </div>
		                </div>
		            	<div class="form-group">
		                    ...
		                    <div class="col-sm-10">
		                        ...
		                        <i class="fa fa-calendar"></i>&nbsp;</div><input type="hidden" name="MR_DATE" class="form-control pull-left" id="datepicker" value="<?php echo $MR_DATE; ?>" style="width:106px"><input type="text" name="MR_DATE1" class="form-control pull-left" id="datepicker" value="<?php echo $MR_DATE; ?>" style="width:106px" disabled></div>
		                    </div>
		                </div>
		                <div class="form-group">
		                    ...
		                    <div class="col-sm-10">
		                        <div class="input-group date">
		                            ...
		                            <input type="hidden" name="MR_DATEU" class="form-control pull-left" id="datepicker1" value="<?php echo $MR_DATEU; ?>" style="width:106px">
		                            <input type="text" name="MR_DATEU1" class="form-control pull-left" id="datepicker1" value="<?php echo $MR_DATEU; ?>" style="width:106px" disabled>
		                        </div>
		                    </div>
		                </div>
		            	<div class="form-group" style="display:none">
		            	...
		            	<div class="form-group">
		                    ...
		                    <div class="col-sm-10">
		                    	<textarea name="MR_NOTE" class="form-control" style="max-width:350px; display:none" id="MR_NOTE" cols="30"><?php echo $MR_NOTE; ?></textarea>
		                    	<textarea name="MR_NOTEX" class="form-control" id="MR_NOTEX" cols="30" disabled><?php echo $MR_NOTE; ?></textarea>
		                    </div>
		                </div>
		                <div class="form-group">
		                    <label for="inputName" class="col-sm-2 control-label"><?php echo $ApproverNotes; ?></label>
		                    <div class="col-sm-10">
		                        <textarea name="MR_NOTE1" class="form-control" id="MR_NOTE1" cols="30"><?php echo $MR_NOTE1; ?></textarea>                        
		                    </div>
		                </div>
		            	<div class="form-group">
								...
								<?php
									// START : FOR ALL APPROVAL FUNCTION
										if($disableAll == 0)
										{
											...
											{
												$disButton	= 0;
												$sqlCAPPHE	= "tbl_approve_hist WHERE AH_CODE = '$MR_NUM' AND AH_APPROVER = '$DefEmp_ID'";
												$resCAPPHE	= $this->db->count_all($sqlCAPPHE);
												if($resCAPPHE > 0)
													$disButton	= 1;
												?>
													<select name="MR_STAT" id="MR_STAT" class="form-control select2" <?php if($disButton == 1) { ?> disabled <?php } ?> >
														<option value="0"> --- </option>
														<option value="3"<?php if($MR_STAT == 3) { ?> selected <?php } ?>>Approved</option>
														<option value="4"<?php if($MR_STAT == 4) { ?> selected <?php } ?>>Revised</option>
														<option value="5"<?php if($MR_STAT == 5) { ?> selected <?php } ?>>Rejected</option>
														<option value="7"<?php if($MR_STAT == 7) { ?> selected <?php } ?> disabled>Awaiting</option>
													</select>
												<?php
											}
											else
		                        	...
		                        	$url_AddItem	= site_url('c_production/c_mr180d0c/popupallitem/?id='.$this->url_encryption_helper->encode_url($theProjCode));
		                        ?>
												...
												/*	if ($j==1) {
				                                    ...
				                                    <tr id="tr_<?php echo $currentRow; ?>">
				                                        ...
				                                        <td width="11%" style="text-align:right"> <!-- Item Bdget -->
				                                            ...
				                                            <!-- <input type="text" class="form-control" style="min-width:110px; max-width:300px; text-align:right" name="ITM_BUDGVOLX<?php echo $currentRow; ?>" id="ITM_BUDGVOLX<?php echo $currentRow; ?>" value="<?php print number_format($ITM_QTY, $decFormat); ?>" disabled > -->
				                                        ...
				                                        <td width="11%" style="text-align:right">  <!-- Item Requested FOR INFORMATION ONLY -->
				                                            ...
				                                            <!-- <input type="text" class="form-control" style="min-width:110px; max-width:300px; text-align:right" name="ITM_TOTREQVOLx<?php echo $currentRow; ?>" id="ITM_TOTREQVOLx<?php echo $currentRow; ?>" value="<?php print number_format($REQ_VOLM, $decFormat); ?>" disabled > -->
				                                        ...
				                                        <td width="11%" style="text-align:right"> <!-- Item Request Now -- MR_VOLM -->
				                                            ...
				                                            <!-- <input type="text" name="MR_VOLM<?php echo $currentRow; ?>" id="MR_VOLM<?php echo $currentRow; ?>" value="<?php print number_format($MR_VOLM, $decFormat); ?>" class="form-control" style="min-width:110px; max-width:300px; text-align:right" onKeyPress="return isIntOnlyNew(event);" onBlur="getConvertion(this,<?php echo $currentRow; ?>);" disabled> -->
				                                        ...
				                                        <td width="24%" style="text-align:left;">
				                                        	<?php print $MR_DESC; ?>
				                                            <!-- <input type="text" name="data[<?php echo $currentRow; ?>][MR_DESC]" id="data<?php echo $currentRow; ?>MR_DESC" size="20" value="<?php print $MR_DESC; ?>" class="form-control" style="min-width:110px; max-width:300px; text-align:left" disabled> -->
		                ...
		                <div class="form-group">
		                    <div class="col-sm-offset-2 col-sm-10">
		                        <?php
									if($disableAll == 0)
									{
										if(($MR_STAT == 2 || $MR_STAT == 7) && $canApprove == 1)
										{
											?>
									...
									$backURL	= site_url('c_production/c_mr180d0c/glMr_1Nb/?id='.$this->url_encryption_helper->encode_url($PRJCODE));
...
<script>
	...
	{
		MR_NOTE1	= document.getElementById('MR_NOTE1').value;
		if(MR_NOTE1 == '')
		{
		...
		MR_STAT		= document.getElementById('MR_STAT').value;
		if(MR_STAT == 0)
		{
