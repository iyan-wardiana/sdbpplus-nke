    ...
    <head>
		...
		<?php
			...
			else
			{
				...
				$sqlDET		= "SELECT A.ITM_CODE, B.ITM_CATEG, A.ITM_QTY, A.ITM_PRICE FROM tbl_bom_stfdetail A
									LEFT JOIN tbl_item B ON A.ITM_CODE = B.ITM_CODE
										AND B.PRJCODE = '$PRJCODE'
								WHERE A.BOM_NUM = '$BOM_NUM' AND A.PRJCODE = '$PRJCODE' AND B.ISRM = 1 AND A.BOMSTF_TYPE = 'IN'";
				...
				foreach($resDET as $rowDET) :
		            ...
		            $ITM_CATEG	= $rowDET->ITM_CATEG;
		            $ITM_QTY	= $rowDET->ITM_QTY;
		            $ITM_PRICE	= $rowDET->ITM_PRICE;
		            if($ITM_CATEG == 'DY')
                    {
                    	$ITMQTYP 	= $ITM_QTY * $ITM_PRICE / 100;
                    }
                    else
                    {
                    	$ITMQTYP 	= $ITM_QTY * $ITM_PRICE;
                    }
                    $CCAL_RMCOST 	= $CCAL_RMCOST + $ITMQTYP;
		        endforeach;
			}
		                    ...
		                    <form class="form-horizontal" name="frm" id="frm" method="post" action="<?php echo $form_action; ?>" onSubmit="return checkInp()">
		                        ...
		                        <div class="row">
		                            <div class="col-md-12">
		                                <div class="box box-success">
		                               		<table id="tbl_fg" class="table table-bordered table-striped" width="100%">
		                                        <tr style="background:#00A65A; font-weight:bold; color:#FFF">
		                                          	...
		                                          	<td width="30%" style="text-align:center" nowrap><?php echo $ItemName; ?> </td>
		                                          	<td width="8%" style="text-align:center" nowrap><?php echo $Quantity; ?> </td> 
		                                            <!-- Input Manual -->
		                                            <td width="5%" style="text-align:center" nowrap><?php echo $Unit; ?> </td>
		                                          	...
		                                          	<td width="25%" style="text-align:center" nowrap><?php echo $Description; ?></td>
		                                      	</tr>
												<?php
		                                            $resultC	= 0;
													if($task == 'add' && $BOM_NUM != '')
		                                                ...
		                                                foreach($result as $row) :
		                                                	...
		                                                	<tr>
		                                                        ...
		                                                        <td style="text-align:right">
		                                                            ...
		                                                            <input type="hidden" class="form-control" style="min-width:100px; max-width:300px; text-align:right" name="ITM_QTYX_fg<?php echo $currentRow; ?>" id="ITM_QTYX_fg<?php echo $currentRow; ?>" value="<?php print number_format($ITM_QTY, $decFormat); ?>" onKeyPress="return isIntOnlyNew(event);" onBlur="getQtyITM_fg(this, <?php echo $currentRow; ?>);" disabled >
		                                                        ...
		                                                        <td style="text-align:right;">
		                                                            ...
		                                                            <input type="hidden" class="form-control" style="text-align:right; min-width:100px" name="ITM_PRICEX_fg<?php echo $currentRow; ?>" id="ITM_PRICEX_fg<?php echo $currentRow; ?>" size="10" value="<?php echo number_format($ITM_PRICE, $decFormat); ?>" onKeyPress="return isIntOnlyNew(event);" onBlur="getPRICE_fg(this, <?php echo $currentRow; ?>);" disabled>
		                                                        ...
		                                                        <!-- ITEM TOTAL COST -->
		                                                        <td style="text-align:right;">
		                                                        	<?php print number_format($ITM_TOTAL, $decFormat); ?>
		                                                            <input type="hidden" class="form-control" style="min-width:130px; max-width:350px; text-align:right" name="ITM_TOTALX_fg<?php echo $currentRow; ?>" id="ITM_TOTALX_fg<?php echo $currentRow; ?>" value="<?php print number_format($ITM_TOTAL, $decFormat); ?>" size="10" disabled >
		                                                        ...
		                                                        <td style="text-align:left">
		                                                        	...
		                                                        	<?php } else { ?>
		                                                            	<?php print $ITM_NOTES; ?>  
		                                                            	<input type="hidden" class="form-control" name="data_fg[<?php echo $currentRow; ?>][ITM_NOTES]" id="data_fg<?php echo $currentRow; ?>ITM_NOTES" value="<?php echo $ITM_NOTES; ?>">
		                                                        	<?php } ?>
		                                                        </td>
		                                                    </tr>
		                                                    <?php
		                        ...
		                        <div class="row">
		                            <div class="col-md-12">
	                                    ...
	                                    <?php } ?>
		                                <div class="box box-primary">
	                            			<table id="tbl_rm" class="table table-bordered table-striped" width="100%">
												...
												<?php
		                                            ...
		                                            //{
		                                                foreach($result as $row) :
		                                                    ...
		                                                    $ITM_QTYV 		= number_format($ITM_QTY, $decForm4);
		                                                    $ITM_UNITV 		= $ITM_UNIT;
		                                                    if($ITM_CATEG == 'DY')
		                                                    {
		                                                    	$ITM_QTYV 	= number_format($ITM_QTY, $decForm3);
		                                                    	$ITM_UNITV	= "%";
		                                                    	$ITM_QTYP 	= $ITM_QTY * $TOTPROD / 100;
		                                                    	$ITM_TOTAL 	= $ITM_QTYP * $ITM_PRICE;
		                                                    }
		                                                    elseif($ITM_CATEG == 'WIP')
		                                                    {
		                                                    	$ITM_QTYV 	= number_format($ITM_QTY, $decForm2);
		                                                    }
		                                                    else
		                                                    {
		                                                    	$ITM_QTYP 	= $ITM_QTY * $TOTPROD;
		                                                    	$ITM_TOTAL 	= $ITM_QTYP * $ITM_PRICE;
		                                                    }
		                                                	...
		                                                	<tr>
		                                                        ...
		                                                        <td style="text-align:right">
		                                                        	<?php echo $ITM_QTYV; ?>
		                                                             <input type="hidden" class="form-control" style="max-width:200px; text-align:right" name="ITM_QTYX_rm<?php echo $currentRow_rm; ?>" id="ITM_QTYX_rm<?php echo $currentRow_rm; ?>" value="<?php print number_format($ITM_QTY, $decFormat); ?>" onKeyPress="return isIntOnlyNew(event);" onBlur="getQtyITM_rm(this, <?php echo $currentRow_rm; ?>);" disabled >
		                                                        ...
		                                                        <!-- ITEM TOTAL COST -->
		                                                        <td style="text-align:right;">
		                                                        	<?php echo number_format($ITM_TOTAL, $decFormat); ?>
		                                                            <input type="hidden" class="form-control" style="min-width:130px; max-width:350px; text-align:right" name="ITM_TOTALX_rm<?php echo $currentRow_rm; ?>" id="ITM_TOTALX_rm<?php echo $currentRow_rm; ?>" value="<?php print number_format($ITM_TOTAL, $decFormat); ?>" disabled>
		                                                        ...
		                                                        <td style="text-align:left">
		                                                            <?php print $ITM_NOTES; ?>
		                                                            <input type="hidden" class="form-control" name="data_rm[<?php echo $currentRow_rm; ?>][ITM_NOTES]" id="data_rm<?php echo $currentRow_rm; ?>ITM_NOTES" value="<?php echo $ITM_NOTES; ?>">
		                                                        </td>
		                                                    </tr>
		                                                    <?php
		                                                endforeach;
		                        ...
		                        <div class="row">
		                            <div class="col-md-12">
		                                ...
		                                <div class="box box-warning">
		                               		<table id="tbl_oth" class="table table-bordered table-striped" width="100%">
		                                                ...
		                                                foreach($result as $row) :
		                                                	...
		                                                	<tr>
		                                                        ...
		                                                        <td width="13%" style="text-align:right;">
		                                                        	...
		                                                        	<?php } else { ?>
		                                                            	<?php print number_format($ITM_TOTAL, $decFormat); ?>
		                                                            	<input type="hidden" class="form-control" style="min-width:130px; max-width:350px; text-align:right" name="ITM_TOTALX_oth<?php echo $currentRow_oth; ?>" id="ITM_TOTALX_oth<?php echo $currentRow_oth; ?>" value="<?php print number_format($ITM_TOTAL, $decFormat); ?>" disabled >
		                                                        	<?php } ?>
		                                                        ...
		                                                        <td width="21%" style="text-align:left">
		                                                        	...
		                                                        	<?php } else { ?>
		                                                            	<?php print $ITM_NOTES; ?>
		                                                            	<input type="hidden" class="form-control" name="data_oth[<?php echo $currentRow_oth; ?>][ITM_NOTES]" id="data_oth<?php echo $currentRow_oth; ?>ITM_NOTES" value="<?php echo $ITM_NOTES; ?>">
		                                                        	<?php } ?>
		                                                        </td>
		                                                    </tr>
		                                                    <?php
