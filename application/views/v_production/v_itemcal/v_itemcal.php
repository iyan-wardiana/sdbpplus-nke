		            ...
		            <div class="search-table-outter">
		                <table id="example" class="table table-bordered table-striped table-responsive search-table inner" width="100%">
		                    ...
		                    <tr>
		                        ...
		                        <th width="6%" style="vertical-align:middle; text-align:center" nowrap><?php echo $DocCode ?> </th>
		                        <th width="6%" style="vertical-align:middle; text-align:center" nowrap><?php echo $ColorCode ?></th>
		                        <th width="36%" style="vertical-align:middle; text-align:center"><?php echo $ColorName  ?> </th>
		                        <th width="30%" style="vertical-align:middle; text-align:center"><?php echo $CustName ?></th>
		                        <th width="11%" style="vertical-align:middle; text-align:center"><?php echo $Cost ?> </th>
...
<script>
    ...
    $('#example').DataTable( {
		...
		"autoWidth": true,
		"filter": true,
        "ajax": "<?php echo site_url('c_production/c_I73mc05tc4l/get_AllData/?id='.$PRJCODE)?>",
        "type": "POST",
