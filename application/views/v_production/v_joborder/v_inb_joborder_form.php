...
<html>
	...
	<?php
		...
		foreach($resTransl as $rowTransl) :
			...
			if($TranslCode == 'mcnUsed')$mcnUsed = $LangTransl;
		...
		if($LangID == 'IND')
		{
			...
			$alert11		= "Silahkan pilih status persetujuan JO.";
		}
		else
		{
			...
			$alert11		= "Please select approval status.";
		}
		...
		$JO_NUMREF 	= '';
		$sqlJOH		= "SELECT JO_NUMREF FROM tbl_jo_header WHERE PRJCODE = '$PRJCODE' AND JO_NUM = '$JO_NUM'";
	    $resJOH 	= $this->db->query($sqlJOH)->result();
	    foreach($resJOH as $rowJOH) :
	        $JO_NUMREF	= $rowJOH->JO_NUMREF;
	    endforeach;
	?>
	                        ...
	                        <div class="active tab-pane" id="SOInfo">
	                            ...
	                            <div class="box-body">
	                                ...
	                                <div class="form-group">
	                                    <label class="control-label col-md-2 col-sm-2 col-xs-12" for="first-name"><?php echo $Code; ?></span>
	                                    </label>
	                                		...
	                                		?>
				                                <div class="form-group">
				                                    ...
				                                    <div class="col-md-2 col-sm-10 col-xs-12">
				                                        <select name="JO_RETYPE1" id="JO_RETYPE1" class="form-control select2" disabled>
				                                    ...
				                                    <?php
				                                    	if($JO_RETYPE == 'JO')
				                                    	{
				                                    		?>
							                                    <div class="col-md-8 col-sm-10 col-xs-12">
							                                        <select name="JO_NUMREF1" id="JO_NUMREF1" class="form-control select2" data-placeholder="&nbsp;&nbsp;&nbsp;><?php echo $Code; ?> SO" disabled>
						                                ...
						                                else
						                                {
				                                    		?>
							                                    <div class="col-md-8 col-sm-10 col-xs-12">
							                                        <select name="JO_NUMREF1" id="JO_NUMREF1" class="form-control select2" disabled>
							                                            <option value="0"> --- </option>
							                                            <?php
	                                ...
	                                <div class="form-group">
	                                    ...
	                                    <div class="col-md-10 col-sm-10 col-xs-12">
	                                        <select name="SO_NUM1" id="SO_NUM1" class="form-control select2" data-placeholder="&nbsp;&nbsp;&nbsp;><?php echo $Code; ?> SO" disabled>
	                                            <option value="0"> --- </option>
	                                            <?php
	                                            	if($task == 'add')
	                                            	{
													...
													if($disableAll == 0)
													{
														if($canApprove == 1)
														{
															...
															if($resCAPPHE > 0)
																$disButton	= 1;
															?>
																<select name="JO_STAT" id="JO_STAT" class="form-control select2" onChange="selStat(this.value)" <?php if($disButton == 1) { ?> disabled <?php } ?> >
																	<option value="0"> --- </option>
																	...
																	<option value="7"<?php if($JO_STAT == 7) { ?> selected <?php } ?> disabled>Awaiting</option>
																</select>
															<?php
														}
														else
	                                    ...
	                                    <table id="example2" class="table table-bordered table-striped table-responsive search-table inner" width="100%">
	                                        <thead>
	                                            <tr>
	                                                ...
	                                                <th width="14%" style="text-align:center" nowrap><?php echo $ItemCode; ?> BB</th>
	                                        ...
	                                        <?php
	                                            ...
	                                            else
	                                            {
	                                               $sqlSO	= "SELECT A.SO_NUM, A.SO_CODE, A.ITM_CODE,
			                                                    ...
			                                                    LEFT JOIN tbl_so_detail B ON A.SO_NUM = B.SO_NUM
																		AND B.PRJCODE = '$PRJCODE'
			                                                    WHERE A.PRJCODE = '$PRJCODE'
			                                                    	AND A.JO_NUM = '$JO_NUM'";
	                                            }
	                                ...
	                                <?php
	                                    $TOTSTEP	= 0;
	                                   	$sqlTSTEP	= "SELECT COUNT(DISTINCT JOSTF_STEP) AS TOTSTEP
	                                   					FROM tbl_jo_stfdetail WHERE BOM_NUM = '$BOM_NUM'";
	                                                ...
	                                                ?>
	                                                    ...
	                                                    <div class="box box-warning">
	                                                        <div class="box-header with-border">
	                                                            <?php
	                                                            	$MCNM 	= '';
	                                                            	$sqlMCN	= "SELECT MCN_NAME FROM tbl_machine WHERE MCN_NUM = '$MCN_NUM'";
					                                            	$resMCN = $this->db->query($sqlMCN)->result();
					                                            	foreach($resMCN as $rowMCN) :
						                                                $MCNM	= $rowMCN->MCN_NAME;
			                                            			endforeach;

			                                            			if($JOSTF_ORD == 99)
			                                            				$MCNM 	= "Skipped";
			                                            		?>
	                                                            <font style="font-weight:bold"><?php echo "$rowStep. $STEP_X : $MCNM"; ?></font>
	                                                            <input type="hidden" name="selSTEP[<?php echo $rowStep; ?>][MCN_NUM]" id="selSTEP<?php echo $rowStep; ?>MCN_NUM" value="<?php echo $MCN_NUM; ?>">
	                                                            <div class="box-tools pull-right">
	                                                            	<input type="hidden" name="selSTEP[<?php echo $rowStep; ?>][P_STEP]" id="selSTEP<?php echo $rowStep; ?>P_STEP" value="<?php echo $selSTEP; ?>">
				                                            		<input type="hidden" name="selSTEP[<?php echo $rowStep; ?>][JOSTF_ORD]" id="selSTEP<?php echo $rowStep; ?>JOSTF_ORD" value="<?php echo $JOSTF_ORD; ?>">
	                                                            </div>
	                                                        </div>
...
<script>
  $(function () {
    ...
    function checkSOInfo()
    {
        ...
        var JO_STAT	= document.getElementById('JO_STAT').value;
        if(JO_STAT == 0)
        {
