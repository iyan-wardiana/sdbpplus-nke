                                                ...
                                                <?php
                                                    ...
                                                    if($cDataItm>0)
													{
														$sqlItm	= "SELECT PRJCODE, ITM_CODE, ITM_GROUP, ITM_CATEG, ITM_NAME, ITM_UNIT, 
																		ITM_VOLM, ITM_PRICE, ITM_IN, ITM_OUT, ACC_ID, ACC_ID_UM
																	FROM tbl_item_whqty WHERE PRJCODE = '$PRJCODE'
																		AND WH_CODE = '$WH_CODE'";
