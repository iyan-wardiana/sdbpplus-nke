...
<html>
	...
	<?php
		...
		foreach($resTransl as $rowTransl) :
            ...
            if($TranslCode == 'sureCMR')$sureCMR = $LangTransl;
		endforeach;
...
<script>
    ...
    $('#example').DataTable( {
		...
		"autoWidth": true,
		"filter": true,
        "ajax": "<?php echo site_url('c_production/c_j0b0rd3r/get_AllData/?id='.$PRJCODE)?>",
        "type": "POST",
	...
	<?php
		$secIdx_DOC	= site_url('c_production/c_j0b0rd3r/pRQ_l5t_x/?id='.$this->url_encryption_helper->encode_url($PRJCODE));
	?>
