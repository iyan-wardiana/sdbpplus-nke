...
if($task == 'add')
{
	...
	$yearCur	= date('Y');
	$sqlC		= "tbl_jo_header WHERE Patt_Year = $yearCur AND PRJCODE = '$PRJCODE' AND ISREPROC = 1";
...
else
{
	...
	$JO_NUMREF 		= $default['JO_NUMREF'];
	$JO_CODEREF 	= $default['JO_CODEREF'];
...
if(isset($_POST['JO_RETYPEX']))
{
	$JO_RETYPE	= $_POST['JO_RETYPEX'];
	$JO_NUMREF	= $_POST['JO_NUMREFX'];
}

$back1	= site_url('c_production/c_rej0b0rd3r/glj0b0rd3r/?id='.$this->url_encryption_helper->encode_url($PRJCODE));
...
<html>
	...
	<?php
		...
		foreach($resTransl as $rowTransl) :
			...
			if($TranslCode == 'reprocType')$reprocType = $LangTransl;
		endforeach;
		...
		if($LangID == 'IND')
		{
			...
			$alert4			= "Jumlah yang di-JO lebih besar dari sisa JO yang di-reject.";
		...
		else
		{
			...
			$alert4			= "JO Qty is greater than of JO Rejected Qty.";
		...
		{
			if($JO_RETYPE == 'JO')
				$sqlJO	= "SELECT SO_NUM FROM tbl_jo_header WHERE PRJCODE = '$PRJCODE' AND JO_NUM = '$JO_NUMREF'";
			else
				$sqlJO	= "SELECT SO_NUM FROM tbl_sr_header WHERE PRJCODE = '$PRJCODE' AND SR_NUM = '$JO_NUMREF'";
		...
		$url_QRC		= site_url('c_production/c_rej0b0rd3r/s3l4llQRC/?id='.$this->url_encryption_helper->encode_url($PRJCODE));
		...
		$secGetMcn	= base_url().'index.php/c_production/c_rej0b0rd3r/genMcnCal/'; // Generate Code
	?>
					...
					<div class="box box-primary">
		                <div class="tab-content">
		                	<form class="form-horizontal" name="frmsrch1" method="post" action="" style="display: none;">
		                    	<input type="text" name="JO_RETYPEX" id="JO_RETYPEX" value="<?php echo $JO_RETYPE; ?>">
		                    	<input type="text" name="JO_NUMREFX" id="JO_NUMREFX" value="<?php echo $JO_NUMREF; ?>">
		                        ...
		                        <div class="active tab-pane" id="SOInfo">
		                            ...
		                            <div class="box-body">
		                                ...
		                                <div class="form-group">
		                                    <label class="control-label col-md-2 col-sm-2 col-xs-12" for="first-name"><?php echo $Code; ?>
		                                    </label>
		                                ...
		                                <!-- RE-PROCESS TYPE : RETUR OR STF REJECT -->
		                                <div class="form-group">
		                                    <label class="control-label col-md-2 col-sm-2 col-xs-12" for="first-name"><?php echo $reprocType; ?>
		                                    </label>
		                                    <div class="col-md-2 col-sm-10 col-xs-12">
		                                        <select name="JO_RETYPE1" id="JO_RETYPE1" class="form-control select2" onChange="getRETYPE(this.value)">
		                                            <option value="0" <?php if($JO_RETYPE == '0') { ?> selected <?php } ?>> --- </option>
		                                            <option value="JO" <?php if($JO_RETYPE == 'JO') { ?> selected <?php } ?>> JO Reject </option>
		                                            <option value="RET" <?php if($JO_RETYPE == 'RET') { ?> selected <?php } ?>> Retur </option>
		                                        </select>
		                                        <input type="hidden" class="form-control" name="JO_RETYPE" id="JO_RETYPE" value="<?php echo $JO_RETYPE; ?>" >
					                            <input type="hidden" class="form-control" name="JO_NUMREF" id="JO_NUMREF" value="<?php echo $JO_NUMREF; ?>" >
		                                    </div>
		                                    <?php
		                                    	if($JO_RETYPE == 'JO')
		                                    	{
		                                    		?>
					                                    <div class="col-md-8 col-sm-10 col-xs-12">
					                                        <select name="JO_NUMREF1" id="JO_NUMREF1" class="form-control select2" data-placeholder="&nbsp;&nbsp;&nbsp;><?php echo $Code; ?> SO" onChange="getJODET(this.value)">
					                                            <option value="0"> --- </option>
					                                            <?php
					                                            	if($task == 'add')
					                                            	{
					                                                	$sqlJO	= "SELECT A.JO_NUM, A.JO_CODE, A.JO_DATE, A.CUST_DESC
					                                                ...
					                                                else
					                                                {
					                                                	$sqlJO	= "SELECT A.JO_NUM, A.JO_CODE, A.JO_DATE, A.CUST_DESC
					                                                                FROM tbl_jo_header A
					                                                                WHERE A.PRJCODE = '$PRJCODE'
					                                                                    AND A.JO_NUM = '$JO_NUMREF'";
					                                                }
					                                                $resJO 		= $this->db->query($sqlJO)->result();
					                                                foreach($resJO as $rowJO) :
					                                                    $JO_NUMA	= $rowJO->JO_NUM;
					                                                    $JO_CODEA	= $rowJO->JO_CODE;
					                                                    $JO_DATEA	= date('d M Y', strtotime($rowJO->JO_DATE));
					                                                    $CUST_DESCA	= $rowJO->CUST_DESC;
					                                                    ?>
					                                                    <option value="<?php echo $JO_NUMA; ?>" <?php if($JO_NUMA == $JO_NUMREF){?> selected <?php } ?>> <?php echo "$JO_CODEA&nbsp;&nbsp;&nbsp;$JO_DATEA&nbsp;&nbsp;&nbsp;$CUST_DESCA"; ?> </option>
					                                                    <?php
					                                                endforeach;
					                                            ?>
					                                        </select>
				                                ...
				                                else
				                                {
		                                    		?>
					                                    <div class="col-md-8 col-sm-10 col-xs-12">
					                                        <select name="JO_NUMREF1" id="JO_NUMREF1" class="form-control select2" onChange="getJODET(this.value)">
					                                            <option value="0"> --- </option>
					                                            <?php
					                                            	if($JO_STAT == 1 || $JO_STAT == 4)
					                                            	{
					                                                	$sqlSR	= "SELECT A.JO_NUM, A.JO_CODE, A.CUST_DESC,
					                                                					A.SR_NUM, A.SR_CODE, A.SR_DATE
					                                                ...
					                                                else
					                                                {
					                                                	$sqlSR	= "SELECT A.JO_NUM, A.JO_CODE, A.CUST_DESC,
					                                                                ...
					                                                                FROM tbl_sr_header A
					                                                                WHERE A.PRJCODE = '$PRJCODE'
					                                                                    AND A.SR_NUM = '$JO_NUMREF'";
					                                                }
					                                                $resSR 		= $this->db->query($sqlSR)->result();
					                                                foreach($resSR as $rowSR) :
					                                                    $SR_NUMA	= $rowSR->SR_NUM;
					                                                    $SR_CODEA	= $rowSR->SR_CODE;
					                                                    $SR_DATEA	= date('d M Y', strtotime($rowSR->SR_DATE));
					                                                    $CUST_DESCA	= $rowSR->CUST_DESC;
					                                                    ?>
					                                                    <option value="<?php echo $SR_NUMA; ?>" <?php if($SR_NUMA == $JO_NUMREF){?> selected <?php } ?>> <?php echo "$SR_CODEA&nbsp;&nbsp;&nbsp;$SR_DATEA&nbsp;&nbsp;&nbsp;$CUST_DESCA"; ?> </option>
					                                                    <?php
					                                                endforeach;
					                                            ?>
					                                        </select>
		                                ...
		                                <div class="form-group">
		                                    ...
		                                    <div class="col-md-10 col-sm-10 col-xs-12">
		                                    	<input type="hidden" class="form-control" name="SO_NUM" id="SO_NUM" value="<?php echo $SO_NUM; ?>" >
		                                    	<input type="text" class="form-control" name="SO_NUM1" id="SO_NUM1" value='<?php echo "$SO_CODE&nbsp;&nbsp;&nbsp;$SO_DATEV1"; ?>' disabled >
		                                    </div>
		                                </div>
		                                <script>
											function getRETYPE(JO_RETYPE) 
											{
												var JO_RETYPEX 	= document.getElementById("JO_RETYPE").value;
												document.getElementById("JO_RETYPE").value 		= JO_RETYPE;
												document.getElementById("JO_RETYPEX").value 	= JO_RETYPE;
												document.frmsrch1.submitSrch1.click();
											}

											function getJODET(JO_NUMREF) 
											{
												var JO_RETYPEX 	= document.getElementById("JO_RETYPE").value;
												document.getElementById("JO_NUMREFX").value 	= JO_NUMREF;
												document.getElementById("JO_RETYPEX").value 	= JO_RETYPEX;
												document.frmsrch1.submitSrch1.click();
											}
		                                ...
		                                <!-- JO_DATE -->
		                                <div class="form-group">
		                                    <label class="control-label col-md-2 col-sm-2 col-xs-12" for="last-name"><?php echo $Date ?> <span class="required">*</span>
		                                    </label>
		                                ...
		                                <!-- JO_NOTES -->
		                                <div class="form-group">
		                                    <label class="control-label col-md-2 col-sm-2 col-xs-12"><?php echo $Description ?> <span class="required">*</span>
		                                    </label>
		                                    <div class="col-md-10 col-sm-10 col-xs-12">
		                                        <?php if($isDis == 0) { ?>
		                                ...
		                                <div class="form-group" <?php if($JO_NOTES2 == '') { ?> style="display:none" <?php } ?>>
		                                    <label class="control-label col-md-2 col-sm-2 col-xs-12"><?php echo $ApproverNotes ?> <span class="required">*</span>
		                                    </label>
		                                    <div class="col-md-10 col-sm-10 col-xs-12">
		                                    ...
		                                    <table id="example2" class="table table-bordered table-striped table-responsive search-table inner" width="100%">
		                                        ...
		                                        <?php
		                                            if($JO_STAT == 1 || $JO_STAT == 4)
		                                            {
		                                            	if($JO_RETYPE == 'JO')
		                                            	{
			                                                $sqlSO	= "SELECT A.SO_NUM, A.SO_CODE, A.ITM_CODE, A.ITM_UNIT, A.ITM_QTY, A.ITM_PRICE, 
			                                                				A.ITM_QTY AS SO_VOLM, A.ITM_TOTAL
			                                                            FROM tbl_jo_detail A
			                                                                INNER JOIN tbl_item B ON A.ITM_CODE  = B.ITM_CODE
			                                                                    AND B.PRJCODE  = '$PRJCODE'
			                                                            WHERE A.PRJCODE = '$PRJCODE' AND A.JO_NUM = '$JO_NUMREF'";
	                                                    }
	                                                    else
	                                                    {
			                                                $sqlSO	= "SELECT '$SO_NUM' AS SO_NUM, '$SO_CODE' AS SO_CODE,
			                                                				A.ITM_CODE, A.ITM_UNIT, A.SR_VOLM AS ITM_QTY, A.SR_PRICE AS ITM_PRICE, 
			                                                				A.SR_VOLM AS SO_VOLM, A.SR_TOTAL AS ITM_TOTAL
			                                                            FROM tbl_sr_detail A
			                                                                INNER JOIN tbl_item B ON A.ITM_CODE  = B.ITM_CODE
			                                                                    AND B.PRJCODE  = '$PRJCODE'
			                                                            WHERE A.PRJCODE = '$PRJCODE' AND A.SR_NUM = '$JO_NUMREF'";
	                                                    }
		                                            }
		                                            else
		                                            {
		                                            ...
		                                            foreach($resSO as $rowSO) :
		                                                ...
		                                                <tr>
		                                                    ...
		                                                    <td width="12%" style="text-align:right">
		                                                        <?php if($isDis == 0) { ?>
		                                                            <input type="hidde" class="form-control" name="ITM_QTYX3_<?php echo $cRow; ?>" id="ITM_QTYX3_<?php echo $cRow; ?>" style="text-align:right" value="<?php echo number_format($ITM_QTY,2); ?>" onBlur="chgQTY(this,'<?php echo $cRow; ?>');" onKeyPress="return isIntOnlyNew(event);">
		                                                        <?php } else {
		                                                        ...
		                                                        <div class="box-header with-border">
		                                                            ...
		                                                            <div class="box-tools pull-right">
			                                                            ...
			                                                            <select name="selSTEP[<?php echo $rowStep; ?>][JOSTF_ORD]" id="selSTEP<?php echo $rowStep; ?>JOSTF_ORD" class="form-control select2" style="max-width:80px" onChange="chgORD(this.value, <?php echo $rowStep; ?>)">
			                                                            	<option value="0"> --- </option>
			                                                            	<option value="99" <?php if($JOSTF_ORD == 99) { ?> selected <?php } ?>>Skip</option>
				                                                            <?php
				                                                            	for($a=1; $a<=$TOTSTEP; $a++)
			                                    								{ ?>
