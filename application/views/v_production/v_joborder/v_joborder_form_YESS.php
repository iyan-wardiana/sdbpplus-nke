...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap -->
    <link href="<?php echo base_url() . 'assets/AdminLTE-2.0.5/build/css/bootstrap.min.css'; ?>" rel="stylesheet">
    <!-- Custom Theme Style -->
                      ...
                      <div id="step-1">
                        <form class="form-horizontal form-label-left">
                          ...
                          <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">First Name1 <span class="required">*</span>
                            </label>
...
<script language="javascript" src="<?php echo base_url() . 'assets/AdminLTE-2.0.5/plugins/jQuerySW/js/jquery.min.js'; ?>"></script>
