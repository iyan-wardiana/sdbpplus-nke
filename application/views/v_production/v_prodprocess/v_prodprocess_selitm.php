...
<?php
	...
	else
	{
		...
		$sqlDataItm		= "SELECT PRJCODE, ITM_CODE, ITM_GROUP, ITM_CATEG, ITM_NAME, ITM_UNIT, ITM_VOLM, ITM_PRICE,
							...
							FROM tbl_item WHERE PRJCODE = '$PRJCODE' AND (ISWIP = 1 OR ISFG = 1) AND STATUS = 1";
    	 ...
    	 <div class="col-md-12">
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    ...
                    <li <?php echo $Active2Cls; ?>><a href="#others" data-toggle="tab" onClick="setType(2)"><?php echo $Substitute; ?></a></li> 		<!-- Tab 1 -->
                </ul>
                <!-- Biodata -->
                                            ...
                                            <table id="example1" class="table table-bordered table-striped table-responsive search-table inner" width="100%">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th width="43%" style="text-align:center" nowrap><?php echo $ItemName; ?> </th>
                                                        <th width="4%" style="text-align:center" nowrap><?php echo $Unit; ?></th>
                                                        <th width="10%" style="text-align:center" nowrap><?php echo $Request; ?>  </th>
                                                        <th width="11%" style="text-align:center" nowrap><?php echo $ReceiptQty; ?></th>
                                                        <th width="9%" style="text-align:center" nowrap><?php echo $Remain; ?>  </th>
                                                        <th width="8%" style="text-align:center" nowrap><?php echo $StockQuantity; ?></th>
                                                  </tr>
                                                </thead>
                                                <tbody>
                                                <?php
                                                    ...
                                                    if($cDataItm>0)
													{
														...
														foreach($vDataItm as $row) :								
															...
															?>
															<td style="text-align:center"><input type="checkbox" name="chk" value="<?php echo $PRJCODE;?>|<?php echo $ITM_CODE;?>|<?php echo $ITM_GROUP;?>|<?php echo $ITM_NAME;?>|<?php echo $ITM_UNIT;?>|<?php echo $ITM_VOLM;?>|<?php echo $ITM_VOLM;?>|<?php echo $ITM_PRICE;?>|<?php echo $ACC_ID;?>|<?php echo $ACC_ID_UM;?>" onClick="pickThis(this);" /></td>
															...
															<td nowrap style="text-align:right"><?php echo number_format($IRM_VOLM, $decFormat); ?></td>
