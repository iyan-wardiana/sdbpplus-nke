        ...
        <div class="col-md-9">
			<div class="nav-tabs-custom">
            	<ul class="nav nav-tabs">
                    ...
                    <li <?php if($showFORM == 3) { ?> class="active" <?php } ?>><a href="#SelectFG" data-toggle="tab">3. <?php echo "$Step3Des : $SO_CODEV"; ?></a></li>					<!-- Tab 3 -->
                </ul>
                                                ...
                                                <table id="example1" class="table table-bordered table-striped" width="100%">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th width="16%" style="text-align:center; vertical-align:middle" nowrap><?php echo $Code; ?> SO</th>
                                                            <th width="4%" style="text-align:center; vertical-align:middle" nowrap><?php echo $Date; ?> </th>
                                                          <th width="11%" style="text-align:center; vertical-align:middle; white-space: nowrap"><?php echo $ProdPlan; ?> </th>
                                                            <th width="67%" style="text-align:center; vertical-align:middle" nowrap><?php echo $CustName; ?> </th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        <?php
                                                            ...
                                                            if($resSOC > 0)
                                                            {
                                                                foreach($resSO as $rowSO) :
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td width="11%" style="text-align:center" nowrap>
                                                                            <?php echo date('d M Y', strtotime($SO_PRODD)); ?>
                                                                        </td>
                                                                        <td width="67%" style="text-align:left" nowrap>
                                                ...
                                                <table width="100%" border="0">
                                                    <tr>
                                                        ...
                                                        <td width="85%" style="text-align:right" nowrap>
                                                            ...
                                                            <button class="btn btn-primary" onClick="isNext2(2);" id="btnSubmit2">
                                                                <i class="glyphicon glyphicon-triangle-right"></i><?php echo $Next; ?>
                                                            </button>
                                                                                ...
                                                                                <div class="timeline-item">
                                                                                    ...
                                                                                    <table class="table table-bordered" width="100%">
                                                                                        <tr>
                                                                                            ...
                                                                                            <th width="108" nowrap><?php echo $Code; ?></th>
                                                                                            <th width="32" nowrap><?php echo $Date; ?></th>
                                                                                            <th width="83" nowrap><?php echo $BOMCode; ?></th>
                                                                                            <th width="785"><?php echo $ItemName; ?></th>
                                                                                            <th width="108">Qty</th>
                                                                                        </tr>
																						<?php
																							$theRowSTF	= 0;
                                                                                            $sqlSTF	= "SELECT A.STF_CODE, A.STF_DATE, A.BOM_CODE,
																											A.ITM_NAME, A.STF_VOLM
                                                                                            ...
                                                                                            $sqlSTF	= "SELECT A.STF_CODE, A.STF_DATE, A.BOM_CODE,
                                                                                                        ...
                                                                                                        FROM tbl_stf_detail A
																											INNER JOIN tbl_stf_header B
																												...
																												AND B.PRJCODE = '$PRJCODE'
																										WHERE A.JO_NUM = '$JO_NUM'
																											AND B.STF_FROM = 'THR' AND STF_STAT = 3";
                                                                                            $resSTF	= $this->db->query($sqlSTF)->result();
                                                                                            foreach($resSTF as $rwSTF):
																								$theRowSTF	= $theRowSTF + 1;
                                                                                                $STF_CODE	= $rwSTF->STF_CODE;
                                                                                            ...
                                                                                            $sqlSTF	= "SELECT A.STF_CODE, A.STF_DATE, A.BOM_CODE,
                                                                                                        ...
                                                                                                        FROM tbl_stf_detail A
																											INNER JOIN tbl_stf_header B
																												...
																												AND B.PRJCODE = '$PRJCODE'
																										WHERE A.JO_NUM = '$JO_NUM'
																											AND B.STF_FROM = 'FOU' AND STF_STAT = 3";
                                                                                            $resSTF	= $this->db->query($sqlSTF)->result();
                                                                                            foreach($resSTF as $rwSTF):
																								$theRowSTF	= $theRowSTF + 1;
                                                                                                $STF_CODE	= $rwSTF->STF_CODE;
                                                                                            ...
                                                                                            $sqlSTF	= "SELECT A.STF_CODE, A.STF_DATE, A.BOM_CODE,
                                                                                                        ...
                                                                                                        FROM tbl_stf_detail A
																											INNER JOIN tbl_stf_header B
																												...
																												AND B.PRJCODE = '$PRJCODE'
																										WHERE A.JO_NUM = '$JO_NUM'
																											AND B.STF_FROM = 'FIV' AND STF_STAT = 3";
                                                                                            $resSTF	= $this->db->query($sqlSTF)->result();
                                                                                            foreach($resSTF as $rwSTF):
																								$theRowSTF	= $theRowSTF + 1;
                                                                                                $STF_CODE	= $rwSTF->STF_CODE;
                                                                                            ...
                                                                                            $sqlSTF	= "SELECT A.STF_CODE, A.STF_DATE, A.BOM_CODE,
                                                                                                        ...
                                                                                                        FROM tbl_stf_detail A
																											INNER JOIN tbl_stf_header B
																												...
																												AND B.PRJCODE = '$PRJCODE'
																										WHERE A.JO_NUM = '$JO_NUM'
																											AND B.STF_FROM = 'SIX' AND STF_STAT = 3";
                                                                                            $resSTF	= $this->db->query($sqlSTF)->result();
                                                                                            foreach($resSTF as $rwSTF):
																								$theRowSTF	= $theRowSTF + 1;
                                                                                                $STF_CODE	= $rwSTF->STF_CODE;
                                                                                            ...
                                                                                            $sqlSTF	= "SELECT A.STF_CODE, A.STF_DATE, A.BOM_CODE,
                                                                                                        ...
                                                                                                        FROM tbl_stf_detail A
																											INNER JOIN tbl_stf_header B
																												...
																												AND B.PRJCODE = '$PRJCODE'
																										WHERE A.JO_NUM = '$JO_NUM'
																											AND B.STF_FROM = 'SEV' AND STF_STAT = 3";
                                                                                            $resSTF	= $this->db->query($sqlSTF)->result();
                                                                                            foreach($resSTF as $rwSTF):
																								$theRowSTF	= $theRowSTF + 1;
                                                                                                $STF_CODE	= $rwSTF->STF_CODE;
