...
<html>
    ...
    <body class="<?php echo $appBody; ?>">
        <div class="content-wrapper">
            ...
            <?php
                $dateNow    = date('Y-m-d');
                $sqlAbsC    = "tbl_absensi WHERE ABS_DATE = '$dateNow'";
                $resAbsC    = $this->db->count_all($sqlAbsC);
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-xs-6">
                                <div class="small-box bg-green">
                                    <div class="inner">
                                        <h3><?php echo $resAbsC; ?></h3>
                                        <p>Kehadiran</p>
                                    </div>
                                    <div class="icon">
                                        <i class="ion ion-clock"></i>
                                    </div>
                                    <a href="<?php echo $urlDash1; ?>" class="small-box-footer">
