            	...
            	<table id="example1" class="table table-bordered table-striped table-responsive search-table inner" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th width="43%" style="text-align:center; vertical-align:middle" nowrap><?php echo "$Topic / $Destination"; ?> </th>
                    ...
                    <?php
                        ...
                        { 
                            foreach($vwVH as $row) :
								...
								// GET Vehicle detail
									$VH_NOPOL	= '';
									$sqlVH		= "SELECT VH_NOPOL FROM tbl_vehicle WHERE VH_CODE = '$CATEG_CODE'";
                                ...
                                ?>
                                    ...
                                    <td nowrap style="text-align:left; vertical-align:middle"><?php echo $VH_MEREK2; ?> </td>
                                    <td nowrap style="text-align:left; vertical-align:middle; <?php echo $bgSetting; ?>"><?php echo $VH_NOPOL2; ?></td>
