...
<?php
	...
	if(isset($_POST['RSV_CODE']))	// MARKETING
	{
		...
		elseif($CUR_STAT == 8)		// FINISH
		{
			...
			//Update Ruang Meeting to avilable
			/*
			if($CATEG_CODE2 == 'MR-180001')
			{
				$CATEG_CODE2 = "'MR-180001','MR-180008','MR-180010'";
			}
			elseif($CATEG_CODE2 == 'MR-180002')
			{
				$CATEG_CODE2 = "'MR-180002','MR-180008','MR-180009','MR-180010'";
			}
			elseif($CATEG_CODE2 == 'MR-180003')
			{
				$CATEG_CODE2 = "'MR-180003','MR-180009','MR-180010'";
			}
			elseif($CATEG_CODE2 == 'MR-180008')
			{
				$CATEG_CODE2 = "'MR-180001','MR-180002','MR-180008','MR-180009','MR-180010'";
			}
			elseif($CATEG_CODE2 == 'MR-180009')
			{
				$CATEG_CODE2 = "'MR-180002','MR-180003','MR-180008','MR-180009','MR-180010'";
			}
			elseif($CATEG_CODE2 == 'MR-180010')
			{
				$CATEG_CODE2 = "'MR-180001','MR-180002','MR-180003','MR-180008','MR-180009','MR-180010'";
			}
			else
			{
				$CATEG_CODE2 = "'$CATEG_CODE2'";
			}
			$sqlMRStatUp	= "UPDATE tbl_meeting_room SET MR_STAT = 0 WHERE MR_CODE IN ($CATEG_CODE2)";
			*/
			...
			// SENT MAIL TO SUBMITTER
				...
				foreach($resRsv as $rowRsv):
					...
					$MR_NAME1		= '';
					$sqlMR1			= "SELECT MR_NAME FROM tbl_meeting_room WHERE MR_CODE = '$CATEG_CODE1'";
					$resMR1			= $this->db->query($sqlMR1)->result();
					foreach($resMR1 as $rowMR1):
						$MR_NAME1	= $rowMR1->MR_NAME;
					endforeach;
				...
				$output		.= '<table width="100%" border="0">
									...
									<tr>
										<td width="2%" style="vertical-align:top">&nbsp;</td>
										<td width="9%" nowrap>Ruang Rapat</td>
										<td width="89%">: '.$MR_NAME1.'</td>
									</tr>
									<tr>
										<td width="2%" style="vertical-align:top">&nbsp;</td>
	...
	$sqlCAg		= "tbl_reservation WHERE (RSV_STARTD2 <= '$dateNow' OR RSV_ENDD2 >= '$dateNow') AND MONTH(RSV_STARTD2) = $NowMonth
						AND RSV_EMPID = '$DefEmp_ID' AND RSV_STAT IN (3,8) AND RSV_CATEG = 'MR'";
            	...
            	<?php
					if($resCAg > 0)
					{
						...
						foreach($resAg as $rowAg):
							...
							$MR_NAME		= '';
							$sqlMR			= "SELECT MR_NAME FROM tbl_meeting_room WHERE MR_CODE = '$CATEG_CODE2'";
                                ...
                                <div class="col-md-4">
                                    <div class="box box-warning box-solid">
                                        <div class="box-header with-border">
                                            <h3 class="box-title"><?php echo $MR_NAME; ?></h3>
