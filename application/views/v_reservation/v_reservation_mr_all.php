                                    ...
                                    <tr>
                                        ...
                                        <td width="50%" style="text-align:right">
                                            <div class="input-group date">
                                                ...
                                                <input type="text" name="ASUM_PERIOD" class="form-control pull-left" id="datepicker1" value="<?php echo $ASUM_PERIODX_1; ?>" style="width:150px" onChange="getNewDate(this.value)">
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td nowrap style="text-align:left">Test 02</td>
                                        <td style="text-align:right">
                                            <input type="text" class="form-control" name="AMOUNT_1x" id="AMOUNT_1x" style="max-width:100%; text-align:right" value="" onKeyPress="return isIntOnlyNew(event);" onBlur="getPERC_1()" />
                                            <input type="hidden" class="form-control" name="AMOUNT_1" id="AMOUNT_1" style="max-width:100%; text-align:right" value="" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>
            	...
            	<table id="example1" class="table table-bordered table-striped table-responsive search-table inner" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th width="43%" style="text-align:center; vertical-align:middle" nowrap><?php echo $Topic; ?> </th>
                            <th width="10%" style="text-align:center; vertical-align:middle" nowrap><?php echo $MeetingRoom; ?></th>
                        ...
                        { 
                            foreach($vwMR as $row) :
                                ...
                                ?>
                                    ...
                                    <td nowrap style="text-align:center; vertical-align:middle">
                                        <a href="<?php echo $secUpd; ?>" class="btn btn-warning btn-xs" title="Update Project" <?php if($enabled == 0) { ?>disabled="disabled" <?php } ?>>
                                            <i class="glyphicon glyphicon-pencil"></i>
                                        </a>
                                        <a href="" class="btn btn-danger btn-xs" title="In Active Project" onclick="return confirm('<?php echo $sureDelete; ?>')" <?php if($enabled == 0) { ?>disabled="disabled" <?php } ?>>
