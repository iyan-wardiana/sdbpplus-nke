 ...
 * File Name	= v_reservation_mr_form.php
 * Location		= -
*/
            ...
            <div class="box box-primary">
                ...
                <div class="box-body chart-responsive">
                	...
                	<form class="form-horizontal" name="frm" id="frm" method="post" action="<?php echo $form_action; ?>" onSubmit="return chkForm()">
                                    ...
                                    <?php
                                        ...
                                        if($CountCTG > 0)
                                        {
                                            foreach($resCTG as $rowCTG) :
                                                ...
                                                ?>
                                                <option value="<?php echo $MR_CODE; ?>" <?php if($MR_CODE == $CATEG_CODE) { ?>selected <?php } if($isDisabled == 1) { ?> disabled <?php } ?>>
                        ...
                        <div class="form-group">
                          	<label for="inputName" class="col-sm-2 control-label"><?php echo $Topic; ?> </label>
                          	<div class="col-sm-10">
