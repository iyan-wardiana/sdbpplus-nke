                ...
                <div class="box-body chart-responsive">
                	...
                	<form class="form-horizontal" name="frm" id="frm" method="post" action="<?php echo $form_action; ?>" onSubmit="return chkForm()">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select name="CATEG_CODEX" id="CATEG_CODEX" class="form-control" style="max-width:250px">
                                    ...
                                    <?php
                                        ...
                                        if($CountCTG > 0)
                                        {
                                            foreach($resCTG as $rowCTG) :
                                                ...
                                                ?>
                                                <option value="<?php echo $MR_CODE; ?>" <?php if($MR_CODE == $CATEG_CODE) { ?>selected <?php } ?>>
                        ...
                        <div class="form-group">
                          	...
                          	<div class="col-sm-10">
                                <input type="text" class="form-control" style="max-width:350px" name="RSV_TITLE" id="RSV_TITLE" value="<?php echo $RSV_TITLE; ?>" readonly />
                          	</div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="inputSkills" class="col-sm-2 control-label">Undangan</label>
                                ...
                                <?php
                                    if($CountUND > 0)
                                    {
                                        foreach($vwUND as $rowUND)
                                        {
											...
											if($RSV_INVIT != "")
											{
												$arr = in_array($Email,(explode(";",$RSV_INVIT))) ? 'selected="selected"' :'';	
											}
                                        
                                ?>
                                  <option value="<?php echo "$Email";?>" <?php echo  $arr; ?>><?php echo "$Full_Name - $Email";?></option>
                                  <?php
                                     }
                                        }
                                  ?>
								...
								<?php
                                    ...
                                    ?>
                                        <select name="RSV_STAT" id="RSV_STAT" class="form-control" style="max-width:120px" onChange="selStat(this.value)" >
                                            <?php /*?><option value="1"<?php if($RSV_STAT == 1) { ?> selected <?php } ?>>New</option><?php */?>
                                            ...
                                            <option value="6"<?php if($RSV_STAT == 7) { ?> selected <?php } ?>>Revise</option>
