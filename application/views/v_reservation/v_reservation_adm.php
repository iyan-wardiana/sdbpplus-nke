 ...
 * File Name	= v_reservation_mr_adm.php
 * Location		= -
*/ 
...
<?php
	...
	foreach($resTransl as $rowTransl) :
		...
		if($TranslCode == 'Order')$Order = $LangTransl;
		if($TranslCode == 'Destination')$Destination = $LangTransl;
		if($TranslCode == 'Back')$Back = $LangTransl;
		if($TranslCode == 'OrderCategory')$OrderCategory = $LangTransl;
            	...
            	<table id="example1" class="table table-bordered table-striped table-responsive search-table inner" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th width="7%" style="text-align:center; vertical-align:middle" nowrap><?php echo $OrderCategory; ?></th>
                            <th width="9%" style="text-align:center; vertical-align:middle" nowrap>
                            <?php
							if($LangID == 'IND')
								echo "$Detail $Order";
							else
                            ...
                            <th width="46%" style="text-align:center; vertical-align:middle" nowrap><?php echo "$Topic / $Destination"; ?> </th>
                        ...
                        { 
                            foreach($vwBL as $row) :
								...
								//GET VEHICLE DETAIL
									...
									$VH_MEREK	= '';
									$VH_NOPOL	= '';
									$sqlVH		= "SELECT VH_TYPE, VH_MEREK, VH_NOPOL FROM tbl_vehicle WHERE VH_CODE = '$CATEG_CODE'";
								...
								if($RSV_CATEG == 'MR')
								{
									$Detail_RSV = $MR_NAME;
									if($LangID == 'IND')
										$RSV_CATEG = 'Ruang Meeting';
									else
										$RSV_CATEG = 'Meeting Room';
								}
								elseif($RSV_CATEG == 'VH')
								{
									$Detail_RSV = "$VH_MEREK - $VH_NOPOL";
									if($LangID == 'IND')
										$RSV_CATEG = 'Kendaraan'; 
									else
										$RSV_CATEG = 'Vehicle';	
                                ...
                                ?>
                                    ...
                                    <td nowrap style="text-align:left; vertical-align:middle"><?=$RSV_CATEG?></td>
                                    ...
                                    <td nowrap style="text-align:center; vertical-align:middle">
										...
										{
										?>
                                        <a href="" class="btn btn-danger btn-xs" title="In Active Project" onclick="return confirm('<?php echo $sureDelete; ?>')" >
...
<script>
  $(function () 
  {
	...
	function viewBookList(row)
	{
		var url	= document.getElementById('urlViewList'+row).value;
		w = 900;
		h = 550;
