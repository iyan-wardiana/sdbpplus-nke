                	...
                	<form class="form-horizontal" name="frm" id="frm" method="post" action="<?php echo $form_action; ?>" onSubmit="return chkForm()">
                        ...
                        <script>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <select name="CATEG_CODE" id="CATEG_CODE" class="form-control" style="max-width:250px" onChange="return cekVH_CODE();">
                                      ...
                                      <?php
                                          ...
                                          if($CountCTG > 0)
                                          {
                                              foreach($resCTG as $rowCTG) :
                                                  ...
                                                  ?>
                                                  <option <?php if($isDisabled == 1) {?> style="font-style:italic;color:red" <?php }?> value="<?php echo $VH_CODE; ?>" <?php if($VH_CODE == $CATEG_CODE) { ?>selected <?php } if($isDisabled == 1) { ?> disabled <?php } ?>>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <input type="text" id="NOPOL" name="NOPOL" class="form-control" value="<?=$VH_NOPOL?>">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          	<label for="inputName" class="col-sm-2 control-label"><?php echo "$Topic / $Destination"; ?> </label>
                          	<div class="col-sm-10">
                                <textarea class="form-control" style="max-width:350px" name="RSV_TITLE" id="RSV_TITLE" cols="30"><?php echo $RSV_TITLE; ?></textarea>
                          	</div>
                        </div>
                        <div class="form-group">
