    ...
    <section class="content">
        <div class="row">
            <div class="col-md-3">
                ...
                <?php					
					$MR_CODE_DEF		= "$MR_CODE_DEF~$RSV_STARTD2~$RSV_ENDD2";
                                        ...
                                        <div class="col-md-8">
                                            <select name="CATEG_CODE" id="CATEG_CODE" class="form-control">
                                                <?php
                                                    ...
                                                    $sqlCTG 	= "SELECT MR_CODE, MR_NAME, MR_STAT, MR_STATD FROM tbl_meeting_room WHERE MR_CODE = '$MR_CODE_DEFA'";
                                                    ...
                                                    if($CountCTG > 0)
                                                    {
                                                        foreach($resCTG as $rowCTG) :
                                                            ...
                                                            ?>
                                                            <option value="<?php echo $MR_CODE; ?>" selected>
                                                                <?php echo "$MR_NAME"; ?>
                                                            </option>
                                                            <?php
                                                        endforeach;
                        ...
                        <div class="modal-content">
                            ...
                            <form class="form-horizontal" name="frm" id="frm" method="post" action="<?php echo $edit_event; ?>" onSubmit="return chkForm_E()">
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-4 label-heading"><?php echo "$InviteTo edit"; ?></label>
                                        <div class="col-md-8 ui-front">
                                        	
                                        	<input type="hidden" class="form-control" name="Inv_Emp_ID" id="Inv_Emp_ID" placeholder="Input ID" />
                                        	<input type="text" class="form-control" name="Inv_Emp_Email" id="Inv_Emp_Email" placeholder="Select Email" />
                                            <!--<input type="hidden" class="form-control" name="Inv_Emp_E" id="Inv_Emp_E" placeholder="Inv_Emp_E" />-->
                                            <!--<input type="text" class="form-control" name="Inv_Emp_E" id="Inv_Emp_ID - Inv_Emp_Email" placeholder="Inv_Emp_ID - Inv_Emp_Email" />-->
                                                                                      
                                            <select name="Inv_Emp_Email[]" id="Inv_Emp_Email" class="form-control select2" multiple="multiple" data-placeholder="Select Karyawan" style="width: 100%;">
                                            <?php
												
											
												 $CountE 	= $this->db->count_all('tbl_employee');
                                                 $sqlE 	= "SELECT Emp_ID, First_Name, Last_Name, Email FROM tbl_employee ";
                                                 $resE		= $this->db->query($sqlE)->result();
													if($CountE > 0)
												{
											...
											?>
                                             ...
                                             <?php //$email2= array("hendar.permana@nusakonstruksi.com","dianhermanto@nusakonstruksi.com")?>
                                            
											
											<?php 
											  	
												  $str = "hendar.permana@nusakonstruksi.com;dedeubay@nusakonstruksi.com";
												  
												  
												  
												  //$str = "document.getElementById('Inv_Emp_Email').value 	= Inv_Emp_Email;";
													//echo "email:$str";
												  //print_r (explode(";",$str));
													
											   ?>
                                              <option value="<?php echo "$Email"; ?>" <?php echo  in_array($Email,(explode(";",$str))) ? 'selected="selected"' :'' ?>> <?php echo "$Full_Name - $Email"; ?></option>-->
                                              
                                             <!-- <option value="<?php //echo "$Email"; ?>" <?php //if($Email == $email2[0]){ ?> selected <?php //} ?>> <?php //echo "$Full_Name - $Email"; ?></option>-->
		...
		$(function ()
		{
			...
			$('#calendar').fullCalendar(
			{
				...
				eventClick: function(event, jsEvent, view) 
				{
					...
					var Inv_Emp_ID		= event.Inv_Emp_ID;
					var Inv_Emp_Email	= event.Inv_Emp_Email;
					
					//alert (Inv_Emp_Email);
					//var Inv_Emp_E		= event.Inv_Emp_E;
					...
					//inv_to_email_E	= Inv_Emp_Email.split(';');
					//alert (inv_to_email_E);
					...
					document.getElementById('Inv_Emp_ID').value 	= Inv_Emp_ID;
					document.getElementById('Inv_Emp_Email').value 	= Inv_Emp_Email;
										
					//document.getElementById('Inv_Emp_E').value		= 'Testing3';
					...
					if(RSV_STAT != 1)
					{
						...
						document.getElementById('p-in').style.display = 'none';
					}
