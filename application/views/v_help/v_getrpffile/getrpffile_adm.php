        	...
        	<form action="" onSubmit="confirmDelete();" method=POST>
                    <table id="example1" class="table table-bordered table-striped table-responsive search-table inner" width="100%">
                    	...
                    	<?php
							...
							$Dir1		= "Temp";
							$Dir2		= "Temp$FlagUSER";							
							$Dir3		= "C:/xampp/htdocs/nke.co.id/uploads/$Dir2";
							//$dir 		= "C:/$Dir2/";
							$dir 		= "$Dir3/";
							//echo "$FlagUSER";
							//echo "$Dir1";
									...
									while (($file = readdir($dh)) !== false) 
									{
										...
										if($icon == "RPF")
										{
											...
											else // Apabila sduah ada, maka cek apakah tanggal updtae nya sama
											{
												...
												{
													$sqlRTFUpNm	= "UPDATE tbl_rtflistA SET RTF_SHOW = 1 WHERE RTF_NAME = '$file'";
													$resRTFUpNm	= $this->db->query($sqlRTFUpNm);
												}
												elseif($RTF_MOD == $RTF_MODA && $RTF_SHOW == 0)
												{
													$sqlRTFUpNm	= "UPDATE tbl_rtflistA SET RTF_SHOW = 0 WHERE RTF_NAME = '$file'";
													$resRTFUpNm	= $this->db->query($sqlRTFUpNm);
												}
												else
												{
												...
												if($isSearch == 'No')
												{
													...
													else
													{
														...
														else
														{
															...
															$link = '<a href="'.base_url().'uploads/'.$Dir2.'/'.$file.'" title="Download file" data-skin="skin-green" class="btn btn-success btn-xs"><i class="fa fa-download"></i></a> 
