                        	...
                        	<div class="search-table-outter">
		                        ...
		                        <!-- <table width="100%" border="1" id="tbl"> -->
		                        	<tr style="background:#CCCCCC">
		                              	...
		                              	<th width="150" style="text-align:center"><?php echo $Remarks; ?></th>
		                          	</tr>
		                            <?php
		                            $editable	= 0;
		                            if($GEJ_STAT == 1 || $GEJ_STAT == 4)
									...
									else
									{
										...
										?>
											<tr>
		                                        <td style="text-align:left" nowrap>
	                                            	<select name="AccId_D" id="AccId_D" class="form-control select2" onChange="selectAccount(this.value)">
						                            	<option value=""> --- </option>
						                                <?php echo $i = 0;
							                                if($countAcc > 0)
							                                {
																foreach($vwAcc as $row) :
																	...
																	if($Account_Class == 2)
																		$disable = 0;
																	?>
																		<option value="<?php echo $Account_Number; ?>" <?php if($Account_Number == $AccId_D){ ?> selected <?php } if($disable == 1) { ?> style="color:#999" disabled <?php } else { ?> style="color:#00F; font-weight:bold" <?php } ?>>
		                                        ...
		                                        <td style="text-align:right" nowrap>
		                                        	<input type="text" class="form-control" style="text-align:right" name="JournalD_Amount" id="JournalD_Amount" value="" placeholder="Jumlah Debet" onBlur="chgAmountD()" onKeyPress="return isIntOnlyNew(event);">
		                                        </td>
		                                        <td style="text-align:right" nowrap>
		                                        	<input type="text" class="form-control" style="text-align:right" name="JournalK_Amount" id="JournalK_Amount" value="" placeholder="Jumlah Kredit" onBlur="chgAmountK()" onKeyPress="return isIntOnlyNew(event);">
		                                        </td>
		                                        <td style="text-align:left" nowrap>&nbsp;</td>
							          		</tr>
							          		<tr>
		                                        <td style="text-align:left" nowrap>
	                                            	<select name="AccId_K" id="AccId_K" class="form-control select2" onChange="selectAccount(this.value)">
						                            	<option value=""> --- </option>
						                                <?php echo $i = 0;
							                                if($countAcc > 0)
							                                {
																foreach($vwAcc as $row) :
																	...
																	if($Account_Class == 2)
																		$disable = 0;
																	?>
																		<option value="<?php echo $Account_Number; ?>" <?php if($Account_Number == $AccId_K){ ?> selected <?php } if($disable == 1) { ?> style="color:#999" disabled <?php } else { ?> style="color:#00F; font-weight:bold" <?php } ?>>
																			<?php echo "$Account_Number &nbsp;&nbsp;$Account_Name"; ?>
																		</option>
																 	<?php
																endforeach;
