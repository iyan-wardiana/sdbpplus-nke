        ...
        <td colspan="3" class="style2">
            <table width="100%" border="1" rules="all">
                ...
                <tr style="background:#CCCCCC">
                    ...
                    <td width="3%" nowrap style="text-align:center; font-weight:bold"><?php echo $NEXTWEEK1+1; ?></td>
                    <td width="3%" nowrap style="text-align:center; font-weight:bold"><?php echo $NEXTWEEK1+2; ?></td>
                    <td width="3%" nowrap style="text-align:center; font-weight:bold"><?php echo $NEXTWEEK1+3; ?></td>
                    <td width="3%" nowrap style="text-align:center; font-weight:bold"><?php echo $NEXTWEEK1+4; ?></td>
                    <td width="3%" nowrap style="text-align:center; font-weight:bold"><?php echo $NEXTWEEK1+5 ?></td>
                    <td width="3%" nowrap style="text-align:center; font-weight:bold"><?php echo $NEXTWEEK1+6; ?></td>
                    <td width="3%" nowrap style="text-align:center; font-weight:bold"><?php echo $NEXTWEEK1+7; ?></td>
              </tr>
                <?php
                if($CFType == 1)	// SUMMARY
                {
								...
								// TOTAL OUTSTANDING PAYMENT BEFORE DATE REPORT
									...
									$sqlOUTPAY_P	= "SELECT SUM(B.TTKCOST) AS OUTPAY_P, SUM(B.PPN) AS OUTPAYPPN_P
														...
														WHERE B.PRJCODE = '$PRJCODE'
															AND (A.TTKDATE < '$startDate' OR A.TTKDATE BETWEEN '$startDate1' AND '$endDate1')
															AND A.TRXCANC = 0";
