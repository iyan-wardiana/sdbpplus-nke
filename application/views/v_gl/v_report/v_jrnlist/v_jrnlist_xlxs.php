<?php
	...
	header("Content-Disposition: attachment; filename=GL_".date('YmdHis').".xlsx");
        ...
        <table width="100%">
            ...
            <tbody>
            	<?php
					...
					$QRYSTAT = "";
					if($GEJSTAT == 3)
						$QRYSTAT = "AND A.GEJ_STAT = 3";
					elseif($GEJSTAT == 9)
						$QRYSTAT = "AND A.GEJ_STAT = 9";
            		...
            		/*$s_00 	= "SELECT DISTINCT A.JournalH_Code, A.proj_Code, A.JournalH_Date, A.isLock, A.JournalType, B.CREATERNM AS Creater, B.Created
								...
								ORDER BY B.JournalH_Date, A.JournalH_Code ASC";*/
					$s_00 	= "SELECT DISTINCT A.JournalH_Code, A.proj_Code, A.JournalH_Date, A.isLock, A.JournalType, A.Creater, A.Created
								FROM tbl_journaldetail A
								WHERE A.JournalH_Date BETWEEN '$STARTD' AND '$ENDD'
								$QRYSTAT $QRYPRJACC
								GROUP BY A.JournalH_Code
								ORDER BY A.JournalH_Date, A.JournalH_Code ASC";
					...
					foreach($r_00 as $rw_00):
						...
						$PRJCODEVW2		= strtolower(preg_replace("/[^a-zA-Z0-9\s]/", "", $PRJCODE));
						$isLock			= $rw_00->isLock;
						...
						/*$s_01 			= "SELECT A.JournalD_Id, A.JournalH_Code, A.Manual_No, A.JournalH_Date, A.JournalType,
											...
											FROM tbl_journaldetail_$PRJCODEVW2 A
						...
						$s_01 			= "SELECT A.JournalD_Id, A.JournalH_Code, A.Manual_No, A.JournalH_Date, A.JournalType,
												...
												A.Acc_Id, A.Acc_Name, A.JournalD_Debet AS JournalD_Debet, A.JournalD_Kredit AS JournalD_Kredit, A.Creater, A.Proj_Code
											FROM tbl_journaldetail A
											WHERE  A.JournalH_Code = '$JournalH_Code'
												ORDER BY A.Base_Kredit";
						...
						foreach($r_01 as $rowJD):
							...
							if($AccNameId == '')
							{
								$sqlAccNm		= "SELECT Account_NameId, Account_NameEn FROM tbl_chartaccount_$PRJCODEVW2
