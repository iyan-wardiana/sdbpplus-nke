	...
	<div class="page">
		<section class="content">
	        <table width="100%" border="0" style="size:auto">
	            ...
	            <tr>
	                <td colspan="2" valign="top" class="style2" style="font-weight:bold; font-size:12px; border-bottom:groove;"><span class="style2" style="font-weight:bold; font-size:12px"><?php echo strtoupper($comp_name); ?></span></td>
	            </tr>
	            <tr>
					...
					<td colspan="3" class="style2" style="text-align:left; font-size:12px">
	              	<table width="100%" border="1" style="size:auto; font-size:12px;" rules="all">
	                	<tr style="font-weight:bold; text-align:center; background:#CCC; font-size:12px;">
	                        ...
	                        <td style="<?=$stlLine6?> text-align: center;" width="14%">RENCANA AWAL</td>
	                        <td style="<?=$stlLine6?> text-align: center;" width="10%" nowrap>PERIODE<br>SEBELUMNYA</td>
	                        <td style="<?=$stlLine6?> text-align: center;" width="4%" nowrap>%</td>
	                        <td style="<?=$stlLine6?> text-align: center;" width="13%" nowrap>BULAN INI</td>
	                        <td style="<?=$stlLine6?> text-align: center;" width="5%"> (%)</td>
	                        <td style="<?=$stlLine6?> text-align: center;" width="13%" nowrap>PROYEKSI (%)</td>
	                	</tr>
