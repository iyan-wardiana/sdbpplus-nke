				...
				<td colspan="3" class="style2" style="text-align:left; font-size:12px">
              	<table width="100%" border="1" style="size:auto; font-size:12px;">
                	...
                	<tr>
                	  ...
                	  <td style="text-align:right"><?php echo number_format($BPP_BAU_BEF, 0); ?></td>
                	  <td style="text-align:right"><?php echo number_format($BPP_BAU_BEFP, 2); ?></td>
                	  <td style="text-align:right"><?php echo number_format($BPP_BAU_REALC, 0); ?></td>
                	  <td style="text-align:right"><?php echo number_format($BPP_BAU_REALP, 2); ?></td>
                	  <td style="text-align:right">&nbsp;</td>
              	  	</tr>
                	<tr>
                	  <td>&nbsp;</td>
