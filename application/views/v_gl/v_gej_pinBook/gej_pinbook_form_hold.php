                        	...
                        	<div class="search-table-outter">
		                       	<table id="tbl" class="table table-bordered table-striped">
		                        	<tr style="background:#CCCCCC">
		                              	<th width="250" style="text-align:center"><?php echo $AccountNo; ?> </th>
		                              	<th style="text-align:center"><?php echo $Description; ?> </th>
		                              	<th width="80" style="text-align:center"><?php echo $AccountPosition; ?></th>
		                              	<th width="200" style="text-align:center"><?php echo $Amount; ?></th>
                                    ...
                                    if($task == 'edit')
                                    {
                                    	$s_00 	= "SELECT JournalH_Code, proj_Code, proj_CodeHO, PRJPERIOD, Acc_ID, Acc_Name, Notes, Base_Debet, Base_Kredit, Other_Desc, Journal_DK FROM tbl_journaldetail_pb
                                    	...
                                    	foreach($r_00 as $rw_00):
											...
											$proj_Code 		= $rw_00->proj_Code;
											$proj_CodeHO	= $rw_00->proj_CodeHO;
											$PRJPERIOD 		= $rw_00->PRJPERIOD;
                                    		// $AccId_D 		= $rw_00->Acc_ID;
                                    		// $AccD_Name 		= $rw_00->Acc_Name;
                                    		// $JrnD_Desc 		= $rw_00->Notes;
                                    		// $JrnD_Amoun		= $rw_00->Base_Debet;
                                    		// $OthD_Desc 		= $rw_00->Other_Desc;
											// $Journal_DK 	= $rw_00->Journal_DK;

											$Acc_ID 		= $rw_00->Acc_ID;
                                    		$Acc_Name 		= $rw_00->Acc_Name;
                                    		$Notes 			= $rw_00->Notes;
                                    		$Base_Debet		= $rw_00->Base_Debet;
											$Base_Kredit 	= $rw_00->Base_Kredit;
                                    		$Other_Desc 	= $rw_00->Other_Desc;
											$Journal_DK 	= $rw_00->Journal_DK;
											...
											?>
												<tr id="tr_<?php echo $currentRow; ?>">
													...
													<td style="text-align:left" nowrap>
														<input type="text" name="data[<?php echo $currentRow; ?>][JournalD_Desc]" id="data<?php echo $currentRow; ?>JournalD_Desc" value="<?php echo $Notes; ?>" class="form-control" style="max-width:500px;" placeholder="<?php echo $Description; ?>">
													</td>
                                    	...
                                    	/* ----------------------------- 
										$s_01 	= "SELECT Acc_ID, Acc_Name, Notes, Base_Kredit, Other_Desc, Journal_DK FROM tbl_journaldetail_pb
                                    ...
                                    else
                                    {
										...
										$LnRow 		= 2;
										for($currentRow=1;$currentRow<=$LnRow;$currentRow++) {
											...
											?>
												<tr id="tr_<?php echo $currentRow; ?>">
													...
													<td style="text-align:left" nowrap>
														<?php if($editable == 1) { ?>
															<input type="text" name="data[<?php echo $currentRow; ?>][Acc_Id]" id="data<?php echo $currentRow; ?>Acc_Id" value="" class="form-control" style="max-width:150px;" onClick="selectAccount(<?php echo $currentRow; ?>);" placeholder="<?php echo $SelectAccount; ?>" >
														<?php } else { ?>
															<?php echo $ITM_CODEV; ?>
															<?php echo $addVw1; ?>
													...
													<td style="text-align:left" nowrap>
														...
														<?php } else { ?>
															<?php echo $Notes; ?>
															<input type="hidden" name="data[<?php echo $currentRow; ?>][JournalD_Desc]" id="data<?php echo $currentRow; ?>JournalD_Desc" value="<?php echo $Notes; ?>" class="form-control" style="max-width:500px;" placeholder="<?php echo $Description; ?>">
														<?php } ?>
													</td>
													<td nowrap style="text-align:center" nowrap>
														<?php if($editable == 1) { ?>
									...
									<tr>
                                        <td style="text-align:left" nowrap>
                                        	<select name="AccId_1" id="AccId_1" class="form-control select2" onChange="chgAccCB(this.value)" style="width: 100%">
				                            	<option value=""> --- </option>
				                                <?php echo $i = 0;
					                                if($countAcc > 0)
					                                {
														foreach($vwAcc as $row) :
															...
															if($Account_Class == 2)
																$disable = 0;
															?>
																<option value="<?php echo $Account_Number; ?>" <?php if($disable == 1) { ?> style="color:#999" disabled <?php } else { ?> style="color:#00F; font-weight:bold" <?php } if($AccId_1 == $Account_Number) { ?> selected <?php } ?>>
                                        ...
                                        <td style="text-align:left" nowrap>
											<input type="text" class="form-control" id="Journal1_Desc" name="Journal1_Desc" value="<?=$Jrn1_Desc;?>">
										</td>
                                        <td style="text-align:center;" nowrap>
											<select name="Journal_DK1" id="Journal_DK1" class="form-control select2">
												<option value="" <?php if($Journal_DK1 == "") { ?> selected <?php } ?>>--</option>
												<option value="D" <?php if($Journal_DK1 == "D") { ?> selected <?php } ?>>D</option>
												<option value="K" <?php if($Journal_DK1 == "K") { ?> selected <?php } ?>>K</option>
											</select>
                                        </td>
										<td style="text-align:center" nowrap>
											<input type="hidden" class="form-control" style="text-align:right" name="Journal1_Amount" id="Journal1_Amount" value="<?=$Jrn1_Amoun;?>" placeholder="0.00">
                                        	<input type="text" class="form-control" style="text-align:right" name="Journal1_AmountV" id="Journal1_AmountV" value="<?php echo number_format($Jrn1_Amoun, 2);?>" placeholder="0.00" onBlur="chgAmountK(this)" onKeyPress="return isIntOnlyNew(event);">
										</td>
                                        <td style="text-align:left" nowrap>
											<input type="text" class="form-control" id="Other1_Desc" name="Other1_Desc" value="<?=$Oth1_Desc;?>">
										</td>
					          		</tr>
					          		<tr>
                                        <td style="text-align:left" nowrap>
                                        	<select name="AccId_2" id="AccId_2" class="form-control select2" style="width: 100%">
				                            	<option value=""> --- </option>
				                                <?php echo $i = 0;
					                                if($countAcc > 0)
					                                {
														foreach($vwAcc as $row) :
															...
															if($Account_Class == 2)
																$disable = 0;
															?>
																<option value="<?php echo $Account_Number; ?>" <?php if($disable == 1) { ?> style="color:#999" disabled <?php } else { ?> style="color:#00F; font-weight:bold" <?php } if($AccId_2 == $Account_Number) { ?> selected <?php } ?>>
																	<?php echo "$Account_Number &nbsp;&nbsp;$Account_Name"; ?>
																</option>
														 	<?php
														endforeach;
                                        ...
                                        <td style="text-align:left" nowrap>
											<input type="text" class="form-control" id="Journal2_Desc" name="Journal2_Desc" value="<?=$Jrn2_Desc;?>">
										</td>
                                        <td style="text-align:center;" nowrap>
											<select name="Journal_DK2" id="Journal_DK2" class="form-control select2">
												<option value="" <?php if($Journal_DK2 == "") { ?> selected <?php } ?>>--</option>
												<option value="D" <?php if($Journal_DK2 == "D") { ?> selected <?php } ?>>D</option>
												<option value="K" <?php if($Journal_DK2 == "K") { ?> selected <?php } ?>>K</option>
											</select>
                                        </td>
										<td style="text-align:center" nowrap>
                                        	<input type="hidden" class="form-control" style="text-align:right" name="Journal2_Amount" id="Journal2_Amount" value="<?=$Jrn2_Amoun;?>" placeholder="0.00">
                                        	<input type="text" class="form-control" style="text-align:right" name="Journal2_AmountV" id="Journal2_AmountV" value="<?php echo number_format($Jrn2_Amoun, 2);?>" placeholder="0.00" onBlur="chgAmountK(this)" onKeyPress="return isIntOnlyNew(event);">
										</td>
                                        <td style="text-align:left" nowrap>
											<input type="text" class="form-control" id="Other2_Desc" name="Other2_Desc" value="<?=$Oth2_Desc;?>">
										</td>
					          		</tr>
					                <script type="text/javascript">
