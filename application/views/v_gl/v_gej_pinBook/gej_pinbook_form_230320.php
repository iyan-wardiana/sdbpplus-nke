							...
							<div class="box box-primary">
								...
								<div class="box-body">
					            	...
					            	<div class="form-group">
					                    ...
					                    <div class="col-sm-4">
					                    	<input type="text" class="form-control" name="Manual_No1" id="Manual_No1" size="30" value="<?php echo $Manual_No; ?>" onblur="chgManualNo(this.value)" />
										...
										<div class="col-sm-5">
											<input type="checkbox" id="stopAutoCode" title="stop auto number" onchange="stopAuto_Code()">
										</div>
					                </div>
					            	<div class="form-group">
