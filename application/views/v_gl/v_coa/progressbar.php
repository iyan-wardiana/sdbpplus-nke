...
*/
	...
	if($resCountCOA == 0)
	{
		if(isset($_POST['COAH_CODEX']))	// MARKETING
		{
			...
			$rata2a		= $rata2 * 5;				// TOTAL VALUE PER LOOP
			$rata2b		= intval($rata2 * 5);				// TOTAL LOOP = 20
			$totLoop 	= intval($baris / $rata2a);	// TOTAL LOOP = 20
			$fLoop 		= 0;
			$totRow		= 0;
			...
			for ($i=2; $i <= $baris; $i++)
			{
				...
				$modRow	= $totRow % $rata2b;
				if($modRow == 0)
				{
					$fLoop = $fLoop + 1;
					//echo '<script type="text/javascript">showBarx('.$fLoop.');</script>';
				...
				//echo '<script type="text/javascript">alert('.$rata2.')</script>';
			...
			//echo '<script type="text/javascript">showBarx('.$modRow.')</script>';
			/*echo '<script type="text/javascript">
				document.getElementById("progressbarXX").innerHTML="<div style="width: 50%; background:linear-gradient(to bottom, rgba(125,126,125,1) 0%,rgba(14,14,14,1) 100%); ;height:35px;">&nbsp;</div>";
			</script>';*/
			echo '<script type="text/javascript">
					document.getElementById("progressbarXX").innerHTML="<div style=\'width: 50%; background:linear-gradient(to bottom, rgba(125,126,125,1) 0%,rgba(14,14,14,1) 100%); height:35px;\'>&nbsp;</div>";
			</script>';
