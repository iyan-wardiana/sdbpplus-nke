	...
	if($IMP_TYPE == 'COA')
	{
		...
		if($resCountCOA == 0)
		{
			...
			echo '<script>
			    ...
			    parent.document.getElementById("loading_2").style.display ="none";</script>';
				...
				<div class="panel-body">
					...
					<form method="post" id="sample_form">
						...
						<div class="form-group">
							...
							<input type="text" name="COAH_CODEX" id="COAH_CODEX" class="form-control" value="" />
						</div>
						<div class="form-group">
							<label>TIPE</label>
