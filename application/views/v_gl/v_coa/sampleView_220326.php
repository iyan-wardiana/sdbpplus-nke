	...
	else if($IMP_TYPE == 'RENDERDATA')
	{
		...
		else if($REN_GROUP == 'PR')
		{
			...
			// START : RENDER PROCEDUR - RENDER RPB
				...
				$s_01	= "SELECT nomor, tanggal, user_i, proyek, kodepek, namapek, CONCAT(namapek, ' ', uraian) AS rpb_desc,
								tgl_pakai, tgl_i, no_minta, vol_kirim, volrpb, harga, status_trma
				...
				foreach($r_01 as $rw_01) :
					...
					$vol_kirim_01 	= $rw_01->vol_kirim;
					$volrpb_01 		= $rw_01->volrpb;
					$harga_01 		= $rw_01->harga;
					$spp_value_01	= $volrpb_01*$harga_01;
					$status_trma_01	= $rw_01->status_trma;			// 1 DiPO sebagian, 2. Close
					...
					// START : INSERT HEADER
						$s_ins1 	= "INSERT INTO tbl_pr_header (PR_NUM, PR_CODE, PR_DATE, PR_RECEIPTD, PRJCODE, DEPCODE,
											PR_REQUESTER, PR_NOTE, PR_PLAN_IR, PR_STAT, STATDESC, STATCOL,
											PR_VALUE, PR_CREATER, PR_CREATED, PR_REFNO, PR_ISCLOSE, STATDESC, STATCOL)
										VALUES ('$nomor_01', '$nomor_01', '$tanggal_01', '$tgl_pakai_01', '$PRJCODE', 'D.IMP',
											'$user_i_01', '$rpb_desc_01', '$tgl_pakai_01', '$PR_STAT', '$STATDESC', '$STATCOL',
											$spp_value_01', '$user_i_01', '$tgl_i_01', '$no_minta', 0, 'Approved', 'success')";
						$this->db->query($s_ins1);
					// END : INSERT HEADER

					// START : INSERT DETAIL
						$ord_02	= 0;
						$s_02	= "SELECT nomor, tanggal, user_i, proyek, kode, kodepek, namapek, CONCAT(namapek, ' ', uraian) AS rpb_desc,
									tgl_pakai, tgl_i, no_minta, vol_kirim, volrpb, harga, vol_po
									FROM rpb WHERE proyek = '$proyek_01' AND hr = 0 AND nomor = '$nomor_01' ORDER BY id";
						$r_02 	= $this->db->query($s_02)->result();
						foreach($r_02 as $rw_02) :
							$ord_02 		= $ord_02+1;
