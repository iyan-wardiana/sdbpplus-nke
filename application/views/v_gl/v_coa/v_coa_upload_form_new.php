			...
			<div class="row">
							...
							<form name="myformupload" id="myformupload" class="form-horizontal" enctype="multipart/form-data" method="post" action="<?php echo $form_action; ?>" onSubmit="return chcekFile();" >
								<div class="box-body">
					                <div class="form-group">
					                  	<label for="exampleInputEmail1"><?php echo $ChooseFile; ?></label>
					                ...
					                <div class="form-group">
					                  	...
					                  	<textarea class="form-control" name="COAH_DESC" id="COAH_DESC" style="height:70px" placeholder="Deskripsi / Keterangan Tambahan"></textarea>
					                </div>
			                        <div class="form-group">
				...
				<div class="col-md-4">
					<div class="box box-warning">
				        ...
				        <!-- <div id="progress" title="Import Progress">
							<div class="progress-label">Starting download...</div>
							<div id="progressbar" style="display: none;"></div>
							<div class="progress">
				                <div class="progress-bar progress-bar-success" id="progressbarx" role="progressbar" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100">
				                </div>
			              	</div>
						</div> -->
					</div>
				...
				<div class="col-md-4">
					<div class="box box-success">
						<div class="box-header with-border">
							...
							<h3 class="box-title">Progres Import</h3>
						</div>
						<div class="box-body">
							fsf
						</div>
		...
		.then((willDelete) => {
			if (willDelete) 
			{
				...
				.then((value) => {
					...
					/*var elem = document.getElementById("progressbarx");
				    var progressTimer,
					...
					progressbar.progressbar({
						...
						change: function() 
						{
							...
							elem.style.width = + progressbar.progressbar( "value" ) + "%";
						},
						complete: function() {
