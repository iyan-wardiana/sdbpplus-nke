...
$sqlJH      = "SELECT DISTINCT A.JournalH_Code, B.Manual_No, B.JournalH_Date, B.JournalH_Desc, A.Acc_Id, C.Account_NameId,
                ...
                FROM
                    tbl_journaldetail_$PRJCODEVW A
          ...
          <td colspan="11" class="style2">
              <table width="100%" border="1" rules="all">
                    ...
                    <?php
                        ...
                        $i          = 0;
                        $totAmount  = 0;
                        $sqlq2      = "SELECT A.Acc_Id, A.proj_Code, A.Base_Kredit, A.JournalD_Debet,
                                            A.JournalD_Kredit, A.isDirect, A.Notes, A.ITM_CODE,
                                            A.Ref_Number, A.Other_Desc, A.Journal_DK, A.isTax, B.Account_NameEn, C.JournalH_Desc
                                        FROM tbl_journaldetail_$PRJCODEVW A
                                            INNER JOIN tbl_chartaccount_$PRJCODEVW B ON A.Acc_Id = B.Account_Number
