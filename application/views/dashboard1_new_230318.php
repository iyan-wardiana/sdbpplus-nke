...
<html>
	...
	<?php
        ...
        $s_PROGPRJ		= "SELECT B.Prg_Date1, B.Prg_Plan, B.Prg_PlanAkum, A.PRJP_DATE, A.PRJP_GTOT, A.PRJP_PERC_PI
        ...
        foreach($r_PROGPRJ as $rw_PROGPRJ):
            ...
            $PROG_REAL_V 	= $PROG_REAL_K * $PRJCOSTX / 100;
        endforeach;
	?>
	<body class="<?php echo $appBody; ?>" onLoad="taskNotifApp();taskNotif();">
		...
		<section class="content">
			...
			<!-- START 	: PROJECT INFORMATION AND REALISATION -->
				<div class="row">
	                <div class="col-xs-8" style="padding-right: 2px;">
				        <div class="box box-info">
							<div class="box-body no-padding">
					            <div class="box-header with-border" style="text-align: center;">
					              	<h3 class="box-title"><?php echo $PRJNAMEX; ?></h3>
					            </div>
					            <div class="row">
									<div class="col-md-10 col-sm-10 box1">
										<div class="nav-tabs-custom">
						                    <div class="chart" id="line-chart" style="min-width: 310px; height: 380px; margin: 0 auto"></div>
										</div>
									</div>
									<div class="col-md-2 col-sm-2 box2">
										<div class="pad box-pane-right bg-green-gradient" style="height: 380px;">
											<div class="description-block margin-bottom">
												<span class="description-text">Progres Proyek</span>
											</div>
											<div class="description-block margin-bottom">
												<div class="sparkbar" data-color="#fff">90,70,90,70,75,80,70</div>
												<span class="description-header" style="font-size: 25px"><?php echo number_format($PROG_REAL_K,2); ?>%</span>
												<span class="description-text">Realisasi</span>
											</div>

											<div class="description-block margin-bottom">
												<div class="sparkbar" data-color="#fff">90,50,90,70,61,83,63</div>
												<span class="description-header" style="font-size: 25px"><?php echo number_format($PROG_PLAN_K,2); ?>%</span>
											...
											<div class="description-block">
												...
												<span class="description-header" style="font-size: 25px"><?php echo number_format($PROG_REAL_DEV,2); ?>%</span>
						...
						<div class="box box-warning">
							...
							<div class="box-body no-padding" style="padding-bottom: 1px;">
								<div class="row">
									...
									<div class="col-md-6">
										<ul class="chart-legend clearfix">
											<li><i class="fa fa-circle-o text-red"></i>
												<span> M</span> <span class="pull-right" title="<?="dari ".number_format($M_PLANP,2)." (".number_format($M_REALP,2)."%)"?>"><?=number_format($M_REAL)." (".number_format($M_REALP,1)."%)";?></span>
											</li>
											<li><i class="fa fa-circle-o text-green"></i>
												<span> U</span> <span class="pull-right" title="<?="dari ".number_format($U_PLANP,2)." (".number_format($U_REALP,2)."%)"?>"><?=number_format($U_REAL)." (".number_format($U_REALP,1)."%)";?></span>
											</li>
											<li><i class="fa fa-circle-o text-yellow"></i>
												<span> S</span> <span class="pull-right" title="<?="dari ".number_format($S_PLANP,2)." (".number_format($S_REALP,2)."%)"?>"><?=number_format($S_REAL)." (".number_format($S_REALP,1)."%)";?></span>
											</li>
											<li><i class="fa fa-circle-o text-aqua"></i> 
												<span> T</span> <span class="pull-right" title="<?="dari ".number_format($T_PLANP,2)." (".number_format($T_REALP,2)."%)"?>"><?=number_format($T_REAL)." (".number_format($T_REALP,1)."%)";?></span>
											</li>
											...
											<li><i class="fa fa-circle-o text-light-blue"></i>
												<span> O</span> <span class="pull-right" title="<?="dari ".number_format($O_PLANP,2)." (".number_format($O_REALP,2)."%)"?>"><?=number_format($O_REAL)." (".number_format($O_REALP,1)."%)";?></span>
											</li>
										</ul>
									</div>
					                ...
					                <div class="col-md-4 col-sm-6 col-xs-12" style="padding-right: 4px">
										<div class="small-box bg-teal-gradient">
											<div class="inner">
												<h3 style="font-size: 25px"><?php echo number_format($TOT_PROG,2,",","."); ?>%</h3>
												<p>Terbayar</p>
											</div>
					                ...
					                <div class="col-md-8 col-sm-6 col-xs-12" style="padding-left: 2px">
										<div class="small-box bg-teal-gradient">
											<div class="inner">
												<h3 style="font-size: 25px"><?php echo number_format($MC_PROGAPP,2,",","."); ?></h3>
												<p>Nilai Terbayar</p>
											</div>
											<div class="icon">
	      ...
	      data: [<?php
					...
					foreach($ressqla as $rowa) :
						...
						foreach($ressql0 as $row0) :
							...
							{
								?>
									{y: "<?=$Prg_Step?>", item1: <?=$Prg_PlanAkum.$totFix1?>, item2: <?=$Prg_RealAkum.$totFix2?>},
								<?php
							}
						endforeach;
					endforeach;
