...
<html class="lockscreen">
    <head>
        ...
        <?php
            $sqlcss = "SELECT cssjs_lnk FROM tbl_cssjs WHERE cssjs_typ = 'css' AND isAct = 99";
            ...
            endforeach;
        ?>
        <link href="<?php echo base_url(). 'assets/css/bootstrap4.1.1/bootstrap.min.css' ?>" rel="stylesheet" id="bootstrap-css">
