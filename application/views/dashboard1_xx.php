<?php
    ...
    // SET PROJECT
		...
		else
		{
			...
			$PRJCODEX 	= 
			$PRJNAMEX 	= $selPRJCODE;
			$sqlPRJ   	= "SELECT PRJNAME, PRJCOST, PRJDATE, PRJEDAT FROM tbl_project WHERE PRJCODE = $myPRJCODE";
						...
						<div class="box-body no-padding">
							<div class="row">
								<div class="col-md-8 col-sm-8">
									<div id="world-map-markers" style="height: 325px;"><img src="<?php echo base_url() . 'assets/AdminLTE-2.0.5/dist/img/projects/nke_0001.png'; ?>"></div>
								</div>
								<div class="col-md-4 col-sm-4">
									<div class="pad box-pane-right bg-green" style="min-height: 280px">
										<div class="description-block margin-bottom">
											<span class="description-text">RAB (Rp)</span>
											<h5 class="description-header"><?=number_format($TOT_BOQ)?></h5>
										</div>
										<div class="description-block margin-bottom">
											<span class="description-text">ADD. (Rp)</span>
											<h5 class="description-header"><?=number_format($TOT_ADD)?></h5>
										</div>
										<div class="description-block margin-bottom">
											<span class="description-text">RAP</span>
											<h5 class="description-header"><?=number_format($TOT_RAP)."<br>(".number_format($TOT_RAPP,2)."%)"?></h5>
										</div>
										<div class="description-block margin-bottom">
