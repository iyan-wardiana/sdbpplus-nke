	...
	<body class="<?php echo $appBody; ?>" onLoad="StartTimers();" onmousemove="ResetTimers();">
		...
		<section class="content">
			...
			<?php
				...
				$s_PROFLOST	= "SELECT SUM(BPP_MTR_PLAN) AS MTR_PLAN, SUM(BPP_UPH_PLAN) AS UPH_PLAN, SUM(BPP_SUBK_PLAN) AS SUBK_PLAN, SUM(BPP_ALAT_PLAN) AS ALAT_PLAN,
									SUM(BPP_I_PLAN) AS I_PLAN, SUM(BPP_BAU_PLAN) AS BAU_PLAN, SUM(BPP_OTH_PLAN) AS OTH_PLAN,
									SUM(BPP_MTR_REAL) AS MTR_REAL, SUM(BPP_UPH_REAL) AS UPH_REAL, SUM(BPP_SUBK_REAL) AS SUBK_REAL, SUM(BPP_ALAT_REAL) AS ALAT_REAL,
								...
								<div class="row" style="display: none;">
					                <div class="col-md-6 col-sm-6 col-xs-12">
										<div class="small-box bg-yellow-gradient">
											...
											<div class="icon">
												<i class="fa fa-cubes" style="font-size: 0.50em;"></i>
											</div>
										</div>
									</div>
					                <div class="col-md-6 col-sm-6 col-xs-12">
										<div class="small-box bg-green-gradient">
											...
											<div class="icon">
												<i class="fa fa-pied-piper-alt" style="font-size: 0.50em;"></i>
											</div>
										</div>
									</div>
					                <div class="col-md-6 col-sm-6 col-xs-12">
										<div class="small-box bg-red-gradient">
											...
											<div class="icon">
												<i class="fa fa-users" style="font-size: 0.50em;"></i>
											</div>
										</div>
									</div>
					                <div class="col-md-6 col-sm-6 col-xs-12">
										<div class="small-box bg-aqua-gradient">
											...
											<div class="icon">
												<i class="ion ion-planet" style="font-size: 0.50em;"></i>
											</div>
										</div>
									</div>
					                <div class="col-md-6 col-sm-6 col-xs-12">
												...
												<div class="row">
									                <div class="col-md-6 col-sm-6 col-xs-12">	<!-- yellow -->
									                  	<div class="progress-group">
										                    <span class="progress-text">Material</span>
										                    <span class="progress-number"><b><?=number_format($MTR_REAL)?></b></span>

										                    <div class="progress sm">
										                      <div class="progress-bar progress-bar-yellow" style="width: <?=$MTR_REALP?>%" title="<?="dari ".number_format($MTR_PLANP,2)." (".number_format($MTR_REALP,2)."%)"?>"></div>
										                    </div>
									                  	</div>
													</div>
									                <div class="col-md-6 col-sm-6 col-xs-12">	<!-- green -->
									                  	<div class="progress-group">
										                    <span class="progress-text">Upah</span>
										                    <span class="progress-number"><?=number_format($UPH_REAL)?></span>

										                    <div class="progress sm">
										                      <div class="progress-bar progress-bar-green" style="width: <?=$UPH_REALP?>%" title="<?="dari ".number_format($UPH_PLANP,2)." (".number_format($UPH_REALP,2)."%)"?>"></div>
										                    </div>
									                  	</div>
													</div>
									                <div class="col-md-6 col-sm-6 col-xs-12">	<!-- red -->
									                  	<div class="progress-group">
										                    <span class="progress-text">Subkon</span>
										                    <span class="progress-number"><?=number_format($SUB_REAL)?></span>

										                    <div class="progress sm">
										                      <div class="progress-bar progress-bar-red" style="width: <?=$SUB_REALP?>%" title="<?="dari ".number_format($SUB_PLANP,2)." (".number_format($SUB_REALP,2)."%)"?>"></div>
										                    </div>
									                  	</div>
													</div>
									                <div class="col-md-6 col-sm-6 col-xs-12">	<!-- aqua -->
									                  	<div class="progress-group">
										                    <span class="progress-text">Alat</span>
										                    <span class="progress-number"><?=number_format($ALT_REAL)?></span>

										                    <div class="progress sm">
										                      <div class="progress-bar progress-bar-aqua" style="width: <?=$ALT_REALP?>%" title="<?="dari ".number_format($ALT_PLANP,2)." (".number_format($ALT_REALP,2)."%)"?>"></div>
										                    </div>
									                  	</div>
													</div>
									                <div class="col-md-6 col-sm-6 col-xs-12">	<!-- warning -->
									                  	<div class="progress-group">
										                    <span class="progress-text">Lain-Lain</span>
										                    <span class="progress-number"><?=number_format($I_REAL)?></span>

										                    <div class="progress sm">
										                      	<div class="progress-bar progress-bar-warning" style="width: <?=$I_REALP?>%" title="<?="dari ".number_format($I_PLANP,2)." (".number_format($I_REALP,2)."%)"?>"></div>
										                    </div>
									                  	</div>
													</div>
									                <div class="col-md-6 col-sm-6 col-xs-12">	<!-- blue -->
									                  	<div class="progress-group">
										                    <span class="progress-text">Ovh.</span>
										                    <span class="progress-number"><?=number_format($OVH_REAL)?></span>

										                    <div class="progress sm">
										                      	<div class="progress-bar progress-bar-blue" style="width: <?=$OVH_REALP?>%" title="<?="dari ".number_format($OVH_PLANP,2)." (".number_format($OVH_REALP,2)."%)"?>"></div>
										                    </div>
									                  	</div>
													</div>
