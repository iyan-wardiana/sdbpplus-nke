		                                        ...
		                                        <div class="form-group">
		                                        	<form method="post" name="frmSearch" action="">
			                                            <table id="example1" class="table table-bordered table-striped table-responsive search-table inner" width="100%">
			                                                ...
			                                                <tr>
			                                                  	<td colspan="7" nowrap>
			                                                  		<input type="text" name="rowCheck" id="rowCheck" value="">
...
<script>
	...
	$(document).ready(function()
	{
    	$('#example1').DataTable(
    	{
			...
			"autoWidth": true,
			"filter": true,
	        "ajax": "<?php echo site_url('c_finance/c_cpa70d18/get_AllDataITM/?id='.$collData)?>",
	        "type": "POST",
	...
	$(document).ready(function()
	{
	   	$("#btnDetail1").click(function()
	    {
		    ...
		    $.each($("input[name='chk1']:checked"), function()
		    {
		      	window.opener.add_item($(this).val());
		    });
		    window.close();
	    });
	});
