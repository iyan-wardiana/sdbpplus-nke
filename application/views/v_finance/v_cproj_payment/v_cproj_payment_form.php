...
/* 
	...
	* Create Date	= 19 Agustus 2018
	* File Name	= v_cho_payment_form.php
	* Location		= -
*/
    ...
    <body class="<?php echo $appBody; ?>" style="background-color: <?=$comp_color?>">
		...
		<section class="content">
	        <form class="form-horizontal" name="frm" method="post" action="<?php echo $form_action; ?>" enctype="multipart/form-data" onSubmit="return validateInData()">
	            ...
	            <input type="hidden" name="JournalType" id="JournalType" value="CPRJ" />
                        ...
                        <div class="box box-success">
                            ...
                            <div class="box-body">
				            	...
				            	<div class="form-group">
				                    ...
				                    <div class="col-sm-4">
				                    	<select name="ISPERSL" id="ISPERSL" class="form-control select2" onChange="chgCat(this.value)">
				                          	<option value="0" <?php if($ISPERSL == 0) { ?> selected <?php } ?>> --- </option>
	                            	...
	                            	if($resCAPPH > 0)
				                	{
						                ...
						                <div class="form-group">
			                            	...
			                            	<div class="col-sm-4">
				                        		...
				                        		<input type="text" class="form-control" style="text-align:right" name="Journal_AmountX" id="Journal_AmountX" value="<?php echo number_format($Journal_Amount, 2); ?>" title="Total Jurnal" readonly />
			                            	</div>
			                            	<div class="col-sm-4">
							                    <label for="inputName">&nbsp;</label>
			                            		<?php
