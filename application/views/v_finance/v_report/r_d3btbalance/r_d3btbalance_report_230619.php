                ...
                <table width="100%" border="1" cellpadding="0" cellspacing="0">
					<thead>
						<tr>	
							...
							<th>Supplier</th>
							<th width="120">Kode LPM/OPN</th>
							<th width="120">Jumlah LPM/OPN</th>
					...
					<tbody>
						...
						// get PRJ & SPL
							...
							$s_HUTSPL 		= "SELECT A.IR_NUM AS DOC_NUM, A.IR_CODE AS DOC_CODE, A.PRJCODE, A.SPLCODE, A.IR_NOTE AS DOC_NOTES, A.IR_AMOUNT_NETT AS DOC_AMN, 
												...
												FROM tbl_ir_header A WHERE A.IR_STAT IN (3,6) $ADDQRYSPL
												UNION
												...
												A.TTK_CODE, A.TTK_DATE, A.INV_CODE, A.INV_DATE, A.BP_CODE, A.BP_DATE 
												FROM tbl_opn_header A WHERE A.OPNH_STAT IN (3,6) $ADDQRYSPL";
								...
								foreach($res_HUTSPL->result() as $rHUTSPL):
									...
									?>
										<tr>
											...
											<td style="text-align: center;"><?php echo number_format($DOC_AMN, 2);?></td>
