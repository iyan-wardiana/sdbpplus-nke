...
// $getSupplier  	= "SELECT SPLCODE, SPLDESC FROM tbl_supplier WHERE SPLSTAT = 1 AND SPLCODE IN (SELECT SPLCODE FROM tbl_ir_header WHERE IR_STAT IN (3,6) UNION SELECT SPLCODE FROM tbl_opn_header WHERE OPNH_STAT IN (3,6))";
$getSupplier  	= "SELECT SPLCODE, SPLDESC FROM tbl_supplier WHERE SPLSTAT = 1";
