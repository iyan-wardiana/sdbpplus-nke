        ...
        <div class="cont">
            <div class="box-header">
                ...
                <div class="box-column-title">
                    <span><?php echo "LAPORAN REALISASI PINJAMAN DINAS"; ?></span>
            ...
            <div class="box-detail">
                ...
                <table width="100%" border="1" cellpadding="0" cellspacing="0">
                    ...
                    <tbody>
                        <tr>
                            <td colspan="12" style="line-height: 1px; border-left: hidden; border-right: hidden;">&nbsp;</td>
                        </tr>
                        <?php
                            if($SPLCODE[0] == 'All')
                            {
                            ...
                            $get_OUTPD      = "SELECT * FROM tbl_journalheader_pd
                                                WHERE proj_Code = '$PRJCODE' AND GEJ_STAT IN (3,6) $addQSPL 
                                                AND ((Journal_AmountReal + PPNH_Amount - PPHH_Amount) > 0 OR isManualClose = 1) 
                                                AND JournalH_Date BETWEEN '$Start_Date' AND '$End_Date'";
                            ...
                            else
                            {
                                ?>
                                    <tr>
                                        <td colspan="12" style="font-family: italic; text-align: center;">No data available</td>
                                    </tr>
                                <?php
                            }
                        ?>
