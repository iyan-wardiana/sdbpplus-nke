        ...
        <div class="cont">
            <div class="box-header">
                ...
                <div class="box-column-title">
                    <span><?php echo "LAPORAN PINJAMAN DINAS"; ?></span>
                ...
                <table width="100%" border="1" cellpadding="0" cellspacing="0">
                    <thead>
                        <tr>
                            ...
                            <th width="100" rowspan="2" style="display: none;">PROYEK</th>
                            ...
                            <th width="150" rowspan="2">CATATAN</th>
                        </tr>
                        <tr>
                    ...
                    <tbody>
                        <tr>
                            <td colspan="17" style="line-height: 1px; border-left: hidden; border-right: hidden;">&nbsp;</td>
                        </tr>
                        <?php
                            if($SPLCODE[0] == 'All')
                            {
                            ...
                            $get_OUTPD      = "SELECT * FROM tbl_journalheader_pd
                                                WHERE proj_Code = '$PRJCODE' AND GEJ_STAT IN (3,6) $addQSPL AND JournalH_Date BETWEEN '$Start_Date' AND '$End_Date'";
                            ...
                            if($res_OUTPD->num_rows() > 0)
                            {
                                ...
                                foreach($res_OUTPD->result() as $rOPD):
                                    ...
                                    // Outstanding PD :
                                        ...
                                        if($isManualClose == 2)
                                        {
                                            $TOT_REALZ      = $TOT_OUTCURR;
                                            $TOT_REALZDESC  = "Close Manual";
                                            $TOT_OUTCURR    = 0;
                                        }
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td style="display: none;"><?php echo "$PRJCODE - $PRJNAME"; ?></td>
                                            ...
                                            <td style="text-align: right;">
                                                <?php echo number_format($TOT_REALZ, 2); ?>
                                                <span style="font-style: italic; color: red"><?php echo $TOT_REALZDESC; ?></span>
                                            </td>
                                            <td style="text-align: center;"><?php echo $selisihRV; ?></td>
                            ...
                            else
                            {
                                ?>
                                    <tr>
                                        <td colspan="17" style="font-family: italic; text-align: center;">No data available</td>
                                    </tr>
                                <?php
                            }
                        ?>
