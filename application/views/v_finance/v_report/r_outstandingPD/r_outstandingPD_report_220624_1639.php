                        ...
                        <?php
                            ...
                            if($res_OUTPD->num_rows() > 0)
                            {
                                ...
                                foreach($res_OUTPD->result() as $rOPD):
                                    ...
                                    if($Journal_Amount > $TOT_REALZ) // Lebih Bayar
                                    {
                                        $TOT_CLOSED = $TOT_REALZ + $PPD_RemAmount;
                                        if($TOT_REALZ == 0)
                                        {
                                            if($isManualClose == 1) $TOT_CLOSED = $Journal_Amount;
                                        }
                                    }
                                    elseif($Journal_Amount < $TOT_REALZ) // Kurang Bayar
                                    {
                                        $TOT_CLOSED = $TOT_REALZ - $PPD_RemAmount;
                                    }
                                    elseif($Journal_Amount == $TOT_REALZ)
                                    {
                                        $TOT_CLOSED = $Journal_Amount;
                                    }
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td style="text-align: right;"><?php echo number_format($TOT_CLOSED, 2); ?></td>
