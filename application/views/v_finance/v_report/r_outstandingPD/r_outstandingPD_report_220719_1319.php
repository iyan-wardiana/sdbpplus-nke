                ...
                <table width="100%" border="1" cellpadding="0" cellspacing="0">
                    <thead>
                        <tr>
                            ...
                            <th width="70" rowspan="2">TOTAL OUTSTANDING DAN CURRENT</th>
                        </tr>
                        <tr>
                    ...
                    <tbody>
                        <tr>
                            <td colspan="16" style="line-height: 1px; border-left: hidden; border-right: hidden;">&nbsp;</td>
                        </tr>
                        <?php
                            if($SPLCODE[0] == 'All')
                            {
                            ...
                            $get_OUTPD      = "SELECT JournalH_Code, JournalType, JournalH_Desc, 
                                                JournalH_Date, PD_Date, JournalH_Date_PD, PlanRDate, Reference_Number, ISPERSL, PERSL_EMPID, PERSL_STAT, acc_number, proj_Code, Journal_Amount, Journal_AmountReal, PPNH_Amount, PPHH_Amount, PDPaid_Amount, GJournal_Total, Manual_No, REF_CODE, SPLCODE, SPLDESC, GEJ_STAT, GEJ_STAT_PD, GEJ_STAT_PPD, STATDESC 
                                                FROM tbl_journalheader_pd
                                                WHERE proj_Code = '$PRJCODE' AND GEJ_STAT IN (1,2,3,4,6) $addQSPL AND PD_Date BETWEEN '$Start_Date' AND '$End_Date'";
                            ...
                            if($res_OUTPD->num_rows() > 0)
                            {
                                ...
                                foreach($res_OUTPD->result() as $rOPD):
                                    ...
                                    // Outstanding PD :
                                        $PlanRDateX     = date('Y-m-d', strtotime($PlanRDate));
                                        ...
                                        else
                                        {
                                            ...
                                            if($Journal_Amount != $TOT_REALZ)
                                            {
                                                $PD_Date    = new DateTime($PlanRDateX);
                                                $currDate   = new DateTime($current_Date);
                                                $selisihC   = $currDate->diff($PD_Date);
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td style="text-align: right;"><?php echo number_format($CURR_AMOUNT, 2); ?></td>
                                            <td style="text-align: center;"><?=$JournalH_Date_PDV?></td>
                                            <td style="text-align: right;"><?php echo number_format($TOT_REALZ, 2); ?></td>
                                            <td style="text-align: right;"><?php echo number_format($TOT_OUTCURR, 2); ?></td>
                                        </tr>
                                    <?php
                                endforeach;
                                ?>
                            ...
                            else
                            {
                                ?>
                                    <tr>
                                        <td colspan="16" style="font-family: italic; text-align: center;">No data available</td>
                                    </tr>
                                <?php
                            }
                        ?>
