...
$getDTRX      = "SELECT DATEDIFF(NOW(),DP_DATE) AS DateTRX
                    FROM tbl_dp_header ORDER BY DP_DATE ASC LIMIT 1";
                ...
                <div class="box-body chart-responsive">
                	<form class="form-horizontal" method="post" name="frm" id="frm" action="<?php echo $form_action; ?>" onSubmit="return target_popup(this);" >
                      	...
                      	<div class="form-group">
                            ...
                            <div class="col-sm-10">
                              	<select name="SPLCODE" id="SPLCODE" class="form-control select2" data-placeholder="&nbsp;<?php echo $Splnm; ?>" >
                                    <option value="" ></option>
