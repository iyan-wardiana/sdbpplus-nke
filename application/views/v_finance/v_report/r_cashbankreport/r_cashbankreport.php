		    ...
		    <div class="box box-primary">
                <div class="box-body chart-responsive">
                	<form class="form-horizontal" method="post" name="frm" id="frm" action="<?php echo $form_action; ?>" onSubmit="return target_popup(this);" >
                            ...
                            <div class="col-sm-10">
                            	<select name="selAccount[]" id="selAccount" class="form-control select2" data-placeholder="&nbsp;<?php echo $AccountName; ?>" >
									<option value="0" > --- </option>
	        						<?php
                      	...
                      	<div class="form-group">
                            <label for="inputName" class="col-sm-2 control-label">s.d. Tanggal</label>
                            <div class="col-sm-10">
                              	<div class="input-group date">
                                	<div class="input-group-addon"><i class="fa fa-calendar"></i></div>
