...
<section class="content">
    ...
    <tr>
        ...
        <td colspan="2" class="style2" style="text-align:center; font-weight:bold; font-size:18px"><?php echo $h1_title; ?> <br>
          <span class="style2" style="text-align:center; font-weight:bold; font-size:12px">PT. MEGA SUKMA</span>
          </td>
  </tr>
    <tr>
      ...
      <td colspan="3" class="style2" style="text-align:left; font-style:italic">
      	<table width="100%" border="0" style="size:auto">
        	<tr>
                ...
                <td width="1%">:</td>
                <td width="88%">25 FEBRUARI - 10 MARET 2018</td>
            </tr>
        </table>
      </td>
    </tr>
        ...
        <td colspan="3" class="style2">
            <table width="100%" border="1" rules="all">
                <tr style="background:#CCCCCC">
                  ...
                  <td width="22%" rowspan="2" nowrap style="text-align:center; font-weight:bold">Uraian</td>
                  <td width="17%" rowspan="2" nowrap style="text-align:center; font-weight:bold">Nama Suplier /Subkont/Mandor <br>yang dibayar</td>
                  <td width="10%" rowspan="2" nowrap style="text-align:center; font-weight:bold">No SPK/PO</td>
                  <td width="11%" rowspan="2" nowrap style="text-align:center; font-weight:bold">Tanggal Cair<br>(Tertera dalam cek)</td>
                  <td width="8%" rowspan="2" nowrap style="text-align:center; font-weight:bold">Nilai Tagihan<br>Rp.</td>
                  <td colspan="3" nowrap style="text-align:center; font-weight:bold"> Realisasi Pencairan Cek</td>
                  <td width="9%" rowspan="2" nowrap style="text-align:center; font-weight:bold">Keterangan</td>
              </tr>
                <tr style="background:#CCCCCC">
                  <td width="6%" nowrap style="text-align:center; font-weight:bold">Nilai Cek  Rp.</td>
                  <td width="6%" nowrap style="text-align:center; font-weight:bold">Tanggal Cair</td>
                  <td width="4%" nowrap style="text-align:center; font-weight:bold">Nomor cek /giro</td>
                </tr>
                <?php
					...
					if($CFType == 1) // 1. Detail, 2. Sumamry
					{
						...
						{
								$sql0 		= "tbl_pinv_header WHERE PRJCODE IN ($PRJCODECOL) AND INV_DATE <= '$End_Date' AND INV_PAYSTAT IN ('NP', 'HP')";
								$sql1 		= "SELECT * FROM tbl_pinv_header WHERE PRJCODE IN ($PRJCODECOL) AND INV_DATE <= '$End_Date' AND INV_PAYSTAT IN ('NP', 'HP')";
						}
						else				// ALL PROJECT
						{
								$sql0 		= "tbl_pinv_header WHERE AND INV_DATE <= '$End_Date' AND INV_PAYSTAT IN ('NP', 'HP')";
								$sql1 		= "SELECT * FROM tbl_pinv_header WHERE INV_DATE <= '$End_Date' AND INV_PAYSTAT IN ('NP', 'HP')";
						}
						...
						if($res0 > 0)
						{
							foreach($res1 as $rowsql1) :
								...
								$INV_PAYSTAT	= $rowsql1->INV_PAYSTAT;
						...
						else
						{
							?>
							<tr>
                                <td nowrap style="text-align:center;" colspan="11">--- no data ---</td>
                            </tr>
							<?php
						}
					}
                ?>
                <tr>
                    <td colspan="6" nowrap style="text-align:center; font-style:italic; font-weight:bold">JUMLAH</td>
