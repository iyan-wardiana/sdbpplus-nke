	...
	<?php
		...
		// get PRJ & SPL
			if($PRJCODE[0] != 'All')
			{
				...
				$ADDQRY1	= "AND B.PRJCODE IN ('$ADDQRYPRJ')";
			}

			if($SPLCODE[0] != 'All')
			{
				$ADDQRYSPL 	= implode("','", $SPLCODE);
				$ADDQRY2	= "AND B.SPLCODE IN ('$ADDQRYSPL')";
			}
		...
		$sqlSPLC 	= "tbl_pinv_header A
						...
						WHERE A.INV_PAYSTAT IN ('NP','HP') 
						AND A.INV_STAT IN (3,6) $ADDQRY1 $ADDQRY2";
				...
				<div class="page">
					...
					<table border="1" width="100%">
			        	<tr class="hcol1" style="background:#CCCCCC">
							<td nowrap style="text-align:center; font-weight:bold">No.</td>
							<td nowrap style="text-align:center; font-weight:bold">Suplier</td>
							<td nowrap style="text-align:center; font-weight:bold">Saldo Awal</td>
							<td nowrap style="text-align:center; font-weight:bold">Pembelian<br>(+)</td>
							<td nowrap style="text-align:center; font-weight:bold">Pembayaran<br>(+)</td>
							<td nowrap style="text-align:center; font-weight:bold">Potongan<br>(Retur)</td>
							<td nowrap style="text-align:center; font-weight:bold">Saldo Akhir</td>
				      	</tr>
				      	<?php
					      	for($i=0;$i<41;$i++)
				            {
				        ...
				        <tr class="hcol1" style="background:#CCCCCC">
							<td colspan="2" nowrap style="text-align:center; font-weight:bold">GRAND TOTAL</td>
			        ...
			        <table width="100%" border="1" rules="all">
			            <tr>
			                <td style="text-align: center;"><?=$comp_name?></td>
			                <td style="text-align: center;">CORPORATE</td>
			                <td style="text-align: center;">COMMITEE</td>
			            </tr>
			            <tr>
			        ...
			        <table width="100%" border="0" style="display: none;">
			            <tr>
			                <td>Keterangan : </td>
			                <td>FAM = Finance Accounting Manager</td>
			                <td>FC = Finance Committee</td>
			            </tr>
			        </table>
			        <br>
