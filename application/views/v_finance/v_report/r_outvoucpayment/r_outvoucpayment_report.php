...
/* 
 * Author		= Wardiana
 * Create Date	= 08 Agustus 2018
 * File Name	= r_outvoucpayment_report.php
 * Location		= -
*/
		...
		<div class="page">
			<section class="content">
			    <table width="100%" border="0" style="size:auto">
				    <tr>
				        <td width="9%" class="style2" style="text-align:left; font-weight:bold;">&nbsp;</td>
				    ...
				    <tr>
				      	<td colspan="3"style="text-align:center; font-weight:bold;">Rincian Umur Hutang</td>
				    </tr>
				    <tr>
				        ...
				        <td colspan="3" class="style2">
				            <table width="100%" border="1" rules="all">
				                <tr class="hcol1" style="background:#CCCCCC">
				                  ...
				                  <td width="24%" nowrap style="text-align:center; font-weight:bold">Supplier/Vendor</td>
				                  <td width="13%" nowrap style="text-align:center; font-weight:bold">No.PO</td>
				                  <td width="7%" nowrap style="text-align:center; font-weight:bold">Tgl. Faktur</td>
				                  <td width="8%" nowrap style="text-align:center; font-weight:bold">Tgl.<br>Jatuh Tempo</td>
				                  <td width="9%" nowrap style="text-align:center; font-weight:bold">Jumlah Hutang<br>Supplier</td>
				                  <td width="7%" nowrap style="text-align:center; font-weight:bold">0 - 30 Hari</td>
				                  <td width="7%" nowrap style="text-align:center; font-weight:bold">31-60 Hari</td>
				                  <td width="7%" nowrap style="text-align:center; font-weight:bold">60-90 Hari</td>
				                  <td width="7%" nowrap style="text-align:center; font-weight:bold">91-120 Hari</td>
				                  <td width="8%" nowrap style="text-align:center; font-weight:bold">&gt; 120 Hari</td>
				              </tr>
				                <?php
									...
									if($CFType == 1) // 1. Sumamry
									{
										...
										$sql1 		= "SELECT SPLCODE, PO_NUM, INV_DATE, INV_DUEDATE, SUM(INV_AMOUNT) AS TOTAMOUNT, 
															SUM(INV_AMOUNT_PAID) AS TOTPAID, SUM(INV_LISTTAXVAL) AS INV_TAXVAL
														FROM tbl_pinv_header 
														WHERE PRJCODE IN ($COLREFPRJ)
															AND INV_DATE <= '$End_Date' AND SPLCODE IN ($COLREFSPL)
															AND INV_PAYSTAT IN ('NP', 'HP') AND INV_STAT IN (3,6)
										...
										if($res0 > 0)
										{
											foreach($res1 as $row1) :
												...
												$INV_AMOUNT_REM	= $INV_AMOUNT + $INV_TAXVAL - $INV_AMOUNT_P;
												...
												<tr>
													...
													<td style="text-align:right">
														<?php
															echo number_format($INV_AM_121, 2);
														?>
				                                    </td>
												</tr>
												<?php
										...
										?>
											<tr>
												<td colspan="5" nowrap style="text-align:right; font-style:italic; font-weight:bold">Total</td>
												...
												<td style="text-align:right; font-weight:bold" nowrap><?php echo number_format($TOTAM_90, 2); ?></td>
												<td style="text-align:right; font-weight:bold" nowrap><?php echo number_format($TOTAM_120, 2); ?></td>
												<td style="text-align:right; font-weight:bold" nowrap><?php echo number_format($TOTAM_121, 2); ?></td>
											</tr>
										<?php
									}
									elseif($CFType == 2) // 2. Detail
									{
										...
										if($res0 > 0)
										{
											foreach($res1 as $row1) :
												...
												$INV_LISTTAXVAL	= $row1->INV_LISTTAXVAL;
												$INV_AMOUNT_P	= $row1->INV_AMOUNT_PAID;
												$INV_AMOUNT_REM	= $INV_AMOUNT + $INV_LISTTAXVAL - $INV_AMOUNT_P;
