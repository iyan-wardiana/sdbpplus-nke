		...
		<div class="page">
			<section class="content">
			    <table width="100%" border="0" style="size:auto">
				    ...
				    <tr>
				      <td colspan="3"style="text-align:center; font-weight:bold;">Rincian Buku Besar Pembantu Hutang</td>
				    </tr>
				    <tr>
				        ...
				        <td colspan="3" class="style2">
				            <table width="100%" border="1" rules="all">
				                <tr style="background:#CCCCCC">
				                  <td width="24%" nowrap style="text-align:center; font-weight:bold">Supplier</td>
				                  <td width="13%" nowrap style="text-align:center; font-weight:bold">No.PO</td>
				                  <td width="7%" nowrap style="text-align:center; font-weight:bold">Saldo AWAL</td>
				                  <td width="8%" nowrap style="text-align:center; font-weight:bold">Faktur <br>Pembelian</td>
				                  <td width="9%" nowrap style="text-align:center; font-weight:bold">Pembayaran <br>Supplier</td>
				                  <td width="7%" nowrap style="text-align:center; font-weight:bold">Retur <br>Pembelian</td>
				                  <td width="7%" nowrap style="text-align:center; font-weight:bold">Uang Muka</td>
				                  <td width="7%" nowrap style="text-align:center; font-weight:bold">No Voucher</td>
				                ...
				                <?php
									...
									if($CFType == 1) // 1. Sumamry
									{
										...
										$sql1 		= "SELECT SPLCODE, PO_NUM, DP_AMOUNT, VENDINV_NUM, INV_DUEDATE,
															SUM(INV_AMOUNT) AS TOTAMOUNT, SUM(INV_AMOUNT_PAID) AS TOTPAID,
															SUM(INV_LISTTAXVAL) AS INV_TAXVAL
										...
										if($res0 > 0)
										{
											foreach($res1 as $row1) :
												...
												$VENDINV_NUM	= $row1->VENDINV_NUM;
												$PO_NUM 		= $row1->PO_NUM;
												$PO_CODE	= '-';
												if($PO_NUM != '')
												{
													$sql1A 	= "SELECT PO_CODE FROM tbl_po_header WHERE PO_NUM = '$PO_NUM' LIMIT 1";
													$res1A 	= $this->db->query($sql1A)->result();
													foreach($res1A as $row1A) :
														$PO_CODE 	= $row1A->PO_CODE;
													endforeach;
												}
												...
												$INV_AMOUNT_REM	= $INV_AMOUNT - $INV_AMOUNT_P - $DP_AMOUNT;
												...
												$TOTINV			= $TOTINV + $INV_AMOUNT;
												$TOTINV_REM		= $TOTINV_REM + $INV_AMOUNT_REM;
												?>
												<tr>
													...
													<td style="text-align:right;" nowrap>
														<?php echo number_format($INV_AMOUNT_P, 2); ?>
				                                    </td>
													<td style="text-align:right;" nowrap>
														<?php echo number_format($INV_AMOUNT_R, 2); ?>
				                                    </td>
													<td nowrap style="text-align:right">
														<?php echo number_format($DP_AMOUNT, 2); ?>
													</td>
													...
													<td style="text-align:right" nowrap>
														<?php
															echo number_format($INV_AMOUNT_REM, 2);
														?>
													</td>
												</tr>
												<?php
										...
										else
										{
											?>
												<tr>
													<td colspan="9" nowrap style="text-align:center; font-style:italic">&nbsp;</td>
												</tr>
											<?php
										}
										?>
											<tr>
												<td colspan="2" nowrap style="text-align:Right; font-style:italic; font-weight:bold">Total</td>
				                                <td style="text-align:right; font-weight:bold" nowrap><?php echo number_format($TOTINV, 2); ?></td>
				                                <td style="text-align:right; font-weight:bold" nowrap><?php echo number_format($TOTINV, 2); ?></td>
				                                <td style="text-align:right; font-weight:bold" nowrap><?php echo number_format($TOTAM_30, 2); ?></td>
												<td style="text-align:right; font-weight:bold" nowrap><?php echo number_format($TOTAM_30, 2); ?></td>
												<td style="text-align:right; font-weight:bold" nowrap><?php echo number_format($DP_AMOUNT, 2); ?></td>
												<td style="text-align:right; font-weight:bold" nowrap>&nbsp;</td>
												<td style="text-align:right; font-weight:bold" nowrap><?php echo number_format($TOTINV_REM, 2); ?></td>
											</tr>
										<?php
									}
									elseif($CFType == 2) // 2. Detail
									{
										...
										if($res0 > 0)
										{
											foreach($res1 as $row1) :
												...
												<tr>
													...
													<td style="text-align:right" nowrap>
														<?php
															echo number_format($INV_AM_90, 2);
														?>
													</td>
													<td style="text-align:right" nowrap>
														<?php
															echo number_format($INV_AM_120, 2);
														?>
													</td>
												</tr>
												<?php
										...
										?>
											<tr>
												...
												<td style="text-align:right" nowrap><?php echo number_format($TOTAM_90, 2); ?></td>
												<td style="text-align:right" nowrap><?php echo number_format($TOTAM_120, 2); ?></td>
											</tr>
										<?php
									}
				                ?>
