 ...
 * File Name	= r_outvoucpayment_ruh_report.php
 * Location		= -
*/
		...
		<div class="page">
			<section class="content">
			    <table width="100%" border="0" style="size:auto">
				    ...
				    <tr>
				      <td colspan="3"style="text-align:center; font-weight:bold;">Ringkasan Umur Hutang</td>
				    </tr>
				    <tr>
				            ...
				            <table width="100%" border="1" rules="all">
				                ...
				                <?php
									...
									if($CFType == 1) // 1. Sumamry
									{
										...
										$sql1 		= "SELECT SPLCODE, PO_NUM, INV_DUEDATE, SUM(INV_AMOUNT) AS TOTAMOUNT, 
										...
										else
										{
											?>
												<tr>
													<td colspan="10" nowrap style="text-align:center; font-style:italic">-- No Data --</td>
												</tr>
											<?php
										}
										?>
											<tr>
												<td colspan="3" nowrap style="text-align:right; font-style:italic; font-weight:bold">Total</td>
									...
									elseif($CFType == 2) // 2. Detail
									{
										...
										?>
											<tr>
				                                ...
				                                <td style="text-align:right" nowrap>&nbsp;</td>
				                                <td style="text-align:right" nowrap>&nbsp;</td>
												<td style="text-align:righ; font-weight:boldt" nowrap><?php echo number_format($TOTAM_30, 2); ?></td>
												<td style="text-align:right; font-weight:bold" nowrap><?php echo number_format($TOTAM_60, 2); ?></td>
												<td style="text-align:right; font-weight:bold" nowrap><?php echo number_format($TOTAM_90, 2); ?></td>
												<td style="text-align:right; font-weight:bold" nowrap><?php echo number_format($TOTAM_120, 2); ?></td>
												<td style="text-align:right; font-weight:bold" nowrap><?php echo number_format($TOTAM_121, 2); ?></td>
