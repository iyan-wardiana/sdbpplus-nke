 ...
 * File Name	= r_ttkoutstanding.php
 * Location		= -
*/
?>
<?php 
                  ...
                  <table width="100%">
                    ...
                    <tr id="projAll01">
                        ...
                        <td width="5%" id="projAll02" nowrap>
                            <select multiple="multiple" class="options" size="10" name="pavailable" ondblclick="MoveOption(this.form.pavailable, this.form.packageelements)">
                            <?php 
