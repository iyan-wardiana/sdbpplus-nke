...
<?php
    ...
    if($LangID == 'IND')
    {
        ...
        $alert2     = "Silahkan pilih salah satu supplier";
    }
    else
    {
                ...
                <div class="box-body chart-responsive">
                    <form class="form-horizontal" method="post" name="frm" id="frm" action="<?php echo $form_action; ?>" onSubmit="return target_popup(this);">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select name="PRJCODE[]" id="PRJCODE" class="form-control select2" multiple data-placeholder="&nbsp;&nbsp;&nbsp;<?php echo $ProjectName; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select name="SPLCODE" id="SPLCODE" class="form-control select2" data-placeholder="&nbsp;&nbsp;&nbsp;<?php echo $ProjectName; ?>">
