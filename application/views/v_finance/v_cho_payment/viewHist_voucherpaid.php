			...
			<div class="box-header-detail">
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
						...
						<td width="5">:</td>
						<td>&nbsp;<?php echo number_format($GJournal_Total, 2); ?></td>
					</tr>
					<tr>
			...
			<div class="box-detail">
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
					...
					<tbody>
						<?php  
							// get pay history
							$this->db->select("A.CB_NUM, A.CB_CODE, A.CBD_AMOUNT, B.CB_DATE, B.CB_ACCID");
							$this->db->from("tbl_bp_detail A");
							$this->db->join("tbl_bp_header B", "B.CB_NUM = A.CB_NUM AND B.PRJCODE = A.PRJCODE");
							$this->db->where(["A.CBD_DOCNO" => $JournalH_Code, 
											  "B.PRJCODE" => $PRJCODE, 
											  "B.CB_DOCTYPE" => 'VCASH', 
											  "B.CB_PAYFOR" => $SPLCODE, 
											  "B.CB_STAT" => 3]);
							...
							if($getPayHist->num_rows() > 0)
							{
								...
								foreach($getPayHist->result() as $rPAY):
									...
									$CBD_AMOUNT = $rPAY->CBD_AMOUNT;

									$CB_REMAM 	= $GJournal_Total - $CBD_AMOUNT;
									?>
										<tr>
											...
											<td style="text-align: right;"><?php echo number_format($CBD_AMOUNT, 2); ?>&nbsp;</td>
