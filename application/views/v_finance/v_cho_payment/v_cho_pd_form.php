...
if($LangID == 'IND')
{
	...
	$docalert4	= 'Anda belum men-setting akun untuk hutang Pinjaman Dinas (PD). Silahkan atur akun Pinjaman Dinas dari menu pengaturan umum.';
}
else
{
	$docalert1	= 'Warning';
	...
	$docalert4	= 'You have not set up an account for the Account Payable of the Personal Loan category. Please set up a Loan Account from the General Settings menu.';
}
...
<html>
	...
	<?php
		...
		if($LangID == 'IND')
		{
			...
			$alert18	= "Silahkan pilih nama karyawan";
		...
		else
		{
			...
			$alert18	= "Please select an employee name";
		...
		<section class="content">
	        <form class="form-horizontal" name="frm" id="frm" method="post" action="<?php echo $form_action; ?>" enctype="multipart/form-data" onSubmit="return validateInData()">
                ...
                <div class="row">
                        ...
                        <div class="box box-success">
                            ...
                            <div class="box-body">
				            	...
				            	<div class="form-group">
				                    ...
				                    <div class="col-sm-10" id="isPersLoan" <?php if($ISPERSL == 0) { ?> style="display: none;" <?php } ?>>
				                    	<select name="PERSL_EMPID" id="PERSL_EMPID" class="form-control select2" style="width: 100%">
				                          	<option value=""> --- </option>
				                          	<?php
				            	...
				            	<div class="form-group">
				                    ...
				                    <div class="col-sm-10" id="isPersLoan" <?php if($ISPERSL == 0) { ?> style="display: none;" <?php } ?>>
				                    	<select name="SPLCODE" id="SPLCODE" class="form-control select2" style="width: 100%">
				                          	<option value=""> --- </option>
				                          	<?php
                            ...
                            <div class="box-body">
				                <div class="form-group">
	                            	<div class="col-sm-8">
				                    	...
				                    	<textarea name="JournalH_Desc" class="form-control" id="JournalH_Desc" style="height: 80px"><?php echo $JournalH_Desc; ?></textarea>
	                            	...
	                            	<div class="col-sm-4">
	                                    <label for="exampleInputEmail1">Rencana Penyelesaian</label>
				                    	<div class="input-group date">
				                        	<div class="input-group-addon">
				                ...
				                <div class="form-group">
									...
									?>
				                	<div class="col-sm-4">
	                                    <label for="exampleInputEmail1"><br></label><br>
					                    <input type="hidden" name="ACC_ID_PERSL" id="ACC_ID_PERSL" value="<?php echo $ACC_ID_PERSL; ?>" />
					                    <input type="hidden" name="ACC_ID_EMPAP" id="ACC_ID_EMPAP" value="<?php echo $ACC_ID_EMPAP; ?>" />
			                    ...
			                    <script>
			                    	...
			                    	function chgAmn(thisval)
			                    	{
			                    		...
			                    		if(isNaN(Journal_Amount) == true)
			                    			Journal_Amount	= parseFloat(0);
                    ...
                    <div class="col-sm-12" id="setAccAPAlert" style="display: none;">
                        <div class="alert alert-danger alert-dismissible">
                            <h4><i class="icon fa fa-ban"></i> <?php echo $docalert1; ?>!</h4>
                            <?php echo $docalert4; ?>
                        </div>
		...
		function chkAppStat()
		{
            ...
            $.ajax({
                ...
                success: function(response)
                {
            		...
            		if(ACCID_EMPAP == '')
            		{
                		document.getElementById('setAccAPAlert').style.display 	= '';
                		document.getElementById('btnSave').style.display 		= 'none';
                	}
                	else
                	{
                		document.getElementById('setAccAPAlert').style.display 	= 'none';
                		document.getElementById('btnSave').style.display 		= '';
                	}
