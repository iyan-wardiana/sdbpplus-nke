						...
						<div class="box-body">
	                        <div class="col-sm-4">
                            	...
                            	<select name="SPLCODE" id="SPLCODE" class="form-control select2" style="width: 100%" onChange="grpVC(this.value)">
                            		<option value=""> --- </option>
									<?php
										$s_SPL	= "SELECT DISTINCT B.SPLCODE, B.SPLDESC FROM tbl_journalheader_revers A
		    ...
		    <script type="text/javascript">
		    	function grpVC()
		    	{
		    		...
		    		$('#example').DataTable({
						...
						"autoWidth": true,
						"filter": true,
				        "ajax": "<?php echo site_url('c_finance/c_cho70d18/get_AllDataJRNREVGRP/?id='.$PRJCODE.'&jrnType='.$jrnType)?>"+'&SPLC='+SPLC+'&GSTAT='+GSTAT,
				        "type": "POST",
...
<script>
    ...
    $('#example').DataTable( {
		...
		"autoWidth": true,
		"filter": true,
        "ajax": "<?php echo site_url('c_finance/c_cho70d18/get_AllDataJRNREV/?id='.$PRJCODE.'&jrnType='.$jrnType)?>",
        "type": "POST",
		//"lengthMenu": [[10, 25, 50, 100, 200, -1], [10, 25, 50, 100, 200, "All"]],
		"lengthMenu": [[10, 25, 50, 100, 200], [10, 25, 50, 100, 200]],
		"columnDefs": [	{ targets: [0,2,5,6], className: 'dt-body-center' },
