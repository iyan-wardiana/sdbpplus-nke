    ...
    <section class="page sheet custom">
        <div class="cont">
            <div class="box-header">
                ...
                <div class="pageno">
                    <span>NO.VOC : <b><?php echo $Manual_No; ?></b></span>
                </div>
            </div>
                ...
                <table width="100%" border="1" cellpadding="0" cellspacing="0">
                    ...
                    <tbody>
                        <?php
                            ...
                            $getJCPRJ   = "SELECT A.JournalH_Code, A.JournalH_Date, A.JournalType, A.Acc_Id, 
                                            ...
                                            AND A.JournalType = 'CPRJ' AND A.GEJ_STAT IN (2,3)
                                            GROUP BY A.Acc_Id ORDER BY A.PattNum ASC";
                            ...
                            if($resJCPRJ->num_rows() > 0)
                            {
                                ...
                                foreach($resJCPRJ->result() as $rJCPRJ):
                                    ...
                                    {
                                        /*if($isTax == 1)
                                            $JDesc_hut = "PPN - $JournalH_Desc : $Other_Desc";
                                        else
                                            $JDesc_hut = "$JournalH_Desc : $Other_Desc";*/

                                        // $JournalH_Desc DIHILANGKAN BERDASARKAN NKES.TR-220921.00019
                                        if($isTax == 1)
                                            $JDesc_hut = "PPN - : $Other_Desc";
                                        else
                                            $JDesc_hut = "$Other_Desc";
                                    }
                                        

                                    if($Journal_DK == 'K')
                                    {
                                        $JDesc_hut = "Pembayaran ke $EMP_NAME";
                                    }
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td width="350">
                                                    <div class="desc_itm" style="display: <?php echo $Journal_DK == 'K' ? 'none':'' ?>;">
                                                        <?php echo $EMP_NAME; ?>
                                                    </div>
                                                    <div class="acc_desc" style="font-style: italic;"><?php echo $JDesc_hut; ?></div>
                                                </td>
                                                <td width="100" style="text-align: right;"><?php echo number_format($JournalD_Debet, 2); ?>
                                                </td>
                                                <td width="100" style="text-align: right; font-weight: <?php echo $Journal_DK == 'K' ? 'bold':'' ?>;"><?php echo number_format($JournalD_Kredit, 2); ?></td>
                                                <td width="100">&nbsp;</td>
                                            </tr>
                                        <?php
                                            if($PPN_Amount != 0)
                                            {
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td width="100" style="text-align: right;"><?php echo number_format($PPN_Amount, 2); ?></td>
                                            ...
                                            $TOT_DEBET = $TOT_DEBET + $JournalD_Debet + $PPN_Amount;
                                        

                                        if($PPH_Amount != 0)
                                        {
                                            // get PPN 
                                            $JDesc_hut = "PPH - $JournalH_Desc";
                                            /*$JDesc_hut      = "PPH - $JournalH_Desc";*/

                                            // $JournalH_Desc DIHILANGKAN BERDASARKAN NKES.TR-220921.00019
                                            $JDesc_hut      = "PPH - $Other_Desc";
                                            $Acc_Id         = '';
                                            $this->db->select("TAXLA_DESC, TAXLA_LINKIN");
                                            ...
                                            ?>
                                                <tr>
                                                    <td width="100"><?php echo $Acc_Id; ?></td>
                                                    <td width="350">
                                                        <div class="desc_itm"><?php echo $EMP_NAME; ?></div>
                                                        <div class="acc_desc" style="font-style: italic;"><?php echo $JDesc_hut; ?></div>
                                                    </td>
                                                    <td width="100" style="text-align: right;"><?php echo number_format($JournalD_Debet, 2); ?>
                                                    <td width="100" style="text-align: right;">&nbsp;</td>
                                                    <td width="100" style="text-align: right;"><?php echo number_format($PPH_Amount, 2); ?></td>
                                                </tr>
                                            <?php
                                        }
                                        
                                        $TOT_PAYMENT = $JournalD_Kredit;

                                        $TOT_KREDIT = $TOT_KREDIT + $JournalD_Kredit + $PPH_Amount;
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <td width="100" style="text-align: right;"><?php echo number_format($TOT_DEBET, 2); ?></td>
                            <td colspan="2" style="text-align: center;"><?php echo number_format($TOT_KREDIT, 2); ?></td>
                        </tr>
                        <tr>
                            <td style="border-right: hidden; text-align: right; vertical-align: top;">Terbilang :</td>
                            <td colspan="4" style="font-weight: bold;"><?php echo $moneyFormat->terbilang($TOT_PAYMENT, 2); ?></td>
                        </tr>
                    </tfoot>
                </table>
            </div>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <thead>
                        <tr>
                            <th width="50">NO.</th>
                            <th>KETERANGAN</th>
                            <th width="50" style="display: none;">Proyek</th>
                    ...
                    <tbody>
                        <?php
                            ...
                            // $this->db->distinct();
                            $this->db->select("A.JournalH_Code, A.SPLCODE, B.Acc_Id, B.proj_Code, B.Journal_DK, B.Base_Debet, B.Base_Kredit, 
                            B.PPN_Code, B.PPN_Amount, B.PPH_Code, B.PPH_Amount, B.Ref_Number, B.TAX_NO, B.TAX_DATE, B.Other_Desc, C.ITM_CODE, C.ITM_NAME");
                            ...
                            if($getJournal_Hutang->num_rows() > 0)
                            {
                                ...
                                foreach($getJournal_Hutang->result() as $rJ):
                                    ...
                                    if($Journal_DK == 'D')
                                        ...
                                        $JournalDesc = "<span>$ITM_NAME</span><div class='text-muted' style='font-style: italic;'>$ITM_DESC</div>";
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td style="text-align: center; display: none;"><?php echo $PRJCODE; ?></td>
                                    ...
                                    <?php
                                        if($PPN_Amount != 0)
                                        {
                                            ...
                                            $JournalDesc    = "Faktur PPN No. $TAX_NO,Tgl $TAX_DATE";
                                            $Acc_Id         = $TAXLA_LINKIN;
                                            $ITM_CODE       = '';
