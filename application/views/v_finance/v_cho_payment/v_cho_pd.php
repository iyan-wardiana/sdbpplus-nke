            ...
            <script type="text/javascript">
                function grpData()
                {
                    ...
                    $('#example').DataTable( {
                        ...
                        "autoWidth": true,
                        "filter": true,
                        "ajax": "<?php echo site_url('c_finance/c_cho_pd/get_AllDataGRP/?id='.$PRJCODE.'&jrnType='.$jrnType)?>"+'&SPLC='+SPLC+'&DSTAT='+DSTAT+'&SRC='+SRC+'&PROJECT='+PROJECT,
				        "type": "POST",
						//"lengthMenu": [[10, 25, 50, 100, 200, -1], [10, 25, 50, 100, 200, "All"]],
						"lengthMenu": [[10, 25, 50, 100, 200], [10, 25, 50, 100, 200]],
						"columnDefs": [	{ targets: [0,5,6], className: 'dt-body-center' },
...
<script>
    ...
    $('#example').DataTable( {
		...
		"autoWidth": true,
		"filter": true,
        "ajax": "<?php echo site_url('c_finance/c_cho_pd/get_AllData/?id='.$PRJCODE.'&jrnType='.$jrnType)?>", 
        "type": "POST",
		//"lengthMenu": [[10, 25, 50, 100, 200, -1], [10, 25, 50, 100, 200, "All"]],
		"lengthMenu": [[10, 25, 50, 100, 200], [10, 25, 50, 100, 200]],
		"columnDefs": [	{ targets: [0,5,6], className: 'dt-body-center' },
