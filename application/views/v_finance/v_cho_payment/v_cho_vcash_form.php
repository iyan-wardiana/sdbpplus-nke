...
$JRNNUM_SESS 		= "";
if(isset($_SESSION['JRNNUM_SESS']))
	$JRNNUM_SESS 	= $_SESSION['JRNNUM_SESS'];
...
else
{
	...
	$sessNo 			= array('JRNNUM_SESS' => $JournalH_Code);
	...
	$ACCID_AP			= $acc_number;
	$s_01 				= "SELECT VC_LA_PAYINV FROM tbl_vendcat WHERE VendCat_Code IN (SELECT SPLCAT FROM tbl_supplier WHERE SPLCODE = '$PERSL_EMPID')";
	...
	foreach($r_00 as $rw_00):
		$SPLDESC 	= stripslashes($rw_00->SPLDESC);
...
if($LangID == 'IND')
{
	...
	$docalert5	= "Jurnal bulan $MonthVw $JournalY sudah terkunci, silahkan hubungi departemen terkait.";
}
else
{
	...
	$docalert5	= "journal month $MonthVw $JournalY locked, please contact the relevant department.";
}
?>
<!DOCTYPE html>
<html>
    ...
    <body class="<?php echo $appBody; ?>" style="background-color: <?=$comp_color?>" onLoad="clearTemp()">
                            ...
                            <div class="box-body">
				            	...
				            	<div class="form-group">
				                    ...
				                    <div class="col-sm-5">
				                    	...
				                    	<?php if($task == 'add') { ?>
					                    	<input type="hidden" class="form-control" style="max-width:400px;text-align:right" name="Pattern_Code" id="Pattern_Code" size="30" value="<?php echo $Pattern_Code; ?>" />
					                    <?php } ?>
				            	...
				            	<div class="form-group">
				                    ...
				                    <div class="col-sm-9">
				                    	<!-- <select name="ISPERSLX" id="ISPERSLX" class="form-control select2" onChange="chgCat(this.value)" disabled>
				                       	...
				                       	<input type="hidden" name="ISPERSLX" id="ISPERSLX" value="<?php echo $ISPERSL; ?>" />
				                        ...
				                        <select name="PERSL_EMPID" id="PERSL_EMPID" class="form-control select2" style="width: 100%" onChange="chgSpl(this.value)">
				                          	...
				                          	<?php
				                          		...
				                          		foreach($r_01 as $rw_01):
				                          			$EMPID 	= $rw_01->SPLCODE;
				                          			$EMPNM 	= stripslashes($rw_01->SPLDESC);
				                          			?>
				            	...
				            	<div class="form-group">
				                    ...
				                    ?></label>
				                    <div class="col-sm-5">
				                    	<input type="text" class="form-control" name="Reference_Number" id="Reference_Number" value="<?php echo $Reference_Number; ?>" placeholder="No. Kwitansi Supplier" />
				                    </div>
				                    <div class="col-sm-4">
				                    	<div class="input-group date">
				                        <div class="input-group-addon">
				                        <i class="fa fa-calendar"></i>&nbsp;</div><input type="text" name="Reference_Date" class="form-control pull-left" id="datepicker1" value="<?php echo $Reference_Date; ?>"></div>
		                            </div>
				                </div>
		                                    ...
		                                    <tr id="tr_<?php echo $currentRow; ?>">
												<td style="text-align:center; vertical-align: middle;">
													<?php
														if($GEJ_STAT == 1 || $GEJ_STAT == 4)
														{
															...
															<!-- <a href="#" onClick="delRow(<?php // echo $currentRow; ?>)" title="Hapus" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i></a> --> <!-- Sudah direset dicontroll -->
															<a href="#" onClick="deleteRow(<?php echo $currentRow; ?>)" title="Hapus" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i></a> <!-- Hanya Hapus baris & diupdate ketika disimpan -->
															<?php
														}
														else
														{
												...
												<td width="6%" nowrap style="text-align:center; display:none">
											  	...
											  	<td style="text-align:center; vertical-align: middle;">
				                                    ...
				                                    <input type="hidden" name="data<?php echo $currentRow; ?>isLS" id="isLS<?php echo $currentRow; ?>" value="<?php echo $r_isLS; ?>" class="form-control" style="max-width:150px;" >
								...
								<div class="row">
							    	<div class="col-md-12">
						              	<ul class="nav nav-tabs">
						                    ...
						                    <li id="li2" <?php echo $Active2Cls; ?> style="display: none;">
		                                        	...
		                                        	<form method="post" name="frmSearch1" id="frmSearch1" action="">
														<div class="search-table-outter">
				                                            <table id="example0" class="table table-bordered table-striped table-responsive search-table inner" width="100%">
				                                                <thead>
				                                                    <tr>
				                                                        <th rowspan="2" width="2%" style="text-align:center; vertical-align:middle">M</th>
...
<?php
	...
	$ClrItm 	= base_url().'index.php/c_finance/c_cho70d18/ClrItmTmp/?id=';
...
<script>
	...
	// START : LOCK PROCEDURE => old prosedure 
		/* ---------------------------- Hidden -----------------------
		$(document).ready(function()
		{
	...
	function clearTemp()
	{
		var JRN_NUM = "<?=$JRNNUM_SESS?>";
		url 		= "<?=$ClrItm?>";
		$.ajax({
            type: 'POST',
            url: url,
            data: {JRN_NUM: JRN_NUM}
        });
	}
	...
	function add_listAcc(strItem) 
	{
		...
		// Item Unit
			...
			objTD.noWrap = true;
			objTD.innerHTML = '<div id="div_unit_'+intIndex+'"></div><input type="hidden" name="data'+intIndex+'ITM_UNIT" id="ITM_UNIT'+intIndex+'" value="'+ITM_UNIT+'" class="form-control" style="min-width:50px;" readonly><input type="hidden" name="data'+intIndex+'isLS" id="isLS'+intIndex+'" value="'+isLS+'" class="form-control" style="min-width:50px;"><input type="hidden" name="data['+intIndex+'][ITM_UNIT]" id="data'+intIndex+'ITM_UNIT" value="'+ITM_UNIT+'" class="form-control" style="max-width:150px;" >';
		...
		// Account Reference
			...
			objTD.noWrap = true;
			//objTD.style.display = 'none';
			objTD.innerHTML = '<input type="text" name="data['+intIndex+'][TAX_DATE]" id="data'+intIndex+'TAX_DATE" value="'+TAX_DATE+'" class="form-control" style="min-width:100px;max-width:100px;" placeholder="YYYY-MM-DD" >';
		...
		// Remarks
			objTD = objTR.insertCell(objTR.cells.length);
			objTD.align = 'left';
			objTD.innerHTML = '<input type="text" name="data['+intIndex+'][Other_Desc]" id="data'+intIndex+'Other_Desc" size="20" value="" class="form-control" style="min-width:110px; max-width:300px; text-align:left" placeholder="<?php echo $Remarks; ?>"><input type="hidden" name="data['+intIndex+'][isVerified]" id="data'+intIndex+'isVerified" value="'+isVerified+'" class="form-control" style="min-width:150px;max-width:300px;" >';
	...
	function chgVolume(thisval, row)
	{
		...
		var isLS			= parseFloat(document.getElementById('isLS'+row).value);
