                ...
                <table width="100%" border="1" cellpadding="0" cellspacing="0">
                    ...
                    <tbody>
                        <?php
                            $getJCPRJ   = "SELECT A.JournalH_Code, A.JournalH_Date, A.JournalType, A.Acc_Id, 
                                            A.Acc_Id_Cross, A.Acc_Name, A.proj_Code, A.JOBCODEID, 
                            ...
                            if($resJCPRJ->num_rows() > 0)
                            {
                                foreach($resJCPRJ->result() as $rJCPRJ):
                                    ...
                                    if($Journal_DK == 'D')
                                    {
                                        ?>
                                            ...
                                            <?php
                                                ...
                                                {
                                                    // get PPN
                                                        $getPPN     = "SELECT * FROM tbl_tax_ppn WHERE TAXLA_NUM = '$PPN_Code'";
                                                        $resPPN     = $this->db->query($getPPN);
                                                        if($resPPN->num_rows() > 0)
                                                        {
                                                            foreach($resPPN->result() as $rPPN):
                                                                $TAXLA_NUM      = $rPPN->TAXLA_NUM;	
                                                                $Acc_Name	    = $rPPN->TAXLA_DESC; 
                                                                $Acc_Id         = $rPPN->TAXLA_LINKIN;
                                                                $TAXLA_PERC     = $rPPN->TAXLA_PERC;	
                                                            endforeach;
                                                        }
                                    ...
                                    else
                                    {
                                        ...
                                        {
                                            // get PPH
                                                $getPPH     = "SELECT * FROM tbl_tax_la WHERE TAXLA_NUM = '$PPN_Code'";
                                                $resPPH     = $this->db->query($getPPH);
                                                if($resPPH->num_rows() > 0)
                                                {
                                                    foreach($resPPH->result() as $rPPH):
                                                        $TAXLA_NUM      = $rPPH->TAXLA_NUM;	
                                                        $Acc_Name	    = $rPPH->TAXLA_DESC; 
                                                        $Acc_Id         = $rPPH->TAXLA_LINKIN;
                                                        $TAXLA_PERC     = $rPPH->TAXLA_PERC;	
                                                    endforeach;
                                                }
                                            ?>
                                                <tr>
                        ...
                        <tr>
                            <td width="100">&nbsp;</td>
                            <td width="350">&nbsp;Pembayaran Tagihan No.&nbsp;<?php echo $Manual_No; ?></td>
                            <td width="100" style="text-align: right;"><?php echo number_format($Amount, 2); ?>&nbsp;</td>
                            <td width="100">&nbsp;</td>
                            <td width="100">&nbsp;</td>
                        </tr>
                        <tr style="display: none;">
                            <td width="100">&nbsp;</td>
                            <td width="350">&nbsp;Nomor Seri Pajak : &nbsp;<?php echo $TAXNO; ?></td>
                            <td width="100">&nbsp;</td>
                            <td width="100">&nbsp;</td>
                            <td width="100">&nbsp;</td>
                        </tr>
                        <tr>
                            <td width="100">&nbsp;</td>
                            <td width="350">&nbsp;<?php echo $PRJNAME; ?></td>
                            <td width="100">&nbsp;</td>
                            <td width="100">&nbsp;</td>
                            <td width="100">&nbsp;</td>
                        </tr>
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <td width="100" style="text-align: right; font-weight: bold;"><?php echo number_format($TAmount, 2); ?>&nbsp;</td>
                        ...
                        <tr>
                            ...
                            <td colspan="4"><?php echo $moneyFormat->terbilang($TAmount, 2); ?></td>
                        </tr>
                    </tfoot>
                </table>
            </div>
