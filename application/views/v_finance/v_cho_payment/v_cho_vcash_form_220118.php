                    ...
                    <div class="col-md-6">
                        <div class="box box-warning">
                            ...
                            <div class="box-body">
				                ...
				                <div class="form-group">
	                            	<div class="col-sm-8">
	                                    <label for="exampleInputEmail1"><?php echo $SupplierName; ?></label>
				                        <select name="PERSL_EMPID" id="PERSL_EMPID" class="form-control select2" style="width: 100%" onChange="chgSpl(this.value)">
				                          	...
				                          	<?php
				                          		...
				                          		foreach($r_01 as $rw_01):
				                          			...
				                          			<?php
				                          		endforeach;*/
				                          		$s_01 	= "SELECT SPLCODE, SPLDESC FROM tbl_supplier ORDER BY SPLDESC ASC";
				                          		$r_01 	= $this->db->query($s_01)->result();
				                          		foreach($r_01 as $rw_01):
				                          			$EMPID 	= $rw_01->SPLCODE;
				                          			$EMPNM 	= $rw_01->SPLDESC;
                        ...
                        <div class="box box-primary">
	                        <div class="search-table-outter">
	                            <table id="tbl" class="table table-bordered table-striped" width="100%">
		                            ...
		                            if($task == 'edit')
		                            {
		                                $sqlDET	= "SELECT A.JournalD_Id, A.JournalH_Code, A.Acc_Id, A.proj_Code, A.JOBCODEID,
