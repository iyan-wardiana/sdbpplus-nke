	        ...
	        <form class="form-horizontal" name="frm" method="post" action="<?php echo $form_action; ?>" enctype="multipart/form-data" onSubmit="return validateInData()">
                ...
                <div class="row">
                        ...
                        <div class="box box-success">
                            ...
                            <div class="box-body">
				            	...
				            	<div class="form-group">
				                    ...
				                    <div class="col-sm-5">
				                    	<div class="form-group">
					                    	<label for="inputName" class="col-sm-4 control-label">Rencana Penyelesaian</label>
					                    	<div class="col-sm-8">
						                    	<div class="input-group date">
						                        	<div class="input-group-addon">
				                	...
				                	{*/
						                ...
						                <div class="form-group">
			                            	...
			                            	<div class="col-sm-4">
			                            		...
			                            		<?php
													$edited	= 0;
													if ($GEJ_STAT == 1 && $ISPERSL == 0)
													{
														$edited	= 1;
													}
													elseif ($GEJ_STAT == 4 && $ISPERSL == 0)
													{
														$edited	= 1;
													}
                    ...
                    <?php
                    	...
                    	endforeach;
                    ?>
                    <input type="hidden" name="ACC_ID_PERSL" id="ACC_ID_PERSL" value="<?php echo $ACCID_PERSL; ?>" />
