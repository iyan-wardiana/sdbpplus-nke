						...
						<div class="box-body">
	                        ...
	                        <div class="col-sm-4">
                            	...
                            	<select name="SPLCODE" id="SPLCODE" class="form-control select2" style="width: 100%" onChange="grpData(this.value)">
                            		<option value=""> --- </option>
									<?php
										$s_SPL	= "SELECT DISTINCT B.SPLCODE, B.SPLDESC FROM tbl_journalheader_vcash A
                                        ...
                                        foreach($r_SPL as $rw_SPL) :
                                            ...
                                            $SPLDESC 	= stripslashes($rw_SPL->SPLDESC);
                                            ?>
                          	...
                          	<div class="col-sm-1" style="display: none;">
                            	...
                            	<button class="btn btn-primary" type="button" id="btnGrp" name="btnGrp" onClick="grpData()">
		    ...
		    <script type="text/javascript">
		    	function grpData()
		    	{
		    		...
		    		$('#example').DataTable({
						...
						"autoWidth": true,
						"filter": true,
				        "ajax": "<?php echo site_url('c_finance/c_cho70d18/get_AllDataCHOGRP/?id='.$PRJCODE.'&jrnType='.$jrnType)?>"+'&SPLC='+SPLC+'&GSTAT='+GSTAT+'&PROJECT='+PROJECT,
				        "type": "POST",
