...
E-mail : corporate@nusakonstruksi.com</td>
                ...
                <tr>
                  <td colspan="8" height="25" style="text-align:center; font-weight:bold; font-size:15px; border-bottom-color:#FFFFFF; font-family:Times New Roman">SURAT PERINTAH KERJA (SPK) UPAH PEMBORONGAN</td>
                </tr>
                <tr>
                ...
                <tr style="font-size:12px;">
                  ...
                  <?php
                        ...
                        {
                            $sqlsp3	= "tvendor_upd WHERE SPLCODE = '$splCode'";
                            $sqlsp3R= $this->db->count_all($sqlsp3);
                            if($sqlsp3R > 0)
                            {
                                $sqlsp4		= "SELECT SPLDESC, SPLADD1, SPLADD2, SPLTELP, SPLKOTA FROM tvendor_upd WHERE SPLCODE = '$splCode'";
                                $sqlsp4R	= $this->db->query($sqlsp4)->result();
                                foreach($sqlsp4R as $rowsp4) :
                                    $SPLDESC		= $rowsp4->SPLDESC;
									$SPLADD1 		= $rowsp4->SPLADD1;
									$SPLADD2 		= $rowsp4->SPLADD2;
									$SPLTELP 		= $rowsp4->SPLTELP;
									$SPLKOTA 		= $rowsp4->SPLKOTA;
                                endforeach;
                            }
                            else
                            {
                ...
                <tr style="font-size:12px;">
                  <td width="3%" style="text-align:center; font-family:Times New Roman">No.</td>
                  <td width="10%" style="text-align:center; font-family:Times New Roman">Kode Item</td>
                  <td style="text-align:center; font-family:Times New Roman">Item Pekerjaan</td>
                  <td style="text-align:center; font-family:Times New Roman">Volume</td>
                  <td style="text-align:center; font-family:Times New Roman">Satuan</td>
                  <td style="text-align:center; font-family:Times New Roman">Harga</td>
                  <td style="text-align:center; font-family:Times New Roman">Total</td>
                  <td style="text-align:center; font-family:Times New Roman">Keterangan</td>
                </tr>
                <?php
					...
					$totSPK = 0;
					$totMaxRow = 32; 
					$sqlR	= "SPKDT WHERE SPKCODE = '$chckSPKCode'";
					$qtyRow = $this->db->count_all($sqlR);

					$remLoop = 32 - $qtyRow;
					
					$qGetSPKDet	= "SELECT A.*
										FROM SPKDT A INNER JOIN SPKHD B ON A.SPKCODE = B.SPKCODE
										WHERE A.SPKCODE = '$chckSPKCode'";
				...
				<tr style="font-size:12px;">
                  ...
                  <td style="text-align:left; font-family:Times New Roman"><?php echo $CSTCODE; ?></td>
                  <td style="text-align:left; font-family:Times New Roman"><?php echo $SPKDESC; ?></td>
                  <td style="text-align:right; font-family:Times New Roman"><?php print number_format($SPKVOLM, $decFormat); ?>&nbsp;</td>
                  <td style="text-align:center; font-family:Times New Roman"><?php echo $CSTUNIT; ?></td>
                  <td style="text-align:right; font-family:Times New Roman"><?php print number_format($CSTPUNT, $decFormat); ?>&nbsp;</td>
                  <td style="text-align:right; font-family:Times New Roman"><?php print number_format($CSTCOST, $decFormat); ?>&nbsp;</td>
				...
				?>
				<tr style="font-size:12px;">
                  <td colspan="6" style="text-align:right; font-family:Times New Roman; font-weight:bold">T O T A L &nbsp;&nbsp;&nbsp;S P K&nbsp;&nbsp;:</td>
                  <td style="text-align:right; font-family:Times New Roman; font-weight:bold;font-size:15px"><?php print number_format($totSPK, $decFormat); ?>&nbsp;</td>
                  <td style="text-align:left; font-family:Times New Roman">&nbsp;</td>
                </tr>
				<tr style="font-size:12px;">
				  <td colspan="8" style="text-align:center; font-size:15px; font-family:Times New Roman">&nbsp;</td>
			  	</tr>
				<tr style="font-size:12px;">
