...
$PRJSTAT    = 0;
$PRJHO      = '';
$sql        = "SELECT PRJNAME, PRJSTAT, PRJCODE_HO FROM tbl_project WHERE PRJCODE = '$PRJCODE'";
        ...
        <section class="content">
                ...
                <div class="col-md-12">
                    <div class="box box-primary">
                        <div class="box-body">
                            ...
                            <div class="col-sm-4">
                                <label for="inputName" class="control-label">Nama Kary. / Supplier</label>
                                <select name="SPLCODE" id="SPLCODE" class="form-control select2" style="width: 100%" onChange="grpData(this.value)">
                                    <option value=""> --- </option>
                                    <?php
                                        $s_SPL  = "SELECT DISTINCT B.SPLCODE, B.SPLDESC FROM tbl_journalheader_pd A
													LEFT JOIN tbl_supplier B ON A.PERSL_EMPID = B.SPLCODE
													UNION
													SELECT DISTINCT B.Emp_ID AS SPLCODE, CONCAT(B.First_Name,' ', B.Last_Name) AS SPLDESC FROM tbl_journalheader_pd A
													LEFT JOIN tbl_employee B ON A.PERSL_EMPID = B.Emp_ID ORDER BY SPLDESC ASC";
                            ...
                            <div class="col-sm-2">
                                ...
                                <select name="GEJ_STAT" id="GEJ_STAT" class="form-control select2" onChange="grpData(this.value)">
            ...
            <script type="text/javascript">
                function grpData()
                {
                    ...
                    var DSTAT   = document.getElementById('GEJ_STAT').value;
                    ...
                    $('#example').DataTable( {
                        ...
                        "autoWidth": true,
                        "filter": true,
                        "ajax": "<?php echo site_url('c_finance/c_r_pd/get_AllDataGRP/?id='.$PRJCODE)?>"+'&SPLC='+SPLC+'&DSTAT='+DSTAT+'&SRC='+SRC+'&PROJECT='+PROJECT,
				        "type": "POST",
				      	...
				      	<table id="example" class="table table-bordered table-striped" width="100%">
							<thead>
					            <tr>
                                    ...
                                    <th style="vertical-align:middle; text-align:center" width="14%" nowrap><?php echo $Reference; ?> </th>
					                ...
					                <th style="vertical-align:middle; text-align:center" width="8%" nowrap><?php echo $RealisasiNumber; ?></th>
...
<script>
    ...
    $('#example').DataTable( {
		...
		"autoWidth": true,
		"filter": true,
        "ajax": "<?php echo site_url('c_finance/c_r_pd/get_AllData/?id='.$PRJCODE)?>",
        "type": "POST",
		//"lengthMenu": [[10, 25, 50, 100, 200, -1], [10, 25, 50, 100, 200, "All"]],
		"lengthMenu": [[10, 25, 50, 100, 200], [10, 25, 50, 100, 200]],
		"columnDefs": [	{ targets: [0,2], className: 'dt-body-center' },
