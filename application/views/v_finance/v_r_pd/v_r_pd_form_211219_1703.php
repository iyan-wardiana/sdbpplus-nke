...
<html>
	...
	<?php
		...
		if($LangID == 'IND')
		{
			...
			$alert14	= "Total detail melebihi nilai Perjalanan Dinas (PD)";
		}
		else
		{
			$subTitleH	= "Add";
				                ...
				                <div class="row">
					                ...
					                <div class="col-md-9">
					                  	...
					                  	<div class="row">
					                    	...
					                    	<div class="col-md-5">
					                    		<?php echo "<i>$pdVal:</i><br><i class='text-yellow' style='font-size: 16px;'><strong>".number_format($Journal_Amount, 2)."</strong></i><br>"; ?>
					                    	</div>
					                    	<div class="col-md-5">
					                  	...
					                  	<div class="row">
					                    	...
					                    	<div class="col-md-10">
					                    		<?php echo "<i>$Remain:</i><br><i class='text-danger' style='font-size: 16px;'><strong>".number_format($remRealiz, 2)."</strong></i>"; ?>
					                    	</div>
				                    	</div>
...
<script>
	...
	function chgVolume(thisval, row)
	{
		...
		document.getElementById('ITM_VOLM'+row).value 			= doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(Acc_Volume)), 2));
		document.getElementById('data'+row+'ITM_VOLM').value 	= parseFloat(Math.abs(Acc_Volume));
	...
	function countAmount()
	{
		...
		for(i=1;i<=totRow;i++)
		{
			...
			if(parseFloat(totAmountD) > parseFloat(totRealizRem))
			{
