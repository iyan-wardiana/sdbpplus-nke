                            ...
                            <div class="box-body">
				                ...
				                <div class="row">
					                ...
					                <div class="col-md-9">
				                        ...
				                        <input type="text" name="Journal_AmountRemOri" id="Journal_AmountRemOri" value="<?php echo $remRealiz; ?>" />
				                        <input type="text" name="Journal_AmountRem" id="Journal_AmountRem" value="<?php echo $remRealiz; ?>" />
	...
	function chgVolume(thisval, row)
	{
		...
		if(isExtra == 0)
		{
			if(ITM_UNIT == 'LS')
			{
		        ...
		        else if((TOTPRC > totRealizRem) && (TOTPRC < ITM_REMAMN))
				{
		        ...
		        else if((TOTPRC > totRealizRem) && (TOTPRC > ITM_REMAMN))
				{
					...
					.then(function()
		            {
						var ITM_VOLM 	= parseFloat(totRealizRem / ITM_PRICE);

						document.getElementById('ITM_VOLM'+row).value 			= doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(ITM_VOLM)), 2));
						document.getElementById('data'+row+'ITM_VOLM').value 	= RoundNDecimal(parseFloat(Math.abs(ITM_VOLM)), 2);
						document.getElementById('ITM_PRICE'+row).value 			= doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(ITM_PRICE)), 2));
						document.getElementById('data'+row+'ITM_PRICE').value 	= RoundNDecimal(parseFloat(Math.abs(ITM_PRICE)), 2);
