 ...
 * File Name	= v_expense_oth_form.php
 * Location		= -
*/
...
{	
	...
	$sql 	= "tbl_journalheader WHERE YEAR(JournalH_Date) = $yearC AND proj_Code = '$PRJCODE' AND JournalType = 'O-EXP'";
        ...
        <form class="form-horizontal" name="frm" method="post" action="<?php echo $form_action; ?>" enctype="multipart/form-data" onSubmit="return validateInData()">
            ...
            <input type="Hidden" name="rowCount" id="rowCount" value="0">
            	...
            	<div class="form-group">
                    ...
                    <div class="col-sm-10">
                    	<select name="proj_Code" id="proj_Code" class="form-control" style="max-width:400px" disabled>
                          ...
                          <?php
						  	$theProjCode 	= $PRJCODE;
                        	$url_AddItem	= site_url('c_finance/c_cpa70d18/puSA0b28t18yXI/?id=');
                            if($countPRJ > 0)
                            {
            	...
            	<div class="form-group">
                    ...
                    <div class="col-sm-10">
                    	<select name="acc_number" id="acc_number" class="form-control select2" style="max-width:400px">
                          <option value="none">--- None ---</option>
                          <?php
						  	$theProjCode 	= $PRJCODE;
                        	$url_AddItem	= site_url('c_finance/c_cpa70d18/puSA0b28t18yXI/?id=');
                        ...
                        <table width="100%" border="1" id="tbl">
                            ...
                            if($task == 'edit')
                            {
								...
								foreach($result as $row) :
									...
									//$BUDG_REMVOLM	= $BUDG_REMVOLM;
									//$BUDG_REMAMNT	= $BUDG_REMAMN;
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        <?php
							...
							$backURL	= site_url('c_finance/c_cpa70d18/cpothb80da8_4ll/?id='.$this->url_encryption_helper->encode_url($PRJCODE));
