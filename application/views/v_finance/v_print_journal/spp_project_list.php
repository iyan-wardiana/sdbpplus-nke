 ...
 * File Name	= spp_project_list.php
 * Location		= -
*/
	...
	<table id="example1" class="table table-bordered table-striped table-responsive search-table inner">
		...
		<?php 
			...
			foreach($vewproject as $row) : 
				...
				$secUpd			= site_url('c_finance/print_journal_spp/list_spp_journal/?id='.$this->url_encryption_helper->encode_url($PRJCODE));
