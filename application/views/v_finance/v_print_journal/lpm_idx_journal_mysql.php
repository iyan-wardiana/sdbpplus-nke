		...
		<form name="frm" id="frm" method="post" action="<?php echo $form_action; ?>" onSubmit="return target_popup(this);" >
			<table id="example1" class="table table-bordered table-striped">
				...
				<?php								
					$myNewNoc = 0;
					$i = 0;
					$sqlC 		= "LPMHD WHERE APPROVE = '1' AND PRJCODE = '$PRJCODE' AND LPMCODE  LIKE '%$LPMCODE%'";
					$ressqlC	= $this->db->count_all($sqlC);
					if($ressqlC > 0)
					{
						$sqlLPM		= "SELECT LPMCODE, OP_CODE, TRXDATE, PRJCODE, SPLCODE FROM LPMHD 
										WHERE APPROVE = '1' AND PRJCODE = '$PRJCODE' AND LPMCODE LIKE '%$LPMCODE%'";
