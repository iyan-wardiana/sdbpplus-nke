...
$EMP_NAME       = "";
$REK            = "";
$s_emp          =  "SELECT CONCAT(First_Name, ' ', Last_Name) AS EMP_NAME, '' AS NO_REK, '' AS NM_REK, '' AS NM_BANK
                        FROM tbl_employee WHERE Emp_ID = '$BR_PAYFROM'
                    UNION
                    SELECT SPLDESC AS EMP_NAME, SPLNOREK AS NO_REK, SPLNMREK AS NM_REK, SPLBANK AS NM_BANK
                        FROM tbl_supplier WHERE SPLCODE = '$BR_PAYFROM'";
                ...
                <table width="100%" cellpadding="0" cellspacing="0">
                    ...
                    <tbody>
                        <?php
                            ...
                            $this->db->where(["B.JournalH_Code" => $BR_NUM, "A.GEJ_STAT" => 3, "A.proj_Code" => $PRJCODE]);
                            ...
                            if($getVoucher->num_rows() > 0)
                            {
                                ...
                                foreach($getVoucher->result() as $rVOC):
                                    ...
                                    // get Voucher_pd
                                    $VOUCHER_CODE = $this->db->get_where("tbl_journalheader_$PRJCODEVW", ["JournalH_Code" => $Reference_Number, "GEJ_STAT" => 3])->row("Manual_No");
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php
                                                    ...
                                                    {
                                                        ?>
                                                            <div style="padding-left: 5px;"><?php echo $Acc_Name; ?><b><?=wordwrap($VOUCHER_CODE, 40, "<br>", true)?></b></div>
