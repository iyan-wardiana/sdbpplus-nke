...
<html>
    ...
    <body class="<?php echo $appBody; ?>" style="background-color: <?=$comp_color?>">
		<section class="content-header">
			<h1>
			    <img src="<?php echo base_url() . 'assets/AdminLTE-2.0.5/dist/img/icon/bank_receipt.png'; ?>" style="max-width:40px; max-height:40px" >&nbsp;&nbsp;<?php echo $Approval; ?>
													...
													if($canApprove == 1)
													{
														...
														?>
															<select name="BR_STAT" id="BR_STAT" class="form-control select2" <?php if($disButton == 1) { ?> disabled <?php } ?> >
																...
																<option value="3"<?php if($BR_STAT == 3) { ?> selected <?php } ?>>Approved</option>
	                        ...
	                        <div class="search-table-outter">
	                            <table id="tbl" class="table table-bordered table-striped" width="100%">
		                            <tr style="background:#CCCCCC">
		                              	<th width="1%" height="25" rowspan="2" style="text-align:left">&nbsp;</th>
		                              	<th width="8%" rowspan="2" style="text-align:center; vertical-align: middle;">
		                              		<?php
		                              			if($BR_RECTYPE == 'PPD')
		                              				echo "No PD";
		                              			else
		                            ...
		                            if($task == 'edit')
		                            {
		                                ...
		                                if($resultCount > 0)
		                                {
		                                    foreach($result as $row) :
		                                        ...
		                                        ?>
		                                        <!-- JournalH_Code, BR_NUM -->
		                                        <tr><td width="1%" height="25" style="text-align:left">
													<?php
		                                            if($BR_STAT == 1)
		                                            {
		                                                ?>
		                                        ...
		                                        <!-- BR_CODE, DocumentNo, DocumentRef -->
		                                      	<td width="8%" style="text-align:left" nowrap>
													<?php echo $ManNOPD; ?>
		                                        ...
		                                        <td width="7%" style="text-align:right; display:none" nowrap><input type="text" name="INV_Amount_PPn<?php echo $currentRow; ?>" id="INV_Amount_PPn<?php echo $currentRow; ?>" value="<?php echo number_format($Inv_Amount_PPn, $decFormat); ?>" size="15" class="form-control" style="min-width:110px; max-width:200px; text-align:right" disabled >
		                                      	...
		                                      	<!-- Amount -->
		                                      	<td width="11%" style="text-align:right" nowrap>
