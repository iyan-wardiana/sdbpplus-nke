...
if($LangID == 'IND')
{
    $h1_title   = 'Bukti Penerimaan Kas / Bank';
}
else
{
    $dh1_title  = 'Bukti Penerimaan Kas / Bank';
}

$EMP_NAME       = "";
$REK            = "";
$s_emp          =  "SELECT CONCAT(First_Name, ' ', Last_Name) AS EMP_NAME, '' AS NO_REK, '' AS NM_REK, '' AS NM_BANK FROM tbl_employee WHERE Emp_ID = '$BR_PAYFROM'
                    UNION
                    SELECT SPLDESC AS EMP_NAME, SPLNOREK AS NO_REK, SPLNMREK AS NM_REK, SPLBANK AS NM_BANK FROM tbl_supplier WHERE SPLCODE = '$BR_PAYFROM'";
        ...
        <div class="cont">
            <div class="box-header">
                ...
                <div class="box-column-title">
                    <span><u><?php echo $h1_title; ?></u></span>
                </div>
                <div class="pageno">
                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td width="5">:</td>
                            <td>&nbsp;<?php echo date('d-m-Y', strtotime($BR_DATE)); ?></td>
                        </tr>
                    </table>
                </div>
            </div>
            <div class="box-header-detail col-7" style="padding-top: 60px;">
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <tr style="vertical-align: top;">
                        ...
                        <td width="5">:</td>
                        <td><?php echo "$BR_PAYFROM - $EMP_NAME"; ?></td>
                    </tr>
                    <tr>
            ...
            <div class="box-detail">
                <table width="100%" cellpadding="0" cellspacing="0">
                    ...
                    <tbody>
                        <?php
                            // get Voucher Detail
                            $this->db->select("A.JournalH_Code, A.JournalType, A.JournalH_Desc, A.JournalH_Desc2, A.JournalH_Date, A.JournalH_Date_PD, A.PlanRDate, A.Reference_Number, A.Reference_Type, A.ISPERSL, A.PERSL_EMPID, A.Journal_Amount, A.PPNH_Amount, A.PPHH_Amount, A.GJournal_Total, A.Manual_No, A.SPLCODE, A.GEJ_STAT, B.Acc_Id, B.Manual_No, B.Faktur_No, B.Other_Desc, B.Base_Debet, B.Base_Kredit, B.Journal_DK, B.Acc_Name");
                            $this->db->from("tbl_journalheader_$PRJCODEVW A");
                            $this->db->join("tbl_journaldetail_$PRJCODEVW B", "B.JournalH_Code = A.JournalH_Code AND B.proj_Code = A.proj_Code", "INNER");
                            $this->db->where(["B.JournalH_Code" => $BR_NUM, "A.GEJ_STAT" => 3]);
                            ...
                            if($getVoucher->num_rows() > 0)
                            {
                                ...
                                foreach($getVoucher->result() as $rVOC):
                                    ...
                                    $Reference_Number = $rVOC->Reference_Number;
                                    ...
                                    // get Voucher_pd
                                    $VOUCHER_CODE = $this->db->get_where("tbl_journalheader", ["JournalH_Code" => $Reference_Number, "GEJ_STAT" => 3])->row("Manual_No");
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php
                                                    ...
                                                    {
                                                        ?>
                                                            <div style="padding-left: 5px;">Voucher No. <b><?=wordwrap($VOUCHER_CODE, 40, "<br>", true)?></b></div>
                                                            <div style="padding-left: 5px; font-style: italic;"><?=wordwrap($Other_Desc, 40, "<br>", true)?></div>
                                                        <?php
                                                    }
                                                    else
                                                    {
                                                        $ReceiptDesc = "Penerimaan dari $EMP_NAME";
                                                        ?>
                                                            <div style="padding-left: 5px;"><?=wordwrap($ReceiptDesc, 40, "<br>", true)?></div>
                                                            <div style="padding-left: 5px; font-style: italic;"><?=wordwrap($Other_Desc, 40, "<br>", true)?></div>
                                                        <?php
                                                    }
                                                ?>
                                            </td>
                                            <td style="padding-right: 5px;"><?php echo $Acc_Id;?></td>
                                            <td style="padding-right: 5px;"><?php echo wordwrap($Acc_Name, 20, "<br>", true);?></td>
                                            <td style="padding-right: 5px; text-align: right;"><?php echo number_format($Base_Debet, 2);?></td>
                                            <td style="padding-right: 5px; text-align: right;"><?php echo number_format($Base_Kredit, 2);?></td>
                                        </tr>
                                    <?php
                                endforeach;
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="4">
                                <span>Terbilang :</span>
                                <span><?php echo $moneyFormat->terbilang(abs($TBase_Debet)); ?></span>
                            </td>
                            <td style="padding-right: 5px; text-align: right; font-weight: bold;"><?php echo number_format($TBase_Debet, 2); ?></td>
                            <td style="padding-right: 5px; text-align: right; font-weight: bold;"><?php echo number_format($TBase_Kredit, 2); ?></td>
                        </tr>
                    </tfoot>
                </table>
            </div>
