...
<html>
    ...
    <body class="<?php echo $appBody; ?>" style="background-color: <?=$comp_color?>">
        <section class="content-header">
            <h1>
            <img src="<?php echo base_url() . 'assets/AdminLTE-2.0.5/dist/img/icon/list.png'; ?>" style="max-width:40px; max-height:40px" >&nbsp;&nbsp;<?php echo $Approval; ?>
            <small><?php echo $BankReceipt; ?></small>
            </h1>
        </section>
                            ...
                            <tr style="display:none">
                                <td colspan="10">
                                	...
                                	<button class="btn btn-warning" style="display:none">
                                    	<i class="cus-print-16x16"></i>&nbsp;&nbsp;<?php echo $Print; ?>
                                    </button>
                            	</td>
                            </tr>
                        </table>
