    	...
    	<section class="content-header">
            <h1>
                ...
                <div class="pull-right">
                    <?php
                        $backURL    = site_url('c_finance/c_40wnp1ymt/prj180c21l_1n2/inbox/?id=');
                    	...
                    	<table id="example" class="table table-bordered table-striped" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th width="25%" style="text-align:center; vertical-align:middle" nowrap><?php echo $SupplierName ?></th>
                                    <th width="34%" style="text-align:center; vertical-align:middle" nowrap><?php echo $Description ?></th>
                                    <th width="10%" style="text-align:center; vertical-align:middle" nowrap><?php echo $Amount ?></th>
                                    <th width="9%" style="text-align:center; vertical-align:middle" nowrap><?php echo $Used ?></th>
...
<script>
    ...
    $('#example').DataTable( {
		...
		"autoWidth": true,
		"filter": true,
        "ajax": "<?php echo site_url('c_finance/c_40wnp1ymt/get_AllData_1n2/?id='.$PRJCODE)?>",
        "type": "POST",
		//"lengthMenu": [[10, 25, 50, 100, 200, -1], [10, 25, 50, 100, 200, "All"]],
		"lengthMenu": [[10, 25, 50, 100, 200], [10, 25, 50, 100, 200]],
		"columnDefs": [	{ targets: [1,2,7,8], className: 'dt-body-center' },
