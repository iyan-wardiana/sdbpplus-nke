...
// $EMPNAME = $this->db->select("CONCAT(First_Name,' ',Last_Name) AS FullName", false)->from("tbl_employee")->where(["Emp_ID" => $SPLCODE, "Employee_status" => 1])->get()->row("FullName");
    ...
    $this->db->where(["JournalH_Code" => $DP_NUM, "Ref_Number !=" => "", "Journal_DK" => 'D']);
    ...
    $PPNH_Amount    = $DP_AMOUNT_PPN;
    $PPHH_Amount    = $DP_AMOUNT_PPH;
    $Tot_TAX        = $PPNH_Amount - $PPHH_Amount;
    $Amount         = $DP_AMOUNT;
    $TAmount        = $DP_AMOUNT + $PPNH_Amount - $PPHH_Amount;
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body class="page A4">
        ...
        <div class="cont">
            <div class="box-header">
                ...
                <div class="box-column-title">
                    <span>VOUCHER <br>UANG MUKA</span>
                </div>
            </div>
            ...
            <div class="box-detail">
                <table width="100%" border="1" cellpadding="0" cellspacing="0">
                    ...
                    <tbody>
                        <tr>
                            <td width="100">&nbsp;</td>
                            <td>&nbsp;Pembayaran Tagihan No.&nbsp;<?php echo $DP_CODE; ?></td>
                            <td width="200" style="text-align: right;"><?php echo number_format($DP_AMOUNT, 2); ?>&nbsp;</td>
                        </tr>
                        <?php
                            $Reference_Number = '';
                            if($Reference_Number == '')
    ...
    <section class="page sheet custom" style="display: none;">
        <div class="cont">
            <div class="box-header">
                <div class="box-column-logo">
                    <img src="<?=base_url()?>/assets/AdminLTE-2.0.5/dist/img/NKELogo.jpg">
