                    	...
                    	<table id="example" class="table table-bordered table-striped" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th width="9%" style="text-align:center; vertical-align:middle"><?php echo "Pengembalian Uang Muka"; ?></th>
                                    <th width="9%" style="text-align:center; vertical-align:middle"><?php echo $Remain; ?></th>
...
<script>
    ...
    $('#example').DataTable( {
		...
		"autoWidth": true,
		"filter": true,
        "ajax": "<?php echo site_url('c_finance/c_40wnp1ymt/get_AllData/?id='.$PRJCODE)?>",
        "type": "POST",
