...
if($task == 'add')
{
	...
	$sql 		= "SELECT MAX(Patt_Number) as maxNumber FROM tbl_dp_header WHERE Patt_Year = $year AND PRJCODE = '$PRJCODE'";
	...
	$month			= date('m');
	$days			= date('d');
	$DocNumber 		= "$Pattern_Code$PRJCODE$year$month$days-$lastPatternNumb";
	$DP_NUM			= $DocNumber;
	$DP_CODE		= "$lastPatternNumb"; // OP MANUAL
	
	$DPCODE			= substr($lastPatternNumb, -4);
	$DPYEAR			= date('y');
	$DPMONTH		= date('m');
	$DP_CODE		= "DP.$DPCODE.$DPYEAR.$DPMONTH"; // MANUAL CODE
                        ...
                        <div class="box box-warning">
                            ...
                            <div class="box-body">
		                        ...
		                        <div class="form-group">
		                          	...
		                          	<div class="col-sm-5">
		                                <input type="text" class="form-control" name="DP_CODE" id="DP_CODE" value="<?php echo $DP_CODE; ?>" >
		                          	</div>
		                          	<div class="col-sm-4">
		                          		<label for="inputName" class="control-label">TTK No.</label>
		                            </div>
		                        </div>
		                        <div class="form-group">
		                          	...
		                          	<div class="col-sm-5">
		                                <div class="input-group date">
		                                    ...
		                                    <input type="text" name="DP_DATE" class="form-control pull-left" id="datepicker1" value="<?php echo $DP_DATE; ?>" style="width:100px">
		                                </div>
		                          	</div>
		                          	<div class="col-sm-4">
		                        ...
		                        <div class="form-group">
		                          	<label for="inputName" class="col-sm-3 control-label">No. Ref / <?php echo $Amount ?> </label>
		                          	<div class="col-sm-5">
		                          	...
		                          	<div class="col-sm-4">
		                                <input type="text" class="form-control" style="text-align: right;" name="DP_REFAMOUNT1" id="DP_REFAMOUNT1" value="<?php echo number_format($DP_REFAMOUNT, 2); ?>" readonly>
		                        ...
		                        <div class="form-group">
		                          	...
		                          	<div class="col-sm-2">
		                                <input type="text" class="col-sm-2 form-control" style="text-align:right" name="DP_PERC1" id="DP_PERC1" value="<?php echo number_format($DP_PERC, 2); ?>" onBlur="getPercDP(this);" title="Persentase" >
                            ...
                            <div class="box-body">
		                        ...
		                        <div class="form-group" >
		                          	...
		                          	<div class="col-sm-9">
										...
										?>
		                                <select name="DP_STAT" id="DP_STAT" class="form-control select2">
		                                    <?php
		                                    if($DP_STAT != 1 AND $DP_STAT != 4) 
		                                    {
		                                        ?>
