    ...
    <body class="<?php echo $appBody; ?>" style="background-color: <?=$comp_color?>">
		...
		<section class="content">
            <form name="frmsrch1" id="frmsrch1" action="" method=POST style="display:none">
                <input type="text" name="WO_NUM" id="WO_NUM" value="<?php echo $DP_REFNUM; ?>" />
                        ...
                        <div class="box box-warning">
                            ...
                            <div class="box-body">
		                        <div class="form-group" style="display:none">
		                          	...
		                          	<div class="col-sm-9">
		                                <input type="text" class="form-control" style="max-width:195px" name="DP_NUM1" id="DP_NUM1" value="<?php echo $DocNumber; ?>" disabled >
		                       			<input type="hidden" class="textbox" name="DP_NUM" id="DP_NUM" size="30" value="<?php echo $DocNumber; ?>" />
		                                <input type="hidden" name="Patt_Number" id="Patt_Number" value="<?php echo $lastPattNo; ?>">
		                          	</div>
		                        </div>
		                        <div class="form-group">
		                          	<label for="inputName" class="col-sm-3 control-label"><?php echo $ManualCode ?> </label>
		                          	<div class="col-sm-9">
		                                <input type="hidden" class="form-control" name="DP_CODE" id="DP_CODE" value="<?php echo $DP_CODE; ?>" >
		                                <input type="text" class="form-control" name="DP_CODE1" id="DP_CODE1" value="<?php echo $DP_CODE; ?>" disabled >
		                          	</div>
		                        </div>
		                        <div class="form-group">
		                          	...
		                          	<div class="col-sm-9">
		                                <div class="input-group date">
		                                    ...
		                                    <input type="text" name="DP_DATE1" class="form-control pull-left" id="datepicker1" value="<?php echo $DP_DATE; ?>" style="width:100px" disabled>
		                                </div>
		                          	</div>
		                        	<input type="hidden" name="DP_DATE" id="DP_DATE" value="<?php echo $DP_DATE; ?>">
		                        </div>
		                        <div class="form-group" style="display: none;">
		                        ...
		                        <div class="form-group">
		                          	...
		                          	<div class="col-sm-5">
		                                <div class="input-group">
		                                    ...
		                                    <input type="text" class="form-control" name="DP_REFCODE" id="DP_REFCODE" value="<?php echo $DP_REFCODE; ?>" onClick="pleaseCheck();" <?php if($DP_STAT != 1 && $DP_STAT != 6) { ?> disabled <?php } ?>>
		                                    <input type="hidden" class="form-control" name="DP_REFNUM" id="DP_REFNUM" style="max-width:200px" value="<?php echo $DP_REFNUM; ?>" >
		                                </div>
		                            </div>
		                          	<div class="col-sm-4">
		                                <input type="text" class="form-control" style="max-width:195px; text-align: right;" name="DP_REFAMOUNT1" id="DP_REFAMOUNT1" value="<?php echo number_format($DP_REFAMOUNT, 2); ?>" readonly>
		                                <input type="hidden" class="form-control" style="max-width:195px; text-align: right;" name="DP_REFAMOUNT" id="DP_REFAMOUNT" value="<?php echo $DP_REFAMOUNT; ?>">
		                            </div>
		                        </div>
		                        <div class="form-group">
		                        ...
		                        <div class="form-group">
		                          	...
		                          	<div class="col-sm-2">
		                                <input type="text" class="col-sm-2 form-control" style="text-align:right" name="DP_PERC1" id="DP_PERC1" value="<?php echo number_format($DP_PERC, 2); ?>" onBlur="getPercDP(this);" title="Persentase" readonly>
		                                <input type="hidden" class="form-control" name="DP_PERC" id="DP_PERC" value="<?php echo $DP_PERC; ?>" >
		                          	</div>
		                          	<div class="col-sm-4">
		                                <input type="text" class="form-control" style="text-align:right" name="DP_AMOUNT1" id="DP_AMOUNT1" value="<?php echo number_format($DP_AMOUNT, 2); ?>" onBlur="getValueDP(this);" readonly >
		                                <input type="hidden" class="form-control" name="DP_AMOUNT" id="DP_AMOUNT" value="<?php echo $DP_AMOUNT; ?>" >
		                          	</div>
		                          	<div class="col-sm-3">
		                                <input type="text" class="form-control" style="text-align:right" name="DP_AMOUNT_USED1" id="DP_AMOUNT_USED1" value="<?php echo number_format($DP_AMOUNT_USED, 2); ?>" readonly >
												...
												if($canApprove == 1)
												{
													...
													?>
														<select name="DP_STAT" id="DP_STAT" class="form-control select2" <?php if($disButton == 1) { ?> disabled <?php } ?> >
															...
															<option value="3"<?php if($DP_STAT == 3) { ?> selected <?php } ?>>Approved</option>
