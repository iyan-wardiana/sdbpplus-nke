                        ...
                        <td colspan="5" class="style2" style="text-align:left">
                          	<table width="100%" border="0" style="size:auto">
                            	<tr>
                                    ...
                                    <td width="35%">: <?php echo $DP_CODE; ?></td>
                                    <td width="10%">Proyek</td>
                                    <td width="45%">: <?php echo "$PRJCODE - $PRJNAME"; ?></td>
                                </tr>
                                <tr>
                                    <td nowrap>Tanggal Dok.</td>
                        ...
                        <td colspan="5" class="style2">
                            <table width="100%" border="1" rules="all">
                                <tr style="background:#CCCCCC">
                                    <td width="60%" height="37" nowrap style="text-align:center; font-weight:bold" colspan="3">Keterangan</td>
                                    <td width="20%" nowrap style="text-align:center; font-weight:bold">No. Rekening</td>
                                    <td width="20%" nowrap style="text-align:center; font-weight:bold">J u m l a h</td>
                                </tr>
                                <tr height="300px">
                                    <td nowrap style="text-align:left; vertical-align:top" colspan="3">
                                        <?php
                                            echo "$SPLCODE : $SPLDESC<br><br>Deskripsi:<br><font style='font-style: italic'>$DP_NOTES</font>";
                                        ?>
                                    </td>
                                ...
                                <tr>
                                    <td width="32%" height="129" style="text-align:center; border-right: none;"> Dibuat oleh : <br>
                                        <br>
                                        <br>
                                        <br>
                                        <br>
                                    ...
                                    <td width="36%" style="text-align:center; border-left: none; border-right: none;"> Diperiksa : <br>
                                        <br>
                                        <br>
                                        <br>
                                        <br>
                                    ...
                                    <td width="32%" style="text-align:center; border-left: none;"> Disetujui : <br>
                                        <br>
                                        <br>
                                        <br>
                                        <br>
                                    ...
                                    <td style="text-align:left; vertical-align:top; border-right: none;" nowrap>
                                        <br>
                                        Diterima sejumlah (Rp) :
                                        <br><br><br><br><br>
                                        <div style="text-align:center">___________<br>
                                        Penerima</div>
                                    </td>
                                    <td style="text-align:left; vertical-align:top; border-left: none;" nowrap>
                                        <br>
