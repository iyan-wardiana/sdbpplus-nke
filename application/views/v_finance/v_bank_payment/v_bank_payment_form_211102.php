                            	...
                            	<div class="col-sm-4">
	                                <div class="form-group"> <!-- SOURCE NUMBER -->
	                                    ...
	                                    <select name="CB_SOURCE" id="CB_SOURCE" class="form-control select2" onChange="selectAccount(this.value)">
			                                <option value=""> --- </option>
			                                <option value="PINV" <?php if($CB_SOURCE == 'PINV'){ ?> selected <?php } ?>>TTK</option>
                            ...
                            <div class="box-body">
                            	...
                            	<div class="col-sm-12">
									<?php if($CB_SOURCE != 'GEJ') { ?>
	                                    <div class="form-group"> <!-- CHOOSE DOC. -->
	                                        ...
	                                        <button class="btn btn-warning" type="button" onClick="selectitem();" <?php if($CB_STAT != 1 && $CB_STAT != 4) { ?>disabled <?php } ?>>
			                    ...
			                    <script>
									...
									function selectitem()
									{
										...
										SEL_ACC	= document.getElementById('selAccount').value;
										if(SEL_ACC == 0)
										{
											...
											document.getElementById('selAccount').focus();
											return false;
										}
				                      	...
				                      	<td colspan="8" align="left" class="style1">
					                        <table id="tbl" class="table table-bordered table-striped" width="100%">
					                            <tr style="background:#CCCCCC">
					                              	...
					                              	<th width="10%" style="text-align:center"><?php echo $InvoiceAmount; ?> </th>
					                              	<th colspan="5" style="text-align:center"><?php echo $Payment; ?> </th>
					                            </tr>
					                            <tr style="background:#CCCCCC">
					                              	<th width="10%" style="text-align:center;"><?php echo $Amount; ?> </th>
					                              	<th width="10%" style="text-align:center;"><?php echo $Amount; ?> </th>
					                              	<th width="10%" style="text-align:center; display:none" nowrap>PPh</th>
					                              	<th width="10%" style="text-align:center; display:none" nowrap>&nbsp;</th>
					                              	<th width="10%" style="text-align:center;" nowrap>Disc.</th>
						                                ...
						                                if($resultCount > 0)
						                                {
						                                    foreach($result as $row) :
																...
																// GET THE FIRST SOURCE : OPN OR IR
																	...
																	if($CB_CATEG == 'IR')
																	{
																		$sqlINV			= "SELECT INV_CODE FROM tbl_pinv_header
																							WHERE INV_NUM = '$DocumentNo' LIMIT 1";
																		$resINV 		= $this->db->query($sqlINV)->result();
																		foreach($resINV as $rowINV) :
																			$DocumentRef1	= $rowINV->INV_CODE;
																			$DocumentRef2	= "-";
																		endforeach;
																		$INV_CODE		= $DocumentRef1;
																	}
																	else
																	{
						                                        ...
						                                        ?>
							                                        ...
							                                        <td style="text-align:right" >
																		<?php if($CB_STAT == 1 || $CB_STAT == 4) { ?>
																			<input type="text" name="Inv_Amount<?php echo $currentRow; ?>" id="Inv_Amount<?php echo $currentRow; ?>" value="<?php echo number_format($Inv_TOT_Am, $decFormat); ?>" class="form-control" style="min-width:120px; max-width:150px; text-align:right" title="Nilai Total Inv" disabled >
																		<?php } else { ?>
																			<?php echo number_format($Inv_Amount, $decFormat); ?>
																			<input type="hidden" name="Inv_Amount<?php echo $currentRow; ?>" id="Inv_Amount<?php echo $currentRow; ?>" value="<?php echo number_format($Inv_TOT_Am, $decFormat); ?>" class="form-control" style="min-width:120px; max-width:150px; text-align:right" title="Nilai Total Inv" disabled >
																		<?php } ?>
							                                        ...
							                                        <td style="text-align:right" >
																		...
																		<?php } else { ?>
																			...
																			<input type="hidden" name="Amount<?php echo $currentRow; ?>" id="Amount<?php echo $currentRow; ?>" value="<?php echo number_format($Amount, $decFormat); ?>" class="form-control" style="min-width:130px; max-width:150px; text-align:right" onKeyPress="return isIntOnlyNew(event);" onBlur="chgPayAmount(this,<?php echo $currentRow; ?>);" title="Nilai Total Inv" >
																		<?php } ?>
							                                        ...
							                                        <!-- PPh & Retensi Amount -->
							                                      	...
							                                      	<td style="text-align:right;">
																		...
																		<?php } else { ?>
							                                        		...
							                                        		<input type="hidden" name="DPAmount<?php echo $currentRow; ?>" id="DPAmount<?php echo $currentRow; ?>" value="<?php echo number_format($DPAmount, $decFormat); ?>" class="form-control" style="min-width:130px; max-width:150px; text-align:right" onKeyPress="return isIntOnlyNew(event);" onBlur="chgAftDP(this,<?php echo $currentRow; ?>);" title="Nilai Pot Pemb." >
																		<?php } ?>
...
<script>
	...
	function chgAftDP(thisVal1, row)
	{
		...
		var DPAMOUNT 		= document.getElementById('CB_DPAMOUNT');
		//chgDPAmount(DPAMOUNT);
		countAllInvoice();
	}
	...
	function countAllInvoice()
	{
		...
		for(i=1;i<=totrow;i++)
		{
			...
			// SISI NILAI INVOICE - TOTAL PER ROW
				Inv_TOT_Am		= parseFloat(Inv_Amount) + parseFloat(Inv_Amount_PPn);				// Nilai Inv. dan PPn
				Inv_TOT_AmG		= parseFloat(Inv_TOT_AmG) + parseFloat(Inv_Amount);					// Nilai Inv. Non PPn
			...
			// SISI NILAI PEMBAYARAN INVOICE - TOTAL PER ROW
		...
		// Pay_TOT_POTG	= parseFloat(Pay_TOT_POT) + parseFloat(GTOT_DP); // POT DP SUDAH ADA PADA BARIS KE 3113
		Pay_TOT_POTG	= parseFloat(Pay_TOT_POT);
