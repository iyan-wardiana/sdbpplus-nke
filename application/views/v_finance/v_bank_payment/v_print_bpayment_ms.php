...
<section class="content">
    ...
    <tr>
        ...
        <td width="10%" class="style2" style="text-align:left; font-size:12px" valign="top"><u>007</u></td>
    </tr>
    <tr>
      ...
      <td colspan="5" class="style2" style="text-align:left">
      	<table width="100%" border="0" style="size:auto">
            ...
            <tr>
              ...
              <td valign="bottom">: Moch Aris Risnandar</td>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
                    	...
                    	<table width="100%" border="0">
                            <tr height="30px" valign="middle">
                                <td width="32%" height="129">
                                    ...
                                    <br><br><br><br><br>
                                    <div style="text-align:center">Moch Aris Risnandar<br>
                                    Penerima</div>
                                </td>
                              <td width="36%">
                                	Rp <?php echo number_format($GCB_TOTAM, 2); ?>
                                    <br><br><br><br><br>
                                    <div style="text-align:center">15-Dec-2017<br>
                                    Tanggal</div>
                                </td>
                            </tr>
                        </table>
