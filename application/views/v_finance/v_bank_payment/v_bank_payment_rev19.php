            ...
            <div class="search-table-outter">
                <table id="example1" class="table table-bordered table-striped table-responsive search-table inner" width="100%">
                    ...
                    <tr>
                        ...
                        <th width="30%" style="text-align:center"><?php echo $BankAccount; ?></th>
                        <th width="17%" style="text-align:center"><?php echo $Payment; ?></th>
                        <th width="4%" style="text-align:center; display:none" nowrap><?php echo $Memo; ?></th>
                        ...
                        if($cData > 0)
                        {
                            ...
                            foreach($vData as $row) :
                        		...
                        		?>
									...
									<?php
										$secUpd		= site_url('c_finance/c_bp0c07180851/update/?id='.$this->url_encryption_helper->encode_url($JournalH_Code));
                                    ...
                                    <td style="text-align:center" nowrap>
                                        ...
                                        <a href="javascript:void(null);" class="btn btn-primary btn-xs" title="Print" onClick="printDocument('<?php echo $myNewNo; ?>')">
