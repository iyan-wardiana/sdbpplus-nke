						                                ...
						                                if($resultCount > 0)
						                                {
						                                    foreach($result as $row) :
						                                        ...
						                                        ?>
							                                        ...
							                                        <td style="text-align:right" > <!-- CBD_AMOUNT_DISC -->
																		<?php if($CB_STAT == 1 || $CB_STAT == 4) { ?>
						                            ...
						                            elseif($CB_SOURCENO != '' && $task == 'add')
						                            {
						                                ...
						                                foreach($result as $row) :
															...
															<td width="47%" style="text-align:left">
																<input type="text" name="data[<?php echo $currentRow; ?>][CBD_DESC]" id="data<?php echo $currentRow; ?>CBD_DESC" value="<?php echo $ITM_NAME; ?>" class="form-control" style="max-width:600px;" >                                      	</td>
															...
															<td width="2%" style="text-align:center; display:none">
																<input type="hidden" name="data[<?php echo $currentRow; ?>][Notes]" id="data<?php echo $currentRow; ?>Notes" value="<?php echo $Notes; ?>" class="form-control" style="max-width:500px;" >
																<input type="text" name="totalrow" id="totalrow" value="<?php echo $currentRow; ?>">                                        </td>
						                                	</tr>
						                              	<?php
						                                endforeach;
						                            }
