	                            ...
	                            <div class="col-sm-9">
									<?php
		                                ...
		                                if($ShowBtn == 1)
		                                {
		                                    ...
		                                    {
		                                        ?>
		                                            <button class="btn btn-primary" id="tblSave" <?php if($CB_STAT == 3) { ?> style="display:none" <?php } ?>>
		                                            <i class="fa fa-save"></i></button>&nbsp;
		                                        <?php
		                                    }
		                                }
											                ...
											                <?php } ?>
										              		<?php if($CB_SOURCE == 'VCASH') { ?>
											                    <li id="li1" <?php echo $Active2Cls; ?>>
											                    	<a href="#itm2" onclick="showVC();" data-toggle="tab"><?php echo $VCList." - ".$SPLDESC; ?> AA</a>
											                    </li>
											                <?php } ?>
								...
								<script type="text/javascript">
									$(document).ready(function()
									{
								    	$('#example0').DataTable(
								    	{
											...
											"autoWidth": true,
											"filter": true,
									        "ajax": "<?php echo site_url('c_finance/c_bp0c07180851/get_AllDataINV/?id='.$colPAYERID.'&DocNumber='.$CB_NUM)?>",
									        "type": "POST",
								    	...
								    	$('#example1').DataTable(
								    	{
											...
											"autoWidth": true,
											"filter": true,
									        "ajax": "<?php echo site_url('c_finance/c_bp0c07180851/get_AllDataVC/?id='.$colPAYERID.'&DocNumber='.$CB_NUM)?>",
									        "type": "POST",
											//"lengthMenu": [[10, 25, 50, 100, 200, -1], [10, 25, 50, 100, 200, "All"]],
											"lengthMenu": [[10, 25, 50, 100, 200], [10, 25, 50, 100, 200]],
											"columnDefs": [	{ targets: [0], className: 'dt-body-center' },
								    	...
								    	$('#example2').DataTable(
								    	{
											...
											"autoWidth": true,
											"filter": true,
									        "ajax": "<?php echo site_url('c_finance/c_bp0c07180851/get_AllDataPPD/?id='.$colPAYERID.'&DocNumber='.$CB_NUM)?>",
									        "type": "POST",
											//"lengthMenu": [[10, 25, 50, 100, 200, -1], [10, 25, 50, 100, 200, "All"]],
											"lengthMenu": [[10, 25, 50, 100, 200], [10, 25, 50, 100, 200]],
											"columnDefs": [	{ targets: [0], className: 'dt-body-center' },
								    	...
								    	$('#example3').DataTable(
								    	{
											...
											"autoWidth": true,
											"filter": true,
									        "ajax": "<?php echo site_url('c_finance/c_bp0c07180851/get_AllDataPD/?id='.$colPAYERID.'&DocNumber='.$CB_NUM)?>",
									        "type": "POST",
											//"lengthMenu": [[10, 25, 50, 100, 200, -1], [10, 25, 50, 100, 200, "All"]],
											"lengthMenu": [[10, 25, 50, 100, 200], [10, 25, 50, 100, 200]],
											"columnDefs": [	{ targets: [0], className: 'dt-body-center' },
