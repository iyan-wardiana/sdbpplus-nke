...
{	
	...
	$sql 	= "tbl_fpa_header WHERE Patt_Year = $yearC AND PRJCODE = '$PRJCODE'";
...
{
	$FPA_CATEG 		= $_POST['FPA_CATEG_X'];
	$SPLCODE 		= $_POST['SPLCODE_X'];
}
?>
<!DOCTYPE html>
<html>
...
<?php
	...
	$secGetJID	= base_url().'index.php/c_finance/c_f180p0/getJID/'; // Generate Code
?>
...
<section class="content">
    <div class="box box-primary">
        ...
        <form class="form-horizontal" name="frm1" id="frm1" method="post" action="" style="display:none">
        	<input type="text" name="FPA_CATEG_X" id="FPA_CATEG_X" value="<?php echo $FPA_CATEG; ?>" />
        	<input type="text" name="SPLCODE_X" id="SPLCODE_X" value="<?php echo $SPLCODE; ?>" />
        ...
        <form class="form-horizontal" name="frm" method="post" action="<?php echo $form_action; ?>" enctype="multipart/form-data" onSubmit="return validateInData()">
            ...
            <input type="Hidden" name="rowCount" id="rowCount" value="0">
            	...
            	<div class="form-group" style="display:none">
                    <label for="inputName" class="col-sm-2 control-label">No. RPM</label>
                    <div class="col-sm-10">
            	...
            	<div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <label>
                            <input type="text" class="form-control" style="min-width:110px; max-width:180px; text-align:left" id="FPA_CODE" name="FPA_CODE" value="<?php echo $FPA_CODE; ?>" />
                        </label>
                        <label>
            	...
            	<div class="form-group">
                    ...
                    <div class="col-sm-10">
                    	<select name="FPA_CATEG" id="FPA_CATEG" class="form-control select2" style="max-width:150px" onChange="chkSPL(this.value)">
                          <option value="">--- None ---</option>
                          <?php /*?><option value="SUB" style="display:none" <?php if($FPA_CATEG == 'SUB') { ?> selected <?php } ?>> Sub Contractor</option><?php */?>
                          <option value="OHP" <?php if($FPA_CATEG == 'OHP') { ?> selected <?php } ?>> Over Head</option>
                          <?php /*?><option value="RPA" <?php if($FPA_CATEG == 'RPA') { ?> selected <?php } ?> style="display:none"> Rupa - Rupa</option><?php */?>
                ...
                <script>
					function chkSPL(GEJTYPE)
					{
						if(GEJTYPE == 'OTH')
						{
							...
							document.getElementById('splGEJID').style.display = '';
						}
						else
						{
							document.getElementById('splID').style.display = 'none';
							document.getElementById('splGEJID').style.display = 'none';
						}
					}
				</script>
                <?php
            	...
            	<div class="form-group" id="splID" <?php if($FPA_CATEG != 'OTH') { ?> style="display:none" <?php } ?>>
                    ...
                    <div class="col-sm-10">
                        <select name="SPLCODE" id="SPLCODE" class="form-control select2" data-placeholder="&nbsp;&nbsp;&nbsp;<?php echo $SupplierName; ?>" style="width:400px;" onChange="selSPL(this.value)">
                        	<option value=""> --- </option>
							<?php
                            $i = 0;
				...
				<script>
                    function selSPL()
                    {
                        ...
                        document.getElementById('FPA_CATEG_X').value = FPA_CATEG;
                        SPLCODE		= document.getElementById('SPLCODE').value;
                        document.getElementById('SPLCODE_X').value = SPLCODE;                        
            	...
            	<div class="form-group" id="splGEJID" <?php if($FPA_CATEG != 'OTH') { ?> style="display:none" <?php } ?>>
                    ...
                    <div class="col-sm-10">
                        <select name="GEJ_NUM" id="GEJ_NUM" class="form-control select2" data-placeholder="&nbsp;&nbsp;&nbsp;Ref. No." style="width:400px;">
                        	<option value=""> --- </option>
							<?php
                            $i = 0;
            	...
            	<div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <select name="JOBCODEID[]" id="JOBCODEID" class="form-control select2" multiple="multiple" data-placeholder="&nbsp;&nbsp;&nbsp;<?php echo $JobName; ?>" onBlur="selJOB(this.value)">
                        	<option value="">--- None ---</option>
							<?php
                                $Disabled_1	= 0;
            	...
            	<div class="form-group">
                    ...
                    <div class="col-sm-10">
                    	<textarea name="FPA_NOTE" class="form-control" id="FPA_NOTE" cols="30"><?php echo $FPA_NOTE; ?></textarea>                        
                    </div>
                </div>
            	<div class="form-group" <?php if($FPA_NOTE2 == '') { ?> style="display:none" <?php } ?>>
                    <label for="inputName" class="col-sm-2 control-label"><?php echo $ApproverNotes; ?></label>
                    <div class="col-sm-10">
                    	<textarea name="FPA_NOTE2" class="form-control" id="FPA_NOTE2" cols="30" disabled><?php echo $FPA_NOTE2; ?></textarea>                        
                    </div>
                </div>
            	<div class="form-group">
                    ...
                    <div class="col-sm-10">
						...
						<?php
							...
							?>
								<select name="FPA_STAT" id="FPA_STAT" class="form-control select2" style="max-width:150px">
									<?php
									if($FPA_STAT != 1 AND $FPA_STAT != 4) 
									{
										?>
											...
											<option value="9"<?php if($FPA_STAT == 9) { ?> selected <?php } ?>>Void</option>
										<?php
									}
									else
									{
							...
							<?php
							$theProjCode 	= "$PRJCODE";
                        	$url_AddItem	= site_url('c_finance/c_f180p0/popupallitem/?id=');
                        ?>
                    </div>
                </div>
                <script>
					$(document).ready(function(e) {
                        $("#FPA_STAT").change(function(e) {
                            var FPASTAT	= $("#FPA_STAT").val();
							if(FPASTAT == 6 || FPASTAT == 9)
							{
								$("#chkClose").show();
							}
							else
                    ...
                    <div class="col-md-12">
                        ...
                        <table width="100%" border="1" id="tbl">
                        	<tr style="background:#CCCCCC">
                              ...
                              <th rowspan="2" style="text-align:center;"><span style="text-align:center"><?php echo $Remarks;?></span></th>
                          	</tr>
                            <tr style="background:#CCCCCC">
                            ...
                            if($task == 'edit')
                            {
								...
								/*	if ($j==1) {
									...
									<?php
										...
										// GET TOT REQ
										// DIGANTI KE TOT FPA : MS.2019100400020 : perbaikan perencanaan pengeluaran
										$sqlTOTREQ		= "SELECT SUM(A.FPA_VOLM) AS REQ_VOLM, SUM(A.FPA_TOTAL) AS REQ_AMOUNT FROM tbl_fpa_detail A
																INNER JOIN tbl_fpa_header B ON B.FPA_NUM = A.FPA_NUM
															WHERE A.JOBCODEID = '$JOBCODEID' AND A.PRJCODE = '$PRJCODE'
																AND ITM_CODE = '$ITM_CODE' AND B.FPA_STAT IN (3,6)";
										$resTOTREQ		= $this->db->query($sqlTOTREQ)->result();
										foreach($resTOTREQ as $rowTOTREQ) :
											$REQVOLM	= $rowTOTREQ->REQ_VOLM;
											$REQAMOUNT	= $rowTOTREQ->REQ_AMOUNT;
										endforeach;
										if($REQVOLM != '')
											$TOTWOQTY 	= $REQVOLM;
										
										if($REQVOLM != '')
											$TOTWOAMOUNT = $REQAMOUNT;
									...
									<td width="8%" style="text-align:right"> <!-- Item Bdget -->
                                     ...
                                     <td width="7%" style="text-align:center; font-style:italic">
                                     	<?php if($ISWAGE == 0) { ?>
                                        	<input type="text" name="ITM_PRICE<?php echo $currentRow; ?>" id="ITM_PRICE<?php echo $currentRow; ?>" value="<?php echo number_format($ITM_PRICE, $decFormat); ?>" class="form-control" style="min-width:100px; max-width:100px; text-align:right" onKeyPress="return isIntOnlyNew(event);" onBlur="getConvertion_1(this,<?php echo $currentRow; ?>);" <?php if($ITM_UNIT == 'LS') { ?> disabled <?php } ?> >
                                        <?php } else { ?>
                                        	<!-- hidden -->
                                        	<input type="text" name="ITM_PRICE<?php echo $currentRow; ?>" id="ITM_PRICE<?php echo $currentRow; ?>" value="<?php echo number_format($ITM_PRICE, $decFormat); ?>" class="form-control" style="min-width:100px; max-width:100px; text-align:right;" onKeyPress="return isIntOnlyNew(event);" onBlur="getConvertion_1(this,<?php echo $currentRow; ?>);" <?php if($ITM_UNIT == 'LS') { ?> disabled <?php } ?> >
                                    ...
                                    <!-- Item Unit Type -- ITM_UNIT --></td>
                              		...
                              		<td>
                                    	<input type="text" name="data[<?php echo $currentRow; ?>][FPA_DESC]" id="data<?php echo $currentRow; ?>FPA_DESC" size="20" value="<?php echo $FPA_DESC;?>" class="form-control" style="width:200px; max-width:200px; text-align:left">
                              		</td>
							  </tr>
                              	<?php
                             	endforeach;
            	...
            	<div class="form-group">
                    ...
                    <div class="col-sm-10">
                    	...
                    	<input type="text" name="FPA_VALUE1" id="FPA_VALUE1" class="form-control" style="max-width:150px; text-align:right" value="<?php echo number_format($TOTFPAVAL, 2); ?>" disabled>                        
                    </div>
                </div>
                <br>
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        <?php
							...
							{
								if(($FPA_STAT == 1 || $FPA_STAT == 4) && $ISCREATE == 1)
								{
									?>
										<button class="btn btn-primary" >
								...
								{
									?>
										<button class="btn btn-primary" id="chkClose" style="display:none">
										<i class="fa fa-save"></i>&nbsp;&nbsp;<?php echo $Update; ?>
										</button>&nbsp;
									<?php
								}
							}
							$backURL	= site_url('c_finance/c_f180p0/gallS180d0bpk/?id='.$this->url_encryption_helper->encode_url($PRJCODE));
...
<script>
	...
	function add_item(strItem) 
	{
		...
		if(ITM_UNIT == 'LS')
		{
			document.getElementById('ITM_PRICE'+intIndex).disabled	= true;
		}
	...
	function getConvertion(thisVal1, row)
	{
		...
		TAXCODE1	= document.getElementById('TAXCODE1'+row).value;
		TAXPRICE1	= 0;
		FPA_TOTAL2	=parseFloat(REQ_NOW_AMOUNT);
		if(TAXCODE1 == 'TAX01')
		{
			TAXPRICE1 	= parseFloat(0.1 * REQ_NOW_AMOUNT);
			FPA_TOTAL2	= parseFloat(REQ_NOW_AMOUNT + TAXPRICE1);
		...
		document.getElementById('data'+row+'FPA_TOTAL2').value 	= parseFloat(FPA_TOTAL2); // After Plus or Min Tax
		document.getElementById('FPA_TOTAL2A'+row).value		= doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(FPA_TOTAL2)),decFormat));
		document.getElementById('data'+row+'TAXPRICE1').value 	= TAXPRICE1;
