					...
					if ($j==1) {
						...
						?>
                                ...
                                <?php
									...
									$secDel_PO 	= base_url().'index.php/c_finance/c_f180p0/trash_PO/?id='.$FPA_NUM;
								...
								<td style="text-align:center" nowrap>
                                    ...
                                    <?php if($resCreateC > 0) { if($TSF_STAT == 0) { if($ISAPPROVE == 1) { ?>
                                    ...
                                    <a href="#" onClick="deleteMail('<?php echo $secDel_PO; ?>')" title="Delete file" class="btn btn-danger btn-xs" <?php if($FPA_STAT > 1) { ?>disabled="disabled" <?php } ?> style="display:none">
