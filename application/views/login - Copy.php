            ...
            <div class="d-flex justify-content-center h-100">
                <div class="card">
                    <div class="card-header" style="text-align: center; font-weight: bold; font-size: 20px; color: #F4DB7D">
                        <h3 style="text-align: center;"><img src="<?php echo base_url() . 'assets/AdminLTE-2.0.5/dist/img/compLog/'. $comp_init . '/compLog_Login.png'; ?>" style="max-width:200px; max-height:200px" ></strong></h3>
