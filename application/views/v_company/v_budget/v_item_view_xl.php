...
// ---------- START EXCEL_READER2 ----------
	...
	*/
	...
	$ITMH_FN	= '';
	$sqlFN		= "SELECT ITMH_FN FROM tbl_item_uphist WHERE ITMH_CODE = '$ITMH_CODE' AND ITMH_PRJCODE = '$PRJCODE'";
	$sqlFNR		= $this->db->query($sqlFN)->result();
	foreach($sqlFNR as $rowFN) :
		$ITMH_FN		= $rowFN->ITMH_FN;
	endforeach;
...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <section class="content-header" style="text-align:center">
        <h1>
            <?php echo $h2_title; ?> 
            <small>Bill of Quantity <?php echo " : $PRJCODE"; ?><br>File Name<?php echo " : $myXlsFile"; ?></small>
        </h1>
        <br>
    </section>
    <style>
