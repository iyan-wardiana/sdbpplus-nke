...
<html>
	...
	<?php
		...
		if($LangID == 'IND')
		{
			...
			$alert8	= "Silahkan pilih tipe import.";
		}
		else
		{
			...
			$alert8	= "Please select import type.";
		}
		$isLoadDone_1	= 1;
...
<script>
	...
	$(document).ready(function() {
		$('#myformupload').submit(function(e){
			...
			var BOQH_TYPE = document.getElementById('BOQH_TYPE').value;
		...
		.then((willDelete) => {
			if (willDelete) 
			{
				...
				.then((value) => {
					...
					var BOQTYPE = document.getElementById('BOQH_TYPE'+row).value;
					var collID	= collID1;
