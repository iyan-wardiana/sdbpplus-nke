...
<html>
    ...
    <?php
    	...
    	if($LangID == 'IND')
    	{
    		...
    		$alert2		= "Anda belum menentukan induk anggaran.";
            $alert3     = "Kode anggaran tidak boleh kosong.";
            $alert4     = "Nama anggaran tidak boleh kosong.";
            $alert5     = "Anda belum menentukan unit anggaran.";
    		$miscell	= "Rupa-Rupa";
    	}
    	else
    	{
    		...
    		$alert2		= "You have not defined a parent budget yet.";
    		$alert3		= "Budget code can not be empty.";
            $alert4     = "Budget description can not be empty.";
            $alert5     = "You have not defined a unit budget yet.";
...
<script>
	...
	$(document).ready(function()
	{
		$("#JOBLEV").change(function()
		{
			...
			{
				$.ajax({
					url: '<?php echo site_url('c_comprof/c_bUd93tL15t/getJOBLIST/?id=')?>',
					type: 'post',
					data: {depart:deptid},
					dataType: 'json',
    ...
    function submitForm()
    {
        var JOBLEV      = document.getElementById('JOBLEV').value;
        ...
        if(JOBLEV == 0)
        {
            ...
            .then(function()
            {
                document.getElementById('JOBLEV').focus();
            });
            return false;
        }
