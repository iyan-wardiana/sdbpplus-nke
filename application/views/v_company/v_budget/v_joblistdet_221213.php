						...
						<table id="example" class="table table-bordered table-striped table-responsive search-table inner" width="100%">
					        <thead>
					            <tr>
					                ...
					                <th width="15%" colspan="3" style="text-align:center; vertical-align:middle" nowrap>
						                RAPT
						                <div class="pull-right">
					                ...
					                <th width="10%" rowspan="2"  style="text-align:center; vertical-align:middle" title="BoQ - RAPP - BA" nowrap>Deviasi</th>
		    	...
		    	<?php
					...
					if($RAPT_STAT == 1)
					{
						...
						foreach($r_LOCKER as $rw_LOCKER):
							...
							$RAPT_FILE1 	= $rw_LOCKER->RAPT_FILE;
											                    			...
											                    			?>
																				<div class="input-group">
												                            		...
												                            		<div class="input-group-addon">
												                            			<div class="actfile">
																							<!-- View File -->
																							<a href="#" onclick="viewFile('<?php echo $RAPT_FILE1;?>')" title="View File">
													...
													<div class="box box-success">
														...
														<div class="box-body">
															<div class="form-group">
											                    ...
											                    <div class="col-sm-6 pull-right" style="font-style: italic;">
											                    	Locked : <?=$LOCK_CREATED2?>
											                    </div>
											                    <div class="col-sm-12">
											                    	<input type="text" class="form-control" style="text-align:left" name="LOCK_ID" id="LOCK_ID" value="<?=$LOCK_ID?>"/>
											                    			...
											                    			?>
																				<div class="input-group">
												                            		...
												                            		<div class="input-group-addon">
												                            			<div class="actfile">
																							<!-- View File -->
																							<a href="#" onclick="viewFile('<?php echo $RAPT_FILE2;?>')" title="View File">
																								<i class="fa fa-eye" style="color: green;"></i> View
																							</a>
																						</div>
												                            		</div>
		                                        ...
		                                        <div class="form-group">
			                                    	<form method="post" name="frmSearch1" id="frmSearch1" action="">
			                                        	<div class="col-md-12">
									                    	...
									                    	<div class="row">
										                    	<div class="col-md-2" style="white-space: nowrap;">
										                    		<input type="text" name="UPD_VOLX" id="UPD_VOLX" value="" class="form-control" style="min-width:80px;" onKeyPress="return isIntOnlyNew(event);" onBlur="chgRAPPVOL(this);" placeholder="Volume" readonly >
