		                        ...
		                        <div class="form-group">
		                          	...
		                          	<div class="col-sm-9">
		                                <div class="input-group">
		                                    ...
		                                    <input type="text" class="form-control" name="JOBCODEID1" id="JOBCODEID1" value="<?php echo "$JOBCODEID $JOBDESC"; ?>" <?php if($AMD_STAT != 1 && $AMD_STAT != 4) { ?> disabled <?php } else { ?> onClick="selJOB()" <?php } ?>>
