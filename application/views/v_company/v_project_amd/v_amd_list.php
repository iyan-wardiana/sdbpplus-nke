...
<html>
    ...
    <body class="<?php echo $appBody; ?>" style="background-color: <?=$comp_color?>">
        ...
        <section class="content">
			<?php
				$disAdd 	= 0;
            	$s_00 		= "tbl_project WHERE PRJCODE = '$PRJCODE' AND (RAPT_STAT = '0' OR RAPP_STAT = '0') AND PRJCATEG IN ('SPL','GDG')";
            	...
            	if($r_00 > 0)
            	{
            		...
            		?>
                                <div class="alert alert-danger alert-dismissible">
                                    ...
                                    Tidak bisa membuat amandemen / BA selama masih dalam proses RAPT / RAPP.
                                </div>
                    <?php
            	}
            ?>
		    <div class="box">
				...
				<div class="box-body">
		            ...
		            <br>
                    <?php
                    	if($disAdd == 0 OR $PRJCODE == '363022' OR $PRJCODE == '540022')
                    	{
