							...
							<div class="box box-primary">
								...
								<div class="box-body">
			                        ...
			                        <div class="form-group">
			                          	...
			                          	<div class="col-sm-3">
	                                        <select name="AMD_FUNC1" id="AMD_FUNC1" class="form-control select2" onChange="selFUNC(this.value)" <?php if($AMD_CATEG == 'OB' || $AMD_CATEG == 'NB' || $AMD_CATEG == 'OTH' || $AMD_CATEG == 'EFS') { ?> disabled <?php } ?>>
	                                            <option value=""> --- </option>
			                        ...
			                        <script>
			                            function selCAT(AMD_CATEG)
			                            {
			                                ...
			                                if(AMD_CATEG == 'SI')
			                                {
	        									...
	        									document.getElementById('detItmEFS').style.display 	= 'none';
	        									document.getElementById('detItmSUB').style.display 	= 'none';
	        									document.getElementById('JOBCODEID1').disabled 		= false;
	        									document.getElementById('btnSelJID').disabled 		= false;
			                                }
			                                ...
			                                else if(AMD_CATEG == 'OTH')
			                                {
	        									...
	        									// document.getElementById('JOBCODEID1').disabled 		= true;
	        									// document.getElementById('btnSelJID').disabled 		= true;
	        									document.getElementById('JOBCODEID1').disabled 		= false;
	        									document.getElementById('btnSelJID').disabled 		= false;
			                                }
			                                else if(AMD_CATEG == 'EFS')
			                                {
			                                	document.getElementById('itmName').innerHTML 		= '<?=$jobCd?>';
			                                	$('#btnselSI').attr('disabled', 'disabled');							// OK
			                                	$('#AMD_REFNOX').attr('disabled', 'disabled');							// OK
			                                	$('#AMD_FUNC1').attr('disabled', 'disabled');							// OK
			                                	$('#AMD_FUNC1').val('').trigger('change');								// OK
		                                		$('#AMD_FUNC').val('');													// OK
	        									document.getElementById('btnModal').style.display 	= 'none';				// OK

	        									document.getElementById('detItm1').style.display 	= 'none';
	        									document.getElementById('detItmOB').style.display 	= 'none';
	        									document.getElementById('detItmEFS').style.display 	= '';
	        									document.getElementById('detItmSUB').style.display 	= '';
	        									document.getElementById('JOBCODEID1').disabled 		= true;
	        									document.getElementById('btnSelJID').disabled 		= true;
			                                }
	                                ...
	                                <div class="form-group">
	                                    ...
	                                    <div class="col-sm-6">
	                                        <div class="input-group">
	                                            ...
	                                            <input type="text" class="form-control" name="AMD_REFNOX" id="AMD_REFNOX" value="<?php echo $AMD_REFNO; ?>" <?php if($AMD_CATEG == 'OB' || $AMD_CATEG == 'NB' || $AMD_CATEG == 'OTH' || $AMD_CATEG == 'EFS') { ?> disabled <?php } ?>>
			                        ...
			                        <div class="form-group">
					                    ...
					                    <div class="col-sm-3">
					                        <div class="pull-right">
					                        	<a class="btn btn-sm btn-warning" <?php if($AMD_CATEG == 'EFS') { ?> style="display: none;" <?php } ?> id="btnModal" onClick="mdlJlist()">
		                                    ...
		                                    if($task == 'edit')
		                                    {
		                                        $sqlDET	= "SELECT DISTINCT A.AMD_NUM, A.JOBCODEID, A.ITM_CODE, A.ITM_UNIT,
		                                                    ...
		                                                    FROM tbl_amd_detail A
																...
																LEFT JOIN tbl_joblist_detail_$PRJCODEVW C ON C.PRJCODE = '$PRJCODE'
		                                    ...
		                                    if($task == 'edit')
		                                    {
		                                        ...
		                                        foreach($result as $row) :
													...
													$s_JID 			= "SELECT
																		...
																		(FPA_VAL+FPA_VAL_R+PO_VAL+PO_VAL_R+WO_VAL+WO_VAL_R+VCASH_VAL+VCASH_VAL_R+VLK_VAL+VLK_VAL_R+PPD_VAL+PPD_VAL_R) AS ITM_REQVAL,
			                                            ...
			                                            <td height="25" style="text-align:center;">
			                                              	<?php
				                                                if($AMD_STAT == 1)
				                                                {
				                                                	echo $cRwIEFS
				                                                    ?>
				                                                    <a href="#" onClick="deleteRow_iefs(<?php echo $cRwIEFS; ?>)" title="Delete Document" class="btn btn-danger btn-xs" style="display: none;"><i class="fa fa-trash-o"></i></a>
				                                                    <?php
				                                                }
				                                                else
				                                                {
								...
								<div class="box-body">
			                        <div class="search-table-outter">
			                            <table id="tbl_subs" class="table table-bordered table-striped table-responsive search-table inner" width="100%">
		                                            ...
		                                            <tr id="tr_subs<?php echo $cRwSUB; ?>">
			                                            ...
			                                            <td height="25" style="text-align:center;">
			                                              	<?php
				                                                ...
				                                                {
				                                                    ?>
				                                                    <a href="#" onClick="deleteRow_subs_oth(<?php echo $cRwSUB; ?>)" title="Delete Document" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i></a>
				                                                    <?php
				                                                }
				                                                else
				                                                {
			                                            ...
			                                            <!-- AMD_PRICE -->
			                                         	<td style="text-align:right">
			                                         		<?php
				                                         		...
				                                         		{
				                                         			?>
				                                                		<input type="text" id="<?php echo $cRwSUB; ?>SUB_AMD_PRICE" value="<?php echo number_format($AMD_PRICE, 2); ?>" class="form-control" style="min-width:80px; max-width:300px; text-align:right" onKeyPress="return isIntOnlyNew(event);" onBlur="chgPriceOTH_S(this,<?php echo $cRwSUB; ?>);" >
				                                                	<?php
				                                                }
				                                                else
				                                                {
			                                            ...
			                                            <td style="text-align: right;">
			                                         		<?php
				                                         		...
				                                         		{
				                                         			?>
				                                                		<input type="text" name="<?php echo $cRwSUB; ?>SUB_AMD_TOTAL" id="<?php echo $cRwSUB; ?>SUB_AMD_TOTAL" value="<?php echo number_format($AMD_TOTAL, 2); ?>" class="form-control" style="min-width:80px; max-width:300px; text-align:right" onKeyPress="return isIntOnlyNew(event);" onClick="showINFO(this.value)" readonly >
				                                                	<?php
				                                                }
				                                                else
				                                                {
		                                    ...
		                                    ?>
		                                    <input type="hidden" name="totalrowSUB" id="totalrowSUB" value="<?php echo $cRwSUB; ?>">
		                                </table>
		                            </div>
		                        </div>
	                        </div>
	    	...
	    	<!-- ============ START MODAL JOBLIST =============== -->
				...
				<script type="text/javascript">
					function mdlJlist()
					{
						...
						if(AMD_CATEG != 'OTH' && AMD_CATEG != 'EFS' && JOBCODEID1.trim() == '')
						{
...
<script>
	...
	function add_JOBOTH(strItem)
	{
		...
		// SATUAN
			...
			objTD.align = 'left';
			objTD.noWrap = true;
			objTD.innerHTML = ITM_UNIT+'<input type="hidden" name="dataIOB['+intIndex+'][ITM_UNIT]" id="dataIOB'+intIndex+'ITM_UNIT" value="'+ITM_UNIT+'" class="form-control" style="max-width:300px;" ><br><a href="#" onClick="mdlJlistSubs(\''+COLLDATA+'\')" title="Tambah Budget" class="btn btn-warning btn-xs"><i class="glyphicon glyphicon-transfer"></i></a><a class="btn btn-sm btn-warning" data-toggle="modal" data-target="#mdl_addJListSubs" id="btnModalB" style="display: none;"><i class="glyphicon glyphicon-search"></i></a><input type="hidden" id="dataIOB'+intIndex+'r_isLS" value="'+r_isLS+'">';
		...
		// REMAIN_VOLUME
			...
			objTD = objTR.insertCell(objTR.cells.length);
			objTD.style.textAlign = 'right';
			objTD.innerHTML = ''+ITM_REMVW+' (V)<input type="hidden" id="'+intIndex+'IOB_ITM_REMV" value="'+ITM_REMV+'" class="form-control" style="max-width:300px;" ><br>'+ITM_REMVALV+' (J)<input type="hidden" id="'+intIndex+'IOB_ITM_REMVAL" value="'+ITM_REMVAL+'" class="form-control" style="max-width:300px;" ><input type="hidden" name="dataIOB['+intIndex+'][AMD_CLASS]" id="dataIOB'+intIndex+'AMD_CLASS" value="2" class="form-control" style="max-width:300px;" >';

		// AMANDEMEN VOL.
			ITM_REMVW	= doDecimalFormat(RoundNDecimal(parseFloat((ITM_REMV)),2));
			objTD = objTR.insertCell(objTR.cells.length);
			objTD.style.textAlign = 'right';
			objTD.innerHTML = '<input type="text" id="'+intIndex+'IOB_AMD_VOLM" value="0.00" style="min-width:60px; max-width:300px; text-align:right" onKeyPress="return isIntOnlyNew(event);" onBlur="chgVolOTH(this,'+intIndex+');" class="form-control" ><input type="hidden" name="dataIOB['+intIndex+'][AMD_VOLM]" id="dataIOB'+intIndex+'AMD_VOLM" value="0" class="form-control" style="max-width:300px;" >';

		// AMANDEMEN HARGA
			ITM_PRICEV	= doDecimalFormat(RoundNDecimal(parseFloat((ITM_PRICE)),2));
			objTD = objTR.insertCell(objTR.cells.length);
			objTD.style.textAlign = 'right';
			objTD.innerHTML = '<input type="text" name="'+intIndex+'IOB_AMD_PRICE" id="'+intIndex+'IOB_AMD_PRICE" value="0.00" style="min-width:80px; max-width:300px; text-align:right" onKeyPress="return isIntOnlyNew(event);" onBlur="chgPriceOTH(this,'+intIndex+');" class="form-control" ><input type="hidden" name="dataIOB['+intIndex+'][AMD_PRICE]" id="dataIOB'+intIndex+'AMD_PRICE" value="0" class="form-control" style="max-width:300px;" >';

		// AMANDEMEN VALUE
			objTD = objTR.insertCell(objTR.cells.length);
			objTD.style.textAlign = 'right';
			objTD.innerHTML = '<input type="text" name="'+intIndex+'IOB_AMD_TOTAL" id="'+intIndex+'IOB_AMD_TOTAL" value="0.00" class="form-control inplabel" style="min-width:80px; max-width:300px; text-align:right" onKeyPress="return isIntOnlyNew(event);" readonly onClick="showINFO(this.value)" ><input type="hidden" name="dataIOB['+intIndex+'][AMD_TOTAL]" id="dataIOB'+intIndex+'AMD_TOTAL" value="0" class="form-control" style="max-width:300px;" onKeyPress="return isIntOnlyNew(event);" ><input type="hidden" id="dataIOB'+intIndex+'AMD_MAXVAL" value="" class="form-control" style="max-width:300px;" ><input type="hidden" name="dataIOB['+intIndex+'][AMD_DESC]" id="dataIOB'+intIndex+'AMD_DESC" size="20" value="" class="form-control" style="min-width:110px; max-width:300px; text-align:left">';
	...
	function add_JOBSUBS(strItem)
	{
		...
		// SATUAN
			ITM_UNIT		= JOBUNIT.toUpperCase();
			objTD = objTR.insertCell(objTR.cells.length);
			objTD.align = 'left';
			objTD.noWrap = true;
			objTD.innerHTML = ITM_UNIT+'<input type="hidden" name="dataSUB['+intIndex+'][ITM_UNIT]" id="dataSUB'+intIndex+'ITM_UNIT" value="'+ITM_UNIT+'" class="form-control" style="max-width:300px;" ><input type="hidden" name="dataSUB['+intIndex+'][AMD_CLASS]" id="dataSUB'+intIndex+'AMD_CLASS" value="2" class="form-control" style="max-width:300px;" ><input type="hidden" id="dataSUB'+intIndex+'r_isLS" value="'+r_isLS+'">';

		// REMAIN VOL
			var ITM_REMVOLV = doDecimalFormat(RoundNDecimal(parseFloat((ITM_REMVOL)), 2));
			var ITM_REMVALV = doDecimalFormat(RoundNDecimal(parseFloat((ITM_REMVAL)), 2));
			objTD = objTR.insertCell(objTR.cells.length);
			objTD.style.textAlign = 'right';
			objTD.noWrap = true;
			objTD.innerHTML = ''+ITM_REMVOLV+' (V)<input type="hidden" name="dataSUB['+intIndex+'][REM_VOL]" id="dataSUB'+intIndex+'REM_VOL" value="'+ITM_REMVOL+'" class="form-control" style="max-width:300px;" ><br>'+ITM_REMVALV+' (J)<input type="hidden" name="dataSUB['+intIndex+'][REM_VAL]" id="dataSUB'+intIndex+'REM_VAL" value="'+ITM_REMVAL+'" class="form-control" style="max-width:300px;" >';

		// AMD VOL
			objTD = objTR.insertCell(objTR.cells.length);
			objTD.style.textAlign = 'right';
			objTD.innerHTML = '<input type="text" id="'+intIndex+'SUB_AMD_VOLM" value="1.00" style="min-width:60px; max-width:300px; text-align:right" onKeyPress="return isIntOnlyNew(event);" onBlur="chgVolOTH_S(this,'+intIndex+');" class="form-control" title="Hanya bisa amandemen nilai" readonly ><input type="hidden" name="dataSUB['+intIndex+'][AMD_VOLM]" id="dataSUB'+intIndex+'AMD_VOLM" value="1" class="form-control" style="max-width:300px;" >';

		// AMD PRICE
			objTD = objTR.insertCell(objTR.cells.length);
			objTD.style.textAlign = 'right';
			objTD.innerHTML = '<input type="text" id="'+intIndex+'SUB_AMD_PRICE" value="0.00" style="min-width:80px; max-width:300px; text-align:right" onKeyPress="return isIntOnlyNew(event);" onBlur="chgPriceOTH_S(this,'+intIndex+');" class="form-control" ><input type="hidden" name="dataSUB['+intIndex+'][AMD_PRICE]" id="dataSUB'+intIndex+'AMD_PRICE" value="0" class="form-control" style="max-width:300px;" >';

		// AMD TOTAL
			//document.getElementById('colRemark').style.display 	= 'none';
			objTD = objTR.insertCell(objTR.cells.length);
			objTD.align = 'left';
			objTD.innerHTML = '<input type="text" name="'+intIndex+'SUB_AMD_TOTAL" id="'+intIndex+'SUB_AMD_TOTAL" value="0.00" class="form-control inplabel" style="min-width:80px; max-width:300px; text-align:right" onKeyPress="return isIntOnlyNew(event);" readonly onClick="showINFO(this.value)" ><input type="hidden" name="dataSUB['+intIndex+'][AMD_TOTAL]" id="dataSUB'+intIndex+'AMD_TOTAL" value="0" class="form-control" style="max-width:300px;" onKeyPress="return isIntOnlyNew(event);" >';
	...
	{
		var decFormat	= document.getElementById('decFormat').value;
		var AMD_CLASS	= document.getElementById('dataIOB'+row+'AMD_CLASS').value;
		var PRJCODE		= document.getElementById('PRJCODE').value;
		var AMD_VOLM	= eval(thisVal.value.split(",").join(""));

		var AMD_PRICE 	= parseFloat(document.getElementById('dataIOB'+row+'AMD_PRICE').value);
		var AMD_TOTAL 	= parseFloat(AMD_VOLM) * parseFloat(AMD_PRICE);

		document.getElementById(row+'IOB_AMD_VOLM').value 			= doDecimalFormat(RoundNDecimal(parseFloat((AMD_VOLM)),decFormat));
		document.getElementById('dataIOB'+row+'AMD_VOLM').value 	= parseFloat((AMD_VOLM));
		document.getElementById(row+'IOB_AMD_TOTAL').value 			= doDecimalFormat(RoundNDecimal(parseFloat((AMD_TOTAL)),decFormat));
		document.getElementById('dataIOB'+row+'AMD_TOTAL').value 	= AMD_TOTAL;

		var tTOB 	= 0;
		var totSB 	= parseFloat(document.getElementById('totSB').value);
		var totSBV 	= doDecimalFormat(RoundNDecimal(parseFloat((totSB)),decFormat));
		...
		for(i=1;i<intTable;i++)
		{
			...
			if(values != null)
			{
				if(i != row)
				{
					ITOTAL 		= document.getElementById('dataIOB'+i+'AMD_TOTAL').value;
					tTOB		= parseFloat(tTOB) + parseFloat(ITOTAL);
				}
			}
		}

		var totRem 	= parseFloat(totSB - tTOB);
		var totRemV	= doDecimalFormat(RoundNDecimal(parseFloat((totRem)),decFormat));
		...
		for(i=1;i<intTable;i++)
		{
			...
			if(values != null)
			{
				ITMAMD_TOTAL 	= document.getElementById('dataIOB'+i+'AMD_TOTAL').value;
				AMDT_AMOUNT		= parseFloat(AMDT_AMOUNT) + parseFloat(ITMAMD_TOTAL);

				if(AMDT_AMOUNT > totSB)
				{
					swal("Nilai total yang permintaan amandemen lebih besar dari nilai total yang disediakan, "+totSBV+". Sisa "+totRemV,
					{
						icon: "warning",
					})
					.then(function()
					{
						swal.close();
						document.getElementById(row+'IOB_AMD_VOLM').value 			= doDecimalFormat(RoundNDecimal(parseFloat((0)),decFormat));
						document.getElementById('dataIOB'+row+'AMD_VOLM').value 	= parseFloat((0));
						document.getElementById(row+'IOB_AMD_TOTAL').value 			= doDecimalFormat(RoundNDecimal(parseFloat((0)),decFormat));
						document.getElementById('dataIOB'+row+'AMD_TOTAL').value 	= 0;
						// document.getElementById('totOB').value 						= parseFloat(0);
						// document.getElementById('totOBVW').innerHTML 				= doDecimalFormat(RoundNDecimal(parseFloat((0)),decFormat));
					});
					return false;
				}
				else
				{
					...
					document.getElementById('dataIOB'+row+'AMD_VOLM').value 	= parseFloat(AMD_VOLM);
					document.getElementById(row+'IOB_AMD_TOTAL').value 			= doDecimalFormat(RoundNDecimal(parseFloat((AMD_TOTAL)),decFormat));
					document.getElementById('dataIOB'+row+'AMD_TOTAL').value 	= parseFloat(AMD_TOTAL);
					document.getElementById('totOB').value 						= parseFloat(AMDT_AMOUNT);
					document.getElementById('totOBVW').innerHTML 				= doDecimalFormat(RoundNDecimal(parseFloat((AMDT_AMOUNT)),decFormat));
				}
			}
		}
	}
	...
	function chgPriceOTH(thisVal, row)
	{
		...
		var AMD_VOLM 	= parseFloat(document.getElementById('dataIOB'+row+'AMD_VOLM').value);
		var AMD_TOTAL 	= parseFloat(AMD_VOLM) * parseFloat(AMD_PRICE);

		document.getElementById(row+'IOB_AMD_PRICE').value 			= doDecimalFormat(RoundNDecimal(parseFloat((AMD_PRICE)),decFormat));
		document.getElementById('dataIOB'+row+'AMD_PRICE').value 	= parseFloat((AMD_PRICE));
		document.getElementById(row+'IOB_AMD_TOTAL').value 			= doDecimalFormat(RoundNDecimal(parseFloat((AMD_TOTAL)),decFormat));
		document.getElementById('dataIOB'+row+'AMD_TOTAL').value 	= AMD_TOTAL;
		...
		for(i=1;i<intTable;i++)
		{
			...
			if(values != null)
			{
				...
				if(AMDT_AMOUNT > totSB)
				{
					...
					{
						swal.close();
						document.getElementById(row+'IOB_AMD_PRICE').value 			= doDecimalFormat(RoundNDecimal(parseFloat((0)),decFormat));
						document.getElementById('dataIOB'+row+'AMD_PRICE').value 	= parseFloat((0));
						document.getElementById(row+'IOB_AMD_TOTAL').value 			= doDecimalFormat(RoundNDecimal(parseFloat((0)),decFormat));
						document.getElementById('dataIOB'+row+'AMD_TOTAL').value 	= parseFloat(0);
						// document.getElementById('totOB').value 						= parseFloat(0);
						// document.getElementById('totOBVW').innerHTML 				= doDecimalFormat(RoundNDecimal(parseFloat((0)),decFormat));
					});
					return false;
	...
	function chgVolOTH_S(thisVal, row)
	{
		var decFormat	= document.getElementById('decFormat').value;
		var AMD_CLASS	= document.getElementById('dataSUB'+row+'AMD_CLASS').value;
		var PRJCODE		= document.getElementById('PRJCODE').value;
		var AMD_VOLM	= eval(thisVal.value.split(",").join(""));

		var r_isLS 		= document.getElementById('dataSUB'+row+'r_isLS').value;
		var REM_VOL 	= parseFloat(document.getElementById('dataSUB'+row+'REM_VOL').value);
		var REM_VAL 	= parseFloat(document.getElementById('dataSUB'+row+'REM_VAL').value);
		var AMD_PRICE 	= parseFloat(document.getElementById('dataSUB'+row+'AMD_PRICE').value);
		var AMD_TOTAL 	= parseFloat(AMD_VOLM) * parseFloat(AMD_PRICE);

		REM_VOLV 		= doDecimalFormat(RoundNDecimal(parseFloat((REM_VOL)),decFormat));
		REM_VALV 		= doDecimalFormat(RoundNDecimal(parseFloat((REM_VAL)),decFormat));

		if(r_isLS == 0 && AMD_VOLM > REM_VOL)
		{
			swal('Volume yang dimasukan lebih besar dari sisa volume yang tersedia '+REM_VOLV,
			{
				icon:"warning"
			})
			.then(function()
			{
				swal.close();
				document.getElementById(row+'SUB_AMD_VOLM').value 			= doDecimalFormat(RoundNDecimal(parseFloat((0)),decFormat));
				document.getElementById('dataSUB'+row+'AMD_VOLM').value 	= parseFloat((0));
				document.getElementById('dataSUB'+row+'AMD_TOTAL').value 	= parseFloat((0));
				...
				for(i=1;i<intTable;i++)
				{
					let myObj 	= document.getElementById('dataSUB'+i+'AMD_TOTAL');
					var values 	= typeof myObj !== 'undefined' ? myObj : '';
					
					if(values != null)
					{
						ITMAMD_TOTAL 	= document.getElementById('dataSUB'+i+'AMD_TOTAL').value;
						AMDT_AMOUNT		= parseFloat(AMDT_AMOUNT) + parseFloat(ITMAMD_TOTAL);
						console.log('A = '+AMDT_AMOUNT)
					}
				}

				document.getElementById('totSB').value 				= parseFloat(AMDT_AMOUNT);
				document.getElementById('totSBVW').innerHTML 		= doDecimalFormat(RoundNDecimal(parseFloat((AMDT_AMOUNT)),decFormat));
			});
		}
		else if(r_isLS > 0 && AMD_TOTAL > REM_VAL)
		{
			swal('Total amandemen lebih besar dari sisa yang tersedia '+REM_VALV,
			{
				icon:"warning"
			})
			.then(function()
		...
		{
			document.getElementById(row+'SUB_AMD_VOLM').value 			= doDecimalFormat(RoundNDecimal(parseFloat((AMD_VOLM)),decFormat));
			document.getElementById('dataSUB'+row+'AMD_VOLM').value 	= parseFloat((AMD_VOLM));
			document.getElementById(row+'SUB_AMD_TOTAL').value 			= doDecimalFormat(RoundNDecimal(parseFloat((AMD_TOTAL)),decFormat));
			document.getElementById('dataSUB'+row+'AMD_TOTAL').value 	= AMD_TOTAL;
	...
	function chgPriceOTH_S(thisVal, row)
	{
		var decFormat	= document.getElementById('decFormat').value;
		var AMD_CLASS	= document.getElementById('dataSUB'+row+'AMD_CLASS').value;
		var PRJCODE		= document.getElementById('PRJCODE').value;
		...
		var r_isLS 		= parseFloat(document.getElementById('dataSUB'+row+'r_isLS').value);
		var REM_VOL 	= parseFloat(document.getElementById('dataSUB'+row+'REM_VOL').value);
		var REM_VAL 	= parseFloat(document.getElementById('dataSUB'+row+'REM_VAL').value);
		var AMD_VOLM 	= parseFloat(document.getElementById('dataSUB'+row+'AMD_VOLM').value);
		var AMD_TOTAL 	= parseFloat(AMD_VOLM) * parseFloat(AMD_PRICE);

		if(r_isLS > 0 && AMD_TOTAL > REM_VAL)
		{
			swal('Total amandemen lebih besar dari sisa yang tersedia '+doDecimalFormat(RoundNDecimal(parseFloat((REM_VAL)),decFormat)),
			{
				icon:"warning"
			})
			.then(function()
			{
				swal.close();
				document.getElementById(row+'SUB_AMD_PRICE').value 			= doDecimalFormat(RoundNDecimal(parseFloat((0)),decFormat));
				document.getElementById(row+'SUB_AMD_TOTAL').value 			= doDecimalFormat(RoundNDecimal(parseFloat((0)),decFormat));
				document.getElementById('dataSUB'+row+'AMD_PRICE').value 	= parseFloat((0));
				document.getElementById('dataSUB'+row+'AMD_TOTAL').value 	= parseFloat((0));
		...
		{
			document.getElementById(row+'SUB_AMD_PRICE').value 			= doDecimalFormat(RoundNDecimal(parseFloat((AMD_PRICE)),decFormat));
			document.getElementById('dataSUB'+row+'AMD_PRICE').value 	= parseFloat((AMD_PRICE));
			document.getElementById(row+'SUB_AMD_TOTAL').value 			= doDecimalFormat(RoundNDecimal(parseFloat((AMD_TOTAL)),decFormat));
			document.getElementById('dataSUB'+row+'AMD_TOTAL').value 	= AMD_TOTAL;
	...
	function checkInp()
	{
		...
		{
			totIOB	= parseFloat(document.getElementById('totalrowIEFS').value);
			totSUB	= parseFloat(document.getElementById('totalrowSUB').value);
