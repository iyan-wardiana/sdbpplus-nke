		                                            ...
		                                            <tr id="tr_<?php echo $currentRow; ?>">
			                                            ...
			                                            <!-- ITM_NAME -->
			                                          	<td style="text-align:left" nowrap>
															<?php //echo "$JOBCODEID : $ITM_NAME<br>"; ?>
															<?php //echo "$ITM_CODEH ($JOBCODEIDH) : $ITM_NAMEH"; ?>
															<?php echo "$JOBCODEID : $ITM_NAME<br>"; ?>
			                                            ...
			                                            <!-- AMD_CLASS -->
			                                         	<td>
			                                         		<?php
				                                         		...
				                                         		{
				                                         			?>
						                                                <select name="dataSUB[<?php echo $cRwSUB; ?>][AMD_CLASS]" id="dataIOB<?php echo $cRwSUB; ?>AMD_CLASS" class="form-control" style="min-width: 80px; max-width:150px" onChange="chgCLS(this.value,<?php echo $cRwSUB; ?>);">
						                                                	<option value="1" <?php if($AMD_CLASS == 1) { ?> selected <?php } ?>> Vol. </option>
						                                                	<option value="2" <?php if($AMD_CLASS == 2) { ?> selected <?php } ?>> Harga </option>
						                                                </select>
				                                                	<?php
