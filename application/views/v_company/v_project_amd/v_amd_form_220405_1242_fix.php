			    	...
			    	<div class="row">
	                    ...
	                    <div class="col-md-6" id="detItmOB" <?php if($AMD_CATEG != 'OTH') { ?> style="display: none;" <?PHP } ?>>
	                        <div class="box box-danger">
								...
								<div class="box-body">
			                        <div class="search-table-outter">
			                            <table id="tbl_iob" class="table table-bordered table-striped table-responsive search-table inner" width="100%">
		                                    <tr style="background:#CCCCCC">
												<th width="2%" style="text-align:center; vertical-align: middle;">No.</th>
		                                    ...
		                                    if($task == 'edit')
		                                    {
		                                        ...
		                                        foreach($result as $row) :
													...
													$ITM_REMV 		= 0;
		                                            $ITM_REMAMN 	= 0;
		                                            $s_JDSC 		= "SELECT (ITM_VOLM - ITM_USED) AS ITM_REMV,
		                                            						(ITM_BUDG - ITM_USED_AM) AS ITM_REMAMN
		                                            					FROM tbl_joblist_detail
		                                            					WHERE JOBCODEID = '$JOBCODEID' AND PRJCODE = '$PRJCODE' LIMIT 1";
													$r_JDSC			= $this->db->query($s_JDSC)->result();
													foreach($r_JDSC as $rw_JDSC):
		                                            ...
		                                            <tr id="tr_<?php echo $cRwIOB; ?>">
			                                            ...
			                                            <td height="25" style="text-align:center;">
			                                              	<?php
				                                                ...
				                                                {
				                                                    ?>
				                                                    <a href="#" onClick="deleteRow(<?php echo $cRwIOB; ?>)" title="Delete Document" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i></a>
				                                                    <?php
				                                                }
				                                                else
				                                                {
		                                            ...
		                                            <tr id="tr_<?php echo $currentRow; ?>">
			                                            ...
			                                            <!-- ITM_NAME -->
			                                          	<td style="text-align:left" nowrap>
															<?php echo "($ITM_CODEH) $JOBCODEID : $ITM_NAME<br>"; ?>
															<?php echo "$JOBCODEIDH : $ITM_NAMEH"; ?>
...
<script>
	...
	function add_JOBOTH(strItem)
	{
		...
		// START : SETTING ROWS INDEX
			...
			intIndex 		= parseInt(intIndexA)+1;
			objTable 		= document.getElementById('tbl_iob');
			intTable 		= objTable.rows.length;
