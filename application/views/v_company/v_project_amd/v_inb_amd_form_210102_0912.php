	                        ...
	                        <div class="search-table-outter">
	                            <table id="tbl" class="table table-bordered table-striped" width="100%">
	                            	<tr style="background:#CCCCCC">
										...
										<th width="15%" style="text-align:center;" id="colItmNm"><div id="itmName"><?php echo $ItemCode ?></div></th>
										<th width="30%" style="text-align:center;"><?php echo $ItemName ?> </th>
										<th width="10%" style="text-align:center" nowrap>Vol. Sisa</th>
										<th width="10%" style="text-align:center" colspan="2">Vol. Amd.</th>
										<th width="13%" style="text-align:center;" colspan="2"><?php echo $Price ?></th>
										<th width="5%" style="text-align:center;"><div id="itmUM"><?php echo $Unit ?></div></th>
										<th width="25%" style="text-align:center;" id="colDesc"><?php echo $Remarks ?> </th>
                                    </tr>
                                    <?php					
                                    if($task == 'edit')
                                    {
                                        ...
                                        foreach($result as $row) :
											...
											foreach($r_JDSC as $rw_JDSC):
												$JOBPARDESC	= wordwrap($rw_JDSC->JOBDESC, 60, "<br>", true);
											endforeach;
	                                          	...
	                                          	<td style="text-align:left">
	                                                ...
	                                                <input type="hidden" id="data<?php echo $currentRow; ?>JOBDESC" name="data[<?php echo $currentRow; ?>][JOBDESC]" value="<?php echo $ITM_NAME; ?>" class="form-control" style="max-width:300px;">
												  	<div style='margin-left: 10px; font-style: italic; white-space:nowrap'>
												  		<label style='white-space:nowrap'><?=$JOBPARENT?> : <?=$JOBPARDESC?></label>
												  	</div>
	                                          	</td>
