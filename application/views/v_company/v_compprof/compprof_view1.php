        ...
        <div class="col-md-3">
          	...
          	<div class="box box-primary">
                <div class="box-body box-profile">
                    ...
                    <p class="text-muted text-center"><?php echo $PRJADD; ?></p>
                </div>
          	</div>
        ...
        <div class="col-md-9">
			<div class="nav-tabs-custom">
            	<ul class="nav nav-tabs">
                    ...
                    <li><a href="#profPicture" data-toggle="tab"><?php echo $Picture; ?></a></li>						<!-- Tab 2 -->
                </ul>
                <!-- Biodata -->
                        ...
                        <form class="form-horizontal" name="frm" method="post" action="<?php echo $form_action; ?>" onSubmit="return validateInData()">
                            ...
                            <div class="box box-primary">
                                ...
                                <div class="form-group">
                                    <label for="inputName" class="col-sm-2 control-label"><?php echo $ProjectNumber?></label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="PRJNAME" id="PRJNAME" size="50" value="<?php echo $default['PRJNAME']; ?>" >
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <script>
                                    function functioncheck(myValue)
                                    {
                                        ...
                                        ajaxRequest.open("GET", "<?php echo base_url().'index.php/c_comprof/c_30Mp70f/getTheCode/';?>" + PRJCODE, true);
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="PRJCNUM" id="PRJCNUM" value="<?php echo $PRJCNUM; ?>" >
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="inputName" class="col-sm-2 control-label"><?php echo $TelpNo; ?></label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="PRJTELP" id="PRJTELP" value="<?php echo $PRJTELP; ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="inputName" class="col-sm-2 control-label">Fax No.</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="PRJFAX" id="PRJFAX" value="<?php echo $PRJFAX; ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="inputName" class="col-sm-2 control-label">E-mail</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="PRJMAIL" id="PRJMAIL" value="<?php echo $PRJMAIL; ?>">
                                    </div>
                                </div>
                                <div class="form-group" style="display:none">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="form-control" name="PRJADD"  id="PRJADD" style="height:70px"><?php echo $PRJADD; ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group" style="display:none">
                                ...
                                <div class="form-group">
                                    <label for="inputName" class="col-sm-2 control-label"><?php echo $Owner ?></label>
                                    <div class="col-sm-10">
