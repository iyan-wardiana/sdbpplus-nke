...
<script>
	...
	function add_item(strItem)
	{
		...
		// Item Used
			objTD = objTR.insertCell(objTR.cells.length);
			objTD.style.textAlign = 'right';
			objTD.innerHTML = '<input type="text" class="form-control" style="min-width:110px; max-width:300px; text-align:right" name="TOT_USEDQTY'+intIndex+'" id="TOT_USEDQTY'+intIndex+'" value="'+TOT_USEDQTY+'" disabled ><input type="text" name="data['+intIndex+'][REM_BUDG]" id="data'+intIndex+'REM_BUDG" value="'+REM_BUDG+'">';
