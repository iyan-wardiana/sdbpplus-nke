					...
					<div class="col-md-6">
						<div class="box box-primary">
							...
							<div class="box-body">
		                        ...
		                        <?php
		                        	$JOBDESC 	= "";
		                        	$sqlJDESCX 	= "SELECT JOBDESC FROM tbl_joblist WHERE JOBCODEID = '$AMD_JOBPAR' LIMIT 1";
                                ...
                                <div id="sinjType" class="form-group" <?php if($AMD_CATEG != 'SI' && $AMD_CATEG != 'SINJ') { ?> style="display: none;" <?php } ?>>
		                                    ...
		                                    <div class="col-sm-9">
		                                        <script>
		                                            ...
		                                            function selectitem()
		                                            {
														...
														collData 	= PRJCODE+'~'+AMD_CATEG+'~'+JOBCODEID;
														if(JOBCODEID == '')
														{
		                                                ...
		                                                var left = (screen.width/2)-(w/2);
		                                                var top = (screen.height/2)-(h/2);
		                                                return window.open(url+'&clDat4='+collData, title, 'toolbar=yes, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width='+w+', height='+h+', top='+top+', left='+left);
		                                            }
		                                        </script>
...
<script>
	...
	function add_header(strItem)
	{
		...
		document.getElementById('JOBCODEIDX').value 	= JOBCODEID+' '+JOBDESC;
	}
	...
	function add_item(strItem)
	{
		arrItem = strItem.split('|');
		var objTable, objTR, objTD, intIndex, arrItem;
		var AMD_CATEG 	= document.getElementById('AMD_CATEG1').value;
