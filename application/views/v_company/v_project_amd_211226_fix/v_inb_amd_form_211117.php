						...
						<div class="box box-primary">
							...
							<div class="box-body">
                                ...
                                <div id="sinjType" class="form-group" <?php if($AMD_CATEG != 'SI' && $AMD_CATEG != 'SINJ') { ?> style="display: none;" <?php } ?>>
                                    ...
                                    <div class="col-sm-2">
                                        <select name="AMD_FUNC1" id="AMD_FUNC1" class="form-control select2" disabled>
                                            <option value=""> --- </option>
                                        ...
                                        <input type="hidden" class="form-control" name="AMD_FUNC" id="AMD_FUNC" value="<?php echo $AMD_FUNC; ?>" >
                                    </div>
                                    <div class="col-sm-7">
                                        <div class="input-group">
                                            <div class="input-group-btn">
							...
							<div class="box-body">
		                        <div class="form-group">
		                       	  <label for="inputName" class="col-sm-3 control-label"><?php echo $Notes; ?></label>
		                          	<div class="col-sm-9">
		                                <textarea class="form-control" name="AMD_NOTES1" id="AMD_NOTES1"  style="height:83px" disabled=""><?php echo $AMD_NOTES; ?></textarea>
