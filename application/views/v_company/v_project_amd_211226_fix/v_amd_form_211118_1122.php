						...
						<div class="box box-primary">
							...
							<div class="box-body">
		                        ...
		                        <div class="form-group">
		                          	...
		                          	<div class="col-sm-5">
		                            	<select name="AMD_CATEG" id="AMD_CATEG" class="form-control select2" onChange="selCAT(this.value)">
		                                    ...
		                                    <?php if($PRJSCATEG == 99) { // SENGAJA DI HOLD DULU ?>
			                                ...
			                                <?php } ?>
		                                    <!-- <option value="OTH" <?php if($AMD_CATEGX == 'OTH') { ?> selected <?php } ?>><?php echo $Others; ?> - OTH</option> -->
		                                </select>
		                          	</div>
		                          	<div class="col-sm-4">
		                        ...
		                        <div class="form-group">
		                          	...
		                          	<div class="col-sm-9">
		                                <div class="input-group">
		                                    ...
		                                    <input type="text" class="form-control" name="JOBCODEID1" id="JOBCODEID1" value="<?php echo "$JOBCODEID $JOBDESC"; ?>" onClick="selJOB();">
		                        ...
		                        <script>
									...
									/*function selJOBCODE()
									{
										...
										return window.open(urlJL, title, 'toolbar=yes, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width='+w+', height='+h+', top='+top+', left='+left);
									}*/

		                            function selCAT(AMD_CATEG)
		                            {
		                                document.getElementById("AMD_CATEGX").value = AMD_CATEG;
		                                if(AMD_CATEG == 'SI' || AMD_CATEG == 'SINJ')
		                                {
		                                	document.getElementById('itmName').innerHTML = '<?php echo $ItemCode ?>';
		                                	document.getElementById('sinjType').style.display = '';
		                                }
		                                else
		                                {
		                                	document.getElementById('itmName').innerHTML = 'Kode Pekerjaan';
		                                	document.getElementById('sinjType').style.display = 'none';
		                                }
		                            ...
		                            function selJOB_HOLD(JOBCODEID)
		                            {
		                                document.getElementById("AMD_JOBID1").value = JOBCODEID;
		                            }
		                        </script>
                                <div id="sinjType" class="form-group" <?php if($AMD_CATEG == 'OB' || $AMD_CATEG == 'NB' || $AMD_CATEG == '0' || $AMD_CATEG == '') { ?> style="display: none;" <?php } ?>>
                                    <label for="inputName" class="col-sm-3 control-label"><?php echo $FunctionalPosition; ?></label>
                                    <div class="col-sm-2">
                                        <select name="AMD_FUNC" id="AMD_FUNC" class="form-control select2">
                                            <option value=""> --- </option>
                                    ...
                                    <div class="col-sm-7">
                                        <div class="input-group">
                                            <div class="input-group-btn">
                                                <button type="button" class="btn btn-primary">No. SI</button>
                                            </div>
		                        ...
		                        <script>
									...
									function pleaseCheck()
									{
										...
										return window.open(url1,'null',winFeature, 'width='+w+', height='+h+', top='+top+', left='+left);  

										// window.open(url1, title, 'width='+w+', height='+h+', top='+top+', left='+left);
									}
								</script>
		                        <div class="form-group" style="display:none">
							...
							<div class="box-body">
		                        ...
		                        <div class="form-group">
		                       	  <label for="inputName" class="col-sm-3 control-label"><?php echo $Notes; ?></label>
		                          	<div class="col-sm-9">
		                                <textarea class="form-control" name="AMD_NOTES"  id="AMD_NOTES" style="height:80px"><?php echo $AMD_NOTES; ?></textarea>
		                          	</div>
		                        </div>
...
<script>
	...
	function add_item(strItem)
	{
		arrItem = strItem.split('|');
		var objTable, objTR, objTD, intIndex, arrItem;
		var AMD_CATEG 	= document.getElementById('AMD_CATEGX').value;
