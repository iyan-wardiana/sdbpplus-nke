...
<html>
    ...
    <?php
        ...
        foreach($resTransl as $rowTransl) :
            ...
            if($TranslCode == 'LasttypeOfBuss')$LasttypeOfBuss = $LangTransl;
                  	...
                  	<div class="search-table-outter">
                      	<table id="example" class="table table-bordered table-striped table-responsive search-table inner" width="100%">
                          	<thead>
                              	...
                              	<th width="15%" style="text-align:center; vertical-align:middle" nowrap><?php echo $CompanyName?></th>
                              	<th width="15%" style="text-align:center; vertical-align:middle" nowrap><?php echo $typeOfBuss?> <br /></th>
                              	<th width="35%" style="text-align:center; vertical-align:middle" nowrap><?php echo $Address?></th>
                              	<th width="25%" style="text-align:center; vertical-align:middle" nowrap><?php echo $Notes?></th>
...
<script>
    ...
    $('#example').DataTable( {
        ...
        "autoWidth": true,
        "filter": true,
        "ajax": "<?php echo site_url('c_project/lst180c2hprj/get_AllDataComp/?id='.$secURL)?>",
        "type": "POST",
