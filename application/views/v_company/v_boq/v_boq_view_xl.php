...
// ---------- START EXCEL_READER2 ----------
	...
	*/
	...
	$BOQH_FN	= '';
	$BOQH_TYPE	= 2;
	$sqlFN		= "SELECT BOQH_FN, BOQH_TYPE FROM tbl_boq_hist WHERE BOQH_CODE = '$BOQH_CODE' AND BOQH_PRJCODE = '$PRJCODE'";
	$sqlFNR		= $this->db->query($sqlFN)->result();
	foreach($sqlFNR as $rowFN) :
		$BOQH_FN		= $rowFN->BOQH_FN;
		$BOQH_TYPE		= $rowFN->BOQH_TYPE;
	endforeach;
				
	$myXlsFile	= "$BOQH_FN";
	if($BOQH_TYPE == 1)
		$myPath 	= "import_excel/import_boq_mst/$myXlsFile";
	else
...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <section class="content-header" style="text-align:center">
        <h1>
            <?php echo $h2_title; ?> 
            <small><?php echo " : $PRJCODE"; ?><br>File Name<?php echo " : $myXlsFile"; ?></small>
        </h1>
        <br>
    </section>
    <style>
