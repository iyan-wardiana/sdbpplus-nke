 ...
 * File Name	= asset_maintenance_selectitem.php
 * Location		= -
*/
...
<head>
	...
	foreach($resTransl as $rowTransl) :
		...
		if($TranslCode == 'Item')$Item = $LangTransl;
...
<div class="box-body">
    <div class="callout callout-success">
        <h4><?php echo "$h2_title :: Please select items below."; ?></h4>
    </div>
                ...
                <thead>
                    <tr>
                        ...
                        <th width="11%" rowspan="2" style="vertical-align:middle; text-align:center" nowrap><?php echo $ItemCode ?> </th>
                   	  ...
                   	  <th colspan="3" nowrap style="text-align:center"><?php echo $Item ?> </th>
                      	<th width="15%" rowspan="2" nowrap><?php echo $UnitType ?> </th>
                  </tr>
                    <tr>
                      <th width="7%" nowrap><?php echo $ItemQty ?>  </th>
                ...
                <?php
                    ...
                    if($recordcountAllItem>0)
                    {
                        ...
                        foreach($viewAllItem as $row) :
							...
							?> 
                            <td style="text-align:center"><input type="checkbox" name="chk" value="<?php echo $ITM_CODE;?>|<?php echo $serialNumber;?>|<?php echo $ITM_DESC;?>|<?php echo $ITM_UNIT;?>|<?php echo $Unit_Type_Name;?>|<?php echo $ITM_UNIT2;?>|<?php echo $Unit_Type_Name2;?>|0|0|<?php echo $itemConvertion;?>|<?php echo $REM_QTY;?>|<?php echo $ITM_PRICE;?>|<?php echo $ITM_KIND;?>" onClick="pickThis(this);" /></td>
