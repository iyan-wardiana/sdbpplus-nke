...
<div class="box">
    <div class="box-body">
        <div class="search-table-outter">
              <table id="example1" class="table table-bordered table-striped" width="100%">
                <thead>
                    <tr>
                        ...
                        <th style="vertical-align:middle; text-align:center" width="14%" nowrap><?php echo $ExpNo; ?> </th>
                ...
                <?php
                    ...
                    if($cASEXP >0)
                    {
                        foreach($vwASEXP as $row) :													
                            ...
                            $PRJNAME			= $row->PRJNAME;
                            $ASEXP_NOTE			= $row->ASEXP_NOTE;
                            $ASEXP_STAT			= $row->ASEXP_STAT;
                            $ASEXP_CREATER		= $row->ASEXP_CREATER;
                            ...
                            if ($j==1) {
                                ...
                                ?>
                                        <td style="text-align:center">
                                        	<?php echo $myNewNo1; ?>.
                                            <input type="radio" name="chkDetail" id="chkDetail" value="<?php echo $ASEXP_NUM;?>" onClick="getValueNo(this);" style="display:none" />
                                        </td>
                                        <td nowrap>
                                            <?php echo $ASEXP_NUM;?>
                                        </td>
                                        <td> <?php print $ASEXP_CODE; ?></td>
                                        <td style="text-align:center"><?php
                                                $date = new DateTime($ASEXP_DATE);
                                                echo $ASEXP_DATE;
                                            ?>                            </td>
                                        <td><?php print "$JOBDESC - $ASEXP_NOTE"; ?> </td>
                                        <td style="text-align:center"><?php echo $ASEXP_CREATER; ?></td>
                                        <td style="text-align:center">
                                        ...
                                        <?php
                                            $secUpd		= site_url('c_asset/c_1s3txpen/update/?id='.$this->url_encryption_helper->encode_url($ASEXP_NUM));
                                            $secPrint	= site_url('c_asset/c_1s3txpen/printdocument/?id='.$this->url_encryption_helper->encode_url($ASEXP_NUM));
                                            $CollID		= "$ASEXP_NUM~$PRJCODE";
                                            $secDel_PO 	= base_url().'index.php/c_asset/c_1s3txpen/trash_PO/?id='.$ASEXP_NUM;
                                        ?>
                                        ...
                                        <td style="text-align:center" nowrap>
                                            ...
                                            <a href="#" onClick="deleteMail('<?php echo $secDel_PO; ?>')" title="Delete file" class="btn btn-danger btn-xs" <?php if($ASEXP_STAT > 1) { ?>disabled="disabled" <?php } ?>>
            ...
            <?php
                $secIndex_PR	= site_url('c_asset/c_1s3txpen/get_all_PR/?id='.$this->url_encryption_helper->encode_url($PRJCODE));
            ?>
        </div>
        <!-- /.box-body -->
    </div>
