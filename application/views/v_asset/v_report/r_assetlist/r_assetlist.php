...
<?php
	...
	foreach($resTransl as $rowTransl) :
		...
		if($TranslCode == 'SortType')$SortType = $LangTransl;
		...
		if($TranslCode == 'AssetStatus')$AssetStatus = $LangTransl;
        ...
        <div class="col-md-12">
            <div class="box box-primary">
                ...
                <div class="box-body chart-responsive">
                    <form class="form-horizontal" name="frm" id="frm" method="post" action="<?php echo $form_action; ?>" onSubmit="return target_popup(this)">
                        <div class="form-group">
                          	<label for="inputName" class="col-sm-2 control-label"><?php echo $ReportType ?> </label>
                          	<div class="col-sm-10">
                                <select name="rType" id="rType" class="form-control" style="max-width:180px" disabled >
                                    <option value="rType" selected> Asset List Report</option>
                                </select>
                          	</div>
                        </div>
                        <div class="form-group">
                          	...
                          	<div class="col-sm-10">
                                <select name="sortBy" id="sortBy" class="form-control select2" style="max-width:140px" >
                                    <option value="AS_CODE" ><?php echo $AssetCode ?> </option>
                                    <option value="AS_NAME" ><?php echo $AssetName ?> </option>
                                    <option value="AS_STAT" ><?php echo $AssetStatus ?> </option>
                                </select>
                          	</div>
                        </div>
                        <div class="form-group">
                          	<label for="inputName" class="col-sm-2 control-label"><?php echo $SortType ?> </label>
                          	<div class="col-sm-10">
                                <select name="sortType" id="sortType" class="form-control select2" style="max-width:140px" >
                        ...
                        <div class="form-group">
                          	...
                          	<div class="col-sm-10">
                                <input type="radio" class="flat-red" name="viewType" id="viewType" value="0" checked /> 
                                <?php echo $WebViewer ?> &nbsp;&nbsp;
                                <input type="radio" class="flat-red" name="viewType" id="viewType" value="1" />
                                <?php echo $Excel ?> 
							</div>
                        </div>
                        <br>
