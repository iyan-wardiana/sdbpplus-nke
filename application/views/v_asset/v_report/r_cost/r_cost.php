 ...
 * Create Date	= 29 Sept 2017
 * File Name	= r_cost.php
 * Location		= -
*/
...
$getproject 	= "SELECT A.PRJCODE, A.PRJNAME FROM tbl_project A ORDER BY A.PRJCODE";
    ...
    <div class="box box-primary"><br>
        <form name="frmsrch" id="frmsrch" action="" method=POST style="display:none">
          ...
          <table width="100%">
            ...
            <tr>
              <td nowrap>&nbsp;&nbsp;<?php echo $AstName; ?><font color="#FFFFFF">&nbsp;</font></td>
              <td nowrap>:</td>
              <td colspan="2" nowrap>
...
<script>
	...
	function target_popup(form)
	{
		...
		isVSAll			= document.getElementById('isVSAll').value;
		if(isVSAll == 0)
		{		
			packageelementsAst	= document.getElementById('packageelementsAst').value;
			if(packageelementsAst == '')
			{
				alert('Please select one or all asset.');
				return false;
			}
		}
