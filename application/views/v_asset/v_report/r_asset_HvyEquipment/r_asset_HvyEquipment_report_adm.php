...
if($vPeriod == "daily")
{
	...
	$KONDITT	= "A.AU_STARTD >= '$StartDate1' AND A.AU_STARTD <= '$EndDate1'";
}
...
else
{
	...
	$KONDITT	= "A.AU_STARTD <= '$EndDate1'";
}

$sqlASET		= "SELECT AS_CODE, AS_CODE_M, AS_NAME, AS_DESC, AS_MACH_TYPE FROM tbl_asset_list WHERE AS_CODE IN ($AS_CODE)";
$resASET 		= $this->db->query($sqlASET)->result();	
foreach($resASET as $rowAset) :
	$AS_CODE_M		= $rowAset->AS_CODE_M;
	$AS_NAME		= $rowAset->AS_NAME;
	$AS_DESC		= $rowAset->AS_DESC;
	$AS_MACH_TYPE	= $rowAset->AS_MACH_TYPE;
endforeach;
?>
<!DOCTYPE html>
<html>
...
<section class="content">
    ...
    <tr>
        ...
        <td colspan="2" class="style2" style="text-align:center; font-weight:bold; text-transform:uppercase; font-size:12px"><?php echo "$RekapitulasiTimeSheet $HeavyEquipmentRent"; ?></td>
  </tr>
    <tr>
        <td colspan="2" valign="top" class="style2" style="text-align:center; font-weight:bold; font-size:12px"><span class="style2" style="text-align:center; font-weight:bold; font-size:12px">(<?=$WeeklyReport?>)</span></td>
    </tr>
    <tr>
        ...
        <td colspan="3" class="style2" style="text-align:left; font-style:italic">
            <table width="100%">
                <tr style="text-align:left; font-style:italic">
                    <td width="4%" nowrap valign="top"><?php echo "$Nomor &amp; $ProjectName"; ?></td>
                    <td width="1%">:</td>
                ...
                <tr style="text-align:left; font-style:italic">
                  <td nowrap valign="top"><?php echo "$ContractNo/SPK"; ?></td>
                  <td>:</td>
              ...
              <tr style="text-align:left; font-style:italic">
                  <td nowrap valign="top"><?php echo "$Periode $Rent"; ?></td>
                  <td>:</td>
                  <td><span class="style2" style="text-align:left; font-style:italic"><?php //echo $PRJNAMECOLLD;?>&nbsp;</span></td>
                  <td>Nama Operator</td>
                  <td>:</td>
                ...
                <tr style="text-align:left; font-style:italic">
                  <td nowrap valign="top"><?php echo $ReportDate; ?></td>
                  <td>:</td>
        ...
        <td colspan="3" class="style2">
            <table width="100%" border="1" rules="all">
                <tr style="background:#CCCCCC">
                  ...
                  <td width="7%" nowrap style="text-align:center; font-weight:bold"><?php //echo $Project ?>Tanggal</td>
                  <td width="24%" nowrap style="text-align:center; font-weight:bold"><?php //echo $AssetName ?>Kegiatan Alat</td>
                  <td width="10%" nowrap style="text-align:center; font-weight:bold"><?php //echo $AssetName ?>No. SPK</td>
                ...
                <?php					
                    ...
                    foreach($resq0 as $rowsqlq0) :
                        ...
                        $AU_REFNO		= $rowsqlq0->AU_REFNO;

                        $WO_CODE		= '';
                        $sqlWO			= "SELECT WO_CODE FROM tbl_wo_header WHERE WO_NUM = '$AU_REFNO'";
