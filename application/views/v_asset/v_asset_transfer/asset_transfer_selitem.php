 ...
 * Create Date	= 13 Agustus 2018
 * File Name	= asset_transfer_selitem.php
 * Location		= -
*/
              ...
              <table id="example1" class="table table-bordered table-striped table-responsive search-table inner" width="100%">
                <thead>
                    <tr>
                        ...
                        <th width="72%" style="text-align:center; vertical-align:middle" nowrap><?php echo $ItemName; ?> </th>
                        <th width="7%" style="text-align:center; vertical-align:middle" nowrap>Unit</th>
                        <th width="6%" style="text-align:center; vertical-align:middle" nowrap>Volume</th>
                  </tr>
                </thead>
                <tbody>
                <?php
                    ...
                    if($cAllItem>0)
                    {
                        ...
                        foreach($vwAllItem as $row) :
							...
							?>
                            <td style="text-align:center"><input type="checkbox" name="chk" value="<?php echo $JOBCODEID;?>|<?php echo $PRJCODE;?>|<?php echo $ITM_CODE;?>|<?php echo $ITM_CODE_H;?>|<?php echo $ITM_NAME;?>|<?php echo $ITM_DESC;?>|<?php echo $ITM_GROUP;?>|<?php echo $ITM_CATEG;?>|<?php echo $ITM_UNIT;?>|<?php echo $ITM_VOLM;?>|<?php echo $ITM_PRICE;?>" onClick="pickThis(this);" /></td>
                            <td nowrap><?php echo $ITM_CODE_H; ?></td>
                            <td nowrap><?php echo "$ITM_NAME - $ITM_DESC"; ?></td>
                            <td style="text-align:center" nowrap><?php echo $ITM_UNIT; ?></td>
                            <td style="text-align:right" nowrap><?php echo number_format($ITM_VOLM, 2); ?></td>
                            </tr>
                        <?php
                        endforeach;
                    }
