 ...
 * File Name	= v_asset_position_report.php
 * Location		= -
*/
...
<section class="content">
    ...
    <tr>
        ...
        <td colspan="2" class="style2" style="text-align:center; font-weight:bold; text-transform:uppercase; font-size:12px"><?php echo $AssetPositionReport ?> (ADMIN)</td>
  </tr>
    <tr>
        ...
        <td colspan="3" class="style2">
            <table width="100%" border="1" rules="all">
                <tr style="background:#CCCCCC">
                  ...
                  <td width="15%" nowrap style="text-align:center; font-weight:bold"><?php echo $Code ?> Manual</td>
                        ...
                        ?>
                            <tr>
                                ...
                                <td nowrap style="text-align:center;"><?php echo $AS_CODE; ?></td>
                              	<td nowrap style="text-align:center;"><?php echo $AS_CODE_M; ?></td>
