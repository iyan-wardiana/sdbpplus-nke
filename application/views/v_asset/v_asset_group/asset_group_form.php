 ...
 * File Name	= asset_group_form.php
 * Location		= -
*/
...
else
{
	...
	$DocNumber		= $default['AG_CODE'];
	$AG_MANCODE		= $default['AG_MANCODE'];
	$AG_NAME		= $default['AG_NAME'];
	$AG_DESC		= $default['AG_DESC'];
}
?>
<!DOCTYPE html>
<html>
        ...
        <div class="col-md-12">
            <div class="box box-primary">
                ...
                <div class="box-body chart-responsive">
                	<form class="form-horizontal" name="news_form" method="post" action="<?php echo $form_action; ?>" enctype="multipart/form-data" onSubmit="return validateInData();">
                        <div class="form-group">
                          	<label for="inputName" class="col-sm-2 control-label"><?php echo $GroupCode ?></label>
                          	<div class="col-sm-10">
                                <?php echo $DocNumber; ?>
               					<input type="hidden" name="AG_CODE" id="AG_CODE" value="<?php echo $DocNumber; ?>" >
                          	</div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <label>
                                    <input type="text" class="form-control" style="max-width:100px; "  name="AG_MANCODE" id="AG_MANCODE" value="<?php echo $AG_MANCODE; ?>" maxlength="10" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                            	<input type="text" class="form-control" style="max-width:150px" name="AG_NAME" id="AG_NAME" size="50" value="<?php echo $AG_NAME; ?>" >
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="inputName" class="col-sm-2 control-label"><?php echo $Notes ?></label>
                            <div class="col-sm-10">
                            	<textarea class="form-control" name="AG_DESC"  id="AG_DESC" style="max-width:350px;height:70px"><?php echo $AG_DESC; ?></textarea>
                            </div>
                        </div>
                        <br>
                        <div class="form-group">
