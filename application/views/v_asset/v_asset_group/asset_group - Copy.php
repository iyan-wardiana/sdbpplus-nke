    ...
    <body class="<?php echo $appBody; ?>" style="background-color: <?=$comp_color?>">
		...
		<?php
			...
			foreach($vAssetGroup as $row) :
				$myNewNo 		= ++$i;
				$AG_CODE 		= $row->AG_CODE;
				$AG_MANCODE		= $row->AG_MANCODE;
				$AG_NAME		= $row->AG_NAME;
				$AG_DESC		= $row->AG_DESC;
				
				$secUpd			= site_url('c_asset/c_asset_group/update/?id='.$this->url_encryption_helper->encode_url($AG_CODE));
				...
				?> 
                        ...
                        <td nowrap> <?php echo anchor($secUpd,$AG_CODE);?></td>
                        <td> <?php echo $AG_MANCODE; ?> </td>
                        <td> <?php echo $AG_NAME; ?> </td>
                        <td> <?php echo $AG_DESC; ?></td>
                    </tr>
					<?php 
				endforeach; 
			}
