              ...
              <table id="example1" class="table table-bordered table-striped table-responsive search-table inner" width="100%">
                <thead>
                    <tr>
                        ...
                        <th width="11%" rowspan="2" style="vertical-align:middle; text-align:center" nowrap>Item Code</th>
                   	  <th width="49%" rowspan="2" style="vertical-align:middle; text-align:center">Item Name</th>
                   	  <th colspan="3" nowrap style="text-align:center">Item Qty</th>
                      	<th width="15%" rowspan="2" nowrap>Unit Type</th>
                  </tr>
                    <tr>
                      <th width="5%" nowrap>Item Qty </th>
                      <th width="6%" nowrap>Used </th>
                      <th width="12%" nowrap>Remain </th>
                    </tr>
                </thead>
                <tbody>
                <?php
                    ...
                    if($recordcountAllItem>0)
                    {
                        ...
                        foreach($viewAllItem as $row) :
							...
							?> 
                            <td style="text-align:center"><input type="checkbox" name="chk" value="<?php echo $ITM_CODE;?>|<?php echo $serialNumber;?>|<?php echo $ITM_DESC;?>|<?php echo $ITM_UNIT;?>|<?php echo $Unit_Type_Name;?>|<?php echo $ITM_UNIT2;?>|<?php echo $Unit_Type_Name2;?>|0|0|<?php echo $itemConvertion;?>|<?php echo $ITM_VOLM;?>|<?php echo $ITM_PRICE;?>" onClick="pickThis(this);" /></td>
