 ...
 * File Name	= asset_usagreq_form.php
 * Location		= -
*/
...
{	
	...
	$sql = "SELECT MAX(Patt_Number) as maxNumber FROM tbl_wosalt_header
...
<?php
	...
	if($resCAPP > 0)
	{
		$sqlAPP	= "SELECT * FROM tbl_docstepapp WHERE MENU_CODE = 'MN342'";
        ...
        <form class="form-horizontal" name="frm" method="post" action="<?php echo $form_action; ?>" enctype="multipart/form-data" onSubmit="return validateInData()">
            ...
            <input type="Hidden" name="rowCount" id="rowCount" value="0">
            	...
            	<div class="form-group" style="display:none">
                    ...
                    <div class="col-sm-10">
                    	<input type="text" class="form-control" style="max-width:180px;text-align:left" name="WO_NUM1" id="WO_NUM1" size="30" value="<?php echo $DocNumber; ?>" disabled />
            	...
            	<div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <label>
                            <input type="text" class="form-control" style="min-width:110px; max-width:180px; text-align:left" id="WO_CODE" name="WO_CODE" value="<?php echo $WO_CODE; ?>" />
                        </label>
                        <label>
            	...
            	<div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        <i class="fa fa-calendar"></i>&nbsp;</div><input type="text" name="WO_DATE" class="form-control pull-left" id="datepicker" value="<?php echo $WO_DATE; ?>" style="width:106px" onChange="getWO_NUM(this.value)"></div>
                    </div>
                </div>
            	<div class="form-group">
                    ...
                    <div class="col-sm-10">
                    	<div class="input-group date">
                        <div class="input-group-addon">
                        <i class="fa fa-calendar"></i>&nbsp;</div><input type="text" name="WO_ENDD" class="form-control pull-left" id="datepicker1" value="<?php echo $WO_ENDD; ?>" style="width:106px"></div>
                    </div>
                </div>
            	<div class="form-group">
                    <label for="inputName" class="col-sm-2 control-label"><?php echo $Category; ?></label>
                    <div class="col-sm-10">
                    	<select name="WO_CATEG" id="WO_CATEG" class="form-control" style="max-width:150px" onChange="changeCODE(this.value)" >
                          ...
                          <option value="SUBC" <?php if($WO_CATEG == 'SUBC') { ?> selected <?php } ?>> Sub Contractor</option>
                        </select>                       
                    </div>
                </div>
            	<div class="form-group" style="display:none">
            	...
            	<div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <select name="PR_REFNO[]" id="PR_REFNO" class="form-control select2" multiple="multiple" data-placeholder="&nbsp;&nbsp;&nbsp;<?php echo $JobName; ?>" style="max-width:400px;" onBlur="selJOB(this.value)">
            	...
            	<div class="form-group">
                    ...
                    <div class="col-sm-10">
                    	<textarea name="WO_NOTE" class="form-control" style="max-width:350px;" id="WO_NOTE" cols="30"><?php echo $WO_NOTE; ?></textarea>                        
                    </div>
                </div>
            	<div class="form-group">
                    ...
                    <div class="col-sm-10">
						...
						<?php
                            ...
                            if($ISCREATE == 1)
                            {
								...
								?>
									<select name="WO_STAT" id="WO_STAT" class="form-control" style="max-width:100px" onChange="selStat(this.value)" <?php if($isDisabled == 1) { ?> disabled <?php } ?>>
...
<script>
	...
	function add_item(strItem) 
	{
		...
		objTD = objTR.insertCell(objTR.cells.length);
		objTD.style.textAlign = 'center';
		objTD.innerHTML = '<input type="hidden" name="data['+intIndex+'][WO_TOTAL2]" id="data'+intIndex+'WO_TOTAL2" value="" class="form-control" style="max-width:300px;" onKeyPress="return isIntOnlyNew(event);" ><input type="text" name="data'+intIndex+'WO_TOTAL2A" id="WO_TOTAL2A'+intIndex+'" value="" class="form-control" style="min-width:130px; max-width:130px; text-align:right;" onKeyPress="return isIntOnlyNew(event);" ><input type="hidden" name="data['+intIndex+'][WO_DESC]" id="data'+intIndex+'WO_DESC" size="20" value="" class="form-control" style="min-width:110px; max-width:100px; text-align:left">';
	...
	function getConvertion(thisVal1, row)
	{
		...
		if(REQ_NOW_AMOUNT > REM_WO_AMOUNT)
		{
			...
			alert('Request Qty is Greater than Budget. Maximum Qty is '+REM_WO_QTY+' or in Amount is '+REM_WO_AMOUNT);
