                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown notifications-menu" style="display:none">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <?php /*?><span class="label label-warning">10</span><?php */?>
                        ...
                        <li class="dropdown tasks-menu" style="display:none">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <?php /*?><span class="label label-danger">9</span><?php */?>
                                <span class="label label-danger" style="display:none">9</span>
                            </a>
                            <ul class="dropdown-menu">
                                <?php /*?><li class="header">You have 9 tasks</li><?php */?>
                                <li class="header" style="display:none">You have 9 tasks</li>
                                <li>
                                    <!-- inner menu: contains the actual data -->
                                    <ul class="menu" style="display:none">
                                        <li><!-- Task item -->
