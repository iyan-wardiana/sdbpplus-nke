...
$getproject 	= "SELECT PRJCODE, PRJNAME FROM tbl_project
					...
					ORDER BY PRJCODE";
$qProject 		= $this->db->query($getprojectaa)->result();
?>
<!DOCTYPE html>
<html>
<head>
...
<?php
	$urlUpdAuth			= site_url('c_setting/c_employee/employee_project_process/?id='.$this->url_encryption_helper->encode_url($appName));
?>
          ...
          <table width="100%">
              <tr>
                  <td width="16%"><input type="hidden" id="Emp_ID1" name="Emp_ID1" value="<?php print $Emp_ID; ?>" width="10" size="10" class="textbox">
                      &nbsp;&nbsp;&nbsp;Function Name        </td>
                  <td width="1%">:</td>
                  <td width="83%">Authorization Employee's Project and Account</td>
              </tr>
              <tr>
                  <td width="16%">
                      &nbsp;&nbsp;&nbsp;Username Name        </td>
              ...
              <tr>
                  ...
                  <table width="200" border="0">
                    <tr>
                      <td width="12">&nbsp;</td>
                      <td width="106">
                      	<select multiple="multiple" class="options" size="20" name="pavailable" onclick="MoveOption(this.form.pavailable, this.form.packageelements)">
                            <?php
                      ...
                      <td width="60" bor>
                          <?php					
                            ...
                            ?>
                          <select multiple="multiple" name="packageelements[]" id="packageelements" size="20"  style="width: 300px;" ondblclick="MoveOption(this.form.packageelements, this.form.pavailable)">
                            <?php
                                if($resGetCount > 0)
                                {
