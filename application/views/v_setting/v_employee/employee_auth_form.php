...
<?php
	$urlUpdAuth			= site_url('c_setting/c_employee/employee_authorization_process/?id='.$this->url_encryption_helper->encode_url($appName));
?>
                		...
                		<table width="100%">
							<?php 
                                ...
                                foreach($viewallmenu as $row) : 
                                {
                                    ...
                                    <?php
                                    // Menu level 2
                                    $sql2 = "SELECT menu_id, menu_code, isHeader, level_menu, link_alias, menu_name_IND, menu_name_ENG, menu_user
                                        FROM tbl_menu
                                        WHERE parent_code = '$menu_code1'
                                        ORDER BY no_urut";
                                    ...
                                    if($resultCount2 > 0)
                                    {
                                        ...
                                        <?php
                                            // Menu level 3
                                            $sql3 = "SELECT menu_id, menu_code, isHeader, level_menu, link_alias, menu_name_IND, menu_name_ENG, menu_user
                                                FROM tbl_menu
                                                WHERE parent_code = '$menu_code2'
                                                ORDER BY no_urut";
