 ...
 * Create Date	= 28 Agustus 2017
 * File Name	= v_news_read_list.php
 * Location		= -
*/
...
$sqlMG		= "SELECT A.NEWSD_ID, A.NEWSD_CODE, A.NEWSD_DATE, A.NEWSD_RECEIVER, A.NEWSD_TITLE, A.NEWSD_CONTENT, A.NEWSD_CREATER, 
					A.NEWSD_CREATED, A.NEWSD_IMG, A.NEWSD_IMG1, A.NEWSD_IMG2, A.NEWSD_IMG3, A.NEWSD_IMG4, B.First_Name, B.Last_Name
				FROM tbl_news_detail A
					INNER JOIN tbl_employee B ON A.NEWSD_CREATER = B.Emp_ID
				WHERE A.NEWSD_CODE = '$NEWSH_CODE'";
$sqlMG		= $this->db->query($sqlMG)->result();
foreach($sqlMG as $rowMG) :
	$NEWSD_ID		= $rowMG->NEWSD_ID;
            ...
            <!-- timeline time label -->
                ...
                <li>
                    ...
                    <div class="timeline-item">
                        ...
                        <h3 class="timeline-header"><?php echo $NEWSD_TITLE; ?></h3>
