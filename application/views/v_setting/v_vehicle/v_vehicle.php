                        ...
                        <table id="example" class="table table-bordered table-striped table-responsive search-table inner" width="100%">
                            ...
                            <tr>
				                ...
				                <th width="5%" style="text-align:center; vertical-align:middle" nowrap><?php echo $Code ?> </th>
				           	  	<th width="35%" style="text-align:center; vertical-align:middle" nowrap><?php echo $Type ?> </th>
				           	  	<th width="35%" style="text-align:center; vertical-align:middle" nowrap><?php echo $Brand ?> </th>
				                <th width="15%" style="text-align:center; vertical-align:middle" nowrap>No. Polisi </th>
                            ...
                            <tr>
                              <td style="text-align:left" colspan="6">
                                <?php
            						$secAddURL = site_url('c_setting/c_vehicle/v3hl44d/?id='.$this->url_encryption_helper->encode_url($appName));
...
<script>
    ...
    $('#example').DataTable( {
        ...
        "autoWidth": true,
        "filter": true,
        "ajax": "<?php echo site_url('c_setting/c_vehicle/get_AllData/')?>",
        "type": "POST",
