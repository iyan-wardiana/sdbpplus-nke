...
{
	$CURR_ID 		= $default['CURR_ID'];
	$CURR_CODE 		= $default['CURR_CODE'];
	$CURR_NOTES 	= $default['CURR_NOTES'];
	$CURR_STAT 		= $default['CURR_STAT'];
}
?>
<!DOCTYPE html>
<html>
    ...
    <div class="box box-primary"><br>
      <form name="absen_form" method="post" action="<?php echo $form_action; ?>" onSubmit="return validateInCurr();">
          ...
          <table width="100%" border="0" style="size:auto" bgcolor="#FFFFFF">
              <tr>
                  <td width="15%" align="left" class="style1">Currency ID</td>
                  <td width="1%" align="left" class="style1">:</td>
                  <td width="84%" align="left" class="style1" style="font-style:italic">
                      <input type="text" maxlength="15" name="CURR_ID" id="CURR_ID" class="form-control" style="max-width:80px" value="<?php echo $CURR_ID; ?>" />                  </td>
              </tr>
              <tr>
                  <td align="left" class="style1">Currency Code</td>
                  <td align="left" class="style1">:</td>
                  <td align="left" style="font-style:italic">
                      <input type="text" maxlength="15" name="CURR_CODE" id="CURR_CODE" class="form-control" style="max-width:80px" value="<?php echo $CURR_CODE; ?>" onChange="changeLimit(1)" /></td>
              </tr>
              <tr style="vertical-align:top">
                  <td align="left" class="style1">Notes</td>
                  <td align="left" class="style1">:</td>
                  <td align="left" style="font-style:italic">
                      <textarea name="CURR_NOTES" id="CURR_NOTES" cols="30" rows="4" class="form-control" style="max-width:350px"><?php echo $CURR_NOTES; ?></textarea>                  </td>
              </tr>
              <tr style="vertical-align:top">
                  <td align="left" class="style1">Status</td>
                  <td align="left" class="style1">:</td>
                  <td align="left" style="font-style:italic">
                      <select name="CURR_STAT" id="CURR_STAT" class="form-control" style="max-width:130px">
                          <option value="1" <?php if($CURR_STAT == 1) { ?>selected<?php } ?>>Aktive</option>
                          <option value="0" <?php if($CURR_STAT == 0) { ?>selected<?php } ?>>Non Aktive</option>
                      </select>                  </td>
              </tr>
              <tr>
                  <td align="left" class="style1">&nbsp;</td>
