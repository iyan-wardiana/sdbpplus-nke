        ...
        <section class="content">
            <div class="box">
                <div class="box-body">
                    <div class="search-table-outter">
                        <table id="example" class="table table-bordered table-striped table-responsive search-table inner" width="100%">
                            ...
                            <tr>
                                ...
                                <th width="25%"><?php echo $Description; ?></th>
                                <th width="60%" nowrap>Link Acount</th>
                    ...
                    <?php
                        $secAddURL = site_url('c_setting/c_t4x_ppn/t4x_l44d/?id='.$this->url_encryption_helper->encode_url($appName));
...
<script>
    ...
    $('#example').DataTable( {
        ...
        "autoWidth": true,
        "filter": true,
        "ajax": "<?php echo site_url('c_setting/c_t4x_ppn/get_AllData/')?>",
        "type": "POST",
