...
<?php
	...
	foreach($resTransl as $rowTransl) :
		...
		if($TranslCode == 'Departement')$Departement = $LangTransl;
            ...
            <table id="example1" class="table table-bordered table-striped" width="100%">
                ...
                <tr>
                    <th width="8%"><?php echo $Code ?>  </th>
               	  <th width="78%"><?php echo $Departement ?> </th>
                ...
                <tr>
                    <td colspan="3">
                    	<?php echo anchor($secAddURL,'<input type="button" name="btnSubmit" id="btnSubmit" class="btn btn-primary" value="Add Department" />');?>                    </td>
			    </tr>                              
            </table>
      </div>
      	<!-- /.box -->
