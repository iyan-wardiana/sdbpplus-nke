                ...
                <div class="box-body">
                    <table id="example1" class="table table-bordered table-striped" width="100%">
                        ...
                        <tr>
                            ...
                            <th width="11%">ID</th>
                            <th width="37%"><?php echo $UnitName; ?></th>
                        ...
                        if($recordcount >0)
                        {
                            foreach($viewCurrency as $row) : 
                                ...
                                $secUpd		= site_url('c_setting/c_1Nv7yp3/update/?id='.$this->url_encryption_helper->encode_url($Unit_Type_ID));
                                ...
                                ?> 
                                    ...
                                    <td><?php echo anchor($secUpd,$Unit_Type_Code);?></td>
                                    <td><?php echo "$Unit_Type_Code"; ?></td>
                                    <td><?php echo "$Unit_Type_Name"; ?></td>
                                </tr>
                                <?php
                            endforeach; 
                        }
                        $secAddURL = site_url('c_setting/c_1Nv7yp3/add/?id='.$this->url_encryption_helper->encode_url($appName));
                        ?>
                        </tbody>
                        <tfoot>
                            <tr>
