	    	...
	    	<form class="form-horizontal" name="frm" method="post" action="" enctype="multipart/form-data" onSubmit="return validateInData()">
				...
				<div class="box box-danger">
					<div class="box-body">
						...
						<?php
							$imgLoc	= base_url('assets/AdminLTE-2.0.5/dist/img/compLog/nkes/compLog_Login.png');
						?>
				        <div class="col-md-12">
				          	<div class="box box-widget">
					            <div class="box-header with-border">
					              	<div class="user-block">
					                	<img class="img-circle" src="<?=$imgLoc?>" alt="User Image">
					                	<span class="username"><a href="#">Tim Pengembang SdBP+ dan Dooc. Center</a></span>
					                	<span class="description">Informasi Publik - Kamis, 20 Oktober 2022 13:30</span>
					              	</div>
					            ...
					            <div class="box-body">
					              	...
					              	<p>Kami informasikan bahwa untuk melakukan pengisian Lembar Kerja Harian (LKH) karyawan akan mulai diberlakukan pada<br>
					              		Hari : Senin, 24 Oktober 2022<br>
					              		URL  : <a href="https://doc.nke.co.id/" target="_blank">https://doc.nke.co.id/</a><br>
					              		Menu : <b>Laporan Kerja Harian</b><br><br></p>
					              	<p>Dengan demikian, untuk melakukan penginputan LKH Karyawan, Bapak/Ibu silahkan makses URL di atas.</p>

					              	<div class="alert alert-warning alert-dismissible">
						                <button type="button" class="close" data-dismiss="alert" aria-hidden="true" style="display: none;">&times;</button>
						                <h4><i class="icon fa fa-warning"></i> PERHATIAN!</h4>
						                Mohon untuk diperhatikan bahwa batas Pengisian LKH mulai dari pukul 00.00 - 23.00 WIB setiap harinya.
					              	</div>

					              	<button type="button" class="btn btn-default btn-xs"><i class="fa fa-share"></i></button>
					              	<button type="button" class="btn btn-default btn-xs"><i class="fa fa-thumbs-o-up"></i></button>
					              	<span class="pull-right text-muted">IT NKE Developer Team</span>
					            </div>
				        	</div>
						</div>
					</div>
