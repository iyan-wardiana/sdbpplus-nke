                        ...
                        <table id="example" class="table table-bordered table-striped table-responsive search-table inner" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th width="20%" style="text-align:center; vertical-align:middle">NIK / <?php echo $EmployeeName; ?></th>
                                    <th width="25%" style="text-align:center; vertical-align:middle"><?php echo $SectionName; ?></th>
                                    ...
                                    <th width="10%" style="text-align:center; vertical-align:middle"><?php echo $Authorization; ?></th>
                                </tr>
                            </thead>
                            <tbody>
                            </tbody>
