...
<form action="<?php print site_url();?>/c_purchase/purchase_requisition/searchpurreq" method=POST>
...
<div class="CSSTableGenerator">
    <table width="100%">
		...
		?>
            <tr>
                <td> <?php print ++$i; ?> </td>
                <td> <?php print anchor('c_purchase/purchase_requisition/update_inbox/'.$row->PR_Number,$row->PR_Number,array('class' => 'update')).' '; ?> </td>
                <td> <?php print $row->PR_Date; ?> </td>
                <td> <?php print $row->Vend_Code; ?> </td>
                <td> <?php print $compName; ?> </td>
