...
/* 
	...
	* File Name		= purchase_req_inb4lt_form.php
	* Location		= -
*/
						...
						<div class="box box-primary">
							...
							<div class="box-body">
				                ...
				                <div class="form-group">
				                    ...
				                    <div class="col-sm-3">
		                                <select name="PR_CATEG" id="PR_CATEG" class="form-control select2" onChange="chkSTAT(this.value)">
                                            <option value="1"<?php if($PR_CATEG == 0) { ?> selected <?php } ?>>---</option>
                                            <option value="2"<?php if($PR_CATEG == 1) { ?> selected <?php } ?>>Alat</option>
		                                </select>
				                    </div>
				                </div>
				            	<div class="form-group">
                      	...
                      	<div class="box box-primary">
	                        <div class="search-table-outter">
	                            <table id="tbl" class="table table-bordered table-striped" width="100%">
	                                ...
	                                if($task == 'edit')
	                                {
	                                    $sqlDET	= "SELECT DISTINCT A.PR_NUM, A.PR_CODE, A.PRJCODE, A.PR_REFNO, A.ITM_CODE, A.SNCODE, A.ITM_UNIT, 
		                ...
		                <div class="form-group">
			           	<label for="inputName" class="col-sm-3 control-label">&nbsp;</label>
		                        ...
		                        <?php
		                            ...
		                            $backURL	= site_url('c_purchase/c_pr180d0c/iN20_x14lt/?id='.$this->url_encryption_helper->encode_url($PRJCODE));
