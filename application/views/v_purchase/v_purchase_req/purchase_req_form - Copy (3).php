		                                            ...
		                                            else
		                                            {
		                                                ...
		                                                if($PR_STAT == 3 && $REM_VOLPR > 0)
		                                                {
		                                                	...
		                                                	?>
		                                                		...
		                                                		<a onClick="cancelRow(<?php echo $currentRow; ?>)" title="Batalkan Sisa Volume" class="btn btn-danger btn-xs"><i class="fa fa-repeat"></i></a>
		                                                	<?php
		                                                }
		                                                else
		                                                {
														...
														<table class="table no-margin">
															<tbody>
																<tr style="font-size: 14px">
																	<td>
																		<span class="label label-primary" style="font-size: 12px; width: 100%" id="itmCode"></span>
																	</td>
																	<td colspan="4">
																		<span class="label label-primary" style="font-size: 12px; width: 100%" id="itmName"></span>
																	</td>
																</tr>
																<tr style="font-size: 14px">
																	<td>&nbsp;</td>
																	<td colspan="4">
																		<span class="label label-primary" style="font-size: 12px; width: 100%" id="jobName"></span>
																	</td>
																</tr>
																<tr style="font-size: 14px">
																	<td>&nbsp;</td>
																	<td style="text-align: right;">
																		<span style="font-size: 12px; font-weight: bold;"><?=$Planning?></span>
																	</td>
																	<td style="text-align: right;">
																		<span style="font-size: 12px; font-weight: bold;"><?=$Requested?></span>
																	</td>
																	<td style="text-align: right;">
																		<span style="font-size: 12px; font-weight: bold;"><?=$Remain?></span>
																	</td>
																	<td style="text-align: right;">
																		<span style="font-size: 12px; font-weight: bold;"><?=$Unit?></span>
																	</td>
																</tr>
																<tr style="font-size: 14px">
																	<td>&nbsp;</td>
																	<td style="text-align: right;">
																		<span class="label label-info" id="itmPRVol" style="font-size: 12px; width: 100%"></span>
																	</td>
																	<td>
																		<span class="label label-danger" id="itmPOVol" style="font-size: 12px"></span>
																	</td>
																	<td>
																		<span class="label label-success" id="itmREMVol" style="font-size: 12px"></span>
																	</td>
																	<td>
																		<span class="label label-success" id="itmUnit" style="font-size: 12px"></span>
																	</td>
																</tr>
																<tr style="font-size: 14px">
																	<td>
																		<button type="button" class="btn bg-olive margin">Vol. <?=$Cancel?></button></td>
...
<script>
	...
	function cancelRow(row) 
	{
		...
		document.getElementById('itmPRVol').innerHTML 	= doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(PR_VOLM)), 2));
		document.getElementById('itmPOVol').innerHTML 	= doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(PO_VOLM)), 2));
		document.getElementById('itmREMVol').innerHTML 	= doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(REM_VOLPR)), 2));
