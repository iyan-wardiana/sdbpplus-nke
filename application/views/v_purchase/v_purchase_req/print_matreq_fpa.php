				...
				<table width="100%">
					...
					<tbody>
						...
						<?php
							...
							$this->db->from('tbl_pr_detail_fpa A');
							$this->db->join('tbl_pr_header_fpa B','B.PR_NUM = A.PR_NUM AND B.PRJCODE = A.PRJCODE','INNER');
			...
			<div class="box-asign">
				<table width="100%" border="1" rules="all">
					<tr>
						...
						<td width="100" height="100" style="text-align: center; vertical-align: top; display: none;">
						...
						<td width="100" height="100" style="text-align: center; vertical-align: top;">
							<span class="asign-top" style="font-weight: bold; font-size: 9px;"><?=strtoupper($POSIT_03)?><br></span>
	                        <input id="app_03" type="app_03" value="<?php echo $COMPIL_03; ?>" style="width:80%; display:none" />
							<div id="qrc_03"></div><br>
						</td>
						<td width="100" height="100" style="text-align: center; vertical-align: top;">
							<span class="asign-top" style="font-weight: bold; font-size: 9px;"><?=strtoupper($POSIT_04)?><br></span>
