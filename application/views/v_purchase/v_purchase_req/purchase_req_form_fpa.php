...
/* 
	...
	* File Name		= purchase_req_form_fpa.php
	* Location		= -
*/
...
else
{
	...
	$s_sql 	= "SELECT COUNT(*) AS TOT_PR
				FROM (SELECT A.* FROM tbl_pr_detail_fpa A WHERE A.PR_NUM = '$PR_NUM' AND A.PRJCODE = '$PRJCODE'
				UNION ALL
...
// REJECT FUNCTION
	// CEK ACCESS OTORIZATION
		$resAPP	= 0;
		$sqlAPP	= "tbl_docstepapp_det WHERE MENU_CODE = 'MN469'
		                ...
		                <div class="form-group">
		                    ...
		                    <div class="col-sm-9">
		                        <?php
		                            ...
		                            $backURL	= site_url('c_purchase/c_pr180d0c/pRQ_l5t_x_fpa/?id='.$this->url_encryption_helper->encode_url($PRJCODE));
							    	...
							    	<div class="col-md-12">
						              	<ul class="nav nav-tabs">
						                    <li id="li1" <?php echo $Active1Cls; ?>>
						                    	<a href="#itm1" data-toggle="tab" onClick="setType(1)"><?php echo "Daftar Pekerjaan Alat"; ?></a>
						                    </li>	
					...
					function setType(tabType)
					{
						if(tabType == 1)
						{
							...
							$('#mtr_perjob').DataTable(
					    	{
								...
								"autoWidth": true,
								"filter": true,
						        "ajax": "<?php echo site_url('c_purchase/c_pr180d0c/get_AllDataITMT/?id='.$PRJCODE.'&PRNUM='.$PR_NUM)?>",
						        "type": "POST",
...
<script>
	...
	$(document).ready(function()
	{
		$('#tbl').DataTable(
    	{
	        ...
	        "ajax": {
				        "url": "<?php echo site_url('c_purchase/c_pr180d0c/get_AllDataIITMDET_fpa/?id='.$PRJCODE.'&PR_NUM='.$PR_NUM.'&task='.$task)?>",
				        "type": "POST",
						"beforeSend": function() {
		...
		$.ajax({
            ...
            success: function(maxPR_ID)
            {
            	...
            	$('#tbl').DataTable(
		    	{
					...
					"autoWidth": true,
					"filter": true,
			        "ajax": "<?php echo site_url('c_purchase/c_pr180d0c/get_AllDataIITMDET_fpa/?id='.$PRJCODE.'&PR_NUM='.$PR_NUM.'&task='.$task)?>",
			        "type": "POST",
					"lengthMenu": [[5, 10, 25, 50, 100, 200, -1], [5, 10, 25, 50, 100, 200, "All"]],
					"pageLength": -1,
					// "lengthMenu": [[500,1000], [500,1000]],
