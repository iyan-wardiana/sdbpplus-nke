    ...
    <body class="<?php echo $appBody; ?>" style="background-color: <?=$comp_color?>">
		...
		<section class="content">
						...
						<div class="box box-warning">
							...
							<div class="box-body">
				                ...
				                <div id="upFile" class="form-group">
				                    <label for="upFile" class="col-sm-3 control-label">Attachment</label>
				                    <div class="col-sm-9">
				                    	<a class="btn btn-sm btn-default" data-toggle="modal" data-target="#mdl_uplFile" data-backdrop="static" data-keyboard="false">
			                        		<i class="glyphicon glyphicon-cloud-upload"></i>&nbsp;&nbsp;<?php echo "Upload File"; ?>
			                        	</a>
				                    </div>
				                </div>
				                <div class="form-group">
	    	...
	    	<!-- ============ START MODAL =============== -->
				...
				<div class="modal fade" id="mdl_uplFile" name='mdl_uplFile' tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		            <div class="modal-dialog">
			            <div class="modal-content">
			                <div class="modal-body">
								<div class="row">
							    	<div class="col-md-12">
							    		<div class="box box-primary">
								            <div class="box-header">
									            ...
									            <div class="box-body">
									            	<form class="form-horizontal" name="frmUploadFile" id="frmUploadFile" enctype="multipart/form-data">
									              	<div class="form-group">
									            		<label for="inputName" class="col-sm-3 control-label">Upload File</label>
									            		<div class="col-sm-9">
															<div class="multiple-form-group input-group">
																<input type="file" name="UP_FILE[]" id="UP_FILE" class="form-control" multiple>
			                                        ...
			                                        <div class="form-group">
			                                        	<label for="inputName" class="col-sm-3 control-label"><?php echo "Deskripsi"; ?></label>
										                    <div class="col-sm-9">
										                        <textarea name="UPFILE_DESC" class="form-control" id="UPFILE_DESC"></textarea>
										                    </div>
			                                        </div>
									            </div>
									            <!-- /.box-body -->
									            ...
									            <div class="box-footer">
		                                      		<button class="btn btn-primary" type="button" id="btnUpload" name="btnUpload">
	                                            		<i class="glyphicon glyphicon-upload"></i>&nbsp;&nbsp;<?php echo "Upload"; ?>
	                                            	</button>
	                              					<button type="button" id="idClose_upl" class="btn btn-danger" data-dismiss="modal"><i class="glyphicon glyphicon-remove"></i>&nbsp;&nbsp;<?php echo $Close; ?>
			                                        </button>
		                                      	</div>
								        </div>
								        <!-- /.box -->
				...
				<script type="text/javascript">
					...
					$(document).ready(function()
					{
					    ...
					    $('#btnUpload').on('click', function(){
							...
							jQuery.each(jQuery('#UP_FILE')[0].files, function(i, file) {
							    data.append('file[]', file);
							});
					    	$.ajax({
					    		url: "<?php echo base_url('c_purchase/c_pr180d0c/uploadFile') ?>",
					    		type: "POST",
					    		dataType: "JSON",
					    		...
					    		complete: function()
					    		{
					    			...
					    			$('#mdl_uplFile').find("input[type=file], textarea").val("").end();
					    		}
					    	});
					    });
					});
