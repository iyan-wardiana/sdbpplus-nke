				                ...
				                <div class="form-group">
				                    ...
				                    <div class="col-sm-9">
				                        <div class="input-group date">
				                        	...
				                        	<input type="text" name="PR_DATEX" class="form-control pull-left" value="<?php echo $PR_DATE; ?>" style="width:106px" onChange="getPR_NUM(this.value)">
				                        	<input type="hidden" name="PR_DATE" class="form-control pull-left" id="datepicker" value="<?php echo $PR_DATE; ?>">
				                        </div>
				                    </div>
				                </div>
				                <script>
