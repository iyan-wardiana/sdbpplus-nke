...
<html>
    ...
    <body class="<?php echo $appBody; ?>" style="background-color: <?=$comp_color?>">
			...
			<h1>
			    ...
			    <div class="pull-right">
                    <?php
                    	...
                    	//if($ISDELETE == 1)
                    		echo '<button class="btn btn-warning" onClick="syncPR()" title="Sync. Data SPP, OP, LPM"><i class="glyphicon glyphicon-refresh"></i></button>&nbsp;';
		...
		<section class="content">
			<div class="row" id="syncPRDESC" style="display: none;">
                <div class="col-sm-12">
                    <div class="alert alert-danger alert-dismissible">
                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                        <h4><i class="icon fa fa-warning"></i> PERHATIAN</h4>
                        Proses ini akan melakukan:<br>
                        1. Mereset harga SPP menyesuaikan harga RAP<br> 
                        2. Mereset Qty dan Harga pada dokumen OP.<br>
                        <button class="btn btn-info" onClick="syncPRPROC()"></i>Lanjutkan</button>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="box box-primary">
                        <div class="box-body">
                            ...
                            <div class="col-sm-2">
                                <label for="inputName" class="control-label">No. OP</label>
                            ...
                            <input type="hidden" name="SPPCAT" id="SPPCAT" value="<?=$SPPCAT?>">
                        </div>
                    </div>
                </div>
            </div>
...
<script>
	...
	function showDHist(row)
	{
		var url	= document.getElementById('urlHist'+row).value;
		w = 900;
		h = 550;
		var left = (screen.width/2)-(w/2);
		var top = (screen.height/2)-(h/2);
	...
	function syncPR()
	{
		document.getElementById('syncPRDESC').style.display 	= '';
	}
	
	function syncPRPROC()
	{
		document.getElementById('syncPRDESC').style.display 	= 'none';
		...
		$("#myiFrame")[0].contentWindow.IMP_CODEX.value 	= 'SYNCPR';
		$("#myiFrame")[0].contentWindow.IMP_TYPE.value 		= 'SYNCPR';
		butSubm.submit();
	}
