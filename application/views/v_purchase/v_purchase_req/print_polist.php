...
<?php
	...
	foreach($resTransl as $rowTransl) :
		...
		if($TranslCode == 'RequestDate')$RequestDate = $LangTransl;
		if($TranslCode == 'OrderCode')$OrderCode = $LangTransl;
		if($TranslCode == 'OrderDate')$OrderDate = $LangTransl;
...
<div class="box-body">
    <div class="callout callout-success">
        <?php echo "$POList : $PR_CODE ($PR_DATE)"; ?>
    </div>
              ...
              <table id="example11" class="table table-bordered table-striped table-responsive search-table inner" width="100%">
                <thead>
                    <tr>
                        ...
                        <th width="13%" nowrap><?php echo $OrderCode; ?></th>
                        <th width="9%" nowrap><?php echo $OrderDate; ?></th>
                        <th width="75%" nowrap><?php echo $Supplier; ?>  </th>
                  </tr>
                </thead>
                <tbody>
                <?php
