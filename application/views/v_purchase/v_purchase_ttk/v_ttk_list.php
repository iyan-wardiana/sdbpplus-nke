	    ...
	    <section class="content-header">
	        <h1>
                ...
                <div class="pull-right">
                    <?php
						$url_add 	= site_url('c_purchase/c_pi180c23/i180dahdd/?id='.$this->url_encryption_helper->encode_url($PRJCODE));
						$url_addDir	= site_url('c_purchase/c_pi180c23/i180dahdir/?id='.$this->url_encryption_helper->encode_url($PRJCODE));
						echo anchor("$url_add",'<button class="btn btn-primary"><i class="glyphicon glyphicon-plus"></i></button>&nbsp;');
						echo anchor("$url_addDir",'<button class="btn btn-warning"><i class="glyphicon glyphicon-plus"></i>&nbsp;&nbsp;Direct</button>&nbsp;');
                ...
                <div class="col-md-12">
                    <div class="box box-primary">
                        <div class="box-body">
                            ...
                            <div class="col-sm-4">
                                <?php
                                $s_DOCREF   = "SELECT DISTINCT TTK_REF1_NUM AS DOC_NUM, TTK_REF1_CODE AS DOC_CODE FROM tbl_ttk_detail WHERE PRJCODE = '$PRJCODE' AND TTKD_STAT NOT IN (5,9)";
                                $r_DOCREF   = $this->db->query($s_DOCREF);
                                ?>
                                <label for="inputName" class="control-label">No. LPM/Opn</label>
                                <select name="DOC_NUM" id="DOC_NUM" class="form-control select2">
                                    <option value=""> --- </option>
                                    <?php
            ...
            <script type="text/javascript">
                function grpData_HOLD()
                {
                    ...
                    $('#example').DataTable(
			    	{
			            ...
			            "autoWidth": true,
			            "filter": true,
				        "ajax": "<?php echo site_url('c_purchase/c_pi180c23/get_AllDataTTKGRP/?id='.$PRJCODE)?>"+'&SPLCODE='+SPLCODE+'&PROJECT='+PROJECT,
				        "type": "POST",
						"lengthMenu": [[10, 25, 50, 100, 200], [10, 25, 50, 100, 200]],
						"columnDefs": [	{ targets: [0,1,2,6], className: 'dt-body-center' },
		            ...
		            <div class="search-table-outter">
		                <table id="example" class="table table-bordered table-striped table-responsive search-table inner" width="100%">
		                    ...
		                    <tr style="text-align:center">
		                        <th width="11%" style="text-align:center" nowrap><?php echo $Code; ?>  </th>
		                        <th width="3%" style="text-align:center"><?php echo $Date; ?> </th>
		                        <th width="3%" style="text-align:center" nowrap><?php echo $DueDate; ?> </th>
		                        <th width="21%" style="text-align:center"><?php echo $Supplier; ?> </th>
		                        <th width="35%" style="text-align:center"><?php echo $Notes; ?> </th>
		                        <th width="7%" style="text-align:center"><?php echo $Amount; ?></th>
		                        <th width="7%" style="text-align:center" nowrap><?php echo $Status; ?> </th>
...
<script>
    ...
    $('#example').DataTable( {
		...
		"autoWidth": true,
		"filter": true,
        // "ajax": "<?php // echo site_url('c_purchase/c_pi180c23/get_AllDataTTK/?id='.$PRJCODE)?>",
        "ajax": {
            "url": "<?php echo site_url('c_purchase/c_pi180c23/get_AllDataTTK/?id='.$PRJCODE)?>",
            "type": "GET",
            "data": function(data) {
                data.PRJCODEA   = $('#PRJCODEA').val();
        ...
        $('#PRJCODEA').on('change', function(e) {
            $('#example').DataTable().ajax.reload();
        });
        
        $('#SPLCODEA').on('change', function(e) {
            $('#example').DataTable().ajax.reload();
        });
        
        $('#DOC_NUM').on('change', function(e) {
            $('#example').DataTable().ajax.reload();
        });
	} );
