  ...
  <div class="row">
            <div class="col-xs-12">
                <table border="0" width="100%">
                    ...
                    <tr>
                      <td style="text-align:center; font-size:14px; vertical-align:top">No. Ref. : <?php echo $TTK_CODE; ?></td>
                      <td>&nbsp;</td>
                    </tr>
                </table>
            </div>
        ...
        <form name="frmsync" id="frmsync" action="" method=POST onSubmit="return checkInpt()">
                ...
                <tr>
                  ...
                  <table width="100%" border="0" style="font-size:14px">
                    <tr>
                      ...
                      <td width="50%">Diterima, Rencana Tanggal Bayar : <font style="font-weight:bold; font-size:16px"><?php echo date('d/m/Y', strtotime($TTK_ESTDATE)); ?></font>
            ...
            <table width="100%" border="1">
         	...
         	<table width="100%" border="0">
				<?php
					//$TTK_GTOTAL	= $TTK_GTOTAL - $TTK_AMOUNT_RET - $TTK_AMOUNT_POT + $TTK_AMOUNT_PPN;
