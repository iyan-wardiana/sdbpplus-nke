		...
		<div class="flex-container">
			...
			<div class="detail-content">
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
					...
					<tbody>
						<?php
							$s_01 	= "SELECT TTK_NUM, TTK_CODE, PRJCODE, TTK_REF1_NUM, TTK_REF1_CODE, SUM(TTK_REF1_AM) AS TOT_TTKAM, 
										SUM(TTK_REF1_PPN) AS TOT_TTKPPN, SUM(TTK_REF1_PPH) AS TOT_TTKPPH, SUM(TTK_REF1_DPB) AS TOT_TTKDP, 
										SUM(TTK_REF1_RET) AS TOT_TTKRET, SUM(TTK_REF1_POT) AS TOT_TTKPOT, 
										TTK_REF2_NUM, TTK_REF2_CODE, TTK_DESC
										FROM tbl_ttk_detail
										WHERE TTK_NUM = '$TTK_NUM'
										GROUP BY TTK_REF2_NUM";
							...
							if($r_01->num_rows() > 0)
							{
								...
								foreach($r_01->result() as $rw_01):
									...
									?>
										<tr>
											<td width="50" style="text-align: center;"><?php echo $PRJCODE; ?></td>
											...
											<td width="150" style="text-align: right;"><?php echo number_format($TTK_AMOUNT, 2); ?></td>
										</tr>
									<?php
								endforeach;
								...
								?>
									<tr id="tfoot">
										<td colspan="5">Terbilang : <?php echo ucwords(terbilang(round($TTK_GAMOUNT,2))); ?></td>
									</tr>
								<?php
							}
						?>
