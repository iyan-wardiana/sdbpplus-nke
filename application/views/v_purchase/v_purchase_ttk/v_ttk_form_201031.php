							...
							<div class="box-body">
		                      	<div class="form-group">
		                            ...
		                            <div class="col-sm-4">
		                                ...
		                                <?php if($TTK_STAT == 1 || $TTK_STAT == 4) { ?>
		                               		<input type="text" class="form-control" style="text-align:right" name="TTK_AMOUNT_PPNX" id="TTK_AMOUNT_PPNX" value="<?php echo number_format($TTK_AMOUNT_PPN, 2); ?>" onBlur="getAmountPPn(this)" onKeyPress="return isIntOnlyNew(event);" >
		                                <?php } else { ?>
		                                	<input type="text" class="form-control" style="text-align:right" name="TTK_AMOUNT_PPNX" id="TTK_AMOUNT_PPNX" value="<?php echo number_format($TTK_AMOUNT_PPN, 2); ?>" onBlur="getAmountPPn(this)" onKeyPress="return isIntOnlyNew(event);" readonly >
		                                <?php } ?>
		                            </div>
		                        </div>
		                        <div class="form-group" style="display:none">
		                            ...
		                            <div class="col-sm-9">
		                                <input type="hidden" class="form-control" style="max-width:130px; text-align:right" name="TTK_AMOUNT_RET" id="TTK_AMOUNT_RET" value="<?php echo $TTK_AMOUNT_RET; ?>" >
		                                <input type="text" class="form-control" style="text-align:right" name="TTK_AMOUNT_RETX" id="TTK_AMOUNT_RETX" value="<?php echo number_format($TTK_AMOUNT_RET, 2); ?>" onKeyPress="return isIntOnlyNew(event);" disabled >
		                            </div>
		                        </div>
		                        <div class="form-group">
		                            <label for="inputName" class="col-sm-3 control-label">Pot. / G. Total</label>
		                            <div class="col-sm-5">
		                                <input type="hidden" class="form-control" style="max-width:120px; text-align:right" name="TTK_AMOUNT_POT" id="TTK_AMOUNT_POT" value="<?php echo $TTK_AMOUNT_POT; ?>" >
		                                <?php if($TTK_STAT == 1 || $TTK_STAT == 4) { ?>
		                               		<input type="text" class="form-control" style="text-align:right" name="TTK_AMOUNT_POTX" id="TTK_AMOUNT_POTX" value="<?php echo number_format($TTK_AMOUNT_POT, 2); ?>" onBlur="getAmountPot(this)"  onKeyPress="return isIntOnlyNew(event);" >
		                                <?php } else { ?>
		                                	<input type="text" class="form-control" style="text-align:right" name="TTK_AMOUNT_POTX" id="TTK_AMOUNT_POTX" value="<?php echo number_format($TTK_AMOUNT_POT, 2); ?>" onBlur="getAmountPot(this)"  onKeyPress="return isIntOnlyNew(event);" readonly >
		                                <?php } ?>
		                            </div>
		                            <div class="col-sm-4">
								...
								<?php
		                            $sqlC0c		= "tbl_chartaccount WHERE Account_Category IN (2,5,7,8) AND PRJCODE = '$PRJCODE'";
		                            $resC0c 	= $this->db->count_all($sqlC0c);
		                            
		                            $sqlC0d		= "SELECT DISTINCT Acc_ID, Account_Number, Account_Level, Account_NameEn, Account_NameId, Acc_ParentList,
		                                                Acc_DirParent, isLast
		                                            FROM tbl_chartaccount WHERE Account_Category IN (2,5,7,8)
		                        ...
		                        <div class="form-group" style="display: none;">
		                            ...
		                            <div class="col-sm-9">
		                            	<div class="row">
		                                    <div class="col-xs-3">
		                                    	<input type="hidden" class="form-control" style="text-align:right" name="TTK_AMOUNT_OTH" id="TTK_AMOUNT_OTH" value="<?php echo $TTK_AMOUNT_OTH; ?>" >
		                                		<input type="text" class="form-control" style="text-align:right" name="TTK_AMOUNT_OTHX" id="TTK_AMOUNT_OTHX" value="<?php echo number_format($TTK_AMOUNT_OTH, 2); ?>" onBlur="getAmountOthEXP()" onKeyPress="return isIntOnlyNew(event);" >
		                                    </div>
		                                    <div class="col-xs-9">
		                                        <select name="TTK_ACC_OTH" id="TTK_ACC_OTH" class="form-control select2">
		                                            <option value="">--- None ---</option>
		                                            <?php
		                                            /*if($resC0c>0)
		                                            {
		                                                foreach($resC0d as $rowC0d) :
		                                                    ...
		                                                    ?>
		                                                        <option value="<?php echo $Account_Number0; ?>" <?php if($Account_Number0 == $TTK_ACC_OTH) { ?> selected <?php } if($isLast_0 == 0) { ?> disabled <?php } ?>><?php echo "$level_coa1$Account_Name0 - $collData0"; ?></option>
		                                                    <?php
		                                                endforeach;
		                                            }*/
		                                            ?>
		                        ...
		                        <div class="form-group">
		                       	  <label for="inputName" class="col-sm-3 control-label"><?php echo $Notes; ?></label>
		                          	<div class="col-sm-9">
		                                <?php if($TTK_STAT == 1 || $TTK_STAT == 4) { ?>
		                               		<textarea class="form-control" name="TTK_NOTES"  id="TTK_NOTES" style="height:83px"><?php echo $TTK_NOTES; ?></textarea>
		                                <?php } else { ?>
		                                	<textarea class="form-control" name="TTK_NOTES"  id="TTK_NOTES" style="height:83px" readonly><?php echo $TTK_NOTES; ?></textarea>
		                                <?php } ?>
		                          	</div>
		                        </div>
												...
												elseif($ISCREATE == 1)
												{
													...
													if($task == "add")
													{
														?>
															<select name="TTK_STAT" id="TTK_STAT" class="form-control select2" onChange="selStat(this.value)" <?php if($isDisabled == 1) { ?> disabled <?php } ?>>
																<option value="1">New</option>
																<option value="3" disabled>Complete</option>
															</select>
														<?php
													}
													else
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													...
													<button class="btn btn-success" type="button" onClick="selectitem();">
														<i class="glyphicon glyphicon-th-list"></i>&nbsp;&nbsp;<?php echo $SelDoc; ?>
													</button>
												</div>
											</div>
										<?php
	                        ...
	                        <div class="search-table-outter">
	                            <table id="tbl" class="table table-bordered table-striped" width="100%">
                                    <tr style="background:#CCCCCC">
                                        ...
                                        <th width="12%" style="text-align:center" nowrap><?php echo $ReceiptNumber; ?></th>
                                        ...
                                        <th width="2%" style="text-align:center" nowrap>Pengemb. DP</th>
                                        <th width="2%" style="text-align:center" nowrap>Retensi</th>
                                    ...
                                    {					
                                        ...
                                        $sqlIR		= "SELECT A.TTK_NUM, A.TTK_REF1, A.TTK_REF1_DATE, A.TTK_REF1_DATED, 
															A.TTK_REF1_AM, A.TTK_REF1_DPB, A.TTK_REF1_RET, A.TTK_REF1_POT,
															A.TTK_REF1_PPN, A.TTK_REF2, A.TTK_REF2_DATE, A.TTK_DESC
                                        ...
                                        if($resIRc > 0)
                                        {
                                            foreach($resIRc as $row) :
												...
												$TTK_TOTAL_AM	= $TTK_REF1_AM + $TTK_REF1_RET + $TTK_REF1_PPN + $TTK_REF1_POT;
												...
												elseif($TTK_CATEG == 'OPN')
												{
													...
													$sqlREF1	= "SELECT OPNH_CODE AS TTK_REF_CODE1 FROM tbl_opn_header 
																	WHERE OPNH_NUM = '$TTK_REF1' LIMIT 1";
													$resREF1	= $this->db->query($sqlREF1)->result();
													foreach($resREF1 as $rowREF1) :
														$TTK_REF_CODE1	= $rowREF1->TTK_REF_CODE1;
													endforeach;
												...
												else
												{
													...
													$sqlREF1	= "SELECT FPA_CODE AS TTK_REF_CODE1 FROM tbl_fpa_header 
																	WHERE FPA_NUM = '$TTK_REF1' LIMIT 1";
													$resREF1	= $this->db->query($sqlREF1)->result();
													foreach($resREF1 as $rowREF1) :
														$TTK_REF_CODE1	= $rowREF1->TTK_REF_CODE1;
													endforeach;
													
													$TTK_REF_CODE2	= $TTK_REF2;
												}
												// POTONGAN RETENSI SUDAH DILAKUKAN DI HALAMAN SELECT
												//$TTK_REF1_TOT = $TTK_REF1_AM - $TTK_REF1_RET - $TTK_REF1_POT + $TTK_REF1_PPN;
												$TTK_REF1_TOT = $TTK_REF1_AM + $TTK_REF1_PPN - $TTK_REF1_POT;
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td width="4%" style="text-align:right">
                                                            ...
                                                            <input type="hidden" id="TTK_REF1_AM<?php echo $currentRow; ?>" name="TTK_REF1_AM<?php echo $currentRow; ?>" value="<?php echo number_format($TTK_REF1_AM, 2); ?>" class="form-control" style="min-width:120px; max-width:300px; text-align:right;" readonly>
                                                        </td>
                                                        <td width="2%" style="text-align:right">
                                                            ...
                                                            <input type="hidden" id="TTK_REF1_DPB<?php echo $currentRow; ?>" name="TTK_REF1_DPB<?php echo $currentRow; ?>" value="<?php echo number_format($TTK_REF1_DPB, 2); ?>" class="form-control" style="min-width:120px; max-width:300px; text-align:right;" readonly>
                                                        </td>
                                                        <td width="2%" style="text-align:right">
                                                            ...
                                                            <input type="hidden" id="TTK_REF1_RET<?php echo $currentRow; ?>" name="TTK_REF1_RET<?php echo $currentRow; ?>" value="<?php echo number_format($TTK_REF1_RET, 2); ?>" class="form-control" style="min-width:120px; max-width:300px; text-align:right;" readonly>
                                                        </td>
                                                        <td width="3%" style="text-align:right">
                                                        	<?php
                                                        		if($TTK_STAT == 1 || $TTK_STAT == 4)
                                                        		 {
                                                        			echo number_format($TTK_REF1_POT, 2); ?>
                                                            		<input type="hidden" id="TTK_REF1_POT<?php echo $currentRow; ?>" name="TTK_REF1_POT<?php echo $currentRow; ?>" value="<?php echo number_format($TTK_REF1_POT, 2); ?>" class="form-control"style="min-width:100px; text-align:right;" onKeyPress="return isIntOnlyNew(event);" onBlur="getPOT(this, <?php echo $currentRow; ?>)">
                                                        		<?php } else {
                                                        			echo number_format($TTK_REF1_POT, 2); ?>
                                                            		<input type="hidden" id="TTK_REF1_POT<?php echo $currentRow; ?>" name="TTK_REF1_POT<?php echo $currentRow; ?>" value="<?php echo number_format($TTK_REF1_POT, 2); ?>" class="form-control"style="min-width:100px; text-align:right;" onKeyPress="return isIntOnlyNew(event);" onBlur="getPOT(this, <?php echo $currentRow; ?>)"> <?php
                                                        		}
                                                        	?>
                                                        ...
                                                        <td width="7%" style="text-align:right">
                                                        	<?php
                                                        		if($TTK_STAT == 1 || $TTK_STAT == 4)
                                                        		{ 
                                                        			echo number_format($TTK_REF1_PPN, 2); ?>
                                                            		<input type="hidden" id="TTK_REF1_PPN<?php echo $currentRow; ?>" name="TTK_REF1_PPN<?php echo $currentRow; ?>" value="<?php echo number_format($TTK_REF1_PPN, 2); ?>" class="form-control" style="min-width:120px; max-width:300px; text-align:right;" readonly>
                                                        		<?php } else {
                                                        			echo number_format($TTK_REF1_PPN, 2); ?>
                                                            		<input type="hidden" id="TTK_REF1_PPN<?php echo $currentRow; ?>" name="TTK_REF1_PPN<?php echo $currentRow; ?>" value="<?php echo number_format($TTK_REF1_PPN, 2); ?>" class="form-control" style="min-width:120px; max-width:300px; text-align:right;" readonly> <?php
                                                        		}
                                                        	?>
                                                        ...
                                                        <td width="11%" style="text-align:right">
                                                        	<?php
                                                        		if($TTK_STAT == 1 || $TTK_STAT == 4)
                                                        		{
                                                        			echo number_format($TTK_REF1_TOT, 2); ?>
                                                            		<input type="hidden" id="TTK_REF1_TOT<?php echo $currentRow; ?>" name="TTK_REF1_TOT<?php echo $currentRow; ?>" value="<?php echo number_format($TTK_REF1_TOT, 2); ?>" class="form-control" style="min-width:120px; max-width:300px; text-align:right;" readonly>
                                                        		<?php } else {
                                                        			echo number_format($TTK_REF1_TOT, 2); ?>
                                                            		<input type="hidden" id="TTK_REF1_TOT<?php echo $currentRow; ?>" name="TTK_REF1_TOT<?php echo $currentRow; ?>" value="<?php echo number_format($TTK_REF1_TOT, 2); ?>" class="form-control" style="min-width:120px; max-width:300px; text-align:right;" readonly> <?php
                                                        		}
                                                        	?>
                                                        </td>
                                                    </tr>
...
<script>
  $(function () {
	...
	function getPOT(thisVal, theRow)
	{
		var decFormat	= document.getElementById('decFormat').value;
		var TTK_POT1 	= eval(thisVal).value.split(",").join("");
		
		document.getElementById('data'+theRow+'TTK_REF1_POT').value 	= parseFloat(Math.abs(TTK_POT1));
		document.getElementById('TTK_REF1_POT'+theRow).value 	= doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(TTK_POT1)),decFormat));
		...
		for(i=1; i<=totalrow; i++)
		{
			...
			TTK_AMOUNT_POTV	= parseFloat(TTK_AMOUNT_RET) + parseFloat(TTK_AMOUNT_POT);
			...
			document.getElementById('TTK_AMOUNT_POTX').value 	= doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(TTK_AMOUNT_POTV)),2));
			...
			if(TTK_CATEG == 'OPN')
			{
				...
				//TTK_REF1_TOT	= parseFloat(TTK_REF1_AM) + parseFloat(TTK_REF1_PPN) - parseFloat(TTK_REF1_RET) - parseFloat(TTK_REF1_POT);
				// POTONGAN RETENSI SUDAH DILAKUKAN DI HALAMAN SELECT
			...
			document.getElementById('TTK_REF1_TOT'+i).value		 = doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(TTK_REF1_TOT)),2));
		}
		...
		if(TTK_CATEG == 'OPN')
		{
			...
			TTK_GTOTALV		= parseFloat(TTK_AMOUNT) + parseFloat(TTK_AMOUNT_PPN) + parseFloat(TTK_AMOUNT_OTH) - parseFloat(TTK_AMOUNT_RET) - parseFloat(TTK_AMOUNT_POT);
		}
		else
		{
			TTK_GTOTAL		= parseFloat(TTK_AMOUNT) + parseFloat(TTK_AMOUNT_PPN) + parseFloat(TTK_AMOUNT_OTH) - parseFloat(TTK_AMOUNT_POT);
	...
	{
		// PERHATIAN : RETENSI DAN PENGEMBALIAN DP HANYA INFORMASI, TIDAK MENGURANFI NILAI AKHIR
		...
		for(i=1; i<=totalrow; i++)
		{
			...
			TTK_REF1_POT	= document.getElementById('data'+i+'TTK_REF1_POT').value;
			TTK_AMOUNT_POT	= parseFloat(TTK_AMOUNT_POT) + parseFloat(TTK_REF1_POT);
			TTK_AMOUNT_POT1	= parseFloat(TTK_AMOUNT_POT1) + parseFloat(TTK_REF1_POT);
		...
		// POTONGAN RETENSI SUDAH DILAKUKAN DI HALAMAN SELECT
			//TTK_GTOTAL	= parseFloat(TTK_AMOUNT) - parseFloat(TTK_AMOUNT_RET) + parseFloat(TTK_AMOUNT_PPN) - parseFloat(TTK_AMOUNT_POT);
			if(TTK_AMOUNT_PPN == 0)
			...
			TTK_GTOTAL		= parseFloat(TTK_AMOUNT) + parseFloat(TTK_AMOUNT_PPN) - parseFloat(TTK_AMOUNT_POT);
	...
	function deleteRow(btn)
	{
		...
		document.getElementById('totalrow').value = intTable;
