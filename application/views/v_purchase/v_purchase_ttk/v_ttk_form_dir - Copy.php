 ...
 * Create Date	= 02 Juni 2018
 * File Name	= v_ttk_form_dir.php
 * Location		= -
*/
                ...
                <div class="box-body chart-responsive">
                    ...
                    <form class="form-horizontal" name="frm" id="frm" method="post" action="<?php echo $form_action; ?>" onSubmit="return checkInp()">
                        ...
                        <div class="form-group">
                          	...
                          	<div class="col-sm-10">
                            	<select name="SPLCODE" id="SPLCODE" class="form-control" style="max-width:250px">
                        ...
                        <div class="form-group">
                          	<label for="inputName" class="col-sm-2 control-label"><?php echo $TotAmount; ?></label>
                          	<div class="col-sm-10">
                                ...
                                <input type="text" class="form-control" style="max-width:160px; text-align:right" name="TTK_AMOUNTX" id="TTK_AMOUNTX" value="<?php echo number_format($TTK_AMOUNT, 2); ?>" onBlur="getAmount(this)" onKeyPress="return isIntOnlyNew(event);" >
                          	</div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                <input type="text" class="form-control" style="max-width:160px; text-align:right" name="TTK_GTOTALX" id="TTK_GTOTALX" value="<?php echo number_format($TTK_GTOTAL, 2); ?>" onKeyPress="return isIntOnlyNew(event);" readonly >
                            </div>
                        </div>
                        <script>
							function getAmount(thisVal)
							{
								...
								var TTK_AMOUNT		= parseFloat(eval(thisVal).value.split(",").join(""));
								document.getElementById('TTK_AMOUNTX').value 	= doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(TTK_AMOUNT)),decFormat));
								document.getElementById('TTK_AMOUNT').value 	= parseFloat(Math.abs(TTK_AMOUNT));
								
								var TTK_AMOUNT_PPN	= parseFloat(TTK_AMOUNT * 0.1);
								document.getElementById('TTK_AMOUNT_PPNX').value 	= doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(TTK_AMOUNT_PPN)),decFormat));
								document.getElementById('TTK_AMOUNT_PPN').value 	= parseFloat(Math.abs(TTK_AMOUNT_PPN));
																
								TTK_GTOTAL			= parseFloat(TTK_AMOUNT) + parseFloat(TTK_AMOUNT_PPN);
								document.getElementById('TTK_GTOTALX').value 	= doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(TTK_GTOTAL)),decFormat));
								document.getElementById('TTK_GTOTAL').value 	= parseFloat(Math.abs(TTK_GTOTAL));
							}
							
							function getAmountPPn(thisVal)
							{
								var decFormat		= document.getElementById('decFormat').value;
								var TTK_AMOUNT_PPN	= parseFloat(eval(thisVal).value.split(",").join(""));
								document.getElementById('TTK_AMOUNT_PPNX').value 	= doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(TTK_AMOUNT_PPN)),decFormat));
								document.getElementById('TTK_AMOUNT_PPN').value 	= parseFloat(Math.abs(TTK_AMOUNT_PPN));
                                    ...
                                    <?php
										// START : FOR ALL APPROVAL FUNCTION
											...
											if($ISAPPROVE == 1)
											{
												...
												{
													?>
														<select name="TTK_STAT" id="TTK_STAT" class="form-control" style="max-width:120px" onChange="selStat(this.value)" <?php if($isDisabled == 1) { ?> disabled <?php } ?>>
												...
												else
												{
													?>
														<select name="TTK_STAT" id="TTK_STAT" class="form-control" style="max-width:120px" onChange="selStat(this.value)" <?php if($isDisabled == 1) { ?> disabled <?php } ?>>
															...
															<option value="6"<?php if($TTK_STAT == 6) { ?> selected <?php } ?> style="display:none" >Closed</option>
												...
												else
												{
													?>
														<select name="TTK_STAT" id="TTK_STAT" class="form-control" style="max-width:120px" onChange="selStat(this.value)" <?php if($isDisabled == 1) { ?> disabled <?php } ?>>
															...
															<option value="6"<?php if($TTK_STAT == 6) { ?> selected <?php } ?> style="display:none" disabled>Closed</option>
...
<script>
	...
	function add_IR(strItem) 
	{
		...
		objTD.noWrap = true;
		objTD.innerHTML = ''+doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(TTK_REF1_AM)),2))+'<input type="hidden" id="data'+intIndex+'TTK_REF1_AM" name="data['+intIndex+'][TTK_REF1_AM]" value="'+TTK_REF1_AM+'" class="form-control" style="max-width:300px;">';
		
		// GTTax
		objTD = objTR.insertCell(objTR.cells.length);
		objTD.style.textAlign = 'right';
		objTD.noWrap = true;
		objTD.innerHTML = ''+doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(TTK_REF1_PPN)),2))+'<input type="hidden" id="data'+intIndex+'TTK_REF1_PPN" name="data['+intIndex+'][TTK_REF1_PPN]" value="'+TTK_REF1_PPN+'" class="form-control" style="max-width:300px;">';
		
		// GTotal
		objTD = objTR.insertCell(objTR.cells.length);
		objTD.style.textAlign = 'right';
		objTD.noWrap = true;
		objTD.innerHTML = ''+doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(TTK_REF1_TOT)),2))+'<input type="hidden" id="TTK_REF1_TOT'+intIndex+'" name="TTK_REF1_TOT'+intIndex+'" value="'+TTK_REF1_TOT+'" class="form-control" style="max-width:300px;">';
