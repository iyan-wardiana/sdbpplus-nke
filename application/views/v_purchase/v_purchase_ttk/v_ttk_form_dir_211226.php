...
<html>
	...
	<style type="text/css">
	    ...
	    .form-group div#GuaranteeExpDate label {
	    	/*position: fixed;*/
	    	text-align: left;
	    	margin-left: 0px;
	    	padding-left: 0px;
						...
						<div class="box box-primary">
							...
							<div class="box-body">
								...
								<div class="form-group">
		                          	...
		                          	<div class="col-sm-5" id="GuaranteeExpDate" <?php echo $divGuarantee; ?>>
		                        ...
		                        <div class="form-group" <?php echo $divGuarantee; ?>>
		                        	...
		                        	<div class="col-sm-5" id="GexpDate">
		                                <div class="input-group date">
		                                    <div class="input-group-addon"><i class="fa fa-calendar"></i>&nbsp;</div>
		                                    <input type="text" name="TTK_DUEDATE" class="form-control pull-left" id="datepicker2" value="<?php echo $TTK_DUEDATE; ?>">
		                                </div>
								...
								<div class="search-table-outter">
		                            <table id="tbl" class="table table-bordered table-striped" width="100%">
		                            	<tr style="background:#CCCCCC">
		                            		<th width="50">&nbsp;</th>
		                            		<th width="150" style="text-align: center;">No. Uang Muka</th>
		                            		<th width="150" style="text-align: center;"><?php echo $Date; ?></th>
		                            		<th width="200" style="text-align: center;">No. Referensi</th>
		                            		<th width="300" style="text-align: center;">Deskripsi</th>
		                            		<th width="100" style="text-align: center;">DP %</th>
		                            		<th width="200" style="text-align: center;">Jumlah DP</th>
		                            	</tr>
		                            </table>
		                        </div>
							</div>
