...
if($LangID == 'IND')
{
	...
	$alert1		= "Silahkan tentukan status dokumen ini, diterima atau ditolak.";
	$alert2		= "Silahkan tentukan jenis dokumen.";
}
else
{
	...
	$alert1		= "Please specify document status, accepted or rejected.";
	$alert2		= "Please specify the type of document.";
}
...
{
	$PO_CODE1	= '';
	$sqlIR		= "SELECT TTK_REF1 FROM tbl_ttk_detail WHERE TTK_NUM = '$TTK_NUM'";
	$resIR		= $this->db->query($sqlIR)->result();
	foreach($resIR as $rowIR) :
		$TTK_REF1	= $rowIR->TTK_REF1;
		$sqlPO		= "SELECT PO_CODE FROM tbl_ir_header WHERE IR_NUM = '$TTK_REF1'";
...
{
	$WO_CODE1	= '';
	$sqlOPN		= "SELECT TTK_REF1 FROM tbl_ttk_detail WHERE TTK_NUM = '$TTK_NUM'";
	$resOPN		= $this->db->query($sqlOPN)->result();
	foreach($resOPN as $rowOPN) :
		$TTK_REF1	= $rowOPN->TTK_REF1;
		$sqlWO		= "SELECT WO_NUM FROM tbl_opn_header WHERE OPNH_NUM = '$TTK_REF1'";
  ...
  <div class="row">
            <div class="col-xs-12">
                <table border="0" width="100%">
                    <tr>
                      <td width="14%" rowspan="2"><img src="<?php echo base_url('assets/AdminLTE-2.0.5/dist/img/compLog/compLog.png') ?>" width="150" height="44"></td>
        ...
        <form name="frmsync" id="frmsync" action="" method=POST onSubmit="return checkInpt()">
        	<table border="0" width="100%">
                ...
                <tr>
                    ...
                    <td width="30%" nowrap>: <?php echo $SPLDESC; ?></td>
                </tr>
                <tr>
                  ...
                  <td nowrap>: <?php echo $TTK_CHECKER; ?></td>
                </tr>
                <tr>
                    <td nowrap>Paket</td>
                  <td>:</td>
                  ...
                  <td nowrap>: <?php echo $TTK_DATE; ?></td>
                </tr>
                <tr>
                    <td nowrap>Jatuh Tempo Bayar</td>
                  <td>:</td>
                  <td nowrap><?php echo $TTK_DUEDATE; ?></td>
                  <td nowrap>&nbsp;</td>
                  <td nowrap>&nbsp;</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <table width="100%" border="0">
                    <tr>
                      <td width="3%"><input type="radio" name="TTKP_DENIED" id="TTKP_DENIED1" value="1" <?php if($TTKP_DENIED == 1) { ?> checked <?php }?>></td>
                      <td width="50%">Diterima, Rencana Tanggal Bayar : <?php echo $TTK_ESTDATE; ?>
                        <input type="hidden" name="TTKP_RECDATE" style="max-width:250px" value="<?php echo $TTK_ESTDATE; ?>">
                      </td>
                      <td><input type="radio" name="TTKP_DOCTYPE" id="TTKP_DOCTYPE1" value="1" <?php if($TTKP_DOCTYPE == 1) { ?> checked <?php }?>></td>
                      <td>Uang Muka / Down Payment ( 1 )</td>
                    </tr>
                    <tr>
                      <td><input type="radio" name="TTKP_DENIED" id="TTKP_DENIED2" value="2" <?php if($TTKP_DENIED == 2) { ?> checked <?php }?>></td>
                      <td>Ditolak</td>
                      <td width="3%"><input type="radio" name="TTKP_DOCTYPE" id="TTKP_DOCTYPE2" value="2" <?php if($TTKP_DOCTYPE == 2) { ?> checked <?php }?>></td>
                      <td width="44%">Kemajuan Pekerjaan / Progress ( 2 )</td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
                      <td>&nbsp;</td>
                      <td><input type="radio" name="TTKP_DOCTYPE" id="TTKP_DOCTYPE3" value="3" <?php if($TTKP_DOCTYPE == 3) { ?> checked <?php }?>></td>
                      <td>Pekerjaan / Pengadaan Selesai 100 % ( 3 )</td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
                      <td>&nbsp;</td>
                      <td><input type="radio" name="TTKP_DOCTYPE" id="TTKP_DOCTYPE4" value="4" <?php if($TTKP_DOCTYPE == 4) { ?> checked <?php }?>></td>
            ...
            <table border="1" width="100%">
                ...
                <tr>
                    ...
                    <td><input type="text" name="TTKP_KWITPEN" style="max-width:250px" value="<?php echo $TTKP_KWITPEN; ?>"></td>
                ...
                <tr>
                    ...
                    <td>Faktur Pajak</td>
                    <td><input type="text" name="TTKP_FAKPAJAK" style="max-width:250px" value="<?php echo $TTKP_FAKPAJAK; ?>"></td>
                    <td style="text-align:center">1,2,3,4</td>
                </tr>
                <tr style="border-color:#000">
                  ...
                  <td><input type="text" name="TTKP_COPYPO" style="max-width:250px" value="<?php echo $TTKP_COPYPO; ?>"></td>
                  <td style="text-align:center">1,2,3,4</td>
                </tr>
                <tr style="border-color:#000">
                  ...
                  <td><input type="text" name="TTKP_BAKEM" style="max-width:250px" value="<?php echo $TTKP_BAKEM; ?>"></td>
                ...
                <tr style="border-color:#000">
                  ...
                  <td><input type="text" name="TTKP_LKEM" style="max-width:250px" value="<?php echo $TTKP_LKEM; ?>"></td>
                  <td style="text-align:center">2,3,4</td>
                </tr>
                <tr style="border-color:#000">
                  ...
                  <td><input type="text" name="TTKP_BAPRES" style="max-width:250px" value="<?php echo $TTKP_BAPRES; ?>"></td>
                  <td style="text-align:center">2,3,4</td>
                </tr>
                <tr style="border-color:#000">
                  ...
                  <td><input type="text" name="TTKP_SJ" style="max-width:250px" value="<?php echo $TTKP_SJ; ?>"></td>
                ...
                <tr style="border-color:#000">
                  ...
                  <td><input type="text" name="TTKP_KMA" style="max-width:250px" value="<?php echo $TTKP_KMA; ?>"></td>
                  <td style="text-align:center">1</td>
                </tr>
                <tr style="border-color:#000">
                  ...
                  <td><input type="text" name="TTKP_KPPSA" style="max-width:250px" value="<?php echo $TTKP_KPPSA; ?>"></td>
                  <td style="text-align:center">1</td>
                </tr>
                <tr style="border-color:#000">
                  ...
                  <td><input type="text" name="TTKP_SI" style="max-width:250px" value="<?php echo $TTKP_SI; ?>"></td>
                  <td style="text-align:center">2,3</td>
                </tr>
                <tr style="border-color:#000">
                  ...
                  <td><input type="text" name="TTKP_PKER" style="max-width:250px" value="<?php echo $TTKP_PKER; ?>"></td>
                  <td style="text-align:center">2,3</td>
                </tr>
                <tr style="border-color:#000">
                  ...
                  <td><input type="text" name="TTKP_LPK" style="max-width:250px" value="<?php echo $TTKP_LPK; ?>"></td>
                  <td style="text-align:center">2,3</td>
                </tr>
                <tr style="border-color:#000">
                  ...
                  <td><input type="text" name="TTKP_KDAB" style="max-width:250px" value="<?php echo $TTKP_KDAB; ?>"></td>
                  <td style="text-align:center">3</td>
                </tr>
                <tr style="border-color:#000">
                  ...
                  <td><input type="text" name="TTKP_FPMSM" style="max-width:250px" value="<?php echo $TTKP_FPMSM; ?>"></td>
                  <td style="text-align:center">2,3,4</td>
                </tr>
                <tr style="border-color:#000">
                  ...
                  <td><input type="text" name="TTKP_BOL" style="max-width:250px" value="<?php echo $TTKP_BOL; ?>"></td>
                ...
                <tr style="border-color:#000">
                  ...
                  <td><input type="text" name="TTKP_LPP" style="max-width:250px" value="<?php echo $TTKP_LPP; ?>"></td>
                  <td style="text-align:center">3</td>
                </tr>
                <tr style="border-color:#000">
                  ...
                  <td><input type="text" name="TTKP_LPA" style="max-width:250px" value="<?php echo $TTKP_LPA; ?>"></td>
                  <td style="text-align:center">2,3</td>
                </tr>
                <tr style="border-color:#000">
                  ...
                  <td><input type="text" name="TTKP_KPM" style="max-width:250px" value="<?php echo $TTKP_KPM; ?>"></td>
                  <td style="text-align:center">2,3</td>
                </tr>
                <tr style="border-color:#000">
                  ...
                  <td><input type="text" name="TTKP_JAMSER" style="max-width:250px" value="<?php echo $TTKP_JAMSER; ?>"></td>
                  <td style="text-align:center">3</td>
                </tr>
              <tr style="border-color:#000">
                  ...
                  <td><input type="hidden" name="TTKP_TDPO" style="max-width:250px" value="<?php echo $TTKP_TDPO; ?>"></td>
                  <td style="text-align:center">&nbsp;</td>
              </tr>
              <tr style="border-color:#000">
                <td style="text-align:center">&nbsp;</td>
                ...
                <td><input type="text" name="TTKP_JUM" style="max-width:250px" value="<?php echo $TTKP_JUM; ?>"></td>
                <td style="text-align:center">1</td>
              </tr>
              <tr style="border-color:#000">
                <td style="text-align:center">&nbsp;</td>
                ...
                <td><input type="text" name="TTKP_JPEL" style="max-width:250px" value="<?php echo $TTKP_JPEL; ?>"></td>
                <td style="text-align:center">1</td>
              </tr>
              <tr style="border-color:#000">
                <td style="text-align:center">&nbsp;</td>
                ...
                <td><input type="text" name="TTKP_MPEL" style="max-width:250px" value="<?php echo $TTKP_MPEL; ?>"></td>
                <td style="text-align:center">1</td>
              </tr>
              <tr style="border-color:#000">
                <td style="text-align:center">&nbsp;</td>
                ...
                <td><input type="text" name="TTKP_LPD" style="max-width:250px" value="<?php echo $TTKP_LPD; ?>"></td>
                <td style="text-align:center">1</td>
              </tr>
              <tr style="border-color:#000">
                <td style="text-align:center">&nbsp;</td>
                ...
                <td><input type="text" name="TTKP_LHP" style="max-width:250px" value="<?php echo $TTKP_LHP; ?>"></td>
                <td style="text-align:center">1</td>
              </tr>
              <tr style="border-color:#000">
                <td style="text-align:center">&nbsp;</td>
                ...
                <td><input type="text" name="TTKP_JADPEL" style="max-width:250px" value="<?php echo $TTKP_JADPEL; ?>"></td>
                <td style="text-align:center">1</td>
              </tr>
              <tr style="border-color:#000">
                <td style="text-align:center">&nbsp;</td>
                ...
                <td><input type="text" name="TTKP_STRO" style="max-width:250px" value="<?php echo $TTKP_STRO; ?>"></td>
                <td style="text-align:center">1</td>
              </tr>
              <tr style="border-color:#000">
                <td style="text-align:center">&nbsp;</td>
                ...
                <td>* S Curve</td>
                <td><input type="text" name="TTKP_SCURVE" style="max-width:250px" value="<?php echo $TTKP_SCURVE; ?>"></td>
                <td style="text-align:center">1</td>
              </tr>
              <tr style="border-color:#000">
                <td style="text-align:center">&nbsp;</td>
            ...
            <table width="100%" border="1">
         	...
         	<table width="100%" border="0">
                <tr>
                    ...
                    <td colspan="2">Nilai Invoice Rp. <?php echo number_format($TTK_GTOTAL, 2); ?></td>
                </tr>
                    <?php						
                ...
                <tr>
                  ...
                  <td width="67%">: <?php echo $terbilang; ?> Rupiah</td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
          ...
          <table width="100%" border="1">
                ...
                <?php
					if($TTK_NOTES == '')
						$TTK_NOTES = "__________________________________________________________________________________";
				?>
                <tr>
                  <td width="3%">&nbsp;</td>
                  ...
                  &nbsp;&nbsp;&nbsp;<?php echo $comp_name; ?> tidak bertanggung jawab terhadap segala kerugian yang timbul akibat hal tersebut.</td>
                    ...
                    <tr>
                      <td colspan="2">
                        ...
                        <?php if($resTTKP > 0) { ?>
                        <button class="btn btn-warning" type="button" onClick="getPRINT()">
