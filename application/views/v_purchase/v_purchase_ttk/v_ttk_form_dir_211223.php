					...
					<div class="col-md-6">
						<div class="box box-primary">
							...
							<div class="box-body">
			                    ...
			                    <div class="form-group">
			                      	<label for="inputName" class="col-sm-3 control-label"><?php echo $Amount; ?> / PPn</label>
			                      	<div class="col-sm-5">
...
<script>
	...
	function checkForm(value)
	{
		...
		if(STAT_BEFORE == 1 || STAT_BEFORE == 4)
		{
			for(i=1;i<=totrow;i++)
			{
				var TTK_VOLM = parseFloat(document.getElementById('TTK_VOLM'+i).value);
				if(TTK_VOLM == 0)
				{
		            ...
		            {
		                swal.close();
						document.getElementById('TTK_VOLM'+i).value = '0';
		                $('#TTK_VOLM'+i).focus();
		            });
					return false;
				}
