						...
						<div class="box box-primary">
							...
							<div class="box-body">
		                        ...
		                        <div class="form-group">
		                          	...
		                          	<div class="col-sm-4">
		                          		<label for="inputName" class="col-sm-12 control-label"><?php echo $Receiver; ?></label>
		                          	</div>
		                        </div>
		                        <div class="form-group" style="display:none">
										    	...
										    	<div class="col-md-12">
									              	<ul class="nav nav-tabs">
									                    <li id="li1" <?php echo $Active1Cls; ?>>
									                    	<a href="#itm1" data-toggle="tab"><?php echo $h3_title; ?></a>
									                    </li>
									                </ul>
										            <div class="box-body">
...
<script>
	...
	function add_DETIL(strItem) 
	{
		...
		// GTotal
			...
			objTD.style.textAlign = 'right';
			objTD.noWrap = true;
			objTD.innerHTML = '<span id="data'+intIndex+'TTK_REF1_GTOTV">'+doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(GTOTALROW)),2))+'</span><input type="hidden" id="data'+intIndex+'TTK_REF1_GTOT" name="data['+intIndex+'][TTK_REF1_GTOT]" value="'+GTOTALROW+'" class="form-control" style="min-width:100px; text-align:right;">';
	...
	function checkTotalTTK()
	{
		...
		console.log('TTK_AMOUNT_OTH = '+TTK_AMOUNT_OTH)
		TTK_GTOTAL			= parseFloat(TTK_AMOUNT) + parseFloat(TTK_AMOUNT_PPN) - parseFloat(TTK_AMOUNT_PPH) - parseFloat(TTK_AMOUNT_DPB) - parseFloat(TTK_AMOUNT_RET) - parseFloat(TTK_AMOUNT_POT) + parseFloat(TTK_AMOUNT_OTH);
