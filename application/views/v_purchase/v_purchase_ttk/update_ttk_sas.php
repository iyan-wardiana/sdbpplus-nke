        ...
        <form name="frmsync" id="frmsync" action="" method=POST onSubmit="return checkInpt()">
            ...
            <table border="1" width="100%">
                ...
                <tr>
                    ...
                    <td>Faktur Pajak (bila ada PPN dan PPh)</td>
                ...
                <tr style="border-color:#000">
                  ...
                  <td>Copy PO / SPK / Kontrak / SPP / LPM</td>
            ...
            <table width="100%" border="1">
         	...
         	<table width="100%" border="0">
                <tr>
                    <td width="3%"><input type="checkbox" <?php if($TTK_AMOUNT_PPN > 0) { ?> checked <?php } ?>></td>
					...
					?>
                <tr>
                  <td><input type="checkbox" <?php if($TTK_AMOUNT_PPN == 0) { ?> checked <?php } ?>></td>
