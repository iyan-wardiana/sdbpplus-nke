		...
		<div class="flex-container">
			...
			<div class="detail-content">
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
					...
					<tbody>
						<?php
							$s_01 	= "SELECT A.TTK_NUM, A.TTK_CODE, A.PRJCODE, A.TTK_REF1_NUM, A.TTK_REF1_CODE, B.TTK_AMOUNT AS TOT_TTKAM, 
										B.TTK_AMOUNT_PPN AS TOT_TTKPPN, B.TTK_AMOUNT_PPH AS TOT_TTKPPH, B.TTK_AMOUNT_DPB AS TOT_TTKDP, 
										B.TTK_AMOUNT_RET AS TOT_TTKRET, B.TTK_AMOUNT_POT AS TOT_TTKPOT, A.TTK_REF1_GTOT,
							...
							if($r_01->num_rows() > 0)
							{
								...
								foreach($r_01->result() as $rw_01):
									...
									$TTK_AMOUNTV 		= "";
									$PRJCODEV 		= $PRJCODE;
									$TTK_AMOUNTV 	= number_format($TTK_REF1_GTOT, 2);
									// if($no == 1)
									// {
									// 	$PRJCODEV 		= $PRJCODE;
