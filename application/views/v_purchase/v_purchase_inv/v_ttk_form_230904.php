							...
							<div class="box-body">
		                        <div class="search-table-outter">
		                            <table id="tbl_exp" class="table table-bordered table-striped" width="100%">
	                                    <tr style="background:#CCCCCC">
	                                        <th width="5%" height="25" style="text-align:center">&nbsp;</th>
	                                        <th width="10%" style="text-align:center" nowrap>No. LPM/<br>Opname</th>
	                                        <th width="10%" style="text-align:center; display: none;" nowrap><?php echo $Date; ?></th>
	                                        <th width="60%" style="text-align:center; vertical-align: middle;" nowrap><?php echo $Description; ?></th>
	                                        <th width="15%" style="text-align:center; vertical-align: middle;" nowrap><?php echo $AmountReceipt; ?></th>
	                                        <th width="5%" style="text-align:center; display: none;" nowrap><?php echo $deduction; ?></th>
	                                        <th width="5%" style="text-align:center; display: none;" nowrap>PPn</th>
	                                        <th width="5%" style="text-align:center; display: none;" nowrap>PPh</th>
	                                        <th width="5%" style="text-align:center; display: none;" nowrap>P.UM</th>
	                                        <th width="5%" style="text-align:center; display: none;" nowrap>Retensi</th>
	                                        <th width="10%" style="text-align:center; display: none;" nowrap><?php echo $TotAmount; ?></th>
	                                    </tr>
										<?php
										$currentRow 	= 0;
										$TOT_AMOUNT2	= 0;
	                                    if($task == 'edit')
	                                    {
	                                        ...
	                                        if($resIRc > 0)
	                                        {
	                                            foreach($resIRc as $row) :
													...
													$TTK_REF1_TOT	= $TTK_REF1_AM + $TTK_REF1_PPN - $TTK_REF1_PPH - $TTK_REF1_DPB - $TTK_REF1_RET - $TTK_REF1_POT;
	                                                ?>
	                                                    <tr id="trEXP_<?php echo $currentRow; ?>">
	                                                        <td height="25" style="text-align:left">
																<?php
																	if($TTK_STAT == 1)
																	{
				    	...
				    	<!-- ============ START MODAL ITEM =============== -->
					    	...
					    	<?php
								...
								if($TTK_CATEG1 == 'IR' || $TTK_CATEG1 == 'SJ')
								{
									...
									$popURLSJ 	= site_url('c_purchase/c_pi180c23/get_AllDataIRSJ/?id='.$collData);
								}
	...
	function add_TAXNO() 
	{
		...
		// START : SETTING ROWS INDEX
			...
			if(intIndex == 1)
			{
				...
				TTKT_TAXAMOUNT 	= parseFloat(0.1 * TTKT_AMOUNT);
			}
