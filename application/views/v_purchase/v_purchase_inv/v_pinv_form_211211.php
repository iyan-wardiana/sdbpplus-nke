							...
							<div class="box-body">
		                        ...
		                        <div class="form-group">
		                       	  <label for="inputName" class="col-sm-3 control-label"><?php echo $Notes; ?></label>
		                          	<div class="col-sm-9">
		                                <textarea class="form-control" name="INV_NOTES"  id="INV_NOTES" style="height:50px"><?php echo $INV_NOTES; ?></textarea>
		                          	</div>
		                        </div>
					...
					<div class="col-md-6">
						<div class="box box-warning">
							...
							<div class="box-body">
		                        ...
		                        <div class="form-group">
		                            <label for="inputName" class="col-sm-3 control-label">Ret. / Pot. Lain</label>
		                            <div class="col-sm-5">
...
<script>
	...
	function checkTotalTTK()
	{
		...
		if(task == 'edit')
		{
			...
			// JIKA ADA PINJAMAN MATERIAL OLEH SUPPLIER, MAKA KURANGKAN DARI TOTAL INVOICE
			INV_TOT_GTOTAL 	= parseFloat(INV_TOT_AMN) + parseFloat(INV_TOT_PPN) - parseFloat(INV_TOT_PPH) - parseFloat(INV_TOT_DPB) - parseFloat(INV_TOT_RET) - parseFloat(INV_TOT_POT) + parseFloat(INV_TOT_OTH) - parseFloat(INV_TOT_POTUM);
		}

		//console.log('b = '+INV_TOT_PPH)
	...
	function countAmn()
	{
        ...
        GTOTAL_AMN 		= parseFloat(INV_AMOUNT) + parseFloat(INV_AMOUNT_PPN) - parseFloat(INV_AMOUNT_PPH) - parseFloat(INV_AMOUNT_RET) - parseFloat(INV_AMOUNT_POT) + parseFloat(INV_AMOUNT_OTH) - parseFloat(INV_AMOUNT_DPB) - parseFloat(INV_AMOUNT_POTUM);
