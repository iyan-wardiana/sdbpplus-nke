                    ...
                    <script type="text/javascript">
                    	function showPD()
                    	{
					    	...
					    	$('#tbl_pd').DataTable(
					    	{
								...
								"autoWidth": true,
								"filter": true,
						        "ajax": "<?php echo site_url('c_purchase/c_pi180c23/get_AllDataSPL_PD/?id=')?>"+collData,
						        "type": "POST",
                            ...
                            <div class="box-body">
		                        <div class="search-table-outter">
		                            <table id="tbl_pd" class="table table-bordered table-striped table-responsive search-table inner" width="100%">
                                        <thead>
                                            <tr>
		                                        <th width="100" style="text-align:center" nowrap>No. PD</th>
												<th width="50" style="text-align:center" nowrap><?=$Reference?></th>
		                                            ...
		                                            foreach($resPDc as $rPD) :
		                                                ...
		                                                ?>
		                                                    <tr id="trTAX_<?php echo $rowPD; ?>">
																...
																<td style="text-align: center;"><?=$Jrn_RefNo?></td>
		                                                        <td>
