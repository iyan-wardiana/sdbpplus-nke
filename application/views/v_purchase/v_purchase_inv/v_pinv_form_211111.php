                              	...
                              	<div class="box box-warning">
                                    ...
                                    <div class="box-body">
	                                    <table id="tbl" class="table table-bordered table-striped" width="100%">
											...
											<?php
												$s_01	= "SELECT A.INV_NUM, A.INV_CODE, A.TTK_NUM, A.TTK_CODE, A.TTK_DATE, A.ITM_UNIT, A.ITM_QTY, A.ITM_UNITP,
																A.ITM_AMOUNT, A.ITM_AMOUNT_PPN, A.ITM_AMOUNT_PPH, A.ITM_AMOUNT_DPB, A.ITM_AMOUNT_RET,
																A.ITM_AMOUNT_POT, A.ITM_AMOUNT_OTH, A.ITM_ACC_OTH, A.ITM_AMOUNT_TOT, A.ITM_NOTES
...
<script>
	...
	function add_DETIL(strItem) 
	{
		...
		// TTK DATE
			...
			objTD.noWrap = true;
			objTD.innerHTML = ''+TTK_DATEV+'<input type="hidden" id="data'+intIndex+'TTK_DATE" name="data['+intIndex+'][TTK_DATE]" value="'+TTK_DATE+'" class="form-control" style="min-width:100px;">';
