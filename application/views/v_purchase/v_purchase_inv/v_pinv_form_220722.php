...
if($LangID == 'IND')
{
	...
	$docalert3	= 'Supplier ini memiliki Pinjaman Dinas (PD) yang beleum diselesaikan. Silahkan masukan jumlah/nilai PD yang akan dijadikan sebagai pengurang nilai pembayaran.';
}
else
{
	$docalert1	= 'Warning';
		...
		<section class="content">
		    <div class="row">
                ...
                <form class="form-horizontal" name="frm" id="frm" method="post" action="<?php echo $form_action; ?>" onSubmit="return checkForm()">
						...
						<div class="box box-primary">
							...
							<div class="box-body">
		                        ...
		                        <div class="form-group">
		                          	...
		                          	<div class="col-sm-9">
		                                <textarea name="SPLADD1" id="SPLADD1" cols="50" class="form-control"  style="height:65px"><?php echo $SPLADD1; ?></textarea>
		                          	</div>
		                        </div>
		                        <div class="form-group" style="display:none">
		                        ...
		                        <div class="form-group">
		                       	  <label for="inputName" class="col-sm-3 control-label"><?php echo $Notes; ?></label>
		                          	<div class="col-sm-9">
		                                <textarea class="form-control" name="INV_NOTES"  id="INV_NOTES" style="height:100px"><?php echo $INV_NOTES; ?></textarea>
		                          	</div>
		                        </div>
					...
					<div class="col-md-6">
						<div class="box box-warning">
							...
							<div class="box-body">
		                        ...
		                        <div class="form-group">
		                            <label for="inputName" class="col-sm-3 control-label">PPn / PPh</label>
		                            ...
		                            <div class="col-sm-4">
		                                ...
		                                <input type="text" class="form-control" style="text-align:right" name="INV_AMOUNT_PPHX" id="INV_AMOUNT_PPHX" value="<?php echo number_format($INV_AMOUNT_PPH, 2); ?>" onBlur="countAmn_pph(this)" onKeyPress="return isIntOnlyNew(event);" readonly>
		                            </div>
		                        </div>
			                	<?php
								...
								<?php
		                            $sqlC0a		= "tbl_chartaccount WHERE Account_Category IN (4) AND PRJCODE = '$PRJCODE'";
		                            $resC0a 	= $this->db->count_all($sqlC0a);
		                            
		                            $sqlC0b		= "SELECT DISTINCT Acc_ID, Account_Number, Account_Level, Account_NameEn, Account_NameId, Acc_ParentList,
														Acc_DirParent, isLast
		                                            FROM tbl_chartaccount WHERE Account_Category IN (4) AND PRJCODE = '$PRJCODE' ORDER BY Account_Number";
		                            $resC0b 	= $this->db->query($sqlC0b)->result();
		                        ?>
		                        <div class="form-group">
		                        ...
		                        <div class="form-group">
		                            ...
		                            <div class="col-sm-4">
		                                ...
		                                <input type="text" class="form-control" style="text-align:right" name="INV_AMOUNT_DPBX" id="INV_AMOUNT_DPBX" value="<?php echo number_format($INV_AMOUNT_DPB, 2); ?>" onBlur="countAmn_dpb(this)" onKeyPress="return isIntOnlyNew(event);" readonly>
		                            </div>
		                            <div class="col-sm-5">
                    ...
                    <div class="col-sm-12" id="pdAlert" style="display: none;">
		                        ...
		                        <div class="search-table-outter">
		                            <table id="tbl_pd" class="table table-bordered table-striped table-responsive search-table inner" width="100%">
										...
										<?php
		                                    ...
		                                    if($task == 'edit')
		                                    {
		                                        $sqlPDc		= "tbl_journalheader_pd WHERE REF_PINV = '$INV_CODE' AND proj_Code = '$PRJCODE'";
		                                        $resPDc 	= $this->db->count_all($sqlPDc);

		                                        $sqlPD			= "SELECT JournalH_Code, Manual_No, Journal_Amount, Journal_AmountReal,
		                                        						JournalH_Desc, JournalH_Date FROM tbl_journalheader_pd
																	WHERE REF_PINV = '$INV_CODE' AND proj_Code = '$PRJCODE'";
		                                        ...
		                                        if($resPDc > 0)
		                                        {
		                                            foreach($resPDc as $rPD) :
														...
														$Jrn_Date 	= strftime('%d %B %Y', strtotime($rPD->JournalH_Date));
														$Jrn_Amn 	= $rPD->Journal_Amount;
														$Jrn_AmnR 	= $rPD->Journal_AmountReal;
		                                                ...
		                                                ?>
		                                                    <tr id="trTAX_<?php echo $rowPD; ?>">
		                                                    	...
		                                                    	<input type="hidden" id="dataPD<?php echo $rowPD; ?>TOT_REM" name="dataPD[<?php echo $rowPD; ?>][TOT_REM]" value="<?php echo $Jrn_Rem; ?>">
		                                                    	<input type="hidden" id="dataPD<?php echo $rowPD; ?>TOT_REMREAL" name="dataPD[<?php echo $rowPD; ?>][TOT_REMREAL]" value="<?php echo $Jrn_AmnR; ?>">
		                                                        <td height="25" style="text-align:left;">
																	<?php echo "$Jrn_CodeM<br>"; ?>
																	<div style="white-space:nowrap"><strong><i class="fa fa-calendar margin-r-5"></i><?php echo $Jrn_Date; ?></strong></div>
		                                                        </td>
		                                                        <td>
		                                                        ...
		                                                        <td style="text-align:left;" nowrap>
		                                                        	<?php
			                                                        	...
			                                                        	{
			                                                        		?>
			                                                        		<input type="text" id="TOT_REMREAL<?php echo $rowPD; ?>" value="<?php echo number_format($Jrn_AmnR, 2); ?>" class="form-control" style="min-width:100px; text-align: right" onBlur="chgPDREAL(this, <?php echo $rowPD; ?>)">
			                                                        		<?php 
			                                                        	} 
			                                                        	else 
			                                                        	{
			                                                        		echo number_format($Jrn_AmnR, 2);
			                                                        		?>
			                                                            	<input type="hidden" id="TOT_REMREAL<?php echo $rowPD; ?>" value="<?php echo $Jrn_AmnR; ?>" class="form-control" style="min-width:100px; text-align: right" onBlur="chgPDREAL(this, <?php echo $rowPD; ?>)">
			                                                        		<?php 
			                                                        	}
		                                                        	?>
		                                                        </td>
...
<script>
	...
	function add_DETIL(strItem) 
	{
		...
		// TTK PPH
			...
			objTD.style.textAlign = 'right';
			objTD.noWrap = true;
			objTD.innerHTML = ''+doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(ITM_AMOUNT_PPH)),2))+'<input type="hidden" id="data'+intIndex+'ITM_AMOUNT_PPH" name="data['+intIndex+'][ITM_AMOUNT_PPH]" value="'+ITM_AMOUNT_PPH+'" class="form-control" style="min-width:100px;"><input type="hidden" id="data'+intIndex+'TAXCODE_PPH" name="data['+intIndex+'][TAXCODE_PPH]" value="'+TAXCODE_PPH+'" class="form-control" style="min-width:100px;">';
		...
		if(JRN_CODE != '')
		{
			...
			// PD CODE
				...
				objTDPD.noWrap = true;
				objTDPD.innerHTML = JRN_CODEM+'<input type="hidden" id="dataPD'+intIndex+'JRN_CODEM" name="dataPD['+intIndex+'][JRN_CODEM]" value="'+JRN_CODEM+'"><input type="hidden" id="dataPD'+intIndex+'JRN_CODE" name="dataPD['+intIndex+'][JRN_CODE]" value="'+JRN_CODE+'"><input type="hidden" id="dataPD'+intIndex+'TOT_REM" name="dataPD['+intIndex+'][TOT_REM]" value="'+TOT_REM+'"><input type="hidden" id="dataPD'+intIndex+'TOT_REMREAL" name="dataPD['+intIndex+'][TOT_REMREAL]" value=""><br><div style="white-space:nowrap"><strong><i class="fa fa-calendar margin-r-5"></i>'+JRN_DATED+'</strong></div>';
