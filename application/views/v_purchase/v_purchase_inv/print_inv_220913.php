...
<head>
    ...
    <?php
        ...
        $INV_TOTPOT     = $INV_AMOUNT_PPH + $INV_AMOUNT_DPB + $INV_AMOUNT_POTUM + $INV_AMOUNT_OTH + $INV_AMOUNT_POT;
                ...
                <table width="100%" border="1" cellpadding="0" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td width="200" style="text-align: right;">(<?php echo number_format($INV_AMOUNT_POT, 2); ?>)&nbsp;</td>
                        </tr>
                        <tr>
                            <td width="100">&nbsp;</td>
                            <td>PPN</td>
                        ...
                        <?php
                            ...
                            // START : CACATAN 29-08-2022. BY DIAN HERMANTO
                                ...
                                $s_SQL      = "SELECT A.JournalH_Code, A.proj_Code, A.Acc_Id, A.Acc_Name, A.ITM_CODE, C.ITM_NAME, A.Journal_DK,
                                                   A.Base_Debet, A.Base_Kredit, A.Manual_No, A.Other_Desc, A.ISRET
                                ...
                                if($getJournal_Hutang->num_rows() > 0)
                                {
                                    ...
                                    foreach($r_SQL as $rJ):
                                        ...
                                        if($ISRET == 1)
                                        {
                                            $RET_DESC   = $JournalDesc;
                                            $RET_ACC    = $Acc_Id;
                                            $RET_ITM    = $ITM_CODE;
                                            $TOT_RET    = $TOT_RET + $Base_Kredit;
                                        }
                                        else
                                        {
