							...
							<div class="box-body">
		                        ...
		                        <div class="form-group">
		                            ...
		                            <div class="col-sm-5">
		                                ...
		                                <input type="text" class="form-control" style="text-align:right" name="INV_AMOUNT_RETX" id="INV_AMOUNT_RETX" value="<?php echo number_format($INV_AMOUNT_RET, 2); ?>" onBlur="countAmn_ret(this)" onKeyPress="return isIntOnlyNew(event);" title="Pembentukan Faktur Retensi dilakukan terpisah." >
		                            </div>
		                            <div class="col-sm-4">
	                                    ...
	                                    <table id="tbl" class="table table-bordered table-striped" width="100%">
											...
											<?php
												$s_01	= "SELECT A.INV_NUM, A.INV_CODE, A.TTK_NUM, A.TTK_CODE, A.TTK_DATE, A.ITM_UNIT, A.ITM_QTY,
																...
																A.ITM_AMOUNT_TOT, A.ITM_NOTES, A.REF_CATEG
...
<script>
	...
	function checkTotalTTK()
	{
		...
		for (i = 1; i <= totalrow; i++) 
		{
			...
			INV_TOT_GTOTAL 	= parseFloat(INV_TOT_GTOTAL) + parseFloat(ITM_AMOUNT_TOT) - parseFloat(INV_TOT_POTUM);
		}
	...
	function checkForm()
	{
		...
		console.log('INV_PPN = '+INV_PPN)
		INV_AMOUNT_PPN	= document.getElementById("INV_AMOUNT_PPN").value;
		console.log('INV_AMOUNT_PPN = '+INV_AMOUNT_PPN)
