...
$sqlINV			= "SELECT * FROM tbl_pinv_header WHERE INV_NUM = '$INV_NUM' LIMIT 1";
...
foreach($resINV as $rowINV):
	...
	$PO_NUM 		= $rowINV->PO_NUM;
	$PRJCODE 		= $rowINV->PRJCODE;
	...
	$JH_CODEM 	= $rowINV->INV_CODE;
	$JH_DATEY 	= date('Y', strtotime($rowINV->INV_DATE));
	$JH_DATEM 	= date('m', strtotime($rowINV->INV_DATE));
	$INV_CURRENCY	= $rowINV->INV_CURRENCY;
	$INV_TAXCURR	= $rowINV->INV_TAXCURR;
	$DP_NUM 		= $rowINV->DP_NUM;
	$DP_AMOUNT 		= $rowINV->DP_AMOUNT;
	$INV_AMOUNT 	= $rowINV->INV_AMOUNT;
	$INV_TERM 		= $rowINV->INV_TERM;
	$INV_STAT 		= $rowINV->INV_STAT;
	$INV_PAYSTAT 	= $rowINV->INV_PAYSTAT;
	$COMPANY_ID 	= $rowINV->COMPANY_ID;
	$VENDINV_NUM 	= $rowINV->VENDINV_NUM;
	$INV_NOTES 		= $rowINV->INV_NOTES;
	$Acc_ID			= "";
endforeach;
$noU				= 1;
...
<section class="content">
    ...
    <tr>
        ...
        <td colspan="10" class="style2" style="text-align:center; font-weight:bold; font-size:18px"><u><?php echo $h1_title; ?></u><br></td>
      </tr>
    <tr>
      ...
      <td width="12%" valign="top" class="style2" style="text-align:left; font-size:12px">&nbsp;</td>
    </tr>
    <tr>
      ...
      <td colspan="4" rowspan="2"  nowrap class="style2" style="text-align:left;">
        <?php /*?>PUTIH &nbsp;: GENERAL ACCOUNTING<br>
        MERAH&nbsp;&nbsp;: COST/BUDGET CONTROL<br>
        KUNING&nbsp;&nbsp;: ARSIP<?php */?>      </td>
    ...
    <tr>
      <td colspan="6" nowrap class="style2" style="text-align:left;">BANK : </td>
      <td class="style2" style="text-align:right;" nowrap>NO. PEMBAYRAN (KASIR) :</td>
    </tr>
    <tr>
      <td colspan="11" class="style2" height="4" style="text-align:left">NO. FAKTUR : <?php echo $INV_CODE; ?></td>
    </tr>
    <tr>
          ...
          <table width="100%" border="1" rules="all">
                ...
                <?php
					...
					$sqlq2 	= "SELECT DISTINCT A.Acc_Id, A.proj_Code, A.Base_Kredit, A.JournalD_Debet, A.JournalD_Debet_tax,
								...
								WHERE A.JournalH_Code = '$INV_NUM' cv";
                ...
                <tr height="40px">
                    <td colspan="5" nowrap style="text-align:left; border-right:none">TERBILANG :
                    	<font style="font-style:italic"><?php echo $terbilang = $moneyFormat->terbilang($INV_AMOUNT); ?></font>
                    </td>
                    <td nowrap style="text-align:right; font-weight:bold">TOTAL :</td>
                    <td nowrap style="text-align:right; font-weight:bold"><?php echo number_format($INV_AMOUNT, 2); ?></td>
                </tr>
       	</table>
            <br>
        <table width="100%" border="1" rules="all">
