...
<head>
    ...
    <?php
        ...
        $INV_TOTPOT     = $INV_AMOUNT_PPH + $INV_AMOUNT_DPB + $INV_AMOUNT_RET + $INV_AMOUNT_POTUM + $INV_AMOUNT_OTH;

        $INV_TOTCOST    = $INV_AMOUNT + $INV_AMOUNT_PPN - $INV_TOTPOT;
                ...
                <table width="100%" border="1" cellpadding="0" cellspacing="0">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td width="200" style="text-align: right;"><?php echo number_format($INV_AMOUNT, 2); ?>&nbsp;</td>
                        </tr>
                        <tr>
                            <td width="100">&nbsp;</td>
                        ...
                        <tr>
                            <td width="100">&nbsp;</td>
                            <td>Potongan Retensi</td>
                            <td width="200" style="text-align: right;">(<?php echo number_format($INV_AMOUNT_RET, 2); ?>)&nbsp;</td>
                        </tr>
                        <tr>
                            <td width="100">&nbsp;</td>
            ...
            <div class="box-detail" id="detail_JurnalHutang">
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tbody>
                        <?php
                            // get TTK_NUM
                            $this->db->select("A.TTK_REF1_NUM");
                            $this->db->from("tbl_ttk_detail A");
                            $this->db->join("tbl_pinv_detail B", "B.TTK_NUM = A.TTK_NUM AND B.PRJCODE = A.PRJCODE");
                            $this->db->where(["B.INV_NUM" => $INV_NUM]);
                            $getTTK = $this->db->get();
                            $arrTTK_REF = [];
                            foreach($getTTK->result() as $rTTK):
                                $arrTTK_REF[] = $rTTK->TTK_REF1_NUM;
                            endforeach;

                            // get Journal hutang voucher
                            $this->db->select("A.JournalH_Code, A.SPLCODE, B.Acc_Id, B.proj_Code, B.Journal_DK, C.ITM_CODE, C.ITM_NAME");
                            ...
                            $this->db->where_in("A.JournalH_Code", $arrTTK_REF);
                            ...
                            if($getJournal_Hutang->num_rows() > 0)
                            {
                                ...
                                $TBalance_Debet = 0;
                                $TBalance_Kredit = 0;
                                // echo $getJournal_Hutang->num_rows();
                                foreach($getJournal_Hutang->result() as $rJ):
                                    ...
                                    $BaseKredit = $BaseKredit + $Base_Debet;
                                    ...
                                    if($Journal_DK == 'K')
                                    {
                                        $SPLDESC     = $this->db->select("SPLDESC")->from("tbl_supplier")->where(["SPLCODE" => $SPLCODE, "SPLSTAT" => 1])->get()->row("SPLDESC");
                                        $JournalDesc = "$SPLDESC";  
                                    }
