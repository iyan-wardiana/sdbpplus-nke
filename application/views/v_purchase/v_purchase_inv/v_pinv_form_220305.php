							...
							<div class="box-body">
		                        ...
		                        <div class="form-group">
		                          	...
		                          	<div class="col-sm-4">
                        				<div class="input-group date">
		                                    <div class="input-group-addon"><i class="fa fa-calendar"></i>&nbsp;</div>
		                                    <input type="text" name="INV_DUEDATEX" class="form-control pull-left" id="INV_DUEDATEX" value="<?php echo $INV_DUEDATE; ?>" readonly>
		                                    <input type="hidden" name="INV_DUEDATE" class="form-control pull-left" id="INV_DUEDATE" value="<?php echo $INV_DUEDATE; ?>" readonly>
		                                </div>
		                          	</div>
		                        </div>
		                        <script>
						...
						<div class="box box-warning">
							...
							<div class="box-body">
								...
								<?php
		                            ...
		                            $sqlC0b		= "SELECT DISTINCT Acc_ID, Account_Number, Account_Level, Account_NameEn, Account_NameId, Acc_ParentList,
														Acc_DirParent, isLast
		                                            FROM tbl_chartaccount WHERE Account_Category IN (4) AND PRJCODE = '$PRJCODE' ORDER BY ORD_ID";
		                            $resC0b 	= $this->db->query($sqlC0b)->result();
		                        ?>
		                        <div class="form-group">
		                            ...
		                            <table id="tbl_tax" class="table table-bordered table-striped table-responsive search-table inner" width="100%">
                                        <thead>
                                            <tr>
		                                        ...
		                                        <th width="40%" style="text-align:center" nowrap><?php echo "No. Seri Pajak"; ?></th>
		                                        <th width="20%" style="text-align:center" nowrap><?php echo $AmountReceipt; ?></th>
		                                        <th width="20%" style="text-align:center" nowrap><?php echo $PPNValue; ?></th>
						                  	</tr>
                                        </thead>
                                        <tbody>
										<?php
	...
	<?php
		...
		if($task == 'add')
		{
			?>
				...
				{
					var formData 	= {
										MenuCode		: "MN045", 		// <?=$MenuCode?> : SETT TO VCASH KARENA NOMORNYA DISATUKAN
										JournalType		: "",
	...
	function checkTAXNO(TOT_ROWSEL)
	{
		...
		if(totalrow == TOT_ROWSEL)
		{
	    	...
	    	$('#tbl_tax').DataTable(
	    	{
				...
				"autoWidth": true,
				"filter": true,
		        "ajax": "<?php echo site_url('c_purchase/c_pi180c23/get_AllDataTTKTAX/?id='.$collID.'~')?>"+collTTK,
		        "type": "POST",
				//"lengthMenu": [[10, 25, 50, 100, 200, -1], [10, 25, 50, 100, 200, "All"]],
				"lengthMenu": [[10, 25, 50, 100, 200], [10, 25, 50, 100, 200]],
