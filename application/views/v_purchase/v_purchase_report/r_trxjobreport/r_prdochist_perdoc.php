...
/* 
	...
	* File Name		= r_prdochist_perdoc.php
	* Location		= -
*/
/*if($viewType == 1)
{
			                ...
			                <tr style="background:#CCCCCC">
			               	...
			               	<?php
								$getPR 		= "SELECT
												...
												FROM
													tbl_po_header A
													INNER JOIN tbl_employee AA ON A.PO_CREATER = AA.Emp_ID
													RIGHT JOIN tbl_pr_header B ON A.PR_NUM = B.PR_NUM 
													INNER JOIN tbl_employee C ON B.PR_CREATER = C.Emp_ID
												WHERE
													B.PR_NUM =  '$PR_NUM' AND B.PRJCODE = '$PRJCODE' ORDER BY B.PR_CODE";
