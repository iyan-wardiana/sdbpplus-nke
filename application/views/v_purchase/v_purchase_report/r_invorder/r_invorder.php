                    ...
                    <input type="submit" class="button_css" name="submitSrch" id="submitSrch" value=" search " />
           	  	...
           	  	<form method="post" name="frm" id="frm" action="<?php echo $form_action; ?>" onSubmit="return target_popup(this);" >
                  	<table width="100%">
	                    ...
	                    <tr>
	                        <td><?php //echo $Month ?> Periode  </td>
	                        <td nowrap>:</td>
	                        <td colspan="2" nowrap>
	                            <select name="VMonth" id="VMonth" class="form-control" style="max-width:70px; display:none" >
	                            ...
	                            <div class="input-group date">
	                              	...
	                              	<input type="text" name="datePeriod" class="form-control pull-right" id="reservation" style="width:180px">
	                            </div>
	        				</td>
	                    </tr>
