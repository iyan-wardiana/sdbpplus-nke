                ...
                <div class="box-body chart-responsive">
                	<form class="form-horizontal" method="post" name="frm" id="frm" action="<?php echo $form_action; ?>" onSubmit="return target_popup(this);" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select name="REPCAT" id="REPCAT" class="form-control select2" >
                                    <option value="1" > Semua </option>
                                    <option value="PO" > OP </option>
                                    <option value="SPK" > SPK </option>
                                    <option value="VCASH" > V-CASH </option>
                                    <option value="VLK" > V-LK </option>
