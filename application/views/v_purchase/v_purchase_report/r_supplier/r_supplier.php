...
<html>
    ...
    <?php
    	...
    	if($LangID == 'IND')
    	{
    		$alert1			= "Anda belum memilih kategori laporan.";
    	}
    	else
    	{
    		$alert1			= "You not yet select report category.";
    	}
            	...
            	<div class="box-body chart-responsive">
                	<form class="form-horizontal" name="frm" method="post" action="<?php echo $form_action; ?>" enctype="multipart/form-data" onSubmit="return target_popup(this)">
                    	<div class="form-group">
                            ...
                            <div class="col-sm-10">
                            	<select name="SortBy" id="SortBy" class="form-control select2" data-placeholder="&nbsp;&nbsp;&nbsp;<?php echo $Category; ?>" >
                                	<option value="none"> --- </option>
        							<?php
        								$vsql		= "SELECT * FROM tbl_vendcat";
        								$res_sql	= $this->db->query($vsql)->result();
        								foreach($res_sql as $row_ven):
        									$VendCat_Code	= $row_ven->VendCat_Code;
        									$VendCat_Name	= $row_ven->VendCat_Name;
        									$VendCat_Desc	= $row_ven->VendCat_Desc;
        									?>
        									<option value="<?php echo $VendCat_Code; ?>">
        										<?php echo $VendCat_Name; ?>
        									</option>
        									<?php
        								endforeach;
                                    ?>
                    	...
                    	<div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select name="SuppStat" id="SuppStat" class="form-control select2" >
                                    <option value="2" selected><?php echo $All; ?></option>
