			                ...
			                <tr style="background:#CCCCCC">
			               	...
			               	<?php
								$getPR 		= "SELECT
												...
												WHERE
													B.PR_DATE BETWEEN '$Start_Date' AND '$End_Date' AND B.PRJCODE = '$PRJCODE' $addQuery ORDER BY B.PR_DATE, B.PR_CODE, A.PO_DATE, A.PO_CODE";
								...
								if($resPR->num_rows() > 0)
								{
									...
									foreach($resPR->result() as $rPR):
										...
										$RECOM_DATE 	= $rPR->RECOM_DATE;
										$PO_CREATED 	= $rPR->RECOM_DATE;
										if($PO_CREATED == "")
										{
											$PO_DATEV 	= "";
											$PO_CREATER = "";
