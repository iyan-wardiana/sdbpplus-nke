		                        ...
		                        <div class="form-group">
		                          	...
		                          	<div class="col-sm-9">
		                                <div class="input-group">
		                                    ...
		                                    <input type="text" class="form-control" name="PR_NUM1" id="PR_NUM1" value="<?php echo $PR_CODE; ?>" data-toggle="modal" data-target="#mdl_addItm" <?php if($task != 'add') { ?> disabled <?php } ?>>
		                                </div>
		                            </div>
		                        </div>
								<?php
															...
															<?php
																...
																if($resReqC > 0)
																{
																	...
																	foreach($viewAllMR as $row) :
																		...
																		?>
														  				<td style="text-align:center"><input type="radio" name="chk1" value="<?php echo $PR_NUM;?>|<?php echo $PR_CODE;?>" onClick="pickThis1(this);" /></td>
																		<td nowrap>
																...
																else
																{
																	?>
																	<tr>
																		<td colspan="5" style="font-style: italic; text-align: center;" nowrap>no data</td>
																	</tr>
																	<?php
																}
															?>
