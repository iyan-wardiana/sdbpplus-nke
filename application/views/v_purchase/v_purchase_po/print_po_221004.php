				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
					...
					<tbody>
						<?php
				            ...
				            endforeach;
						?>
						<tr style="border-top: 2px solid; background-color: rgba(152, 156, 153, 0.3) !important; font-weight: bold; vertical-align: top; font-size:medium;">
							<td colspan="6" rowspan="3" style="vertical-align: top; border-right: hidden;">TERBILANG :&nbsp;<i><?php echo terbilang($PO_TOTCOST); ?>&nbsp;<?=$currency?></i></td>
							<td colspan="2" style="text-align: right; border-right: hidden;">TOTAL :</td>
							<td style="text-align: right;">&nbsp;<?php echo number_format($TOT_COST, 2); ?></td>
						</tr>
						<tr style="background-color: rgba(152, 156, 153, 0.3) !important; font-weight: bold; vertical-align: top; font-size:medium;">
							<td colspan="2" style="text-align: right; border-right: hidden;">PPN :</td>
							<td style="text-align: right;">&nbsp;<?php echo number_format($TOTPPN, 2); ?></td>
						</tr>
						<tr style="background-color: rgba(152, 156, 153, 0.3) !important; font-weight: bold; vertical-align: top; font-size:medium;">
							<td colspan="2" style="text-align: right; border-right: hidden;">GRAND TOTAL :</td>
						...
						<div class="cont">
							<div class="box-notes" style="border-top: hidden;">
								...
								<div class="box-column-9">
									<ol>
										<li>Pengiriman paling lambat tanggal : <span style="font-weight: normal;"><?=$PO_PLANIRV?></span></li>
										<li>
							...
							<div class="box-asign">
								<div class="box-column-4">
									<span id="acc">D i a j u k a n<br><br></span>
									<span id="nama">Nama: .....................</span>
									<span id="jab">Jab.: Unit Pengadaan Barang (Pusat/Proy.)</span>
								</div>
								<div class="box-column-4">
									<span id="acc">D i p e r i k s a<br><br></span>
									<span id="nama">Nama: .....................</span>
									<span id="jab">Jab.: (Ka. Divisi)</span>
								</div>
								<div class="box-column-4">
									<span id="acc">D i p e r i k s a<br><br></span>
									<span id="nama">Nama: .....................</span>
									<span id="jab">Jab.: (Kadept. Operasi)</span>
								</div>
								<div class="box-column-4">
									<span id="acc">M e n y e t u j u i<br><br></span>
									<span id="nama">Nama: .....................</span>
									<span id="jab">Jab.: (Dir. Operasi)</span>
								</div>
								<div class="box-column-4" style="border-right: hidden;">
	...
	$(function(){
		...
		mediaQueryList.addListener(function(mql) {
		    if (mql.matches) {
				...
				// Update isPrint = 1
				if(PO_STAT != 1 || PO_STAT != 2 || PO_STAT != 4)
				{
    				$.ajax({
