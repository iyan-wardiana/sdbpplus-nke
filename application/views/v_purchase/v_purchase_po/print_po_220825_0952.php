					...
					<tbody>
						<?php
							$sqlPODET 	= "SELECT A.PO_NUM, A.PO_CODE, A.PO_DATE, A.PRJCODE, A.PR_NUM, A.JOBCODEDET, 
											A.JOBCODEID, A.JOBPARDESC, A.ITM_CODE, A.ITM_UNIT, A.PR_VOLM, A.PO_VOLM, A.IR_VOLM,
				            ...
				            foreach($resPODET as $row) :
								...
								if($PO_DISC != 0)
								  	$PO_DISCV = number_format($PO_DISC, 2);
								else
									$PO_DISCV = '';
				              	...
				              	?>
				              		<tr style="border-bottom: 2px solid;">
										...
										<td style="text-align: center;"><?php echo $PO_DISCV; ?></td>
