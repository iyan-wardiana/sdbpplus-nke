		                        ...
		                        <div class="form-group">
		                          	...
		                          	<div class="col-sm-3">
		                                <div class="input-group date">
		                                    ...
		                                    <input type="text" name="PO_DATE" class="form-control pull-left" id="datepicker" value="<?php echo $PO_DATE; ?>">
		                                </div>
		                          	</div>
		                          	<div class="col-sm-2">
		                                    ...
		                                    <?php
												...
												if($PO_STAT != 1 AND $PO_STAT != 4) 
												{
													?>
														...
														<option value="4"<?php if($PO_STAT == 4) { ?> selected <?php } if($can_revise == 0) { ?> disabled <?php } ?>>Revising</option>
                                        ...
                                        if($resultC > 0)
                                        {
                                            ...
                                            foreach($result as $row) :
                                                ...
                                                // START : GET TOTAL ORDERED VOLUME
                                                	...
                                                	// 3. TOTAL VOLUME PO
	                                            			$ORDERED_VOL 	= $ORDERED_VOL0 + $ORDERED_VOL1;
                                                ...
                                                // START : GET TOTAL ORDERED VALUE
                                                	...
                                                	// 4. TOTAL VOLUME PO
	                                                		$ORDERED_VAL 	= $ORDERED_VAL0 + $ORDERED_VAL1 + $ORDERED_VAL2 + $ORDERED_VAL3;
		                                                            ...
		                                                            else
		                                                            {
																		...
																		{																			
																			// START : CANCEL VOL. PER ITEM
																				$secShwD 	= base_url().'index.php/c_purchase/c_p180c21o/cancelItem/?id=';
																				...
																				$canclRow 	= "$secDelD~OP~$PRJCODE~$PO_ID~$PO_NUM~$JOBCODEID~$ITM_CODE~$ITM_NAME";
																			// END : CANCEL VOL. PER ITEM
																			?>
																			<input type="hidden" name="urlgetID<?php echo $currentRow; ?>" id="urlgetID<?php echo $currentRow; ?>" value="<?=$canShwRow?>">
																			<input type="hidden" name="urlcanD<?php echo $currentRow; ?>" id="urlcanD<?php echo $currentRow; ?>" value="<?=$canclRow?>">
																			<a href="#" onClick="cancelRow(<?php echo $currentRow; ?>)" title="Batalkan Volume OP" class="btn btn-danger btn-xs"><i class="fa fa-repeat"></i></a>
																			<?php
																		}
																		else 
																		{
