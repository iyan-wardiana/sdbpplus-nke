                                ...
                                <select name="SPLCODE" id="SPLCODE" class="form-control select2" style="width: 100%" onChange="grpData(this.value)">
                                    ...
                                    <?php
                                        $s_SPL  = "SELECT DISTINCT B.SPLCODE, B.SPLDESC FROM tbl_po_header A
                                                    ...
                                                    WHERE A.PRJCODE = '$PRJCODE' AND A.PO_STAT IN (2,7) AND A.PO_CATEG = 0 ORDER BY B.SPLDESC ASC";
                                ...
                                <select name="PR_NUM" id="PR_NUM" class="form-control select2" style="width: 100%" onChange="grpData(this.value)">
                                    ...
                                    <?php
                                        $s_SPP  = "SELECT DISTINCT PR_NUM, PR_CODE FROM tbl_po_header
                                                    WHERE PR_NUM != '' AND PO_CATEG = 0 AND PO_STAT IN (2,7) AND PRJCODE = '$PRJCODE' ORDER BY PR_CODE ASC";
            ...
            <script type="text/javascript">
                function grpData()
                {
                    ...
                    $('#example').DataTable( {
                        ...
                        "autoWidth": true,
                        "filter": true,
                        "ajax": "<?php echo site_url('c_purchase/c_p180c21o/get_AllData_1n2GRP/?id='.$PRJCODE)?>"+'&SPLC='+SPLC+'&SPNO='+SPNO+'&DSTAT='+DSTAT+'&SRC='+SRC,
                        "type": "POST",
...
<script>
    ...
    $(document).ready(function() {
        $('#example').DataTable( {
            ...
            "autoWidth": true,
            "filter": true,
            "ajax": "<?php echo site_url('c_purchase/c_p180c21o/get_AllData_1n2/?id='.$PRJCODE)?>",
            "type": "POST",
            //"lengthMenu": [[10, 25, 50, 100, 200, -1], [10, 25, 50, 100, 200, "All"]],
            "lengthMenu": [[10, 25, 50, 100, 200], [10, 25, 50, 100, 200]],
            "columnDefs": [ { "width": "100px", "targets": [1] }
