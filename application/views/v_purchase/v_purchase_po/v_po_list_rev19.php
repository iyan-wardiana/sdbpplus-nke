            ...
            <div class="search-table-outter">
                <table id="example1" class="table table-bordered table-striped table-responsive search-table inner" width="100%">
                    ...
                    <tr>
                        ...
                        <th width="53%" style="vertical-align:middle; text-align:center"><?php echo $Supplier  ?> </th>
                        <th width="6%" style="vertical-align:middle; text-align:center"><?php echo $PRCode ?> </th>
                        <th width="6%" style="vertical-align:middle; text-align:center"><?php echo $OPCost ?> </th>
                        <th width="3%" style="vertical-align:middle; text-align:center"><?php echo $ReceivePlan ?> </th>
                        <th width="4%" style="vertical-align:middle; text-align:center; display:none"><?php echo $Term ?> </th>                   
                    ...
                    <tbody> 
                        ...
                        if($cData > 0)
                        {
                            ...
                            foreach($vData as $row) :
                        		...
                        		?>
                                    <td style="text-align:center; display:none"><?php print $myNewNo; ?>.</td>                   
                                    <td nowrap style="text-align:left; display:none"> <?php print $PO_NUM; ?> </td>                   
                                    <td nowrap style="text-align:left"> <?php print $PO_CODE; ?> </td>
                                    <td style="text-align:center" nowrap><?php print date('d M Y', strtotime($PO_DATE)); ?> </td>
                                    ...
                                    endforeach;
									$PO_DESC	= "$SPLCODE2 - $SPLDESC2";
									if($PO_NOTES != '')
									{
										$PO_DESC	= "$PO_DESC : $PO_NOTES";
									}
                                    ?>
                                    <td style="text-align:left"><?php print $PO_DESC; ?> </td>
                                    <td style="text-align:left" nowrap><?php print "$PR_CODE"; ?> </td>
                                    <td style="text-align:right" nowrap><?php print number_format($PO_TOTCOST, $decFormat); ?> </td>
                                    <td style="text-align:center" nowrap><?php print date('d M Y', strtotime($PO_PLANIR)); ?> </td>
