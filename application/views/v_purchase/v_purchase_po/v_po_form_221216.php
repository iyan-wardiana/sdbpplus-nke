...
<script>
		...
		if(ITM_CATEG != 'UA')
		{
			...
			for(i=0;i<=totRow;i++)
			{
				...
				if(theObj != null)
				{
					...
					console.log('1. '+ITM_RAPVAL 	+'='+ parseFloat(REM_VAL_JOB) +'-'+ parseFloat(TOTPO_VAL3));
	...
	function add_item(strItem) 
	{
		...
		objTD = objTR.insertCell(objTR.cells.length);
		objTD.style.textAlign = 'center';
		objTD.innerHTML = '<input type="text" class="form-control" style="text-align:center; max-width:90px" id="data'+intIndex+'ITM_UNIT" name="data['+intIndex+'][ITM_UNIT]" value="'+ITM_UNIT+'">';
