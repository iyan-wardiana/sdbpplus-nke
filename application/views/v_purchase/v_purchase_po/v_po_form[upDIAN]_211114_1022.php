			                ...
			                <div class="modal-body">
								<div class="row">
							    	<div class="col-md-12">
						              	<ul class="nav nav-tabs">
						                    <li id="li1" <?php echo $Active1Cls; ?>>
						                    	<a href="#itm1" data-toggle="tab" onClick="setType(1)"><?php echo $Wage; ?></a>
						                    </li>	
							            ...
							            <div class="box-body">
                                      	...
                                      	<input type="text" name="rowCheck_itm" id="rowCheck_itm" value="0">
                                      	<button type="button" id="idClose_itm" class="btn btn-default" data-dismiss="modal" style="display: none";>Close</button>
	                                </div>
	                            </div>
			                </div>
				        </div>
...
<script>
	...
	function add_upah(strItem) //ADD Upah Angkut
	{
		arrItem = strItem.split('|');		
		alert(arrItem);
		var objTable, objTR, objTD, intIndex, arrItem;
		...
		objTD.innerHTML = '<a href="#" onClick="deleteRow('+intIndex+')" title="Delete Document" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i></a><input type="Checkbox" id="data['+intIndex+'][chk]" name="data['+intIndex+'][chk]" value="'+intIndex+'" onclick="pickThis(this,'+intIndex+')" style="display:none"><input type="Checkbox" style="display:none" id="chk'+intIndex+'" name="chk'+intIndex+'" value="" ><input type="hidden" id="chk" name="chk" value="'+intIndex+'" width="10" size="15" readonly class="form-control" style="max-width:300px;"><input type="hidden" id="data'+intIndex+'PO_NUM" name="data['+intIndex+'][PO_NUM]" value="'+PO_NUM+'" width="10" size="15"><input type="hidden" id="data'+PO_CODE+'" name="data['+intIndex+'][PO_CODE]" value="'+PO_CODE+'" width="10" size="15"><input type="hidden" id="data'+intIndex+'PRJCODE" name="data['+intIndex+'][PRJCODE]" value="'+PRJCODE+'" width="10" size="15"><input type="hidden" id="data'+intIndex+'PR_NUM" name="data['+intIndex+'][PR_NUM]" value="'+PR_NUMX+'" width="10" size="15">';

		// ITM_CODE [1]
		objTD = objTR.insertCell(objTR.cells.length);
		objTD.align = 'left';
		objTD.innerHTML = ''+ITM_CODE+' : '+JOBDESC+'<input type="hidden" id="data'+intIndex+'JOBCODEDET" name="data['+intIndex+'][JOBCODEDET]" value="'+JOBCODEDET+'" width="10" size="15"><input type="hidden" id="data'+intIndex+'JOBCODEID" name="data['+intIndex+'][JOBCODEID]" value="'+JOBCODEID+'" width="10" size="15"><input type="hidden" id="data'+intIndex+'JOBPARENT" name="data['+intIndex+'][JOBPARENT]" value="'+JOBPARENT+'" width="10" size="15"><input type="hidden" id="data'+intIndex+'JOBPARDESC" name="data['+intIndex+'][JOBPARDESC]" value="'+JOBDESC+'" width="10" size="15">';
		...
		objTD = objTR.insertCell(objTR.cells.length);
		objTD.style.textAlign = 'right';
		objTD.innerHTML = '<input type="text" id="ITM_PRICEx'+intIndex+'" name="ITM_PRICEx'+intIndex+'" value="'+ITM_PRICE+'" width="10" size="15" class="form-control" style="max-width:400px;text-align:right"><input type="hidden" id="data'+intIndex+'ITM_PRICE" name="data['+intIndex+'][ITM_PRICE]" value="'+ITM_PRICE+'" width="10" size="15" class="form-control" style="max-width:400px;text-align:right">';
		...
		objTD = objTR.insertCell(objTR.cells.length);
		objTD.style.textAlign = 'center';
		objTD.innerHTML = '<input type="text" id="data['+intIndex+'][PO_DESC]" name="data['+intIndex+'][PO_DESC]" value="'+JOBDESCH+'" width="10" size="15" class="form-control" style="max-width:350px;text-align:right"><input type="hidden" name="totalrow" id="totalrow" value="'+intIndex+'">';

		//swal(objTD.innerHTML);
		
		
		var decFormat												= document.getElementById('decFormat').value;
		var ITM_PRICE												= document.getElementById('data'+intIndex+'ITM_PRICE').value;
