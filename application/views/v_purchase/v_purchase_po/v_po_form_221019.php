		                        ...
		                        <div class="form-group" >
									...
									<div class="col-sm-2" style="padding-right: 0;">
				                        <div class="pull-right" style="display: <?php if($PR_NUMX <> '' && ($PO_STAT == 1 || $PO_STAT == 4)) echo ""; else echo "none";?>;">
				                        	<a class="btn btn-sm btn-info" id="btn_addItemPR" data-toggle="modal" data-target="#mdl_addItemPR">
                        ...
                        <div class="box box-primary">
	                        <div class="search-table-outter">
	                            <table id="tblITMDET" class="table table-bordered table-striped" width="100%">
                                    ...
                                    <tbody>
										<?php
											/* ------------------------------ Hidden: 2022-1013 => dipindahkan ke controll ------------
											$resultC	= 0;
											if($task == 'add' && $PR_NUMX != '')
											{
												$autoPOID 	= 1;
												$sqlDETPR	= "SELECT DISTINCT A.PR_NUM, A.JOBCODEDET, A.JOBCODEID, A.ITM_CODE, A.SNCODE, 
																	A.ITM_UNIT, (A.PR_VOLM - A.PR_CVOL) AS PR_VOLM,
																...
																WHERE PR_NUM = '$PR_NUMX' AND (A.PR_VOLM - A.PR_CVOL) > 0
																	AND B.PRJCODE = '$PRJCODE'
												...
												if($task == 'edit' && isset($_POST['PR_NUMX']))
												{
													...
													$sqlDETPR	= "SELECT DISTINCT A.PR_NUM, A.JOBCODEDET, A.JOBCODEID, A.ITM_CODE, A.SNCODE, 
																	...
																	WHERE PR_NUM = '$PR_NUMX' 
																		AND B.PRJCODE = '$PRJCODE' AND (A.PR_VOLM - A.PR_CVOL) > 0
														...
														?>
															<tr id="tr_<?php echo $currentRow; ?>">
																...
																<td style="text-align:left; vertical-align: middle;" nowrap>
																	...
																	<div style="font-style: italic; margin-left: 15px;">
																		<span style="font-style: italic; font-weight: bold;">
																			RAP : &nbsp;&nbsp;<?=number_format($ITM_BUDGVAL,2);?>
																		</span>
																		<span id="usedValue_<?php echo $currentRow; ?>" style="font-style: italic; font-weight: bold; display: none;">
																			R : &nbsp;&nbsp;<?=number_format($ORDERED_VAL,2);?>
																		</span>&nbsp;&nbsp;
																...
																<td style="text-align:right; vertical-align: middle;">
																	...
																	<input type="hidden" class="form-control" style="min-width:130px; max-width:200px; text-align:right" name="ITM_BUDGVAL<?php echo $currentRow; ?>" id="ITM_BUDGVAL<?php echo $currentRow; ?>" value="<?php echo $ITM_BUDGVAL; ?>" >
																	<input type="hidden" class="form-control" style="min-width:130px; max-width:200px; text-align:right" name="TOTVAL_OTHDOC<?php echo $currentRow; ?>" id="TOTVAL_OTHDOC<?php echo $currentRow; ?>" value="<?php echo $TOTVAL_OTHDOC; ?>" >
																...
																<td style="text-align:left; vertical-align: middle;">
																	<input type="text" class="form-control" style="text-align:right; min-width:90px" name="PO_PRICEX<?php echo $currentRow; ?>" id="PO_PRICEX<?php echo $currentRow; ?>" size="10" value="<?php echo number_format($ITM_PRICE, $decFormat); ?>" onKeyPress="return isIntOnlyNew(event);" onBlur="getValuePO(<?php echo $currentRow; ?>);">
																...
																<td style="text-align:<?php if($TAXCODE1 == '' || $TAXCODE1 == 0)echo "center;";else echo "left";?>; vertical-align: middle;">
																	<?php if($ITM_CATEG != 'UA'): ?>
																		<select name="data[<?php echo $currentRow; ?>][TAXCODE1]" class="form-control select2" id="data<?php echo $currentRow; ?>TAXCODE1"  onChange="getValuePO(<?php echo $currentRow; ?>);" style="min-width:90px; max-width:150px;">
																...
																?>
																	<tr id="tr_<?php echo $currentRow; ?>">
																		...
																		<td style="text-align:right; vertical-align: middle;">
																			...
																			<input type="hidden" class="form-control" style="text-align:right; min-width:100px" name="PO_PRICEX<?php echo $currentRow; ?>" id="PO_PRICEX<?php echo $currentRow; ?>" size="10" value="<?php echo number_format($ITM_PRICE, $decFormat); ?>" onKeyPress="return isIntOnlyNew(event);" onBlur="getValuePO(<?php echo $currentRow; ?>);">
																			<input style="text-align:right" type="hidden" name="data[<?php echo $currentRow; ?>][PO_PRICE]" id="data<?php echo $currentRow; ?>PO_PRICE" size="6" value="<?php echo $ITM_PRICE; ?>"></td>
																		...
																		<td style="text-align:<?php if($TAXCODE1 == '' || $TAXCODE1 == 0)echo "center;";else echo "left";?>; vertical-align: middle;">
																			<?php
																				if($PO_STAT == 1 || $PO_STAT == 4)
																				{
																					?>
																						<?php if($ITM_CATEG != 'UA'): ?>
																							<select name="data[<?php echo $currentRow; ?>][TAXCODE1]" class="form-control" id="data<?php echo $currentRow; ?>TAXCODE1"  onChange="getValuePO(<?php echo $currentRow; ?>);" style="min-width:90px; max-width:150px;">
																								<option value="0"> --- </option>
																								<?php
						...
						$('#example4').DataTable(
						{
							...
							"ajax": {
								...
								"complete": function() {
									...
									const task 			= '<?=$task?>';
									const totRowDet 	= $('#totalrow').val();
									const totRowDet4 	= $('#totalrow4').val();
									// alert("totalrow4 = "+totRowDet4);
									if(task == 'add')
									{
										for(let i=1; i<=totRowDet; i++) {
											// Table tblITMDET
											const PO_ID_DT 		= $('#data'+i+'PO_ID').val();
											const PRD_ID_DT		= $('#data'+i+'PRD_ID').val();
											const ITM_CODE_DT	= $('#data'+i+'ITM_CODE').val();
											const JOBCODEID_DT	= $('#data'+i+'JOBCODEID').val();
											const PO_VOLM_DT	= $('#data'+i+'PO_VOLM').val();
											const PR_DESC_ID_DT	= $('#data'+i+'PR_DESC_ID').val();
											// alert("PO_ID = "+PO_ID+" PRD_ID = "+PRD_ID+" ITM_CODE = "+ITM_CODE+" JOBCODEID = "+JOBCODEID+"PO_VOLM = "+PO_VOLM+" PR_DESC_ID = "+PR_DESC_ID);

											// Table example4
											for(let j=1; j<=totRowDet4; j++) {
												const PO_ID_REQ 		= $('#PO_ID_REQ'+j).val();
												const PRD_ID_REQ		= $('#PRD_ID_REQ'+j).val();
												const ITM_CODE_REQ		= $('#ITM_CODE_REQ'+j).val();
												const JOBCODEID_REQ		= $('#JOBCODEID_REQ'+j).val();
												const PO_VOLM_REQ		= $('#PO_REQVOLM'+j).val();
												const PR_DESC_ID_REQ	= $('#PR_DESC_ID_REQ'+j).val();

												if(ITM_CODE_DT == ITM_CODE_REQ && JOBCODEID_DT == JOBCODEID_REQ && PR_DESC_ID_DT == PR_DESC_ID_REQ)
												{
													// alert("PR_DESC_ID_DT = "+PR_DESC_ID_DT+" == PR_DESC_ID_REQ = "+PR_DESC_ID_REQ+" row"+j);
													$('#orderedDET'+j).append("<i class='glyphicon glyphicon-triangle-top'></i>&nbsp;"+doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(PO_VOLM_DT)), 2)));
													$('#remVolDET'+j).append("<i class='glyphicon glyphicon-triangle-bottom'></i>&nbsp;"+doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(PO_VOLM_DT)), 2)));

													const ITM_REMVOL_REQ 	= $('#PO_REMVOLM'+j).val();
													const ITM_REMVOL_TREQ	= parseFloat(ITM_REMVOL_REQ - PO_VOLM_DT);
													// alert(ITM_REMVOL_REQ);
													$('#PO_REQVOLMX'+j).val(doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(ITM_REMVOL_TREQ)), 2)));
													$('#PO_REQVOLM'+j).val(ITM_REMVOL_TREQ);
													$('#PO_REMVOLM'+j).val(ITM_REMVOL_TREQ);

													if(ITM_REMVOL_TREQ == 0) $('#chkRow_'+j).prop('disabled', true);
												}
											}
										}
									}
							...
							"columnDefs": [	{ targets: [0,1], className: 'dt-body-center' },
											{ targets: [3,4,5,6,8], className: 'dt-body-right' },
											{ targets: [1,7,9], visible: false},
											{ targets: [4,5], 
							...
							"footerCallback": function (row, data, start, end, display) {
								...
								// console.log("PO_REQVOLM = "+$('#PO_REQVOLM1').val());
								const totRow = $('#totalrow').val();
								// alert(totRow)
								var TPO_REMREQVOLM = 0;
								if(task == 'add')
								{
									if(totRow > 0)
									{
										for(var i=1; i<=totRow;i++) {
											var PO_VOLM_DT	= parseFloat($('#data'+i+'PO_VOLM').val());
											TPO_REMREQVOLM 	= parseFloat(TPO_REMREQVOLM + PO_VOLM_DT);
										}
										// alert(TPO_REMREQVOLM)
									}
								}
								
								var totalREMORDERVOL1 = parseFloat(totalREMORDERVOL + TPO_REMREQVOLM);
								var totalREMORDERVOLV = doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(totalREMORDERVOL1)), 2));
								// Update footer
								$(api.column(6).footer()).html('<div style="font-weight: bold;">'+totalREMORDERVOLV+'</div>');
								...
								var totalITM_REMVOL1 = parseFloat(totalITM_REMVOL - TPO_REMREQVOLM);
								var totalITM_REMVOLV = doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(totalITM_REMVOL1)), 2));

								// Update footer
								$(api.column(8).footer()).html('<div style="font-weight: bold;">'+totalITM_REMVOLV+'</div>');
							}
						});
...
<script>
	...
	function add_item(strItem) 
	{
		...
		/* Validate double ITM_CODE, JOBCODEID, PR_DESC_ID => hold: 2022-10-19
			if(totRow > 0)
			{
				for(let i=1; i<=totRow; i++) {
					...
					// alert(ITM_CODE_DET+'='+arrItem[2]+' - '+JOBCODEID_DET+'='+arrItem[5]+''+PR_DESC_ID_DET+'='+arrItem[21]);
					if(ITM_CODE_DET == arrItem[2] && JOBCODEID_DET == arrItem[5] && PR_DESC_ID_DET == arrItem[21])
					{
						swal(arrItem[22]+" dengan kode pekerjaan "+arrItem[5]+" sudah ditambahkan.", { icon:"warning" });
						return false;
					}
				}
			}
		...
		objTD.innerHTML = '<div class="input-group">'+
								...
								'</div>'+
								'<input type="hidden" name="data['+intIndex+'][PR_DESC_ID]" id="data'+intIndex+'PR_DESC_ID" size="20" value="'+PR_DESC_ID+'" class="form-control">'+
								'<input type="hidden" name="data['+intIndex+'][PO_DESC_ID]" id="data'+intIndex+'PO_DESC_ID" size="20" value="'+PR_DESC_ID+'" class="form-control" style="min-width:110px; max-width:500px; text-align:left" data-toggle="modal" data-target="#mdl_addCMN">'+
