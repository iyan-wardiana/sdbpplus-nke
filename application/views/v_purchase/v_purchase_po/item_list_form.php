...
if($task == 'add')
{
	...
	$myCount = $this->db->count_all('tbl_item');
	
	$sql = "SELECT MAX(LASTNO) as maxNumber FROM tbl_item WHERE PRJCODE = '$PRJCODE' AND ITM_CATEG = '$ITM_CATEG'";
            ...
            <div class="box box-primary">
                ...
                <div class="box-body chart-responsive">
                	...
                	<form class="form-horizontal" name="frm" id="frm" method="post" action="<?php echo $form_action; ?>" onSubmit="return saveRecomend()">
                        ...
                        <div class="form-group">
                          	<label for="inputName" class="col-sm-2 control-label">Item Code</label>
                          	<div class="col-sm-10">
                            	<input type="hidden" class="textbox" name="ITM_TYPE" id="ITM_TYPE" size="5" value="<?php echo $ITM_TYPE; ?>" />
                                <input type="text" class="form-control" style="max-width:90px" name="ITM_CODE" id="ITM_CODE" value="<?php echo $ITM_CODE; ?>" />
                        ...
                        <div class="form-group">
                          	...
                          	<div class="col-sm-10">
                                <input type="text" class="form-control" style="max-width:200px" name="ITM_NAME" id="ITM_NAME" value="<?php echo $ITM_NAME;?>" title="Input Item Name" />
                          	</div>
                        </div>
                        <div class="form-group">
                          	<label for="inputName" class="col-sm-2 control-label">Description</label>
                          	<div class="col-sm-10">
                                <textarea class="form-control" name="ITM_DESC"  id="ITM_DESC" style="max-width:300px;height:70px"><?php echo $ITM_DESC; ?></textarea>
                          	</div>

                        </div>
                        <div class="form-group">
                          	<label for="inputName" class="col-sm-2 control-label">Deafult Currency</label>
                          	<div class="col-sm-10">
                    			<input type="text" class="form-control" style="max-width:70px" name="ITM_CURRENCY" id="ITM_CURRENCY" value="<?php echo $ITM_CURRENCY; ?>" title="<?php echo $ITM_CURRENCY; ?>" />
                          	</div>
                        </div>
                        <div class="form-group">
                          	<label for="inputName" class="col-sm-2 control-label">Primary Unit</label>
                          	<div class="col-sm-10">
                            	<select name="ITM_UNIT" id="ITM_UNIT" class="form-control" style="max-width:100px" onChange="checkUnit(this.value)">
                                    <option value="0">None</option>
                                    <?php echo $i = 0;
                                    if($recordcountUnit > 0)
                                    {
