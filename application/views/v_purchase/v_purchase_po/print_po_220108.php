            	...
            	<td>
            		<table border="1" width="100%">
			            ...
			            <?php
						    ...
						    $GTOTAL 	= $TOT_COST;
						    $GTOTALP 	= $TOT_COST;
						    if($GTOTALP == 0 || $GTOTALP == '')
						    	$GTOTALP= 1;

						    $DISCP 		= round($TOTDISC / $GTOTALP * 100, 2);
						    $remRow 	= $max - $curRow;
						    $nxtRow		= $curRow;
			            	for($i=1;$i<=$remRow;$i++)
			            	{
            			...
            			<tr>
			                ...
			                <td style="vertical-align: middle; text-align: right; font-weight: bold;"><?=number_format($DISCP,2)?>&nbsp;&nbsp;</td>
			            </tr>
            			<tr>
