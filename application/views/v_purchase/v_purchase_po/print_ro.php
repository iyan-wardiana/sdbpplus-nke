    ...
    <section class="invoice">
            ...
            <div class="col-xs-12 table-responsive">
                <table width="100%" border="1">
                    <tr style="background-color:#999">
                        <th style="text-align:center; background-color:#999; font-weight:bold">RENTAL ORDER ( RO )</th>
                    </tr>
                </table>
            </div>
        </div>
            	...
            	<table width="100%" border="1" style="background-color:#999">
                    <tr>
                      <td>
                      	<table width="100%">
                          <tr>
                            <th width="23%" style="background-color:#999; text-align:left">No. RO</th>
                    ...
                    <tr>
                      <td>
                          ...
                          <tr>
						   ...
						   ?>
                           <tr>
                           	<td nowrap>Cara Pembayaran</td>
                            <td>:</td>
                            <td><?php echo $descPay; ?></td>
                           </tr>
                           <tr>
                           	<td>&nbsp;</td>
                            <td>&nbsp;</td>
                    ...
                    <tr>
                      <td>
                          ...
                          <tr>
                            ...
                            <td width="1%">:</td>
                            <td width="76%"><?php echo $SPLADD1; ?></td>
                           </tr>
                           <tr>
        ...
        <div class="row">
            <div class="col-xs-12 table-responsive">
                <table width="100%" border="1">
                    <tr style="background-color:#999">
                        <th style="text-align:left; background-color:#999; font-weight:bold">Dengan diterimanya RO ini, <br>supplier setuju dan sanggup untuk menyediakan barang seluruhnya sesuai quantity dan quality yang sudah disepakati.</th>
                    </tr>
                </table>
            </div>
        </div>
                ...
                <table width="100%" border="1" cellpadding="0.5">
                    <thead>
                        <tr style="background-color:#999">
                            ...
                            <th width="35%" rowspan="2" style="background-color:#999; text-align:center">Nama Alat</th>
                    ...
                    <?php
						$sqlPODET	= "SELECT A.PO_NUM, A.PO_CODE, A.PO_DATE, A.PRJCODE, A.PR_NUM, A.JOBCODEDET, A.JOBCODEID, A.ITM_CODE, 
										...
										A.PO_PRICE AS PR_PRICE, A.PO_PRICE AS ITM_PRICE, A.PO_DISP, A.PO_DISC, A.PO_COST,
										A.PO_DESC, A.PO_DESC1,
		...
		<div class="row">
            <div class="col-xs-12 table-responsive">
                <table width="100%" border="1">
                    ...
                    <?php						
						$terbilang = $moneyFormat->terbilang($TOTPRICE3);						
					?>
                    <tr>
                        <td rowspan="4" style="font-style:italic; font-weight:bold"><?php echo $terbilang; ?> Rupiah</td>
            ...
            <div class="col-xs-12 table-responsive">
                <table width="100%" border="1">
                    ...
                    <tr>
                    	<td>
                        <ol type="1">
                        	<li>Mohon Rental Order (RO) Yang sudah diterima ditandatangani, distempel dan di e-mail kembali ke
suhendar@megasukma.com atau di Fax : +6222 8680 0620</li>
                            <li>Tagihan uang muka harus melampirkan <b><font color="#FF0000">Kwitansi Bermaterai</font></b>, <b><b>Invoice, Faktur Pajak Asli dan Surat Konfirmasi Mobilisasi yang telah disetujui</b></li>
                            <li><font color="#FF0000">Setiap Tagihan</font> harus melampirkan <b><font color="#FF0000">Kuitansi Bermeterai</font>, Invoice, Faktur Pajak Asli dan Time Sheet</b> yang sudah di verifikasi oleh PT. Mega Sukma termasuk <b>Berita Acara Sewa Alat</b></li>
							<li>Tanpa faktur pajak hanya akan dibayarkan harga pokoknya saja tanpa Pajak Pertambahan Nilai (PPN)</li>
                            <li>Pengiriman alat berat harus melampirkan surat jalan yang mencantumkan Nomor <b>Rental Order ( RO )</b></li>
                            <li>Invoice penagihan harus mencantumkan Nomor <b>Rental Order ( RO )</b> yang sudah diterbitkan.</li>
							<li>Setiap alat berat yang dirental harus memiliki <b>Surat Izin Laik Operasi</b></li>
                            <li>Setiap operator alat berat harus memiliki <b><font color="#FF0000">Surat Izin Operator</font></b> alat berat <b>( SIO )</b></li>
                            <li>Bersedia dipotong Pajak Penghasilan (PPh) sewa alat</li>
                        </ol>
                        </td>
                    </tr>
            	</table>
        ...
        <div class="row">
            ...
            <div class="col-xs-10 table-responsive">
            	<table width="100%" border="1">
                    ...
                    <tr>
                    	<td style="text-align:center"><b>Suhendar Priatna</b></td>
                        <td style="text-align:center"><b>Johana Runtukahu</b></td>
                        <td style="text-align:center"><b>Dedy Sutjipto</b></td>
                    </tr>
                    <tr>
                    	<td style="text-align:center">Procurement</td>
                        <td style="text-align:center">Cost Control</td>
                        <td style="text-align:center">Direktur Operasional</td>
                    </tr>
                </table>
            </div>
