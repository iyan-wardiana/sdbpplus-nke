						...
						$('#chgVolPO').bind('blur', function(){
								...
								for(let i=1; i<=jmlItmCUR; i++) {
									...
									if(PO_REMVOLM > 0)
									{
										...
										if(POVOL_REQVOL > PO_REMVOLM)
										{
											...
											{
												let rowB 			= i - 1;
												let PO_REMVOLMB 	= parseFloat(document.getElementById('PO_REMVOLM'+rowB).value);
												POVOL_REQVOL 		= POVOL_REQVOL - PO_REMVOLMB;
							...
							else
							{
								...
								{ 
									...
									$('#chgVolPO').val(doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(0)), decFormat)));
									$('#chgVolPO').prop('disabled', false);
								});
								return false;
							}
	...
	function add_item(strItem) 
	{
		...
		if(totRow > 0)
		{
			for(let i=1; i<=totRow; i++) {
				...
				if(ITM_CODE_DET == arrItem[2] && JOBCODEID_DET == arrItem[5] && PO_DESC_ID_DET == arrItem[21])
				{
