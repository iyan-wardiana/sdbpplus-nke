						...
						<div class="col-md-6">
							<div class="box box-primary">
								...
								<div class="box-body">
			                        ...
			                        <div class="form-group">
			                          	<label for="inputName" class="col-sm-3 control-label"><?php echo $RequestCode ?> </label>
			                          	<div class="col-sm-9">
			                        ...
			                        <div class="form-group">
			                       	  <label for="inputName" class="col-sm-3 control-label"><?php echo $PaymentType ?> </label>
			                          	<div class="col-sm-9">
			                          		<div class="row">
			                                	<div class="col-xs-4">
			                                		<select name="PO_PAYTYPE" id="PO_PAYTYPE" class="form-control" onChange="selPO_PAYTYPE(this)" readonly>
			                                	...
			                                	<div class="col-xs-6">
			                                		<div class="col-sm-9">
						                                <select name="PO_TENOR" id="PO_TENOR" class="form-control" onChange="selPO_TENOR(this)" readonly>
                                ...
                                <table width="100%" border="1" id="tbl">
                                    <tr style="background:#CCCCCC">
                                        ...
                                        <th width="5%" style="text-align:center" nowrap><?php echo $Unit; ?> </th>
                                      	...
                                      	(%)</th>
                                      	<th width="7%" style="text-align:center" nowrap><?php echo $Discount; ?> </th>
                                      	<th width="7%" style="text-align:center" nowrap><?php echo $Tax; ?></th>
                                      	<th width="7%" style="text-align:center" nowrap><?php echo $TotalPrice; ?></th>
                                 	</tr>
                                    <?php
                                        $resultC	= 0;
                                        if($task == 'add' && $PR_NUMX != '')
                                        {
                                            $sqlDETPR	= "SELECT A.PR_NUM, A.JOBCODEDET, A.JOBCODEID, A.ITM_CODE, A.SNCODE, 
                                                                ...
                                                                A.TAXCODE2, A.TAXPRICE1, A.TAXPRICE2, A.PR_ID AS PRD_ID,
                                                                B.ITM_NAME
                                        ...
                                        if($resultC > 0)
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td width="7%" style="text-align:center;" nowrap>
                                                    <?php
                                                    	if ($TAXCODE1 == "TAX01") { echo "PPn 10%"; } else { echo "-"; }
                                                    ?>
                                                    <input style="text-align:right" type="hidden" name="data[<?php echo $currentRow; ?>][TAXCODE1]" id="data<?php echo $currentRow; ?>TAXCODE1" value="<?php echo $TAXCODE1; ?>">
                                                      	<select name="<?php echo $currentRow; ?>TAXCODE1" class="form-control" id="<?php echo $currentRow; ?>TAXCODE1"  onChange="getValuePO(this, <?php echo $currentRow; ?>);" style="min-width:100px; max-width:150px; display: none;" disabled>
                                                        <option value="0"> --- </option>
                                                        <?php
