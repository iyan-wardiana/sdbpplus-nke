...
<html>
	...
	<?php
		...
		if($LangID == 'IND')
		{
			...
			//Update [iyan]
			$alert3		= "Silahkan pilih salah satu item upah angkut yang akan diminta";
		}
		else
		{
			...
			$alert3		= "Please select an item of transportation wages that will be requested";
		}
...
<script>
	...
	function add_itemU(strItem) //ADD Upah Angkut
	{
		...
		//alert(arrItem);
		var objTable, objTR, objTD, intIndex, arrItem;
		var totrowPR 	= document.getElementById('totalrow').value;
		//alert(totrowPR);
		var PO_NUM 		= "<?php echo $DocNumber; ?>";
		var PO_CODE 	= "<?php echo $PO_CODE; ?>";
		var PRJCODE 	= "<?php echo $PRJCODE; ?>";
		...
		objTD.innerHTML = '<a href="#" onClick="deleteRow('+intIndex+')" title="Delete Document" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i></a><input type="Checkbox" id="data['+intIndex+'][chk]" name="data['+intIndex+'][chk]" value="'+intIndex+'" onclick="pickThis(this,'+intIndex+')" style="display:none"><input type="Checkbox" style="display:none" id="chk'+intIndex+'" name="chk'+intIndex+'" value="" ><input type="hidden" id="chk" name="chk" value="'+intIndex+'" width="10" size="15" readonly class="form-control" style="max-width:300px;"><input type="hidden" id="data'+intIndex+'PO_NUM" name="data['+intIndex+'][PO_NUM]" value="'+PO_NUM+'" width="10" size="15"><input type="hidden" id="data'+intIndex+'PO_CODE" name="data['+intIndex+'][PO_CODE]" value="'+PO_CODE+'" width="10" size="15"><input type="hidden" id="data'+intIndex+'PRJCODE" name="data['+intIndex+'][PRJCODE]" value="'+PRJCODE+'" width="10" size="15"><input type="hidden" id="data'+intIndex+'PR_NUM" name="data['+intIndex+'][PR_NUM]" value="'+PR_NUMX+'" width="10" size="15"><input type="hidden" name="totalrow" id="totalrow" value="'+intIndex+'">';

		// ITM_CODE [1]
		objTD = objTR.insertCell(objTR.cells.length);
		objTD.align = 'left';
		objTD.innerHTML = ''+ITM_CODE+' : '+JOBDESC+'<input type="hidden" id="data'+intIndex+'JOBCODEDET" name="data['+intIndex+'][JOBCODEDET]" value="'+JOBCODEDET+'" width="10" size="15"><input type="hidden" id="data'+intIndex+'JOBCODEID" name="data['+intIndex+'][JOBCODEID]" value="'+JOBCODEID+'" width="10" size="15"><input type="hidden" id="data'+intIndex+'JOBPARENT" name="data['+intIndex+'][JOBPARENT]" value="'+JOBPARENT+'" width="10" size="15"><input type="hidden" id="data'+intIndex+'JOBPARDESC" name="data['+intIndex+'][JOBPARDESC]" value="'+JOBDESC+'" width="10" size="15"><input type="hidden" id="data'+intIndex+'ITM_CODE" name="data['+intIndex+'][ITM_CODE]" value="'+ITM_CODE+'" width="10" size="15"><input type="hidden" name="ITM_CATEG'+intIndex+'" id="ITM_CATEG'+intIndex+'" value="'+ITM_CATEG+'">';
