 ...
 * File Name	= v_inb_po4lt_form.php
 * Location		= -
*/
                                    ...
                                    <?php
                                        ...
                                        if($task == 'add' && $PR_NUMX != '')
                                        {
                                            $sqlDETPR	= "SELECT A.PR_NUM, A.JOBCODEDET, A.JOBCODEID, A.ITM_CODE, A.SNCODE, 
                                                                A.ITM_UNIT, A.ITM_UNIT2, A.PR_VOLM,
                                                                A.PO_VOLM, A.IR_VOLM, A.IR_AMOUNT, 0 AS PO_DISP, 0 AS PO_DISC, 
                                                                A.PO_VOLM AS ORDERED_QTY, 
                                                                A.PR_PRICE AS ITM_PRICE, 0 AS A.PO_OA, A.PR_PRICE AS PO_PRICE, A.PR_TOTAL,
                                        ...
                                        else
                                        {
                                            if($task == 'edit')
                                            {
                                                $sqlDET		= "SELECT A.PO_NUM, A.PO_DATE, A.PR_NUM, A.JOBCODEDET, A.JOBCODEID, 
                                                                    A.ITM_CODE, B.ITM_NAME, A.ITM_UNIT, A.ITM_UNIT2, 
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align:left; vertical-align: middle;">
		                                        	...
		                                        	<div style="font-style: italic;">
												  		<i class='text-muted fa fa-chevron-circle-right'></i>&nbsp;&nbsp;<?php echo "$JOBDESC ($JOBCODEID)"; ?>
												  	</div></td>
                                                ...
                                                <td style="text-align:center; vertical-align: middle;">
                                                    <?php print $ITM_UNIT2; ?>  
                                                     ...
                                                     <input type="hidden" id="data<?php echo $currentRow; ?>ITM_UNIT2" name="data[<?php echo $currentRow; ?>][ITM_UNIT2]" value="<?php print $ITM_UNIT2; ?>">
                                                 </td>
                                                <?php
                                                    /* Perhitungan ........
                                                ...
                                                <td style="text-align:right; vertical-align: middle;">
                                                    ...
                                                    <input type="hidden" class="form-control" style="text-align:right; min-width:100px" name="PO_OAx<?php echo $currentRow; ?>" id="PO_OAx<?php echo $currentRow; ?>" size="10" value="<?php echo number_format($PO_OA, $decFormat); ?>" onKeyPress="return isIntOnlyNew(event);" onBlur="getValuePO(this, <?php echo $currentRow; ?>);" disabled>
                                                    <input style="text-align:right" type="hidden" name="data[<?php echo $currentRow; ?>][PO_OA]" id="data<?php echo $currentRow; ?>PO_OA" size="6" value="<?php echo $PO_OA; ?>"></td>
	                    ...
	                    <div class="form-group">
                            ...
                            <div class="col-sm-9">
                            	<?php
									...
									$backURL	= site_url('c_purchase/c_p180c21o/iN20_x14lt/?id='.$this->url_encryption_helper->encode_url($PRJCODE));
