				...
				<script type="text/javascript">
					...
					$(document).ready(function()
					{
						...
						$('#example4').DataTable(
						{
							...
							"filter": true,
							"ajax": {
								"url": "<?php echo site_url('c_purchase/c_p180c21o/get_AllDataIITMREQDET/?id='.$PRJCODE.'&PR_NUM='.$PR_NUMX.'&task='.$task)?>",
								"type": "POST",
								"data": function(data) {
						...
						$('div.toolbar').html('<form id="form-filter" class="form-horizontal">'+
							  ...
							  '<option value=""></option></select>&nbsp;'+
							  '<input type="text" class="form-control" id="chgVolPO" name="chgVolPO" value="" placeholder="Total Volume" onKeyPress="return isIntOnlyNew(event);" style="max-width: 120px">'+
							  '</form>');
