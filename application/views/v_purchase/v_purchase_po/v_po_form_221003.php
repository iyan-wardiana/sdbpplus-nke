						...
						<div class="box box-warning">
							...
							<div class="box-body">
								<div class="form-group">
									...
									<div class="col-sm-4">
										<input type="text" class="form-control" name="PO_TAXAMN1" id="PO_TAXAMN1" value="<?php echo number_format($PO_TAXAMN, 2); ?>" readonly/>
										<input type="hidden" class="form-control" name="PO_TAXAMN" id="PO_TAXAMN" value="<?php echo $PO_TAXAMN; ?>" />
									</div>
								</div>
		                        <div class="form-group">
...
<script>
	...
	function recalculatePO_221003(row) // HOLD
	{
		var decFormat		= document.getElementById('decFormat').value;
		...
		var thisValPRC	= document.getElementById('PO_PRICEX'+row);
		var thisValDISC	= document.getElementById('PO_DISC'+row);
		var TAXCODE1	= document.getElementById('data'+row+'TAXCODE1').value;
		...
		$.ajax({
			...
			success: function(result) {
				...
				for(let i = 1; i <= totalrow; i++) {
					...
					let PO_VOLMX = document.getElementById('data'+i+'PO_VOLM').value;
