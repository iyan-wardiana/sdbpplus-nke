        ...
        <table id="example1" class="table table-bordered table-striped table-responsive search-table inner" width="100%">
            <thead>
                <tr>
                    ...
                    <th width="12%" style="vertical-align:middle; text-align:center" nowrap><?php echo $ReceiptNumber; ?></th>
                    <th width="13%" style="vertical-align:middle; text-align:center"><?php echo $ReceiptDate; ?></th>
            ...
            <?php
                ...
                if($countAllIR > 0)
                {
                    ...
                    foreach($viewAllIR as $row) :
                        ...
                        ?>
                        <td style="text-align:center"><input type="checkbox" name="chk" value="<?php echo $IR_NUM;?>|<?php echo $IR_DATEV;?>|<?php echo $IR_DUEDATEV;?>|<?php echo $IR_AMOUNT;?>" onClick="pickThis(this);" /></td>
                        <td nowrap>
                        ...
                        <td style="text-align:center"><?php echo $IR_DUEDATE; ?></td>
                        <td><?php echo $IR_NOTE; ?></td>
                        <td><?php echo number_format($IR_AMOUNT, $decFormat); ?></td>
                        </tr>
                    <?php
                    endforeach;
                }
...
function get_ir() 
	{
		if(typeof(document.frmSearch.chk[0]) == 'object') 
		{
			for(i=0;i<document.frmSearch.chk.length;i++) 
			{
				if(document.frmSearch.chk[i].checked) 
				{
					...
					window.opener.addHeader(document.frmSearch.chk[i].value);				
				}
			}
		}
		else
		{
			...
			{
				window.opener.addHeader(document.frmSearch.chk.value);
