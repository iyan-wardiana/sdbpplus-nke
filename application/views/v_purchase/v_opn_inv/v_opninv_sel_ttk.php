        ...
        <table id="example1" class="table table-bordered table-striped table-responsive search-table inner" width="100%">
            <thead>
                <tr>
                    ...
                    <th width="12%" style="vertical-align:middle; text-align:center" nowrap><?php echo $TTKNumber; ?></th>
            ...
            <?php
                ...
                if($countAllTTK > 0)
                {
                    ...
                    foreach($viewAllTTK as $row) :
                        ...
                        $SPLDESC		= $row->SPLDESC;
                        $compName 		= "";
						$TTK_AMOUNT		= $TTK_AMOUNT1 + $TTK_AMOUNT_PPN;
                        ...
                        <td style="text-align:center"><?php echo $TTK_DATE; ?></td>
                        <td style="text-align:center"><?php echo $TTK_DUEDATE; ?></td>
                        <td><?php echo $TTK_NOTES; ?></td>
                        <td style="text-align:right"><?php echo number_format($TTK_AMOUNT, $decFormat); ?></td>
                        </tr>
                    <?php
                    endforeach;
                }
