                    ...
                    <form class="form-horizontal" name="frm" id="frm" method="post" action="<?php echo $form_action; ?>" onSubmit="return checkInp()">
                        ...
                        <div class="form-group">
                          	...
                          	<div class="col-sm-10">
                            	...
                            	<input type="text" class="form-control" style="max-width:150px;"  name="HTU_CODE" id="HTU_CODE" value="<?php echo $HTU_CODE; ?>" disabled>
                          	</div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                              ...
                              <!--<textarea name="HTU_PROCEDURE" class="form-control" style="max-width:500px; max-height:500px;" id="HTU_PROCEDURE" cols="50"><?php //echo $HTU_PROCEDURE ?></textarea>-->
                          	  <textarea name="HTU_PROCEDURE" id="compose-textarea" class="form-control" style="height: 300px; width:700px">
