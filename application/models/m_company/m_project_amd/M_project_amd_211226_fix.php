...
class M_project_amd extends CI_Model
{
		...
		elseif($AMD_CLASS == 1) // VOLUME IS DISABLED. PRICE ONLY. SO NOT AMOUNT UPDATE
		{
			...
			// UPDATE JOBLIST
				$s_u1		= "UPDATE tbl_joblist_detail SET ITM_PRICE = $ADD_PRICE, ITM_LASTP = $ADD_PRICE, ADD_PRICE = $ADD_PRICE,
									ADD_JOBCOST = $DELTA_BUDG, ITM_BUDG = $ITM_BUDGB
								WHERE JOBCODEID = '$JOBCODEID' AND PRJCODE = '$PRJCODE' AND ITM_CODE = '$ITM_CODE'";
				$this->db->query($s_u1);
				echo "DONE 1<br>";
				$s_P2 		= "SELECT JOBPARENT FROM tbl_joblist_detail WHERE JOBCODEID = '$JOBCODEID' LIMIT 1";
				...
				foreach($r_P2 as $rw_P2) :
					...
					$s_u2a	= "UPDATE tbl_joblist SET PRICE = $ADD_PRICE, ADD_PRICE = $ADD_PRICE, JOBCOST = JOBCOST + $DELTA_BUDG,
									ADD_JOBCOST = ADD_JOBCOST + $DELTA_BUDG
								WHERE JOBCODEID = '$JP2' AND PRJCODE = '$PRJCODE'";
					$this->db->query($s_u2a);
		...
		elseif($AMD_CLASS == 2) // PRICE IS DISABLED. QTY ONLY
		{
			...
			// TIDAK MERUBAH HARGA
				...
				foreach($resJL as $rowJL):
					...
					$ITM_BUDGA	= $rowJL->ITM_BUDG;
				endforeach;
				$ITM_BUDGB	= $ADD_VOLM * $ITM_PRICE;
				echo "ITM_BUDGB = $ITM_BUDGB<br>";
			
			// UPDATE JOBLIST
				$s_u1		= "UPDATE tbl_joblist_detail SET ADD_VOLM = ADD_VOLM + $ADD_VOLM, ADD_JOBCOST = $ITM_BUDGB,
				...
				foreach($r_P2 as $rw_P2) :
					$JP2 	= $rw_P2->JOBPARENT;
					$s_u2a	= "UPDATE tbl_joblist SET JOBCOST = JOBCOST + $ITM_BUDGB, ADD_JOBCOST = ADD_JOBCOST + $ITM_BUDGB
								WHERE JOBCODEID = '$JP2' AND PRJCODE = '$PRJCODE'";
					$this->db->query($s_u2a);

					$s_u2b	= "UPDATE tbl_joblist_detail SET ITM_BUDG = ITM_BUDG + $ITM_BUDGB, ADD_JOBCOST = ADD_JOBCOST + $ITM_BUDGB
								WHERE JOBCODEID = '$JP2' AND PRJCODE = '$PRJCODE'";
					$this->db->query($s_u2b);
					echo "DONE 2<br>";
					$s_P3 		= "SELECT JOBPARENT FROM tbl_joblist WHERE JOBCODEID = '$JP2' LIMIT 1";
					...
					foreach($r_P3 as $rw_P3) :
						$JP3 	= $rw_P3->JOBPARENT;
						$s_u3a	= "UPDATE tbl_joblist SET JOBCOST = JOBCOST + $ITM_BUDGB, ADD_JOBCOST = ADD_JOBCOST + $ITM_BUDGB
									WHERE JOBCODEID = '$JP3' AND PRJCODE = '$PRJCODE'";
						$this->db->query($s_u3a);

						$s_u3b	= "UPDATE tbl_joblist_detail SET ITM_BUDG = ITM_BUDG + $ITM_BUDGB, ADD_JOBCOST = ADD_JOBCOST + $ITM_BUDGB
									WHERE JOBCODEID = '$JP3' AND PRJCODE = '$PRJCODE'";
						$this->db->query($s_u3b);
						echo "DONE 3<br>";
						$s_P4 		= "SELECT JOBPARENT FROM tbl_joblist WHERE JOBCODEID = '$JP3' LIMIT 1";
						...
						foreach($r_P4 as $rw_P4) :
							$JP4 	= $rw_P4->JOBPARENT;
							$s_u4a	= "UPDATE tbl_joblist SET JOBCOST = JOBCOST + $ITM_BUDGB, ADD_JOBCOST = ADD_JOBCOST + $ITM_BUDGB
										WHERE JOBCODEID = '$JP4' AND PRJCODE = '$PRJCODE'";
							$this->db->query($s_u4a);

							$s_u4b	= "UPDATE tbl_joblist_detail SET ITM_BUDG = ITM_BUDG + $ITM_BUDGB, ADD_JOBCOST = ADD_JOBCOST + $ITM_BUDGB
										WHERE JOBCODEID = '$JP4' AND PRJCODE = '$PRJCODE'";
							$this->db->query($s_u4b);
							echo "DONE 4<br>";
							$s_P5 		= "SELECT JOBPARENT FROM tbl_joblist WHERE JOBCODEID = '$JP4' LIMIT 1";
							...
							foreach($r_P5 as $rw_P5) :
								$JP5 	= $rw_P5->JOBPARENT;
								$s_u5a	= "UPDATE tbl_joblist SET JOBCOST = JOBCOST + $ITM_BUDGB, ADD_JOBCOST = ADD_JOBCOST + $ITM_BUDGB
											WHERE JOBCODEID = '$JP5' AND PRJCODE = '$PRJCODE'";
								$this->db->query($s_u5a);

								$s_u5b	= "UPDATE tbl_joblist_detail SET ITM_BUDG = ITM_BUDG + $ITM_BUDGB, ADD_JOBCOST = ADD_JOBCOST + $ITM_BUDGB
											WHERE JOBCODEID = '$JP5' AND PRJCODE = '$PRJCODE'";
								$this->db->query($s_u5b);
								echo "DONE 5<br>";
								$s_P6 		= "SELECT JOBPARENT FROM tbl_joblist WHERE JOBCODEID = '$JP5' LIMIT 1";
								...
								foreach($r_P6 as $rw_P6) :
									$JP6 	= $rw_P6->JOBPARENT;
									$s_u6a	= "UPDATE tbl_joblist SET JOBCOST = JOBCOST + $ITM_BUDGB, ADD_JOBCOST = ADD_JOBCOST + $ITM_BUDGB
												WHERE JOBCODEID = '$JP6' AND PRJCODE = '$PRJCODE'";
									$this->db->query($s_u6a);

									$s_u6b	= "UPDATE tbl_joblist_detail SET ITM_BUDG = ITM_BUDG + $ITM_BUDGB, ADD_JOBCOST = ADD_JOBCOST + $ITM_BUDGB
												WHERE JOBCODEID = '$JP6' AND PRJCODE = '$PRJCODE'";
									$this->db->query($s_u6b);
									echo "DONE 6<br>";
									$s_P7 		= "SELECT JOBPARENT FROM tbl_joblist WHERE JOBCODEID = '$JP6' LIMIT 1";
									...
									foreach($r_P7 as $rw_P7) :
										$JP7 	= $rw_P7->JOBPARENT;
										$s_u7a	= "UPDATE tbl_joblist SET JOBCOST = JOBCOST + $ITM_BUDGB, ADD_JOBCOST = ADD_JOBCOST + $ITM_BUDGB
													WHERE JOBCODEID = '$JP7' AND PRJCODE = '$PRJCODE'";
										$this->db->query($s_u7a);

										$s_u7b	= "UPDATE tbl_joblist_detail SET ITM_BUDG = ITM_BUDG + $ITM_BUDGB, ADD_JOBCOST = ADD_JOBCOST + $ITM_BUDGB
													WHERE JOBCODEID = '$JP7' AND PRJCODE = '$PRJCODE'";
										$this->db->query($s_u7b);
										echo "DONE 7<br>";
										$s_P8 		= "SELECT JOBPARENT FROM tbl_joblist WHERE JOBCODEID = '$JP7' LIMIT 1";
										...
										foreach($r_P8 as $rw_P8) :
											$JP8 	= $rw_P8->JOBPARENT;
											$s_u8a	= "UPDATE tbl_joblist SET JOBCOST = JOBCOST + $ITM_BUDGB, ADD_JOBCOST = ADD_JOBCOST + $ITM_BUDGB
														WHERE JOBCODEID = '$JP8' AND PRJCODE = '$PRJCODE'";
											$this->db->query($s_u8a);

											$s_u8b	= "UPDATE tbl_joblist_detail SET ITM_BUDG = ITM_BUDG + $ITM_BUDGB, ADD_JOBCOST = ADD_JOBCOST + $ITM_BUDGB
														WHERE JOBCODEID = '$JP8' AND PRJCODE = '$PRJCODE'";
											$this->db->query($s_u8b);
											echo "DONE 8<br>";
											$s_P9 		= "SELECT JOBPARENT FROM tbl_joblist WHERE JOBCODEID = '$JP8' LIMIT 1";
											...
											foreach($r_P9 as $rw_P9) :
												$JP9 	= $rw_P9->JOBPARENT;
												$s_u9a	= "UPDATE tbl_joblist SET JOBCOST = JOBCOST + $ITM_BUDGB, ADD_JOBCOST = ADD_JOBCOST + $ITM_BUDGB
															WHERE JOBCODEID = '$JP9' AND PRJCODE = '$PRJCODE'";
												$this->db->query($s_u9a);

												$s_u9b	= "UPDATE tbl_joblist_detail SET ITM_BUDG = ITM_BUDG + $ITM_BUDGB, ADD_JOBCOST = ADD_JOBCOST + $ITM_BUDGB
															WHERE JOBCODEID = '$JP9' AND PRJCODE = '$PRJCODE'";
												$this->db->query($s_u9b);
												echo "DONE 9<br>";
												$s_P10 		= "SELECT JOBPARENT FROM tbl_joblist WHERE JOBCODEID = '$JP9' LIMIT 1";
												...
												foreach($r_P10 as $rw_P10) :
													$JP10 	= $rw_P10->JOBPARENT;
													$s_u10a	= "UPDATE tbl_joblist SET JOBCOST = JOBCOST + $ITM_BUDGB, ADD_JOBCOST = ADD_JOBCOST + $ITM_BUDGB
																WHERE JOBCODEID = '$JP10' AND PRJCODE = '$PRJCODE'";
													$this->db->query($s_u10a);

													$s_u10b	= "UPDATE tbl_joblist_detail SET ITM_BUDG = ITM_BUDG + $ITM_BUDGB, ADD_JOBCOST = ADD_JOBCOST + $ITM_BUDGB
																WHERE JOBCODEID = '$JP10' AND PRJCODE = '$PRJCODE'";
													$this->db->query($s_u10b);
													echo "DONE 10<br>";
												endforeach;
	...
	function get_AllDataJLL($PRJCODE, $search, $length, $start, $order, $dir) // GOOD
	{
		if($length == -1)
		{
			if($order !=null)
			{
				$sql = "SELECT DISTINCT A.JOBCODEID, A.JOBDESC, A.JOBUNIT, A.JOBLEV, A.ISLAST
						FROM tbl_joblist A
						WHERE A.PRJCODE = '$PRJCODE'
