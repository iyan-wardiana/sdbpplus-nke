		...
		if($length == -1)
		{
			if($order !=null)
			{
				$sql = "SELECT DISTINCT A.PR_ID, A.PR_NUM, A.PR_CODE, A.PR_DATE, A.PRJCODE, A.DEPCODE, A.JOBCODEDET, A.JOBCODEID, A.JOBPARENT, A.JOBPARDESC,
							A.ITM_CODE, A.ITM_NAME, A.ITM_UNIT, A.ITM_UNIT2, A.PR_VOLM, A.PR_PRICE, A.PR_TOTAL, A.PR_DESC_ID, A.PR_DESC, A.PO_VOLM, A.ITM_VOLMBG, A.ITM_BUDG, A.PR_STAT,
							A.PR_CVOL
						...
						SELECT DISTINCT B.PR_ID, B.PR_NUM, B.PR_CODE, B.PR_DATE, B.PRJCODE, B.DEPCODE, B.JOBCODEDET, B.JOBCODEID, B.JOBPARENT, B.JOBPARDESC,
							B.ITM_CODE, B.ITM_NAME, B.ITM_UNIT, B.ITM_UNIT2, B.PR_VOLM, B.PR_PRICE, B.PR_TOTAL, B.PR_DESC_ID, B.PR_DESC, B.PO_VOLM, B.ITM_VOLMBG, B.ITM_BUDG, B.PR_STAT,
							B.PR_CVOL
