<?php
	...
	*/
	...
	class M_gej extends CI_Model
	{
		...
		function get_AllDataAC($PRJCODE, $ACCID, $search, $STARTD, $ENDD, $GEJSTAT) // GOOD
		{
		...
		function get_AllDataAL($PRJCODE, $ACCID, $search, $length, $start, $order, $dir, $STARTD, $ENDD, $GEJSTAT) // GOOD
		{
			$PRJCODEVW 		= strtolower(preg_replace("/[^a-zA-Z0-9\s]/", "", $PRJCODE));
			$TBLNMH 	 	= "tbl_journalheader_$PRJCODEVW";
			$TBLNMD 	 	= "tbl_journaldetail_$PRJCODEVW";
