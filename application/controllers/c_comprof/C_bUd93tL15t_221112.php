...
class C_bUd93tL15t extends CI_Controller  
{
  	...
  	function get_AllDataJL() // GOOD
	{
        ...
        $s_RAPSTAT	= "SELECT RAPT_STAT, RAPP_STAT FROM tbl_project WHERE PRJCODE = '$PRJCODE'";
		...
		// START : FOR SERVER-SIDE
			...
			foreach ($query->result_array() as $dataI) 
			{
				...
				if($ISLAST == 0)	// HEADER
				{
					...
					// PENJUMLAHAN ADDENDUM
						$TOT_BUDGAM	= $JOBCOSTDET;
						$TOT_ADDAM	= $ADD_JOBCOST;
						$TOT_USEDAM	= 0;
						$JOBCOST		= $TOT_BUDGAM;
	...
	function updRAPP()
	{
		...
		// START : UPDATE PROCEDURE
			$s_01 		= 	"UPDATE tbl_joblist_detail SET ITM_PRICE = '$RAPP_PRICE', ITM_LASTP = '$RAPP_PRICE', ITM_AVGP = '$RAPP_PRICE', ITM_BUDG = '$ITM_TOTAL',
