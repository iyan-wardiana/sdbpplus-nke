  	...
  	function get_AllDataJLD() // GOOD
	{
		...
		// START : FOR SERVER-SIDE
			...
			foreach ($query->result_array() as $dataI) 
			{
				...
				$JOBCODEID 	= "";
				$s_JID 		= "SELECT JOBCODEID FROM tbl_joblist_detail
				...
				{
					$chkBox	= "<input type='checkbox' name='chk0' value='".$JOBCODEID."|".$JCODEH_0."|".$JDESCH_0."|".$ITM_UNIT."|".$nwJID."' onClick='pickThis0(this);'/>";
					$fntBld = " style='font-weight:bold;'";
				}
