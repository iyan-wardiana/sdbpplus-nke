	...
	function update_process()
	{
		...
		if($genSett == 1)
		{
			$globalsetting = array('Display_Rows' 	=> $this->input->post('Display_Rows'), 
							...
							'ACC_ID_SUPPLY'		=> $this->input->post('ACC_ID_SUPPLY'),
							...
							'ACC_ID_OA'			=> $this->input->post('ACC_ID_OA'),
			...
			if($invMC == 1)
			{
				$globalsetting = array( 'ACC_ID_MCR'	=> $this->input->post('ACC_ID_MCR'),
										...
										'ACC_ID_MCIB'	=> $this->input->post('ACC_ID_MCIB'),
										'ACC_ID_MCKPROG'=> $this->input->post('ACC_ID_MCKPROG'),
