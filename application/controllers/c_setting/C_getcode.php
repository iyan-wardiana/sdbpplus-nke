 ...
 * Create Date	= 29 Januari 2019
 * File Name	= C_getcode.php
 * Location		= -
*/

class C_getcode extends CI_Controller
{
	function genCode() // G
	{
		...
		$year		= date('Y',strtotime($this->input->post('TRXDate')));
		$month 		= (int)date('m',strtotime($this->input->post('TRXDate')));
		$date 		= (int)date('d',strtotime($this->input->post('TRXDate')));
		
		$this->db->where('Patt_Year', $year);
		$myCount = $this->db->count_all($tbl_name);
