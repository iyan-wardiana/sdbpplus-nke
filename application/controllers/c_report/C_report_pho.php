 ...
 * File Name	= c_report_pho.php
 * Location		= -
*/

if ( ! defined('BASEPATH')) exit('No direct script access allowed');
class C_report_pho extends CI_Controller  
{	
    function index()
	{		
		if ($this->session->userdata('login') == TRUE)
		{
			...
			$url			= site_url('c_report/c_report_pho/pho/?id='.$this->url_encryption_helper->encode_url($appName));
			redirect($url);
		}
		else
		{
	...
	function pho() // OK
	{
		...
		if ($this->session->userdata('login') == TRUE)
		{
			...
			$data['form_action'] 	= site_url('c_report/c_report_pho/pho_view/?id='.$this->url_encryption_helper->encode_url($appName));
			
			$this->load->view('v_report/v_pho/v_pho', $data);
		}
		else
		{
			redirect('Auth');
	...
	function pho_view() // OK
	{
		...
		{			
			...
			{
				$this->load->view('v_report/v_pho/v_pho_report_adm', $data);
			}
			else
			{
				$this->load->view('v_report/v_pho/v_pho_report', $data);
			}
		}
		else
		{
