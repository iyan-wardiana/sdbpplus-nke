				...
				foreach ($query->result_array() as $dataI) 
				{
					...
					elseif($UM_STAT == 3)
					{
						$secAction	= 	"<input type='hidden' name='urlPrint".$noU."' id='urlPrint".$noU."' value='".$secPrint."'>
										...
										<a href='javascript:void(null);' class='btn btn-danger btn-xs' onClick='deleteDOC(".$noU.")' disabled>
											<i class='fa fa-trash-o'></i>
										</a>
										</label>";
					}                                      
			...
			// START : FOR SERVER-SIDE
				...
				foreach ($query->result_array() as $dataI) 
				{
					...
					// GET RESERVE ITEM
						...
						$ITM_READY 	= $ITM_VOLM - $ITMRSV - $ITM_USED;
					...
					$output['data'][] 	= array($chkBox,
												"<div style='font-style: italic;'>
											  		<span style='white-space:nowrap'><i class='text-muted'>$ITM_CODE - $ITM_NAME</span>
											  	</div>
											  	<div>
											  		<i class='text-muted fa fa-rss'>&nbsp;&nbsp;$JOBPARENT : $JOBDESC</i>
											  	</div>",
