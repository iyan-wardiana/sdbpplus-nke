		...
		// START : FOR SERVER-SIDE
			...
			{								
				...
				$output['data'][] 	= array("<a href='#' onClick='deleteRow_MAnlDet(".$noU.")' title='Delete Document' class='btn btn-danger btn-xs'><i class='fa fa-trash-o'></i></a>",
											...
											"<input type='text' name='ITM_QTY".$noU."' id='ITM_QTY".$noU."' value='".number_format($ITM_QTY, 3)."' class='form-control' style='max-width:100px; text-align:right' onKeyPress='return isIntOnlyNew(event);' onBlur='chgQty(this,".$noU.");' readonly >
											...
											"<input type='text' name='ITM_KOEF".$noU."' id='ITM_KOEF".$noU."' value='". number_format($ITM_KOEF, 3)."' class='form-control' style='max-width:90px; text-align:right' onKeyPress='return isIntOnlyNew(event);' onBlur='chgKoef(this,".$noU.");' >
