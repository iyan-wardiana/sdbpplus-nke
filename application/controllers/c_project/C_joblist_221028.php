...
class C_joblist extends CI_Controller  
{
					...
					foreach($r_00 as $rw_00) :
						...
						// START : UPDATE ALL HEADER IN HIERARKI
							...
							$s_u1c0	= "UPDATE tbl_joblist_detail A, tbl_joblist B SET A.ITM_VOLM = IF(A.ITM_VOLM = 0, 1, A.ITM_VOLM),
											...
											A.RAPT_VOLM = IF(A.RAPT_VOLM = 0, 1, A.RAPT_VOLM), A.RAPT_JOBCOST = B.JOBCOST, A.RAPT_PRICE = A.ITM_PRICE
										WHERE A.JOBCODEID = B.JOBCODEID AND A.PRJCODE = B.PRJCODE
											AND B.JOBCODEID = '$JOBPARENT' AND B.PRJCODE = '$PRJCODE'";
							$this->db->query($s_u1c0);

							$s_P2 	= "SELECT JOBPARENT FROM tbl_joblist_detail_$PRJCODEVW WHERE JOBCODEID = '$JOBPARENT' LIMIT 1";
							...
							foreach($r_P2 as $rw_P2) :
								...
								$s_P3 	= "SELECT JOBPARENT, JOBCOST FROM tbl_joblist_$PRJCODEVW WHERE JOBCODEID = '$JP2' LIMIT 1";
								...
								foreach($r_P3 as $rw_P3) :
									...
									$s_P4 	= "SELECT JOBPARENT, JOBCOST FROM tbl_joblist_$PRJCODEVW WHERE JOBCODEID = '$JP3' LIMIT 1";
									...
									foreach($r_P4 as $rw_P4) :
										...
										$s_P5 	= "SELECT JOBPARENT, JOBCOST FROM tbl_joblist_$PRJCODEVW WHERE JOBCODEID = '$JP4' LIMIT 1";
										...
										foreach($r_P5 as $rw_P5) :
											...
											$s_P6 	= "SELECT JOBPARENT, JOBCOST FROM tbl_joblist_$PRJCODEVW WHERE JOBCODEID = '$JP5' LIMIT 1";
											...
											foreach($r_P6 as $rw_P6) :
												...
												$s_P7 	= "SELECT JOBPARENT, JOBCOST FROM tbl_joblist_$PRJCODEVW WHERE JOBCODEID = '$JP6' LIMIT 1";
												...
												foreach($r_P7 as $rw_P7) :
													...
													$s_P8 	= "SELECT JOBPARENT, JOBCOST FROM tbl_joblist_$PRJCODEVW WHERE JOBCODEID = '$JP7' LIMIT 1";
													...
													foreach($r_P8 as $rw_P8) :
														...
														$s_P9 	= "SELECT JOBPARENT, JOBCOST FROM tbl_joblist_$PRJCODEVW WHERE JOBCODEID = '$JP8' LIMIT 1";
														...
														foreach($r_P9 as $rw_P9) :
															...
															$s_P10 	= "SELECT JOBPARENT, JOBCOST FROM tbl_joblist_$PRJCODEVW WHERE JOBCODEID = '$JP9' LIMIT 1";
	...
	function undoComp()
	{
		...
		// START : UPDATE PROCEDURE
			$ITM_BUDG = 0;
			$s_00 	= "SELECT ITM_BUDG FROM tbl_joblist_detail_$PRJCODEVW WHERE JOBCODEID = '$JOBCODEID' AND PRJCODE = '$PRJCODE' LIMIT 1";
			$r_00 	= $this->db->query($s_00)->result();
			foreach($r_00 as $rw_00) :
