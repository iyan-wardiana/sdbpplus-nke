...
class C_r3p extends CI_Controller  
{
	...
	function i7MbUdGR3Q_0fv13w() // G
	{
		...
		{			
			...
			if($TransType == 1) $this->load->view('v_project/v_report/v_itembudg_detreq/v_jobbudg_detreqrep', $data);
			else $this->load->view('v_project/v_report/v_itembudg_detreq/v_itembudg_detreqrep', $data);
		}
		else
		{
			redirect('__l1y');
