...
class C_s180d0bpk extends CI_Controller
{
			...
			foreach ($query->result_array() as $dataI)
			{
				...
				if($WO_STAT == 1 || $WO_STAT == 4)
				{
					$secAction	= 	"<input type='hidden' name='urlPrint".$noU."' id='urlPrint".$noU."' value='".$secPrint."'>
									...
									<a href='javascript:void(null);' class='btn btn-".$PRINTCOL." btn-xs' onClick='printD(".$noU.")'>
	...
	function add_process() // OK
	{
		...
		if ($this->session->userdata('login') == TRUE)
		{
			...
			$WO_VALPPHP		= $WO_VALPPH / $WO_VALUEP * 100;
				...
				for($i = 0; $i < $count; $i++) {
					if(!empty($_FILES['userfile']['name'][$i])) {
						...
						if($this->upload->do_upload('userfile'))
						{
							...
							$source		= "assets/AdminLTE-2.0.5/doc_center/uploads/WO_Document/$PRJCODE/$fileName";
							...
							if($srvURL == '10.0.0.144')
							{
								...
								$destination = "/assets/AdminLTE-2.0.5/doc_center/uploads/WO_Document/$PRJCODE/$fileName";
	
								if($this->ftp->list_files("./assets/AdminLTE-2.0.5/doc_center/uploads/WO_Document/$PRJCODE/") == FALSE) 
								{
									$this->ftp->mkdir("./assets/AdminLTE-2.0.5/doc_center/uploads/WO_Document/$PRJCODE/", 0777);
								}
				...
				if($PRJHO == 'KTR')
				{
					...
					foreach($r_DIV as $rw_DIV):
						...
						if($AS_MNCODEA == 'MN437')				// Sekret
							// $AS_MNCODE 	= "MN458";
						{
							if($WO_CATEG == 'U') $AS_MNCODE 	= "MN473";
							elseif($WO_CATEG == 'S') $AS_MNCODE = "MN474";
							elseif($WO_CATEG == 'O') $AS_MNCODE = "MN475";
							elseif($WO_CATEG == 'A') $AS_MNCODE = "MN517";
							elseif($WO_CATEG == 'T') $AS_MNCODE = "MN470";
							// else $AS_MNCODE = "MN354";
						}
						elseif($AS_MNCODEA == 'MN438')			// Audit
							// $AS_MNCODE 	= "MN459";
						{
							if($WO_CATEG == 'U') $AS_MNCODE 	= "MN476";
							elseif($WO_CATEG == 'S') $AS_MNCODE = "MN477";
							elseif($WO_CATEG == 'O') $AS_MNCODE = "MN478";
							elseif($WO_CATEG == 'A') $AS_MNCODE = "MN518";
							elseif($WO_CATEG == 'T') $AS_MNCODE = "MN470";
							// else $AS_MNCODE = "MN354";
						}
						elseif($AS_MNCODEA == 'MN439')			// Corp. L1
							// $AS_MNCODE 	= "MN460";
						{
							if($WO_CATEG == 'U') $AS_MNCODE 	= "MN479";
							elseif($WO_CATEG == 'S') $AS_MNCODE = "MN480";
							elseif($WO_CATEG == 'O') $AS_MNCODE = "MN481";
							elseif($WO_CATEG == 'A') $AS_MNCODE = "MN519";
							elseif($WO_CATEG == 'T') $AS_MNCODE = "MN470";
							// else $AS_MNCODE = "MN354";
						}
						elseif($AS_MNCODEA == 'MN440')			// Corp. L2
							// $AS_MNCODE 	= "MN461";
						{
							if($WO_CATEG == 'U') $AS_MNCODE 	= "MN482";
							elseif($WO_CATEG == 'S') $AS_MNCODE = "MN483";
							elseif($WO_CATEG == 'O') $AS_MNCODE = "MN484";
							elseif($WO_CATEG == 'A') $AS_MNCODE = "MN520";
							elseif($WO_CATEG == 'T') $AS_MNCODE = "MN470";
							// else $AS_MNCODE = "MN354";
						}
						elseif($AS_MNCODEA == 'MN441')			// QHSSE-SI
							// $AS_MNCODE 	= "MN462";
						{
							if($WO_CATEG == 'U') $AS_MNCODE 	= "MN485";
							elseif($WO_CATEG == 'S') $AS_MNCODE = "MN486";
							elseif($WO_CATEG == 'O') $AS_MNCODE = "MN487";
							elseif($WO_CATEG == 'A') $AS_MNCODE = "MN521";
							elseif($WO_CATEG == 'T') $AS_MNCODE = "MN470";
							// else $AS_MNCODE = "MN354";
						}
						elseif($AS_MNCODEA == 'MN442')			// Marketing
							// $AS_MNCODE 	= "MN463";
						{
							if($WO_CATEG == 'U') $AS_MNCODE 	= "MN488";
							elseif($WO_CATEG == 'S') $AS_MNCODE = "MN489";
							elseif($WO_CATEG == 'O') $AS_MNCODE = "MN490";
							elseif($WO_CATEG == 'A') $AS_MNCODE = "MN522";
							elseif($WO_CATEG == 'T') $AS_MNCODE = "MN470";
							// else $AS_MNCODE = "MN354";
						}
						elseif($AS_MNCODEA == 'MN443')			// Operasi
							// $AS_MNCODE 	= "MN464";
						{
							if($WO_CATEG == 'U') $AS_MNCODE 	= "MN491";
							elseif($WO_CATEG == 'S') $AS_MNCODE = "MN492";
							elseif($WO_CATEG == 'O') $AS_MNCODE = "MN493";
							elseif($WO_CATEG == 'A') $AS_MNCODE = "MN523";
							elseif($WO_CATEG == 'T') $AS_MNCODE = "MN470";
							// else $AS_MNCODE = "MN354";
						}
						elseif($AS_MNCODEA == 'MN444')			// Keuangan
							// $AS_MNCODE 	= "MN465";
						{
							if($WO_CATEG == 'U') $AS_MNCODE 	= "MN494";
							elseif($WO_CATEG == 'S') $AS_MNCODE = "MN495";
							elseif($WO_CATEG == 'O') $AS_MNCODE = "MN496";
							elseif($WO_CATEG == 'A') $AS_MNCODE = "MN524";
							elseif($WO_CATEG == 'T') $AS_MNCODE = "MN470";
							// else $AS_MNCODE = "MN354";
						}
						elseif($AS_MNCODEA == 'MN445')			// HRD
							// $AS_MNCODE 	= "MN466";
						{
							if($WO_CATEG == 'U') $AS_MNCODE 	= "MN497";
							elseif($WO_CATEG == 'S') $AS_MNCODE = "MN498";
							elseif($WO_CATEG == 'O') $AS_MNCODE = "MN499";
							elseif($WO_CATEG == 'A') $AS_MNCODE = "MN525";
							elseif($WO_CATEG == 'T') $AS_MNCODE = "MN470";
							// else $AS_MNCODE = "MN354";
						}
						elseif($AS_MNCODEA == 'MN446')			// SPK Anak Usaha
							// $AS_MNCODE 	= "MN467";
						{
							if($WO_CATEG == 'U') $AS_MNCODE 	= "MN500";
							elseif($WO_CATEG == 'S') $AS_MNCODE = "MN501";
							elseif($WO_CATEG == 'O') $AS_MNCODE = "MN502";
							elseif($WO_CATEG == 'A') $AS_MNCODE = "MN526";
							elseif($WO_CATEG == 'T') $AS_MNCODE = "MN470";
							// else $AS_MNCODE = "MN354";
						}
					endforeach;
			...
			if($WO_STAT == 2)
			{
				...
				$s_UPD 		= "UPDATE tbl_wo_header SET WO_CONFIRMER = '$UPD_USR', WO_CONFIRMED = '$UPD_TIME' WHERE WO_NUM = '$WO_NUM' AND PRJCODE = '$PRJCODE'";
				$this->db->query($s_UPD);
			}
			...
			// START : ADD DOC HISTORY
				$this->load->model('m_updash/m_updash', '', TRUE);
				date_default_timezone_set("Asia/Jakarta");
				$paramTrack 	= array('REF_NUM' 		=> $WO_NUM,
										'TBLNAME' 		=> "tbl_wo_header",
										'FLDCODE'		=> "WO_CODE",
										'FLDNAME'		=> "WO_NUM",
										'HISTTYPE'		=> "Penambahan ($WO_STAT)");
	...
	function update_process() // OK
	{
		...
		if ($this->session->userdata('login') == TRUE)
		{
			...
			// END : UPDATE QTY_COLLECTIVE
				...
				$projWOH 		= array('WO_UPDATER'	=> $DefEmp_ID,
										'WO_UPDATED'	=> date('Y-m-d H:i:s'));
				$this->m_spk->update($WO_NUM, $projWOH);
	...
	function trash_WO() // U
	{
		...
		$s_WO		= "SELECT PRJCODE FROM tbl_wo_header WHERE WO_NUM = '$WO_NUM'";
		$r_WO		= $this->db->query($s_WO)->result();
		foreach($r_WO as $rw_WO) :
			$PRJCODE= $rw_WO->PRJCODE;
		endforeach;
 	...
 	function inbox_int() // OK
	{
		...
		$url			= site_url('c_project/c_s180d0bpk/pR7_l5t_5pKx1_int/?id='.$this->url_encryption_helper->encode_url($appName));
		redirect($url);
	}
	...
	function pR7_l5t_5pKx1_int() // G
	{
		...
		if ($this->session->userdata('login') == TRUE)
		{
			...
			$data["MenuCode"] 	= 'MN239';
			$data['viewPRJ'] 	= $this->m_projectlist->get_all_project($DefEmp_ID)->result();
			$data["secURL"] 	= "c_project/c_s180d0bpk/s5pK_1nb_5pKa_int/?id=";
	...
	function s5pK_1nb_5pKa_int() // OK
	{
		...
		if ($this->session->userdata('login') == TRUE)
		{
			...
			$data['title'] 		= $appName;
			$data['backURL'] 	= site_url('c_project/c_s180d0bpk/inbox_int/');
			$data['PRJCODE'] 	= $PRJCODE;
			$data['MenuCode']	= 'MN470';
			...
			$this->load->view('v_project/v_spk/int_spk_inb', $data);
		}
		else
		{
			redirect('__l1y');
  	...
  	function get_AllData_1n2_int() // GOOD
	{
		...
		// START : FOR SERVER-SIDE
			...
			$start			= $_REQUEST['start'];
			$search			= $_REQUEST['search']["value"];
			$num_rows 		= $this->m_spk->get_AllDataC_1n2_int($PRJCODE, $search);
			$total			= $num_rows;
			$output			= array();
			$output['draw']	= $draw;
			$output['recordsTotal'] = $output['recordsFiltered']= $total;
			$output['data']	= array();
			$query 			= $this->m_spk->get_AllDataL_1n2_int($PRJCODE, $search, $length, $start, $order, $dir);
			...
			foreach ($query->result_array() as $dataI)
			{
				...
				$CollID		= "$PRJCODE~$WO_NUM";
				$secUpd		= site_url('c_project/c_s180d0bpk/update_inb_int/?id='.$this->url_encryption_helper->encode_url($CollID));
				$secPrint	= site_url('c_project/c_s180d0bpk/printdocument/?id='.$this->url_encryption_helper->encode_url($WO_NUM));
	...
	function update_inb_int()
	{
		...
		if ($this->session->userdata('login') == TRUE)
		{
			...
			$data['title'] 		= $appName;
			$data['task'] 		= 'edit';
			$data['form_action']= site_url('c_project/c_s180d0bpk/update_process_inb_int');
			...
			$this->load->view('v_project/v_spk/int_spk_inb_form', $data);
		}
		else
		{
			redirect('__l1y');
	...
	function update_process_inb() // OK
	{
		...
		if ($this->session->userdata('login') == TRUE)
		{
			...
			$WO_STAT 		= $this->input->post('WO_STAT');
			$WO_CATEG 		= $this->input->post('WO_CATEG');
			// $WO_NOTE2		= htmlspecialchars($this->input->post('WO_NOTE2'), ENT_QUOTES | ENT_SUBSTITUTE | ENT_HTML401 | ENT_HTML5);
			$WO_NOTE2		= $this->db->escape_str($this->input->post('WO_NOTE2'));
			...
			if($WO_STAT == 3)
			{
				// START : SAVE APPROVE HISTORY
					...
					// $AH_NOTES		= htmlspecialchars($this->input->post('WO_NOTE2'), ENT_QUOTES | ENT_SUBSTITUTE | ENT_HTML401 | ENT_HTML5);
					$AH_NOTES		= $this->db->escape_str($this->input->post('WO_NOTE2'));
			...
			// START : ADD DOC HISTORY
				...
				$paramTrack 	= array('REF_NUM' 		=> $WO_NUM,
										...
										'FLDCODE'		=> "WO_CODE",
										'FLDNAME'		=> "WO_NUM",
										'HISTTYPE'		=> "Update approve ($WO_STAT)");
				$this->m_updash->uDocH($paramTrack);
			// END : ADD DOC HISTORY
			...
			elseif($WO_CATEG == 'T')
				$url	= site_url('c_project/c_s180d0bpk/s5pK_1nb_5pKa_int/?id='.$this->url_encryption_helper->encode_url($PRJCODE));
			else
	...
	function pr1n7d0c_e()
	{
		...
		if ($this->session->userdata('login') == TRUE)
		{
			...
			$data['default']['WO_NOTE2'] 	= $getwodata->WO_NOTE2;
			$data['default']['WO_PAYNOTE'] 	= $getwodata->WO_PAYNOTE;
			$data['default']['isPrint'] 	= $getwodata->isPrint;
			$data['default']['WO_STAT'] 	= $getwodata->WO_STAT;
			$data['default']['WO_VALUE'] 	= $getwodata->WO_VALUE;
			$data['default']['WO_MEMO'] 	= $getwodata->WO_MEMO;
			$data['default']['PRJNAME'] 	= $getwodata->PRJNAME;
			...
			$data['default']['WO_QUOT'] 	= $getwodata->WO_QUOT;
			$data['default']['WO_NEGO'] 	= $getwodata->WO_NEGO;
			$data['default']['WO_STEP_AMD'] = $getwodata->WO_STEP_AMD;
			$data['default']['WO_ENDD_AMD'] = $getwodata->WO_ENDD_AMD;
			$data['default']['Patt_Year'] 	= $getwodata->Patt_Year;
			$data['default']['Patt_Month'] 	= $getwodata->Patt_Month;
			$data['default']['Patt_Date'] 	= $getwodata->Patt_Date;
			$data['default']['Patt_Number']	= $getwodata->Patt_Number;
	...
	function add_req_process() // OK
	{
		...
		if ($this->session->userdata('login') == TRUE)
		{
			...
			$WO_CATEG 		= $this->input->post('WO_CATEG');
			$WO_TYPE 		= $this->input->post('WO_TYPE');
			$WO_NOTE 		= htmlspecialchars($this->input->post('WO_NOTE'), ENT_QUOTES | ENT_SUBSTITUTE | ENT_HTML401 | ENT_HTML5);
			$WO_STAT 		= $this->input->post('WO_STAT');
  	...
  	function get_AllDataM() // GOOD
	{
		...
		// START : FOR SERVER-SIDE
			...
			$start			= $_REQUEST['start'];
			$search			= $_REQUEST['search']["value"];
			$num_rows 		= $this->m_spk->get_AllDataITMMC($PRJCODE, $length, $start);
			$total			= $num_rows;
			$output			= array();
			$output['draw']	= $draw;
			$output['recordsTotal'] = $output['recordsFiltered']= $total;
			...
			foreach ($query->result_array() as $dataI) 
			{
				...
				$sqlJOBDR			= "SELECT PR_VOL, PR_VOL_R, PR_CVOL, PO_VOL, PO_VOL_R, PO_CVOL, PO_VAL, PO_VAL_R, PO_CVAL,
				...
				foreach($resJOBDR as $rowJOBDR) :
					...
					$TREQ_VAL_R		= $PO_VAL_R + $WO_VAL_R;												// VAL REQUEST NEW, CONFIRMED &  WAITING
				...
				$TBUDG_VOL	= $ITM_VOLM + $AMD_VOL - $AMDM_VOL;				// 9
				if($TBUDG_VOL == '')
					$TBUDG_VOL	= 0;

				$TBUDG_VAL	= $ITM_BUDG + $AMD_VAL - $AMDM_VAL;				// 10
				if($TBUDG_VAL == '')
					$TBUDG_VAL	= 0;

				$tempTotMax		= $TBUDG_VOL - $TREQ_VOL - $TREQ_VOL_R;		// 13 			yang status new pun harus sudah terkoreksi
				
				$ITM_REMVOL		= $TBUDG_VOL - $TREQ_VOL - $TREQ_VOL_R;
				$ITM_REMVAL		= $TBUDG_VAL - $TREQ_VAL - $TREQ_VAL_R;
				...
				if($r_isLS > 0)
				{
					...
					$ITM_BUDGVW		= $TBUDG_VAL;
					$ITM_REQVW		= $TREQ_VAL;
					$ITM_USEDVW		= $TUSED_VAL;
					$TREQ_RVW 	= "";
					if($TREQ_VAL_R > 0)
					{
						$TREQ_RVW 	= 	"<div>
												<p class='text-yellow' style='white-space:nowrap'><i class='fa fa-exclamation-triangle'></i>
										  		".number_format($TREQ_VAL_R, 2)."</p>
										  	</div>";
					}
					$TUSED_RVW 	= "";
					if($TUSED_VAL_R > 0)
					{
						$TUSED_RVW 	= 	"<div>
												<p class='text-yellow' style='white-space:nowrap'><i class='fa fa-exclamation-triangle'></i>
										  		".number_format($TUSED_VAL_R, 2)."B</p>
										  	</div>";
					}
					$ITM_REMVW	= $ITM_REMVAL;
				...
				else
				{
					...
					$ITM_BUDGVW		= $TBUDG_VOL;
					$ITM_REQVW		= $TREQ_VOL;
					$ITM_USEDVW		= $TUSED_VOL;
					...
					if($TUSED_VOL_R > 0)
					{
						$TUSED_RVW 	= 	"<div>
												<p class='text-yellow' style='white-space:nowrap'><i class='fa fa-exclamation-triangle'></i>
										  		".number_format($TUSED_VOL_R, 2)."</p>
										  	</div>";
					}
					$ITM_REMVW	= $ITM_REMVOL;
				...
				$JOBPARDESC = "";
				$sqlJDP 	= "SELECT JOBDESC FROM tbl_joblist_detail_$PRJCODEVW WHERE JOBCODEID = '$JOBPARENT' AND PRJCODE = '$PRJCODE' LIMIT 1";
				$resJDP 	= $this->db->query($sqlJDP)->result();
				foreach($resJDP as $rowJDP) :
					$JOBPARDESC = $rowJDP->JOBDESC;
				endforeach;
				...
				$ACC_ID_UM		= "";
				$s_ACCID		= "SELECT ACC_ID_UM FROM tbl_item_$PRJCODEVW WHERE ITM_CODE = '$ITM_CODE' AND PRJCODE = '$PRJCODE' LIMIT 1";
				$r_ACCID		= $this->db->query($s_ACCID)->result();
				foreach($r_ACCID as $rw_ACCID) :
					$ACC_ID_UM	= $rw_ACCID->ACC_ID_UM;
				endforeach;
				...
				if($ACC_ID_UM == '')
				{
					...
					$ACC_IDVw 	= "<input type='hidden' name='urlCopyCOA".$noU."' id='urlCopyCOA".$noU."' value='".$urlCopyCOA."'>
									<div style='font-style: italic; font-size:7pt; color: red;'>NOT SET ACCOUNT</div>
									<a href='javascript:void(null);' title='Silahkan klik untuk copy akun dari proyek lain' onClick='copyCOA(".$noU.")'><i class='fa fa-repeat'></i></a>";
				}
				...
				$RecItemV 		= "<input type='hidden' name='urlRecM".$noU."' id='urlRecM".$noU."' value='".$RecItem."'>
									<a onClick='recountItmM(".$noU.");' title='Hitung ulang permintaan' class='pull-left' style='cursor: pointer'><i class='fa fa-repeat'></i></a>";
				...
				$output['data'][] 	= array($chkBox,
											"<div style='text-align:center;'>".$ACC_IDVw."</span></div>",
											"<div style='white-space:nowrap'>
												".$JobView."
											</div>
  	...
  	function get_AllDataS() // GOOD
	{
		...
		// START : FOR SERVER-SIDE
			...
			$start			= $_REQUEST['start'];
			$search			= $_REQUEST['search']["value"];
			$num_rows 		= $this->m_spk->get_AllDataITMSC($PRJCODE, $length, $start);
			$total			= $num_rows;
			$output			= array();
			$output['draw']	= $draw;
			$output['recordsTotal'] = $output['recordsFiltered']= $total;
			...
			foreach ($query->result_array() as $dataI) 
			{
				...
				$secRecount		= base_url().'index.php/__l1y/recItem/?id=';
				$RecItem 		= "$secRecount~$PRJCODE~$JOBCODEID~$ITM_CODE~$ITM_NAME";
				$RecItemV 		= "<input type='hidden' name='urlRecS".$noU."' id='urlRecS".$noU."' value='".$RecItem."'>
									<a onClick='recountItmS(".$noU.");' title='Hitung ulang permintaan' class='pull-left' style='cursor: pointer'><i class='fa fa-repeat'></i></a>";
  	...
  	function get_AllDataU() // GOOD
	{
		...
		// START : FOR SERVER-SIDE
			...
			$start			= $_REQUEST['start'];
			$search			= $_REQUEST['search']["value"];
			$num_rows 		= $this->m_spk->get_AllDataITMUC($PRJCODE, $length, $start);
			$total			= $num_rows;
			$output			= array();
			$output['draw']	= $draw;
			$output['recordsTotal'] = $output['recordsFiltered']= $total;
	...
	function cancelItem()
	{
		...
		// START : ADD DOC HISTORY
			...
			$paramTrack 	= array('REF_NUM' 		=> $WO_NUM,
									...
									'FLDCODE'		=> "WO_CODE",
									'FLDNAME'		=> "WO_NUM",
									'HISTTYPE'		=> "Cancel item $WO_ID $ITM_CODE $ITM_NAME canceled vol $WO_CVOL");
			$this->m_updash->uDocH($paramTrack);
		// END : ADD DOC HISTORY
	...
	function get_AllDataA() // GOOD
	{
		...
		// START : FOR SERVER-SIDE
			...
			$start			= $_REQUEST['start'];
			$search			= $_REQUEST['search']["value"];
			$num_rows 		= $this->m_spk->get_AllDataITMAC($PRJCODE, $length, $start);
			$total			= $num_rows;
			$output			= array();
			$output['draw']	= $draw;
			$output['recordsTotal'] = $output['recordsFiltered']= $total;
			...
			foreach ($query->result_array() as $dataI) 
			{
				...
				$REM_VW 	= 	"<div><span ".$CELL_COL.">".number_format($ITM_REMVOLVW, 2)." (V)</span></div>
							  	<div><span ".$CELL_COL.">".number_format($ITM_REMVALVW, 2)." (J)</span></div>";

				$ITM_REMVOLVWP 		= $ITM_REMVOLVW;
				if($ITM_REMVOLVW == 0)
					$ITM_REMVOLVWP 	= 1;
				$ITM_PRICE 	= floor($ITM_REMVALVW / $ITM_REMVOLVWP * 100) / 100;
				...
				$secRecount		= base_url().'index.php/__l1y/recItem/?id=';
				$RecItem 		= "$secRecount~$PRJCODE~$JOBCODEID~$ITM_CODE~$ITM_NAME";
				$RecItemV 		= "<input type='hidden' name='urlRecA".$noU."' id='urlRecA".$noU."' value='".$RecItem."'>
									<a onClick='recountItmA(".$noU.");' title='Hitung ulang permintaan' class='pull-left' style='cursor: pointer'><i class='fa fa-repeat'></i></a>";
				...
				$output['data'][] 	= array($chkBox,
											...
											"<div style='text-align:right'><span ".$CELL_COL.">".number_format($ITM_REQVW, 2).$TREQ_RVW."</span></div>",
											"<div style='text-align:right;'><span ".$CELL_COL.">".number_format($ITM_USEDVW, 2).$TUSED_RVW."</span></div>",
											"<div style='text-align:right;'>".$REM_VW."</div>");
											//"<div style='text-align:right;'>".$RecItemV."&nbsp;&nbsp;&nbsp;<span ".$CELL_COL.">".number_format($ITM_REMVW, 2)."</span></div>");
	...
	function get_AllDataO() // GOOD
	{
		...
		// START : FOR SERVER-SIDE
			...
			$start			= $_REQUEST['start'];
			$search			= $_REQUEST['search']["value"];
			$num_rows 		= $this->m_spk->get_AllDataITMOC($PRJCODE, $length, $start);
			$total			= $num_rows;
			$output			= array();
			$output['draw']	= $draw;
			$output['recordsTotal'] = $output['recordsFiltered']= $total;
			...
			foreach ($query->result_array() as $dataI) 
			{
				...
				$secRecount		= base_url().'index.php/__l1y/recItem/?id=';
				$RecItem 		= "$secRecount~$PRJCODE~$JOBCODEID~$ITM_CODE~$ITM_NAME";
				$RecItemV 		= "<input type='hidden' name='urlRecO".$noU."' id='urlRecO".$noU."' value='".$RecItem."'>
									<a onClick='recountItmO(".$noU.");' title='Hitung ulang permintaan' class='pull-left' style='cursor: pointer'><i class='fa fa-repeat'></i></a>";
				...
				$output['data'][] 	= array($chkBox,
											...
											"<div style='text-align:center;'><span ".$CELL_COL.">".$ITM_UNIT."</span></div>",
											"<div style='text-align:right; white-space: nowrap'><span ".$CELL_COL.">".number_format($ITM_BUDG, 2).$ADD_VW.$ADDM_VW."</span></div>",
											"<div style='text-align:right'><span ".$CELL_COL.">".number_format($ITM_REQVW, 2).$TREQ_RVW."</span></div>",
											"<div style='text-align:right;'><span ".$CELL_COL.">".number_format($ITM_USEDVW, 2).$TUSED_RVW."</span></div>",
											"<div style='text-align:right;'>".$RecItemV."&nbsp;&nbsp;&nbsp;<span ".$CELL_COL.">".number_format($ITM_REMVW, 2)."</span></div>");
  	...
  	function get_AllDataFPA() // GOOD
	{
		...
		// START : FOR SERVER-SIDE
			...
			$start			= $_REQUEST['start'];
			$search			= $_REQUEST['search']["value"];
			$num_rows 		= $this->m_spk->get_AllDataFPAC($PRJCODE, $search);
			$total			= $num_rows;
			$output			= array();
			$output['draw']	= $draw;
			$output['recordsTotal'] = $output['recordsFiltered']= $total;
			...
			$query 			= $this->m_spk->get_AllDataFPAL($PRJCODE, $search, $length, $start, $order, $dir);
			...
			foreach ($query->result_array() as $dataI) 
			{
				...
				$chkBox			= "<input type='radio' name='chk0' value='".$PR_NUM."|".$PR_CODE."' onClick='pickThis0(this);' />";
  	...
  	function get_AllDataFPAITM() // GOOD
	{
		//$PRJCODE		= $_GET['id'];
		...
		// START : FOR SERVER-SIDE
			...
			$start			= $_REQUEST['start'];
			$search			= $_REQUEST['search']["value"];
			$num_rows 		= $this->m_spk->get_AllDataITMFPAC($PRJCODE, $FPA_NUM, $length, $start);
			$total			= $num_rows;
			$output			= array();
			$output['draw']	= $draw;
			$output['recordsTotal'] = $output['recordsFiltered']= $total;
			...
			$query 			= $this->m_spk->get_AllDataITMFPAL($PRJCODE, $FPA_NUM, $search, $length, $start, $order, $dir);
 	...
 	function index_int() // OK
	{
		...
		$url			= site_url('c_project/c_s180d0bpk/prj180d0blst_int/?id='.$this->url_encryption_helper->encode_url($appName));
		redirect($url);
	}

	function prj180d0blst_int() // OK
	{
		$this->load->model('m_projectlist/m_projectlist', '', TRUE);
		$this->load->model('m_project/m_spk/m_spk', '', TRUE);
		...
		if ($this->session->userdata('login') == TRUE)
		{
			...
			$data["MenuCode"] 	= 'MN471';
			$data['viewPRJ'] 	= $this->m_projectlist->get_all_project($DefEmp_ID)->result();
			$data["secURL"] 	= "c_project/c_s180d0bpk/gallS180d0bpk_int/?id=";
	...
	function gallS180d0bpk_int() // OK
	{
		...
		if ($this->session->userdata('login') == TRUE)
		{
			// -------------------- START : SEARCHING METHOD --------------------
				...
				$data["url_search"] = site_url('c_project/c_s180d0bpk/f4n7_5rcH5pK_int/?id='.$this->url_encryption_helper->encode_url($PRJCODE));
			...
			$data['title'] 		= $appName;
			$data['addURL'] 	= site_url('c_project/c_s180d0bpk/s180d0bpk_144n3_int/?id='.$this->url_encryption_helper->encode_url($PRJCODE));
			$data['backURL'] 	= site_url('c_project/c_s180d0bpk/index_int/?id='.$this->url_encryption_helper->encode_url($PRJCODE));
			$data['PRJCODE'] 	= $PRJCODE;
			$MenuCode 			= 'MN471';
			$data["MenuCode"] 	= 'MN471';
			...
			$this->load->view('v_project/v_spk/int_spk_list', $data);
		}
		else
		{
			redirect('__l1y');
  	...
  	function get_AllData_int() // GOOD
	{
		...
		// START : FOR SERVER-SIDE
			...
			$start			= $_REQUEST['start'];
			$search			= $_REQUEST['search']["value"];
			$num_rows 		= $this->m_spk->get_AllDataC_int($PRJCODE, $length, $start);
			$total			= $num_rows;
			$output			= array();
			$output['draw']	= $draw;
			$output['recordsTotal'] = $output['recordsFiltered']= $total;
			$output['data']	= array();
			$query 			= $this->m_spk->get_AllDataL_int($PRJCODE, $search, $length, $start, $order, $dir);
			...
			foreach ($query->result_array() as $dataI)
			{
				...
				$CollID		= "$PRJCODE~$WO_NUM";
				$secUpd		= site_url('c_project/c_s180d0bpk/up180d0bdt_int/?id='.$this->url_encryption_helper->encode_url($CollID));
				$secCreate	= site_url('c_project/c_s180d0bpk/cr3473d0c_m4d/?id='.$this->url_encryption_helper->encode_url($WO_NUM));
				// if($WO_CATEG == 'MDR')
				// 	$secPrint	= site_url('c_project/c_s180d0bpk/pr1n7d0c_m4d/?id='.$this->url_encryption_helper->encode_url($WO_NUM));
				// else
  	...
  	function get_AllDataWOGRP_int() // GOOD
	{
		$PRJCODE		= $_GET['id'];
		$SPLCODE		= $_GET['SPLC'];
		$WO_STAT		= $_GET['GSTAT'];
		...
		// START : FOR SERVER-SIDE
			...
			$start			= $_REQUEST['start'];
			$search			= $_REQUEST['search']["value"];
			$num_rows 		= $this->m_spk->get_AllDataGRPC_int($PRJCODE, $SPLCODE, $WO_STAT, $WO_CATEG, $length, $start);
			$total			= $num_rows;
			$output			= array();
			$output['draw']	= $draw;
			$output['recordsTotal'] = $output['recordsFiltered']= $total;
			$output['data']	= array();
			$query 			= $this->m_spk->get_AllDataGRPL_int($PRJCODE, $SPLCODE, $WO_STAT, $WO_CATEG, $search, $length, $start, $order, $dir);
	...
	function s180d0bpk_144n3_int() // OK
	{
		$this->load->model('m_projectlist/m_projectlist', '', TRUE);
		$this->load->model('m_project/m_spk/m_spk', '', TRUE);
		...
		if ($this->session->userdata('login') == TRUE)
		{
			...
			$data['title'] 		= $appName;
			$data['task'] 		= 'add';
			$data['form_action']= site_url('c_project/c_s180d0bpk/add_process_int');
			$data['PRJCODE'] 	= $PRJCODE;
			...
			$this->load->view('v_project/v_spk/int_spk_form', $data);
		}
		else
		{
			redirect('__l1y');
	...
	function add_process_int() // OK
	{
		...
		if ($this->session->userdata('login') == TRUE)
		{
			...
			$url			= site_url('c_project/c_s180d0bpk/gallS180d0bpk_int/?id='.$this->url_encryption_helper->encode_url($PRJCODE));
			redirect($url);
		}
		else
		{
	...
	function up180d0bdt_int() // OK
	{
		...
		if ($this->session->userdata('login') == TRUE)
		{
			...
			$data['title'] 		= $appName;
			$data['task'] 		= 'edit';
			$data['form_action']= site_url('c_project/c_s180d0bpk/update_process_int');
	...
	function update_process_int() // OK
	{
		$this->load->model('m_project/m_spk/m_spk', '', TRUE);
		$sqlApp 		= "SELECT * FROM tappname";
		$resultaApp 	= $this->db->query($sqlApp)->result();
	...
	function watermark_upd()
	{
		...
		$this->db->update("tbl_wo_header", $updW);

		// Insert print History
			date_default_timezone_set("Asia/Jakarta");
			$PDOC_DATE 		= date('Y-m-d H:i:s');
			$inPrintHist 	= ["PDOC_NUM" => $WO_NUM, 
							   "PDOC_CODE" => $WO_CODE, 
							   "PDOC_DATE" => $PDOC_DATE,
							   "isPrint" => $isPrint,
	...
	function get_ITMSRC()
	{
		...
		$data 		= $this->m_spk->getITM_SRC($PRJCODE, $WO_CATEG)->result();
		echo json_encode($data);
	}

	function get_ITMFPASRC()
	{
		$GET 		= $this->input->get();
		$PRJCODE 	= $GET['id'];
		$WO_CATEG 	= $GET['WO_CATEG'];
		$FPA_NUM 	= $GET['FPA_NUM'];

		$data 		= $this->m_spk->getITMFPA_SRC($PRJCODE, $WO_CATEG, $FPA_NUM)->result();
		echo json_encode($data);
	}
}