	...
	function lockComp()
	{
		...
		// UPDATE ALL HEADER IN HIERARKI
			$s_u2a0	= "UPDATE tbl_joblist SET JOBCOST = (SELECT SUM(A.ITM_BUDG) AS TOTDET FROM tbl_joblist_detail A WHERE A.JOBPARENT = '$JOBPARENT'
								AND A.PRJCODE = '$PRJCODE') AS JOBCOSTDET, PRICE = JOBCOST / JOBVOLM
						WHERE JOBCODEID = '$JOBPARENT' AND PRJCODE = '$PRJCODE'";
			//******$this->db->query($s_u2a0);

			$s_u2b0	= "UPDATE tbl_boqlist A, tbl_joblist B SET A.JOBCOST = B.JOBCOST, A.PRICE = A.JOBCOST / A.JOBVOLM
			...
			$s_u2c0	= "UPDATE tbl_joblist_detail A, tbl_joblist B
							SET A.ITM_BUDG = B.JOBCOST, A.ITM_PRICE = A.ITM_BUDG / A.ITM_VOLM, A.ITM_LASTP = A.ITM_BUDG / A.ITM_VOLM,
								A.ITM_AVGP = A.ITM_BUDG / A.ITM_VOLM
						WHERE A.JOBCODEID = B.JOBCODEID AND A.PRJCODE = B.PRJCODE
							AND B.JOBCODEID = '$JOBPARENT' AND B.PRJCODE = '$PRJCODE'";
			...
			foreach($r_P2 as $rw_P2) :
				...
				foreach($r_P3 as $rw_P3) :
					...
					$s_u3b0	= "UPDATE tbl_boqlist A, tbl_joblist B SET A.JOBCOST = B.JOBCOST, A.PRICE = A.JOBCOST / A.JOBVOLM
								WHERE A.JOBCODEID = B.JOBCODEID AND A.PRJCODE = B.PRJCODE
					...
					foreach($r_P4 as $rw_P4) :
						...
						$s_u4b0	= "UPDATE tbl_boqlist A, tbl_joblist B SET A.JOBCOST = B.JOBCOST, A.PRICE = A.JOBCOST / A.JOBVOLM
									WHERE A.JOBCODEID = B.JOBCODEID AND A.PRJCODE = B.PRJCODE
						...
						foreach($r_P5 as $rw_P5) :
							...
							$s_u5b0	= "UPDATE tbl_boqlist A, tbl_joblist B SET A.JOBCOST = B.JOBCOST, A.PRICE = A.JOBCOST / A.JOBVOLM
										WHERE A.JOBCODEID = B.JOBCODEID AND A.PRJCODE = B.PRJCODE
							...
							foreach($r_P6 as $rw_P6) :
								...
								$s_u6b0	= "UPDATE tbl_boqlist A, tbl_joblist B SET A.JOBCOST = B.JOBCOST, A.PRICE = A.JOBCOST / A.JOBVOLM
											WHERE A.JOBCODEID = B.JOBCODEID AND A.PRJCODE = B.PRJCODE
								...
								foreach($r_P7 as $rw_P7) :
									...
									$s_u7b0	= "UPDATE tbl_boqlist A, tbl_joblist B SET A.JOBCOST = B.JOBCOST, A.PRICE = A.JOBCOST / A.JOBVOLM
												WHERE A.JOBCODEID = B.JOBCODEID AND A.PRJCODE = B.PRJCODE
									...
									foreach($r_P8 as $rw_P8) :
										...
										$s_u8b0	= "UPDATE tbl_boqlist A, tbl_joblist B SET A.JOBCOST = B.JOBCOST, A.PRICE = A.JOBCOST / A.JOBVOLM
													WHERE A.JOBCODEID = B.JOBCODEID AND A.PRJCODE = B.PRJCODE
										...
										foreach($r_P9 as $rw_P9) :
											...
											$s_u9b0	= "UPDATE tbl_boqlist A, tbl_joblist B SET A.JOBCOST = B.JOBCOST, A.PRICE = A.JOBCOST / A.JOBVOLM
														WHERE A.JOBCODEID = B.JOBCODEID AND A.PRJCODE = B.PRJCODE
											...
											foreach($r_P10 as $rw_P10) :
												...
												$s_u10a0	= "UPDATE tbl_joblist SET JOBCOST = (SELECT SUM(A.ITM_BUDG) AS TOTDET FROM tbl_joblist_detail A
																WHERE A.JOBPARENT = '$JP10' AND A.PRJCODE = '$PRJCODE') AS JOBCOSTDET, PRICE = JOBCOST / JOBVOLM
															WHERE JOBCODEID = '$JP10' AND PRJCODE = '$PRJCODE'";
												$this->db->query($s_u10a0);

												$s_u10b0	= "UPDATE tbl_boqlist A, tbl_joblist B SET A.JOBCOST = B.JOBCOST, A.PRICE = A.JOBCOST / A.JOBVOLM
															WHERE A.JOBCODEID = B.JOBCODEID AND A.PRJCODE = B.PRJCODE
		...
		echo "Analisa RAP sudah kami proses. Silahkan cek di daftar RAP..! $s_05";
    }
