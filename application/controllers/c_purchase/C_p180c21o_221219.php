	...
	function get_AllDataIITMREQDET() // GOOD
	{
		...
		// START : FOR SERVER-SIDE
			...
			foreach ($query->result_array() as $dataI) 
			{
				...
				$JOBCODEID		= $dataI['JOBCODEID'];
				$JOBPARENT 		= $dataI['JOBPARENT'];
				$JOBPARDESC		= htmlspecialchars($dataI['JOBPARDESC'], ENT_QUOTES);
				$PRD_ID 		= $dataI['PRD_ID'];
				$ITM_CODE 		= $dataI['ITM_CODE'];
				$ITM_NAME 		= htmlspecialchars($dataI['ITM_NAME'], ENT_QUOTES);
				$ITM_NAME 		= wordwrap($ITM_NAME, 60, "<br>", TRUE);
				...
				$PO_DESC		= htmlspecialchars($dataI['PO_DESC'], ENT_QUOTES);
				$TAXCODE1		= $dataI['TAXCODE1'];
				$TAXCODE2		= $dataI['TAXCODE2'];
				$TAXPRICE1		= $dataI['TAXPRICE1'];
				$TAXPRICE2		= $dataI['TAXPRICE2'];
				...
				if($disabledB == 0)
				{
					$chkBox	= "<input type='checkbox' name='chk4' id='chkRow_".$noU."' value='".$PO_ID."|".$PRD_ID."|".$ITM_CODE."|".$ITM_NAME."|".$JOBCODEDET."|".$JOBCODEID."|".$JOBPARENT."|".$JOBPARDESC."|".$JOBDESC."|".$ITM_PRICE."|".$TBUDG_VAL."|".$ORDERED_VAL."|".$REM_SPP_VOL."|".$ITM_REMVAL."|".$ITM_CATEG."|".$PR_VOLM."|".$PR_AMOUNT."|".$TOTVAL_OTHDOC."|".$PO_VOLM."|".$ORDERED_VOL0."|".$ITM_UNIT."|".$PR_DESC_ID."|".$PO_DESC_ID."|".$PO_DESC."|".$selRow."' onChange='pickThis4(this);'/>";
				}
				else
				{
					$chkBox	= "<input type='checkbox' name='chk4' id='chkRow_".$noU."' value='' style='display: none' />";
