				...
				$output['data'][] 	= array("<div style='white-space:nowrap'>
											...
											$ITM_R,
									  		"<div style='white-space:nowrap; text-align: center'>
									  			...
									  			<input type='hidden' name='data[".$noU."][ITM_UNIT2]' id='data".$noU."ITM_UNIT2' value='".$ITM_UNIT."' class='form-control' style='max-width:300px;' >
									  		</div>",
									  		"$ITM_DESCVW
		...
		// INSERT DATA
			$s_02 	= 	"INSERT INTO tbl_pr_detail_tmp
						...
						VALUES
							...
							'$ITM_CODE', '$ITM_NAME', '$ITM_UNIT', '$ITM_UNIT', 0, '$PR_PRICE', 0, '',
