...
class C_pr180d0c extends CI_Controller  
{
	...
	function addItmTmp()
	{
		...
		$PRJCODE 		= $arrItem[3];
		$ITM_CODE 		= $arrItem[4];
		$ITM_NAME 		= htmlspecialchars($arrItem[5], ENT_QUOTES);
		$ITM_SN			= $arrItem[6];
		$ITM_UNIT 		= $arrItem[7];
		$ITM_PRICE 		= $arrItem[8];
		$ITM_VOLM 		= $arrItem[9];
		...
		$ITM_TYPE		= $arrItem[18];
		$JOBDESCH 		= htmlspecialchars($arrItem[19], ENT_QUOTES);
		$PR_NUM 		= $arrItem[20];
		$PR_CODE 		= $arrItem[21];
        ...
        foreach($resJPAR as $rowJPAR) :
            ...
            $JOBPARDESC	= htmlspecialchars($rowJPAR->JOBDESC, ENT_QUOTES);
        endforeach;
	...
	function addDesc()
	{
		...
		$ITMCODE 	= $arrItem[0];
		$ITMDESC 	= nl2br(htmlspecialchars($arrItem[1], ENT_QUOTES));
