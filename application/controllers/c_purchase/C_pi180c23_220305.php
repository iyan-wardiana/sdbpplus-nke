	...
	function add_process() // OK - ADD INVOICING PROCESS
	{
		...
		{			
			...
			foreach($_POST['data'] as $d)
			{
				...
				// UPDATE TTK STATUS
					$TTKNUM 	= $d['TTK_NUM'];
					$s_01		= "UPDATE tbl_ttk_header SET INV_STAT = 'FI', INV_CREATED = 1 WHERE TTK_NUM = '$TTKNUM'";
					$this->db->query($s_01);
			}
	...
	function update_process() // OK
	{
		...
		{			
			...
			elseif($INV_STAT == 3)
			{
				...
				// START : CREATE INVOICE RETENSI : DI-HOLD KARENA JURNAL RETENSI SUDAH TERBENTUK SAAT OPNAME ------- HOLDED
				...
				// END : CREATE INVOICE RETENSI : DI-HOLD KARENA JURNAL RETENSI SUDAH TERBENTUK SAAT OPNAME ------- HOLDED
